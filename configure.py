...
LIBS = [
    ...
    },
    {
        ...
        "objects": [
            ...
            ["libs/RVL_SDK/src/revolution/os/OSUtf", True, {"mw_version" : "3.0"}],
    ...
    },
    {
        ...
        "objects": [
            ...
            ["libs/RVL_SDK/src/revolution/sc/scapi_prdinfo", True, {"mw_version" : "3.0"}],
        ],
    },
    {
        "lib": "si",
    ...
    },
    {
        ...
        "host": True,
        "objects": [
            ["libs/mm/asm/code_80432678", False],
            ["libs/mm/asm/Heap", False],
            ["libs/mm/asm/StringUtils", False],
            ["libs/mm/src/MTRand", True],
            ["libs/mm/src/Vec3", True],
            ["libs/mm/src/Vec4", True],
            ["libs/mm/src/FastCast", True],
            ["libs/mm/src/MathConstants", True],
            ["libs/mm/src/Random", True],
            ["libs/mm/src/FloatUtils", True],
            ["libs/mm/src/Col3", True],
            ["libs/mm/src/Col4", True],
            ["libs/mm/asm/Mat34", False],
            ["libs/mm/src/Mat44", True],
            ["libs/mm/asm/Quat", False],
        ],
    },
    {
        "lib": "monolithlib",
...
if __name__ == "__main__":
    ...
    n.variable("cflags_criware", "$cflags_base -sdata 0 -sdata2 0")
