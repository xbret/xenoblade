LIBS = [
	{
		...
		"objects": [
			...
			["src/kyoshin/appgame/plugin/plugin_deb", True],
			["src/kyoshin/appgame/plugin/plugin_wait", True],
			...
			["src/kyoshin/appgame/plugin/plugin_game", True],
	...
	},
	{
		...
		"host": True,
		"objects": [
			["libs/monolib/asm/CAttrTransform", False],
			["libs/monolib/asm/MemManager", False],
			["libs/monolib/asm/CPathUtil", False],
			["libs/monolib/src/MTRand", True],
			["libs/monolib/src/CRect16", True],
			["libs/monolib/src/CVec3", True],
			["libs/monolib/src/CVec4", True],
			["libs/monolib/src/FastCast", True],
			["libs/monolib/src/MathConstants", True],
			["libs/monolib/src/Random", True],
			["libs/monolib/src/FloatUtils", True],
			["libs/monolib/src/CCol3", True],
			["libs/monolib/src/CCol4", True],
			["libs/monolib/asm/CMat34", False],
			["libs/monolib/src/CMat44", True],
			["libs/monolib/asm/CQuat", False],
			["libs/monolib/asm/work/CWorkThread", False],
			["libs/monolib/asm/CProc", False],
			["libs/monolib/asm/CProcRoot", False],
			["libs/monolib/asm/CRsrcData", False],
			["libs/monolib/asm/CScriptCode", False],
			["libs/monolib/asm/CToken", False],
			["libs/monolib/asm/CRootProc", False],
			["libs/monolib/asm/CView", False],
			["libs/monolib/asm/CViewFrame", False],
			["libs/monolib/asm/CViewRoot", False],
			["libs/monolib/asm/work/CWorkControl", False],
			["libs/monolib/asm/work/CWorkFlowSetup", False],
			["libs/monolib/asm/work/CWorkRoot", False],
			["libs/monolib/asm/work/CWorkSystem", False],
			["libs/monolib/asm/work/CWorkSystemMem", False],
			["libs/monolib/asm/CProcess", False],
			["libs/monolib/asm/CDoubleListNode", False],
			["libs/monolib/asm/CChildListNode", False],
			["libs/monolib/asm/device/CDeviceRemotePad", False],
			["libs/monolib/asm/device/CDeviceBase", False],
			["libs/monolib/asm/device/CDeviceSC", False],
			["libs/monolib/asm/device/CDeviceVI", False],
			["libs/monolib/asm/device/CDeviceVICb", False],
			["libs/monolib/asm/CFontLayer", False],
			["libs/monolib/asm/CGXCache", False],
			["libs/monolib/asm/IStateCache", False],
			["libs/monolib/asm/device/CDevice", False],
			["libs/monolib/asm/device/CDeviceClock", False],
			["libs/monolib/asm/device/CDeviceFile", False],
			["libs/monolib/asm/device/CDeviceFileCri", False],
			["libs/monolib/src/code_80450B14", True],
			["libs/monolib/asm/device/code_80450B2C", False],
			["libs/monolib/asm/device/CDeviceFileDvd", False],
			["libs/monolib/asm/device/CDeviceFileJob", False],
			["libs/monolib/asm/device/CDeviceFileJobReadDvd", False],
			["libs/monolib/asm/device/CDeviceFont", False],
			["libs/monolib/asm/device/CDeviceFontInfoExt", False],
			["libs/monolib/asm/device/CDeviceFontInfoRom", False],
			["libs/monolib/asm/device/CDeviceFontLayer", False],
			["libs/monolib/asm/device/CDeviceFontLoader", False],
			["libs/monolib/asm/device/CDeviceGX", False],
			["libs/monolib/asm/CDesktop", False],
			["libs/monolib/asm/code_80456134", False],
			["libs/monolib/asm/CException", False],
			["libs/monolib/asm/lib/CLib", False],
			["libs/monolib/asm/lib/CLibCri", False],
			["libs/monolib/asm/lib/CLibCriMoviePlay", False],
			["libs/monolib/asm/lib/CLibCriStreamingPlay", False],
			["libs/monolib/asm/lib/CLibG3d", False],
			["libs/monolib/asm/lib/CLibHbm", False],
			["libs/monolib/asm/lib/CLibHbmControl", False],
			["libs/monolib/asm/lib/CLibLayout", False],
			["libs/monolib/asm/lib/CLibStaticData", False],
			["libs/monolib/asm/lib/CLibVM", False],
			["libs/monolib/asm/CTaskLOD", False],
			["libs/monolib/asm/code_8046376C", False],
			["libs/monolib/asm/code_804645CC", False],
			["libs/monolib/asm/code_80468434", False],
			["libs/monolib/asm/code_8046A530", False],
			["libs/monolib/asm/LOD/LODMemMan", False],
			["libs/monolib/asm/mpfsys/MPFDrawDisplayList", False],
			["libs/monolib/asm/mpfsys/MPFDrawMdlNoColor", False],
			["libs/monolib/asm/mpfsys/MPFDrawMdlColor", False],
			["libs/monolib/asm/mpfsys/MPFDrawBillboard", False],
			["libs/monolib/asm/mpfsys/MPFDrawCross", False],
			["libs/monolib/asm/mpfsys/MPFDrawBillLayTex", False],
			["libs/monolib/asm/mpfsys/code_8047BB54", False],
			["libs/monolib/asm/code_8047CA88", False],
			["libs/monolib/asm/code_8047D2AC", False],
			["libs/monolib/asm/scn/CScnItemCameraNw4r", False],
			["libs/monolib/asm/scn/CScnItemId", False],
			["libs/monolib/asm/scn/CScnItemLight", False],
			["libs/monolib/asm/scn/CScnItemLightNw4r", False],
			["libs/monolib/asm/scn/CScnItemModel", False],
			["libs/monolib/asm/scn/CScnItemModelNw4r", False],
			["libs/monolib/asm/scn/CScnItemPool", False],
			["libs/monolib/asm/scn/CScnLightMan", False],
			["libs/monolib/asm/scn/CScnMaruShadowNw4r", False],
			["libs/monolib/asm/scn/CScnMem", False],
			["libs/monolib/asm/scn/CScnRoot", False],
			["libs/monolib/asm/scn/CScnRootNw4r", False],
			["libs/monolib/asm/scn/CScnTexWorkMan", False],
			["libs/monolib/asm/scn/CScnVirtualLight", False],
			["libs/monolib/asm/code_8049431C", False],
			["libs/monolib/asm/CVirtualLightAmb", False],
			["libs/monolib/asm/CVirtualLightDir", False],
			["libs/monolib/asm/CVirtualLightObj", False],
			["libs/monolib/asm/scn/CScn", False],
			["libs/monolib/asm/scn/CScn_80496B0C", False],
			["libs/monolib/asm/scn/CScnBlend", False],
			["libs/monolib/asm/scn/CScnBloom", False],
			["libs/monolib/asm/scn/CScnCameraMan", False],
			["libs/monolib/asm/scn/CScnEffectActNw4r", False],
			["libs/monolib/asm/scn/CScnFadeMan", False],
			["libs/monolib/asm/scn/CScnFilter", False],
			["libs/monolib/asm/scn/CScnFilterMan", False],
			["libs/monolib/asm/scn/CScnFogMan", False],
			["libs/monolib/asm/scn/CScnFrame", False],
			["libs/monolib/asm/scn/CScnIdMan", False],
			["libs/monolib/asm/scn/CScnItemAnim", False],
			["libs/monolib/asm/scn/CScnItemCamera", False],
			["libs/monolib/asm/vm/yvm", False],
			["libs/monolib/asm/code_804A6C60", False],
			["libs/monolib/asm/CColiProc", False],
			["libs/monolib/asm/code_804B2FF0", False],
			["libs/monolib/asm/code_804B59C8", False],
			["libs/monolib/asm/code_804BAE10", False],
			["libs/monolib/asm/code_804BC9EC", False],
			["libs/monolib/asm/code_804BD8E8", False],
			["libs/monolib/asm/code_804BF59C", False],
			["libs/monolib/asm/CLight", False],
			["libs/monolib/asm/scn/CScnEnvLgtCtrl", False],
			["libs/monolib/src/Unknown1", True],
			["libs/monolib/asm/code_804C8684", False],
			["libs/monolib/asm/code_804C8718", False],
			["libs/monolib/asm/code_804CC2B8", False],
			["libs/monolib/asm/effect/CETrail", False],
			["libs/monolib/asm/effect/code_804D854C", False],
			["libs/monolib/asm/work/CWorkSystemCache", False],
			["libs/monolib/asm/code_804D9274", False],
			["libs/monolib/asm/nand/CNand", False],
			["libs/monolib/asm/nand/CNReqtaskSave", False],
			["libs/monolib/asm/nand/CNReqtaskLoad", False],
			["libs/monolib/asm/nand/CNReqtaskReaddir", False],
			["libs/monolib/asm/nand/CNReqtaskRemove", False],
			["libs/monolib/asm/nand/CNReqtaskCheck", False],
			["libs/monolib/src/effect/CERand", True],
			["libs/monolib/asm/code_804DB938", False],
			["libs/monolib/asm/work/CWorkSystemPack", False],
			["libs/monolib/asm/CPackItem", False],
			["libs/monolib/asm/CArcItem", False],
			["libs/monolib/asm/code_804DEDA8", False],
			["libs/monolib/asm/CSchedule", False],
			["libs/monolib/asm/code_804E36DC", False],
			["libs/monolib/asm/ScheduleList", False],
			["libs/monolib/asm/scn/CMdlMaterial", False],
			["libs/monolib/asm/scn/CMdlMouth", False],
			["libs/monolib/asm/scn/CMdlAnmUV", False],
			["libs/monolib/asm/scn/CMdlAnmEye", False],
			["libs/monolib/asm/scn/CMdlLook", False],
			["libs/monolib/asm/scn/CMdlDynamics", False],
			["libs/monolib/asm/code_804EE0F4", False],
			["libs/monolib/asm/code_804F0258", False],
			["libs/monolib/asm/nand/CNReqtaskSaveBanner", False],
			["libs/monolib/asm/nand/CNBanner", False],
		],
	},
]
