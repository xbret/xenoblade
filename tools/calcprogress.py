...
# Progress flavor
codeFrac = 200        # total code "item" amount
dataFrac = 21          # total data "item" amount
codeItem = "achievements"      # code flavor item
dataItem = "collectopaedias"  # data flavor item
...
if __name__ == "__main__":
    ...
    print("\nYou have earned {} out of {} {} and completed {} out of {} {}.".format(codeCount, codeFrac, codeItem, dataCount, dataFrac, dataItem))