...
LIBS = ["CriWare", "NdevExi2A", "nw4r", "PowerPC_EABI_Support", "RVL_SDK", "mm", "monolib"]
...
if __name__ == "__main__":
	...
	for i in range(first_section, len(symbols)):
		...
		# Parse symbols until we hit the next section declaration
			...
			if (symb.startswith("*fill*")) or is_file_symbol:
				continue

			# Subtract the size of the symbol if the object file is in an asm folder
