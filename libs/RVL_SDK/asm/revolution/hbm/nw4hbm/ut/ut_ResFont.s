...
/* 803387D8 00301D98  3C 80 80 55 */	lis r4, __vt__Q36nw4hbm2ut7ResFont@ha
/* 803387DC 00301D9C  7F E3 FB 78 */	mr r3, r31
/* 803387E0 00301DA0  38 84 EC D0 */	addi r4, r4, __vt__Q36nw4hbm2ut7ResFont@l
/* 803387E4 00301DA4  90 9F 00 00 */	stw r4, 0(r31)
...
/* 80338818 00301DD8  93 C1 00 08 */	stw r30, 8(r1)
...
/* 80338844 00301E04  83 C1 00 08 */	lwz r30, 8(r1)
...
/* 803388B4 00301E74  2C 03 00 00 */	cmpwi r3, 0
/* 803388B8 00301E78  40 81 00 98 */	ble .L_80338950
/* 803388BC 00301E7C  60 00 00 00 */	nop 
.L_803388C0:
/* 803388C0 00301E80  80 64 00 00 */	lwz r3, 0(r4)
...
/* 803388D0 00301E90  38 A4 00 08 */	addi r5, r4, 8
/* 803388D4 00301E94  48 00 00 7C */	b .L_80338950
.L_803388D8:
/* 803388D8 00301E98  80 04 00 04 */	lwz r0, 4(r4)
...
.L_803388E8:
/* 803388E8 00301EA8  A0 04 00 06 */	lhz r0, 6(r4)
/* 803388EC 00301EAC  28 00 01 04 */	cmplwi r0, 0x104
/* 803388F0 00301EB0  40 82 00 2C */	bne .L_8033891C
/* 803388F4 00301EB4  3C 80 52 46 */	lis r4, 0x52464E54@ha
...
.L_8033891C:
/* 8033891C 00301EDC  3C 80 52 46 */	lis r4, 0x52464E54@ha
...
/* 80338958 00301F18  38 60 00 00 */	li r3, 0
...
.L_803389C8:
/* 803389C8 00301F88  80 85 00 00 */	lwz r4, 0(r5)
...
/* 80338A10 00301FD0  38 C5 00 08 */	addi r6, r5, 8
...
/* 80338A20 00301FE0  2C 00 00 00 */	cmpwi r0, 0
...
/* 80338A34 00301FF4  2C 00 00 00 */	cmpwi r0, 0
...
/* 80338A5C 0030201C  2C 00 00 00 */	cmpwi r0, 0
...
/* 80338A74 00302034  2C 00 00 00 */	cmpwi r0, 0
...
.L_80338A88:
/* 80338A88 00302048  38 60 00 00 */	li r3, 0
/* 80338A8C 0030204C  4E 80 00 20 */	blr
.L_80338A90:
/* 80338A90 00302050  80 05 00 04 */	lwz r0, 4(r5)
/* 80338A94 00302054  38 E7 00 01 */	addi r7, r7, 1
...
/* 80338AA8 00302068  3C 80 52 46 */	lis r4, 0x52464E55@ha
/* 80338AAC 0030206C  38 04 4E 55 */	addi r0, r4, 0x52464E55@l
...
.obj __vt__Q36nw4hbm2ut7ResFont, global
...
.endobj __vt__Q36nw4hbm2ut7ResFont
...
.obj __RTTI__Q36nw4hbm2ut7ResFont, global
	.4byte lbl_8054ED28
	.4byte lbl_8054ED3C
.endobj __RTTI__Q36nw4hbm2ut7ResFont
...
.obj __RTTI__Q46nw4hbm2ut6detail11ResFontBase, global
	.4byte lbl_8054ED58
	.4byte lbl_8054ED78
.endobj __RTTI__Q46nw4hbm2ut6detail11ResFontBase
...
.obj __RTTI__Q36nw4hbm2ut4Font, global
	.4byte lbl_8054ED90
	.4byte 0
.endobj __RTTI__Q36nw4hbm2ut4Font
