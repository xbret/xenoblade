...
#include <nw4hbm/ut/ut_NonCopyable.h>
 ...
 */
#define NW4R_UT_LIST_NODE_DECL() nw4hbm::ut::LinkListNode node
 ...
 * Use the specified link node (name suffix) for classes with multiple nodes.
 */
#define NW4R_UT_LIST_NODE_DECL_EX(SUFFIX) nw4hbm::ut::LinkListNode node##SUFFIX
