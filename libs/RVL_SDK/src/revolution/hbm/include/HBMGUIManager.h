...
protected:
    ...
    nw4hbm::ut::List mIDToComponent; // at 0x8
...
public:
    PaneManager(EventHandler* pEventHandler,
                const nw4hbm::lyt::DrawInfo* pDrawInfo, MEMAllocator* pAllocator)
...
private:
    ...
    nw4hbm::ut::List mPaneToComponent;       // at 0x18
    const nw4hbm::lyt::DrawInfo* mpDrawInfo; // at 0x24
...
public:
    ...
    virtual void setPane(nw4hbm::lyt::Pane* pPane) { // at 0x60
        mpPane = pPane;
    }
    virtual nw4hbm::lyt::Pane* getPane() { // at 0x64
        return mpPane;
    }

private:
    nw4hbm::lyt::Pane* mpPane; // at 0x2C
};
