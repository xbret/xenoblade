...
/* 802CCB58 00296118  48 00 09 4D */	bl TRK_GetFreeBuffer
...
/* 802CCBF4 002961B4  48 00 09 C1 */	bl TRK_SetBufferPosition
...
/* 802CCCA8 00296268  48 00 07 79 */	bl TRK_MessageSend
...
/* 802CCCDC 0029629C  48 00 08 D9 */	bl TRK_SetBufferPosition
...
/* 802CCD74 00296334  48 00 07 F1 */	bl TRK_ReleaseBuffer
...
/* 802CCE28 002963E8  48 00 06 7D */	bl TRK_GetFreeBuffer
...
/* 802CCEB0 00296470  48 00 06 B5 */	bl TRK_ReleaseBuffer
.L_802CCEB4:
/* 802CCEB4 00296474  80 61 00 0C */	lwz r3, 0xc(r1)
/* 802CCEB8 00296478  48 00 06 AD */	bl TRK_ReleaseBuffer
...
/* 802CCF20 002964E0  48 00 05 85 */	bl TRK_GetFreeBuffer
...
/* 802CCF8C 0029654C  48 00 05 D9 */	bl TRK_ReleaseBuffer
.L_802CCF90:
/* 802CCF90 00296550  80 61 00 0C */	lwz r3, 0xc(r1)
/* 802CCF94 00296554  48 00 05 D1 */	bl TRK_ReleaseBuffer
...
/* 802CD01C 002965DC  48 00 04 89 */	bl TRK_GetFreeBuffer
...
/* 802CD094 00296654  48 00 04 D1 */	bl TRK_ReleaseBuffer
.L_802CD098:
/* 802CD098 00296658  80 61 00 0C */	lwz r3, 0xc(r1)
/* 802CD09C 0029665C  48 00 04 C9 */	bl TRK_ReleaseBuffer
