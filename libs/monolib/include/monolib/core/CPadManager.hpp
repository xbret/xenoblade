...
#define TURBO_HOLD_TIMER_THRESHOLD (int)(SECONDS_TO_FRAMES(1)/3.0f)
#define TURBO_INPUT_FRAMES (int)(SECONDS_TO_FRAMES(1) * 0.1f)
#define LONG_HOLD_TIMER_THRESHOLD (int)(SECONDS_TO_FRAMES(1) * (2.0f/3.0f))
#define SHORT_PRESS_MAX_FRAMES (int)(SECONDS_TO_FRAMES(1)/6.0f)
