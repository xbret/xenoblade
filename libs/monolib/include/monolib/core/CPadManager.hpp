...
enum PadInput{
    ...
    PAD_INPUT_UP = (1 << 2),
    PAD_INPUT_DOWN = (1 << 3),
    PAD_INPUT_CORE_A = (1 << 4),
    PAD_INPUT_CORE_B = (1 << 5),
    PAD_INPUT_1 = (1 << 6),
    PAD_INPUT_2 = (1 << 7),
    PAD_INPUT_HOME = (1 << 8),
    PAD_INPUT_PLUS = (1 << 9),
    PAD_INPUT_MINUS = (1 << 10),
    PAD_INPUT_FS_C = (1 << 11),
    PAD_INPUT_FS_Z = (1 << 12),
    PAD_INPUT_LSTICK_LEFT = (1 << 13),
    PAD_INPUT_LSTICK_RIGHT = (1 << 14),
    PAD_INPUT_LSTICK_UP = (1 << 15),
    PAD_INPUT_LSTICK_DOWN = (1 << 16),
    PAD_INPUT_RSTICK_LEFT = (1 << 17),
    PAD_INPUT_RSTICK_RIGHT = (1 << 18),
    PAD_INPUT_RSTICK_UP = (1 << 19),
    PAD_INPUT_RSTICK_DOWN = (1 << 20),
    PAD_INPUT_CLASSIC_A = (1 << 21),
    PAD_INPUT_CLASSIC_B = (1 << 22),
    PAD_INPUT_CLASSIC_X = (1 << 23),
    PAD_INPUT_CLASSIC_Y = (1 << 24),
    PAD_INPUT_CLASSIC_L = (1 << 25),
    PAD_INPUT_CLASSIC_R = (1 << 26),
    PAD_INPUT_CLASSIC_ZL = (1 << 27),
    PAD_INPUT_CLASSIC_ZR = (1 << 28),

    MAX_PAD_INPUT_FLAGS = 32
};
