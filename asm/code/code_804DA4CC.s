...
/* 804DA4E8 004A3AA8  3C C0 80 4E */	lis r6, lbl_804DA97C@ha
...
/* 804DA4F8 004A3AB8  38 C6 A9 7C */	addi r6, r6, lbl_804DA97C@l
...
/* 804DA510 004A3AD0  4B E7 6A 91 */	bl func_80350FA0
...
/* 804DA548 004A3B08  3C C0 80 4E */	lis r6, lbl_804DA97C@ha
...
/* 804DA55C 004A3B1C  38 C6 A9 7C */	addi r6, r6, lbl_804DA97C@l
...
/* 804DA57C 004A3B3C  4B E7 55 65 */	bl func_8034FAE0
...
/* 804DA5BC 004A3B7C  3C C0 80 4E */	lis r6, lbl_804DA97C@ha
...
/* 804DA5E8 004A3BA8  38 C6 A9 7C */	addi r6, r6, lbl_804DA97C@l
...
/* 804DA5F8 004A3BB8  4B E7 47 A9 */	bl func_8034EDA0
...
/* 804DA630 004A3BF0  3C C0 80 4E */	lis r6, lbl_804DA97C@ha
...
/* 804DA65C 004A3C1C  38 C6 A9 7C */	addi r6, r6, lbl_804DA97C@l
...
/* 804DA66C 004A3C2C  4B E7 48 25 */	bl func_8034EE90
...
/* 804DA6A8 004A3C68  3C 80 80 4E */	lis r4, lbl_804DA97C@ha
...
/* 804DA6C4 004A3C84  38 84 A9 7C */	addi r4, r4, lbl_804DA97C@l
...
/* 804DA6D4 004A3C94  4B E7 55 FD */	bl func_8034FCD0
...
/* 804DA714 004A3CD4  3C C0 80 4E */	lis r6, lbl_804DA97C@ha
...
/* 804DA724 004A3CE4  38 C6 A9 7C */	addi r6, r6, lbl_804DA97C@l
...
/* 804DA774 004A3D34  3C 80 80 4E */	lis r4, lbl_804DA97C@ha
...
/* 804DA784 004A3D44  38 84 A9 7C */	addi r4, r4, lbl_804DA97C@l
...
/* 804DA79C 004A3D5C  4B E7 43 F5 */	bl func_8034EB90
...
/* 804DA7D4 004A3D94  3C A0 80 4E */	lis r5, lbl_804DA97C@ha
...
/* 804DA7E4 004A3DA4  38 A5 A9 7C */	addi r5, r5, lbl_804DA97C@l
...
/* 804DA7FC 004A3DBC  4B E7 4B 55 */	bl func_8034F350
...
/* 804DA834 004A3DF4  3C A0 80 4E */	lis r5, lbl_804DA97C@ha
...
/* 804DA854 004A3E14  38 A5 A9 7C */	addi r5, r5, lbl_804DA97C@l
...
/* 804DA868 004A3E28  4B E7 4B E9 */	bl func_8034F450
...
/* 804DA8D0 004A3E90  3C C0 80 4E */	lis r6, lbl_804DA97C@ha
...
/* 804DA8E0 004A3EA0  38 7F 28 38 */	addi r3, r31, 0x2838
/* 804DA8E4 004A3EA4  38 C6 A9 7C */	addi r6, r6, lbl_804DA97C@l
/* 804DA8E8 004A3EA8  38 E7 26 F0 */	addi r7, r7, lbl_806626F0@l
/* 804DA8EC 004A3EAC  4B E7 46 D5 */	bl func_8034EFC0
...
/* 804DA924 004A3EE4  3C 80 80 4E */	lis r4, lbl_804DA97C@ha
...
/* 804DA934 004A3EF4  38 84 A9 7C */	addi r4, r4, lbl_804DA97C@l
...
/* 804DA9AC 004A3F6C  38 7F 28 38 */	addi r3, r31, 0x2838
...
/* 804DA9F4 004A3FB4  38 BE 28 38 */	addi r5, r30, 0x2838
...
/* 804DAA08 004A3FC8  38 7F 28 7C */	addi r3, r31, 0x287c
...
/* 804DAA40 004A4000  38 7F 28 C0 */	addi r3, r31, 0x28c0
...
/* 804DAAB0 004A4070  3C 80 80 57 */	lis r4, lbl_805735A0@ha
...
/* 804DAAC0 004A4080  38 84 35 A0 */	addi r4, r4, lbl_805735A0@l
...
/* 804DAD44 004A4304  BF C1 00 08 */	stmw r30, 8(r1)
/* 804DAD48 004A4308  7C 9E 23 78 */	mr r30, r4
/* 804DAD4C 004A430C  88 0D C1 28 */	lbz r0, lbl_806682A8@sda21(r13)
/* 804DAD50 004A4310  2C 00 00 00 */	cmpwi r0, 0
/* 804DAD54 004A4314  41 82 00 0C */	beq lbl_804DAD60
/* 804DAD58 004A4318  38 60 00 00 */	li r3, 0
/* 804DAD5C 004A431C  48 00 01 78 */	b lbl_804DAED4
lbl_804DAD60:
/* 804DAD60 004A4320  88 64 00 19 */	lbz r3, 0x19(r4)
/* 804DAD64 004A4324  7C 60 07 74 */	extsb r0, r3
/* 804DAD68 004A4328  2C 00 00 02 */	cmpwi r0, 2
/* 804DAD6C 004A432C  41 80 00 18 */	blt lbl_804DAD84
/* 804DAD70 004A4330  80 0D C1 2C */	lwz r0, lbl_806682AC@sda21(r13)
/* 804DAD74 004A4334  2C 00 00 00 */	cmpwi r0, 0
/* 804DAD78 004A4338  40 80 00 0C */	bge lbl_804DAD84
/* 804DAD7C 004A433C  38 60 00 02 */	li r3, 2
/* 804DAD80 004A4340  48 00 01 54 */	b lbl_804DAED4
lbl_804DAD84:
/* 804DAD84 004A4344  7C 60 07 75 */	extsb. r0, r3
/* 804DAD88 004A4348  41 82 00 38 */	beq lbl_804DADC0
/* 804DAD8C 004A434C  2C 00 00 01 */	cmpwi r0, 1
/* 804DAD90 004A4350  41 82 00 5C */	beq lbl_804DADEC
/* 804DAD94 004A4354  2C 00 00 02 */	cmpwi r0, 2
/* 804DAD98 004A4358  41 82 00 C8 */	beq lbl_804DAE60
/* 804DAD9C 004A435C  2C 00 00 03 */	cmpwi r0, 3
/* 804DADA0 004A4360  41 82 00 E0 */	beq lbl_804DAE80
/* 804DADA4 004A4364  2C 00 00 04 */	cmpwi r0, 4
/* 804DADA8 004A4368  41 82 01 0C */	beq lbl_804DAEB4
/* 804DADAC 004A436C  2C 00 00 05 */	cmpwi r0, 5
/* 804DADB0 004A4370  41 82 01 10 */	beq lbl_804DAEC0
/* 804DADB4 004A4374  2C 00 00 06 */	cmpwi r0, 6
/* 804DADB8 004A4378  41 82 01 10 */	beq lbl_804DAEC8
/* 804DADBC 004A437C  48 00 01 14 */	b lbl_804DAED0
lbl_804DADC0:
/* 804DADC0 004A4380  7F C3 F3 78 */	mr r3, r30
/* 804DADC4 004A4384  48 00 01 25 */	bl func_804DAEE8
/* 804DADC8 004A4388  38 80 00 02 */	li r4, 2
/* 804DADCC 004A438C  4B FF F7 75 */	bl func_804DA540
/* 804DADD0 004A4390  2C 03 00 00 */	cmpwi r3, 0
/* 804DADD4 004A4394  41 82 00 0C */	beq lbl_804DADE0
/* 804DADD8 004A4398  38 60 00 02 */	li r3, 2
/* 804DADDC 004A439C  48 00 00 F8 */	b lbl_804DAED4
lbl_804DADE0:
/* 804DADE0 004A43A0  38 00 00 01 */	li r0, 1
/* 804DADE4 004A43A4  98 1E 00 19 */	stb r0, 0x19(r30)
/* 804DADE8 004A43A8  48 00 00 E8 */	b lbl_804DAED0
lbl_804DADEC:
/* 804DADEC 004A43AC  80 0D C1 2C */	lwz r0, lbl_806682AC@sda21(r13)
/* 804DADF0 004A43B0  2C 00 00 00 */	cmpwi r0, 0
/* 804DADF4 004A43B4  41 82 00 44 */	beq lbl_804DAE38
/* 804DADF8 004A43B8  2C 00 FF F4 */	cmpwi r0, -12
/* 804DADFC 004A43BC  40 82 00 34 */	bne lbl_804DAE30
...
/* 804DAE0C 004A43CC  38 A0 00 00 */	li r5, 0
/* 804DAE10 004A43D0  4B FF F8 FD */	bl func_804DA70C
/* 804DAE14 004A43D4  2C 03 00 00 */	cmpwi r3, 0
/* 804DAE18 004A43D8  41 82 00 0C */	beq lbl_804DAE24
/* 804DAE1C 004A43DC  38 60 00 02 */	li r3, 2
/* 804DAE20 004A43E0  48 00 00 B4 */	b lbl_804DAED4
lbl_804DAE24:
/* 804DAE24 004A43E4  38 00 00 06 */	li r0, 6
/* 804DAE28 004A43E8  98 1E 00 19 */	stb r0, 0x19(r30)
/* 804DAE2C 004A43EC  48 00 00 A4 */	b lbl_804DAED0
lbl_804DAE30:
/* 804DAE30 004A43F0  38 60 00 02 */	li r3, 2
/* 804DAE34 004A43F4  48 00 00 A0 */	b lbl_804DAED4
lbl_804DAE38:
...
/* 804DAE44 004A4404  2C 03 00 00 */	cmpwi r3, 0
/* 804DAE48 004A4408  41 82 00 0C */	beq lbl_804DAE54
/* 804DAE4C 004A440C  38 60 00 02 */	li r3, 2
/* 804DAE50 004A4410  48 00 00 84 */	b lbl_804DAED4
lbl_804DAE54:
/* 804DAE54 004A4414  38 00 00 02 */	li r0, 2
/* 804DAE58 004A4418  98 1E 00 19 */	stb r0, 0x19(r30)
/* 804DAE5C 004A441C  48 00 00 74 */	b lbl_804DAED0
lbl_804DAE60:
/* 804DAE60 004A4420  4B FF F8 3D */	bl func_804DA69C
/* 804DAE64 004A4424  2C 03 00 00 */	cmpwi r3, 0
/* 804DAE68 004A4428  41 82 00 0C */	beq lbl_804DAE74
/* 804DAE6C 004A442C  38 60 00 02 */	li r3, 2
/* 804DAE70 004A4430  48 00 00 64 */	b lbl_804DAED4
lbl_804DAE74:
/* 804DAE74 004A4434  38 00 00 03 */	li r0, 3
/* 804DAE78 004A4438  98 1E 00 19 */	stb r0, 0x19(r30)
/* 804DAE7C 004A443C  48 00 00 54 */	b lbl_804DAED0
lbl_804DAE80:
...
/* 804DAE98 004A4458  2C 03 00 00 */	cmpwi r3, 0
/* 804DAE9C 004A445C  41 82 00 0C */	beq lbl_804DAEA8
/* 804DAEA0 004A4460  38 60 00 02 */	li r3, 2
/* 804DAEA4 004A4464  48 00 00 30 */	b lbl_804DAED4
lbl_804DAEA8:
/* 804DAEA8 004A4468  38 00 00 04 */	li r0, 4
/* 804DAEAC 004A446C  98 1E 00 19 */	stb r0, 0x19(r30)
/* 804DAEB0 004A4470  48 00 00 20 */	b lbl_804DAED0
lbl_804DAEB4:
/* 804DAEB4 004A4474  38 00 00 05 */	li r0, 5
/* 804DAEB8 004A4478  98 04 00 19 */	stb r0, 0x19(r4)
/* 804DAEBC 004A447C  48 00 00 14 */	b lbl_804DAED0
lbl_804DAEC0:
/* 804DAEC0 004A4480  38 60 00 01 */	li r3, 1
/* 804DAEC4 004A4484  48 00 00 10 */	b lbl_804DAED4
lbl_804DAEC8:
/* 804DAEC8 004A4488  38 00 00 00 */	li r0, 0
/* 804DAECC 004A448C  98 04 00 19 */	stb r0, 0x19(r4)
lbl_804DAED0:
/* 804DAED0 004A4490  38 60 00 00 */	li r3, 0
lbl_804DAED4:
/* 804DAED4 004A4494  BB C1 00 08 */	lmw r30, 8(r1)
...
/* 804DAF00 004A44C0  40 82 00 20 */	bne lbl_804DAF20
/* 804DAF04 004A44C4  3C A0 80 66 */	lis r5, lbl_80662908@ha
/* 804DAF08 004A44C8  38 C0 00 00 */	li r6, 0
/* 804DAF0C 004A44CC  38 85 29 08 */	addi r4, r5, lbl_80662908@l
/* 804DAF10 004A44D0  38 00 00 01 */	li r0, 1
/* 804DAF14 004A44D4  98 C5 29 08 */	stb r6, 0x2908(r5)
...
/* 804DAF38 004A44F8  4C C6 31 82 */	crclr 6
/* 804DAF3C 004A44FC  4B B6 90 7D */	bl func_80043FB8
/* 804DAF40 004A4500  38 7F 29 08 */	addi r3, r31, 0x2908
...
.global ctor_804DAF58
ctor_804DAF58:
/* 804DAF58 004A4518  38 6D C1 38 */	addi r3, r13, lbl_806682B8@sda21
/* 804DAF5C 004A451C  48 00 00 04 */	b lbl_804DAF60
lbl_804DAF60:
/* 804DAF60 004A4520  3C 80 80 57 */	lis r4, lbl_805735B0@ha
/* 804DAF64 004A4524  38 84 35 B0 */	addi r4, r4, lbl_805735B0@l
