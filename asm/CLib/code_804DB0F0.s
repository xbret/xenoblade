...
/* 804DB17C 004A473C  40 80 00 0C */	bge lbl_804DB188
/* 804DB180 004A4740  38 60 00 02 */	li r3, 2
/* 804DB184 004A4744  48 00 00 90 */	b lbl_804DB214
lbl_804DB188:
/* 804DB188 004A4748  7C C0 07 75 */	extsb. r0, r6
/* 804DB18C 004A474C  41 82 00 20 */	beq lbl_804DB1AC
/* 804DB190 004A4750  2C 00 00 01 */	cmpwi r0, 1
/* 804DB194 004A4754  41 82 00 40 */	beq lbl_804DB1D4
/* 804DB198 004A4758  2C 00 00 02 */	cmpwi r0, 2
/* 804DB19C 004A475C  41 82 00 60 */	beq lbl_804DB1FC
/* 804DB1A0 004A4760  2C 00 00 03 */	cmpwi r0, 3
/* 804DB1A4 004A4764  41 82 00 64 */	beq lbl_804DB208
/* 804DB1A8 004A4768  48 00 00 68 */	b lbl_804DB210
lbl_804DB1AC:
...
/* 804DB1BC 004A477C  41 82 00 0C */	beq lbl_804DB1C8
/* 804DB1C0 004A4780  38 60 00 02 */	li r3, 2
/* 804DB1C4 004A4784  48 00 00 50 */	b lbl_804DB214
lbl_804DB1C8:
/* 804DB1C8 004A4788  38 00 00 01 */	li r0, 1
/* 804DB1CC 004A478C  98 1F 00 0C */	stb r0, 0xc(r31)
/* 804DB1D0 004A4790  48 00 00 40 */	b lbl_804DB210
lbl_804DB1D4:
...
.global ctor_804DB228
ctor_804DB228:
/* 804DB228 004A47E8  38 6D C1 48 */	addi r3, r13, lbl_806682C8@sda21
/* 804DB22C 004A47EC  48 00 00 04 */	b lbl_804DB230
lbl_804DB230:
/* 804DB230 004A47F0  3C 80 80 57 */	lis r4, lbl_805735F0@ha
/* 804DB234 004A47F4  38 84 35 F0 */	addi r4, r4, lbl_805735F0@l
