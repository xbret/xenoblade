...
/* 8037C000 003455C0  3F C0 80 5E */	lis r30, lbl_805E1280@ha
/* 8037C004 003455C4  3B DE 12 80 */	addi r30, r30, lbl_805E1280@l
...
/* 8037C014 003455D4  41 81 05 2C */	bgt lbl_8037C540
...
/* 8037C048 00345608  48 00 04 F8 */	b lbl_8037C540
.global lbl_8037C04C
lbl_8037C04C:
...
/* 8037C058 00345618  48 00 04 E8 */	b lbl_8037C540
.global lbl_8037C05C
lbl_8037C05C:
...
/* 8037C098 00345658  40 82 01 3C */	bne lbl_8037C1D4
...
/* 8037C0B8 00345678  41 82 00 10 */	beq lbl_8037C0C8
...
/* 8037C0D0 00345690  41 82 00 10 */	beq lbl_8037C0E0
/* 8037C0D4 00345694  2C 00 00 02 */	cmpwi r0, 2
/* 8037C0D8 00345698  41 82 00 14 */	beq lbl_8037C0EC
/* 8037C0DC 0034569C  48 00 00 18 */	b lbl_8037C0F4
lbl_8037C0E0:
/* 8037C0E0 003456A0  38 00 00 12 */	li r0, 0x12
/* 8037C0E4 003456A4  98 1E 00 0C */	stb r0, 0xc(r30)
/* 8037C0E8 003456A8  48 00 00 0C */	b lbl_8037C0F4
lbl_8037C0EC:
...
/* 8037C120 003456E0  40 82 00 0C */	bne lbl_8037C12C
...
/* 8037C158 00345718  41 82 00 0C */	beq lbl_8037C164
/* 8037C15C 0034571C  28 00 00 01 */	cmplwi r0, 1
/* 8037C160 00345720  40 82 00 10 */	bne lbl_8037C170
lbl_8037C164:
/* 8037C164 00345724  7F 83 E3 78 */	mr r3, r28
/* 8037C168 00345728  4B FF E2 79 */	bl WUDiMoveTopSmpDevInfoPtr
/* 8037C16C 0034572C  48 00 00 3C */	b lbl_8037C1A8
lbl_8037C170:
/* 8037C170 00345730  4B FF 9A 71 */	bl func_80375BE0
/* 8037C174 00345734  2C 03 00 00 */	cmpwi r3, 0
/* 8037C178 00345738  41 82 00 28 */	beq lbl_8037C1A0
/* 8037C17C 0034573C  4B FF 9A 65 */	bl func_80375BE0
/* 8037C180 00345740  2C 03 00 00 */	cmpwi r3, 0
/* 8037C184 00345744  41 82 00 24 */	beq lbl_8037C1A8
...
/* 8037C19C 0034575C  40 82 00 0C */	bne lbl_8037C1A8
lbl_8037C1A0:
...
/* 8037C1BC 0034577C  41 82 03 84 */	beq lbl_8037C540
...
/* 8037C1D0 00345790  48 00 03 70 */	b lbl_8037C540
lbl_8037C1D4:
...
/* 8037C1E8 003457A8  41 82 00 6C */	beq lbl_8037C254
...
/* 8037C208 003457C8  40 82 03 38 */	bne lbl_8037C540
/* 8037C20C 003457CC  88 1F 00 59 */	lbz r0, 0x59(r31)
/* 8037C210 003457D0  28 00 00 02 */	cmplwi r0, 2
/* 8037C214 003457D4  40 82 03 2C */	bne lbl_8037C540
...
/* 8037C224 003457E4  41 82 00 24 */	beq lbl_8037C248
/* 8037C228 003457E8  88 1D 00 06 */	lbz r0, 6(r29)
/* 8037C22C 003457EC  28 00 00 0C */	cmplwi r0, 0xc
/* 8037C230 003457F0  40 82 00 18 */	bne lbl_8037C248
...
/* 8037C250 00345810  48 00 02 F0 */	b lbl_8037C540
lbl_8037C254:
...
/* 8037C260 00345820  41 82 02 E0 */	beq lbl_8037C540
/* 8037C264 00345824  88 1D 00 06 */	lbz r0, 6(r29)
/* 8037C268 00345828  28 00 00 0C */	cmplwi r0, 0xc
/* 8037C26C 0034582C  40 82 02 D4 */	bne lbl_8037C540
...
/* 8037C27C 0034583C  41 82 00 24 */	beq lbl_8037C2A0
/* 8037C280 00345840  88 03 00 5B */	lbz r0, 0x5b(r3)
/* 8037C284 00345844  28 00 00 03 */	cmplwi r0, 3
/* 8037C288 00345848  41 82 00 0C */	beq lbl_8037C294
/* 8037C28C 0034584C  28 00 00 01 */	cmplwi r0, 1
/* 8037C290 00345850  40 82 00 0C */	bne lbl_8037C29C
lbl_8037C294:
/* 8037C294 00345854  4B FF E2 6D */	bl func_8037A500
/* 8037C298 00345858  48 00 00 08 */	b lbl_8037C2A0
lbl_8037C29C:
/* 8037C29C 0034585C  4B FF E6 15 */	bl func_8037A8B0
lbl_8037C2A0:
...
/* 8037C2B4 00345874  48 00 02 8C */	b lbl_8037C540
.global lbl_8037C2B8
lbl_8037C2B8:
...
/* 8037C2F8 003458B8  41 82 00 5C */	beq lbl_8037C354
/* 8037C2FC 003458BC  88 03 00 5B */	lbz r0, 0x5b(r3)
/* 8037C300 003458C0  28 00 00 03 */	cmplwi r0, 3
/* 8037C304 003458C4  41 82 00 0C */	beq lbl_8037C310
/* 8037C308 003458C8  28 00 00 01 */	cmplwi r0, 1
/* 8037C30C 003458CC  40 82 00 10 */	bne lbl_8037C31C
lbl_8037C310:
/* 8037C310 003458D0  7F 83 E3 78 */	mr r3, r28
/* 8037C314 003458D4  4B FF E3 0D */	bl WUDiMoveTopOfDisconnectedSmpDevice
/* 8037C318 003458D8  48 00 00 3C */	b lbl_8037C354
lbl_8037C31C:
/* 8037C31C 003458DC  4B FF 98 C5 */	bl func_80375BE0
/* 8037C320 003458E0  2C 03 00 00 */	cmpwi r3, 0
/* 8037C324 003458E4  41 82 00 28 */	beq lbl_8037C34C
/* 8037C328 003458E8  4B FF 98 B9 */	bl func_80375BE0
/* 8037C32C 003458EC  2C 03 00 00 */	cmpwi r3, 0
/* 8037C330 003458F0  41 82 00 24 */	beq lbl_8037C354
...
/* 8037C348 00345908  40 82 00 0C */	bne lbl_8037C354
lbl_8037C34C:
...
/* 8037C380 00345940  41 82 01 C0 */	beq lbl_8037C540
...
/* 8037C394 00345954  48 00 01 AC */	b lbl_8037C540
.global lbl_8037C398
lbl_8037C398:
...
/* 8037C408 003459C8  48 00 01 38 */	b lbl_8037C540
.global lbl_8037C40C
lbl_8037C40C:
...
/* 8037C448 00345A08  48 00 00 F8 */	b lbl_8037C540
.global lbl_8037C44C
lbl_8037C44C:
...
/* 8037C468 00345A28  40 80 00 18 */	bge lbl_8037C480
...
/* 8037C488 00345A48  48 00 00 2C */	b lbl_8037C4B4
lbl_8037C48C:
/* 8037C48C 00345A4C  88 7E 00 06 */	lbz r3, 6(r30)
/* 8037C490 00345A50  28 03 00 10 */	cmplwi r3, 0x10
/* 8037C494 00345A54  40 80 00 18 */	bge lbl_8037C4AC
...
/* 8037C4BC 00345A7C  41 80 FF D0 */	blt lbl_8037C48C
/* 8037C4C0 00345A80  48 00 00 80 */	b lbl_8037C540
.global lbl_8037C4C4
lbl_8037C4C4:
...
/* 8037C4D0 00345A90  48 00 00 70 */	b lbl_8037C540
.global lbl_8037C4D4
lbl_8037C4D4:
...
/* 8037C4E0 00345AA0  48 00 00 60 */	b lbl_8037C540
.global lbl_8037C4E4
lbl_8037C4E4:
...
/* 8037C4F0 00345AB0  48 00 00 50 */	b lbl_8037C540
.global lbl_8037C4F4
lbl_8037C4F4:
...
/* 8037C500 00345AC0  48 00 00 40 */	b lbl_8037C540
.global lbl_8037C504
lbl_8037C504:
...
/* 8037C510 00345AD0  48 00 00 30 */	b lbl_8037C540
.global lbl_8037C514
lbl_8037C514:
...
/* 8037C520 00345AE0  48 00 00 20 */	b lbl_8037C540
.global lbl_8037C524
lbl_8037C524:
...
/* 8037C530 00345AF0  48 00 00 10 */	b lbl_8037C540
.global lbl_8037C534
lbl_8037C534:
...
/* 8037C564 00345B24  3C C0 80 5E */	lis r6, lbl_805E1280@ha
/* 8037C568 00345B28  38 C6 12 80 */	addi r6, r6, lbl_805E1280@l
/* 8037C56C 00345B2C  40 82 00 18 */	bne lbl_8037C584
