...
/* 8031B96C 002E4F2C  00 00 00 00 */	.4byte 0x00000000 /* invalid */
...
/* 8031B9AC 002E4F6C  93 C1 00 08 */	stw r30, 0x8(r1)
/* 8031B9B0 002E4F70  7C 7E 1B 78 */	mr r30, r3
/* 8031B9B4 002E4F74  4C 40 13 82 */	cror eq, lt, eq
...
.L_8031B9C8:
/* 8031B9C8 002E4F88  3B E0 00 00 */	li r31, 0x0
.L_8031B9CC:
...
/* 8031BB18 002E50D8  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 8031BB2C 002E50EC  00 00 00 00 */	.4byte 0x00000000 /* invalid */
...
/* 8031BB58 002E5118  4C 41 13 82 */	cror eq, gt, eq
/* 8031BB5C 002E511C  40 82 00 08 */	bne .L_8031BB64
.L_8031BB60:
/* 8031BB60 002E5120  38 80 00 00 */	li r4, 0x0
.L_8031BB64:
/* 8031BB64 002E5124  2C 04 00 01 */	cmpwi r4, 0x1
/* 8031BB68 002E5128  41 82 00 18 */	beq .L_8031BB80
/* 8031BB6C 002E512C  2C 04 00 02 */	cmpwi r4, 0x2
/* 8031BB70 002E5130  41 82 00 28 */	beq .L_8031BB98
/* 8031BB74 002E5134  2C 04 00 03 */	cmpwi r4, 0x3
...
/* 8031BBF4 002E51B4  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 8031BBF8 002E51B8  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 8031BBFC 002E51BC  00 00 00 00 */	.4byte 0x00000000 /* invalid */
...
.fn GXGetLightPos, global
/* 8031BC10 002E51D0  C0 03 00 28 */	lfs f0, 0x28(r3)
/* 8031BC14 002E51D4  D0 04 00 00 */	stfs f0, 0x0(r4)
/* 8031BC18 002E51D8  C0 03 00 2C */	lfs f0, 0x2c(r3)
/* 8031BC1C 002E51DC  D0 05 00 00 */	stfs f0, 0x0(r5)
/* 8031BC20 002E51E0  C0 03 00 30 */	lfs f0, 0x30(r3)
/* 8031BC24 002E51E4  D0 06 00 00 */	stfs f0, 0x0(r6)
/* 8031BC28 002E51E8  4E 80 00 20 */	blr
.endfn GXGetLightPos
/* 8031BC2C 002E51EC  00 00 00 00 */	.4byte 0x00000000 /* invalid */
...
/* 8031BC4C 002E520C  00 00 00 00 */	.4byte 0x00000000 /* invalid */

.fn GXGetLightDir, global
...
/* 8031BC64 002E5224  D0 44 00 00 */	stfs f2, 0x0(r4)
/* 8031BC68 002E5228  FC 00 00 50 */	fneg f0, f0
/* 8031BC6C 002E522C  D0 25 00 00 */	stfs f1, 0x0(r5)
/* 8031BC70 002E5230  D0 06 00 00 */	stfs f0, 0x0(r6)
/* 8031BC74 002E5234  4E 80 00 20 */	blr
.endfn GXGetLightDir
/* 8031BC78 002E5238  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 8031BC7C 002E523C  00 00 00 00 */	.4byte 0x00000000 /* invalid */
...
/* 8031BC9C 002E525C  F3 E1 00 68 */	psq_st f31, 0x68(r1), 0, qr0
...
/* 8031BCAC 002E526C  F3 C1 00 58 */	psq_st f30, 0x58(r1), 0, qr0
/* 8031BCB0 002E5270  FF C0 10 50 */	fneg f30, f2
/* 8031BCB4 002E5274  DB A1 00 40 */	stfd f29, 0x40(r1)
/* 8031BCB8 002E5278  F3 A1 00 48 */	psq_st f29, 0x48(r1), 0, qr0
...
/* 8031BD48 002E5308  E3 E1 00 68 */	psq_l f31, 0x68(r1), 0, qr0
/* 8031BD4C 002E530C  CB E1 00 60 */	lfd f31, 0x60(r1)
/* 8031BD50 002E5310  E3 C1 00 58 */	psq_l f30, 0x58(r1), 0, qr0
/* 8031BD54 002E5314  CB C1 00 50 */	lfd f30, 0x50(r1)
/* 8031BD58 002E5318  E3 A1 00 48 */	psq_l f29, 0x48(r1), 0, qr0
/* 8031BD5C 002E531C  CB A1 00 40 */	lfd f29, 0x40(r1)
/* 8031BD60 002E5320  E3 81 00 38 */	psq_l f28, 0x38(r1), 0, qr0
/* 8031BD64 002E5324  CB 81 00 30 */	lfd f28, 0x30(r1)
/* 8031BD68 002E5328  E3 61 00 28 */	psq_l f27, 0x28(r1), 0, qr0
/* 8031BD6C 002E532C  CB 61 00 20 */	lfd f27, 0x20(r1)
/* 8031BD70 002E5330  E3 41 00 18 */	psq_l f26, 0x18(r1), 0, qr0
...
/* 8031BDD0 002E5390  E0 A3 00 10 */	psq_l f5, 0x10(r3), 0, qr0
/* 8031BDD4 002E5394  E0 83 00 18 */	psq_l f4, 0x18(r3), 0, qr0
/* 8031BDD8 002E5398  E0 63 00 20 */	psq_l f3, 0x20(r3), 0, qr0
/* 8031BDDC 002E539C  E0 43 00 28 */	psq_l f2, 0x28(r3), 0, qr0
/* 8031BDE0 002E53A0  E0 23 00 30 */	psq_l f1, 0x30(r3), 0, qr0
/* 8031BDE4 002E53A4  E0 03 00 38 */	psq_l f0, 0x38(r3), 0, qr0
...
/* 8031BDF8 002E53B8  F0 A5 00 00 */	psq_st f5, 0x0(r5), 0, qr0
/* 8031BDFC 002E53BC  F0 85 00 00 */	psq_st f4, 0x0(r5), 0, qr0
/* 8031BE00 002E53C0  F0 65 00 00 */	psq_st f3, 0x0(r5), 0, qr0
/* 8031BE04 002E53C4  F0 45 00 00 */	psq_st f2, 0x0(r5), 0, qr0
/* 8031BE08 002E53C8  F0 25 00 00 */	psq_st f1, 0x0(r5), 0, qr0
/* 8031BE0C 002E53CC  F0 05 00 00 */	psq_st f0, 0x0(r5), 0, qr0
/* 8031BE10 002E53D0  38 00 00 01 */	li r0, 0x1
/* 8031BE14 002E53D4  80 62 BC 20 */	lwz r3, lbl_8066BFA0@sda21(r2)
/* 8031BE18 002E53D8  B0 03 00 02 */	sth r0, 0x2(r3)
/* 8031BE1C 002E53DC  4E 80 00 20 */	blr
.endfn GXLoadLightObjImm

.fn GXSetChanAmbColor, global
/* 8031BE20 002E53E0  2C 03 00 00 */	cmpwi r3, 0x0
/* 8031BE24 002E53E4  41 82 00 30 */	beq .L_8031BE54
/* 8031BE28 002E53E8  2C 03 00 01 */	cmpwi r3, 0x1
/* 8031BE2C 002E53EC  41 82 00 40 */	beq .L_8031BE6C
/* 8031BE30 002E53F0  2C 03 00 02 */	cmpwi r3, 0x2
/* 8031BE34 002E53F4  41 82 00 50 */	beq .L_8031BE84
/* 8031BE38 002E53F8  2C 03 00 03 */	cmpwi r3, 0x3
/* 8031BE3C 002E53FC  41 82 00 60 */	beq .L_8031BE9C
/* 8031BE40 002E5400  2C 03 00 04 */	cmpwi r3, 0x4
/* 8031BE44 002E5404  41 82 00 70 */	beq .L_8031BEB4
/* 8031BE48 002E5408  2C 03 00 05 */	cmpwi r3, 0x5
...
/* 8031BE58 002E5418  39 00 00 00 */	li r8, 0x0
/* 8031BE5C 002E541C  80 04 00 00 */	lwz r0, 0x0(r4)
/* 8031BE60 002E5420  80 E3 00 A8 */	lwz r7, 0xa8(r3)
/* 8031BE64 002E5424  50 07 00 2E */	rlwimi r7, r0, 0, 0, 23
/* 8031BE68 002E5428  48 00 00 68 */	b .L_8031BED0
.L_8031BE6C:
/* 8031BE6C 002E542C  80 62 BC 20 */	lwz r3, lbl_8066BFA0@sda21(r2)
/* 8031BE70 002E5430  39 00 00 01 */	li r8, 0x1
/* 8031BE74 002E5434  80 04 00 00 */	lwz r0, 0x0(r4)
/* 8031BE78 002E5438  80 E3 00 AC */	lwz r7, 0xac(r3)
/* 8031BE7C 002E543C  50 07 00 2E */	rlwimi r7, r0, 0, 0, 23
/* 8031BE80 002E5440  48 00 00 50 */	b .L_8031BED0
.L_8031BE84:
/* 8031BE84 002E5444  80 62 BC 20 */	lwz r3, lbl_8066BFA0@sda21(r2)
/* 8031BE88 002E5448  39 00 00 00 */	li r8, 0x0
/* 8031BE8C 002E544C  88 04 00 03 */	lbz r0, 0x3(r4)
/* 8031BE90 002E5450  80 E3 00 A8 */	lwz r7, 0xa8(r3)
/* 8031BE94 002E5454  50 07 06 3E */	rlwimi r7, r0, 0, 24, 31
/* 8031BE98 002E5458  48 00 00 38 */	b .L_8031BED0
.L_8031BE9C:
/* 8031BE9C 002E545C  80 62 BC 20 */	lwz r3, lbl_8066BFA0@sda21(r2)
/* 8031BEA0 002E5460  39 00 00 01 */	li r8, 0x1
/* 8031BEA4 002E5464  88 04 00 03 */	lbz r0, 0x3(r4)
/* 8031BEA8 002E5468  80 E3 00 AC */	lwz r7, 0xac(r3)
/* 8031BEAC 002E546C  50 07 06 3E */	rlwimi r7, r0, 0, 24, 31
/* 8031BEB0 002E5470  48 00 00 20 */	b .L_8031BED0
.L_8031BEB4:
/* 8031BEB4 002E5474  80 E4 00 00 */	lwz r7, 0x0(r4)
/* 8031BEB8 002E5478  39 00 00 00 */	li r8, 0x0
/* 8031BEBC 002E547C  48 00 00 14 */	b .L_8031BED0
.L_8031BEC0:
/* 8031BEC0 002E5480  80 E4 00 00 */	lwz r7, 0x0(r4)
/* 8031BEC4 002E5484  39 00 00 01 */	li r8, 0x1
...
/* 8031BEF8 002E54B8  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 8031BEFC 002E54BC  00 00 00 00 */	.4byte 0x00000000 /* invalid */

.fn GXSetChanMatColor, global
/* 8031BF00 002E54C0  2C 03 00 00 */	cmpwi r3, 0x0
/* 8031BF04 002E54C4  41 82 00 30 */	beq .L_8031BF34
/* 8031BF08 002E54C8  2C 03 00 01 */	cmpwi r3, 0x1
/* 8031BF0C 002E54CC  41 82 00 40 */	beq .L_8031BF4C
/* 8031BF10 002E54D0  2C 03 00 02 */	cmpwi r3, 0x2
/* 8031BF14 002E54D4  41 82 00 50 */	beq .L_8031BF64
/* 8031BF18 002E54D8  2C 03 00 03 */	cmpwi r3, 0x3
/* 8031BF1C 002E54DC  41 82 00 60 */	beq .L_8031BF7C
/* 8031BF20 002E54E0  2C 03 00 04 */	cmpwi r3, 0x4
/* 8031BF24 002E54E4  41 82 00 70 */	beq .L_8031BF94
/* 8031BF28 002E54E8  2C 03 00 05 */	cmpwi r3, 0x5
...
/* 8031BF38 002E54F8  39 00 00 00 */	li r8, 0x0
/* 8031BF3C 002E54FC  80 04 00 00 */	lwz r0, 0x0(r4)
/* 8031BF40 002E5500  80 E3 00 B0 */	lwz r7, 0xb0(r3)
/* 8031BF44 002E5504  50 07 00 2E */	rlwimi r7, r0, 0, 0, 23
/* 8031BF48 002E5508  48 00 00 68 */	b .L_8031BFB0
.L_8031BF4C:
/* 8031BF4C 002E550C  80 62 BC 20 */	lwz r3, lbl_8066BFA0@sda21(r2)
/* 8031BF50 002E5510  39 00 00 01 */	li r8, 0x1
/* 8031BF54 002E5514  80 04 00 00 */	lwz r0, 0x0(r4)
/* 8031BF58 002E5518  80 E3 00 B4 */	lwz r7, 0xb4(r3)
/* 8031BF5C 002E551C  50 07 00 2E */	rlwimi r7, r0, 0, 0, 23
/* 8031BF60 002E5520  48 00 00 50 */	b .L_8031BFB0
.L_8031BF64:
/* 8031BF64 002E5524  80 62 BC 20 */	lwz r3, lbl_8066BFA0@sda21(r2)
/* 8031BF68 002E5528  39 00 00 00 */	li r8, 0x0
/* 8031BF6C 002E552C  88 04 00 03 */	lbz r0, 0x3(r4)
/* 8031BF70 002E5530  80 E3 00 B0 */	lwz r7, 0xb0(r3)
/* 8031BF74 002E5534  50 07 06 3E */	rlwimi r7, r0, 0, 24, 31
/* 8031BF78 002E5538  48 00 00 38 */	b .L_8031BFB0
.L_8031BF7C:
/* 8031BF7C 002E553C  80 62 BC 20 */	lwz r3, lbl_8066BFA0@sda21(r2)
/* 8031BF80 002E5540  39 00 00 01 */	li r8, 0x1
/* 8031BF84 002E5544  88 04 00 03 */	lbz r0, 0x3(r4)
/* 8031BF88 002E5548  80 E3 00 B4 */	lwz r7, 0xb4(r3)
/* 8031BF8C 002E554C  50 07 06 3E */	rlwimi r7, r0, 0, 24, 31
/* 8031BF90 002E5550  48 00 00 20 */	b .L_8031BFB0
.L_8031BF94:
/* 8031BF94 002E5554  80 E4 00 00 */	lwz r7, 0x0(r4)
/* 8031BF98 002E5558  39 00 00 00 */	li r8, 0x0
/* 8031BF9C 002E555C  48 00 00 14 */	b .L_8031BFB0
.L_8031BFA0:
/* 8031BFA0 002E5560  80 E4 00 00 */	lwz r7, 0x0(r4)
/* 8031BFA4 002E5564  39 00 00 01 */	li r8, 0x1
...
/* 8031BFD8 002E5598  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 8031BFDC 002E559C  00 00 00 00 */	.4byte 0x00000000 /* invalid */
...
/* 8031BFE8 002E55A8  50 60 26 76 */	rlwimi r0, r3, 4, 25, 27
...
/* 8031BFF8 002E55B8  60 00 00 04 */	ori r0, r0, 0x4
/* 8031BFFC 002E55BC  90 04 05 FC */	stw r0, 0x5fc(r4)
/* 8031C000 002E55C0  4E 80 00 20 */	blr
.endfn GXSetNumChans
/* 8031C004 002E55C4  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 8031C008 002E55C8  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 8031C00C 002E55CC  00 00 00 00 */	.4byte 0x00000000 /* invalid */

.fn GXSetChanCtrl, global
/* 8031C010 002E55D0  2C 09 00 00 */	cmpwi r9, 0x0
/* 8031C014 002E55D4  39 40 00 00 */	li r10, 0x0
/* 8031C018 002E55D8  50 8A 0F BC */	rlwimi r10, r4, 1, 30, 30
/* 8031C01C 002E55DC  54 6B 07 BE */	clrlwi r11, r3, 30
/* 8031C020 002E55E0  50 CA 07 FE */	rlwimi r10, r6, 0, 31, 31
/* 8031C024 002E55E4  50 AA 36 72 */	rlwimi r10, r5, 6, 25, 25
/* 8031C028 002E55E8  40 82 00 08 */	bne .L_8031C030
/* 8031C02C 002E55EC  39 00 00 00 */	li r8, 0x0
.L_8031C030:
/* 8031C030 002E55F0  20 A9 00 02 */	subfic r5, r9, 0x2
/* 8031C034 002E55F4  38 89 FF FE */	addi r4, r9, -0x2
...
/* 8031C044 002E5604  51 0A 3D F0 */	rlwimi r10, r8, 7, 23, 24
/* 8031C048 002E5608  50 8A 55 AC */	rlwimi r10, r4, 10, 22, 22
/* 8031C04C 002E560C  55 64 10 3A */	slwi r4, r11, 2
/* 8031C050 002E5610  7C 00 4B 78 */	or r0, r0, r9
/* 8031C054 002E5614  2C 03 00 04 */	cmpwi r3, 0x4
/* 8031C058 002E5618  50 0A 5D 6A */	rlwimi r10, r0, 11, 21, 21
/* 8031C05C 002E561C  7C 85 22 14 */	add r4, r5, r4
/* 8031C060 002E5620  50 EA 16 BA */	rlwimi r10, r7, 2, 26, 29
/* 8031C064 002E5624  38 00 10 00 */	li r0, 0x1000
/* 8031C068 002E5628  50 EA 3C 68 */	rlwimi r10, r7, 7, 17, 20
...
.L_8031C098:
/* 8031C098 002E5658  2C 03 00 05 */	cmpwi r3, 0x5
...
.endfn GXSetChanCtrl
/* 8031C0B4 002E5674  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 8031C0B8 002E5678  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 8031C0BC 002E567C  00 00 00 00 */	.4byte 0x00000000 /* invalid */
