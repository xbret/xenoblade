...
/* 8031A774 002E3D34  93 C1 00 08 */	stw r30, 0x8(r1)
/* 8031A778 002E3D38  83 DF 05 FC */	lwz r30, 0x5fc(r31)
/* 8031A77C 002E3D3C  57 C0 07 FF */	clrlwi. r0, r30, 31
/* 8031A780 002E3D40  41 82 00 08 */	beq .L_8031A788
/* 8031A784 002E3D44  48 00 25 1D */	bl __GXSetSUTexRegs
.L_8031A788:
/* 8031A788 002E3D48  57 C0 07 BD */	rlwinm. r0, r30, 0, 30, 30
/* 8031A78C 002E3D4C  41 82 00 08 */	beq .L_8031A794
/* 8031A790 002E3D50  48 00 2E 21 */	bl __GXUpdateBPMask
.L_8031A794:
/* 8031A794 002E3D54  57 C0 07 7B */	rlwinm. r0, r30, 0, 29, 29
/* 8031A798 002E3D58  41 82 00 24 */	beq .L_8031A7BC
/* 8031A79C 002E3D5C  3C 80 CC 01 */	lis r4, 0xcc01
/* 8031A7A0 002E3D60  38 00 00 61 */	li r0, 0x61
/* 8031A7A4 002E3D64  98 04 80 00 */	stb r0, -0x8000(r4)
/* 8031A7A8 002E3D68  38 00 00 00 */	li r0, 0x0
...
.L_8031A814:
/* 8031A814 002E3DD4  54 80 05 AD */	rlwinm. r0, r4, 0, 22, 22
/* 8031A818 002E3DD8  41 82 00 20 */	beq .L_8031A838
/* 8031A81C 002E3DDC  3C 60 CC 01 */	lis r3, 0xcc01
/* 8031A820 002E3DE0  38 00 00 10 */	li r0, 0x10
/* 8031A824 002E3DE4  98 03 80 00 */	stb r0, -0x8000(r3)
...
.L_8031A838:
/* 8031A838 002E3DF8  54 80 05 6B */	rlwinm. r0, r4, 0, 21, 21
/* 8031A83C 002E3DFC  41 82 00 20 */	beq .L_8031A85C
/* 8031A840 002E3E00  3C 60 CC 01 */	lis r3, 0xcc01
/* 8031A844 002E3E04  38 00 00 10 */	li r0, 0x10
/* 8031A848 002E3E08  98 03 80 00 */	stb r0, -0x8000(r3)
...
.L_8031A85C:
/* 8031A85C 002E3E1C  54 80 05 29 */	rlwinm. r0, r4, 0, 20, 20
/* 8031A860 002E3E20  41 82 00 20 */	beq .L_8031A880
/* 8031A864 002E3E24  3C 60 CC 01 */	lis r3, 0xcc01
/* 8031A868 002E3E28  38 00 00 10 */	li r0, 0x10
/* 8031A86C 002E3E2C  98 03 80 00 */	stb r0, -0x8000(r3)
...
/* 8031A884 002E3E44  53 C7 04 27 */	rlwimi. r7, r30, 0, 16, 19
...
/* 8031A89C 002E3E5C  3C 60 CC 01 */	lis r3, 0xcc01
/* 8031A8A0 002E3E60  38 80 00 10 */	li r4, 0x10
/* 8031A8A4 002E3E64  38 00 10 09 */	li r0, 0x1009
/* 8031A8A8 002E3E68  98 83 80 00 */	stb r4, -0x8000(r3)
/* 8031A8AC 002E3E6C  54 A4 E7 7E */	extrwi r4, r5, 3, 25
...
/* 8031A8BC 002E3E7C  54 E7 A7 3E */	extrwi r7, r7, 4, 16
...
.L_8031A8D0:
/* 8031A8D0 002E3E90  54 E0 07 FF */	clrlwi. r0, r7, 31
...
/* 8031A8EC 002E3EAC  38 A5 00 04 */	addi r5, r5, 0x4
/* 8031A8F0 002E3EB0  38 C6 00 01 */	addi r6, r6, 0x1
.L_8031A8F4:
/* 8031A8F4 002E3EB4  2C 07 00 00 */	cmpwi r7, 0x0
...
/* 8031A914 002E3ED4  3C 60 CC 01 */	lis r3, 0xcc01
/* 8031A918 002E3ED8  38 80 00 10 */	li r4, 0x10
/* 8031A91C 002E3EDC  38 00 10 3F */	li r0, 0x103f
/* 8031A920 002E3EE0  98 83 80 00 */	stb r4, -0x8000(r3)
/* 8031A924 002E3EE4  54 A4 07 3E */	clrlwi r4, r5, 28
...
/* 8031A934 002E3EF4  55 08 86 3E */	extrwi r8, r8, 8, 8
...
.L_8031A948:
/* 8031A948 002E3F08  55 00 07 FF */	clrlwi. r0, r8, 31
...
/* 8031A978 002E3F38  38 C6 00 01 */	addi r6, r6, 0x1
/* 8031A97C 002E3F3C  38 E7 00 04 */	addi r7, r7, 0x4
.L_8031A980:
/* 8031A980 002E3F40  2C 08 00 00 */	cmpwi r8, 0x0
...
/* 8031A990 002E3F50  38 60 00 00 */	li r3, 0x0
/* 8031A994 002E3F54  48 00 40 4D */	bl __GXSetMatrixIndex
/* 8031A998 002E3F58  38 60 00 05 */	li r3, 0x5
...
.L_8031A9B8:
/* 8031A9B8 002E3F78  38 00 00 01 */	li r0, 0x1
/* 8031A9BC 002E3F7C  B0 1F 00 02 */	sth r0, 0x2(r31)
.L_8031A9C0:
/* 8031A9C0 002E3F80  38 00 00 00 */	li r0, 0x0
/* 8031A9C4 002E3F84  90 1F 05 FC */	stw r0, 0x5fc(r31)
/* 8031A9C8 002E3F88  83 E1 00 0C */	lwz r31, 0xc(r1)
/* 8031A9CC 002E3F8C  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 8031AA10 002E3FD0  2C 00 00 00 */	cmpwi r0, 0x0
/* 8031AA14 002E3FD4  41 82 00 08 */	beq .L_8031AA1C
/* 8031AA18 002E3FD8  4B FF FD 49 */	bl __GXSetDirtyState
.L_8031AA1C:
/* 8031AA1C 002E3FDC  80 1F 00 00 */	lwz r0, 0x0(r31)
/* 8031AA20 002E3FE0  2C 00 00 00 */	cmpwi r0, 0x0
/* 8031AA24 002E3FE4  40 82 00 D8 */	bne .L_8031AAFC
/* 8031AA28 002E3FE8  80 E2 BC 20 */	lwz r7, lbl_8066BFA0@sda21(r2)
/* 8031AA2C 002E3FEC  3C 60 CC 01 */	lis r3, 0xcc01
/* 8031AA30 002E3FF0  38 00 00 98 */	li r0, 0x98
/* 8031AA34 002E3FF4  38 C0 00 00 */	li r6, 0x0
/* 8031AA38 002E3FF8  A0 A7 00 04 */	lhz r5, 0x4(r7)
/* 8031AA3C 002E3FFC  A0 87 00 06 */	lhz r4, 0x6(r7)
/* 8031AA40 002E4000  7C A5 21 D7 */	mullw. r5, r5, r4
/* 8031AA44 002E4004  98 03 80 00 */	stb r0, -0x8000(r3)
/* 8031AA48 002E4008  A0 07 00 04 */	lhz r0, 0x4(r7)
/* 8031AA4C 002E400C  B0 03 80 00 */	sth r0, -0x8000(r3)
/* 8031AA50 002E4010  41 82 00 A4 */	beq .L_8031AAF4
/* 8031AA54 002E4014  38 65 00 03 */	addi r3, r5, 0x3
/* 8031AA58 002E4018  38 E5 FF E0 */	addi r7, r5, -0x20
/* 8031AA5C 002E401C  54 60 F0 BE */	srwi r0, r3, 2
/* 8031AA60 002E4020  28 00 00 08 */	cmplwi r0, 0x8
/* 8031AA64 002E4024  40 81 00 68 */	ble .L_8031AACC
/* 8031AA68 002E4028  28 03 00 03 */	cmplwi r3, 0x3
/* 8031AA6C 002E402C  38 00 00 00 */	li r0, 0x0
...
/* 8031AA7C 002E403C  38 00 00 01 */	li r0, 0x1
.L_8031AA80:
/* 8031AA80 002E4040  2C 00 00 00 */	cmpwi r0, 0x0
/* 8031AA84 002E4044  41 82 00 48 */	beq .L_8031AACC
/* 8031AA88 002E4048  38 07 00 1F */	addi r0, r7, 0x1f
/* 8031AA8C 002E404C  38 80 00 00 */	li r4, 0x0
...
/* 8031AA9C 002E405C  28 07 00 00 */	cmplwi r7, 0x0
...
.L_8031AACC:
/* 8031AACC 002E408C  38 05 00 03 */	addi r0, r5, 0x3
/* 8031AAD0 002E4090  38 80 00 00 */	li r4, 0x0
...
.L_8031AAF4:
/* 8031AAF4 002E40B4  38 00 00 01 */	li r0, 0x1
/* 8031AAF8 002E40B8  B0 1F 00 02 */	sth r0, 0x2(r31)
.L_8031AAFC:
/* 8031AAFC 002E40BC  3C 60 CC 01 */	lis r3, 0xcc01
/* 8031AB00 002E40C0  7F A0 E3 78 */	or r0, r29, r28
/* 8031AB04 002E40C4  98 03 80 00 */	stb r0, -0x8000(r3)
...
.endfn GXBegin
/* 8031AB2C 002E40EC  00 00 00 00 */	.4byte 0x00000000 /* invalid */

.fn __GXSendFlushPrim, global
/* 8031AB30 002E40F0  80 C2 BC 20 */	lwz r6, lbl_8066BFA0@sda21(r2)
/* 8031AB34 002E40F4  3C 60 CC 01 */	lis r3, 0xcc01
/* 8031AB38 002E40F8  38 00 00 98 */	li r0, 0x98
/* 8031AB3C 002E40FC  38 E0 00 00 */	li r7, 0x0
/* 8031AB40 002E4100  A0 A6 00 04 */	lhz r5, 0x4(r6)
/* 8031AB44 002E4104  A0 86 00 06 */	lhz r4, 0x6(r6)
/* 8031AB48 002E4108  7D 05 21 D7 */	mullw. r8, r5, r4
/* 8031AB4C 002E410C  98 03 80 00 */	stb r0, -0x8000(r3)
/* 8031AB50 002E4110  A0 06 00 04 */	lhz r0, 0x4(r6)
/* 8031AB54 002E4114  B0 03 80 00 */	sth r0, -0x8000(r3)
/* 8031AB58 002E4118  41 82 00 A4 */	beq .L_8031ABFC
/* 8031AB5C 002E411C  38 68 00 03 */	addi r3, r8, 0x3
/* 8031AB60 002E4120  38 A8 FF E0 */	addi r5, r8, -0x20
/* 8031AB64 002E4124  54 60 F0 BE */	srwi r0, r3, 2
/* 8031AB68 002E4128  28 00 00 08 */	cmplwi r0, 0x8
/* 8031AB6C 002E412C  40 81 00 68 */	ble .L_8031ABD4
/* 8031AB70 002E4130  28 03 00 03 */	cmplwi r3, 0x3
/* 8031AB74 002E4134  38 00 00 00 */	li r0, 0x0
...
/* 8031AB84 002E4144  38 00 00 01 */	li r0, 0x1
.L_8031AB88:
/* 8031AB88 002E4148  2C 00 00 00 */	cmpwi r0, 0x0
/* 8031AB8C 002E414C  41 82 00 48 */	beq .L_8031ABD4
/* 8031AB90 002E4150  38 05 00 1F */	addi r0, r5, 0x1f
/* 8031AB94 002E4154  38 80 00 00 */	li r4, 0x0
...
/* 8031ABA4 002E4164  28 05 00 00 */	cmplwi r5, 0x0
...
.L_8031ABD4:
/* 8031ABD4 002E4194  38 08 00 03 */	addi r0, r8, 0x3
/* 8031ABD8 002E4198  38 80 00 00 */	li r4, 0x0
...
.L_8031ABFC:
/* 8031ABFC 002E41BC  38 00 00 01 */	li r0, 0x1
/* 8031AC00 002E41C0  B0 06 00 02 */	sth r0, 0x2(r6)
/* 8031AC04 002E41C4  4E 80 00 20 */	blr
.endfn __GXSendFlushPrim
/* 8031AC08 002E41C8  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 8031AC0C 002E41CC  00 00 00 00 */	.4byte 0x00000000 /* invalid */

.fn GXSetLineWidth, global
/* 8031AC10 002E41D0  81 02 BC 20 */	lwz r8, lbl_8066BFA0@sda21(r2)
/* 8031AC14 002E41D4  3C A0 CC 01 */	lis r5, 0xcc01
/* 8031AC18 002E41D8  38 C0 00 61 */	li r6, 0x61
/* 8031AC1C 002E41DC  38 00 00 00 */	li r0, 0x0
/* 8031AC20 002E41E0  80 E8 00 7C */	lwz r7, 0x7c(r8)
/* 8031AC24 002E41E4  50 67 06 3E */	rlwimi r7, r3, 0, 24, 31
/* 8031AC28 002E41E8  50 87 83 5E */	rlwimi r7, r4, 16, 13, 15
/* 8031AC2C 002E41EC  90 E8 00 7C */	stw r7, 0x7c(r8)
/* 8031AC30 002E41F0  98 C5 80 00 */	stb r6, -0x8000(r5)
/* 8031AC34 002E41F4  80 68 00 7C */	lwz r3, 0x7c(r8)
/* 8031AC38 002E41F8  90 65 80 00 */	stw r3, -0x8000(r5)
/* 8031AC3C 002E41FC  B0 08 00 02 */	sth r0, 0x2(r8)
/* 8031AC40 002E4200  4E 80 00 20 */	blr
.endfn GXSetLineWidth
/* 8031AC44 002E4204  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 8031AC48 002E4208  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 8031AC4C 002E420C  00 00 00 00 */	.4byte 0x00000000 /* invalid */

.fn GXSetPointSize, global
/* 8031AC50 002E4210  81 02 BC 20 */	lwz r8, lbl_8066BFA0@sda21(r2)
/* 8031AC54 002E4214  3C A0 CC 01 */	lis r5, 0xcc01
/* 8031AC58 002E4218  38 C0 00 61 */	li r6, 0x61
/* 8031AC5C 002E421C  38 00 00 00 */	li r0, 0x0
/* 8031AC60 002E4220  80 E8 00 7C */	lwz r7, 0x7c(r8)
/* 8031AC64 002E4224  50 67 44 2E */	rlwimi r7, r3, 8, 16, 23
/* 8031AC68 002E4228  50 87 9A 98 */	rlwimi r7, r4, 19, 10, 12
/* 8031AC6C 002E422C  90 E8 00 7C */	stw r7, 0x7c(r8)
/* 8031AC70 002E4230  98 C5 80 00 */	stb r6, -0x8000(r5)
/* 8031AC74 002E4234  80 68 00 7C */	lwz r3, 0x7c(r8)
/* 8031AC78 002E4238  90 65 80 00 */	stw r3, -0x8000(r5)
/* 8031AC7C 002E423C  B0 08 00 02 */	sth r0, 0x2(r8)
/* 8031AC80 002E4240  4E 80 00 20 */	blr
.endfn GXSetPointSize
/* 8031AC84 002E4244  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 8031AC88 002E4248  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 8031AC8C 002E424C  00 00 00 00 */	.4byte 0x00000000 /* invalid */
...
/* 8031AD14 002E42D4  50 60 9B 18 */	rlwimi r0, r3, 19, 12, 12
/* 8031AD18 002E42D8  90 07 02 54 */	stw r0, 0x254(r7)
/* 8031AD1C 002E42DC  38 00 00 00 */	li r0, 0x0
/* 8031AD20 002E42E0  98 C5 80 00 */	stb r6, -0x8000(r5)
...
/* 8031AD34 002E42F4  B0 07 00 02 */	sth r0, 0x2(r7)
/* 8031AD38 002E42F8  4E 80 00 20 */	blr
.endfn GXSetCoPlanar
/* 8031AD3C 002E42FC  00 00 00 00 */	.4byte 0x00000000 /* invalid */

.fn __GXSetGenMode, global
/* 8031AD40 002E4300  3C 80 CC 01 */	lis r4, 0xcc01
/* 8031AD44 002E4304  38 00 00 61 */	li r0, 0x61
/* 8031AD48 002E4308  98 04 80 00 */	stb r0, -0x8000(r4)
/* 8031AD4C 002E430C  38 00 00 00 */	li r0, 0x0
...
/* 8031AD5C 002E431C  B0 05 00 02 */	sth r0, 0x2(r5)
/* 8031AD60 002E4320  4E 80 00 20 */	blr
.endfn __GXSetGenMode
/* 8031AD64 002E4324  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 8031AD68 002E4328  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 8031AD6C 002E432C  00 00 00 00 */	.4byte 0x00000000 /* invalid */
