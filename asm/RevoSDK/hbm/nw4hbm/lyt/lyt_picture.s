...
/* 8033276C 002FBD2C  90 7C 00 00 */	stw r3, 0x0(r28)
...
/* 8033277C 002FBD3C  38 C0 00 04 */	li r6, 0x4
/* 80332780 002FBD40  38 E0 00 04 */	li r7, 0x4
...
/* 80332794 002FBD54  3B E0 00 08 */	li r31, 0x8
/* 80332798 002FBD58  28 00 00 08 */	cmplwi r0, 0x8
/* 8033279C 002FBD5C  41 81 00 08 */	bgt .L_803327A4
/* 803327A0 002FBD60  7C 1F 03 78 */	mr r31, r0
.L_803327A4:
/* 803327A4 002FBD64  57 E4 06 3F */	clrlwi. r4, r31, 24
...
/* 803327B8 002FBD78  57 E5 06 3F */	clrlwi. r5, r31, 24
...
/* 803327E0 002FBDA0  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 80332878 002FBE38  93 C1 00 08 */	stw r30, 0x8(r1)
...
/* 80332890 002FBE50  90 83 00 00 */	stw r4, 0x0(r3)
/* 80332894 002FBE54  2C 05 00 00 */	cmpwi r5, 0x0
/* 80332898 002FBE58  41 82 00 40 */	beq .L_803328D8
/* 8033289C 002FBE5C  88 05 00 54 */	lbz r0, 0x54(r5)
/* 803328A0 002FBE60  2C 00 00 00 */	cmpwi r0, 0x0
/* 803328A4 002FBE64  40 82 00 34 */	bne .L_803328D8
/* 803328A8 002FBE68  81 85 00 00 */	lwz r12, 0x0(r5)
/* 803328AC 002FBE6C  7C A3 2B 78 */	mr r3, r5
/* 803328B0 002FBE70  38 80 FF FF */	li r4, -0x1
/* 803328B4 002FBE74  81 8C 00 08 */	lwz r12, 0x8(r12)
...
/* 803328D0 002FBE90  38 00 00 00 */	li r0, 0x0
...
/* 803328EC 002FBEAC  38 A0 00 04 */	li r5, 0x4
/* 803328F0 002FBEB0  38 C0 00 04 */	li r6, 0x4
/* 803328F4 002FBEB4  4B F8 73 05 */	bl __destroy_arr
/* 803328F8 002FBEB8  7F C3 F3 78 */	mr r3, r30
/* 803328FC 002FBEBC  38 80 00 00 */	li r4, 0x0
/* 80332900 002FBEC0  4B FF EF 61 */	bl __dt__Q36nw4hbm3lyt4PaneFv
/* 80332904 002FBEC4  2C 1F 00 00 */	cmpwi r31, 0x0
...
/* 8033291C 002FBEDC  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 803329B0 002FBF70  54 1C 27 3E */	srwi r28, r0, 28
/* 803329B4 002FBF74  54 60 27 3E */	srwi r0, r3, 28
/* 803329B8 002FBF78  7C 1C 00 40 */	cmplw r28, r0
/* 803329BC 002FBF7C  40 80 01 14 */	bge .L_80332AD0
/* 803329C0 002FBF80  54 60 67 3E */	extrwi r0, r3, 4, 8
...
.L_803329D0:
/* 803329D0 002FBF90  38 1C 00 01 */	addi r0, r28, 0x1
/* 803329D4 002FBF94  7C A3 2B 78 */	mr r3, r5
/* 803329D8 002FBF98  54 04 06 3E */	clrlwi r4, r0, 24
...
/* 803329F8 002FBFB8  54 04 27 3E */	srwi r4, r0, 28
/* 803329FC 002FBFBC  4B FF D8 25 */	bl SetTexCoordGenNum__Q36nw4hbm3lyt8MaterialFUc
/* 80332A00 002FBFC0  3B A0 00 00 */	li r29, 0x0
/* 80332A04 002FBFC4  3B C0 00 01 */	li r30, 0x1
/* 80332A08 002FBFC8  38 80 00 04 */	li r4, 0x4
...
/* 80332A18 002FBFD8  9B C1 00 08 */	stb r30, 0x8(r1)
/* 80332A1C 002FBFDC  98 81 00 09 */	stb r4, 0x9(r1)
...
.L_80332A98:
/* 80332A98 002FC058  2C 1D 00 00 */	cmpwi r29, 0x0
...
/* 80332AA8 002FC068  54 00 27 3E */	srwi r0, r0, 28
/* 80332AAC 002FC06C  28 00 00 01 */	cmplwi r0, 0x1
/* 80332AB0 002FC070  40 82 00 20 */	bne .L_80332AD0
/* 80332AB4 002FC074  38 61 00 10 */	addi r3, r1, 0x10
/* 80332AB8 002FC078  38 A0 00 00 */	li r5, 0x0
...
/* 80332B1C 002FC0DC  88 05 00 01 */	lbz r0, 0x1(r5)
/* 80332B20 002FC0E0  98 C4 00 D4 */	stb r6, 0xd4(r4)
/* 80332B24 002FC0E4  88 65 00 02 */	lbz r3, 0x2(r5)
/* 80332B28 002FC0E8  98 04 00 D5 */	stb r0, 0xd5(r4)
/* 80332B2C 002FC0EC  88 05 00 03 */	lbz r0, 0x3(r5)
...
/* 80332B40 002FC100  54 85 00 3A */	clrrwi r5, r4, 2
/* 80332B44 002FC104  54 80 07 BE */	clrlwi r0, r4, 30
...
/* 80332B58 002FC118  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 80332B5C 002FC11C  00 00 00 00 */	.4byte 0x00000000 /* invalid */

# nw4hbm::lyt::Picture::SetVtxColorElement(unsigned long, unsigned char)
.fn SetVtxColorElement__Q36nw4hbm3lyt7PictureFUlUc, global
/* 80332B60 002FC120  54 86 00 3A */	clrrwi r6, r4, 2
/* 80332B64 002FC124  54 80 07 BE */	clrlwi r0, r4, 30
...
/* 80332B78 002FC138  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 80332B7C 002FC13C  00 00 00 00 */	.4byte 0x00000000 /* invalid */
...
/* 80332BA4 002FC164  2C 00 00 00 */	cmpwi r0, 0x0
/* 80332BA8 002FC168  41 82 00 94 */	beq .L_80332C3C
/* 80332BAC 002FC16C  81 83 00 00 */	lwz r12, 0x0(r3)
...
/* 80332BD8 002FC198  81 83 00 00 */	lwz r12, 0x0(r3)
...
/* 80332BF4 002FC1B4  2C 1D 00 00 */	cmpwi r29, 0x0
...
.L_80332C04:
/* 80332C04 002FC1C4  3B C0 00 00 */	li r30, 0x0
.L_80332C08:
...
/* 80332C28 002FC1E8  90 61 00 08 */	stw r3, 0x8(r1)
/* 80332C2C 002FC1EC  38 61 00 08 */	addi r3, r1, 0x8
...
/* 80332C5C 002FC21C  00 00 00 00 */	.4byte 0x00000000 /* invalid */

# nw4hbm::lyt::Picture::GetRuntimeTypeInfo() const
...
/* 80332C6C 002FC22C  00 00 00 00 */	.4byte 0x00000000 /* invalid */
...
/* 80332C84 002FC244  00 00 00 00 */	.4byte 0x00000000 /* invalid */
...
.sym lbl_8054D9A4, local
	...
	.4byte 0x74757265
	.4byte 0x00000000
.sym lbl_8054D9BC, local
	.4byte lbl_8054D798
	.4byte 0x00000000
	.4byte lbl_8054D770
	.4byte 0x00000000
	.4byte 0x00000000
.sym lbl_8054D9D0, local
	.4byte lbl_8054D9A4
	.4byte lbl_8054D9BC
...
.balign 8
.sym lbl_805CD7B8, local
	.skip 0x8
.sym lbl_805CD7C0, local
	.skip 0x8
.sym lbl_805CD7C8, local
	.skip 0x8
