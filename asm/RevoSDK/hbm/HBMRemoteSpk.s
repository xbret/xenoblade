...
/* 803219B0 002EAF70  41 82 02 34 */	beq lbl_80321BE4
...
/* 803219CC 002EAF8C  41 82 02 08 */	beq lbl_80321BD4
/* 803219D0 002EAF90  7F 83 E3 78 */	mr r3, r28
/* 803219D4 002EAF94  48 04 B6 9D */	bl func_8036D070
/* 803219D8 002EAF98  2C 03 00 00 */	cmpwi r3, 0
/* 803219DC 002EAF9C  41 82 01 F8 */	beq lbl_80321BD4
...
/* 803219EC 002EAFAC  48 04 CE A5 */	bl func_8036E890
/* 803219F0 002EAFB0  2C 03 00 00 */	cmpwi r3, 0
/* 803219F4 002EAFB4  41 82 01 B8 */	beq lbl_80321BAC
...
/* 80321A18 002EAFD8  41 81 00 08 */	bgt lbl_80321A20
...
/* 80321A28 002EAFE8  40 81 00 C0 */	ble lbl_80321AE8
/* 80321A2C 002EAFEC  54 A0 F0 BF */	rlwinm. r0, r5, 0x1e, 2, 0x1f
/* 80321A30 002EAFF0  7C 09 03 A6 */	mtctr r0
/* 80321A34 002EAFF4  41 82 00 88 */	beq lbl_80321ABC
lbl_80321A38:
...
/* 80321AB0 002EB070  42 00 FF 88 */	bdnz lbl_80321A38
/* 80321AB4 002EB074  70 A5 00 03 */	andi. r5, r5, 3
/* 80321AB8 002EB078  41 82 00 30 */	beq lbl_80321AE8
lbl_80321ABC:
...
/* 80321B2C 002EB0EC  42 00 FF DC */	bdnz lbl_80321B08
/* 80321B30 002EB0F0  70 63 00 07 */	andi. r3, r3, 7
/* 80321B34 002EB0F4  41 82 00 18 */	beq lbl_80321B4C
lbl_80321B38:
...
/* 80321B48 002EB108  42 00 FF F8 */	bdnz lbl_80321B40
lbl_80321B4C:
...
/* 80321BC4 002EB184  40 81 00 08 */	ble lbl_80321BCC
...
/* 80321BE0 002EB1A0  41 80 FD E4 */	blt lbl_803219C4
lbl_80321BE4:
...
/* 80321BFC 002EB1BC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */

.global func_80321C00
func_80321C00:
...
/* 80321C2C 002EB1EC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */

.global func_80321C30
func_80321C30:
...
/* 80321C60 002EB220  41 82 00 24 */	beq lbl_80321C84
...
/* 80321C80 002EB240  48 00 00 0C */	b lbl_80321C8C
lbl_80321C84:
...
/* 80321CCC 002EB28C  41 80 FF DC */	blt lbl_80321CA8
...
/* 80321D18 002EB2D8  41 82 00 58 */	beq lbl_80321D70
...
/* 80321D5C 002EB31C  41 80 FF EC */	blt lbl_80321D48
/* 80321D60 002EB320  2C 1D 00 00 */	cmpwi r29, 0
/* 80321D64 002EB324  40 81 00 0C */	ble lbl_80321D70
/* 80321D68 002EB328  7F 83 E3 78 */	mr r3, r28
/* 80321D6C 002EB32C  48 11 2E C1 */	bl func_80434C2C
lbl_80321D70:
...
/* 80321D94 002EB354  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 80321D98 002EB358  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 80321D9C 002EB35C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */

.global func_80321DA0
func_80321DA0:
...
/* 80321DC0 002EB380  41 82 00 9C */	beq lbl_80321E5C
...
/* 80321DE4 002EB3A4  3D 20 80 32 */	lis r9, lbl_80321990@ha
...
/* 80321E0C 002EB3CC  39 29 19 90 */	addi r9, r9, lbl_80321990@l
...
/* 80321E20 002EB3E0  48 03 12 D1 */	bl func_803530F0
...
/* 80321E58 002EB418  41 80 FF DC */	blt lbl_80321E34
lbl_80321E5C:
...
/* 80321E74 002EB434  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 80321E78 002EB438  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 80321E7C 002EB43C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */

.global func_80321E80
func_80321E80:
...
/* 80321EB8 002EB478  41 80 FF EC */	blt lbl_80321EA4
...
/* 80321ED4 002EB494  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 80321ED8 002EB498  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 80321EDC 002EB49C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
lbl_80321EE0:
...
/* 80321EEC 002EB4AC  48 03 16 D5 */	bl func_803535C0
/* 80321EF0 002EB4B0  3C A0 80 32 */	lis r5, lbl_80321F10@ha
/* 80321EF4 002EB4B4  38 80 00 01 */	li r4, 1
/* 80321EF8 002EB4B8  38 A5 1F 10 */	addi r5, r5, lbl_80321F10@l
/* 80321EFC 002EB4BC  48 04 B1 C5 */	bl func_8036D0C0
...
/* 80321F2C 002EB4EC  41 82 00 A8 */	beq lbl_80321FD4
/* 80321F30 002EB4F0  2C 04 00 00 */	cmpwi r4, 0
/* 80321F34 002EB4F4  41 82 00 18 */	beq lbl_80321F4C
/* 80321F38 002EB4F8  2C 04 FF FD */	cmpwi r4, -3
/* 80321F3C 002EB4FC  41 82 00 34 */	beq lbl_80321F70
/* 80321F40 002EB500  2C 04 FF FE */	cmpwi r4, -2
/* 80321F44 002EB504  41 82 00 40 */	beq lbl_80321F84
/* 80321F48 002EB508  48 00 00 8C */	b lbl_80321FD4
lbl_80321F4C:
/* 80321F4C 002EB50C  1C 03 00 68 */	mulli r0, r3, 0x68
/* 80321F50 002EB510  3C A0 80 32 */	lis r5, lbl_80322020@ha
/* 80321F54 002EB514  38 E0 00 01 */	li r7, 1
/* 80321F58 002EB518  38 A5 20 20 */	addi r5, r5, lbl_80322020@l
...
/* 80321F68 002EB528  48 04 B1 59 */	bl func_8036D0C0
/* 80321F6C 002EB52C  48 00 00 68 */	b lbl_80321FD4
lbl_80321F70:
...
/* 80321F80 002EB540  48 00 00 54 */	b lbl_80321FD4
lbl_80321F84:
...
/* 80321F94 002EB554  48 03 16 1D */	bl func_803535B0
...
/* 80321FA4 002EB564  3C E0 80 32 */	lis r7, lbl_80321EE0@ha
...
/* 80321FB4 002EB574  38 E7 1E E0 */	addi r7, r7, lbl_80321EE0@l
...
/* 80321FD0 002EB590  48 03 10 B1 */	bl func_80353080
lbl_80321FD4:
...
/* 80321FE8 002EB5A8  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 80321FEC 002EB5AC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
lbl_80321FF0:
...
/* 80321FFC 002EB5BC  48 03 15 C5 */	bl func_803535C0
/* 80322000 002EB5C0  3C A0 80 32 */	lis r5, lbl_80322020@ha
/* 80322004 002EB5C4  38 80 00 04 */	li r4, 4
/* 80322008 002EB5C8  38 A5 20 20 */	addi r5, r5, lbl_80322020@l
/* 8032200C 002EB5CC  48 04 B0 B5 */	bl func_8036D0C0
...
/* 8032203C 002EB5FC  41 82 00 B4 */	beq lbl_803220F0
/* 80322040 002EB600  2C 04 00 00 */	cmpwi r4, 0
/* 80322044 002EB604  41 82 00 20 */	beq lbl_80322064
/* 80322048 002EB608  2C 04 FF FD */	cmpwi r4, -3
/* 8032204C 002EB60C  41 82 00 2C */	beq lbl_80322078
/* 80322050 002EB610  2C 04 FF FF */	cmpwi r4, -1
/* 80322054 002EB614  41 82 00 38 */	beq lbl_8032208C
/* 80322058 002EB618  2C 04 FF FE */	cmpwi r4, -2
/* 8032205C 002EB61C  41 82 00 44 */	beq lbl_803220A0
/* 80322060 002EB620  48 00 00 90 */	b lbl_803220F0
lbl_80322064:
...
/* 80322074 002EB634  48 00 00 7C */	b lbl_803220F0
lbl_80322078:
...
/* 80322088 002EB648  48 00 00 68 */	b lbl_803220F0
lbl_8032208C:
...
/* 8032209C 002EB65C  48 00 00 54 */	b lbl_803220F0
lbl_803220A0:
...
/* 803220B0 002EB670  48 03 15 01 */	bl func_803535B0
...
/* 803220C0 002EB680  3C E0 80 32 */	lis r7, lbl_80321FF0@ha
...
/* 803220D0 002EB690  38 E7 1F F0 */	addi r7, r7, lbl_80321FF0@l
...
/* 803220EC 002EB6AC  48 03 0F 95 */	bl func_80353080
lbl_803220F0:
...
/* 80322104 002EB6C4  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 80322108 002EB6C8  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 8032210C 002EB6CC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 80322134 002EB6F4  41 82 00 50 */	beq lbl_80322184
/* 80322138 002EB6F8  3C A0 80 32 */	lis r5, lbl_80321F10@ha
/* 8032213C 002EB6FC  7F E3 FB 78 */	mr r3, r31
/* 80322140 002EB700  38 A5 1F 10 */	addi r5, r5, lbl_80321F10@l
/* 80322144 002EB704  38 80 00 01 */	li r4, 1
/* 80322148 002EB708  48 04 AF 79 */	bl func_8036D0C0
...
/* 8032219C 002EB75C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */

.global func_803221A0
func_803221A0:
...
/* 803221CC 002EB78C  41 82 00 54 */	beq lbl_80322220
...
/* 80322238 002EB7F8  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 8032223C 002EB7FC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */

.global func_80322240
func_80322240:
...
/* 8032225C 002EB81C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 80322270 002EB830  41 82 00 18 */	beq lbl_80322288
/* 80322274 002EB834  80 03 00 58 */	lwz r0, 0x58(r3)
/* 80322278 002EB838  7C 05 00 00 */	cmpw r5, r0
/* 8032227C 002EB83C  40 82 00 0C */	bne lbl_80322288
...
/* 803222AC 002EB86C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */