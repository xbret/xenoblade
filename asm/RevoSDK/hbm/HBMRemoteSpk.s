...
/* 803219AC 002EAF6C  2C 1D 00 00 */	cmpwi r29, 0x0
/* 803219B0 002EAF70  41 82 02 34 */	beq .L_80321BE4
/* 803219B4 002EAF74  3B 80 00 00 */	li r28, 0x0
/* 803219B8 002EAF78  3B E0 00 00 */	li r31, 0x0
/* 803219BC 002EAF7C  3F C0 66 66 */	lis r30, 0x6666
/* 803219C0 002EAF80  3B 40 FF FF */	li r26, -0x1
.L_803219C4:
/* 803219C4 002EAF84  80 1D 00 50 */	lwz r0, 0x50(r29)
/* 803219C8 002EAF88  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 803219D8 002EAF98  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 803219F0 002EAFB0  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 80321A48 002EB008  54 03 0F FE */	srwi r3, r0, 31
/* 80321A4C 002EB00C  7C 00 1A 14 */	add r0, r0, r3
/* 80321A50 002EB010  B0 07 00 00 */	sth r0, 0x0(r7)
/* 80321A54 002EB014  A8 06 00 02 */	lha r0, 0x2(r6)
...
/* 80321A64 002EB024  54 03 0F FE */	srwi r3, r0, 31
/* 80321A68 002EB028  7C 00 1A 14 */	add r0, r0, r3
/* 80321A6C 002EB02C  B0 07 00 02 */	sth r0, 0x2(r7)
/* 80321A70 002EB030  A8 06 00 04 */	lha r0, 0x4(r6)
...
/* 80321A80 002EB040  54 03 0F FE */	srwi r3, r0, 31
/* 80321A84 002EB044  7C 00 1A 14 */	add r0, r0, r3
/* 80321A88 002EB048  B0 07 00 04 */	sth r0, 0x4(r7)
/* 80321A8C 002EB04C  A8 06 00 06 */	lha r0, 0x6(r6)
/* 80321A90 002EB050  38 C6 00 08 */	addi r6, r6, 0x8
...
/* 80321AA0 002EB060  54 03 0F FE */	srwi r3, r0, 31
/* 80321AA4 002EB064  7C 00 1A 14 */	add r0, r0, r3
/* 80321AA8 002EB068  B0 07 00 06 */	sth r0, 0x6(r7)
/* 80321AAC 002EB06C  38 E7 00 08 */	addi r7, r7, 0x8
/* 80321AB0 002EB070  42 00 FF 88 */	bdnz .L_80321A38
/* 80321AB4 002EB074  70 A5 00 03 */	andi. r5, r5, 0x3
/* 80321AB8 002EB078  41 82 00 30 */	beq .L_80321AE8
.L_80321ABC:
/* 80321ABC 002EB07C  7C A9 03 A6 */	mtctr r5
.L_80321AC0:
/* 80321AC0 002EB080  A8 06 00 00 */	lha r0, 0x0(r6)
/* 80321AC4 002EB084  38 C6 00 02 */	addi r6, r6, 0x2
...
/* 80321AD4 002EB094  54 03 0F FE */	srwi r3, r0, 31
/* 80321AD8 002EB098  7C 00 1A 14 */	add r0, r0, r3
/* 80321ADC 002EB09C  B0 07 00 00 */	sth r0, 0x0(r7)
/* 80321AE0 002EB0A0  38 E7 00 02 */	addi r7, r7, 0x2
...
/* 80321AF4 002EB0B4  28 03 00 00 */	cmplwi r3, 0x0
/* 80321AF8 002EB0B8  40 81 00 54 */	ble .L_80321B4C
/* 80321AFC 002EB0BC  54 60 E8 FF */	srwi. r0, r3, 3
/* 80321B00 002EB0C0  7C 09 03 A6 */	mtctr r0
/* 80321B04 002EB0C4  41 82 00 34 */	beq .L_80321B38
.L_80321B08:
/* 80321B08 002EB0C8  B3 E7 00 00 */	sth r31, 0x0(r7)
/* 80321B0C 002EB0CC  B3 E7 00 02 */	sth r31, 0x2(r7)
/* 80321B10 002EB0D0  B3 E7 00 04 */	sth r31, 0x4(r7)
/* 80321B14 002EB0D4  B3 E7 00 06 */	sth r31, 0x6(r7)
/* 80321B18 002EB0D8  B3 E7 00 08 */	sth r31, 0x8(r7)
...
/* 80321B30 002EB0F0  70 63 00 07 */	andi. r3, r3, 0x7
/* 80321B34 002EB0F4  41 82 00 18 */	beq .L_80321B4C
.L_80321B38:
/* 80321B38 002EB0F8  7C 69 03 A6 */	mtctr r3
/* 80321B3C 002EB0FC  60 00 00 00 */	nop
.L_80321B40:
/* 80321B40 002EB100  B3 E7 00 00 */	sth r31, 0x0(r7)
/* 80321B44 002EB104  38 E7 00 02 */	addi r7, r7, 0x2
...
/* 80321B58 002EB118  38 E1 00 08 */	addi r7, r1, 0x8
...
/* 80321B70 002EB130  38 81 00 08 */	addi r4, r1, 0x8
...
/* 80321B94 002EB154  34 03 FF B0 */	addic. r0, r3, -0x50
...
/* 80321BB0 002EB170  38 03 00 01 */	addi r0, r3, 0x1
/* 80321BB4 002EB174  98 1D 00 5E */	stb r0, 0x5e(r29)
/* 80321BB8 002EB178  54 00 06 3E */	clrlwi r0, r0, 24
...
.L_80321BD4:
/* 80321BD4 002EB194  3B 9C 00 01 */	addi r28, r28, 0x1
/* 80321BD8 002EB198  3B BD 00 68 */	addi r29, r29, 0x68
/* 80321BDC 002EB19C  2C 1C 00 04 */	cmpwi r28, 0x4
...
/* 80321BFC 002EB1BC  00 00 00 00 */	.4byte 0x00000000 /* invalid */

# homebutton::RemoteSpk::ClearPcm()
.fn ClearPcm__Q210homebutton9RemoteSpkFv, global
/* 80321C00 002EB1C0  38 80 00 00 */	li r4, 0x0
/* 80321C04 002EB1C4  38 00 FF FF */	li r0, -0x1
...
/* 80321C2C 002EB1EC  00 00 00 00 */	.4byte 0x00000000 /* invalid */
...
/* 80321C48 002EB208  2C 04 00 00 */	cmpwi r4, 0x0
...
/* 80321C98 002EB258  3B 60 00 00 */	li r27, 0x0
/* 80321C9C 002EB25C  3B A0 00 00 */	li r29, 0x0
/* 80321CA0 002EB260  3B C0 FF FF */	li r30, -0x1
/* 80321CA4 002EB264  3B E0 00 01 */	li r31, 0x1
.L_80321CA8:
...
/* 80321CB4 002EB274  3B 7B 00 01 */	addi r27, r27, 0x1
/* 80321CB8 002EB278  2C 1B 00 04 */	cmpwi r27, 0x4
...
/* 80321CEC 002EB2AC  00 00 00 00 */	.4byte 0x00000000 /* invalid */
...
/* 80321CF8 002EB2B8  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 80321D2C 002EB2EC  38 00 00 00 */	li r0, 0x0
...
/* 80321D94 002EB354  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 80321D98 002EB358  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 80321D9C 002EB35C  00 00 00 00 */	.4byte 0x00000000 /* invalid */
...
/* 80321DBC 002EB37C  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 80321DD0 002EB390  3C C0 80 00 */	lis r6, 0x8000
/* 80321DD4 002EB394  3C A0 43 1C */	lis r5, 0x431c
/* 80321DD8 002EB398  80 06 00 F8 */	lwz r0, 0xf8(r6)
/* 80321DDC 002EB39C  3C C0 10 62 */	lis r6, 0x1062
/* 80321DE0 002EB3A0  39 46 4D D3 */	addi r10, r6, 0x4dd3
...
/* 80321DEC 002EB3AC  38 A5 DE 83 */	addi r5, r5, -0x217d
/* 80321DF0 002EB3B0  7D 05 00 16 */	mulhwu r8, r5, r0
/* 80321DF4 002EB3B4  3C E0 00 66 */	lis r7, 0x66
/* 80321DF8 002EB3B8  7C 86 23 78 */	mr r6, r4
/* 80321DFC 002EB3BC  38 07 B9 AB */	addi r0, r7, -0x4655
/* 80321E00 002EB3C0  7C 65 1B 78 */	mr r5, r3
/* 80321E04 002EB3C4  38 7F 01 A0 */	addi r3, r31, 0x1a0
/* 80321E08 002EB3C8  55 04 8B FE */	srwi r4, r8, 15
...
/* 80321E14 002EB3D4  38 E0 00 00 */	li r7, 0x0
...
/* 80321E24 002EB3E4  3B 60 00 00 */	li r27, 0x0
/* 80321E28 002EB3E8  3B 80 00 00 */	li r28, 0x0
/* 80321E2C 002EB3EC  3B A0 FF FF */	li r29, -0x1
/* 80321E30 002EB3F0  3B C0 00 01 */	li r30, 0x1
.L_80321E34:
...
/* 80321E40 002EB400  3B 7B 00 01 */	addi r27, r27, 0x1
/* 80321E44 002EB404  2C 1B 00 04 */	cmpwi r27, 0x4
...
/* 80321E74 002EB434  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 80321E78 002EB438  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 80321E7C 002EB43C  00 00 00 00 */	.4byte 0x00000000 /* invalid */
...
/* 80321E90 002EB450  93 C1 00 08 */	stw r30, 0x8(r1)
...
/* 80321EC4 002EB484  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 80321ED4 002EB494  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 80321ED8 002EB498  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 80321EDC 002EB49C  00 00 00 00 */	.4byte 0x00000000 /* invalid */
...
/* 80321EF4 002EB4B4  38 80 00 01 */	li r4, 0x1
...
/* 80321F28 002EB4E8  2C 06 00 00 */	cmpwi r6, 0x0
/* 80321F2C 002EB4EC  41 82 00 A8 */	beq .L_80321FD4
/* 80321F30 002EB4F0  2C 04 00 00 */	cmpwi r4, 0x0
/* 80321F34 002EB4F4  41 82 00 18 */	beq .L_80321F4C
/* 80321F38 002EB4F8  2C 04 FF FD */	cmpwi r4, -0x3
/* 80321F3C 002EB4FC  41 82 00 34 */	beq .L_80321F70
/* 80321F40 002EB500  2C 04 FF FE */	cmpwi r4, -0x2
...
/* 80321F54 002EB514  38 E0 00 01 */	li r7, 0x1
...
/* 80321F60 002EB520  38 80 00 04 */	li r4, 0x4
...
/* 80321F74 002EB534  38 80 00 00 */	li r4, 0x0
...
/* 80321FA0 002EB560  3C 80 80 00 */	lis r4, 0x8000
/* 80321FA4 002EB564  3C E0 80 32 */	lis r7, DelaySpeakerOnCallback@ha
/* 80321FA8 002EB568  80 04 00 F8 */	lwz r0, 0xf8(r4)
/* 80321FAC 002EB56C  3C 60 10 62 */	lis r3, 0x1062
/* 80321FB0 002EB570  38 83 4D D3 */	addi r4, r3, 0x4dd3
...
/* 80321FC4 002EB584  38 A0 00 00 */	li r5, 0x0
...
/* 80321FE8 002EB5A8  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 80321FEC 002EB5AC  00 00 00 00 */	.4byte 0x00000000 /* invalid */

# homebutton::RemoteSpk::DelaySpeakerOffCallback(OSAlarm*, OSContext*)
...
/* 80322004 002EB5C4  38 80 00 04 */	li r4, 0x4
...
# homebutton::RemoteSpk::SpeakerOffCallback(long, long)
...
/* 80322038 002EB5F8  2C 05 00 00 */	cmpwi r5, 0x0
/* 8032203C 002EB5FC  41 82 00 B4 */	beq .L_803220F0
/* 80322040 002EB600  2C 04 00 00 */	cmpwi r4, 0x0
/* 80322044 002EB604  41 82 00 20 */	beq .L_80322064
/* 80322048 002EB608  2C 04 FF FD */	cmpwi r4, -0x3
/* 8032204C 002EB60C  41 82 00 2C */	beq .L_80322078
/* 80322050 002EB610  2C 04 FF FF */	cmpwi r4, -0x1
/* 80322054 002EB614  41 82 00 38 */	beq .L_8032208C
/* 80322058 002EB618  2C 04 FF FE */	cmpwi r4, -0x2
...
/* 80322068 002EB628  38 80 00 01 */	li r4, 0x1
...
/* 8032207C 002EB63C  38 80 00 00 */	li r4, 0x0
...
/* 80322090 002EB650  38 80 00 00 */	li r4, 0x0
...
/* 803220BC 002EB67C  3C 80 80 00 */	lis r4, 0x8000
/* 803220C0 002EB680  3C E0 80 32 */	lis r7, DelaySpeakerOffCallback__Q210homebutton9RemoteSpkFP7OSAlarmP9OSContext@ha
/* 803220C4 002EB684  80 04 00 F8 */	lwz r0, 0xf8(r4)
/* 803220C8 002EB688  3C 60 10 62 */	lis r3, 0x1062
/* 803220CC 002EB68C  38 83 4D D3 */	addi r4, r3, 0x4dd3
...
/* 803220E0 002EB6A0  38 A0 00 00 */	li r5, 0x0
...
/* 80322104 002EB6C4  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 80322108 002EB6C8  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 8032210C 002EB6CC  00 00 00 00 */	.4byte 0x00000000 /* invalid */

# homebutton::RemoteSpk::Disconnect(long)
...
/* 80322124 002EB6E4  93 C1 00 08 */	stw r30, 0x8(r1)
/* 80322128 002EB6E8  7C 7E 1B 78 */	mr r30, r3
/* 8032212C 002EB6EC  88 03 01 EC */	lbz r0, 0x1ec(r3)
/* 80322130 002EB6F0  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 80322144 002EB704  38 80 00 01 */	li r4, 0x1
/* 80322148 002EB708  48 04 AF 79 */	bl WPADControlSpeaker
/* 8032214C 002EB70C  1C 9F 00 68 */	mulli r4, r31, 0x68
/* 80322150 002EB710  38 60 00 00 */	li r3, 0x0
/* 80322154 002EB714  38 00 00 01 */	li r0, 0x1
...
/* 8032218C 002EB74C  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 8032219C 002EB75C  00 00 00 00 */	.4byte 0x00000000 /* invalid */
...
/* 803221C4 002EB784  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 80322238 002EB7F8  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 8032223C 002EB7FC  00 00 00 00 */	.4byte 0x00000000 /* invalid */
...
/* 80322254 002EB814  54 03 0F FE */	srwi r3, r0, 31
/* 80322258 002EB818  4E 80 00 20 */	blr
.endfn isPlaying__Q210homebutton9RemoteSpkCFl
/* 8032225C 002EB81C  00 00 00 00 */	.4byte 0x00000000 /* invalid */
...
/* 8032226C 002EB82C  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 80322280 002EB840  38 60 00 01 */	li r3, 0x1
/* 80322284 002EB844  4E 80 00 20 */	blr
.L_80322288:
/* 80322288 002EB848  38 60 00 00 */	li r3, 0x0
...
/* 803222A4 002EB864  54 03 0F FE */	srwi r3, r0, 31
