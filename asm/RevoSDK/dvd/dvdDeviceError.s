...
/* 80310374 002D9934  38 00 00 01 */	li r0, 0x1
...
/* 803103A4 002D9964  28 00 00 00 */	cmplwi r0, 0x0
/* 803103A8 002D9968  40 82 00 0C */	bne .L_803103B4
/* 803103AC 002D996C  38 60 00 01 */	li r3, 0x1
...
.L_803103D0:
/* 803103D0 002D9990  38 60 00 01 */	li r3, 0x1
/* 803103D4 002D9994  48 00 02 0C */	b .L_803105E0
.L_803103D8:
/* 803103D8 002D9998  3C 60 80 00 */	lis r3, 0x8000
/* 803103DC 002D999C  88 03 31 9C */	lbz r0, 0x319c(r3)
...
.L_803103EC:
/* 803103EC 002D99AC  38 00 00 00 */	li r0, 0x0
...
/* 80310454 002D9A14  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 80310464 002D9A24  2C 00 00 01 */	cmpwi r0, 0x1
...
.L_80310498:
/* 80310498 002D9A58  38 00 00 00 */	li r0, 0x0
...
/* 803104AC 002D9A6C  3C 80 00 04 */	lis r4, 0x4
/* 803104B0 002D9A70  38 C6 03 70 */	addi r6, r6, lowCallback@l
/* 803104B4 002D9A74  38 A0 00 00 */	li r5, 0x0
...
/* 80310504 002D9AC4  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 80310514 002D9AD4  2C 00 00 01 */	cmpwi r0, 0x1
...
.L_80310558:
/* 80310558 002D9B18  38 60 00 01 */	li r3, 0x1
/* 8031055C 002D9B1C  48 00 00 84 */	b .L_803105E0
.L_80310560:
/* 80310560 002D9B20  83 C2 BC 10 */	lwz r30, "@850"@sda21(r2)
/* 80310564 002D9B24  3B E0 00 00 */	li r31, 0x0
/* 80310568 002D9B28  48 05 0A A9 */	bl SCGetLanguage
/* 8031056C 002D9B2C  54 60 06 3F */	clrlwi. r0, r3, 24
/* 80310570 002D9B30  40 82 00 10 */	bne .L_80310580
/* 80310574 002D9B34  38 60 00 01 */	li r3, 0x1
/* 80310578 002D9B38  48 04 74 99 */	bl OSSetFontEncode
/* 8031057C 002D9B3C  48 00 00 0C */	b .L_80310588
.L_80310580:
/* 80310580 002D9B40  38 60 00 00 */	li r3, 0x0
...
/* 80310594 002D9B54  54 60 06 3E */	clrlwi r0, r3, 24
/* 80310598 002D9B58  28 00 00 06 */	cmplwi r0, 0x6
/* 8031059C 002D9B5C  40 81 00 0C */	ble .L_803105A8
/* 803105A0 002D9B60  80 BD 00 04 */	lwz r5, 0x4(r29)
/* 803105A4 002D9B64  48 00 00 10 */	b .L_803105B4
.L_803105A8:
/* 803105A8 002D9B68  48 05 0A 69 */	bl SCGetLanguage
/* 803105AC 002D9B6C  54 60 15 BA */	clrlslwi r0, r3, 24, 2
...
/* 803105BC 002D9B7C  38 61 00 08 */	addi r3, r1, 0x8
/* 803105C0 002D9B80  93 C1 00 08 */	stw r30, 0x8(r1)
/* 803105C4 002D9B84  48 04 69 7D */	bl OSFatal
/* 803105C8 002D9B88  38 60 00 00 */	li r3, 0x0
/* 803105CC 002D9B8C  48 00 00 14 */	b .L_803105E0
.L_803105D0:
/* 803105D0 002D9B90  38 60 00 00 */	li r3, 0x0
/* 803105D4 002D9B94  48 00 00 0C */	b .L_803105E0
.L_803105D8:
/* 803105D8 002D9B98  4B FF FC 29 */	bl __DVDShowFatalMessage
/* 803105DC 002D9B9C  38 60 00 00 */	li r3, 0x0
.L_803105E0:
