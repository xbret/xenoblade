...
/* 80348CC8 00312288  48 00 0E 09 */	bl MEMInitList
/* 80348CCC 0031228C  80 0D B8 50 */	lwz r0, sRootListInitialized@sda21(r13)
/* 80348CD0 00312290  2C 00 00 00 */	cmpwi r0, 0
/* 80348CD4 00312294  40 82 00 28 */	bne .L_80348CFC
/* 80348CD8 00312298  3C 60 80 5D */	lis r3, sRootList@ha
/* 80348CDC 0031229C  38 80 00 04 */	li r4, 4
/* 80348CE0 003122A0  38 63 FC 50 */	addi r3, r3, sRootList@l
/* 80348CE4 003122A4  48 00 0D ED */	bl MEMInitList
/* 80348CE8 003122A8  3C 60 80 5D */	lis r3, sRootMutex@ha
/* 80348CEC 003122AC  38 63 FC 60 */	addi r3, r3, sRootMutex@l
/* 80348CF0 003122B0  48 01 0F 31 */	bl OSInitMutex
/* 80348CF4 003122B4  38 00 00 01 */	li r0, 1
/* 80348CF8 003122B8  90 0D B8 50 */	stw r0, sRootListInitialized@sda21(r13)
.L_80348CFC:
/* 80348CFC 003122BC  38 7B 00 20 */	addi r3, r27, 0x20
/* 80348D00 003122C0  48 01 0F 21 */	bl OSInitMutex
/* 80348D04 003122C4  3C 60 80 5D */	lis r3, sRootMutex@ha
/* 80348D08 003122C8  38 63 FC 60 */	addi r3, r3, sRootMutex@l
/* 80348D0C 003122CC  48 01 0F 55 */	bl OSLockMutex
/* 80348D10 003122D0  3F E0 80 5D */	lis r31, sRootList@ha
/* 80348D14 003122D4  3B C0 00 00 */	li r30, 0
/* 80348D18 003122D8  3B 9F FC 50 */	addi r28, r31, sRootList@l
/* 80348D1C 003122DC  48 00 00 DC */	b .L_80348DF8
.L_80348D20:
/* 80348D20 003122E0  80 03 00 18 */	lwz r0, 0x18(r3)
/* 80348D24 003122E4  7C 00 D8 40 */	cmplw r0, r27
/* 80348D28 003122E8  41 81 00 D0 */	bgt .L_80348DF8
/* 80348D2C 003122EC  80 03 00 1C */	lwz r0, 0x1c(r3)
/* 80348D30 003122F0  7C 1B 00 40 */	cmplw r27, r0
/* 80348D34 003122F4  40 80 00 C4 */	bge .L_80348DF8
/* 80348D38 003122F8  3B E0 00 00 */	li r31, 0
/* 80348D3C 003122FC  48 00 00 8C */	b .L_80348DC8
.L_80348D40:
/* 80348D40 00312300  80 03 00 18 */	lwz r0, 0x18(r3)
/* 80348D44 00312304  7C 00 D8 40 */	cmplw r0, r27
/* 80348D48 00312308  41 81 00 80 */	bgt .L_80348DC8
/* 80348D4C 0031230C  80 03 00 1C */	lwz r0, 0x1c(r3)
/* 80348D50 00312310  7C 1B 00 40 */	cmplw r27, r0
/* 80348D54 00312314  40 80 00 74 */	bge .L_80348DC8
/* 80348D58 00312318  3B A0 00 00 */	li r29, 0
/* 80348D5C 0031231C  48 00 00 3C */	b .L_80348D98
.L_80348D60:
/* 80348D60 00312320  80 03 00 18 */	lwz r0, 0x18(r3)
/* 80348D64 00312324  7C 00 D8 40 */	cmplw r0, r27
/* 80348D68 00312328  41 81 00 30 */	bgt .L_80348D98
/* 80348D6C 0031232C  80 03 00 1C */	lwz r0, 0x1c(r3)
/* 80348D70 00312330  7C 1B 00 40 */	cmplw r27, r0
/* 80348D74 00312334  40 80 00 24 */	bge .L_80348D98
/* 80348D78 00312338  7F 64 DB 78 */	mr r4, r27
/* 80348D7C 0031233C  38 63 00 0C */	addi r3, r3, 0xc
/* 80348D80 00312340  4B FF FD D1 */	bl FindContainHeap_
/* 80348D84 00312344  2C 03 00 00 */	cmpwi r3, 0
/* 80348D88 00312348  41 82 00 08 */	beq .L_80348D90
/* 80348D8C 0031234C  48 00 00 28 */	b .L_80348DB4
.L_80348D90:
/* 80348D90 00312350  7F A3 EB 78 */	mr r3, r29
/* 80348D94 00312354  48 00 00 20 */	b .L_80348DB4
.L_80348D98:
/* 80348D98 00312358  7F A4 EB 78 */	mr r4, r29
/* 80348D9C 0031235C  38 7F 00 0C */	addi r3, r31, 0xc
/* 80348DA0 00312360  48 00 0E 31 */	bl MEMGetNextListObject
/* 80348DA4 00312364  2C 03 00 00 */	cmpwi r3, 0
/* 80348DA8 00312368  7C 7D 1B 78 */	mr r29, r3
/* 80348DAC 0031236C  40 82 FF B4 */	bne .L_80348D60
/* 80348DB0 00312370  38 60 00 00 */	li r3, 0
.L_80348DB4:
/* 80348DB4 00312374  2C 03 00 00 */	cmpwi r3, 0
/* 80348DB8 00312378  41 82 00 08 */	beq .L_80348DC0
/* 80348DBC 0031237C  48 00 00 28 */	b .L_80348DE4
.L_80348DC0:
/* 80348DC0 00312380  7F E3 FB 78 */	mr r3, r31
/* 80348DC4 00312384  48 00 00 20 */	b .L_80348DE4
.L_80348DC8:
/* 80348DC8 00312388  7F E4 FB 78 */	mr r4, r31
/* 80348DCC 0031238C  38 7E 00 0C */	addi r3, r30, 0xc
/* 80348DD0 00312390  48 00 0E 01 */	bl MEMGetNextListObject
/* 80348DD4 00312394  2C 03 00 00 */	cmpwi r3, 0
/* 80348DD8 00312398  7C 7F 1B 78 */	mr r31, r3
/* 80348DDC 0031239C  40 82 FF 64 */	bne .L_80348D40
/* 80348DE0 003123A0  38 60 00 00 */	li r3, 0
.L_80348DE4:
/* 80348DE4 003123A4  2C 03 00 00 */	cmpwi r3, 0
/* 80348DE8 003123A8  41 82 00 08 */	beq .L_80348DF0
/* 80348DEC 003123AC  48 00 00 28 */	b .L_80348E14
.L_80348DF0:
/* 80348DF0 003123B0  7F C3 F3 78 */	mr r3, r30
/* 80348DF4 003123B4  48 00 00 20 */	b .L_80348E14
.L_80348DF8:
/* 80348DF8 003123B8  7F C4 F3 78 */	mr r4, r30
/* 80348DFC 003123BC  38 7F FC 50 */	addi r3, r31, sRootList@l
/* 80348E00 003123C0  48 00 0D D1 */	bl MEMGetNextListObject
/* 80348E04 003123C4  2C 03 00 00 */	cmpwi r3, 0
/* 80348E08 003123C8  7C 7E 1B 78 */	mr r30, r3
/* 80348E0C 003123CC  40 82 FF 14 */	bne .L_80348D20
/* 80348E10 003123D0  38 60 00 00 */	li r3, 0
.L_80348E14:
/* 80348E14 003123D4  2C 03 00 00 */	cmpwi r3, 0
/* 80348E18 003123D8  41 82 00 08 */	beq .L_80348E20
...
/* 80348E28 003123E8  48 00 0C C9 */	bl MEMAppendListObject
/* 80348E2C 003123EC  3C 60 80 5D */	lis r3, sRootMutex@ha
/* 80348E30 003123F0  38 63 FC 60 */	addi r3, r3, sRootMutex@l
...
/* 80348F8C 0031254C  48 00 0B D5 */	bl MEMRemoveListObject
/* 80348F90 00312550  3C 60 80 5D */	lis r3, sRootMutex@ha
/* 80348F94 00312554  38 63 FC 60 */	addi r3, r3, sRootMutex@l
