...
/* 80349780 00312D40  38 03 00 03 */	addi r0, r3, 3
/* 80349784 00312D44  54 86 00 3A */	rlwinm r6, r4, 0, 0, 0x1d
/* 80349788 00312D48  93 E1 00 0C */	stw r31, 0xc(r1)
/* 8034978C 00312D4C  54 1F 00 3A */	rlwinm r31, r0, 0, 0, 0x1d
/* 80349790 00312D50  7C 1F 30 40 */	cmplw r31, r6
/* 80349794 00312D54  41 81 00 10 */	bgt lbl_803497A4
/* 80349798 00312D58  7C 1F 30 50 */	subf r0, r31, r6
/* 8034979C 00312D5C  28 00 00 48 */	cmplwi r0, 0x48
/* 803497A0 00312D60  40 80 00 0C */	bge lbl_803497AC
lbl_803497A4:
/* 803497A4 00312D64  38 60 00 00 */	li r3, 0
/* 803497A8 00312D68  48 00 00 38 */	b lbl_803497E0
lbl_803497AC:
/* 803497AC 00312D6C  3C 80 46 52 */	lis r4, 0x46524D48@ha
...
/* 80349858 00312E18  40 82 00 08 */	bne lbl_80349860
/* 8034985C 00312E1C  3B C0 00 01 */	li r30, 1
lbl_80349860:
/* 80349860 00312E20  80 03 00 38 */	lwz r0, 0x38(r3)
/* 80349864 00312E24  38 9E 00 03 */	addi r4, r30, 3
/* 80349868 00312E28  54 9E 00 3A */	rlwinm r30, r4, 0, 0, 0x1d
/* 8034986C 00312E2C  54 00 07 7B */	rlwinm. r0, r0, 0, 0x1d, 0x1d
/* 80349870 00312E30  41 82 00 0C */	beq lbl_8034987C
/* 80349874 00312E34  38 63 00 20 */	addi r3, r3, 0x20
/* 80349878 00312E38  48 01 03 E9 */	bl OSLockMutex
lbl_8034987C:
/* 8034987C 00312E3C  2C 1D 00 00 */	cmpwi r29, 0
/* 80349880 00312E40  41 80 00 54 */	blt lbl_803498D4
/* 80349884 00312E44  80 7F 00 3C */	lwz r3, 0x3c(r31)
/* 80349888 00312E48  38 1D FF FF */	addi r0, r29, -1
...
/* 80349898 00312E58  38 84 FF FF */	addi r4, r4, -1
...
/* 803498A8 00312E68  40 81 00 0C */	ble lbl_803498B4
/* 803498AC 00312E6C  3B A0 00 00 */	li r29, 0
/* 803498B0 00312E70  48 00 00 6C */	b lbl_8034991C
lbl_803498B4:
/* 803498B4 00312E74  80 1F 00 38 */	lwz r0, 0x38(r31)
/* 803498B8 00312E78  7C A3 F0 50 */	subf r5, r3, r30
/* 803498BC 00312E7C  54 00 07 FF */	clrlwi. r0, r0, 0x1f
/* 803498C0 00312E80  41 82 00 0C */	beq lbl_803498CC
/* 803498C4 00312E84  38 80 00 00 */	li r4, 0
/* 803498C8 00312E88  4B CB AA 89 */	bl memset
lbl_803498CC:
/* 803498CC 00312E8C  93 DF 00 3C */	stw r30, 0x3c(r31)
/* 803498D0 00312E90  48 00 00 4C */	b lbl_8034991C
lbl_803498D4:
/* 803498D4 00312E94  80 BF 00 40 */	lwz r5, 0x40(r31)
/* 803498D8 00312E98  20 1D FF FF */	subfic r0, r29, -1
...
/* 803498F0 00312EB0  40 80 00 0C */	bge lbl_803498FC
/* 803498F4 00312EB4  3B A0 00 00 */	li r29, 0
/* 803498F8 00312EB8  48 00 00 24 */	b lbl_8034991C
lbl_803498FC:
/* 803498FC 00312EBC  80 1F 00 38 */	lwz r0, 0x38(r31)
/* 80349900 00312EC0  7C BD 28 50 */	subf r5, r29, r5
/* 80349904 00312EC4  54 00 07 FF */	clrlwi. r0, r0, 0x1f
/* 80349908 00312EC8  41 82 00 10 */	beq lbl_80349918
/* 8034990C 00312ECC  7F A3 EB 78 */	mr r3, r29
/* 80349910 00312ED0  38 80 00 00 */	li r4, 0
...
/* 80349920 00312EE0  54 00 07 7B */	rlwinm. r0, r0, 0, 0x1d, 0x1d
/* 80349924 00312EE4  41 82 00 0C */	beq lbl_80349930
...
/* 80349964 00312F24  93 C1 00 08 */	stw r30, 8(r1)
/* 80349968 00312F28  7C 7E 1B 78 */	mr r30, r3
/* 8034996C 00312F2C  80 03 00 38 */	lwz r0, 0x38(r3)
/* 80349970 00312F30  54 00 07 7B */	rlwinm. r0, r0, 0, 0x1d, 0x1d
/* 80349974 00312F34  41 82 00 0C */	beq lbl_80349980
/* 80349978 00312F38  38 63 00 20 */	addi r3, r3, 0x20
/* 8034997C 00312F3C  48 01 02 E5 */	bl OSLockMutex
lbl_80349980:
/* 80349980 00312F40  57 E0 07 FF */	clrlwi. r0, r31, 0x1f
/* 80349984 00312F44  41 82 00 14 */	beq lbl_80349998
/* 80349988 00312F48  80 7E 00 18 */	lwz r3, 0x18(r30)
/* 8034998C 00312F4C  38 00 00 00 */	li r0, 0
/* 80349990 00312F50  90 7E 00 3C */	stw r3, 0x3c(r30)
/* 80349994 00312F54  90 1E 00 44 */	stw r0, 0x44(r30)
lbl_80349998:
/* 80349998 00312F58  57 E0 07 BD */	rlwinm. r0, r31, 0, 0x1e, 0x1e
/* 8034999C 00312F5C  41 82 00 28 */	beq lbl_803499C4
/* 803499A0 00312F60  80 7E 00 44 */	lwz r3, 0x44(r30)
/* 803499A4 00312F64  48 00 00 10 */	b lbl_803499B4
lbl_803499A8:
/* 803499A8 00312F68  80 1E 00 1C */	lwz r0, 0x1c(r30)
/* 803499AC 00312F6C  90 03 00 08 */	stw r0, 8(r3)
/* 803499B0 00312F70  80 63 00 0C */	lwz r3, 0xc(r3)
lbl_803499B4:
/* 803499B4 00312F74  2C 03 00 00 */	cmpwi r3, 0
/* 803499B8 00312F78  40 82 FF F0 */	bne lbl_803499A8
...
/* 803499C8 00312F88  54 00 07 7B */	rlwinm. r0, r0, 0, 0x1d, 0x1d
/* 803499CC 00312F8C  41 82 00 0C */	beq lbl_803499D8
...
/* 803499E0 00312FA0  83 C1 00 08 */	lwz r30, 8(r1)
...
/* 803499FC 00312FBC  7C 80 FE 70 */	srawi r0, r4, 0x1f
...
/* 80349A0C 00312FCC  93 C1 00 08 */	stw r30, 8(r1)
...
/* 80349A1C 00312FDC  38 9F FF FF */	addi r4, r31, -1
...
/* 80349A2C 00312FEC  38 04 FF FF */	addi r0, r4, -1
/* 80349A30 00312FF0  7C A0 00 38 */	and r0, r5, r0
/* 80349A34 00312FF4  7C 00 30 40 */	cmplw r0, r6
/* 80349A38 00312FF8  40 81 00 0C */	ble lbl_80349A44
/* 80349A3C 00312FFC  3B E0 00 00 */	li r31, 0
/* 80349A40 00313000  48 00 00 08 */	b lbl_80349A48
lbl_80349A44:
...
/* 80349A54 00313014  83 C1 00 08 */	lwz r30, 8(r1)
