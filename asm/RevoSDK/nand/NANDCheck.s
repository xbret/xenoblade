...
/* 80350FCC 0031A58C  2C 03 00 00 */	cmpwi r3, 0
/* 80350FD0 0031A590  40 82 00 0C */	bne lbl_80350FDC
/* 80350FD4 0031A594  38 60 FF 80 */	li r3, -128
/* 80350FD8 0031A598  48 00 00 5C */	b lbl_80351034
lbl_80350FDC:
...
/* 80351068 0031A628  41 82 00 0C */	beq lbl_80351074
/* 8035106C 0031A62C  2C 03 FF 96 */	cmpwi r3, -106
/* 80351070 0031A630  40 82 01 EC */	bne lbl_8035125C
lbl_80351074:
/* 80351074 0031A634  80 A4 00 B4 */	lwz r5, 0xb4(r4)
/* 80351078 0031A638  2C 03 00 00 */	cmpwi r3, 0
/* 8035107C 0031A63C  80 65 00 00 */	lwz r3, 0(r5)
/* 80351080 0031A640  40 82 00 24 */	bne lbl_803510A4
...
/* 80351120 0031A6E0  40 81 00 08 */	ble lbl_80351128
/* 80351124 0031A6E4  61 08 00 01 */	ori r8, r8, 1
lbl_80351128:
/* 80351128 0031A6E8  7C 00 2A 14 */	add r0, r0, r5
/* 8035112C 0031A6EC  28 00 00 21 */	cmplwi r0, 0x21
/* 80351130 0031A6F0  40 81 00 08 */	ble lbl_80351138
/* 80351134 0031A6F4  61 08 00 02 */	ori r8, r8, 2
lbl_80351138:
/* 80351138 0031A6F8  7C 06 1A 14 */	add r0, r6, r3
/* 8035113C 0031A6FC  28 00 44 00 */	cmplwi r0, 0x4400
/* 80351140 0031A700  40 81 00 08 */	ble lbl_80351148
/* 80351144 0031A704  61 08 00 04 */	ori r8, r8, 4
lbl_80351148:
/* 80351148 0031A708  7C 07 2A 14 */	add r0, r7, r5
/* 8035114C 0031A70C  28 00 0F A0 */	cmplwi r0, 0xfa0
/* 80351150 0031A710  40 81 00 08 */	ble lbl_80351158
/* 80351154 0031A714  61 08 00 08 */	ori r8, r8, 8
lbl_80351158:
/* 80351158 0031A718  80 84 00 98 */	lwz r4, 0x98(r4)
/* 8035115C 0031A71C  38 60 00 00 */	li r3, 0
/* 80351160 0031A720  91 04 00 00 */	stw r8, 0(r4)
/* 80351164 0031A724  4B FF F0 BD */	bl nandConvertErrorCode
/* 80351168 0031A728  81 9F 00 04 */	lwz r12, 4(r31)
/* 8035116C 0031A72C  7F E4 FB 78 */	mr r4, r31
/* 80351170 0031A730  7D 89 03 A6 */	mtctr r12
/* 80351174 0031A734  4E 80 04 21 */	bctrl 
/* 80351178 0031A738  48 00 00 F8 */	b lbl_80351270
lbl_8035117C:
/* 8035117C 0031A73C  2C 00 00 15 */	cmpwi r0, 0x15
/* 80351180 0031A740  40 82 00 A8 */	bne lbl_80351228
...
/* 803511E8 0031A7A8  40 80 00 08 */	bge lbl_803511F0
...
/* 803511F8 0031A7B8  90 A3 00 00 */	stw r5, 0(r3)
/* 803511FC 0031A7BC  40 80 00 08 */	bge lbl_80351204
/* 80351200 0031A7C0  7C C0 33 78 */	mr r0, r6
lbl_80351204:
/* 80351204 0031A7C4  80 84 00 10 */	lwz r4, 0x10(r4)
/* 80351208 0031A7C8  38 60 00 00 */	li r3, 0
/* 8035120C 0031A7CC  90 04 00 00 */	stw r0, 0(r4)
/* 80351210 0031A7D0  4B FF F0 11 */	bl nandConvertErrorCode
/* 80351214 0031A7D4  81 9F 00 04 */	lwz r12, 4(r31)
/* 80351218 0031A7D8  7F E4 FB 78 */	mr r4, r31
/* 8035121C 0031A7DC  7D 89 03 A6 */	mtctr r12
/* 80351220 0031A7E0  4E 80 04 21 */	bctrl 
/* 80351224 0031A7E4  48 00 00 4C */	b lbl_80351270
lbl_80351228:
