...
/* 8035F008 003285C8  39 00 00 00 */	li r8, 0x0
/* 8035F00C 003285CC  38 E7 8D 10 */	addi r7, r7, lbl_80518D10@l
/* 8035F010 003285D0  41 82 01 1C */	beq .L_8035F12C
/* 8035F014 003285D4  54 80 F0 BF */	srwi. r0, r4, 2
/* 8035F018 003285D8  7C 09 03 A6 */	mtctr r0
/* 8035F01C 003285DC  41 82 00 D4 */	beq .L_8035F0F0
.L_8035F020:
/* 8035F020 003285E0  89 23 00 00 */	lbz r9, 0x0(r3)
...
/* 8035F030 003285F0  54 00 0E FC */	clrlslwi r0, r0, 28, 1
/* 8035F034 003285F4  89 23 00 01 */	lbz r9, 0x1(r3)
...
/* 8035F048 00328608  54 00 0E FC */	clrlslwi r0, r0, 28, 1
...
/* 8035F05C 0032861C  89 23 00 02 */	lbz r9, 0x2(r3)
/* 8035F060 00328620  54 00 0E FC */	clrlslwi r0, r0, 28, 1
...
/* 8035F078 00328638  54 00 0E FC */	clrlslwi r0, r0, 28, 1
...
/* 8035F08C 0032864C  89 23 00 03 */	lbz r9, 0x3(r3)
/* 8035F090 00328650  54 00 0E FC */	clrlslwi r0, r0, 28, 1
/* 8035F094 00328654  55 06 E1 3E */	srwi r6, r8, 4
/* 8035F098 00328658  7C 07 02 2E */	lhzx r0, r7, r0
/* 8035F09C 0032865C  38 63 00 04 */	addi r3, r3, 0x4
...
/* 8035F0AC 0032866C  54 00 0E FC */	clrlslwi r0, r0, 28, 1
...
/* 8035F0C0 00328680  54 00 0E FC */	clrlslwi r0, r0, 28, 1
...
/* 8035F0D4 00328694  54 00 0E FC */	clrlslwi r0, r0, 28, 1
...
/* 8035F0E4 003286A4  42 00 FF 3C */	bdnz .L_8035F020
/* 8035F0E8 003286A8  70 84 00 03 */	andi. r4, r4, 0x3
/* 8035F0EC 003286AC  41 82 00 40 */	beq .L_8035F12C
.L_8035F0F0:
/* 8035F0F0 003286B0  7C 89 03 A6 */	mtctr r4
.L_8035F0F4:
/* 8035F0F4 003286B4  89 23 00 00 */	lbz r9, 0x0(r3)
/* 8035F0F8 003286B8  55 06 E1 3E */	srwi r6, r8, 4
/* 8035F0FC 003286BC  38 63 00 01 */	addi r3, r3, 0x1
/* 8035F100 003286C0  7D 00 4A 78 */	xor r0, r8, r9
/* 8035F104 003286C4  55 25 E1 3E */	srwi r5, r9, 4
/* 8035F108 003286C8  54 00 0E FC */	clrlslwi r0, r0, 28, 1
...
/* 8035F118 003286D8  54 00 0E FC */	clrlslwi r0, r0, 28, 1
...
/* 8035F128 003286E8  42 00 FF CC */	bdnz .L_8035F0F4
.L_8035F12C:
/* 8035F12C 003286EC  55 03 04 3E */	clrlwi r3, r8, 16
/* 8035F130 003286F0  4E 80 00 20 */	blr
.endfn NETCalcCRC16
/* 8035F134 003286F4  00 00 00 00 */	.4byte 0x00000000 /* invalid */
