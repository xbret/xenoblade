...
/* 80353F64 0031D524  7C 70 FA A6 */	mfspr r3, HID0
/* 80353F68 0031D528  60 63 40 00 */	ori r3, r3, 0x4000
/* 80353F6C 0031D52C  7C 70 FB A6 */	mtspr HID0, r3
/* 80353F70 0031D530  4E 80 00 20 */	blr
.endfn DCEnable
/* 80353F74 0031D534  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 80353F78 0031D538  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 80353F7C 0031D53C  00 00 00 00 */	.4byte 0x00000000 /* invalid */

.fn DCInvalidateRange, global
/* 80353F80 0031D540  28 04 00 00 */	cmplwi r4, 0x0
/* 80353F84 0031D544  4C 81 00 20 */	blelr
/* 80353F88 0031D548  54 65 06 FE */	clrlwi r5, r3, 27
...
.L_80353F9C:
/* 80353F9C 0031D55C  7C 00 1B AC */	dcbi r0, r3
...
/* 80353FAC 0031D56C  00 00 00 00 */	.4byte 0x00000000 /* invalid */

.fn DCFlushRange, global
/* 80353FB0 0031D570  28 04 00 00 */	cmplwi r4, 0x0
/* 80353FB4 0031D574  4C 81 00 20 */	blelr
/* 80353FB8 0031D578  54 65 06 FE */	clrlwi r5, r3, 27
...
.L_80353FCC:
/* 80353FCC 0031D58C  7C 00 18 AC */	dcbf r0, r3
...
/* 80353FE0 0031D5A0  28 04 00 00 */	cmplwi r4, 0x0
/* 80353FE4 0031D5A4  4C 81 00 20 */	blelr
/* 80353FE8 0031D5A8  54 65 06 FE */	clrlwi r5, r3, 27
...
.L_80353FFC:
/* 80353FFC 0031D5BC  7C 00 18 6C */	dcbst r0, r3
...
/* 80354010 0031D5D0  28 04 00 00 */	cmplwi r4, 0x0
/* 80354014 0031D5D4  4C 81 00 20 */	blelr
/* 80354018 0031D5D8  54 65 06 FE */	clrlwi r5, r3, 27
...
.L_8035402C:
/* 8035402C 0031D5EC  7C 00 18 AC */	dcbf r0, r3
...
/* 8035403C 0031D5FC  00 00 00 00 */	.4byte 0x00000000 /* invalid */

.fn DCStoreRangeNoSync, global
/* 80354040 0031D600  28 04 00 00 */	cmplwi r4, 0x0
/* 80354044 0031D604  4C 81 00 20 */	blelr
/* 80354048 0031D608  54 65 06 FE */	clrlwi r5, r3, 27
...
.L_8035405C:
/* 8035405C 0031D61C  7C 00 18 6C */	dcbst r0, r3
...
/* 8035406C 0031D62C  00 00 00 00 */	.4byte 0x00000000 /* invalid */

.fn DCZeroRange, global
/* 80354070 0031D630  28 04 00 00 */	cmplwi r4, 0x0
/* 80354074 0031D634  4C 81 00 20 */	blelr
/* 80354078 0031D638  54 65 06 FE */	clrlwi r5, r3, 27
...
.L_8035408C:
/* 8035408C 0031D64C  7C 00 1F EC */	dcbz r0, r3
...
.endfn DCZeroRange
/* 8035409C 0031D65C  00 00 00 00 */	.4byte 0x00000000 /* invalid */

.fn ICInvalidateRange, global
/* 803540A0 0031D660  28 04 00 00 */	cmplwi r4, 0x0
/* 803540A4 0031D664  4C 81 00 20 */	blelr
/* 803540A8 0031D668  54 65 06 FE */	clrlwi r5, r3, 27
...
.L_803540BC:
/* 803540BC 0031D67C  7C 00 1F AC */	icbi r0, r3
/* 803540C0 0031D680  38 63 00 20 */	addi r3, r3, 0x20
/* 803540C4 0031D684  42 00 FF F8 */	bdnz .L_803540BC
/* 803540C8 0031D688  7C 00 04 AC */	sync
/* 803540CC 0031D68C  4C 00 01 2C */	isync
/* 803540D0 0031D690  4E 80 00 20 */	blr
.endfn ICInvalidateRange
/* 803540D4 0031D694  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 803540D8 0031D698  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 803540DC 0031D69C  00 00 00 00 */	.4byte 0x00000000 /* invalid */

.fn ICFlashInvalidate, global
/* 803540E0 0031D6A0  7C 70 FA A6 */	mfspr r3, HID0
/* 803540E4 0031D6A4  60 63 08 00 */	ori r3, r3, 0x800
/* 803540E8 0031D6A8  7C 70 FB A6 */	mtspr HID0, r3
/* 803540EC 0031D6AC  4E 80 00 20 */	blr
.endfn ICFlashInvalidate

.fn ICEnable, global
/* 803540F0 0031D6B0  4C 00 01 2C */	isync
/* 803540F4 0031D6B4  7C 70 FA A6 */	mfspr r3, HID0
/* 803540F8 0031D6B8  60 63 80 00 */	ori r3, r3, 0x8000
/* 803540FC 0031D6BC  7C 70 FB A6 */	mtspr HID0, r3
/* 80354100 0031D6C0  4E 80 00 20 */	blr
.endfn ICEnable
/* 80354104 0031D6C4  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 80354108 0031D6C8  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 8035410C 0031D6CC  00 00 00 00 */	.4byte 0x00000000 /* invalid */
...
/* 8035411C 0031D6DC  3C 60 80 00 */	lis r3, 0x8000
/* 80354120 0031D6E0  38 80 04 00 */	li r4, 0x400
/* 80354124 0031D6E4  7C 89 03 A6 */	mtctr r4
.L_80354128:
/* 80354128 0031D6E8  7C 00 1A 2C */	dcbt r0, r3
/* 8035412C 0031D6EC  7C 00 18 6C */	dcbst r0, r3
/* 80354130 0031D6F0  38 63 00 20 */	addi r3, r3, 0x20
/* 80354134 0031D6F4  42 00 FF F4 */	bdnz .L_80354128
/* 80354138 0031D6F8  7C 98 E2 A6 */	mfspr r4, HID2
/* 8035413C 0031D6FC  64 84 10 0F */	oris r4, r4, 0x100f
/* 80354140 0031D700  7C 98 E3 A6 */	mtspr HID2, r4
...
/* 80354174 0031D734  3C 60 E0 00 */	lis r3, 0xe000
/* 80354178 0031D738  60 63 00 02 */	ori r3, r3, 0x2
...
/* 8035418C 0031D74C  3C 60 E0 00 */	lis r3, 0xe000
/* 80354190 0031D750  38 C0 02 00 */	li r6, 0x200
/* 80354194 0031D754  7C C9 03 A6 */	mtctr r6
/* 80354198 0031D758  38 C0 00 00 */	li r6, 0x0
.L_8035419C:
/* 8035419C 0031D75C  10 06 1F EC */	dcbz_l r6, r3
/* 803541A0 0031D760  38 63 00 20 */	addi r3, r3, 0x20
...
.endfn __LCEnable
/* 803541DC 0031D79C  00 00 00 00 */	.4byte 0x00000000 /* invalid */
...
.endfn LCEnable
/* 80354218 0031D7D8  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 8035421C 0031D7DC  00 00 00 00 */	.4byte 0x00000000 /* invalid */

.fn LCDisable, global
/* 80354220 0031D7E0  3C 60 E0 00 */	lis r3, 0xe000
/* 80354224 0031D7E4  38 80 02 00 */	li r4, 0x200
/* 80354228 0031D7E8  7C 89 03 A6 */	mtctr r4
.L_8035422C:
/* 8035422C 0031D7EC  7C 00 1B AC */	dcbi r0, r3
/* 80354230 0031D7F0  38 63 00 20 */	addi r3, r3, 0x20
/* 80354234 0031D7F4  42 00 FF F8 */	bdnz .L_8035422C
/* 80354238 0031D7F8  7C 98 E2 A6 */	mfspr r4, HID2
/* 8035423C 0031D7FC  54 84 01 04 */	rlwinm r4, r4, 0, 4, 2
/* 80354240 0031D800  7C 98 E3 A6 */	mtspr HID2, r4
/* 80354244 0031D804  4E 80 00 20 */	blr
.endfn LCDisable
/* 80354248 0031D808  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 8035424C 0031D80C  00 00 00 00 */	.4byte 0x00000000 /* invalid */

.fn LCLoadBlocks, global
/* 80354250 0031D810  54 A6 F6 FE */	extrwi r6, r5, 5, 25
/* 80354254 0031D814  54 84 00 FE */	clrlwi r4, r4, 3
/* 80354258 0031D818  7C C6 23 78 */	or r6, r6, r4
/* 8035425C 0031D81C  7C DA E3 A6 */	mtspr DMA_U, r6
/* 80354260 0031D820  54 A6 17 3A */	clrlslwi r6, r5, 30, 2
/* 80354264 0031D824  7C C6 1B 78 */	or r6, r6, r3
/* 80354268 0031D828  60 C6 00 12 */	ori r6, r6, 0x12
/* 8035426C 0031D82C  7C DB E3 A6 */	mtspr DMA_L, r6
/* 80354270 0031D830  4E 80 00 20 */	blr
.endfn LCLoadBlocks
/* 80354274 0031D834  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 80354278 0031D838  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 8035427C 0031D83C  00 00 00 00 */	.4byte 0x00000000 /* invalid */

.fn LCStoreBlocks, global
/* 80354280 0031D840  54 A6 F6 FE */	extrwi r6, r5, 5, 25
/* 80354284 0031D844  54 63 00 FE */	clrlwi r3, r3, 3
/* 80354288 0031D848  7C C6 1B 78 */	or r6, r6, r3
/* 8035428C 0031D84C  7C DA E3 A6 */	mtspr DMA_U, r6
/* 80354290 0031D850  54 A6 17 3A */	clrlslwi r6, r5, 30, 2
/* 80354294 0031D854  7C C6 23 78 */	or r6, r6, r4
/* 80354298 0031D858  60 C6 00 02 */	ori r6, r6, 0x2
/* 8035429C 0031D85C  7C DB E3 A6 */	mtspr DMA_L, r6
/* 803542A0 0031D860  4E 80 00 20 */	blr
.endfn LCStoreBlocks
/* 803542A4 0031D864  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 803542A8 0031D868  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 803542AC 0031D86C  00 00 00 00 */	.4byte 0x00000000 /* invalid */
...
/* 80354350 0031D910  7C 98 E2 A6 */	mfspr r4, HID2
/* 80354354 0031D914  54 83 47 3E */	extrwi r3, r4, 4, 4
/* 80354358 0031D918  4E 80 00 20 */	blr
.endfn LCQueueLength
/* 8035435C 0031D91C  00 00 00 00 */	.4byte 0x00000000 /* invalid */

.fn LCQueueWait, global
/* 80354360 0031D920  7C 98 E2 A6 */	mfspr r4, HID2
/* 80354364 0031D924  54 84 47 3E */	extrwi r4, r4, 4, 4
/* 80354368 0031D928  7C 04 18 00 */	cmpw r4, r3
/* 8035436C 0031D92C  41 81 FF F4 */	bgt LCQueueWait
/* 80354370 0031D930  4E 80 00 20 */	blr
.endfn LCQueueWait
/* 80354374 0031D934  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 80354378 0031D938  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 8035437C 0031D93C  00 00 00 00 */	.4byte 0x00000000 /* invalid */
...
.L_803543C0:
/* 803543C0 0031D980  3F E0 80 55 */	lis r31, "@878"@ha
/* 803543C4 0031D984  90 61 00 08 */	stw r3, 0x8(r1)
/* 803543C8 0031D988  3B FF 18 38 */	addi r31, r31, "@878"@l
...
/* 803543F4 0031D9B4  4C C6 31 82 */	crclr 4*cr1+eq
...
/* 80354440 0031DA00  4C C6 31 82 */	crclr 4*cr1+eq
/* 80354444 0031DA04  48 00 0A AD */	bl OSReport
/* 80354448 0031DA08  38 7F 00 D4 */	addi r3, r31, 0xd4
/* 8035444C 0031DA0C  4C C6 31 82 */	crclr 4*cr1+eq
...
/* 80354460 0031DA20  4C C6 31 82 */	crclr 4*cr1+eq
...
/* 803544C8 0031DA88  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 803544CC 0031DA8C  00 00 00 00 */	.4byte 0x00000000 /* invalid */
...
/* 803544E0 0031DAA0  3F E0 80 55 */	lis r31, "@878"@ha
/* 803544E4 0031DAA4  3B FF 18 38 */	addi r31, r31, "@878"@l
/* 803544E8 0031DAA8  93 C1 00 08 */	stw r30, 0x8(r1)
/* 803544EC 0031DAAC  4B F8 66 85 */	bl PPCMfhid0
/* 803544F0 0031DAB0  54 60 04 21 */	rlwinm. r0, r3, 0, 16, 16
...
/* 80354500 0031DAC0  4C C6 31 82 */	crclr 4*cr1+eq
/* 80354504 0031DAC4  4B FB 4C BD */	bl DBPrintf
.L_80354508:
/* 80354508 0031DAC8  4B F8 66 69 */	bl PPCMfhid0
/* 8035450C 0031DACC  54 60 04 63 */	rlwinm. r0, r3, 0, 17, 17
...
/* 8035451C 0031DADC  4C C6 31 82 */	crclr 4*cr1+eq
/* 80354520 0031DAE0  4B FB 4C A1 */	bl DBPrintf
.L_80354524:
/* 80354524 0031DAE4  4B F8 66 6D */	bl PPCMfl2cr
/* 80354528 0031DAE8  54 60 00 01 */	clrrwi. r0, r3, 31
...
/* 80354538 0031DAF8  7C 00 04 AC */	sync
/* 8035453C 0031DAFC  38 60 00 30 */	li r3, 0x30
/* 80354540 0031DB00  4B F8 66 21 */	bl PPCMtmsr
/* 80354544 0031DB04  7C 00 04 AC */	sync
/* 80354548 0031DB08  7C 00 04 AC */	sync
...
/* 80354558 0031DB18  7C 00 04 AC */	sync
/* 8035455C 0031DB1C  7C 00 04 AC */	sync
...
/* 8035456C 0031DB2C  7C 00 04 AC */	sync
...
/* 803545E8 0031DBA8  4C C6 31 82 */	crclr 4*cr1+eq
...
/* 803545F8 0031DBB8  83 C1 00 08 */	lwz r30, 0x8(r1)
