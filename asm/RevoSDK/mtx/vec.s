...
/* 8034E08C 0031764C  F0 C5 00 00 */	psq_st f6, 0(r5), 0, qr0
/* 8034E090 00317650  E0 63 80 08 */	psq_l f3, 8(r3), 1, qr0
/* 8034E094 00317654  E0 A4 80 08 */	psq_l f5, 8(r4), 1, qr0
...
/* 8034E15C 0031771C  E0 A3 00 00 */	psq_l f5, 0(r3), 0, qr0
/* 8034E160 00317720  E0 84 00 00 */	psq_l f4, 0(r4), 0, qr0
...
/* 8034E180 00317740  C0 64 00 08 */	lfs f3, 8(r4)
...
/* 8034E19C 0031775C  F1 25 80 00 */	psq_st f9, 0(r5), 1, qr0
...
/* 8034E1BC 0031777C  C0 23 00 04 */	lfs f1, 4(r3)
/* 8034E1C0 00317780  C0 03 00 08 */	lfs f0, 8(r3)
...
/* 8034E264 00317824  90 1F 00 04 */	stw r0, 4(r31)
/* 8034E268 00317828  90 7F 00 00 */	stw r3, 0(r31)
/* 8034E26C 0031782C  80 01 00 10 */	lwz r0, 0x10(r1)
/* 8034E270 00317830  90 1F 00 08 */	stw r0, 8(r31)
.L_8034E274:
...
/* 8034E2A0 00317860  E0 64 00 08 */	psq_l f3, 8(r4), 0, qr0
...
.obj float_8066C160, global
	.float 0.5
.endobj float_8066C160


.obj float_8066C164, global
	.float 3 #0x40400000
.endobj float_8066C164


.obj float_8066C168, global
	.float 0
	.4byte 0
.endobj float_8066C168