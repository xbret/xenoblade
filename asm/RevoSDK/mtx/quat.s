...
/* 8034E2C4 00317884  E0 23 00 08 */	psq_l f1, 0x8(r3), 0, qr0
/* 8034E2C8 00317888  10 A0 00 50 */	ps_neg f5, f0
/* 8034E2CC 0031788C  E0 44 00 00 */	psq_l f2, 0x0(r4), 0, qr0
/* 8034E2D0 00317890  10 C0 08 50 */	ps_neg f6, f1
/* 8034E2D4 00317894  E0 64 00 08 */	psq_l f3, 0x8(r4), 0, qr0
...
/* 8034E310 003178D0  F0 E5 00 00 */	psq_st f7, 0x0(r5), 0, qr0
/* 8034E314 003178D4  F0 A5 00 08 */	psq_st f5, 0x8(r5), 0, qr0
/* 8034E318 003178D8  4E 80 00 20 */	blr
.endfn PSQUATMultiply
/* 8034E31C 003178DC  00 00 00 00 */	.4byte 0x00000000 /* invalid */

.fn PSQUATScale, global
/* 8034E320 003178E0  E0 03 00 00 */	psq_l f0, 0x0(r3), 0, qr0
/* 8034E324 003178E4  E0 43 00 08 */	psq_l f2, 0x8(r3), 0, qr0
/* 8034E328 003178E8  10 00 00 58 */	ps_muls0 f0, f0, f1
/* 8034E32C 003178EC  10 42 00 58 */	ps_muls0 f2, f2, f1
/* 8034E330 003178F0  F0 04 00 00 */	psq_st f0, 0x0(r4), 0, qr0
/* 8034E334 003178F4  F0 44 00 08 */	psq_st f2, 0x8(r4), 0, qr0
/* 8034E338 003178F8  4E 80 00 20 */	blr
.endfn PSQUATScale
/* 8034E33C 003178FC  00 00 00 00 */	.4byte 0x00000000 /* invalid */

.fn PSQUATDotProduct, global
/* 8034E340 00317900  E0 03 00 00 */	psq_l f0, 0x0(r3), 0, qr0
/* 8034E344 00317904  E0 24 00 00 */	psq_l f1, 0x0(r4), 0, qr0
/* 8034E348 00317908  E0 43 00 08 */	psq_l f2, 0x8(r3), 0, qr0
/* 8034E34C 0031790C  10 20 00 72 */	ps_mul f1, f0, f1
/* 8034E350 00317910  E0 04 00 08 */	psq_l f0, 0x8(r4), 0, qr0
...
/* 8034E3A8 00317968  F0 04 00 00 */	psq_st f0, 0x0(r4), 0, qr0
/* 8034E3AC 0031796C  F0 24 00 08 */	psq_st f1, 0x8(r4), 0, qr0
/* 8034E3B0 00317970  4E 80 00 20 */	blr
.endfn PSQUATNormalize
/* 8034E3B4 00317974  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 8034E3B8 00317978  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 8034E3BC 0031797C  00 00 00 00 */	.4byte 0x00000000 /* invalid */
...
/* 8034E3D4 00317994  C0 64 00 00 */	lfs f3, 0x0(r4)
...
/* 8034E3F4 003179B4  80 66 00 04 */	lwz r3, 0x4(r6)
/* 8034E3F8 003179B8  80 06 00 08 */	lwz r0, 0x8(r6)
/* 8034E3FC 003179BC  EC 20 08 2A */	fadds f1, f0, f1
/* 8034E400 003179C0  C0 02 BD F8 */	lfs f0, lbl_8066C178@sda21(r2)
...
/* 8034E418 003179D8  C0 02 BD F4 */	lfs f0, lbl_8066C174@sda21(r2)
...
/* 8034E428 003179E8  C0 C2 BD FC */	lfs f6, lbl_8066C17C@sda21(r2)
...
/* 8034E468 00317A28  D0 7F 00 00 */	stfs f3, 0x0(r31)
/* 8034E46C 00317A2C  D0 3F 00 04 */	stfs f1, 0x4(r31)
/* 8034E470 00317A30  D0 1F 00 08 */	stfs f0, 0x8(r31)
/* 8034E474 00317A34  48 00 01 00 */	b .L_8034E574
.L_8034E478:
/* 8034E478 00317A38  FC 02 18 40 */	fcmpo cr0, f2, f3
/* 8034E47C 00317A3C  38 A0 00 00 */	li r5, 0x0
/* 8034E480 00317A40  40 81 00 08 */	ble .L_8034E488
/* 8034E484 00317A44  38 A0 00 01 */	li r5, 0x1
.L_8034E488:
...
/* 8034E4A4 00317A64  38 A0 00 02 */	li r5, 0x2
.L_8034E4A8:
...
/* 8034E4BC 00317A7C  C0 02 BD F4 */	lfs f0, lbl_8066C174@sda21(r2)
...
/* 8034E4FC 00317ABC  C0 42 BD FC */	lfs f2, lbl_8066C17C@sda21(r2)
/* 8034E500 00317AC0  C0 02 BD F8 */	lfs f0, lbl_8066C178@sda21(r2)
/* 8034E504 00317AC4  38 61 00 08 */	addi r3, r1, 0x8
...
/* 8034E520 00317AE0  38 61 00 08 */	addi r3, r1, 0x8
...
/* 8034E558 00317B18  C0 41 00 08 */	lfs f2, 0x8(r1)
...
/* 8034E568 00317B28  D0 5F 00 00 */	stfs f2, 0x0(r31)
/* 8034E56C 00317B2C  D0 3F 00 04 */	stfs f1, 0x4(r31)
/* 8034E570 00317B30  D0 1F 00 08 */	stfs f0, 0x8(r31)
.L_8034E574:
...
.endfn C_QUATMtx
/* 8034E58C 00317B4C  00 00 00 00 */	.4byte 0x00000000 /* invalid */

.fn C_QUATSlerp, global
/* 8034E590 00317B50  94 21 FF A0 */	stwu r1, -0x60(r1)
/* 8034E594 00317B54  7C 08 02 A6 */	mflr r0
/* 8034E598 00317B58  C0 83 00 00 */	lfs f4, 0x0(r3)
/* 8034E59C 00317B5C  90 01 00 64 */	stw r0, 0x64(r1)
/* 8034E5A0 00317B60  C0 64 00 00 */	lfs f3, 0x0(r4)
/* 8034E5A4 00317B64  DB E1 00 50 */	stfd f31, 0x50(r1)
/* 8034E5A8 00317B68  C0 43 00 04 */	lfs f2, 0x4(r3)
/* 8034E5AC 00317B6C  EC 64 00 F2 */	fmuls f3, f4, f3
/* 8034E5B0 00317B70  F3 E1 00 58 */	psq_st f31, 0x58(r1), 0, qr0
/* 8034E5B4 00317B74  FF E0 08 90 */	fmr f31, f1
/* 8034E5B8 00317B78  C0 04 00 04 */	lfs f0, 0x4(r4)
/* 8034E5BC 00317B7C  DB C1 00 40 */	stfd f30, 0x40(r1)
/* 8034E5C0 00317B80  EC 02 00 32 */	fmuls f0, f2, f0
/* 8034E5C4 00317B84  C0 83 00 08 */	lfs f4, 0x8(r3)
/* 8034E5C8 00317B88  F3 C1 00 48 */	psq_st f30, 0x48(r1), 0, qr0
/* 8034E5CC 00317B8C  C0 44 00 08 */	lfs f2, 0x8(r4)
...
/* 8034E5E0 00317BA0  F3 A1 00 38 */	psq_st f29, 0x38(r1), 0, qr0
...
/* 8034E5F0 00317BB0  C0 02 BD F8 */	lfs f0, lbl_8066C178@sda21(r2)
/* 8034E5F4 00317BB4  EC 44 10 2A */	fadds f2, f4, f2
/* 8034E5F8 00317BB8  F3 81 00 28 */	psq_st f28, 0x28(r1), 0, qr0
/* 8034E5FC 00317BBC  C3 C2 BD F4 */	lfs f30, lbl_8066C174@sda21(r2)
...
.L_8034E62C:
/* 8034E62C 00317BEC  C0 02 BE 04 */	lfs f0, lbl_8066C184@sda21(r2)
/* 8034E630 00317BF0  FC 02 00 40 */	fcmpo cr0, f2, f0
/* 8034E634 00317BF4  4C 40 13 82 */	cror eq, lt, eq
...
/* 8034E650 00317C10  C0 02 BD F4 */	lfs f0, lbl_8066C174@sda21(r2)
...
.L_8034E684:
/* 8034E684 00317C44  C0 02 BD F4 */	lfs f0, lbl_8066C174@sda21(r2)
/* 8034E688 00317C48  EF DE 00 72 */	fmuls f30, f30, f1
/* 8034E68C 00317C4C  EF E0 08 28 */	fsubs f31, f0, f1
.L_8034E690:
/* 8034E690 00317C50  C0 1D 00 00 */	lfs f0, 0x0(r29)
/* 8034E694 00317C54  C0 5E 00 00 */	lfs f2, 0x0(r30)
/* 8034E698 00317C58  C0 3D 00 04 */	lfs f1, 0x4(r29)
/* 8034E69C 00317C5C  EC FF 00 32 */	fmuls f7, f31, f0
/* 8034E6A0 00317C60  C0 1E 00 04 */	lfs f0, 0x4(r30)
/* 8034E6A4 00317C64  EC DE 00 B2 */	fmuls f6, f30, f2
/* 8034E6A8 00317C68  C0 7D 00 08 */	lfs f3, 0x8(r29)
/* 8034E6AC 00317C6C  EC BF 00 72 */	fmuls f5, f31, f1
/* 8034E6B0 00317C70  EC 9E 00 32 */	fmuls f4, f30, f0
/* 8034E6B4 00317C74  C0 5E 00 08 */	lfs f2, 0x8(r30)
...
/* 8034E6CC 00317C8C  D0 DF 00 00 */	stfs f6, 0x0(r31)
...
/* 8034E6DC 00317C9C  D0 9F 00 04 */	stfs f4, 0x4(r31)
/* 8034E6E0 00317CA0  EC 43 10 2A */	fadds f2, f3, f2
/* 8034E6E4 00317CA4  EC 01 00 2A */	fadds f0, f1, f0
/* 8034E6E8 00317CA8  D0 5F 00 08 */	stfs f2, 0x8(r31)
/* 8034E6EC 00317CAC  D0 1F 00 0C */	stfs f0, 0xc(r31)
/* 8034E6F0 00317CB0  E3 E1 00 58 */	psq_l f31, 0x58(r1), 0, qr0
/* 8034E6F4 00317CB4  CB E1 00 50 */	lfd f31, 0x50(r1)
/* 8034E6F8 00317CB8  E3 C1 00 48 */	psq_l f30, 0x48(r1), 0, qr0
/* 8034E6FC 00317CBC  CB C1 00 40 */	lfd f30, 0x40(r1)
/* 8034E700 00317CC0  E3 A1 00 38 */	psq_l f29, 0x38(r1), 0, qr0
/* 8034E704 00317CC4  CB A1 00 30 */	lfd f29, 0x30(r1)
/* 8034E708 00317CC8  E3 81 00 28 */	psq_l f28, 0x28(r1), 0, qr0
