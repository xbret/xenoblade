...
/* 803627F4 0032BDB4  4C C6 31 82 */	crclr 6
/* 803627F8 0032BDB8  48 18 BC 9D */	bl OSPanic
lbl_803627FC:
/* 803627FC 0032BDBC  80 1F 00 08 */	lwz r0, 8(r31)
/* 80362800 0032BDC0  38 60 00 00 */	li r3, 0
/* 80362804 0032BDC4  38 A0 00 01 */	li r5, 1
/* 80362808 0032BDC8  7C 00 FA 14 */	add r0, r0, r31
/* 8036280C 0032BDCC  90 1F 00 08 */	stw r0, 8(r31)
/* 80362810 0032BDD0  48 00 00 A4 */	b lbl_803628B4
/* 80362814 0032BDD4  60 00 00 00 */	nop 
lbl_80362818:
/* 80362818 0032BDD8  80 9F 00 08 */	lwz r4, 8(r31)
/* 8036281C 0032BDDC  54 66 1B 78 */	rlwinm r6, r3, 3, 0xd, 0x1c
/* 80362820 0032BDE0  7C 04 30 2E */	lwzx r0, r4, r6
/* 80362824 0032BDE4  2C 00 00 00 */	cmpwi r0, 0
/* 80362828 0032BDE8  41 82 00 38 */	beq lbl_80362860
/* 8036282C 0032BDEC  7C 1F 02 14 */	add r0, r31, r0
/* 80362830 0032BDF0  7C 04 31 2E */	stwx r0, r4, r6
/* 80362834 0032BDF4  80 9F 00 08 */	lwz r4, 8(r31)
/* 80362838 0032BDF8  7C 84 30 2E */	lwzx r4, r4, r6
/* 8036283C 0032BDFC  88 04 00 23 */	lbz r0, 0x23(r4)
/* 80362840 0032BE00  2C 00 00 00 */	cmpwi r0, 0
/* 80362844 0032BE04  40 82 00 1C */	bne lbl_80362860
/* 80362848 0032BE08  80 04 00 08 */	lwz r0, 8(r4)
/* 8036284C 0032BE0C  7C 1F 02 14 */	add r0, r31, r0
/* 80362850 0032BE10  90 04 00 08 */	stw r0, 8(r4)
/* 80362854 0032BE14  80 9F 00 08 */	lwz r4, 8(r31)
/* 80362858 0032BE18  7C 84 30 2E */	lwzx r4, r4, r6
/* 8036285C 0032BE1C  98 A4 00 23 */	stb r5, 0x23(r4)
lbl_80362860:
/* 80362860 0032BE20  80 1F 00 08 */	lwz r0, 8(r31)
/* 80362864 0032BE24  7C 80 32 14 */	add r4, r0, r6
/* 80362868 0032BE28  80 04 00 04 */	lwz r0, 4(r4)
/* 8036286C 0032BE2C  2C 00 00 00 */	cmpwi r0, 0
/* 80362870 0032BE30  41 82 00 40 */	beq lbl_803628B0
/* 80362874 0032BE34  7C 1F 02 14 */	add r0, r31, r0
/* 80362878 0032BE38  90 04 00 04 */	stw r0, 4(r4)
/* 8036287C 0032BE3C  80 1F 00 08 */	lwz r0, 8(r31)
/* 80362880 0032BE40  7C 80 32 14 */	add r4, r0, r6
/* 80362884 0032BE44  80 84 00 04 */	lwz r4, 4(r4)
/* 80362888 0032BE48  88 04 00 02 */	lbz r0, 2(r4)
/* 8036288C 0032BE4C  2C 00 00 00 */	cmpwi r0, 0
/* 80362890 0032BE50  40 82 00 20 */	bne lbl_803628B0
/* 80362894 0032BE54  80 04 00 08 */	lwz r0, 8(r4)
/* 80362898 0032BE58  7C 1F 02 14 */	add r0, r31, r0
/* 8036289C 0032BE5C  90 04 00 08 */	stw r0, 8(r4)
/* 803628A0 0032BE60  80 1F 00 08 */	lwz r0, 8(r31)
/* 803628A4 0032BE64  7C 80 32 14 */	add r4, r0, r6
/* 803628A8 0032BE68  80 84 00 04 */	lwz r4, 4(r4)
/* 803628AC 0032BE6C  98 A4 00 02 */	stb r5, 2(r4)
lbl_803628B0:
/* 803628B0 0032BE70  38 63 00 01 */	addi r3, r3, 1
lbl_803628B4:
/* 803628B4 0032BE74  80 1F 00 04 */	lwz r0, 4(r31)
/* 803628B8 0032BE78  54 64 04 3E */	clrlwi r4, r3, 0x10
/* 803628BC 0032BE7C  7C 04 00 40 */	cmplw r4, r0
/* 803628C0 0032BE80  41 80 FF 58 */	blt lbl_80362818
...
/* 8036291C 0032BEDC  80 C3 00 04 */	lwz r6, 4(r3)
/* 80362920 0032BEE0  83 C3 00 08 */	lwz r30, 8(r3)
...
/* 80362944 0032BF04  80 89 00 08 */	lwz r4, 8(r9)
...
/* 80362954 0032BF14  A0 A9 00 02 */	lhz r5, 2(r9)
/* 80362958 0032BF18  A0 C9 00 00 */	lhz r6, 0(r9)
/* 8036295C 0032BF1C  54 0A 0F FE */	srwi r10, r0, 0x1f
...
/* 80362984 0032BF44  38 C0 00 00 */	li r6, 0
/* 80362988 0032BF48  90 81 00 0C */	stw r4, 0xc(r1)
/* 8036298C 0032BF4C  39 00 00 00 */	li r8, 0
...
/* 8036299C 0032BF5C  C8 01 00 08 */	lfd f0, 8(r1)
