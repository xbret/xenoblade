...
/* 8030954C 002D2B0C  80 8D B6 24 */	lwz r4, __DSP_curr_task@sda21(r13)
...
/* 803095A8 002D2B68  80 6D B6 24 */	lwz r3, __DSP_curr_task@sda21(r13)
...
/* 803095CC 002D2B8C  80 6D B6 24 */	lwz r3, __DSP_curr_task@sda21(r13)
...
.L_803095E8:
/* 803095E8 002D2BA8  80 0D B6 10 */	lwz r0, __DSP_rude_task_pending@sda21(r13)
/* 803095EC 002D2BAC  2C 00 00 00 */	cmpwi r0, 0
/* 803095F0 002D2BB0  41 82 00 98 */	beq .L_80309688
/* 803095F4 002D2BB4  80 0D B6 14 */	lwz r0, __DSP_rude_task@sda21(r13)
...
/* 8030961C 002D2BDC  90 0D B6 14 */	stw r0, __DSP_rude_task@sda21(r13)
/* 80309620 002D2BE0  80 6D B6 24 */	lwz r3, __DSP_curr_task@sda21(r13)
/* 80309624 002D2BE4  90 0D B6 10 */	stw r0, __DSP_rude_task_pending@sda21(r13)
...
/* 80309658 002D2C18  80 6D B6 24 */	lwz r3, __DSP_curr_task@sda21(r13)
/* 8030965C 002D2C1C  80 8D B6 14 */	lwz r4, __DSP_rude_task@sda21(r13)
/* 80309660 002D2C20  48 00 02 D1 */	bl __DSP_exec_task
/* 80309664 002D2C24  80 6D B6 24 */	lwz r3, __DSP_curr_task@sda21(r13)
/* 80309668 002D2C28  38 80 00 02 */	li r4, 2
/* 8030966C 002D2C2C  38 00 00 00 */	li r0, 0
/* 80309670 002D2C30  90 83 00 00 */	stw r4, 0(r3)
/* 80309674 002D2C34  80 6D B6 14 */	lwz r3, __DSP_rude_task@sda21(r13)
/* 80309678 002D2C38  90 6D B6 24 */	stw r3, __DSP_curr_task@sda21(r13)
/* 8030967C 002D2C3C  90 0D B6 14 */	stw r0, __DSP_rude_task@sda21(r13)
/* 80309680 002D2C40  90 0D B6 10 */	stw r0, __DSP_rude_task_pending@sda21(r13)
...
/* 80309694 002D2C54  80 0D B6 20 */	lwz r0, __DSP_first_task@sda21(r13)
...
/* 803096B8 002D2C78  80 6D B6 24 */	lwz r3, __DSP_curr_task@sda21(r13)
...
/* 803096EC 002D2CAC  80 6D B6 24 */	lwz r3, __DSP_curr_task@sda21(r13)
/* 803096F0 002D2CB0  80 8D B6 20 */	lwz r4, __DSP_first_task@sda21(r13)
/* 803096F4 002D2CB4  48 00 02 3D */	bl __DSP_exec_task
/* 803096F8 002D2CB8  80 6D B6 24 */	lwz r3, __DSP_curr_task@sda21(r13)
/* 803096FC 002D2CBC  38 00 00 02 */	li r0, 2
/* 80309700 002D2CC0  90 03 00 00 */	stw r0, 0(r3)
/* 80309704 002D2CC4  80 0D B6 20 */	lwz r0, __DSP_first_task@sda21(r13)
/* 80309708 002D2CC8  90 0D B6 24 */	stw r0, __DSP_curr_task@sda21(r13)
...
/* 80309728 002D2CE8  80 6D B6 24 */	lwz r3, __DSP_curr_task@sda21(r13)
/* 8030972C 002D2CEC  80 83 00 38 */	lwz r4, 0x38(r3)
/* 80309730 002D2CF0  48 00 02 01 */	bl __DSP_exec_task
/* 80309734 002D2CF4  80 6D B6 24 */	lwz r3, __DSP_curr_task@sda21(r13)
/* 80309738 002D2CF8  38 00 00 02 */	li r0, 2
/* 8030973C 002D2CFC  90 03 00 00 */	stw r0, 0(r3)
/* 80309740 002D2D00  80 6D B6 24 */	lwz r3, __DSP_curr_task@sda21(r13)
/* 80309744 002D2D04  80 03 00 38 */	lwz r0, 0x38(r3)
/* 80309748 002D2D08  90 0D B6 24 */	stw r0, __DSP_curr_task@sda21(r13)
/* 8030974C 002D2D0C  48 00 01 BC */	b .L_80309908
.L_80309750:
/* 80309750 002D2D10  80 0D B6 10 */	lwz r0, __DSP_rude_task_pending@sda21(r13)
/* 80309754 002D2D14  2C 00 00 00 */	cmpwi r0, 0
/* 80309758 002D2D18  41 82 00 78 */	beq .L_803097D0
/* 8030975C 002D2D1C  80 0D B6 14 */	lwz r0, __DSP_rude_task@sda21(r13)
...
/* 80309798 002D2D58  80 8D B6 14 */	lwz r4, __DSP_rude_task@sda21(r13)
/* 8030979C 002D2D5C  38 60 00 00 */	li r3, 0
/* 803097A0 002D2D60  48 00 01 91 */	bl __DSP_exec_task
/* 803097A4 002D2D64  80 6D B6 24 */	lwz r3, __DSP_curr_task@sda21(r13)
/* 803097A8 002D2D68  48 00 05 69 */	bl __DSP_remove_task
/* 803097AC 002D2D6C  80 6D B6 14 */	lwz r3, __DSP_rude_task@sda21(r13)
/* 803097B0 002D2D70  38 00 00 00 */	li r0, 0
/* 803097B4 002D2D74  90 6D B6 24 */	stw r3, __DSP_curr_task@sda21(r13)
/* 803097B8 002D2D78  90 0D B6 14 */	stw r0, __DSP_rude_task@sda21(r13)
/* 803097BC 002D2D7C  90 0D B6 10 */	stw r0, __DSP_rude_task_pending@sda21(r13)
/* 803097C0 002D2D80  48 00 01 48 */	b .L_80309908
.L_803097C4:
/* 803097C4 002D2D84  38 00 00 00 */	li r0, 0
/* 803097C8 002D2D88  90 0D B6 14 */	stw r0, __DSP_rude_task@sda21(r13)
/* 803097CC 002D2D8C  90 0D B6 10 */	stw r0, __DSP_rude_task_pending@sda21(r13)
.L_803097D0:
...
/* 803097DC 002D2D9C  80 0D B6 20 */	lwz r0, __DSP_first_task@sda21(r13)
...
/* 80309818 002D2DD8  80 6D B6 24 */	lwz r3, __DSP_curr_task@sda21(r13)
/* 8030981C 002D2DDC  38 00 00 03 */	li r0, 3
/* 80309820 002D2DE0  90 03 00 00 */	stw r0, 0(r3)
/* 80309824 002D2DE4  80 6D B6 24 */	lwz r3, __DSP_curr_task@sda21(r13)
...
/* 80309860 002D2E20  80 8D B6 24 */	lwz r4, __DSP_curr_task@sda21(r13)
/* 80309864 002D2E24  38 00 00 03 */	li r0, 3
/* 80309868 002D2E28  38 60 00 00 */	li r3, 0
/* 8030986C 002D2E2C  90 04 00 00 */	stw r0, 0(r4)
/* 80309870 002D2E30  80 8D B6 20 */	lwz r4, __DSP_first_task@sda21(r13)
/* 80309874 002D2E34  48 00 00 BD */	bl __DSP_exec_task
/* 80309878 002D2E38  80 0D B6 20 */	lwz r0, __DSP_first_task@sda21(r13)
/* 8030987C 002D2E3C  90 0D B6 24 */	stw r0, __DSP_curr_task@sda21(r13)
/* 80309880 002D2E40  80 6D B6 1C */	lwz r3, __DSP_last_task@sda21(r13)
...
/* 80309C70 002D3230  80 AD B6 20 */	lwz r5, __DSP_first_task@sda21(r13)
/* 80309C74 002D3234  2C 05 00 00 */	cmpwi r5, 0
/* 80309C78 002D3238  40 82 00 68 */	bne .L_80309CE0
/* 80309C7C 002D323C  90 6D B6 24 */	stw r3, __DSP_curr_task@sda21(r13)
/* 80309C80 002D3240  38 00 00 00 */	li r0, 0
/* 80309C84 002D3244  90 6D B6 1C */	stw r3, __DSP_last_task@sda21(r13)
/* 80309C88 002D3248  90 6D B6 20 */	stw r3, __DSP_first_task@sda21(r13)
...
/* 80309CCC 002D328C  90 6D B6 20 */	stw r3, __DSP_first_task@sda21(r13)
...
/* 80309CF0 002D32B0  80 8D B6 1C */	lwz r4, __DSP_last_task@sda21(r13)
...
/* 80309D00 002D32C0  80 0D B6 1C */	lwz r0, __DSP_last_task@sda21(r13)
/* 80309D04 002D32C4  90 03 00 3C */	stw r0, 0x3c(r3)
/* 80309D08 002D32C8  90 6D B6 1C */	stw r3, __DSP_last_task@sda21(r13)
...
/* 80309D20 002D32E0  80 0D B6 20 */	lwz r0, __DSP_first_task@sda21(r13)
...
/* 80309D38 002D32F8  90 6D B6 20 */	stw r3, __DSP_first_task@sda21(r13)
/* 80309D3C 002D32FC  90 83 00 3C */	stw r4, 0x3c(r3)
/* 80309D40 002D3300  4E 80 00 20 */	blr
.L_80309D44:
/* 80309D44 002D3304  90 8D B6 24 */	stw r4, __DSP_curr_task@sda21(r13)
/* 80309D48 002D3308  90 8D B6 1C */	stw r4, __DSP_last_task@sda21(r13)
/* 80309D4C 002D330C  90 8D B6 20 */	stw r4, __DSP_first_task@sda21(r13)
/* 80309D50 002D3310  4E 80 00 20 */	blr
.L_80309D54:
/* 80309D54 002D3314  80 0D B6 1C */	lwz r0, __DSP_last_task@sda21(r13)
...
/* 80309D64 002D3324  90 6D B6 1C */	stw r3, __DSP_last_task@sda21(r13)
/* 80309D68 002D3328  90 83 00 38 */	stw r4, 0x38(r3)
/* 80309D6C 002D332C  80 0D B6 20 */	lwz r0, __DSP_first_task@sda21(r13)
/* 80309D70 002D3330  90 0D B6 24 */	stw r0, __DSP_curr_task@sda21(r13)
/* 80309D74 002D3334  4E 80 00 20 */	blr
.L_80309D78:
/* 80309D78 002D3338  80 03 00 38 */	lwz r0, 0x38(r3)
/* 80309D7C 002D333C  90 0D B6 24 */	stw r0, __DSP_curr_task@sda21(r13)
