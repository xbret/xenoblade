...
/* 802D10B0 0029A670  93 C1 00 08 */	stw r30, 0x8(r1)
...
/* 802D10D0 0029A690  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 802D10E4 0029A6A4  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 802D10E8 0029A6A8  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 802D10EC 0029A6AC  00 00 00 00 */	.4byte 0x00000000 /* invalid */
...
/* 802D1104 0029A6C4  93 C1 00 08 */	stw r30, 0x8(r1)
/* 802D1108 0029A6C8  7C 7E 1B 78 */	mr r30, r3
/* 802D110C 0029A6CC  48 08 78 A5 */	bl OSDisableInterrupts
/* 802D1110 0029A6D0  3C E0 CC 00 */	lis r7, 0xcc00
/* 802D1114 0029A6D4  57 C5 84 3E */	srwi r5, r30, 16
/* 802D1118 0029A6D8  A0 C7 50 30 */	lhz r6, 0x5030(r7)
/* 802D111C 0029A6DC  57 C4 04 3E */	clrlwi r4, r30, 16
/* 802D1120 0029A6E0  57 E0 DC 3E */	extrwi r0, r31, 16, 11
/* 802D1124 0029A6E4  54 C6 00 24 */	clrrwi r6, r6, 13
...
/* 802D1134 0029A6F4  54 A5 06 DE */	rlwinm r5, r5, 0, 27, 15
...
/* 802D1144 0029A704  54 84 00 20 */	clrrwi r4, r4, 15
...
/* 802D115C 0029A71C  83 C1 00 08 */	lwz r30, 0x8(r1)
/* 802D1160 0029A720  7C 08 03 A6 */	mtlr r0
/* 802D1164 0029A724  38 21 00 10 */	addi r1, r1, 0x10
/* 802D1168 0029A728  4E 80 00 20 */	blr
.endfn AIInitDMA
/* 802D116C 0029A72C  00 00 00 00 */	.4byte 0x00000000 /* invalid */

.fn AIStartDMA, global
/* 802D1170 0029A730  3C 60 CC 00 */	lis r3, 0xcc00
/* 802D1174 0029A734  A0 03 50 36 */	lhz r0, 0x5036(r3)
...
.endfn AIStartDMA
/* 802D1184 0029A744  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 802D1188 0029A748  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 802D118C 0029A74C  00 00 00 00 */	.4byte 0x00000000 /* invalid */

.fn AIStopDMA, global
/* 802D1190 0029A750  3C 60 CC 00 */	lis r3, 0xcc00
/* 802D1194 0029A754  A0 03 50 36 */	lhz r0, 0x5036(r3)
/* 802D1198 0029A758  54 00 04 7E */	clrlwi r0, r0, 17
/* 802D119C 0029A75C  B0 03 50 36 */	sth r0, 0x5036(r3)
/* 802D11A0 0029A760  4E 80 00 20 */	blr
.endfn AIStopDMA
/* 802D11A4 0029A764  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 802D11A8 0029A768  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 802D11AC 0029A76C  00 00 00 00 */	.4byte 0x00000000 /* invalid */

.fn AIGetDMABytesLeft, global
/* 802D11B0 0029A770  3C 60 CC 00 */	lis r3, 0xcc00
/* 802D11B4 0029A774  A0 03 50 3A */	lhz r0, 0x503a(r3)
/* 802D11B8 0029A778  54 03 2B 34 */	clrlslwi r3, r0, 17, 5
/* 802D11BC 0029A77C  4E 80 00 20 */	blr
.endfn AIGetDMABytesLeft

.fn AIGetDMAStartAddr, global
/* 802D11C0 0029A780  3C 60 CC 00 */	lis r3, 0xcc00
/* 802D11C4 0029A784  A0 83 50 30 */	lhz r4, 0x5030(r3)
/* 802D11C8 0029A788  A0 03 50 32 */	lhz r0, 0x5032(r3)
/* 802D11CC 0029A78C  54 03 04 34 */	rlwinm r3, r0, 0, 16, 26
/* 802D11D0 0029A790  50 83 80 DE */	rlwimi r3, r4, 16, 3, 15
/* 802D11D4 0029A794  4E 80 00 20 */	blr
.endfn AIGetDMAStartAddr
/* 802D11D8 0029A798  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 802D11DC 0029A79C  00 00 00 00 */	.4byte 0x00000000 /* invalid */

.fn AIGetDMALength, global
/* 802D11E0 0029A7A0  3C 60 CC 00 */	lis r3, 0xcc00
/* 802D11E4 0029A7A4  A0 03 50 36 */	lhz r0, 0x5036(r3)
/* 802D11E8 0029A7A8  54 03 2B 34 */	clrlslwi r3, r0, 17, 5
...
.endfn AICheckInit
/* 802D11F8 0029A7B8  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 802D11FC 0029A7BC  00 00 00 00 */	.4byte 0x00000000 /* invalid */
...
/* 802D1220 0029A7E0  2C 00 00 01 */	cmpwi r0, 0x1
...
/* 802D1230 0029A7F0  3C 60 80 00 */	lis r3, 0x8000
/* 802D1234 0029A7F4  3C 80 43 1C */	lis r4, 0x431c
/* 802D1238 0029A7F8  80 03 00 F8 */	lwz r0, 0xf8(r3)
/* 802D123C 0029A7FC  38 E0 00 00 */	li r7, 0x0
/* 802D1240 0029A800  3C A0 10 62 */	lis r5, 0x1062
/* 802D1244 0029A804  38 84 DE 83 */	addi r4, r4, -0x217d
/* 802D1248 0029A808  54 06 F0 BE */	srwi r6, r0, 2
/* 802D124C 0029A80C  3C 60 00 01 */	lis r3, 0x1
/* 802D1250 0029A810  7C C4 30 16 */	mulhwu r6, r4, r6
/* 802D1254 0029A814  39 25 4D D3 */	addi r9, r5, 0x4dd3
/* 802D1258 0029A818  38 03 A4 28 */	addi r0, r3, -0x5bd8
/* 802D125C 0029A81C  90 ED B4 70 */	stw r7, lbl_806675F0@sda21(r13)
/* 802D1260 0029A820  38 83 A4 10 */	addi r4, r3, -0x5bf0
/* 802D1264 0029A824  38 63 F6 18 */	addi r3, r3, -0x9e8
/* 802D1268 0029A828  54 CA 8B FE */	srwi r10, r6, 15
/* 802D126C 0029A82C  90 ED B4 68 */	stw r7, lbl_806675E8@sda21(r13)
/* 802D1270 0029A830  7C CA 01 D6 */	mullw r6, r10, r0
/* 802D1274 0029A834  3F C0 CD 00 */	lis r30, 0xcd00
/* 802D1278 0029A838  90 ED B4 60 */	stw r7, lbl_806675E0@sda21(r13)
/* 802D127C 0029A83C  38 00 FF EA */	li r0, -0x16
...
/* 802D12D4 0029A894  80 7E 6C 00 */	lwz r3, 0x6c00(r30)
...
/* 802D12EC 0029A8AC  54 00 06 F2 */	rlwinm r0, r0, 0, 27, 25
...
/* 802D12FC 0029A8BC  54 00 D7 FE */	extrwi r0, r0, 1, 25
/* 802D1300 0029A8C0  68 00 00 01 */	xori r0, r0, 0x1
/* 802D1304 0029A8C4  2C 00 00 00 */	cmpwi r0, 0x0
/* 802D1308 0029A8C8  41 82 00 30 */	beq .L_802D1338
/* 802D130C 0029A8CC  80 1E 6C 00 */	lwz r0, 0x6c00(r30)
/* 802D1310 0029A8D0  54 00 06 B0 */	rlwinm r0, r0, 0, 26, 24
...
.L_802D1338:
/* 802D1338 0029A8F8  38 00 00 00 */	li r0, 0x0
...
/* 802D1348 0029A908  38 60 00 05 */	li r3, 0x5
...
/* 802D135C 0029A91C  38 00 00 01 */	li r0, 0x1
...
.L_802D13FC:
/* 802D13FC 0029A9BC  38 00 00 00 */	li r0, 0x0
/* 802D1400 0029A9C0  90 0D B4 4C */	stw r0, lbl_806675CC@sda21(r13)
.L_802D1404:
/* 802D1404 0029A9C4  38 61 00 08 */	addi r3, r1, 0x8
...
.endfn __AIDHandler
/* 802D1428 0029A9E8  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 802D142C 0029A9EC  00 00 00 00 */	.4byte 0x00000000 /* invalid */
...
/* 802D1450 0029AA10  90 25 00 00 */	stw r1, 0x0(r5)
/* 802D1454 0029AA14  3C A0 80 66 */	lis r5, lbl_806675FC@ha
/* 802D1458 0029AA18  38 A5 75 FC */	addi r5, r5, lbl_806675FC@l
/* 802D145C 0029AA1C  80 25 00 00 */	lwz r1, 0x0(r5)
/* 802D1460 0029AA20  38 21 FF F8 */	addi r1, r1, -0x8
...
/* 802D1474 0029AA34  80 25 00 00 */	lwz r1, 0x0(r5)
/* 802D1478 0029AA38  7C 2A 0B 78 */	mr r10, r1
/* 802D147C 0029AA3C  83 EA 00 0C */	lwz r31, 0xc(r10)
/* 802D1480 0029AA40  81 41 00 00 */	lwz r10, 0x0(r1)
/* 802D1484 0029AA44  80 0A 00 04 */	lwz r0, 0x4(r10)
...
/* 802D1494 0029AA54  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 802D1498 0029AA58  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 802D149C 0029AA5C  00 00 00 00 */	.4byte 0x00000000 /* invalid */
...
/* 802D14B4 0029AA74  38 80 00 00 */	li r4, 0x0
/* 802D14B8 0029AA78  38 60 00 00 */	li r3, 0x0
/* 802D14BC 0029AA7C  38 00 00 00 */	li r0, 0x0
/* 802D14C0 0029AA80  3B A0 00 00 */	li r29, 0x0
/* 802D14C4 0029AA84  3B C0 00 00 */	li r30, 0x0
...
/* 802D14D4 0029AA94  54 00 06 F2 */	rlwinm r0, r0, 0, 27, 25
...
/* 802D14E4 0029AAA4  54 00 07 FA */	rlwinm r0, r0, 0, 31, 29
/* 802D14E8 0029AAA8  90 1F 6C 00 */	stw r0, 0x6c00(r31)
/* 802D14EC 0029AAAC  80 1F 6C 00 */	lwz r0, 0x6c00(r31)
/* 802D14F0 0029AAB0  54 00 00 3C */	clrrwi r0, r0, 1
/* 802D14F4 0029AAB4  60 00 00 01 */	ori r0, r0, 0x1
...
/* 802D1528 0029AAE8  54 00 07 FA */	rlwinm r0, r0, 0, 31, 29
/* 802D152C 0029AAEC  60 00 00 02 */	ori r0, r0, 0x2
/* 802D1530 0029AAF0  90 1F 6C 00 */	stw r0, 0x6c00(r31)
/* 802D1534 0029AAF4  80 1F 6C 00 */	lwz r0, 0x6c00(r31)
/* 802D1538 0029AAF8  54 00 00 3C */	clrrwi r0, r0, 1
/* 802D153C 0029AAFC  60 00 00 01 */	ori r0, r0, 0x1
...
/* 802D1570 0029AB30  54 00 07 FA */	rlwinm r0, r0, 0, 31, 29
...
/* 802D1580 0029AB40  54 00 00 3C */	clrrwi r0, r0, 1
...
/* 802D15BC 0029AB7C  38 00 00 01 */	li r0, 0x1
...
/* 802D1614 0029ABD4  38 00 00 01 */	li r0, 0x1
/* 802D1618 0029ABD8  83 AD B4 5C */	lwz r29, lbl_806675DC@sda21(r13)
/* 802D161C 0029ABDC  48 00 00 08 */	b .L_802D1624
.L_802D1620:
/* 802D1620 0029ABE0  38 00 00 00 */	li r0, 0x0
.L_802D1624:
/* 802D1624 0029ABE4  2C 00 00 00 */	cmpwi r0, 0x0
