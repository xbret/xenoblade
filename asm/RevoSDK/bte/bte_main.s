...
/* 802DE098 002A7658  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 802DE09C 002A765C  00 00 00 00 */	.4byte 0x00000000 /* invalid */
...
/* 802DE0AC 002A766C  38 00 00 00 */	li r0, 0x0
...
/* 802DE0D4 002A7694  38 60 00 00 */	li r3, 0x0
...
/* 802DE0F0 002A76B0  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 802DE10C 002A76CC  3C A0 80 00 */	lis r5, 0x8000
/* 802DE110 002A76D0  3D 20 80 2E */	lis r9, BTUInterruptHandler@ha
/* 802DE114 002A76D4  80 05 00 F8 */	lwz r0, 0xf8(r5)
/* 802DE118 002A76D8  3C C0 10 62 */	lis r6, 0x1062
/* 802DE11C 002A76DC  7C 65 1B 78 */	mr r5, r3
/* 802DE120 002A76E0  39 29 E0 80 */	addi r9, r9, BTUInterruptHandler@l
/* 802DE124 002A76E4  38 66 4D D3 */	addi r3, r6, 0x4dd3
...
/* 802DE138 002A76F8  38 E0 00 00 */	li r7, 0x0
/* 802DE13C 002A76FC  54 08 D9 7C */	rlwinm r8, r0, 27, 5, 30
/* 802DE140 002A7700  48 07 4F B1 */	bl OSSetPeriodicAlarm
/* 802DE144 002A7704  38 60 00 00 */	li r3, 0x0
...
.endfn BTA_Init
/* 802DE17C 002A773C  00 00 00 00 */	.4byte 0x00000000 /* invalid */
...
.endfn BTA_CleanUp
/* 802DE1B4 002A7774  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 802DE1B8 002A7778  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 802DE1BC 002A777C  00 00 00 00 */	.4byte 0x00000000 /* invalid */

.fn bta_usb_close_evt, global
/* 802DE1C0 002A7780  81 8D B5 EC */	lwz r12, lbl_8066776C@sda21(r13)
/* 802DE1C4 002A7784  2C 0C 00 00 */	cmpwi r12, 0x0
/* 802DE1C8 002A7788  4D 82 00 20 */	beqlr
/* 802DE1CC 002A778C  7C 60 07 75 */	extsb. r0, r3
/* 802DE1D0 002A7790  41 80 00 10 */	blt .L_802DE1E0
/* 802DE1D4 002A7794  38 60 00 00 */	li r3, 0x0
/* 802DE1D8 002A7798  7D 89 03 A6 */	mtctr r12
/* 802DE1DC 002A779C  4E 80 04 20 */	bctr
.L_802DE1E0:
/* 802DE1E0 002A77A0  38 60 00 01 */	li r3, 0x1
