...
/* 802E9F18 002B34D8  40 82 00 50 */	bne lbl_802E9F68
/* 802E9F1C 002B34DC  54 60 07 BD */	rlwinm. r0, r3, 0, 0x1e, 0x1e
/* 802E9F20 002B34E0  41 82 00 28 */	beq lbl_802E9F48
/* 802E9F24 002B34E4  2C 05 00 00 */	cmpwi r5, 0
/* 802E9F28 002B34E8  40 82 00 0C */	bne lbl_802E9F34
...
/* 802E9FA0 002B3560  41 80 00 08 */	blt lbl_802E9FA8
/* 802E9FA4 002B3564  3B 60 00 80 */	li r27, 0x80
lbl_802E9FA8:
/* 802E9FA8 002B3568  2C 05 00 00 */	cmpwi r5, 0
/* 802E9FAC 002B356C  40 82 00 0C */	bne lbl_802E9FB8
/* 802E9FB0 002B3570  38 60 00 05 */	li r3, 5
/* 802E9FB4 002B3574  48 00 01 80 */	b lbl_802EA134
lbl_802E9FB8:
...
/* 802E9FD8 002B3598  41 82 00 1C */	beq lbl_802E9FF4
...
/* 802E9FF0 002B35B0  41 82 00 14 */	beq lbl_802EA004
lbl_802E9FF4:
...
/* 802EA000 002B35C0  41 80 FF D0 */	blt lbl_802E9FD0
lbl_802EA004:
/* 802EA004 002B35C4  57 BE 06 3E */	clrlwi r30, r29, 0x18
/* 802EA008 002B35C8  2C 1E 00 04 */	cmpwi r30, 4
/* 802EA00C 002B35CC  40 82 00 0C */	bne lbl_802EA018
/* 802EA010 002B35D0  38 60 00 07 */	li r3, 7
/* 802EA014 002B35D4  48 00 01 20 */	b lbl_802EA134
lbl_802EA018:
...
/* 802EA030 002B35F0  41 82 00 30 */	beq lbl_802EA060
/* 802EA034 002B35F4  3B 43 FF FF */	addi r26, r3, -1
/* 802EA038 002B35F8  4B FF D9 FD */	bl func_802E7A34
...
/* 802EA054 002B3614  40 82 00 0C */	bne lbl_802EA060
/* 802EA058 002B3618  38 60 00 04 */	li r3, 4
/* 802EA05C 002B361C  48 00 00 D8 */	b lbl_802EA134
lbl_802EA060:
...
/* 802EA06C 002B362C  40 82 00 30 */	bne lbl_802EA09C
/* 802EA070 002B3630  2C 03 00 00 */	cmpwi r3, 0
/* 802EA074 002B3634  41 82 00 20 */	beq lbl_802EA094
...
/* 802EA084 002B3644  41 80 00 18 */	blt lbl_802EA09C
/* 802EA088 002B3648  A0 1C 00 02 */	lhz r0, 2(r28)
/* 802EA08C 002B364C  7C 00 18 40 */	cmplw r0, r3
/* 802EA090 002B3650  41 81 00 0C */	bgt lbl_802EA09C
lbl_802EA094:
/* 802EA094 002B3654  38 60 00 00 */	li r3, 0
/* 802EA098 002B3658  48 00 00 9C */	b lbl_802EA134
lbl_802EA09C:
/* 802EA09C 002B365C  28 1B 00 80 */	cmplwi r27, 0x80
/* 802EA0A0 002B3660  41 82 00 54 */	beq lbl_802EA0F4
...
/* 802EA0BC 002B367C  41 82 00 38 */	beq lbl_802EA0F4
...
/* 802EA0FC 002B36BC  41 82 00 20 */	beq lbl_802EA11C
/* 802EA100 002B36C0  28 00 00 04 */	cmplwi r0, 4
/* 802EA104 002B36C4  41 82 00 18 */	beq lbl_802EA11C
...
/* 802EA188 002B3748  41 82 00 1C */	beq lbl_802EA1A4
...
/* 802EA1A0 002B3760  41 82 00 14 */	beq lbl_802EA1B4
lbl_802EA1A4:
...
/* 802EA1B0 002B3770  41 80 FF D0 */	blt lbl_802EA180
lbl_802EA1B4:
/* 802EA1B4 002B3774  57 E0 06 3E */	clrlwi r0, r31, 0x18
/* 802EA1B8 002B3778  2C 00 00 04 */	cmpwi r0, 4
/* 802EA1BC 002B377C  40 82 00 0C */	bne lbl_802EA1C8
/* 802EA1C0 002B3780  38 60 00 07 */	li r3, 7
/* 802EA1C4 002B3784  48 00 00 20 */	b lbl_802EA1E4
lbl_802EA1C8:
...
/* 802EA218 002B37D8  41 82 00 1C */	beq lbl_802EA234
...
/* 802EA22C 002B37EC  41 82 00 08 */	beq lbl_802EA234
...
.global func_802EA2CC
func_802EA2CC:
/* 802EA2CC 002B388C  2C 03 00 00 */	cmpwi r3, 0
/* 802EA2D0 002B3890  40 82 00 34 */	bne func_802EA304
...
.global func_802EA368
func_802EA368:
/* 802EA368 002B3928  55 20 06 F7 */	rlwinm. r0, r9, 0, 0x1b, 0x1b
/* 802EA36C 002B392C  41 82 00 40 */	beq func_802EA3AC
...
/* 802EA3D4 002B3994  41 82 00 4C */	beq func_802EA420
/* 802EA3D8 002B3998  40 80 00 10 */	bge lbl_802EA3E8
/* 802EA3DC 002B399C  2C 00 00 01 */	cmpwi r0, 1
/* 802EA3E0 002B39A0  40 80 00 14 */	bge lbl_802EA3F4
/* 802EA3E4 002B39A4  48 00 00 FC */	b func_802EA4E0
lbl_802EA3E8:
/* 802EA3E8 002B39A8  2C 00 00 04 */	cmpwi r0, 4
/* 802EA3EC 002B39AC  40 80 00 F4 */	bge func_802EA4E0
/* 802EA3F0 002B39B0  48 00 00 60 */	b func_802EA450
lbl_802EA3F4:
...
/* 802EA460 002B3A20  40 80 00 08 */	bge lbl_802EA468
...
/* 802EA478 002B3A38  40 81 00 08 */	ble lbl_802EA480
...
/* 802EA4B4 002B3A74  40 81 00 08 */	ble lbl_802EA4BC
...
/* 802EA4CC 002B3A8C  40 81 00 08 */	ble lbl_802EA4D4
...
/* 802EA554 002B3B14  48 00 00 DC */	b lbl_802EA630
lbl_802EA558:
...
/* 802EA5BC 002B3B7C  41 80 FF AC */	blt lbl_802EA568
/* 802EA5C0 002B3B80  2C 07 00 00 */	cmpwi r7, 0
/* 802EA5C4 002B3B84  40 82 00 40 */	bne lbl_802EA604
/* 802EA5C8 002B3B88  2C 1B 00 00 */	cmpwi r27, 0
/* 802EA5CC 002B3B8C  41 82 00 30 */	beq lbl_802EA5FC
...
/* 802EA690 002B3C50  4B FF FE 59 */	bl func_802EA4E8
...
/* 802EA6A4 002B3C64  40 82 00 34 */	bne lbl_802EA6D8
/* 802EA6A8 002B3C68  2C 00 00 00 */	cmpwi r0, 0
/* 802EA6AC 002B3C6C  41 82 00 20 */	beq lbl_802EA6CC
...
/* 802EA6BC 002B3C7C  41 80 00 18 */	blt lbl_802EA6D4
/* 802EA6C0 002B3C80  A0 01 00 0A */	lhz r0, 0xa(r1)
/* 802EA6C4 002B3C84  7C 00 20 40 */	cmplw r0, r4
/* 802EA6C8 002B3C88  41 81 00 0C */	bgt lbl_802EA6D4
lbl_802EA6CC:
/* 802EA6CC 002B3C8C  38 60 00 0D */	li r3, 0xd
/* 802EA6D0 002B3C90  48 00 01 8C */	b lbl_802EA85C
lbl_802EA6D4:
...
/* 802EA740 002B3D00  41 82 00 A4 */	beq lbl_802EA7E4
/* 802EA744 002B3D04  40 80 00 14 */	bge lbl_802EA758
/* 802EA748 002B3D08  2C 00 00 00 */	cmpwi r0, 0
/* 802EA74C 002B3D0C  41 82 00 18 */	beq lbl_802EA764
/* 802EA750 002B3D10  40 80 00 74 */	bge lbl_802EA7C4
/* 802EA754 002B3D14  48 00 00 D8 */	b lbl_802EA82C
lbl_802EA758:
/* 802EA758 002B3D18  2C 00 00 04 */	cmpwi r0, 4
/* 802EA75C 002B3D1C  40 80 00 D0 */	bge lbl_802EA82C
/* 802EA760 002B3D20  48 00 00 AC */	b lbl_802EA80C
lbl_802EA764:
/* 802EA764 002B3D24  88 1C 00 20 */	lbz r0, 0x20(r28)
/* 802EA768 002B3D28  2C 00 00 03 */	cmpwi r0, 3
/* 802EA76C 002B3D2C  41 82 00 2C */	beq lbl_802EA798
/* 802EA770 002B3D30  40 80 00 40 */	bge lbl_802EA7B0
/* 802EA774 002B3D34  2C 00 00 02 */	cmpwi r0, 2
/* 802EA778 002B3D38  40 80 00 08 */	bge lbl_802EA780
/* 802EA77C 002B3D3C  48 00 00 34 */	b lbl_802EA7B0
lbl_802EA780:
...
/* 802EA790 002B3D50  48 00 78 B1 */	bl func_802F2040
/* 802EA794 002B3D54  48 00 00 A8 */	b lbl_802EA83C
lbl_802EA798:
...
/* 802EA7A8 002B3D68  48 00 79 D1 */	bl func_802F2178
/* 802EA7AC 002B3D6C  48 00 00 90 */	b lbl_802EA83C
lbl_802EA7B0:
...
/* 802EA7C0 002B3D80  48 00 00 7C */	b lbl_802EA83C
lbl_802EA7C4:
...
/* 802EA7DC 002B3D9C  48 00 76 E5 */	bl func_802F1EC0
/* 802EA7E0 002B3DA0  48 00 00 5C */	b lbl_802EA83C
lbl_802EA7E4:
...
/* 802EA804 002B3DC4  48 00 77 71 */	bl func_802F1F74
/* 802EA808 002B3DC8  48 00 00 34 */	b lbl_802EA83C
lbl_802EA80C:
...
/* 802EA824 002B3DE4  48 00 78 A1 */	bl func_802F20C4
/* 802EA828 002B3DE8  48 00 00 14 */	b lbl_802EA83C
lbl_802EA82C:
...
/* 802EA84C 002B3E0C  40 82 00 0C */	bne lbl_802EA858
/* 802EA850 002B3E10  7F E3 FB 78 */	mr r3, r31
/* 802EA854 002B3E14  4B FF 0C 8D */	bl func_802DB4E0
lbl_802EA858:
...
/* 802EA898 002B3E58  40 80 00 84 */	bge lbl_802EA91C
...
/* 802EA8D0 002B3E90  41 82 00 3C */	beq lbl_802EA90C
...
/* 802EA8E4 002B3EA4  41 82 00 28 */	beq lbl_802EA90C
...
/* 802EA954 002B3F14  4B FF 9B C9 */	bl func_802E451C
/* 802EA958 002B3F18  54 7D 06 3E */	clrlwi r29, r3, 0x18
/* 802EA95C 002B3F1C  2C 1D 00 04 */	cmpwi r29, 4
/* 802EA960 002B3F20  40 80 01 DC */	bge lbl_802EAB3C
...
/* 802EA978 002B3F38  40 82 00 58 */	bne lbl_802EA9D0
/* 802EA97C 002B3F3C  A0 1F 00 38 */	lhz r0, 0x38(r31)
/* 802EA980 002B3F40  2C 00 00 00 */	cmpwi r0, 0
/* 802EA984 002B3F44  41 82 00 4C */	beq lbl_802EA9D0
/* 802EA988 002B3F48  48 00 0F 1D */	bl func_802EB8A4
/* 802EA98C 002B3F4C  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 802EA990 002B3F50  40 82 00 40 */	bne lbl_802EA9D0
...
/* 802EA9A4 002B3F64  41 80 00 20 */	blt lbl_802EA9C4
...
/* 802EA9C0 002B3F80  4B FF 36 21 */	bl func_802DDFE0
lbl_802EA9C4:
/* 802EA9C4 002B3F84  A0 7F 00 34 */	lhz r3, 0x34(r31)
/* 802EA9C8 002B3F88  A0 9F 00 36 */	lhz r4, 0x36(r31)
/* 802EA9CC 002B3F8C  48 00 6E 2D */	bl func_802F17F8
lbl_802EA9D0:
...
/* 802EA9F0 002B3FB0  40 82 00 14 */	bne lbl_802EAA04
/* 802EA9F4 002B3FB4  88 64 04 D4 */	lbz r3, 0x4d4(r4)
/* 802EA9F8 002B3FB8  28 03 00 01 */	cmplwi r3, 1
/* 802EA9FC 002B3FBC  40 82 00 08 */	bne lbl_802EAA04
...
/* 802EAA0C 002B3FCC  40 82 00 14 */	bne lbl_802EAA20
/* 802EAA10 002B3FD0  88 65 00 08 */	lbz r3, 8(r5)
/* 802EAA14 002B3FD4  28 03 00 01 */	cmplwi r3, 1
/* 802EAA18 002B3FD8  40 82 00 08 */	bne lbl_802EAA20
...
/* 802EAA50 002B4010  41 82 00 20 */	beq lbl_802EAA70
...
/* 802EAA7C 002B403C  41 80 FF CC */	blt lbl_802EAA48
...
/* 802EAAF4 002B40B4  48 00 77 09 */	bl func_802F21FC
/* 802EAAF8 002B40B8  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 802EAAFC 002B40BC  41 82 00 10 */	beq lbl_802EAB0C
/* 802EAB00 002B40C0  38 00 00 00 */	li r0, 0
/* 802EAB04 002B40C4  98 1C 01 4F */	stb r0, 0x14f(r28)
/* 802EAB08 002B40C8  48 00 00 34 */	b lbl_802EAB3C
lbl_802EAB0C:
...
/* 802EAB24 002B40E4  41 82 00 18 */	beq lbl_802EAB3C
