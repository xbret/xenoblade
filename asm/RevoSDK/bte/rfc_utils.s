.include "macros.inc"
.file "RevoSDK/bte/rfc_utils.o"

# 0x803026DC - 0x80302EBC
.text
.balign 4
...
.L_803026EC:
/* 803026EC 002CBCAC  88 04 00 00 */	lbz r0, 0x0(r4)
/* 803026F0 002CBCB0  38 84 00 01 */	addi r4, r4, 0x1
/* 803026F4 002CBCB4  7C C0 02 78 */	xor r0, r6, r0
/* 803026F8 002CBCB8  7C C5 00 AE */	lbzx r6, r5, r0
.L_803026FC:
/* 803026FC 002CBCBC  54 60 04 3F */	clrlwi. r0, r3, 16
/* 80302700 002CBCC0  38 63 FF FF */	addi r3, r3, -0x1
/* 80302704 002CBCC4  40 82 FF E8 */	bne .L_803026EC
/* 80302708 002CBCC8  20 06 00 FF */	subfic r0, r6, 0xff
/* 8030270C 002CBCCC  54 03 06 3E */	clrlwi r3, r0, 24
...
.L_80302724:
/* 80302724 002CBCE4  88 04 00 00 */	lbz r0, 0x0(r4)
/* 80302728 002CBCE8  38 84 00 01 */	addi r4, r4, 0x1
/* 8030272C 002CBCEC  7C E0 02 78 */	xor r0, r7, r0
/* 80302730 002CBCF0  7C E6 00 AE */	lbzx r7, r6, r0
.L_80302734:
/* 80302734 002CBCF4  54 60 04 3F */	clrlwi. r0, r3, 16
/* 80302738 002CBCF8  38 63 FF FF */	addi r3, r3, -0x1
...
/* 80302750 002CBD10  38 03 FF 31 */	addi r0, r3, -0xcf
/* 80302754 002CBD14  7C 00 00 34 */	cntlzw r0, r0
/* 80302758 002CBD18  54 03 DE 3E */	extrwi r3, r0, 8, 19
...
/* 803027FC 002CBDBC  3B C3 00 01 */	addi r30, r3, 0x1
/* 80302800 002CBDC0  2C 1E 00 01 */	cmpwi r30, 0x1
/* 80302804 002CBDC4  41 80 00 08 */	blt .L_8030280C
/* 80302808 002CBDC8  3B C0 00 00 */	li r30, 0x0
.L_8030280C:
...
/* 8030283C 002CBDFC  38 A0 00 06 */	li r5, 0x6
...
/* 80302854 002CBE14  28 00 00 04 */	cmplwi r0, 0x4
/* 80302858 002CBE18  41 80 00 1C */	blt .L_80302874
/* 8030285C 002CBE1C  3C 60 00 09 */	lis r3, 0x9
/* 80302860 002CBE20  3C 80 80 55 */	lis r4, lbl_80548E80@ha
/* 80302864 002CBE24  38 63 00 03 */	addi r3, r3, 0x3
...
.L_8030289C:
/* 8030289C 002CBE5C  38 60 00 00 */	li r3, 0x0
.L_803028A0:
...
/* 803028D8 002CBE98  28 00 00 04 */	cmplwi r0, 0x4
/* 803028DC 002CBE9C  41 80 00 18 */	blt .L_803028F4
/* 803028E0 002CBEA0  3C 60 00 09 */	lis r3, 0x9
/* 803028E4 002CBEA4  3C 80 80 55 */	lis r4, lbl_80548E70@ha
/* 803028E8 002CBEA8  38 63 00 03 */	addi r3, r3, 0x3
...
/* 803029A4 002CBF64  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 803029D4 002CBF94  28 00 00 04 */	cmplwi r0, 0x4
/* 803029D8 002CBF98  41 80 00 18 */	blt .L_803029F0
/* 803029DC 002CBF9C  3C 60 00 09 */	lis r3, 0x9
/* 803029E0 002CBFA0  3C 80 80 55 */	lis r4, lbl_80548E70@ha
/* 803029E4 002CBFA4  38 63 00 03 */	addi r3, r3, 0x3
...
/* 80302AAC 002CC06C  28 00 00 04 */	cmplwi r0, 0x4
/* 80302AB0 002CC070  41 80 00 18 */	blt .L_80302AC8
/* 80302AB4 002CC074  3C 60 00 09 */	lis r3, 0x9
/* 80302AB8 002CC078  3C 80 80 55 */	lis r4, lbl_80548EC4@ha
/* 80302ABC 002CC07C  38 63 00 03 */	addi r3, r3, 0x3
...
/* 80302AEC 002CC0AC  38 A0 00 00 */	li r5, 0x0
...
/* 80302B60 002CC120  28 00 00 04 */	cmplwi r0, 0x4
/* 80302B64 002CC124  41 80 00 1C */	blt .L_80302B80
/* 80302B68 002CC128  3C 60 00 09 */	lis r3, 0x9
/* 80302B6C 002CC12C  3C 80 80 55 */	lis r4, lbl_80548E80@ha
/* 80302B70 002CC130  38 63 00 03 */	addi r3, r3, 0x3
/* 80302B74 002CC134  38 A0 00 02 */	li r5, 0x2
...
/* 80302B8C 002CC14C  38 A0 00 02 */	li r5, 0x2
...
/* 80302BC4 002CC184  38 80 00 05 */	li r4, 0x5
/* 80302BC8 002CC188  38 A0 00 00 */	li r5, 0x0
/* 80302BCC 002CC18C  4B FF C1 B8 */	b rfc_mx_sm_execute
.L_80302BD0:
/* 80302BD0 002CC190  80 63 00 10 */	lwz r3, 0x10(r3)
/* 80302BD4 002CC194  38 80 00 05 */	li r4, 0x5
/* 80302BD8 002CC198  38 A0 00 00 */	li r5, 0x0
...
/* 80302BF0 002CC1B0  98 A1 00 08 */	stb r5, 0x8(r1)
/* 80302BF4 002CC1B4  88 04 00 01 */	lbz r0, 0x1(r4)
/* 80302BF8 002CC1B8  2C 00 00 00 */	cmpwi r0, 0x0
/* 80302BFC 002CC1BC  41 82 00 2C */	beq .L_80302C28
/* 80302C00 002CC1C0  88 04 00 68 */	lbz r0, 0x68(r4)
/* 80302C04 002CC1C4  28 00 00 02 */	cmplwi r0, 0x2
/* 80302C08 002CC1C8  41 82 00 10 */	beq .L_80302C18
/* 80302C0C 002CC1CC  28 00 00 03 */	cmplwi r0, 0x3
...
/* 80302C1C 002CC1DC  38 A1 00 08 */	addi r5, r1, 0x8
...
/* 80302C6C 002CC22C  28 00 00 05 */	cmplwi r0, 0x5
/* 80302C70 002CC230  41 80 00 14 */	blt .L_80302C84
/* 80302C74 002CC234  3C 60 00 09 */	lis r3, 0x9
/* 80302C78 002CC238  38 9F 00 68 */	addi r4, r31, 0x68
/* 80302C7C 002CC23C  38 63 00 04 */	addi r3, r3, 0x4
...
/* 80302C90 002CC250  28 00 00 04 */	cmplwi r0, 0x4
/* 80302C94 002CC254  41 80 00 14 */	blt .L_80302CA8
/* 80302C98 002CC258  3C 60 00 09 */	lis r3, 0x9
/* 80302C9C 002CC25C  38 9F 00 54 */	addi r4, r31, 0x54
/* 80302CA0 002CC260  38 63 00 03 */	addi r3, r3, 0x3
...
/* 80302CB0 002CC270  38 80 00 00 */	li r4, 0x0
/* 80302CB4 002CC274  2C 1E 00 00 */	cmpwi r30, 0x0
...
/* 80302CC8 002CC288  38 A0 00 00 */	li r5, 0x0
...
/* 80302D38 002CC2F8  28 00 00 04 */	cmplwi r0, 0x4
/* 80302D3C 002CC2FC  41 80 00 18 */	blt .L_80302D54
/* 80302D40 002CC300  3C 60 00 09 */	lis r3, 0x9
/* 80302D44 002CC304  38 9F 00 10 */	addi r4, r31, 0x10
/* 80302D48 002CC308  38 63 00 03 */	addi r3, r3, 0x3
/* 80302D4C 002CC30C  38 A0 00 02 */	li r5, 0x2
...
/* 80302D60 002CC320  38 A0 00 02 */	li r5, 0x2
...
/* 80302DAC 002CC36C  28 00 00 02 */	cmplwi r0, 0x2
...
/* 80302DCC 002CC38C  28 00 00 04 */	cmplwi r0, 0x4
/* 80302DD0 002CC390  41 80 00 1C */	blt .L_80302DEC
/* 80302DD4 002CC394  3C 60 00 09 */	lis r3, 0x9
/* 80302DD8 002CC398  3C 80 80 55 */	lis r4, lbl_80548EE8@ha
/* 80302DDC 002CC39C  38 63 00 03 */	addi r3, r3, 0x3
/* 80302DE0 002CC3A0  54 C5 04 3E */	clrlwi r5, r6, 16
...
/* 80302E60 002CC420  2C 04 00 00 */	cmpwi r4, 0x0
...
/* 80302E88 002CC448  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 80302EA0 002CC460  2C 00 00 00 */	cmpwi r0, 0x0
...
.data
.balign 8
.sym lbl_80548E70, global
	.4byte 0x7266635F
	.4byte 0x74696D65
	.4byte 0x725F7374
	.4byte 0x6F700000
.sym lbl_80548E80, global
	.4byte 0x7266635F
	.4byte 0x74696D65
	.4byte 0x725F7374
	.4byte 0x61727420
