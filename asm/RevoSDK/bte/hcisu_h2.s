...
/* 802DCAB4 002A6074  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 802DCAB8 002A6078  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 802DCABC 002A607C  00 00 00 00 */	.4byte 0x00000000 /* invalid */
...
/* 802DCAD0 002A6090  4B FD D6 51 */	bl __save_gpr
/* 802DCAD4 002A6094  88 04 00 1E */	lbz r0, 0x1e(r4)
/* 802DCAD8 002A6098  7C 8F 23 78 */	mr r15, r4
/* 802DCADC 002A609C  3A 60 00 00 */	li r19, 0x0
/* 802DCAE0 002A60A0  28 00 00 02 */	cmplwi r0, 0x2
/* 802DCAE4 002A60A4  41 82 00 0C */	beq .L_802DCAF0
/* 802DCAE8 002A60A8  38 60 00 00 */	li r3, 0x0
/* 802DCAEC 002A60AC  48 00 03 54 */	b .L_802DCE40
.L_802DCAF0:
/* 802DCAF0 002A60B0  3A 83 00 01 */	addi r20, r3, 0x1
/* 802DCAF4 002A60B4  54 60 0B FC */	clrlslwi r0, r3, 16, 1
/* 802DCAF8 002A60B8  3F E0 80 5C */	lis r31, lbl_805BBC20@ha
/* 802DCAFC 002A60BC  7E C4 1A 14 */	add r22, r4, r3
/* 802DCB00 002A60C0  56 90 04 3E */	clrlwi r16, r20, 16
/* 802DCB04 002A60C4  54 77 13 BA */	clrlslwi r23, r3, 16, 2
/* 802DCB08 002A60C8  7E A4 02 14 */	add r21, r4, r0
/* 802DCB0C 002A60CC  3B FF BC 20 */	addi r31, r31, lbl_805BBC20@l
/* 802DCB10 002A60D0  3B A0 00 00 */	li r29, 0x0
/* 802DCB14 002A60D4  3B C0 00 04 */	li r30, 0x4
/* 802DCB18 002A60D8  3B 82 BB B0 */	addi r28, r2, lbl_8066BF30@sda21
/* 802DCB1C 002A60DC  3B 20 00 03 */	li r25, 0x3
/* 802DCB20 002A60E0  3B 00 00 02 */	li r24, 0x2
/* 802DCB24 002A60E4  3D C0 80 54 */	lis r14, lbl_80543F60@ha
/* 802DCB28 002A60E8  3B 42 BB B8 */	addi r26, r2, lbl_8066BF38@sda21
/* 802DCB2C 002A60EC  3B 60 00 01 */	li r27, 0x1
.L_802DCB30:
/* 802DCB30 002A60F0  56 03 06 3E */	clrlwi r3, r16, 24
/* 802DCB34 002A60F4  38 81 00 08 */	addi r4, r1, 0x8
/* 802DCB38 002A60F8  38 A0 00 01 */	li r5, 0x1
/* 802DCB3C 002A60FC  48 00 0F 85 */	bl UUSB_Read
/* 802DCB40 002A6100  54 60 04 3F */	clrlwi. r0, r3, 16
/* 802DCB44 002A6104  41 82 02 F8 */	beq .L_802DCE3C
/* 802DCB48 002A6108  88 16 00 1A */	lbz r0, 0x1a(r22)
/* 802DCB4C 002A610C  3A 20 00 00 */	li r17, 0x0
/* 802DCB50 002A6110  3A 73 00 01 */	addi r19, r19, 0x1
/* 802DCB54 002A6114  2C 00 00 00 */	cmpwi r0, 0x0
/* 802DCB58 002A6118  41 82 00 28 */	beq .L_802DCB80
/* 802DCB5C 002A611C  2C 00 00 01 */	cmpwi r0, 0x1
/* 802DCB60 002A6120  41 82 00 C8 */	beq .L_802DCC28
/* 802DCB64 002A6124  2C 00 00 02 */	cmpwi r0, 0x2
/* 802DCB68 002A6128  41 82 01 B8 */	beq .L_802DCD20
/* 802DCB6C 002A612C  2C 00 00 03 */	cmpwi r0, 0x3
/* 802DCB70 002A6130  41 82 01 FC */	beq .L_802DCD6C
/* 802DCB74 002A6134  2C 00 00 04 */	cmpwi r0, 0x4
/* 802DCB78 002A6138  41 82 02 8C */	beq .L_802DCE04
/* 802DCB7C 002A613C  48 00 02 A0 */	b .L_802DCE1C
.L_802DCB80:
/* 802DCB80 002A6140  28 10 00 01 */	cmplwi r16, 0x1
/* 802DCB84 002A6144  40 82 00 18 */	bne .L_802DCB9C
/* 802DCB88 002A6148  38 60 00 02 */	li r3, 0x2
...
/* 802DCB98 002A6158  48 00 00 38 */	b .L_802DCBD0
.L_802DCB9C:
/* 802DCB9C 002A615C  28 10 00 02 */	cmplwi r16, 0x2
/* 802DCBA0 002A6160  40 82 00 18 */	bne .L_802DCBB8
/* 802DCBA4 002A6164  38 60 00 03 */	li r3, 0x3
...
/* 802DCBB4 002A6174  48 00 00 1C */	b .L_802DCBD0
.L_802DCBB8:
/* 802DCBB8 002A6178  28 10 00 03 */	cmplwi r16, 0x3
/* 802DCBBC 002A617C  40 82 02 60 */	bne .L_802DCE1C
/* 802DCBC0 002A6180  38 60 00 01 */	li r3, 0x1
...
/* 802DCBD4 002A6194  2C 03 00 00 */	cmpwi r3, 0x0
/* 802DCBD8 002A6198  41 82 00 30 */	beq .L_802DCC08
/* 802DCBDC 002A619C  B3 A3 00 02 */	sth r29, 0x2(r3)
...
/* 802DCBF0 002A61B0  A0 04 FF FE */	lhz r0, -0x2(r4)
/* 802DCBF4 002A61B4  B0 03 00 00 */	sth r0, 0x0(r3)
/* 802DCBF8 002A61B8  7C 6F B8 2E */	lwzx r3, r15, r23
/* 802DCBFC 002A61BC  B3 A3 00 04 */	sth r29, 0x4(r3)
/* 802DCC00 002A61C0  9B 76 00 1A */	stb r27, 0x1a(r22)
/* 802DCC04 002A61C4  48 00 00 14 */	b .L_802DCC18
.L_802DCC08:
/* 802DCC08 002A61C8  38 8E 3F 60 */	addi r4, r14, lbl_80543F60@l
/* 802DCC0C 002A61CC  3C 60 00 07 */	lis r3, 0x7
/* 802DCC10 002A61D0  48 00 13 91 */	bl LogMsg_0
...
/* 802DCC20 002A61E0  88 03 FF FF */	lbz r0, -0x1(r3)
/* 802DCC24 002A61E4  B0 15 00 0C */	sth r0, 0xc(r21)
.L_802DCC28:
/* 802DCC28 002A61E8  7C CF B8 2E */	lwzx r6, r15, r23
/* 802DCC2C 002A61EC  88 A1 00 08 */	lbz r5, 0x8(r1)
/* 802DCC30 002A61F0  A0 86 00 02 */	lhz r4, 0x2(r6)
/* 802DCC34 002A61F4  7C 66 22 14 */	add r3, r6, r4
/* 802DCC38 002A61F8  38 04 00 01 */	addi r0, r4, 0x1
/* 802DCC3C 002A61FC  98 A3 00 08 */	stb r5, 0x8(r3)
/* 802DCC40 002A6200  B0 06 00 02 */	sth r0, 0x2(r6)
/* 802DCC44 002A6204  A0 75 00 0C */	lhz r3, 0xc(r21)
/* 802DCC48 002A6208  38 03 FF FF */	addi r0, r3, -0x1
/* 802DCC4C 002A620C  B0 15 00 0C */	sth r0, 0xc(r21)
/* 802DCC50 002A6210  54 00 04 3F */	clrlwi. r0, r0, 16
/* 802DCC54 002A6214  40 82 00 C0 */	bne .L_802DCD14
/* 802DCC58 002A6218  88 16 00 14 */	lbz r0, 0x14(r22)
/* 802DCC5C 002A621C  8A 41 00 08 */	lbz r18, 0x8(r1)
/* 802DCC60 002A6220  28 00 00 02 */	cmplwi r0, 0x2
/* 802DCC64 002A6224  40 82 00 44 */	bne .L_802DCCA8
/* 802DCC68 002A6228  88 16 00 17 */	lbz r0, 0x17(r22)
/* 802DCC6C 002A622C  56 44 42 2E */	clrlslwi r4, r18, 16, 8
/* 802DCC70 002A6230  7C 6F B8 2E */	lwzx r3, r15, r23
/* 802DCC74 002A6234  7C 04 02 14 */	add r0, r4, r0
/* 802DCC78 002A6238  54 12 04 3E */	clrlwi r18, r0, 16
/* 802DCC7C 002A623C  48 01 CA 75 */	bl l2cap_link_chk_pkt_start
/* 802DCC80 002A6240  2C 03 00 00 */	cmpwi r3, 0x0
/* 802DCC84 002A6244  7C 6F B9 2E */	stwx r3, r15, r23
/* 802DCC88 002A6248  40 82 00 20 */	bne .L_802DCCA8
/* 802DCC8C 002A624C  2C 12 00 00 */	cmpwi r18, 0x0
/* 802DCC90 002A6250  B2 55 00 0C */	sth r18, 0xc(r21)
/* 802DCC94 002A6254  40 82 00 0C */	bne .L_802DCCA0
/* 802DCC98 002A6258  9B B6 00 1A */	stb r29, 0x1a(r22)
/* 802DCC9C 002A625C  48 00 01 80 */	b .L_802DCE1C
.L_802DCCA0:
/* 802DCCA0 002A6260  9B D6 00 1A */	stb r30, 0x1a(r22)
/* 802DCCA4 002A6264  48 00 01 78 */	b .L_802DCE1C
.L_802DCCA8:
...
/* 802DCCB8 002A6278  54 64 04 3E */	clrlwi r4, r3, 16
/* 802DCCBC 002A627C  7C 7C 02 14 */	add r3, r28, r0
/* 802DCCC0 002A6280  88 03 FF FF */	lbz r0, -0x1(r3)
/* 802DCCC4 002A6284  7C 72 02 14 */	add r3, r18, r0
/* 802DCCC8 002A6288  38 03 00 08 */	addi r0, r3, 0x8
/* 802DCCCC 002A628C  7C 00 20 40 */	cmplw r0, r4
/* 802DCCD0 002A6290  40 81 00 28 */	ble .L_802DCCF8
/* 802DCCD4 002A6294  7C 6F B8 2E */	lwzx r3, r15, r23
/* 802DCCD8 002A6298  4B FF E8 09 */	bl GKI_freebuf
...
/* 802DCCEC 002A62AC  3C 60 00 07 */	lis r3, 0x7
/* 802DCCF0 002A62B0  48 00 12 B1 */	bl LogMsg_0
/* 802DCCF4 002A62B4  48 00 01 28 */	b .L_802DCE1C
.L_802DCCF8:
/* 802DCCF8 002A62B8  2C 12 00 00 */	cmpwi r18, 0x0
/* 802DCCFC 002A62BC  41 82 00 0C */	beq .L_802DCD08
/* 802DCD00 002A62C0  9B 36 00 1A */	stb r25, 0x1a(r22)
/* 802DCD04 002A62C4  48 00 01 18 */	b .L_802DCE1C
.L_802DCD08:
/* 802DCD08 002A62C8  9B B6 00 1A */	stb r29, 0x1a(r22)
/* 802DCD0C 002A62CC  3A 20 00 01 */	li r17, 0x1
/* 802DCD10 002A62D0  48 00 01 0C */	b .L_802DCE1C
.L_802DCD14:
/* 802DCD14 002A62D4  88 01 00 08 */	lbz r0, 0x8(r1)
/* 802DCD18 002A62D8  98 16 00 17 */	stb r0, 0x17(r22)
/* 802DCD1C 002A62DC  48 00 01 00 */	b .L_802DCE1C
.L_802DCD20:
/* 802DCD20 002A62E0  A0 75 00 0C */	lhz r3, 0xc(r21)
/* 802DCD24 002A62E4  38 03 FF FF */	addi r0, r3, -0x1
/* 802DCD28 002A62E8  B0 15 00 0C */	sth r0, 0xc(r21)
/* 802DCD2C 002A62EC  54 00 04 3F */	clrlwi. r0, r0, 16
/* 802DCD30 002A62F0  40 82 00 30 */	bne .L_802DCD60
/* 802DCD34 002A62F4  88 16 00 14 */	lbz r0, 0x14(r22)
/* 802DCD38 002A62F8  88 61 00 08 */	lbz r3, 0x8(r1)
/* 802DCD3C 002A62FC  28 00 00 02 */	cmplwi r0, 0x2
/* 802DCD40 002A6300  40 82 00 14 */	bne .L_802DCD54
/* 802DCD44 002A6304  88 16 00 17 */	lbz r0, 0x17(r22)
/* 802DCD48 002A6308  54 63 42 2E */	clrlslwi r3, r3, 16, 8
/* 802DCD4C 002A630C  7C 03 02 14 */	add r0, r3, r0
/* 802DCD50 002A6310  54 03 04 3E */	clrlwi r3, r0, 16
.L_802DCD54:
/* 802DCD54 002A6314  B0 75 00 0C */	sth r3, 0xc(r21)
/* 802DCD58 002A6318  9B D6 00 1A */	stb r30, 0x1a(r22)
/* 802DCD5C 002A631C  48 00 00 C0 */	b .L_802DCE1C
.L_802DCD60:
/* 802DCD60 002A6320  88 01 00 08 */	lbz r0, 0x8(r1)
/* 802DCD64 002A6324  98 16 00 17 */	stb r0, 0x17(r22)
/* 802DCD68 002A6328  48 00 00 B4 */	b .L_802DCE1C
.L_802DCD6C:
/* 802DCD6C 002A632C  7C EF B8 2E */	lwzx r7, r15, r23
/* 802DCD70 002A6330  56 83 06 3E */	clrlwi r3, r20, 24
/* 802DCD74 002A6334  88 C1 00 08 */	lbz r6, 0x8(r1)
/* 802DCD78 002A6338  A0 A7 00 02 */	lhz r5, 0x2(r7)
/* 802DCD7C 002A633C  7C 87 2A 14 */	add r4, r7, r5
/* 802DCD80 002A6340  38 05 00 01 */	addi r0, r5, 0x1
/* 802DCD84 002A6344  98 C4 00 08 */	stb r6, 0x8(r4)
/* 802DCD88 002A6348  B0 07 00 02 */	sth r0, 0x2(r7)
/* 802DCD8C 002A634C  A0 95 00 0C */	lhz r4, 0xc(r21)
/* 802DCD90 002A6350  38 04 FF FF */	addi r0, r4, -0x1
/* 802DCD94 002A6354  B0 15 00 0C */	sth r0, 0xc(r21)
/* 802DCD98 002A6358  54 05 04 3E */	clrlwi r5, r0, 16
/* 802DCD9C 002A635C  7C 8F B8 2E */	lwzx r4, r15, r23
/* 802DCDA0 002A6360  A0 04 00 02 */	lhz r0, 0x2(r4)
/* 802DCDA4 002A6364  7C 84 02 14 */	add r4, r4, r0
/* 802DCDA8 002A6368  38 84 00 08 */	addi r4, r4, 0x8
...
/* 802DCDB8 002A6378  A0 04 00 02 */	lhz r0, 0x2(r4)
/* 802DCDBC 002A637C  7C 00 1A 14 */	add r0, r0, r3
/* 802DCDC0 002A6380  B0 04 00 02 */	sth r0, 0x2(r4)
...
/* 802DCDD0 002A6390  54 00 04 3F */	clrlwi. r0, r0, 16
/* 802DCDD4 002A6394  40 82 00 48 */	bne .L_802DCE1C
/* 802DCDD8 002A6398  88 16 00 14 */	lbz r0, 0x14(r22)
/* 802DCDDC 002A639C  28 00 00 02 */	cmplwi r0, 0x2
/* 802DCDE0 002A63A0  40 82 00 18 */	bne .L_802DCDF8
/* 802DCDE4 002A63A4  48 01 CA DD */	bl l2cap_link_chk_pkt_end
/* 802DCDE8 002A63A8  54 60 06 3F */	clrlwi. r0, r3, 24
/* 802DCDEC 002A63AC  40 82 00 0C */	bne .L_802DCDF8
/* 802DCDF0 002A63B0  9B B6 00 1A */	stb r29, 0x1a(r22)
/* 802DCDF4 002A63B4  48 00 00 28 */	b .L_802DCE1C
.L_802DCDF8:
/* 802DCDF8 002A63B8  9B B6 00 1A */	stb r29, 0x1a(r22)
/* 802DCDFC 002A63BC  3A 20 00 01 */	li r17, 0x1
/* 802DCE00 002A63C0  48 00 00 1C */	b .L_802DCE1C
.L_802DCE04:
/* 802DCE04 002A63C4  A0 75 00 0C */	lhz r3, 0xc(r21)
/* 802DCE08 002A63C8  38 03 FF FF */	addi r0, r3, -0x1
/* 802DCE0C 002A63CC  B0 15 00 0C */	sth r0, 0xc(r21)
/* 802DCE10 002A63D0  54 00 04 3F */	clrlwi. r0, r0, 16
/* 802DCE14 002A63D4  40 82 00 08 */	bne .L_802DCE1C
/* 802DCE18 002A63D8  9B B6 00 1A */	stb r29, 0x1a(r22)
.L_802DCE1C:
/* 802DCE1C 002A63DC  2C 11 00 00 */	cmpwi r17, 0x0
/* 802DCE20 002A63E0  41 82 FD 10 */	beq .L_802DCB30
/* 802DCE24 002A63E4  88 7F 00 1F */	lbz r3, 0x1f(r31)
/* 802DCE28 002A63E8  38 80 00 00 */	li r4, 0x0
...
/* 802DCE38 002A63F8  4B FF FC F8 */	b .L_802DCB30
.L_802DCE3C:
...
/* 802DCE58 002A6418  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 802DCE5C 002A641C  00 00 00 00 */	.4byte 0x00000000 /* invalid */
...
/* 802DCE74 002A6434  A0 A4 00 00 */	lhz r5, 0x0(r4)
/* 802DCE78 002A6438  7C 9B 23 78 */	mr r27, r4
/* 802DCE7C 002A643C  A0 04 00 04 */	lhz r0, 0x4(r4)
/* 802DCE80 002A6440  28 05 21 00 */	cmplwi r5, 0x2100
/* 802DCE84 002A6444  7C 64 02 14 */	add r3, r4, r0
/* 802DCE88 002A6448  38 C3 00 08 */	addi r6, r3, 0x8
/* 802DCE8C 002A644C  40 82 00 0C */	bne .L_802DCE98
/* 802DCE90 002A6450  3B 80 00 02 */	li r28, 0x2
/* 802DCE94 002A6454  48 00 00 20 */	b .L_802DCEB4
.L_802DCE98:
/* 802DCE98 002A6458  28 05 22 00 */	cmplwi r5, 0x2200
/* 802DCE9C 002A645C  40 82 00 0C */	bne .L_802DCEA8
/* 802DCEA0 002A6460  3B 80 00 03 */	li r28, 0x3
/* 802DCEA4 002A6464  48 00 00 10 */	b .L_802DCEB4
.L_802DCEA8:
/* 802DCEA8 002A6468  28 05 20 00 */	cmplwi r5, 0x2000
/* 802DCEAC 002A646C  40 82 00 08 */	bne .L_802DCEB4
/* 802DCEB0 002A6470  3B 80 00 00 */	li r28, 0x0
.L_802DCEB4:
...
/* 802DCEC0 002A6480  A0 84 00 02 */	lhz r4, 0x2(r4)
...
/* 802DCED4 002A6494  88 06 00 01 */	lbz r0, 0x1(r6)
/* 802DCED8 002A6498  88 66 00 00 */	lbz r3, 0x0(r6)
/* 802DCEDC 002A649C  38 C6 00 02 */	addi r6, r6, 0x2
/* 802DCEE0 002A64A0  54 00 44 2E */	clrlslwi r0, r0, 24, 8
/* 802DCEE4 002A64A4  7C 03 02 14 */	add r0, r3, r0
/* 802DCEE8 002A64A8  54 00 04 3E */	clrlwi r0, r0, 16
...
/* 802DCEF8 002A64B8  48 00 00 D0 */	b .L_802DCFC8
.L_802DCEFC:
...
/* 802DCF0C 002A64CC  A0 7B 00 04 */	lhz r3, 0x4(r27)
/* 802DCF10 002A64D0  A0 1E 00 7C */	lhz r0, 0x7c(r30)
/* 802DCF14 002A64D4  A0 9B 00 02 */	lhz r4, 0x2(r27)
/* 802DCF18 002A64D8  7C 03 02 14 */	add r0, r3, r0
/* 802DCF1C 002A64DC  B0 1B 00 04 */	sth r0, 0x4(r27)
/* 802DCF20 002A64E0  54 00 04 3E */	clrlwi r0, r0, 16
...
/* 802DCF34 002A64F4  B0 1B 00 02 */	sth r0, 0x2(r27)
/* 802DCF38 002A64F8  9B E3 00 08 */	stb r31, 0x8(r3)
/* 802DCF3C 002A64FC  9B A3 00 09 */	stb r29, 0x9(r3)
/* 802DCF40 002A6500  A0 7B 00 02 */	lhz r3, 0x2(r27)
/* 802DCF44 002A6504  A0 1E 00 7E */	lhz r0, 0x7e(r30)
/* 802DCF48 002A6508  7C 03 00 40 */	cmplw r3, r0
/* 802DCF4C 002A650C  40 81 00 20 */	ble .L_802DCF6C
/* 802DCF50 002A6510  A0 1E 00 7C */	lhz r0, 0x7c(r30)
/* 802DCF54 002A6514  98 06 00 00 */	stb r0, 0x0(r6)
/* 802DCF58 002A6518  A0 1E 00 7C */	lhz r0, 0x7c(r30)
/* 802DCF5C 002A651C  7C 00 46 70 */	srawi r0, r0, 8
/* 802DCF60 002A6520  98 06 00 01 */	stb r0, 0x1(r6)
/* 802DCF64 002A6524  38 C6 00 02 */	addi r6, r6, 0x2
/* 802DCF68 002A6528  48 00 00 20 */	b .L_802DCF88
.L_802DCF6C:
/* 802DCF6C 002A652C  38 03 FF FC */	addi r0, r3, -0x4
/* 802DCF70 002A6530  98 06 00 00 */	stb r0, 0x0(r6)
/* 802DCF74 002A6534  A0 7B 00 02 */	lhz r3, 0x2(r27)
/* 802DCF78 002A6538  38 03 FF FC */	addi r0, r3, -0x4
/* 802DCF7C 002A653C  7C 00 46 70 */	srawi r0, r0, 8
/* 802DCF80 002A6540  98 06 00 01 */	stb r0, 0x1(r6)
/* 802DCF84 002A6544  38 C6 00 02 */	addi r6, r6, 0x2
.L_802DCF88:
/* 802DCF88 002A6548  A0 7B 00 06 */	lhz r3, 0x6(r27)
/* 802DCF8C 002A654C  2C 03 00 00 */	cmpwi r3, 0x0
/* 802DCF90 002A6550  41 82 00 38 */	beq .L_802DCFC8
/* 802DCF94 002A6554  38 03 FF FF */	addi r0, r3, -0x1
/* 802DCF98 002A6558  B0 1B 00 06 */	sth r0, 0x6(r27)
/* 802DCF9C 002A655C  54 00 04 3F */	clrlwi. r0, r0, 16
...
/* 802DD00C 002A65CC  00 00 00 00 */	.4byte 0x00000000 /* invalid */

.fn hcisu_h2_init, global
/* 802DD010 002A65D0  3C C0 80 5C */	lis r6, lbl_805BBC20@ha
/* 802DD014 002A65D4  38 00 00 00 */	li r0, 0x0
...
.endfn hcisu_h2_init
/* 802DD03C 002A65FC  00 00 00 00 */	.4byte 0x00000000 /* invalid */
...
/* 802DD050 002A6610  38 00 00 00 */	li r0, 0x0
/* 802DD054 002A6614  38 A5 BC 20 */	addi r5, r5, lbl_805BBC20@l
/* 802DD058 002A6618  98 01 00 13 */	stb r0, 0x13(r1)
/* 802DD05C 002A661C  38 00 00 02 */	li r0, 0x2
/* 802DD060 002A6620  A0 83 00 00 */	lhz r4, 0x0(r3)
/* 802DD064 002A6624  B0 81 00 0C */	sth r4, 0xc(r1)
/* 802DD068 002A6628  88 85 00 1F */	lbz r4, 0x1f(r5)
/* 802DD06C 002A662C  A0 C3 00 02 */	lhz r6, 0x2(r3)
/* 802DD070 002A6630  38 61 00 08 */	addi r3, r1, 0x8
...
/* 802DD088 002A6648  38 61 00 08 */	addi r3, r1, 0x8
...
/* 802DD098 002A6658  38 60 00 01 */	li r3, 0x1
/* 802DD09C 002A665C  7C 08 03 A6 */	mtlr r0
/* 802DD0A0 002A6660  38 21 00 20 */	addi r1, r1, 0x20
/* 802DD0A4 002A6664  4E 80 00 20 */	blr
.endfn hcisu_h2_open
/* 802DD0A8 002A6668  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 802DD0AC 002A666C  00 00 00 00 */	.4byte 0x00000000 /* invalid */
...
/* 802DD0C4 002A6684  38 00 00 00 */	li r0, 0x0
...
/* 802DD0E4 002A66A4  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 802DD0E8 002A66A8  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 802DD0EC 002A66AC  00 00 00 00 */	.4byte 0x00000000 /* invalid */
...
/* 802DD110 002A66D0  38 60 00 01 */	li r3, 0x1
