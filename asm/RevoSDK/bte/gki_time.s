...
/* 802DC204 002A57C4  38 00 00 00 */	li r0, 0x0
/* 802DC208 002A57C8  38 63 31 40 */	addi r3, r3, lbl_80593140@l
/* 802DC20C 002A57CC  3C 63 00 03 */	addis r3, r3, 0x3
...
/* 802DC2BC 002A587C  00 00 00 00 */	.4byte 0x00000000 /* invalid */
...
/* 802DC2C8 002A5888  3C 63 00 03 */	addis r3, r3, 0x3
/* 802DC2CC 002A588C  80 63 88 28 */	lwz r3, -0x77d8(r3)
/* 802DC2D0 002A5890  4E 80 00 20 */	blr
.endfn GKI_get_tick_count
/* 802DC2D4 002A5894  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 802DC2D8 002A5898  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 802DC2DC 002A589C  00 00 00 00 */	.4byte 0x00000000 /* invalid */
...
/* 802DC304 002A58C4  2C 1D 00 00 */	cmpwi r29, 0x0
/* 802DC308 002A58C8  7C 7C 1B 78 */	mr r28, r3
/* 802DC30C 002A58CC  3B C0 00 00 */	li r30, 0x0
/* 802DC310 002A58D0  41 81 00 08 */	bgt .L_802DC318
/* 802DC314 002A58D4  3B A0 00 01 */	li r29, 0x1
.L_802DC318:
/* 802DC318 002A58D8  7C 1F 00 D0 */	neg r0, r31
/* 802DC31C 002A58DC  7C 00 FB 78 */	or r0, r0, r31
/* 802DC320 002A58E0  7C 00 FE 70 */	srawi r0, r0, 31
...
/* 802DC330 002A58F0  3C 60 80 00 */	lis r3, 0x8000
/* 802DC334 002A58F4  38 84 31 40 */	addi r4, r4, lbl_80593140@l
/* 802DC338 002A58F8  3C A4 00 03 */	addis r5, r4, 0x3
/* 802DC33C 002A58FC  38 83 FF FF */	addi r4, r3, -0x1
...
.L_802DC35C:
/* 802DC35C 002A591C  2C 1B 00 00 */	cmpwi r27, 0x0
/* 802DC360 002A5920  41 82 00 10 */	beq .L_802DC370
/* 802DC364 002A5924  2C 1B 00 01 */	cmpwi r27, 0x1
...
/* 802DC374 002A5934  57 85 15 BA */	clrlslwi r5, r28, 24, 2
/* 802DC378 002A5938  38 63 31 40 */	addi r3, r3, lbl_80593140@l
/* 802DC37C 002A593C  3C 03 00 03 */	addis r0, r3, 0x3
...
/* 802DC394 002A5954  57 85 15 BA */	clrlslwi r5, r28, 24, 2
/* 802DC398 002A5958  38 63 31 40 */	addi r3, r3, lbl_80593140@l
/* 802DC39C 002A595C  3C 03 00 03 */	addis r0, r3, 0x3
...
.L_802DC3B0:
/* 802DC3B0 002A5970  3B C0 00 01 */	li r30, 0x1
.L_802DC3B4:
/* 802DC3B4 002A5974  2C 1E 00 00 */	cmpwi r30, 0x0
/* 802DC3B8 002A5978  40 82 00 58 */	bne .L_802DC410
/* 802DC3BC 002A597C  2C 1D 00 00 */	cmpwi r29, 0x0
...
/* 802DC3CC 002A598C  3C 63 00 03 */	addis r3, r3, 0x3
/* 802DC3D0 002A5990  80 83 88 3C */	lwz r4, -0x77c4(r3)
/* 802DC3D4 002A5994  2C 04 00 00 */	cmpwi r4, 0x0
...
/* 802DC3E8 002A59A8  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 802DC3F8 002A59B8  3C 63 00 03 */	addis r3, r3, 0x3
...
/* 802DC42C 002A59EC  00 00 00 00 */	.4byte 0x00000000 /* invalid */
...
/* 802DC448 002A5A08  2C 1F 00 00 */	cmpwi r31, 0x0
/* 802DC44C 002A5A0C  41 82 00 10 */	beq .L_802DC45C
/* 802DC450 002A5A10  2C 1F 00 01 */	cmpwi r31, 0x1
...
/* 802DC460 002A5A20  54 63 15 BA */	clrlslwi r3, r3, 24, 2
/* 802DC464 002A5A24  38 84 31 40 */	addi r4, r4, lbl_80593140@l
/* 802DC468 002A5A28  38 A0 00 00 */	li r5, 0x0
/* 802DC46C 002A5A2C  3C 04 00 03 */	addis r0, r4, 0x3
...
/* 802DC484 002A5A44  54 63 15 BA */	clrlslwi r3, r3, 24, 2
/* 802DC488 002A5A48  38 84 31 40 */	addi r4, r4, lbl_80593140@l
/* 802DC48C 002A5A4C  38 A0 00 00 */	li r5, 0x0
/* 802DC490 002A5A50  3C 04 00 03 */	addis r0, r4, 0x3
...
/* 802DC4B4 002A5A74  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 802DC4B8 002A5A78  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 802DC4BC 002A5A7C  00 00 00 00 */	.4byte 0x00000000 /* invalid */

.fn GKI_init_timer_list, global
/* 802DC4C0 002A5A80  38 00 00 00 */	li r0, 0x0
/* 802DC4C4 002A5A84  90 03 00 00 */	stw r0, 0x0(r3)
/* 802DC4C8 002A5A88  90 03 00 04 */	stw r0, 0x4(r3)
/* 802DC4CC 002A5A8C  90 03 00 08 */	stw r0, 0x8(r3)
/* 802DC4D0 002A5A90  4E 80 00 20 */	blr
.endfn GKI_init_timer_list
/* 802DC4D4 002A5A94  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 802DC4D8 002A5A98  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 802DC4DC 002A5A9C  00 00 00 00 */	.4byte 0x00000000 /* invalid */

.fn GKI_update_timer_list, global
/* 802DC4E0 002A5AA0  80 C3 00 00 */	lwz r6, 0x0(r3)
/* 802DC4E4 002A5AA4  38 E0 00 00 */	li r7, 0x0
/* 802DC4E8 002A5AA8  48 00 00 10 */	b .L_802DC4F8
/* 802DC4EC 002A5AAC  60 00 00 00 */	nop
.L_802DC4F0:
/* 802DC4F0 002A5AB0  80 C6 00 00 */	lwz r6, 0x0(r6)
/* 802DC4F4 002A5AB4  38 E7 00 01 */	addi r7, r7, 0x1
.L_802DC4F8:
/* 802DC4F8 002A5AB8  2C 06 00 00 */	cmpwi r6, 0x0
/* 802DC4FC 002A5ABC  41 82 00 10 */	beq .L_802DC50C
/* 802DC500 002A5AC0  80 06 00 0C */	lwz r0, 0xc(r6)
/* 802DC504 002A5AC4  2C 00 00 00 */	cmpwi r0, 0x0
/* 802DC508 002A5AC8  40 81 FF E8 */	ble .L_802DC4F0
.L_802DC50C:
/* 802DC50C 002A5ACC  7C 88 23 78 */	mr r8, r4
/* 802DC510 002A5AD0  38 00 00 00 */	li r0, 0x0
...
/* 802DC52C 002A5AEC  38 E7 00 01 */	addi r7, r7, 0x1
.L_802DC530:
/* 802DC530 002A5AF0  7D 09 40 50 */	subf r8, r9, r8
/* 802DC534 002A5AF4  80 C6 00 00 */	lwz r6, 0x0(r6)
.L_802DC538:
/* 802DC538 002A5AF8  2C 06 00 00 */	cmpwi r6, 0x0
/* 802DC53C 002A5AFC  41 82 00 0C */	beq .L_802DC548
/* 802DC540 002A5B00  2C 08 00 00 */	cmpwi r8, 0x0
/* 802DC544 002A5B04  41 81 FF D4 */	bgt .L_802DC518
.L_802DC548:
/* 802DC548 002A5B08  80 03 00 08 */	lwz r0, 0x8(r3)
/* 802DC54C 002A5B0C  2C 00 00 00 */	cmpwi r0, 0x0
/* 802DC550 002A5B10  40 81 00 18 */	ble .L_802DC568
/* 802DC554 002A5B14  7C 04 00 51 */	subf. r0, r4, r0
/* 802DC558 002A5B18  90 03 00 08 */	stw r0, 0x8(r3)
/* 802DC55C 002A5B1C  40 80 00 0C */	bge .L_802DC568
/* 802DC560 002A5B20  38 00 00 00 */	li r0, 0x0
/* 802DC564 002A5B24  90 03 00 08 */	stw r0, 0x8(r3)
.L_802DC568:
...
/* 802DC574 002A5B34  2C 05 00 00 */	cmpwi r5, 0x0
/* 802DC578 002A5B38  4D 80 00 20 */	bltlr
/* 802DC57C 002A5B3C  80 03 00 08 */	lwz r0, 0x8(r3)
/* 802DC580 002A5B40  7C 05 00 00 */	cmpw r5, r0
/* 802DC584 002A5B44  41 80 00 54 */	blt .L_802DC5D8
/* 802DC588 002A5B48  80 03 00 00 */	lwz r0, 0x0(r3)
/* 802DC58C 002A5B4C  2C 00 00 00 */	cmpwi r0, 0x0
/* 802DC590 002A5B50  40 82 00 0C */	bne .L_802DC59C
/* 802DC594 002A5B54  90 83 00 00 */	stw r4, 0x0(r3)
/* 802DC598 002A5B58  48 00 00 1C */	b .L_802DC5B4
.L_802DC59C:
/* 802DC59C 002A5B5C  80 A3 00 04 */	lwz r5, 0x4(r3)
/* 802DC5A0 002A5B60  2C 05 00 00 */	cmpwi r5, 0x0
/* 802DC5A4 002A5B64  41 82 00 08 */	beq .L_802DC5AC
/* 802DC5A8 002A5B68  90 85 00 00 */	stw r4, 0x0(r5)
.L_802DC5AC:
/* 802DC5AC 002A5B6C  80 03 00 04 */	lwz r0, 0x4(r3)
/* 802DC5B0 002A5B70  90 04 00 04 */	stw r0, 0x4(r4)
.L_802DC5B4:
/* 802DC5B4 002A5B74  38 00 00 00 */	li r0, 0x0
/* 802DC5B8 002A5B78  90 04 00 00 */	stw r0, 0x0(r4)
/* 802DC5BC 002A5B7C  90 83 00 04 */	stw r4, 0x4(r3)
/* 802DC5C0 002A5B80  80 03 00 08 */	lwz r0, 0x8(r3)
...
/* 802DC5D0 002A5B90  90 A3 00 08 */	stw r5, 0x8(r3)
/* 802DC5D4 002A5B94  48 00 00 7C */	b .L_802DC650
.L_802DC5D8:
/* 802DC5D8 002A5B98  80 C3 00 00 */	lwz r6, 0x0(r3)
/* 802DC5DC 002A5B9C  48 00 00 1C */	b .L_802DC5F8
.L_802DC5E0:
/* 802DC5E0 002A5BA0  2C 05 00 00 */	cmpwi r5, 0x0
...
.L_802DC5F4:
/* 802DC5F4 002A5BB4  80 C6 00 00 */	lwz r6, 0x0(r6)
.L_802DC5F8:
...
/* 802DC608 002A5BC8  80 03 00 00 */	lwz r0, 0x0(r3)
/* 802DC60C 002A5BCC  7C 06 00 40 */	cmplw r6, r0
/* 802DC610 002A5BD0  40 82 00 18 */	bne .L_802DC628
/* 802DC614 002A5BD4  90 04 00 00 */	stw r0, 0x0(r4)
/* 802DC618 002A5BD8  80 A3 00 00 */	lwz r5, 0x0(r3)
/* 802DC61C 002A5BDC  90 85 00 04 */	stw r4, 0x4(r5)
/* 802DC620 002A5BE0  90 83 00 00 */	stw r4, 0x0(r3)
/* 802DC624 002A5BE4  48 00 00 1C */	b .L_802DC640
.L_802DC628:
/* 802DC628 002A5BE8  80 66 00 04 */	lwz r3, 0x4(r6)
/* 802DC62C 002A5BEC  90 83 00 00 */	stw r4, 0x0(r3)
/* 802DC630 002A5BF0  80 06 00 04 */	lwz r0, 0x4(r6)
/* 802DC634 002A5BF4  90 04 00 04 */	stw r0, 0x4(r4)
/* 802DC638 002A5BF8  90 86 00 04 */	stw r4, 0x4(r6)
/* 802DC63C 002A5BFC  90 C4 00 00 */	stw r6, 0x0(r4)
.L_802DC640:
...
.L_802DC650:
/* 802DC650 002A5C10  38 00 00 01 */	li r0, 0x1
/* 802DC654 002A5C14  98 04 00 16 */	stb r0, 0x16(r4)
/* 802DC658 002A5C18  4E 80 00 20 */	blr
.endfn GKI_add_to_timer_list
/* 802DC65C 002A5C1C  00 00 00 00 */	.4byte 0x00000000 /* invalid */

.fn GKI_remove_from_timer_list, global
/* 802DC660 002A5C20  2C 04 00 00 */	cmpwi r4, 0x0
/* 802DC664 002A5C24  4D 82 00 20 */	beqlr
/* 802DC668 002A5C28  88 04 00 16 */	lbz r0, 0x16(r4)
/* 802DC66C 002A5C2C  2C 00 00 00 */	cmpwi r0, 0x0
/* 802DC670 002A5C30  4D 82 00 20 */	beqlr
/* 802DC674 002A5C34  80 03 00 00 */	lwz r0, 0x0(r3)
/* 802DC678 002A5C38  2C 00 00 00 */	cmpwi r0, 0x0
/* 802DC67C 002A5C3C  40 82 00 08 */	bne .L_802DC684
/* 802DC680 002A5C40  4E 80 00 20 */	blr
.L_802DC684:
/* 802DC684 002A5C44  80 C4 00 00 */	lwz r6, 0x0(r4)
/* 802DC688 002A5C48  2C 06 00 00 */	cmpwi r6, 0x0
...
/* 802DC6A8 002A5C68  80 03 00 08 */	lwz r0, 0x8(r3)
/* 802DC6AC 002A5C6C  7C 05 00 50 */	subf r0, r5, r0
/* 802DC6B0 002A5C70  90 03 00 08 */	stw r0, 0x8(r3)
.L_802DC6B4:
/* 802DC6B4 002A5C74  80 03 00 00 */	lwz r0, 0x0(r3)
/* 802DC6B8 002A5C78  7C 00 20 40 */	cmplw r0, r4
/* 802DC6BC 002A5C7C  40 82 00 34 */	bne .L_802DC6F0
/* 802DC6C0 002A5C80  80 A4 00 00 */	lwz r5, 0x0(r4)
/* 802DC6C4 002A5C84  90 A3 00 00 */	stw r5, 0x0(r3)
/* 802DC6C8 002A5C88  2C 05 00 00 */	cmpwi r5, 0x0
/* 802DC6CC 002A5C8C  41 82 00 0C */	beq .L_802DC6D8
/* 802DC6D0 002A5C90  38 00 00 00 */	li r0, 0x0
/* 802DC6D4 002A5C94  90 05 00 04 */	stw r0, 0x4(r5)
.L_802DC6D8:
/* 802DC6D8 002A5C98  80 03 00 04 */	lwz r0, 0x4(r3)
/* 802DC6DC 002A5C9C  7C 00 20 40 */	cmplw r0, r4
/* 802DC6E0 002A5CA0  40 82 00 88 */	bne .L_802DC768
/* 802DC6E4 002A5CA4  38 00 00 00 */	li r0, 0x0
/* 802DC6E8 002A5CA8  90 03 00 04 */	stw r0, 0x4(r3)
/* 802DC6EC 002A5CAC  48 00 00 7C */	b .L_802DC768
.L_802DC6F0:
/* 802DC6F0 002A5CB0  80 03 00 04 */	lwz r0, 0x4(r3)
/* 802DC6F4 002A5CB4  7C 00 20 40 */	cmplw r0, r4
/* 802DC6F8 002A5CB8  40 82 00 20 */	bne .L_802DC718
/* 802DC6FC 002A5CBC  80 A4 00 04 */	lwz r5, 0x4(r4)
/* 802DC700 002A5CC0  90 A3 00 04 */	stw r5, 0x4(r3)
/* 802DC704 002A5CC4  2C 05 00 00 */	cmpwi r5, 0x0
/* 802DC708 002A5CC8  41 82 00 60 */	beq .L_802DC768
/* 802DC70C 002A5CCC  38 00 00 00 */	li r0, 0x0
/* 802DC710 002A5CD0  90 05 00 00 */	stw r0, 0x0(r5)
/* 802DC714 002A5CD4  48 00 00 54 */	b .L_802DC768
.L_802DC718:
/* 802DC718 002A5CD8  80 64 00 00 */	lwz r3, 0x0(r4)
/* 802DC71C 002A5CDC  2C 03 00 00 */	cmpwi r3, 0x0
/* 802DC720 002A5CE0  4D 82 00 20 */	beqlr
/* 802DC724 002A5CE4  80 03 00 04 */	lwz r0, 0x4(r3)
/* 802DC728 002A5CE8  7C 00 20 40 */	cmplw r0, r4
/* 802DC72C 002A5CEC  4C 82 00 20 */	bnelr
/* 802DC730 002A5CF0  80 04 00 04 */	lwz r0, 0x4(r4)
/* 802DC734 002A5CF4  90 03 00 04 */	stw r0, 0x4(r3)
/* 802DC738 002A5CF8  48 00 00 08 */	b .L_802DC740
/* 802DC73C 002A5CFC  4E 80 00 20 */	blr
.L_802DC740:
/* 802DC740 002A5D00  80 64 00 04 */	lwz r3, 0x4(r4)
/* 802DC744 002A5D04  2C 03 00 00 */	cmpwi r3, 0x0
/* 802DC748 002A5D08  4D 82 00 20 */	beqlr
/* 802DC74C 002A5D0C  80 03 00 00 */	lwz r0, 0x0(r3)
/* 802DC750 002A5D10  7C 00 20 40 */	cmplw r0, r4
/* 802DC754 002A5D14  4C 82 00 20 */	bnelr
/* 802DC758 002A5D18  80 04 00 00 */	lwz r0, 0x0(r4)
/* 802DC75C 002A5D1C  90 03 00 00 */	stw r0, 0x0(r3)
/* 802DC760 002A5D20  48 00 00 08 */	b .L_802DC768
/* 802DC764 002A5D24  4E 80 00 20 */	blr
.L_802DC768:
/* 802DC768 002A5D28  38 60 00 00 */	li r3, 0x0
/* 802DC76C 002A5D2C  3C 00 80 00 */	lis r0, 0x8000
/* 802DC770 002A5D30  90 64 00 04 */	stw r3, 0x4(r4)
/* 802DC774 002A5D34  90 64 00 00 */	stw r3, 0x0(r4)
...
/* 802DC784 002A5D44  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 802DC788 002A5D48  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 802DC78C 002A5D4C  00 00 00 00 */	.4byte 0x00000000 /* invalid */
