...
/* 802E1594 002AAB54  3B A0 00 00 */	li r29, 0x0
/* 802E1598 002AAB58  93 81 00 10 */	stw r28, 0x10(r1)
/* 802E159C 002AAB5C  7C 7C 1B 78 */	mr r28, r3
.L_802E15A0:
/* 802E15A0 002AAB60  A0 7C 00 00 */	lhz r3, 0x0(r28)
/* 802E15A4 002AAB64  7C 1D F2 14 */	add r0, r29, r30
/* 802E15A8 002AAB68  54 64 06 3E */	clrlwi r4, r3, 24
/* 802E15AC 002AAB6C  54 63 15 BA */	clrlslwi r3, r3, 24, 2
...
/* 802E15C0 002AAB80  54 00 15 BA */	clrlslwi r0, r0, 24, 2
...
/* 802E15D4 002AAB94  3B BD 00 01 */	addi r29, r29, 0x1
/* 802E15D8 002AAB98  2C 1D 00 02 */	cmpwi r29, 0x2
/* 802E15DC 002AAB9C  41 80 FF C4 */	blt .L_802E15A0
.L_802E15E0:
/* 802E15E0 002AABA0  83 E1 00 1C */	lwz r31, 0x1c(r1)
/* 802E15E4 002AABA4  38 60 00 01 */	li r3, 0x1
...
/* 802E1634 002AABF4  3B A0 00 00 */	li r29, 0x0
...
/* 802E1644 002AAC04  A0 03 00 00 */	lhz r0, 0x0(r3)
/* 802E1648 002AAC08  54 C6 10 3A */	slwi r6, r6, 2
/* 802E164C 002AAC0C  54 04 06 3E */	clrlwi r4, r0, 24
/* 802E1650 002AAC10  54 00 15 BA */	clrlslwi r0, r0, 24, 2
...
/* 802E1660 002AAC20  88 03 00 02 */	lbz r0, 0x2(r3)
/* 802E1664 002AAC24  B0 07 00 18 */	sth r0, 0x18(r7)
.L_802E1668:
/* 802E1668 002AAC28  A0 7C 00 00 */	lhz r3, 0x0(r28)
/* 802E166C 002AAC2C  7C 1D F2 14 */	add r0, r29, r30
/* 802E1670 002AAC30  54 64 06 3E */	clrlwi r4, r3, 24
/* 802E1674 002AAC34  54 63 15 BA */	clrlslwi r3, r3, 24, 2
...
/* 802E1688 002AAC48  54 00 15 BA */	clrlslwi r0, r0, 24, 2
...
/* 802E169C 002AAC5C  3B BD 00 01 */	addi r29, r29, 0x1
/* 802E16A0 002AAC60  2C 1D 00 02 */	cmpwi r29, 0x2
/* 802E16A4 002AAC64  41 80 FF C4 */	blt .L_802E1668
.L_802E16A8:
/* 802E16A8 002AAC68  83 E1 00 1C */	lwz r31, 0x1c(r1)
/* 802E16AC 002AAC6C  38 60 00 01 */	li r3, 0x1
