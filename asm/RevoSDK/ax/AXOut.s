...
/* 802D3A94 0029D054  38 BF 00 00 */	addi r5, r31, 0x0
/* 802D3A98 0029D058  90 7F 00 00 */	stw r3, 0x0(r31)
/* 802D3A9C 0029D05C  90 85 00 04 */	stw r4, 0x4(r5)
...
/* 802D3B00 0029D0C0  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 802D3B10 0029D0D0  3B BF 00 00 */	addi r29, r31, 0x0
/* 802D3B14 0029D0D4  90 9D 00 0C */	stw r4, 0xc(r29)
/* 802D3B18 0029D0D8  90 7D 00 08 */	stw r3, 0x8(r29)
...
/* 802D3B38 0029D0F8  2C 0C 00 00 */	cmpwi r12, 0x0
...
/* 802D3B54 0029D114  39 1F 00 00 */	addi r8, r31, 0x0
...
/* 802D3B84 0029D144  90 C1 00 08 */	stw r6, 0x8(r1)
...
/* 802D3B98 0029D158  38 E0 00 00 */	li r7, 0x0
.L_802D3B9C:
...
/* 802D3BD0 0029D190  38 A1 00 08 */	addi r5, r1, 0x8
...
/* 802D3C20 0029D1E0  54 00 07 FE */	clrlwi r0, r0, 31
...
/* 802D3C3C 0029D1FC  3B BF 00 00 */	addi r29, r31, 0x0
...
/* 802D3C54 0029D214  2C 03 00 00 */	cmpwi r3, 0x0
/* 802D3C58 0029D218  41 82 00 58 */	beq .L_802D3CB0
/* 802D3C5C 0029D21C  38 00 00 07 */	li r0, 0x7
/* 802D3C60 0029D220  7C 09 03 A6 */	mtctr r0
.L_802D3C64:
/* 802D3C64 0029D224  88 1D 00 00 */	lbz r0, 0x0(r29)
/* 802D3C68 0029D228  98 03 00 00 */	stb r0, 0x0(r3)
/* 802D3C6C 0029D22C  88 1D 00 01 */	lbz r0, 0x1(r29)
/* 802D3C70 0029D230  98 03 00 01 */	stb r0, 0x1(r3)
/* 802D3C74 0029D234  88 1D 00 02 */	lbz r0, 0x2(r29)
/* 802D3C78 0029D238  98 03 00 02 */	stb r0, 0x2(r3)
/* 802D3C7C 0029D23C  88 1D 00 03 */	lbz r0, 0x3(r29)
/* 802D3C80 0029D240  98 03 00 03 */	stb r0, 0x3(r3)
/* 802D3C84 0029D244  88 1D 00 04 */	lbz r0, 0x4(r29)
/* 802D3C88 0029D248  98 03 00 04 */	stb r0, 0x4(r3)
/* 802D3C8C 0029D24C  88 1D 00 05 */	lbz r0, 0x5(r29)
/* 802D3C90 0029D250  98 03 00 05 */	stb r0, 0x5(r3)
/* 802D3C94 0029D254  88 1D 00 06 */	lbz r0, 0x6(r29)
/* 802D3C98 0029D258  98 03 00 06 */	stb r0, 0x6(r3)
/* 802D3C9C 0029D25C  88 1D 00 07 */	lbz r0, 0x7(r29)
/* 802D3CA0 0029D260  3B BD 00 08 */	addi r29, r29, 0x8
/* 802D3CA4 0029D264  98 03 00 07 */	stb r0, 0x7(r3)
/* 802D3CA8 0029D268  38 63 00 08 */	addi r3, r3, 0x8
...
.L_802D3D04:
/* 802D3D04 0029D2C4  38 00 00 02 */	li r0, 0x2
...
/* 802D3D1C 0029D2DC  28 00 00 01 */	cmplwi r0, 0x1
...
/* 802D3D44 0029D304  3C 60 AA AB */	lis r3, 0xaaab
/* 802D3D48 0029D308  38 63 AA AB */	addi r3, r3, -0x5555
/* 802D3D4C 0029D30C  80 0D B5 40 */	lwz r0, lbl_806676C0@sda21(r13)
/* 802D3D50 0029D310  38 84 00 01 */	addi r4, r4, 0x1
/* 802D3D54 0029D314  7C 63 20 16 */	mulhwu r3, r3, r4
/* 802D3D58 0029D318  54 63 F8 7E */	srwi r3, r3, 1
/* 802D3D5C 0029D31C  1C 63 00 03 */	mulli r3, r3, 0x3
...
/* 802D3DA0 0029D360  28 00 00 02 */	cmplwi r0, 0x2
/* 802D3DA4 0029D364  40 82 00 28 */	bne .L_802D3DCC
/* 802D3DA8 0029D368  38 00 00 00 */	li r0, 0x0
...
/* 802D3DB8 0029D378  2C 0C 00 00 */	cmpwi r12, 0x0
...
.L_802D3DCC:
/* 802D3DCC 0029D38C  38 00 00 01 */	li r0, 0x1
...
/* 802D3DE4 0029D3A4  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 802D3DE8 0029D3A8  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 802D3DEC 0029D3AC  00 00 00 00 */	.4byte 0x00000000 /* invalid */

.fn __AXDSPDoneCallback, global
/* 802D3DF0 0029D3B0  38 00 00 01 */	li r0, 0x1
...
/* 802D3E04 0029D3C4  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 802D3E08 0029D3C8  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 802D3E0C 0029D3CC  00 00 00 00 */	.4byte 0x00000000 /* invalid */
...
/* 802D3E3C 0029D3FC  39 80 00 00 */	li r12, 0x0
/* 802D3E40 0029D400  93 C1 00 08 */	stw r30, 0x8(r1)
...
/* 802D3E68 0029D428  91 9F 00 04 */	stw r12, 0x4(r31)
...
/* 802D3EBC 0029D47C  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 802D3EDC 0029D49C  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 802D3EEC 0029D4AC  83 C1 00 08 */	lwz r30, 0x8(r1)
...
.L_802D3F38:
/* 802D3F38 0029D4F8  90 85 00 00 */	stw r4, 0x0(r5)
/* 802D3F3C 0029D4FC  90 85 00 04 */	stw r4, 0x4(r5)
/* 802D3F40 0029D500  90 85 00 08 */	stw r4, 0x8(r5)
...
/* 802D3F78 0029D538  38 60 00 00 */	li r3, 0x0
/* 802D3F7C 0029D53C  7C 09 03 A6 */	mtctr r0
.L_802D3F80:
/* 802D3F80 0029D540  90 64 00 00 */	stw r3, 0x0(r4)
/* 802D3F84 0029D544  90 64 00 04 */	stw r3, 0x4(r4)
/* 802D3F88 0029D548  90 64 00 08 */	stw r3, 0x8(r4)
...
/* 802D3FBC 0029D57C  38 60 00 00 */	li r3, 0x0
/* 802D3FC0 0029D580  7C 09 03 A6 */	mtctr r0
.L_802D3FC4:
/* 802D3FC4 0029D584  90 64 00 00 */	stw r3, 0x0(r4)
/* 802D3FC8 0029D588  90 64 00 04 */	stw r3, 0x4(r4)
/* 802D3FCC 0029D58C  90 64 00 08 */	stw r3, 0x8(r4)
...
/* 802D4020 0029D5E0  28 00 00 01 */	cmplwi r0, 0x1
...
/* 802D4030 0029D5F0  90 E1 00 08 */	stw r7, 0x8(r1)
...
/* 802D405C 0029D61C  38 A1 00 08 */	addi r5, r1, 0x8
...
/* 802D4074 0029D634  38 A1 00 08 */	addi r5, r1, 0x8
/* 802D4078 0029D638  4B FF EF 39 */	bl __AXNextFrame
.L_802D407C:
/* 802D407C 0029D63C  80 0D B5 18 */	lwz r0, lbl_80667698@sda21(r13)
/* 802D4080 0029D640  38 80 00 01 */	li r4, 0x1
/* 802D4084 0029D644  38 60 00 00 */	li r3, 0x0
/* 802D4088 0029D648  90 8D B5 38 */	stw r4, lbl_806676B8@sda21(r13)
/* 802D408C 0029D64C  28 00 00 01 */	cmplwi r0, 0x1
...
/* 802D40B4 0029D674  38 03 00 01 */	addi r0, r3, 0x1
...
/* 802D40DC 0029D69C  38 00 00 00 */	li r0, 0x0
...
.endfn __AXOutInit
/* 802D40F8 0029D6B8  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 802D40FC 0029D6BC  00 00 00 00 */	.4byte 0x00000000 /* invalid */
...
/* 802D4110 0029D6D0  93 C1 00 08 */	stw r30, 0x8(r1)
/* 802D4114 0029D6D4  48 08 48 9D */	bl OSDisableInterrupts
/* 802D4118 0029D6D8  3B E0 00 00 */	li r31, 0x0
...
/* 802D4138 0029D6F8  38 60 00 00 */	li r3, 0x0
...
/* 802D4158 0029D718  83 C1 00 08 */	lwz r30, 0x8(r1)
/* 802D415C 0029D71C  7C 08 03 A6 */	mtlr r0
/* 802D4160 0029D720  38 21 00 10 */	addi r1, r1, 0x10
/* 802D4164 0029D724  4E 80 00 20 */	blr
.endfn __AXOutQuit
/* 802D4168 0029D728  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 802D416C 0029D72C  00 00 00 00 */	.4byte 0x00000000 /* invalid */
...
/* 802D4180 0029D740  93 C1 00 08 */	stw r30, 0x8(r1)
...
/* 802D41A0 0029D760  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 802D41B4 0029D774  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 802D41B8 0029D778  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 802D41BC 0029D77C  00 00 00 00 */	.4byte 0x00000000 /* invalid */

.fn AXRmtGetSamplesLeft, global
/* 802D41C0 0029D780  80 6D B5 10 */	lwz r3, lbl_80667690@sda21(r13)
/* 802D41C4 0029D784  34 63 FF DC */	addic. r3, r3, -0x24
...
/* 802D41EC 0029D7AC  00 00 00 00 */	.4byte 0x00000000 /* invalid */
...
/* 802D4204 0029D7C4  37 E6 FF DC */	addic. r31, r6, -0x24
...
/* 802D4250 0029D810  2C 1F 00 00 */	cmpwi r31, 0x0
/* 802D4254 0029D814  40 81 00 2C */	ble .L_802D4280
.L_802D4258:
/* 802D4258 0029D818  54 E6 08 3C */	slwi r6, r7, 1
/* 802D425C 0029D81C  38 E7 00 01 */	addi r7, r7, 0x1
/* 802D4260 0029D820  7C 06 2A AE */	lhax r0, r6, r5
/* 802D4264 0029D824  B0 04 00 00 */	sth r0, 0x0(r4)
/* 802D4268 0029D828  38 84 00 02 */	addi r4, r4, 0x2
...
/* 802D4278 0029D838  38 E0 00 00 */	li r7, 0x0
.L_802D427C:
...
/* 802D42B4 0029D874  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 802D42B8 0029D878  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 802D42BC 0029D87C  00 00 00 00 */	.4byte 0x00000000 /* invalid */

.fn AXRmtAdvancePtr, global
/* 802D42C0 0029D880  80 8D B5 10 */	lwz r4, lbl_80667690@sda21(r13)
/* 802D42C4 0029D884  34 84 FF DC */	addic. r4, r4, -0x24
...
/* 802D4318 0029D8D8  00 00 00 00 */	.4byte 0x00000000 /* invalid */
/* 802D431C 0029D8DC  00 00 00 00 */	.4byte 0x00000000 /* invalid */

# 0x80580BC0 - 0x805819C0
.section .bss, "wa", @nobits
.balign 8
.sym lbl_80580BC0, local
	.skip 0x40
.sym lbl_80580C00, local
	.skip 0x8A0
.sym lbl_805814A0, local
	.skip 0x480
.sym lbl_80581920, local
	.skip 0x60
.sym lbl_80581980, local
	.skip 0x40

# 0x806658B8 - 0x806658C0
.section .sdata, "wa"
.balign 8
.sym lbl_806658B8, local
	.2byte 0x0010
.sym lbl_806658BA, local
	.2byte 0x0037
.sym lbl_806658BC, local
	.4byte 0x20000000

# 0x80667688 - 0x806676C8
.section .sbss, "wa", @nobits
.balign 8
.sym lbl_80667688, local
	.skip 0x4
.sym lbl_8066768C, local
	.skip 0x4
.sym lbl_80667690, local
	.skip 0x4
.sym lbl_80667694, local
	.skip 0x4
.sym lbl_80667698, local
	.skip 0x8
.sym lbl_806676A0, local
	.skip 0x8
.sym lbl_806676A8, local
	.skip 0x4
.sym lbl_806676AC, local
	.skip 0x4
.sym lbl_806676B0, local
	.skip 0x4
.sym lbl_806676B4, local
	.skip 0x4
.sym lbl_806676B8, local
	.skip 0x4
.sym lbl_806676BC, local
	.skip 0x4
.sym lbl_806676C0, local
	.skip 0x8
