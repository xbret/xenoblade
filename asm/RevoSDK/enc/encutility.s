...
/* 80312CD4 002DC294  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 80312CEC 002DC2AC  3B C0 00 00 */	li r30, 0x0
...
/* 80312CFC 002DC2BC  38 00 00 01 */	li r0, 0x1
/* 80312D00 002DC2C0  90 0D B7 40 */	stw r0, lbl_806678C0@sda21(r13)
.L_80312D04:
/* 80312D04 002DC2C4  2C 1B 00 00 */	cmpwi r27, 0x0
/* 80312D08 002DC2C8  41 82 00 10 */	beq .L_80312D18
/* 80312D0C 002DC2CC  80 1B 00 00 */	lwz r0, 0x0(r27)
/* 80312D10 002DC2D0  90 1C 00 00 */	stw r0, 0x0(r28)
/* 80312D14 002DC2D4  48 00 00 0C */	b .L_80312D20
.L_80312D18:
/* 80312D18 002DC2D8  38 00 FF FF */	li r0, -0x1
/* 80312D1C 002DC2DC  90 1C 00 00 */	stw r0, 0x0(r28)
.L_80312D20:
/* 80312D20 002DC2E0  2C 1F 00 00 */	cmpwi r31, 0x0
/* 80312D24 002DC2E4  41 82 00 10 */	beq .L_80312D34
/* 80312D28 002DC2E8  80 1F 00 00 */	lwz r0, 0x0(r31)
/* 80312D2C 002DC2EC  90 18 00 00 */	stw r0, 0x0(r24)
/* 80312D30 002DC2F0  48 00 00 10 */	b .L_80312D40
.L_80312D34:
/* 80312D34 002DC2F4  38 00 FF FF */	li r0, -0x1
/* 80312D38 002DC2F8  90 18 00 00 */	stw r0, 0x0(r24)
/* 80312D3C 002DC2FC  3B C0 FF FD */	li r30, -0x3
.L_80312D40:
/* 80312D40 002DC300  2C 1A 00 00 */	cmpwi r26, 0x0
/* 80312D44 002DC304  40 82 00 08 */	bne .L_80312D4C
/* 80312D48 002DC308  3B C0 FF FD */	li r30, -0x3
.L_80312D4C:
/* 80312D4C 002DC30C  2C 17 00 00 */	cmpwi r23, 0x0
/* 80312D50 002DC310  40 82 00 14 */	bne .L_80312D64
/* 80312D54 002DC314  38 00 00 00 */	li r0, 0x0
/* 80312D58 002DC318  90 19 00 00 */	stw r0, 0x0(r25)
/* 80312D5C 002DC31C  38 00 FF FF */	li r0, -0x1
/* 80312D60 002DC320  90 18 00 00 */	stw r0, 0x0(r24)
.L_80312D64:
/* 80312D64 002DC324  80 1C 00 00 */	lwz r0, 0x0(r28)
/* 80312D68 002DC328  2C 00 00 00 */	cmpwi r0, 0x0
/* 80312D6C 002DC32C  40 80 00 0C */	bge .L_80312D78
/* 80312D70 002DC330  38 00 00 00 */	li r0, 0x0
/* 80312D74 002DC334  90 1D 00 00 */	stw r0, 0x0(r29)
.L_80312D78:
/* 80312D78 002DC338  2C 1E 00 00 */	cmpwi r30, 0x0
/* 80312D7C 002DC33C  41 82 00 10 */	beq .L_80312D8C
/* 80312D80 002DC340  38 00 00 00 */	li r0, 0x0
/* 80312D84 002DC344  90 1F 00 00 */	stw r0, 0x0(r31)
/* 80312D88 002DC348  90 1B 00 00 */	stw r0, 0x0(r27)
.L_80312D8C:
...
/* 80312E1C 002DC3DC  38 BE FF FF */	addi r5, r30, -0x1
/* 80312E20 002DC3E0  38 80 00 00 */	li r4, 0x0
/* 80312E24 002DC3E4  4B CF 15 2D */	bl memset
/* 80312E28 002DC3E8  2C 1F 00 01 */	cmpwi r31, 0x1
/* 80312E2C 002DC3EC  41 82 00 18 */	beq .L_80312E44
/* 80312E30 002DC3F0  2C 1F 00 02 */	cmpwi r31, 0x2
/* 80312E34 002DC3F4  41 82 00 40 */	beq .L_80312E74
/* 80312E38 002DC3F8  2C 1F 00 03 */	cmpwi r31, 0x3
...
/* 80312E4C 002DC40C  98 03 FF FF */	stb r0, -0x1(r3)
/* 80312E50 002DC410  38 BE FF FF */	addi r5, r30, -0x1
/* 80312E54 002DC414  38 80 00 00 */	li r4, 0x0
...
/* 80312E68 002DC428  38 60 00 02 */	li r3, 0x2
/* 80312E6C 002DC42C  98 A4 FF FF */	stb r5, -0x1(r4)
...
/* 80312E7C 002DC43C  98 03 FF FF */	stb r0, -0x1(r3)
/* 80312E80 002DC440  38 60 00 01 */	li r3, 0x1
...
/* 80312E90 002DC450  98 03 FF FF */	stb r0, -0x1(r3)
/* 80312E94 002DC454  38 60 00 01 */	li r3, 0x1
/* 80312E98 002DC458  48 00 00 3C */	b .L_80312ED4
.L_80312E9C:
/* 80312E9C 002DC45C  2C 05 00 01 */	cmpwi r5, 0x1
/* 80312EA0 002DC460  41 82 00 18 */	beq .L_80312EB8
/* 80312EA4 002DC464  2C 05 00 02 */	cmpwi r5, 0x2
/* 80312EA8 002DC468  41 82 00 18 */	beq .L_80312EC0
/* 80312EAC 002DC46C  2C 05 00 03 */	cmpwi r5, 0x3
/* 80312EB0 002DC470  41 82 00 18 */	beq .L_80312EC8
/* 80312EB4 002DC474  48 00 00 1C */	b .L_80312ED0
.L_80312EB8:
/* 80312EB8 002DC478  38 60 00 02 */	li r3, 0x2
/* 80312EBC 002DC47C  48 00 00 18 */	b .L_80312ED4
.L_80312EC0:
/* 80312EC0 002DC480  38 60 00 01 */	li r3, 0x1
/* 80312EC4 002DC484  48 00 00 10 */	b .L_80312ED4
.L_80312EC8:
/* 80312EC8 002DC488  38 60 00 01 */	li r3, 0x1
/* 80312ECC 002DC48C  48 00 00 08 */	b .L_80312ED4
.L_80312ED0:
/* 80312ED0 002DC490  38 60 00 00 */	li r3, 0x0
.L_80312ED4:
