...
/* 804DAFD4 004A4594  41 82 00 0C */	beq lbl_804DAFE0
/* 804DAFD8 004A4598  38 60 00 00 */	li r3, 0
/* 804DAFDC 004A459C  48 00 00 E8 */	b lbl_804DB0C4
lbl_804DAFE0:
/* 804DAFE0 004A45A0  88 64 00 18 */	lbz r3, 0x18(r4)
/* 804DAFE4 004A45A4  7C 60 07 75 */	extsb. r0, r3
/* 804DAFE8 004A45A8  40 81 00 18 */	ble lbl_804DB000
/* 804DAFEC 004A45AC  80 0D C1 2C */	lwz r0, lbl_806682AC@sda21(r13)
/* 804DAFF0 004A45B0  2C 00 00 00 */	cmpwi r0, 0
/* 804DAFF4 004A45B4  40 80 00 0C */	bge lbl_804DB000
/* 804DAFF8 004A45B8  38 60 00 02 */	li r3, 2
/* 804DAFFC 004A45BC  48 00 00 C8 */	b lbl_804DB0C4
lbl_804DB000:
/* 804DB000 004A45C0  7C 60 07 75 */	extsb. r0, r3
/* 804DB004 004A45C4  41 82 00 28 */	beq lbl_804DB02C
/* 804DB008 004A45C8  2C 00 00 01 */	cmpwi r0, 1
/* 804DB00C 004A45CC  41 82 00 4C */	beq lbl_804DB058
/* 804DB010 004A45D0  2C 00 00 02 */	cmpwi r0, 2
/* 804DB014 004A45D4  41 82 00 6C */	beq lbl_804DB080
/* 804DB018 004A45D8  2C 00 00 03 */	cmpwi r0, 3
/* 804DB01C 004A45DC  41 82 00 84 */	beq lbl_804DB0A0
/* 804DB020 004A45E0  2C 00 00 04 */	cmpwi r0, 4
/* 804DB024 004A45E4  41 82 00 94 */	beq lbl_804DB0B8
/* 804DB028 004A45E8  48 00 00 98 */	b lbl_804DB0C0
lbl_804DB02C:
...
/* 804DB040 004A4600  41 82 00 0C */	beq lbl_804DB04C
/* 804DB044 004A4604  38 60 00 02 */	li r3, 2
/* 804DB048 004A4608  48 00 00 7C */	b lbl_804DB0C4
lbl_804DB04C:
/* 804DB04C 004A460C  38 00 00 01 */	li r0, 1
/* 804DB050 004A4610  98 1F 00 18 */	stb r0, 0x18(r31)
/* 804DB054 004A4614  48 00 00 6C */	b lbl_804DB0C0
lbl_804DB058:
...
/* 804DB0B4 004A4674  48 00 00 0C */	b lbl_804DB0C0
lbl_804DB0B8:
/* 804DB0B8 004A4678  38 60 00 01 */	li r3, 1
/* 804DB0BC 004A467C  48 00 00 08 */	b lbl_804DB0C4
lbl_804DB0C0:
...
/* 804DB0DC 004A469C  48 00 00 04 */	b lbl_804DB0E0
lbl_804DB0E0:
/* 804DB0E0 004A46A0  3C 80 80 57 */	lis r4, __vt__805735D0@ha
/* 804DB0E4 004A46A4  38 84 35 D0 */	addi r4, r4, __vt__805735D0@l
