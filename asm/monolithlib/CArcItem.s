...
/* 804DEBCC 004A818C  41 82 00 4C */	beq lbl_804DEC18
...
/* 804DEBE4 004A81A4  41 82 00 0C */	beq lbl_804DEBF0
...
/* 804DEBF8 004A81B8  41 82 00 10 */	beq lbl_804DEC08
...
/* 804DEC0C 004A81CC  40 81 00 0C */	ble lbl_804DEC18
...
/* 804DEC44 004A8204  41 82 00 10 */	beq lbl_804DEC54
...
/* 804DEC90 004A8250  41 82 00 10 */	beq lbl_804DECA0
/* 804DEC94 004A8254  88 03 00 30 */	lbz r0, 0x30(r3)
/* 804DEC98 004A8258  2C 00 00 00 */	cmpwi r0, 0
/* 804DEC9C 004A825C  41 82 00 0C */	beq lbl_804DECA8
lbl_804DECA0:
/* 804DECA0 004A8260  38 60 00 00 */	li r3, 0
/* 804DECA4 004A8264  48 00 00 60 */	b lbl_804DED04
lbl_804DECA8:
...
/* 804DECB4 004A8274  40 80 00 0C */	bge lbl_804DECC0
/* 804DECB8 004A8278  38 60 00 00 */	li r3, 0
/* 804DECBC 004A827C  48 00 00 48 */	b lbl_804DED04
lbl_804DECC0:
...
/* 804DECD4 004A8294  41 82 00 2C */	beq lbl_804DED00
...
/* 804DECFC 004A82BC  48 00 00 08 */	b lbl_804DED04
lbl_804DED00:
...
/* 804DED38 004A82F8  40 82 00 58 */	bne lbl_804DED90
/* 804DED3C 004A82FC  80 04 00 00 */	lwz r0, 0(r4)
/* 804DED40 004A8300  2C 00 00 01 */	cmpwi r0, 1
/* 804DED44 004A8304  40 82 00 34 */	bne lbl_804DED78
...
/* 804DED68 004A8328  40 82 00 18 */	bne lbl_804DED80
/* 804DED6C 004A832C  38 00 00 01 */	li r0, 1
/* 804DED70 004A8330  98 1F 00 30 */	stb r0, 0x30(r31)
/* 804DED74 004A8334  48 00 00 0C */	b lbl_804DED80
lbl_804DED78:
...
/* 804DED8C 004A834C  48 00 00 08 */	b lbl_804DED94
lbl_804DED90:
