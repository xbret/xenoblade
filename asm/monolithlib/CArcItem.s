...
/* 804DEB24 004A80E4  38 00 00 00 */	li r0, 0x0
...
/* 804DEB38 004A80F8  90 A3 00 00 */	stw r5, 0x0(r3)
/* 804DEB3C 004A80FC  98 03 00 04 */	stb r0, 0x4(r3)
...
/* 804DEB58 004A8118  4B F5 58 49 */	bl fn_804343A0
/* 804DEB5C 004A811C  7F E4 FB 78 */	mr r4, r31
/* 804DEB60 004A8120  7F C5 F3 78 */	mr r5, r30
/* 804DEB64 004A8124  38 C0 00 00 */	li r6, 0x0
/* 804DEB68 004A8128  38 E0 00 00 */	li r7, 0x0
/* 804DEB6C 004A812C  4B F6 FC 29 */	bl fn_8044E794
/* 804DEB70 004A8130  90 7E 00 28 */	stw r3, 0x28(r30)
/* 804DEB74 004A8134  7F E4 FB 78 */	mr r4, r31
/* 804DEB78 004A8138  38 61 00 08 */	addi r3, r1, 0x8
/* 804DEB7C 004A813C  4B F5 64 FD */	bl fn_80435078
/* 804DEB80 004A8140  38 61 00 08 */	addi r3, r1, 0x8
/* 804DEB84 004A8144  4B DD AA 35 */	bl strlen
/* 804DEB88 004A8148  90 7E 00 24 */	stw r3, 0x24(r30)
/* 804DEB8C 004A814C  38 7E 00 04 */	addi r3, r30, 0x4
/* 804DEB90 004A8150  38 81 00 08 */	addi r4, r1, 0x8
...
/* 804DEBB8 004A8178  2C 03 00 00 */	cmpwi r3, 0x0
/* 804DEBBC 004A817C  90 01 00 14 */	stw r0, 0x14(r1)
/* 804DEBC0 004A8180  BF C1 00 08 */	stmw r30, 0x8(r1)
...
/* 804DEBDC 004A819C  90 83 00 00 */	stw r4, 0x0(r3)
/* 804DEBE0 004A81A0  2C 00 00 00 */	cmpwi r0, 0x0
/* 804DEBE4 004A81A4  41 82 00 0C */	beq .L_804DEBF0
/* 804DEBE8 004A81A8  7C 03 03 78 */	mr r3, r0
/* 804DEBEC 004A81AC  4B F7 05 2D */	bl fn_8044F118
.L_804DEBF0:
/* 804DEBF0 004A81B0  80 7E 00 38 */	lwz r3, 0x38(r30)
/* 804DEBF4 004A81B4  2C 03 00 00 */	cmpwi r3, 0x0
/* 804DEBF8 004A81B8  41 82 00 10 */	beq .L_804DEC08
/* 804DEBFC 004A81BC  4B F5 58 DD */	bl fn_804344D8
/* 804DEC00 004A81C0  38 00 00 00 */	li r0, 0x0
/* 804DEC04 004A81C4  90 1E 00 38 */	stw r0, 0x38(r30)
.L_804DEC08:
/* 804DEC08 004A81C8  2C 1F 00 00 */	cmpwi r31, 0x0
...
/* 804DEC1C 004A81DC  BB C1 00 08 */	lmw r30, 0x8(r1)
...
/* 804DEC40 004A8200  2C 00 00 00 */	cmpwi r0, 0x0
/* 804DEC44 004A8204  41 82 00 10 */	beq .L_804DEC54
/* 804DEC48 004A8208  38 00 00 02 */	li r0, 0x2
...
/* 804DEC58 004A8218  2C 00 00 00 */	cmpwi r0, 0x0
/* 804DEC5C 004A821C  4D 82 00 20 */	beqlr
/* 804DEC60 004A8220  38 00 00 02 */	li r0, 0x2
...
/* 804DECB0 004A8270  2C 03 00 00 */	cmpwi r3, 0x0
/* 804DECB4 004A8274  40 80 00 0C */	bge .L_804DECC0
/* 804DECB8 004A8278  38 60 00 00 */	li r3, 0x0
...
/* 804DECC8 004A8288  38 A1 00 08 */	addi r5, r1, 0x8
/* 804DECCC 004A828C  4B DF 2C F5 */	bl ARCFastOpen
/* 804DECD0 004A8290  2C 03 00 00 */	cmpwi r3, 0x0
/* 804DECD4 004A8294  41 82 00 2C */	beq .L_804DED00
/* 804DECD8 004A8298  38 61 00 08 */	addi r3, r1, 0x8
/* 804DECDC 004A829C  4B DF 31 85 */	bl ARCGetStartAddrInMem
/* 804DECE0 004A82A0  90 7E 00 00 */	stw r3, 0x0(r30)
/* 804DECE4 004A82A4  38 61 00 08 */	addi r3, r1, 0x8
/* 804DECE8 004A82A8  4B DF 31 99 */	bl ARCGetLength
/* 804DECEC 004A82AC  90 7F 00 00 */	stw r3, 0x0(r31)
/* 804DECF0 004A82B0  38 61 00 08 */	addi r3, r1, 0x8
/* 804DECF4 004A82B4  4B DF 31 9D */	bl ARCClose
/* 804DECF8 004A82B8  38 60 00 01 */	li r3, 0x1
/* 804DECFC 004A82BC  48 00 00 08 */	b .L_804DED04
.L_804DED00:
/* 804DED00 004A82C0  38 60 00 00 */	li r3, 0x0
.L_804DED04:
...
/* 804DED30 004A82F0  80 04 00 04 */	lwz r0, 0x4(r4)
/* 804DED34 004A82F4  7C 00 30 40 */	cmplw r0, r6
/* 804DED38 004A82F8  40 82 00 58 */	bne .L_804DED90
/* 804DED3C 004A82FC  80 04 00 00 */	lwz r0, 0x0(r4)
/* 804DED40 004A8300  2C 00 00 01 */	cmpwi r0, 0x1
/* 804DED44 004A8304  40 82 00 34 */	bne .L_804DED78
/* 804DED48 004A8308  80 A6 00 04 */	lwz r5, 0x4(r6)
/* 804DED4C 004A830C  38 00 00 00 */	li r0, 0x0
/* 804DED50 004A8310  38 9F 00 3C */	addi r4, r31, 0x3c
/* 804DED54 004A8314  90 06 00 04 */	stw r0, 0x4(r6)
