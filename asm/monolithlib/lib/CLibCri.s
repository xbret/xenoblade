.include "macros.inc"
.file "monolithlib/lib/CLibCri.o"

# 0x8001D4A8 - 0x8001D564
.section extab, "a"
.balign 4
...
/* 80459884 00422E44  4B FE F6 BD */	bl fn_80448F40
/* 80459888 00422E48  3C 80 80 57 */	lis r4, __vt__CLibCri@ha
/* 8045988C 00422E4C  2C 1F 00 00 */	cmpwi r31, 0x0
/* 80459890 00422E50  38 84 06 A0 */	addi r4, r4, __vt__CLibCri@l
/* 80459894 00422E54  90 9F 00 00 */	stw r4, 0x0(r31)
...
.L_804598C0:
/* 804598C0 00422E80  48 09 48 D5 */	bl fn_804EE194
...
/* 804598F4 00422EB4  93 C1 00 08 */	stw r30, 0x8(r1)
...
/* 8045990C 00422ECC  90 A3 00 00 */	stw r5, 0x0(r3)
...
/* 8045992C 00422EEC  48 09 48 85 */	bl fn_804EE1B0
/* 80459930 00422EF0  38 00 00 00 */	li r0, 0x0
/* 80459934 00422EF4  90 0D BE 30 */	stw r0, lbl_80667FB0@sda21(r13)
/* 80459938 00422EF8  38 7E 01 C4 */	addi r3, r30, 0x1c4
/* 8045993C 00422EFC  38 80 00 00 */	li r4, 0x0
/* 80459940 00422F00  4B FE F6 3D */	bl fn_80448F7C
/* 80459944 00422F04  7F C3 F3 78 */	mr r3, r30
/* 80459948 00422F08  38 80 00 00 */	li r4, 0x0
/* 8045994C 00422F0C  4B FD E1 7D */	bl fn_80437AC8
/* 80459950 00422F10  2C 1F 00 00 */	cmpwi r31, 0x0
...
/* 80459968 00422F28  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 80459988 00422F48  3C 04 00 01 */	addis r0, r4, 0x1
...
/* 804599B0 00422F70  4B FD A9 F1 */	bl fn_804343A0
/* 804599B4 00422F74  7C 7D 1B 78 */	mr r29, r3
.L_804599B8:
/* 804599B8 00422F78  7F 83 E3 78 */	mr r3, r28
/* 804599BC 00422F7C  4B FD B6 55 */	bl fn_80435010
/* 804599C0 00422F80  2C 03 00 00 */	cmpwi r3, 0x0
/* 804599C4 00422F84  7C 7F 1B 78 */	mr r31, r3
/* 804599C8 00422F88  40 82 00 0C */	bne .L_804599D4
/* 804599CC 00422F8C  38 60 FF FF */	li r3, -0x1
/* 804599D0 00422F90  48 00 00 88 */	b .L_80459A58
.L_804599D4:
/* 804599D4 00422F94  48 08 46 3D */	bl fn_804DE010
/* 804599D8 00422F98  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 804599F4 00422FB4  39 01 00 08 */	addi r8, r1, 0x8
/* 804599F8 00422FB8  48 08 43 5D */	bl fn_804DDD54
/* 804599FC 00422FBC  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 80459A30 00422FF0  54 08 0F FE */	srwi r8, r0, 31
/* 80459A34 00422FF4  48 00 1B 79 */	bl fn_8045B5AC
...
/* 80459A48 00423008  38 C0 FF FF */	li r6, -0x1
/* 80459A4C 0042300C  38 E0 FF FF */	li r7, -0x1
/* 80459A50 00423010  39 00 00 00 */	li r8, 0x0
/* 80459A54 00423014  48 00 1B 59 */	bl fn_8045B5AC
.L_80459A58:
...
.fn fn_80459A78, global
/* 80459A78 00423038  48 00 1E F8 */	b fn_8045B970
.endfn fn_80459A78

.fn fn_80459A7C, global
/* 80459A7C 0042303C  48 00 20 34 */	b fn_8045BAB0
.endfn fn_80459A7C

.fn fn_80459A80, global
/* 80459A80 00423040  48 00 21 20 */	b fn_8045BBA0
.endfn fn_80459A80

.fn fn_80459A84, global
/* 80459A84 00423044  48 00 21 C8 */	b fn_8045BC4C
.endfn fn_80459A84

.fn fn_80459A88, global
/* 80459A88 00423048  48 00 2F C4 */	b fn_8045CA4C
.endfn fn_80459A88

.fn fn_80459A8C, global
/* 80459A8C 0042304C  48 00 2B F0 */	b fn_8045C67C
.endfn fn_80459A8C

.fn fn_80459A90, global
/* 80459A90 00423050  48 00 2C 70 */	b fn_8045C700
.endfn fn_80459A90

.fn fn_80459A94, global
/* 80459A94 00423054  48 00 2E 1C */	b fn_8045C8B0
.endfn fn_80459A94

.fn fn_80459A98, global
/* 80459A98 00423058  48 00 23 B0 */	b fn_8045BE48
.endfn fn_80459A98

.fn fn_80459A9C, global
/* 80459A9C 0042305C  48 00 32 60 */	b fn_8045CCFC
.endfn fn_80459A9C

.fn fn_80459AA0, global
/* 80459AA0 00423060  48 00 35 3C */	b fn_8045CFDC
.endfn fn_80459AA0

.fn fn_80459AA4, global
/* 80459AA4 00423064  48 00 35 98 */	b fn_8045D03C
.endfn fn_80459AA4

.fn fn_80459AA8, global
/* 80459AA8 00423068  48 00 07 B8 */	b fn_8045A260
.endfn fn_80459AA8

.fn fn_80459AAC, global
/* 80459AAC 0042306C  48 00 09 E0 */	b fn_8045A48C
.endfn fn_80459AAC

.fn fn_80459AB0, global
/* 80459AB0 00423070  7C 60 1B 78 */	mr r0, r3
/* 80459AB4 00423074  7C 83 23 78 */	mr r3, r4
/* 80459AB8 00423078  7C 04 03 78 */	mr r4, r0
/* 80459ABC 0042307C  48 00 18 54 */	b fn_8045B310
.endfn fn_80459AB0

.fn fn_80459AC0, global
/* 80459AC0 00423080  48 00 0C 48 */	b fn_8045A708
.endfn fn_80459AC0

.fn fn_80459AC4, global
/* 80459AC4 00423084  48 00 0D 34 */	b fn_8045A7F8
.endfn fn_80459AC4

.fn fn_80459AC8, global
/* 80459AC8 00423088  48 00 0B 7C */	b fn_8045A644
.endfn fn_80459AC8

.fn fn_80459ACC, global
/* 80459ACC 0042308C  48 00 0D FC */	b fn_8045A8C8
.endfn fn_80459ACC

.fn fn_80459AD0, global
/* 80459AD0 00423090  48 00 17 10 */	b fn_8045B1E0
.endfn fn_80459AD0

.fn fn_80459AD4, global
/* 80459AD4 00423094  4E 80 00 20 */	blr
.endfn fn_80459AD4

.fn fn_80459AD8, global
/* 80459AD8 00423098  4B F4 0F 44 */	b ADXM_ExecMain
.endfn fn_80459AD8

.fn fn_80459ADC, global
/* 80459ADC 0042309C  80 6D BE 30 */	lwz r3, lbl_80667FB0@sda21(r13)
/* 80459AE0 004230A0  4E 80 00 20 */	blr
.endfn fn_80459ADC

.fn fn_80459AE4, global
...
/* 80459AF4 004230B4  93 C1 00 08 */	stw r30, 0x8(r1)
/* 80459AF8 004230B8  7C 7E 1B 78 */	mr r30, r3
/* 80459AFC 004230BC  4B FF 37 4D */	bl fn_8044D248
/* 80459B00 004230C0  2C 03 00 00 */	cmpwi r3, 0x0
/* 80459B04 004230C4  41 82 00 D0 */	beq .L_80459BD4
/* 80459B08 004230C8  3C 60 80 46 */	lis r3, fn_80459C70@ha
/* 80459B0C 004230CC  7F C4 F3 78 */	mr r4, r30
/* 80459B10 004230D0  38 63 9C 70 */	addi r3, r3, fn_80459C70@l
/* 80459B14 004230D4  4B F4 12 E5 */	bl fn_8039ADF8
/* 80459B18 004230D8  38 60 00 00 */	li r3, 0x0
/* 80459B1C 004230DC  4B F4 17 7D */	bl ADXWII_SetupDvdFs
/* 80459B20 004230E0  38 60 00 02 */	li r3, 0x2
/* 80459B24 004230E4  38 80 00 00 */	li r4, 0x0
/* 80459B28 004230E8  4B F4 16 61 */	bl ADXM_SetupFramework
/* 80459B2C 004230EC  38 60 00 00 */	li r3, 0x0
...
/* 80459B3C 004230FC  3C 60 80 46 */	lis r3, fn_80459830@ha
/* 80459B40 00423100  38 63 98 30 */	addi r3, r3, fn_80459830@l
...
/* 80459B58 00423118  3B E3 00 05 */	addi r31, r3, 0x5
/* 80459B5C 0042311C  4B FD DA 59 */	bl fn_804375B4
...
/* 80459B6C 0042312C  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 80459B7C 0042313C  48 00 01 1D */	bl fn_80459C98
.L_80459B80:
/* 80459B80 00423140  7F C4 F3 78 */	mr r4, r30
/* 80459B84 00423144  38 A0 00 00 */	li r5, 0x0
/* 80459B88 00423148  4B FD F0 51 */	bl fn_80438BD8
...
/* 80459B98 00423158  4B FD DA 1D */	bl fn_804375B4
...
/* 80459BA8 00423168  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 80459C08 004231C8  80 04 00 00 */	lwz r0, 0x0(r4)
/* 80459C0C 004231CC  7C 00 20 40 */	cmplw r0, r4
/* 80459C10 004231D0  40 82 00 48 */	bne .L_80459C58
/* 80459C14 004231D4  4B FE A8 C1 */	bl fn_804444D4
/* 80459C18 004231D8  2C 03 00 00 */	cmpwi r3, 0x0
/* 80459C1C 004231DC  40 82 00 3C */	bne .L_80459C58
/* 80459C20 004231E0  4B FF F7 D1 */	bl fn_804593F0
/* 80459C24 004231E4  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 80459C38 004231F8  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 80459C50 00423210  4B FD ED D5 */	bl fn_80438A24
/* 80459C54 00423214  48 00 00 08 */	b .L_80459C5C
.L_80459C58:
/* 80459C58 00423218  38 60 00 00 */	li r3, 0x0
.L_80459C5C:
...
.fn fn_80459C70, global
/* 80459C70 00423230  4E 80 00 20 */	blr
.endfn fn_80459C70

.fn fn_80459C74, global
/* 80459C74 00423234  48 00 1F 2C */	b fn_8045BBA0
.endfn fn_80459C74

.fn fn_80459C78, global
/* 80459C78 00423238  38 63 FE 3C */	addi r3, r3, -0x1c4
/* 80459C7C 0042323C  4B FF FE 5C */	b fn_80459AD8
.endfn fn_80459C78

.fn fn_80459C80, global
/* 80459C80 00423240  38 63 FE 3C */	addi r3, r3, -0x1c4
/* 80459C84 00423244  4B FF FC 58 */	b fn_804598DC
.endfn fn_80459C80

.fn fn_80459C88, global
/* 80459C88 00423248  38 63 FE 38 */	addi r3, r3, -0x1c8
/* 80459C8C 0042324C  4B FF FF E8 */	b fn_80459C74
.endfn fn_80459C88

.fn fn_80459C90, global
/* 80459C90 00423250  38 63 FE 38 */	addi r3, r3, -0x1c8
/* 80459C94 00423254  4B FF FC 48 */	b fn_804598DC
.endfn fn_80459C90

# 0x805268F8 - 0x80526928
.rodata
.balign 8
.sym lbl_805268F8, global
	.4byte 0x2E616878
	.4byte 0x00434C69
	.4byte 0x62437269
	.4byte 0x4D6F7669
...
# 0x80667FB0 - 0x80667FB8
.section .sbss, "wa", @nobits
.balign 8
.sym lbl_80667FB0, global
	.skip 0x4
.sym lbl_80667FB4, global
	.skip 0x4

# 0x8066CC90 - 0x8066CC98
.section .sdata2, "a"
.balign 8
