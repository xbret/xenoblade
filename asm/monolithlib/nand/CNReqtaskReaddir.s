.include "macros.inc"
.file "monolithlib/nand/CNReqtaskReaddir.o"

# 0x80020778 - 0x80020780
.section extab, "a"
.balign 4
...
# 0x804DB0F0 - 0x804DB240
.text
.balign 4

.fn fn_804DB0F0, global
/* 804DB0F0 004A46B0  90 83 00 00 */	stw r4, 0x0(r3)
/* 804DB0F4 004A46B4  38 00 00 00 */	li r0, 0x0
/* 804DB0F8 004A46B8  90 A3 00 04 */	stw r5, 0x4(r3)
/* 804DB0FC 004A46BC  90 C3 00 08 */	stw r6, 0x8(r3)
/* 804DB100 004A46C0  98 03 00 0C */	stb r0, 0xc(r3)
/* 804DB104 004A46C4  38 6D C1 48 */	addi r3, r13, lbl_806682C8@sda21
/* 804DB108 004A46C8  98 04 00 00 */	stb r0, 0x0(r4)
/* 804DB10C 004A46CC  90 06 00 00 */	stw r0, 0x0(r6)
/* 804DB110 004A46D0  4E 80 00 20 */	blr
.endfn fn_804DB0F0

.fn fn_804DB114, global
...
/* 804DB12C 004A46EC  2C 00 00 00 */	cmpwi r0, 0x0
/* 804DB130 004A46F0  41 82 00 0C */	beq .L_804DB13C
/* 804DB134 004A46F4  38 60 00 00 */	li r3, 0x0
...
/* 804DB14C 004A470C  2C 00 00 00 */	cmpwi r0, 0x0
/* 804DB150 004A4710  40 80 00 0C */	bge .L_804DB15C
/* 804DB154 004A4714  38 60 00 02 */	li r3, 0x2
/* 804DB158 004A4718  48 00 00 BC */	b .L_804DB214
.L_804DB15C:
/* 804DB15C 004A471C  7C C0 07 74 */	extsb r0, r6
/* 804DB160 004A4720  2C 00 00 01 */	cmpwi r0, 0x1
/* 804DB164 004A4724  40 82 00 24 */	bne .L_804DB188
/* 804DB168 004A4728  80 64 00 08 */	lwz r3, 0x8(r4)
/* 804DB16C 004A472C  80 A4 00 04 */	lwz r5, 0x4(r4)
/* 804DB170 004A4730  80 03 00 00 */	lwz r0, 0x0(r3)
...
/* 804DB180 004A4740  38 60 00 02 */	li r3, 0x2
...
/* 804DB190 004A4750  2C 00 00 01 */	cmpwi r0, 0x1
/* 804DB194 004A4754  41 82 00 40 */	beq .L_804DB1D4
/* 804DB198 004A4758  2C 00 00 02 */	cmpwi r0, 0x2
/* 804DB19C 004A475C  41 82 00 60 */	beq .L_804DB1FC
/* 804DB1A0 004A4760  2C 00 00 03 */	cmpwi r0, 0x3
/* 804DB1A4 004A4764  41 82 00 64 */	beq .L_804DB208
/* 804DB1A8 004A4768  48 00 00 68 */	b .L_804DB210
.L_804DB1AC:
/* 804DB1AC 004A476C  80 84 00 08 */	lwz r4, 0x8(r4)
/* 804DB1B0 004A4770  38 60 00 00 */	li r3, 0x0
/* 804DB1B4 004A4774  4B FF F6 E5 */	bl fn_804DA898
/* 804DB1B8 004A4778  2C 03 00 00 */	cmpwi r3, 0x0
/* 804DB1BC 004A477C  41 82 00 0C */	beq .L_804DB1C8
/* 804DB1C0 004A4780  38 60 00 02 */	li r3, 0x2
/* 804DB1C4 004A4784  48 00 00 50 */	b .L_804DB214
.L_804DB1C8:
/* 804DB1C8 004A4788  38 00 00 01 */	li r0, 0x1
/* 804DB1CC 004A478C  98 1F 00 0C */	stb r0, 0xc(r31)
/* 804DB1D0 004A4790  48 00 00 40 */	b .L_804DB210
.L_804DB1D4:
/* 804DB1D4 004A4794  80 64 00 00 */	lwz r3, 0x0(r4)
/* 804DB1D8 004A4798  80 84 00 08 */	lwz r4, 0x8(r4)
/* 804DB1DC 004A479C  4B FF F6 BD */	bl fn_804DA898
/* 804DB1E0 004A47A0  2C 03 00 00 */	cmpwi r3, 0x0
/* 804DB1E4 004A47A4  41 82 00 0C */	beq .L_804DB1F0
/* 804DB1E8 004A47A8  38 60 00 02 */	li r3, 0x2
/* 804DB1EC 004A47AC  48 00 00 28 */	b .L_804DB214
.L_804DB1F0:
/* 804DB1F0 004A47B0  38 00 00 02 */	li r0, 0x2
/* 804DB1F4 004A47B4  98 1F 00 0C */	stb r0, 0xc(r31)
/* 804DB1F8 004A47B8  48 00 00 18 */	b .L_804DB210
.L_804DB1FC:
/* 804DB1FC 004A47BC  38 00 00 03 */	li r0, 0x3
/* 804DB200 004A47C0  98 04 00 0C */	stb r0, 0xc(r4)
/* 804DB204 004A47C4  48 00 00 0C */	b .L_804DB210
.L_804DB208:
/* 804DB208 004A47C8  38 60 00 01 */	li r3, 0x1
/* 804DB20C 004A47CC  48 00 00 08 */	b .L_804DB214
.L_804DB210:
/* 804DB210 004A47D0  38 60 00 00 */	li r3, 0x0
.L_804DB214:
...
/* 804DB238 004A47F8  90 83 00 00 */	stw r4, 0x0(r3)
/* 804DB23C 004A47FC  4E 80 00 20 */	blr
.endfn sinit_804DB228

# 0x804F5AD8 - 0x804F5ADC
.section .ctors, "a"
.balign 4
	.4byte sinit_804DB228

# 0x80527F20 - 0x80527F38
.rodata
.balign 8
...
# 0x806682C8 - 0x806682D0
.section .sbss, "wa", @nobits
.balign 8
.sym lbl_806682C8, global
	.skip 0x8
