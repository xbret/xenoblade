.include "macros.inc"
.file "monolithlib/nand/code_804DA4CC.o"

# 0x800206A0 - 0x80020758
.section extab, "a"
.balign 4
...
# 0x804DA4CC - 0x804DAD38
.text
.balign 4

.fn fn_804DA4CC, global
/* 804DA4CC 004A3A8C  88 0D C1 30 */	lbz r0, lbl_806682B0@sda21(r13)
/* 804DA4D0 004A3A90  2C 00 00 00 */	cmpwi r0, 0x0
/* 804DA4D4 004A3A94  4D 82 00 20 */	beqlr
/* 804DA4D8 004A3A98  48 00 01 C4 */	b fn_804DA69C
/* 804DA4DC 004A3A9C  4E 80 00 20 */	blr
.endfn fn_804DA4CC

.fn fn_804DA4E0, global
/* 804DA4E0 004A3AA0  94 21 FF F0 */	stwu r1, -0x10(r1)
/* 804DA4E4 004A3AA4  7C 08 02 A6 */	mflr r0
/* 804DA4E8 004A3AA8  3C C0 80 4E */	lis r6, fn_804DA97C@ha
/* 804DA4EC 004A3AAC  3C E0 80 66 */	lis r7, lbl_806626F0@ha
/* 804DA4F0 004A3AB0  90 01 00 14 */	stw r0, 0x14(r1)
/* 804DA4F4 004A3AB4  38 00 00 01 */	li r0, 0x1
/* 804DA4F8 004A3AB8  38 C6 A9 7C */	addi r6, r6, fn_804DA97C@l
/* 804DA4FC 004A3ABC  38 E7 26 F0 */	addi r7, r7, lbl_806626F0@l
/* 804DA500 004A3AC0  BF C1 00 08 */	stmw r30, 0x8(r1)
/* 804DA504 004A3AC4  3B E0 00 00 */	li r31, 0x0
...
/* 804DA55C 004A3B1C  38 C6 A9 7C */	addi r6, r6, fn_804DA97C@l
/* 804DA560 004A3B20  BF A1 00 14 */	stmw r29, 0x14(r1)
/* 804DA564 004A3B24  3B C0 00 01 */	li r30, 0x1
/* 804DA568 004A3B28  3B E0 00 00 */	li r31, 0x0
...
/* 804DA580 004A3B40  2C 03 00 00 */	cmpwi r3, 0x0
/* 804DA584 004A3B44  7C 7D 1B 78 */	mr r29, r3
/* 804DA588 004A3B48  41 82 00 10 */	beq .L_804DA598
/* 804DA58C 004A3B4C  48 00 04 CD */	bl fn_804DAA58
...
/* 804DA5D4 004A3B94  BF C1 00 08 */	stmw r30, 0x8(r1)
/* 804DA5D8 004A3B98  38 00 00 01 */	li r0, 0x1
/* 804DA5DC 004A3B9C  3B E0 00 00 */	li r31, 0x0
/* 804DA5E0 004A3BA0  7D 04 43 78 */	mr r4, r8
/* 804DA5E4 004A3BA4  38 63 27 AC */	addi r3, r3, lbl_806627AC@l
/* 804DA5E8 004A3BA8  38 C6 A9 7C */	addi r6, r6, fn_804DA97C@l
...
/* 804DA648 004A3C08  BF C1 00 08 */	stmw r30, 0x8(r1)
/* 804DA64C 004A3C0C  38 00 00 01 */	li r0, 0x1
/* 804DA650 004A3C10  3B E0 00 00 */	li r31, 0x0
/* 804DA654 004A3C14  7D 04 43 78 */	mr r4, r8
/* 804DA658 004A3C18  38 63 27 AC */	addi r3, r3, lbl_806627AC@l
/* 804DA65C 004A3C1C  38 C6 A9 7C */	addi r6, r6, fn_804DA97C@l
...
/* 804DA6A8 004A3C68  3C 80 80 4E */	lis r4, fn_804DA97C@ha
/* 804DA6AC 004A3C6C  90 01 00 14 */	stw r0, 0x14(r1)
/* 804DA6B0 004A3C70  3C A0 80 66 */	lis r5, lbl_806626F0@ha
/* 804DA6B4 004A3C74  38 00 00 01 */	li r0, 0x1
/* 804DA6B8 004A3C78  38 63 27 AC */	addi r3, r3, lbl_806627AC@l
/* 804DA6BC 004A3C7C  BF C1 00 08 */	stmw r30, 0x8(r1)
/* 804DA6C0 004A3C80  3B E0 00 00 */	li r31, 0x0
/* 804DA6C4 004A3C84  38 84 A9 7C */	addi r4, r4, fn_804DA97C@l
...
/* 804DA6D8 004A3C98  2C 03 00 00 */	cmpwi r3, 0x0
/* 804DA6DC 004A3C9C  7C 7E 1B 78 */	mr r30, r3
/* 804DA6E0 004A3CA0  41 82 00 10 */	beq .L_804DA6F0
/* 804DA6E4 004A3CA4  48 00 03 75 */	bl fn_804DAA58
...
/* 804DA6F8 004A3CB8  BB C1 00 08 */	lmw r30, 0x8(r1)
...
.fn fn_804DA76C, global
/* 804DA76C 004A3D2C  94 21 FF F0 */	stwu r1, -0x10(r1)
/* 804DA770 004A3D30  7C 08 02 A6 */	mflr r0
/* 804DA774 004A3D34  3C 80 80 4E */	lis r4, fn_804DA97C@ha
/* 804DA778 004A3D38  3C A0 80 66 */	lis r5, lbl_806626F0@ha
/* 804DA77C 004A3D3C  90 01 00 14 */	stw r0, 0x14(r1)
/* 804DA780 004A3D40  38 00 00 01 */	li r0, 0x1
/* 804DA784 004A3D44  38 84 A9 7C */	addi r4, r4, fn_804DA97C@l
/* 804DA788 004A3D48  38 A5 26 F0 */	addi r5, r5, lbl_806626F0@l
/* 804DA78C 004A3D4C  BF C1 00 08 */	stmw r30, 0x8(r1)
/* 804DA790 004A3D50  3B E0 00 00 */	li r31, 0x0
...
.fn fn_804DA7CC, global
/* 804DA7CC 004A3D8C  94 21 FF F0 */	stwu r1, -0x10(r1)
/* 804DA7D0 004A3D90  7C 08 02 A6 */	mflr r0
/* 804DA7D4 004A3D94  3C A0 80 4E */	lis r5, fn_804DA97C@ha
/* 804DA7D8 004A3D98  3C C0 80 66 */	lis r6, lbl_806626F0@ha
/* 804DA7DC 004A3D9C  90 01 00 14 */	stw r0, 0x14(r1)
/* 804DA7E0 004A3DA0  38 00 00 01 */	li r0, 0x1
/* 804DA7E4 004A3DA4  38 A5 A9 7C */	addi r5, r5, fn_804DA97C@l
/* 804DA7E8 004A3DA8  38 C6 26 F0 */	addi r6, r6, lbl_806626F0@l
/* 804DA7EC 004A3DAC  BF C1 00 08 */	stmw r30, 0x8(r1)
/* 804DA7F0 004A3DB0  3B E0 00 00 */	li r31, 0x0
...
/* 804DA8A4 004A3E64  38 00 00 01 */	li r0, 0x1
/* 804DA8A8 004A3E68  BF 81 00 10 */	stmw r28, 0x10(r1)
/* 804DA8AC 004A3E6C  3B C0 00 00 */	li r30, 0x0
...
/* 804DA8CC 004A3E8C  48 00 01 8D */	bl fn_804DAA58
/* 804DA8D0 004A3E90  3C C0 80 4E */	lis r6, fn_804DA97C@ha
...
.fn fn_804DA91C, global
/* 804DA91C 004A3EDC  94 21 FF F0 */	stwu r1, -0x10(r1)
/* 804DA920 004A3EE0  7C 08 02 A6 */	mflr r0
/* 804DA924 004A3EE4  3C 80 80 4E */	lis r4, fn_804DA97C@ha
/* 804DA928 004A3EE8  3C A0 80 66 */	lis r5, lbl_806626F0@ha
/* 804DA92C 004A3EEC  90 01 00 14 */	stw r0, 0x14(r1)
/* 804DA930 004A3EF0  38 00 00 01 */	li r0, 0x1
/* 804DA934 004A3EF4  38 84 A9 7C */	addi r4, r4, fn_804DA97C@l
/* 804DA938 004A3EF8  38 A5 26 F0 */	addi r5, r5, lbl_806626F0@l
/* 804DA93C 004A3EFC  BF C1 00 08 */	stmw r30, 0x8(r1)
/* 804DA940 004A3F00  3B E0 00 00 */	li r31, 0x0
...
.fn fn_804DA97C, global
/* 804DA97C 004A3F3C  38 00 00 00 */	li r0, 0x0
...
/* 804DA9A8 004A3F68  48 00 00 B1 */	bl fn_804DAA58
...
/* 804DA9E4 004A3FA4  48 00 00 75 */	bl fn_804DAA58
...
/* 804DAA00 004A3FC0  4C C6 31 82 */	crclr 4*cr1+eq
...
/* 804DAA3C 004A3FFC  48 00 00 1D */	bl fn_804DAA58
...
/* 804DAABC 004A407C  38 00 00 00 */	li r0, 0x0
...
/* 804DAAD0 004A4090  38 80 00 00 */	li r4, 0x0
/* 804DAAD4 004A4094  90 03 00 00 */	stw r0, 0x0(r3)
/* 804DAAD8 004A4098  38 63 00 04 */	addi r3, r3, 0x4
...
/* 804DAB04 004A40C4  BF C1 00 08 */	stmw r30, 0x8(r1)
/* 804DAB08 004A40C8  7C 7E 1B 78 */	mr r30, r3
/* 804DAB0C 004A40CC  7C 9F 23 78 */	mr r31, r4
/* 804DAB10 004A40D0  38 9E 00 04 */	addi r4, r30, 0x4
/* 804DAB14 004A40D4  80 63 00 00 */	lwz r3, 0x0(r3)
/* 804DAB18 004A40D8  81 83 00 00 */	lwz r12, 0x0(r3)
/* 804DAB1C 004A40DC  81 8C 00 08 */	lwz r12, 0x8(r12)
/* 804DAB20 004A40E0  7D 89 03 A6 */	mtctr r12
/* 804DAB24 004A40E4  4E 80 04 21 */	bctrl
/* 804DAB28 004A40E8  2C 03 00 00 */	cmpwi r3, 0x0
/* 804DAB2C 004A40EC  41 82 00 3C */	beq .L_804DAB68
/* 804DAB30 004A40F0  38 03 FF FF */	addi r0, r3, -0x1
/* 804DAB34 004A40F4  38 9E 00 04 */	addi r4, r30, 0x4
/* 804DAB38 004A40F8  7C 00 00 34 */	cntlzw r0, r0
/* 804DAB3C 004A40FC  54 00 D9 7E */	srwi r0, r0, 5
/* 804DAB40 004A4100  98 1F 00 00 */	stb r0, 0x0(r31)
/* 804DAB44 004A4104  80 7E 00 00 */	lwz r3, 0x0(r30)
/* 804DAB48 004A4108  81 83 00 00 */	lwz r12, 0x0(r3)
/* 804DAB4C 004A410C  81 8C 00 0C */	lwz r12, 0xc(r12)
/* 804DAB50 004A4110  7D 89 03 A6 */	mtctr r12
/* 804DAB54 004A4114  4E 80 04 21 */	bctrl
/* 804DAB58 004A4118  38 00 00 00 */	li r0, 0x0
/* 804DAB5C 004A411C  90 1E 00 00 */	stw r0, 0x0(r30)
/* 804DAB60 004A4120  38 60 00 01 */	li r3, 0x1
/* 804DAB64 004A4124  48 00 00 08 */	b .L_804DAB6C
.L_804DAB68:
/* 804DAB68 004A4128  38 60 00 00 */	li r3, 0x0
.L_804DAB6C:
/* 804DAB6C 004A412C  BB C1 00 08 */	lmw r30, 0x8(r1)
...
/* 804DAB94 004A4154  38 63 00 04 */	addi r3, r3, 0x4
/* 804DAB98 004A4158  48 00 07 B1 */	bl fn_804DB348
/* 804DAB9C 004A415C  90 7F 00 00 */	stw r3, 0x0(r31)
/* 804DABA0 004A4160  30 03 FF FF */	addic r0, r3, -0x1
...
/* 804DABD0 004A4190  38 63 00 04 */	addi r3, r3, 0x4
/* 804DABD4 004A4194  48 00 01 15 */	bl fn_804DACE8
/* 804DABD8 004A4198  90 7F 00 00 */	stw r3, 0x0(r31)
/* 804DABDC 004A419C  30 03 FF FF */	addic r0, r3, -0x1
...
/* 804DAC0C 004A41CC  38 63 00 04 */	addi r3, r3, 0x4
/* 804DAC10 004A41D0  48 00 03 61 */	bl fn_804DAF70
/* 804DAC14 004A41D4  90 7F 00 00 */	stw r3, 0x0(r31)
/* 804DAC18 004A41D8  30 03 FF FF */	addic r0, r3, -0x1
...
/* 804DAC48 004A4208  38 63 00 04 */	addi r3, r3, 0x4
/* 804DAC4C 004A420C  48 00 05 F5 */	bl fn_804DB240
/* 804DAC50 004A4210  90 7F 00 00 */	stw r3, 0x0(r31)
/* 804DAC54 004A4214  30 03 FF FF */	addic r0, r3, -0x1
...
/* 804DAC84 004A4244  38 63 00 04 */	addi r3, r3, 0x4
/* 804DAC88 004A4248  48 00 04 69 */	bl fn_804DB0F0
/* 804DAC8C 004A424C  90 7F 00 00 */	stw r3, 0x0(r31)
/* 804DAC90 004A4250  30 03 FF FF */	addic r0, r3, -0x1
...
/* 804DACC0 004A4280  38 63 00 04 */	addi r3, r3, 0x4
/* 804DACC4 004A4284  48 01 A0 B9 */	bl fn_804F4D7C
/* 804DACC8 004A4288  90 7F 00 00 */	stw r3, 0x0(r31)
/* 804DACCC 004A428C  30 03 FF FF */	addic r0, r3, -0x1
...
/* 804DAD0C 004A42CC  38 00 00 00 */	li r0, 0x0
...
# 0x806626F0 - 0x80662908
.section .bss, "wa", @nobits
.balign 8
.sym lbl_806626F0, global
	.skip 0xBC
.sym lbl_806627AC, global
	.skip 0x8C
.sym lbl_80662838, global
	.skip 0x44
.sym lbl_8066287C, global
	.skip 0x44
.sym lbl_806628C0, global
	.skip 0x48

# 0x80666480 - 0x806664A0
.section .sdata, "wa"
.balign 8
.sym lbl_80666480, global
	.4byte lbl_8066D9C8
.sym lbl_80666484, global
	.4byte lbl_8066D9C8
.sym lbl_80666488, global
	.4byte lbl_8066D9C8
	.4byte 0x00000000
...
# 0x806682A8 - 0x806682BC
.section .sbss, "wa", @nobits
.balign 8
.sym lbl_806682A8, global
	.skip 0x4
.sym lbl_806682AC, global
	.skip 0x4
.sym lbl_806682B0, global
	.skip 0x8
.sym lbl_806682B8, global
	.skip 0x4

# 0x8066D9C8 - 0x8066D9D0
.section .sdata2, "a"
.balign 8
.sym lbl_8066D9C8, global
	.4byte 0x00000000
	.4byte 0x00000000
