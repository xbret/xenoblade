...
/* 804DB380 004A4940  41 82 00 0C */	beq lbl_804DB38C
/* 804DB384 004A4944  38 60 00 00 */	li r3, 0
/* 804DB388 004A4948  48 00 00 84 */	b lbl_804DB40C
lbl_804DB38C:
/* 804DB38C 004A494C  88 64 00 0C */	lbz r3, 0xc(r4)
/* 804DB390 004A4950  7C 60 07 75 */	extsb. r0, r3
/* 804DB394 004A4954  40 81 00 18 */	ble lbl_804DB3AC
/* 804DB398 004A4958  80 0D C1 2C */	lwz r0, lbl_806682AC@sda21(r13)
/* 804DB39C 004A495C  2C 00 00 00 */	cmpwi r0, 0
/* 804DB3A0 004A4960  40 80 00 0C */	bge lbl_804DB3AC
/* 804DB3A4 004A4964  38 60 00 02 */	li r3, 2
/* 804DB3A8 004A4968  48 00 00 64 */	b lbl_804DB40C
lbl_804DB3AC:
/* 804DB3AC 004A496C  7C 60 07 75 */	extsb. r0, r3
/* 804DB3B0 004A4970  41 82 00 18 */	beq lbl_804DB3C8
/* 804DB3B4 004A4974  2C 00 00 01 */	cmpwi r0, 1
/* 804DB3B8 004A4978  41 82 00 3C */	beq lbl_804DB3F4
/* 804DB3BC 004A497C  2C 00 00 02 */	cmpwi r0, 2
/* 804DB3C0 004A4980  41 82 00 40 */	beq lbl_804DB400
/* 804DB3C4 004A4984  48 00 00 44 */	b lbl_804DB408
lbl_804DB3C8:
...
.global sinit_804DB420
sinit_804DB420:
/* 804DB420 004A49E0  38 6D C1 58 */	addi r3, r13, lbl_806682D8@sda21
/* 804DB424 004A49E4  48 00 00 04 */	b lbl_804DB428
lbl_804DB428:
