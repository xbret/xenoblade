...
/* 804DB354 004A4914  90 C3 00 08 */	stw r6, 0x8(r3)
...
/* 804DB37C 004A493C  2C 00 00 00 */	cmpwi r0, 0x0
/* 804DB380 004A4940  41 82 00 0C */	beq .L_804DB38C
/* 804DB384 004A4944  38 60 00 00 */	li r3, 0x0
...
/* 804DB39C 004A495C  2C 00 00 00 */	cmpwi r0, 0x0
/* 804DB3A0 004A4960  40 80 00 0C */	bge .L_804DB3AC
/* 804DB3A4 004A4964  38 60 00 02 */	li r3, 0x2
...
/* 804DB3B4 004A4974  2C 00 00 01 */	cmpwi r0, 0x1
/* 804DB3B8 004A4978  41 82 00 3C */	beq .L_804DB3F4
/* 804DB3BC 004A497C  2C 00 00 02 */	cmpwi r0, 0x2
...
/* 804DB430 004A49F0  90 83 00 00 */	stw r4, 0x0(r3)
/* 804DB434 004A49F4  4E 80 00 20 */	blr
.endfn sinit_804DB420

# 0x804F5AE0 - 0x804F5AE4
.section .ctors, "a"
.balign 4
	.4byte sinit_804DB420

# 0x80527F48 - 0x80527F58
.rodata
.balign 8
