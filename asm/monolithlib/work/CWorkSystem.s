.include "macros.inc"
.file "monolithlib/work/CWorkSystem.o"

# 0x8001C838 - 0x8001C870
.section extab, "a"
.balign 4
...
# 0x80444418 - 0x804448B8
.text
.balign 4

.fn fn_80444418, global
...
/* 80444438 0040D9F8  38 80 00 00 */	li r4, 0x0
/* 8044443C 0040D9FC  38 63 F2 68 */	addi r3, r3, __vt__CWorkSystem@l
/* 80444440 0040DA00  38 A0 FF FF */	li r5, -0x1
/* 80444444 0040DA04  90 7F 00 00 */	stw r3, 0x0(r31)
/* 80444448 0040DA08  38 00 00 02 */	li r0, 0x2
...
/* 8044449C 0040DA5C  38 00 00 00 */	li r0, 0x0
/* 804444A0 0040DA60  90 0D BD 7C */	stw r0, lbl_80667EFC@sda21(r13)
/* 804444A4 0040DA64  38 80 00 00 */	li r4, 0x0
/* 804444A8 0040DA68  4B FF 36 21 */	bl fn_80437AC8
/* 804444AC 0040DA6C  2C 1F 00 00 */	cmpwi r31, 0x0
...
/* 804444C0 0040DA80  BB C1 00 08 */	lmw r30, 0x8(r1)
...
/* 8044454C 0040DB0C  2C 00 00 00 */	cmpwi r0, 0x0
/* 80444550 0040DB10  40 82 00 C4 */	bne .L_80444614
/* 80444554 0040DB14  88 03 01 C8 */	lbz r0, 0x1c8(r3)
/* 80444558 0040DB18  2C 00 00 00 */	cmpwi r0, 0x0
/* 8044455C 0040DB1C  40 82 00 54 */	bne .L_804445B0
/* 80444560 0040DB20  48 0A 9F 19 */	bl fn_804EE478
/* 80444564 0040DB24  2C 03 00 00 */	cmpwi r3, 0x0
/* 80444568 0040DB28  41 82 00 48 */	beq .L_804445B0
/* 8044456C 0040DB2C  38 00 00 01 */	li r0, 0x1
/* 80444570 0040DB30  98 1F 01 C8 */	stb r0, 0x1c8(r31)
/* 80444574 0040DB34  48 00 03 09 */	bl fn_8044487C
/* 80444578 0040DB38  38 60 00 01 */	li r3, 0x1
...
/* 804445A4 0040DB64  4C C6 31 82 */	crclr 4*cr1+eq
...
/* 804445B4 0040DB74  2C 00 00 00 */	cmpwi r0, 0x0
/* 804445B8 0040DB78  40 82 00 5C */	bne .L_80444614
/* 804445BC 0040DB7C  48 0A 9E D1 */	bl fn_804EE48C
/* 804445C0 0040DB80  2C 03 00 00 */	cmpwi r3, 0x0
/* 804445C4 0040DB84  41 82 00 50 */	beq .L_80444614
/* 804445C8 0040DB88  38 00 00 01 */	li r0, 0x1
/* 804445CC 0040DB8C  98 1F 01 C9 */	stb r0, 0x1c9(r31)
/* 804445D0 0040DB90  48 00 02 AD */	bl fn_8044487C
/* 804445D4 0040DB94  38 60 00 01 */	li r3, 0x1
...
/* 80444604 0040DBC4  4C C6 31 82 */	crclr 4*cr1+eq
/* 80444608 0040DBC8  4B F1 08 E9 */	bl OSReport
/* 8044460C 0040DBCC  38 60 00 00 */	li r3, 0x0
...
/* 80444634 0040DBF4  BF C1 00 08 */	stmw r30, 0x8(r1)
/* 80444638 0040DBF8  7C 7E 1B 78 */	mr r30, r3
/* 8044463C 0040DBFC  48 00 9E D9 */	bl fn_8044E514
/* 80444640 0040DC00  2C 03 00 00 */	cmpwi r3, 0x0
/* 80444644 0040DC04  40 82 00 0C */	bne .L_80444650
/* 80444648 0040DC08  38 60 00 00 */	li r3, 0x0
...
/* 8044465C 0040DC1C  4B FF 2F 59 */	bl fn_804375B4
...
/* 8044466C 0040DC2C  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 8044467C 0040DC3C  48 00 02 3D */	bl fn_804448B8
.L_80444680:
/* 80444680 0040DC40  7F C4 F3 78 */	mr r4, r30
/* 80444684 0040DC44  38 A0 00 00 */	li r5, 0x0
/* 80444688 0040DC48  4B FF 45 51 */	bl fn_80438BD8
/* 8044468C 0040DC4C  48 00 02 E5 */	bl fn_80444970
...
/* 804446A0 0040DC60  4B FF 2F 15 */	bl fn_804375B4
...
/* 804446B0 0040DC70  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 804446C0 0040DC80  48 09 46 D1 */	bl fn_804D8D90
.L_804446C4:
/* 804446C4 0040DC84  7F C4 F3 78 */	mr r4, r30
/* 804446C8 0040DC88  38 A0 00 00 */	li r5, 0x0
/* 804446CC 0040DC8C  4B FF 45 0D */	bl fn_80438BD8
...
/* 804446DC 0040DC9C  4B FF 2E D9 */	bl fn_804375B4
...
/* 804446EC 0040DCAC  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 80444704 0040DCC4  38 A0 00 00 */	li r5, 0x0
/* 80444708 0040DCC8  4B FF 44 D1 */	bl fn_80438BD8
/* 8044470C 0040DCCC  7F C3 F3 78 */	mr r3, r30
/* 80444710 0040DCD0  4B FF 61 11 */	bl fn_8043A820
/* 80444714 0040DCD4  7F C3 F3 78 */	mr r3, r30
/* 80444718 0040DCD8  4B FF 51 61 */	bl fn_80439878
/* 8044471C 0040DCDC  7F C3 F3 78 */	mr r3, r30
/* 80444720 0040DCE0  4B FF ED DD */	bl fn_804434FC
/* 80444724 0040DCE4  38 60 00 00 */	li r3, 0x0
/* 80444728 0040DCE8  48 01 0C 59 */	bl fn_80455380
/* 8044472C 0040DCEC  48 05 22 69 */	bl fn_80496994
/* 80444730 0040DCF0  4B FF 75 55 */	bl fn_8043BC84
/* 80444734 0040DCF4  48 00 98 55 */	bl fn_8044DF88
/* 80444738 0040DCF8  38 00 FF FF */	li r0, -0x1
/* 8044473C 0040DCFC  7C 83 00 38 */	and r3, r4, r0
/* 80444740 0040DD00  4B FF 17 65 */	bl fn_80435EA4
/* 80444744 0040DD04  48 07 82 A9 */	bl fn_804BC9EC
/* 80444748 0040DD08  38 80 00 00 */	li r4, 0x0
/* 8044474C 0040DD0C  48 07 82 A9 */	bl fn_804BC9F4
/* 80444750 0040DD10  7F C3 F3 78 */	mr r3, r30
/* 80444754 0040DD14  4B FF 42 A5 */	bl fn_804389F8
.L_80444758:
/* 80444758 0040DD18  BB C1 00 08 */	lmw r30, 0x8(r1)
...
/* 80444780 0040DD40  4B FF 53 55 */	bl fn_80439AD4
...
/* 804447A0 0040DD60  4B FF 3B F9 */	bl fn_80438398
/* 804447A4 0040DD64  4B FF 5A 31 */	bl fn_8043A1D4
/* 804447A8 0040DD68  2C 03 00 00 */	cmpwi r3, 0x0
/* 804447AC 0040DD6C  41 82 00 08 */	beq .L_804447B4
/* 804447B0 0040DD70  48 05 21 E9 */	bl fn_80496998
.L_804447B4:
/* 804447B4 0040DD74  7F E3 FB 78 */	mr r3, r31
/* 804447B8 0040DD78  4B FF 53 1D */	bl fn_80439AD4
/* 804447BC 0040DD7C  2C 03 00 00 */	cmpwi r3, 0x0
/* 804447C0 0040DD80  40 82 00 24 */	bne .L_804447E4
/* 804447C4 0040DD84  4B FF 77 55 */	bl fn_8043BF18
/* 804447C8 0040DD88  48 07 82 25 */	bl fn_804BC9EC
/* 804447CC 0040DD8C  48 07 84 51 */	bl fn_804BCC1C
/* 804447D0 0040DD90  38 00 FF FF */	li r0, -0x1
/* 804447D4 0040DD94  90 1F 01 C4 */	stw r0, 0x1c4(r31)
/* 804447D8 0040DD98  7F E3 FB 78 */	mr r3, r31
/* 804447DC 0040DD9C  4B FF 42 49 */	bl fn_80438A24
/* 804447E0 0040DDA0  48 00 00 08 */	b .L_804447E8
.L_804447E4:
/* 804447E4 0040DDA4  38 60 00 00 */	li r3, 0x0
.L_804447E8:
...
/* 8044480C 0040DDCC  4B FF EF B1 */	bl fn_804437BC
...
/* 80444820 0040DDE0  4B FF 2D 95 */	bl fn_804375B4
...
/* 80444830 0040DDF0  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 80444844 0040DE04  4B FF FB D5 */	bl fn_80444418
/* 80444848 0040DE08  7C 7D 1B 78 */	mr r29, r3
.L_8044484C:
/* 8044484C 0040DE0C  7F A3 EB 78 */	mr r3, r29
/* 80444850 0040DE10  7F C4 F3 78 */	mr r4, r30
/* 80444854 0040DE14  38 A0 00 00 */	li r5, 0x0
/* 80444858 0040DE18  4B FF 43 81 */	bl fn_80438BD8
...
/* 8044488C 0040DE4C  2C 0C 00 00 */	cmpwi r12, 0x0
/* 80444890 0040DE50  41 82 00 18 */	beq .L_804448A8
/* 80444894 0040DE54  7D 89 03 A6 */	mtctr r12
/* 80444898 0040DE58  4E 80 04 21 */	bctrl
/* 8044489C 0040DE5C  48 01 51 E5 */	bl fn_80459A80
/* 804448A0 0040DE60  48 00 B0 C5 */	bl fn_8044F964
/* 804448A4 0040DE64  48 00 21 2D */	bl fn_804469D0
.L_804448A8:
...
# 0x80667EF8 - 0x80667F00
.section .sbss, "wa", @nobits
.balign 8
.sym lbl_80667EF8, global
	.skip 0x4
.sym lbl_80667EFC, global
	.skip 0x4
