.include "macros.inc"
.file "monolithlib/effect/CERandomizer.o"
...
/* 804DB444 004A4A04  B0 03 00 04 */	sth r0, 0x4(r3)
/* 804DB448 004A4A08  38 84 36 50 */	addi r4, r4, __vt__18CERandomizerSimple@l
/* 804DB44C 004A4A0C  90 83 00 00 */	stw r4, 0x0(r3)
/* 804DB450 004A4A10  B0 03 00 06 */	sth r0, 0x6(r3)
/* 804DB454 004A4A14  D0 03 00 08 */	stfs f0, 0x8(r3)
...
/* 804DB45C 004A4A1C  2C 04 00 00 */	cmpwi r4, 0x0
...
/* 804DB46C 004A4A2C  A0 04 00 04 */	lhz r0, 0x4(r4)
/* 804DB470 004A4A30  B0 03 00 04 */	sth r0, 0x4(r3)
/* 804DB474 004A4A34  48 00 00 08 */	b .L_804DB47C
.L_804DB478:
/* 804DB478 004A4A38  B0 83 00 04 */	sth r4, 0x4(r3)
.L_804DB47C:
/* 804DB47C 004A4A3C  A0 03 00 04 */	lhz r0, 0x4(r3)
/* 804DB480 004A4A40  C0 02 D6 58 */	lfs f0, lbl_8066D9D8@sda21(r2)
/* 804DB484 004A4A44  B0 03 00 06 */	sth r0, 0x6(r3)
/* 804DB488 004A4A48  D0 03 00 08 */	stfs f0, 0x8(r3)
...
/* 804DB49C 004A4A5C  C0 43 00 08 */	lfs f2, 0x8(r3)
/* 804DB4A0 004A4A60  EC 02 08 2A */	fadds f0, f2, f1
/* 804DB4A4 004A4A64  FC 20 10 1E */	fctiwz f1, f2
/* 804DB4A8 004A4A68  D0 03 00 08 */	stfs f0, 0x8(r3)
/* 804DB4AC 004A4A6C  FC 00 00 1E */	fctiwz f0, f0
/* 804DB4B0 004A4A70  D8 21 00 08 */	stfd f1, 0x8(r1)
...
/* 804DB4C8 004A4A88  A0 03 00 06 */	lhz r0, 0x6(r3)
/* 804DB4CC 004A4A8C  B0 03 00 04 */	sth r0, 0x4(r3)
/* 804DB4D0 004A4A90  48 00 00 2C */	b .L_804DB4FC
.L_804DB4D4:
/* 804DB4D4 004A4A94  D8 01 00 10 */	stfd f0, 0x10(r1)
/* 804DB4D8 004A4A98  A0 83 00 04 */	lhz r4, 0x4(r3)
/* 804DB4DC 004A4A9C  80 01 00 14 */	lwz r0, 0x14(r1)
/* 804DB4E0 004A4AA0  B0 83 00 06 */	sth r4, 0x6(r3)
/* 804DB4E4 004A4AA4  54 00 06 FF */	clrlwi. r0, r0, 27
/* 804DB4E8 004A4AA8  40 82 00 14 */	bne .L_804DB4FC
/* 804DB4EC 004A4AAC  81 83 00 00 */	lwz r12, 0x0(r3)
/* 804DB4F0 004A4AB0  81 8C 00 08 */	lwz r12, 0x8(r12)
...
/* 804DB50C 004A4ACC  A0 03 00 04 */	lhz r0, 0x4(r3)
/* 804DB510 004A4AD0  3C E0 CC CD */	lis r7, 0xcccd
/* 804DB514 004A4AD4  3C C0 4F 89 */	lis r6, 0x4f89
/* 804DB518 004A4AD8  3C 80 68 C9 */	lis r4, 0x68c9
/* 804DB51C 004A4ADC  1D 00 02 A1 */	mulli r8, r0, 0x2a1
/* 804DB520 004A4AE0  38 E7 CC CD */	addi r7, r7, -0x3333
/* 804DB524 004A4AE4  38 C6 C4 DF */	addi r6, r6, -0x3b21
/* 804DB528 004A4AE8  3C A0 00 02 */	lis r5, 0x2
/* 804DB52C 004A4AEC  39 08 03 B1 */	addi r8, r8, 0x3b1
/* 804DB530 004A4AF0  38 04 C4 AD */	addi r0, r4, -0x3b53
/* 804DB534 004A4AF4  7C E7 40 16 */	mulhwu r7, r7, r8
/* 804DB538 004A4AF8  38 85 86 A3 */	addi r4, r5, -0x795d
...
/* 804DB548 004A4B08  54 00 A3 3E */	srwi r0, r0, 12
...
/* 804DB584 004A4B44  B0 03 00 04 */	sth r0, 0x4(r3)
/* 804DB588 004A4B48  B0 03 00 06 */	sth r0, 0x6(r3)
/* 804DB58C 004A4B4C  D0 03 00 08 */	stfs f0, 0x8(r3)
...
/* 804DB5A8 004A4B68  C0 43 00 08 */	lfs f2, 0x8(r3)
/* 804DB5AC 004A4B6C  EC 02 08 2A */	fadds f0, f2, f1
/* 804DB5B0 004A4B70  FC 20 10 1E */	fctiwz f1, f2
/* 804DB5B4 004A4B74  D0 03 00 08 */	stfs f0, 0x8(r3)
/* 804DB5B8 004A4B78  FC 00 00 1E */	fctiwz f0, f0
/* 804DB5BC 004A4B7C  D8 21 00 08 */	stfd f1, 0x8(r1)
...
/* 804DB5D4 004A4B94  A0 03 00 06 */	lhz r0, 0x6(r3)
/* 804DB5D8 004A4B98  B0 03 00 04 */	sth r0, 0x4(r3)
/* 804DB5DC 004A4B9C  48 00 00 2C */	b .L_804DB608
.L_804DB5E0:
/* 804DB5E0 004A4BA0  D8 01 00 10 */	stfd f0, 0x10(r1)
/* 804DB5E4 004A4BA4  A0 83 00 04 */	lhz r4, 0x4(r3)
/* 804DB5E8 004A4BA8  80 01 00 14 */	lwz r0, 0x14(r1)
/* 804DB5EC 004A4BAC  B0 83 00 06 */	sth r4, 0x6(r3)
/* 804DB5F0 004A4BB0  54 00 06 FF */	clrlwi. r0, r0, 27
/* 804DB5F4 004A4BB4  40 82 00 14 */	bne .L_804DB608
/* 804DB5F8 004A4BB8  81 83 00 00 */	lwz r12, 0x0(r3)
/* 804DB5FC 004A4BBC  81 8C 00 08 */	lwz r12, 0x8(r12)
...
/* 804DB630 004A4BF0  4B F5 A8 A9 */	bl mtRand__2mlFv
...
/* 804DB644 004A4C04  93 E1 00 08 */	stw r31, 0x8(r1)
/* 804DB648 004A4C08  C0 22 D6 5C */	lfs f1, lbl_8066D9DC@sda21(r2)
/* 804DB64C 004A4C0C  C8 41 00 08 */	lfd f2, 0x8(r1)
...
/* 804DB660 004A4C20  D0 1E 00 00 */	stfs f0, 0x0(r30)
...
/* 804DB690 004A4C50  D0 1E 00 04 */	stfs f0, 0x4(r30)
...
/* 804DB6C0 004A4C80  D0 1E 00 08 */	stfs f0, 0x8(r30)
...
/* 804DB704 004A4CC4  C8 41 00 08 */	lfd f2, 0x8(r1)
...
/* 804DB73C 004A4CFC  4B F5 A7 9D */	bl mtRand__2mlFv
/* 804DB740 004A4D00  54 64 0F FE */	srwi r4, r3, 31
/* 804DB744 004A4D04  54 60 07 FE */	clrlwi r0, r3, 31
...
.L_804DB760:
/* 804DB760 004A4D20  C0 1F 00 00 */	lfs f0, 0x0(r31)
/* 804DB764 004A4D24  EC 00 00 72 */	fmuls f0, f0, f1
/* 804DB768 004A4D28  D0 1F 00 00 */	stfs f0, 0x0(r31)
/* 804DB76C 004A4D2C  4B F5 A7 6D */	bl mtRand__2mlFv
/* 804DB770 004A4D30  54 64 0F FE */	srwi r4, r3, 31
/* 804DB774 004A4D34  54 60 07 FE */	clrlwi r0, r3, 31
...
.L_804DB790:
/* 804DB790 004A4D50  C0 1F 00 04 */	lfs f0, 0x4(r31)
/* 804DB794 004A4D54  EC 00 00 72 */	fmuls f0, f0, f1
/* 804DB798 004A4D58  D0 1F 00 04 */	stfs f0, 0x4(r31)
/* 804DB79C 004A4D5C  4B F5 A7 3D */	bl mtRand__2mlFv
/* 804DB7A0 004A4D60  54 64 0F FE */	srwi r4, r3, 31
/* 804DB7A4 004A4D64  54 60 07 FE */	clrlwi r0, r3, 31
...
.L_804DB7C0:
/* 804DB7C0 004A4D80  C0 1F 00 08 */	lfs f0, 0x8(r31)
/* 804DB7C4 004A4D84  EC 00 00 72 */	fmuls f0, f0, f1
/* 804DB7C8 004A4D88  D0 1F 00 08 */	stfs f0, 0x8(r31)
...
/* 804DB7EC 004A4DAC  4B F5 A6 ED */	bl mtRand__2mlFv
/* 804DB7F0 004A4DB0  54 64 0F FE */	srwi r4, r3, 31
/* 804DB7F4 004A4DB4  54 60 07 FE */	clrlwi r0, r3, 31
...
/* 804DB82C 004A4DEC  81 83 00 00 */	lwz r12, 0x0(r3)
/* 804DB830 004A4DF0  81 8C 00 08 */	lwz r12, 0x8(r12)
/* 804DB834 004A4DF4  7D 89 03 A6 */	mtctr r12
/* 804DB838 004A4DF8  4E 80 04 21 */	bctrl
/* 804DB83C 004A4DFC  54 60 07 FF */	clrlwi. r0, r3, 31
...
/* 804DB86C 004A4E2C  81 83 00 00 */	lwz r12, 0x0(r3)
/* 804DB870 004A4E30  81 8C 00 08 */	lwz r12, 0x8(r12)
/* 804DB874 004A4E34  7D 89 03 A6 */	mtctr r12
/* 804DB878 004A4E38  4E 80 04 21 */	bctrl
/* 804DB87C 004A4E3C  3C 00 43 30 */	lis r0, 0x4330
/* 804DB880 004A4E40  90 01 00 08 */	stw r0, 0x8(r1)
...
/* 804DB890 004A4E50  C8 41 00 08 */	lfd f2, 0x8(r1)
...
/* 804DB8C0 004A4E80  81 83 00 00 */	lwz r12, 0x0(r3)
/* 804DB8C4 004A4E84  81 8C 00 08 */	lwz r12, 0x8(r12)
/* 804DB8C8 004A4E88  7D 89 03 A6 */	mtctr r12
/* 804DB8CC 004A4E8C  4E 80 04 21 */	bctrl
/* 804DB8D0 004A4E90  3C 00 43 30 */	lis r0, 0x4330
/* 804DB8D4 004A4E94  90 01 00 08 */	stw r0, 0x8(r1)
...
/* 804DB8E4 004A4EA4  C8 21 00 08 */	lfd f1, 0x8(r1)
...
/* 804DB928 004A4EE8  B0 03 00 04 */	sth r0, 0x4(r3)
/* 804DB92C 004A4EEC  B0 03 00 06 */	sth r0, 0x6(r3)
/* 804DB930 004A4EF0  D0 03 00 08 */	stfs f0, 0x8(r3)
...
/* 804DB960 004A4F20  C8 21 00 08 */	lfd f1, 0x8(r1)
