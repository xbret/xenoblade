.include "macros.inc"
.file "monolithlib/scn/CScnEffectActNw4r.o"

# 0x8001F42C - 0x8001F48C
.section extab, "a"
.balign 4

.obj "@etb_8001F42C", local
.hidden "@etb_8001F42C"
	.4byte 0x08080000
	.4byte 0x00000000
.endobj "@etb_8001F42C"

.obj "@etb_8001F434", local
.hidden "@etb_8001F434"
	.4byte 0x08080000
	.4byte 0x00000000
.endobj "@etb_8001F434"

.obj "@etb_8001F43C", local
.hidden "@etb_8001F43C"
	.4byte 0x38080000
	.4byte 0x00000000
.endobj "@etb_8001F43C"

.obj "@etb_8001F444", local
.hidden "@etb_8001F444"
	.4byte 0x00080000
	.4byte 0x00000000
.endobj "@etb_8001F444"

.obj "@etb_8001F44C", local
.hidden "@etb_8001F44C"
	.4byte 0x00080000
	.4byte 0x00000000
.endobj "@etb_8001F44C"

.obj "@etb_8001F454", local
.hidden "@etb_8001F454"
	.4byte 0x00080000
	.4byte 0x00000000
.endobj "@etb_8001F454"

.obj "@etb_8001F45C", local
.hidden "@etb_8001F45C"
	.4byte 0x00080000
	.4byte 0x00000000
.endobj "@etb_8001F45C"

.obj "@etb_8001F464", local
.hidden "@etb_8001F464"
	.4byte 0x10080000
	.4byte 0x00000000
.endobj "@etb_8001F464"

.obj "@etb_8001F46C", local
.hidden "@etb_8001F46C"
	.4byte 0x180A0000
	.4byte 0x00000000
.endobj "@etb_8001F46C"

.obj "@etb_8001F474", local
.hidden "@etb_8001F474"
	.4byte 0x08080000
	.4byte 0x00000000
.endobj "@etb_8001F474"

.obj "@etb_8001F47C", local
.hidden "@etb_8001F47C"
	.4byte 0x100A0000
	.4byte 0x00000000
.endobj "@etb_8001F47C"

.obj "@etb_8001F484", local
.hidden "@etb_8001F484"
	.4byte 0x08080000
	.4byte 0x00000000
.endobj "@etb_8001F484"

# 0x80036EB4 - 0x80036F44
...
/* 8049B9C8 00464F88  2C 04 00 00 */	cmpwi r4, 0x0
...
/* 8049BA14 00464FD4  38 80 00 00 */	li r4, 0x0
/* 8049BA18 00464FD8  90 01 00 0C */	stw r0, 0xc(r1)
/* 8049BA1C 00464FDC  4B F3 DC 91 */	bl GetResNode__Q34nw4r3g3d6ResMdlCFi
/* 8049BA20 00464FE0  90 61 00 08 */	stw r3, 0x8(r1)
/* 8049BA24 00464FE4  7F E3 FB 78 */	mr r3, r31
/* 8049BA28 00464FE8  38 81 00 08 */	addi r4, r1, 0x8
/* 8049BA2C 00464FEC  48 00 00 2D */	bl fn_8049BA58
...
.fn fn_8049BA44, global
/* 8049BA44 00465004  80 63 00 04 */	lwz r3, 0x4(r3)
/* 8049BA48 00465008  81 83 00 00 */	lwz r12, 0x0(r3)
/* 8049BA4C 0046500C  81 8C 00 18 */	lwz r12, 0x18(r12)
/* 8049BA50 00465010  7D 89 03 A6 */	mtctr r12
/* 8049BA54 00465014  4E 80 04 20 */	bctr
.endfn fn_8049BA44

.fn fn_8049BA58, global
...
/* 8049BA70 00465030  80 04 00 00 */	lwz r0, 0x0(r4)
/* 8049BA74 00465034  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 8049BA9C 0046505C  4C C6 31 82 */	crclr 4*cr1+eq
/* 8049BAA0 00465060  4B F3 BA E5 */	bl Panic__Q24nw4r2dbFPCciPCce
.L_8049BAA4:
/* 8049BAA4 00465064  83 9F 00 00 */	lwz r28, 0x0(r31)
/* 8049BAA8 00465068  80 1C 00 08 */	lwz r0, 0x8(r28)
/* 8049BAAC 0046506C  2C 00 00 00 */	cmpwi r0, 0x0
...
.L_8049BABC:
/* 8049BABC 0046507C  38 60 00 00 */	li r3, 0x0
.L_8049BAC0:
/* 8049BAC0 00465080  4B E1 DA F9 */	bl strlen
/* 8049BAC4 00465084  28 03 00 05 */	cmplwi r3, 0x5
/* 8049BAC8 00465088  41 80 02 C8 */	blt .L_8049BD90
/* 8049BACC 0046508C  2C 1C 00 00 */	cmpwi r28, 0x0
...
/* 8049BAF0 004650B0  4C C6 31 82 */	crclr 4*cr1+eq
/* 8049BAF4 004650B4  4B F3 BA 91 */	bl Panic__Q24nw4r2dbFPCciPCce
.L_8049BAF8:
/* 8049BAF8 004650B8  83 7F 00 00 */	lwz r27, 0x0(r31)
/* 8049BAFC 004650BC  80 1B 00 08 */	lwz r0, 0x8(r27)
/* 8049BB00 004650C0  2C 00 00 00 */	cmpwi r0, 0x0
...
.L_8049BB10:
/* 8049BB10 004650D0  3B 80 00 00 */	li r28, 0x0
.L_8049BB14:
...
/* 8049BB30 004650F0  2C 03 00 00 */	cmpwi r3, 0x0
/* 8049BB34 004650F4  40 82 02 5C */	bne .L_8049BD90
/* 8049BB38 004650F8  3B 40 00 01 */	li r26, 0x1
/* 8049BB3C 004650FC  3B 20 00 02 */	li r25, 0x2
/* 8049BB40 00465100  3F 80 80 57 */	lis r28, lbl_805719DC@ha
/* 8049BB44 00465104  3F A0 80 57 */	lis r29, lbl_805719C0@ha
.L_8049BB48:
/* 8049BB48 00465108  2C 1B 00 00 */	cmpwi r27, 0x0
...
/* 8049BB64 00465124  4C C6 31 82 */	crclr 4*cr1+eq
/* 8049BB68 00465128  4B F3 BA 1D */	bl Panic__Q24nw4r2dbFPCciPCce
.L_8049BB6C:
/* 8049BB6C 0046512C  83 7F 00 00 */	lwz r27, 0x0(r31)
/* 8049BB70 00465130  80 1B 00 08 */	lwz r0, 0x8(r27)
/* 8049BB74 00465134  2C 00 00 00 */	cmpwi r0, 0x0
...
.L_8049BB84:
/* 8049BB84 00465144  38 60 00 00 */	li r3, 0x0
.L_8049BB88:
...
/* 8049BB98 00465158  2C 1B 00 00 */	cmpwi r27, 0x0
...
/* 8049BBB4 00465174  4C C6 31 82 */	crclr 4*cr1+eq
/* 8049BBB8 00465178  4B F3 B9 CD */	bl Panic__Q24nw4r2dbFPCciPCce
.L_8049BBBC:
/* 8049BBBC 0046517C  83 7F 00 00 */	lwz r27, 0x0(r31)
/* 8049BBC0 00465180  80 1B 00 08 */	lwz r0, 0x8(r27)
/* 8049BBC4 00465184  2C 00 00 00 */	cmpwi r0, 0x0
...
.L_8049BBD4:
/* 8049BBD4 00465194  38 60 00 00 */	li r3, 0x0
.L_8049BBD8:
...
.L_8049BBE8:
/* 8049BBE8 004651A8  3B 40 00 00 */	li r26, 0x0
/* 8049BBEC 004651AC  48 00 00 10 */	b .L_8049BBFC
.L_8049BBF0:
/* 8049BBF0 004651B0  3B 39 00 01 */	addi r25, r25, 0x1
/* 8049BBF4 004651B4  28 19 00 05 */	cmplwi r25, 0x5
/* 8049BBF8 004651B8  41 80 FF 50 */	blt .L_8049BB48
.L_8049BBFC:
/* 8049BBFC 004651BC  2C 1A 00 00 */	cmpwi r26, 0x0
/* 8049BC00 004651C0  41 82 01 90 */	beq .L_8049BD90
/* 8049BC04 004651C4  2C 1B 00 00 */	cmpwi r27, 0x0
...
/* 8049BC20 004651E0  4C C6 31 82 */	crclr 4*cr1+eq
/* 8049BC24 004651E4  4B F3 B9 61 */	bl Panic__Q24nw4r2dbFPCciPCce
.L_8049BC28:
/* 8049BC28 004651E8  80 7E 00 04 */	lwz r3, 0x4(r30)
/* 8049BC2C 004651EC  80 9F 00 00 */	lwz r4, 0x0(r31)
/* 8049BC30 004651F0  80 63 14 7C */	lwz r3, 0x147c(r3)
/* 8049BC34 004651F4  2C 04 00 00 */	cmpwi r4, 0x0
...
.L_8049BC48:
/* 8049BC48 00465208  38 60 00 00 */	li r3, 0x0
.L_8049BC4C:
...
/* 8049BC60 00465220  90 03 00 08 */	stw r0, 0x8(r3)
/* 8049BC64 00465224  80 1F 00 00 */	lwz r0, 0x0(r31)
/* 8049BC68 00465228  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 8049BC8C 0046524C  4C C6 31 82 */	crclr 4*cr1+eq
/* 8049BC90 00465250  4B F3 B8 F5 */	bl Panic__Q24nw4r2dbFPCciPCce
.L_8049BC94:
/* 8049BC94 00465254  80 7F 00 00 */	lwz r3, 0x0(r31)
/* 8049BC98 00465258  80 03 00 08 */	lwz r0, 0x8(r3)
/* 8049BC9C 0046525C  2C 00 00 00 */	cmpwi r0, 0x0
...
.L_8049BCAC:
/* 8049BCAC 0046526C  3B 80 00 00 */	li r28, 0x0
.L_8049BCB0:
/* 8049BCB0 00465270  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 8049BCD4 00465294  4C C6 31 82 */	crclr 4*cr1+eq
/* 8049BCD8 00465298  4B F3 B8 AD */	bl Panic__Q24nw4r2dbFPCciPCce
.L_8049BCDC:
/* 8049BCDC 0046529C  80 7F 00 00 */	lwz r3, 0x0(r31)
/* 8049BCE0 004652A0  80 03 00 08 */	lwz r0, 0x8(r3)
/* 8049BCE4 004652A4  2C 00 00 00 */	cmpwi r0, 0x0
...
.L_8049BCF4:
/* 8049BCF4 004652B4  3B A0 00 00 */	li r29, 0x0
.L_8049BCF8:
/* 8049BCF8 004652B8  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 8049BD1C 004652DC  4C C6 31 82 */	crclr 4*cr1+eq
/* 8049BD20 004652E0  4B F3 B8 65 */	bl Panic__Q24nw4r2dbFPCciPCce
.L_8049BD24:
/* 8049BD24 004652E4  81 1F 00 00 */	lwz r8, 0x0(r31)
/* 8049BD28 004652E8  88 1D 00 02 */	lbz r0, 0x2(r29)
/* 8049BD2C 004652EC  80 E8 00 08 */	lwz r7, 0x8(r8)
/* 8049BD30 004652F0  7C 03 07 74 */	extsb r3, r0
/* 8049BD34 004652F4  88 9C 00 04 */	lbz r4, 0x4(r28)
/* 8049BD38 004652F8  38 03 FF D0 */	addi r0, r3, -0x30
/* 8049BD3C 004652FC  2C 07 00 00 */	cmpwi r7, 0x0
...
.L_8049BD54:
/* 8049BD54 00465314  38 60 00 00 */	li r3, 0x0
.L_8049BD58:
/* 8049BD58 00465318  88 63 00 03 */	lbz r3, 0x3(r3)
/* 8049BD5C 0046531C  80 1E 01 88 */	lwz r0, 0x188(r30)
/* 8049BD60 00465320  7C 63 07 74 */	extsb r3, r3
/* 8049BD64 00465324  38 63 FF D0 */	addi r3, r3, -0x30
...
/* 8049BD7C 0046533C  38 04 FF D0 */	addi r0, r4, -0x30
/* 8049BD80 00465340  B0 03 01 08 */	sth r0, 0x108(r3)
/* 8049BD84 00465344  80 7E 01 88 */	lwz r3, 0x188(r30)
/* 8049BD88 00465348  38 03 00 01 */	addi r0, r3, 0x1
/* 8049BD8C 0046534C  90 1E 01 88 */	stw r0, 0x188(r30)
.L_8049BD90:
/* 8049BD90 00465350  80 1F 00 00 */	lwz r0, 0x0(r31)
/* 8049BD94 00465354  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 8049BE0C 004653CC  4B FF FC 4D */	bl fn_8049BA58
/* 8049BE10 004653D0  80 1F 00 00 */	lwz r0, 0x0(r31)
/* 8049BE14 004653D4  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 8049BE70 00465430  4C C6 31 82 */	crclr 4*cr1+eq
/* 8049BE74 00465434  4B F3 B7 11 */	bl Panic__Q24nw4r2dbFPCciPCce
/* 8049BE78 00465438  48 00 00 08 */	b .L_8049BE80
.L_8049BE7C:
/* 8049BE7C 0046543C  3B 60 00 00 */	li r27, 0x0
.L_8049BE80:
/* 8049BE80 00465440  93 61 00 08 */	stw r27, 0x8(r1)
/* 8049BE84 00465444  7F C3 F3 78 */	mr r3, r30
/* 8049BE88 00465448  38 81 00 08 */	addi r4, r1, 0x8
/* 8049BE8C 0046544C  4B FF FB CD */	bl fn_8049BA58
.L_8049BE90:
...
.fn fn_8049BEA4, global
/* 8049BEA4 00465464  80 63 00 04 */	lwz r3, 0x4(r3)
/* 8049BEA8 00465468  4B FF 9F B8 */	b fn_80495E60
.endfn fn_8049BEA4

.fn fn_8049BEAC, global
/* 8049BEAC 0046546C  80 63 00 04 */	lwz r3, 0x4(r3)
/* 8049BEB0 00465470  4B FE 8F AC */	b fn_80484E5C
.endfn fn_8049BEAC

.fn fn_8049BEB4, global
/* 8049BEB4 00465474  80 63 00 04 */	lwz r3, 0x4(r3)
/* 8049BEB8 00465478  4B FE 7A 24 */	b fn_804838DC
.endfn fn_8049BEB4

.fn fn_8049BEBC, global
/* 8049BEBC 0046547C  80 63 00 04 */	lwz r3, 0x4(r3)
/* 8049BEC0 00465480  81 83 00 00 */	lwz r12, 0x0(r3)
/* 8049BEC4 00465484  81 8C 00 B4 */	lwz r12, 0xb4(r12)
/* 8049BEC8 00465488  7D 89 03 A6 */	mtctr r12
/* 8049BECC 0046548C  4E 80 04 20 */	bctr
.endfn fn_8049BEBC

.fn fn_8049BED0, global
/* 8049BED0 00465490  80 63 00 04 */	lwz r3, 0x4(r3)
/* 8049BED4 00465494  81 83 00 00 */	lwz r12, 0x0(r3)
/* 8049BED8 00465498  81 8C 00 48 */	lwz r12, 0x48(r12)
/* 8049BEDC 0046549C  7D 89 03 A6 */	mtctr r12
/* 8049BEE0 004654A0  4E 80 04 20 */	bctr
.endfn fn_8049BED0

.fn fn_8049BEE4, global
/* 8049BEE4 004654A4  80 63 00 04 */	lwz r3, 0x4(r3)
/* 8049BEE8 004654A8  4B FE 72 74 */	b fn_8048315C
.endfn fn_8049BEE4

.fn fn_8049BEEC, global
/* 8049BEEC 004654AC  80 63 00 04 */	lwz r3, 0x4(r3)
/* 8049BEF0 004654B0  80 04 00 00 */	lwz r0, 0x0(r4)
/* 8049BEF4 004654B4  90 03 03 04 */	stw r0, 0x304(r3)
/* 8049BEF8 004654B8  80 04 00 04 */	lwz r0, 0x4(r4)
/* 8049BEFC 004654BC  90 03 03 08 */	stw r0, 0x308(r3)
/* 8049BF00 004654C0  80 04 00 08 */	lwz r0, 0x8(r4)
/* 8049BF04 004654C4  90 03 03 0C */	stw r0, 0x30c(r3)
/* 8049BF08 004654C8  4E 80 00 20 */	blr
.endfn fn_8049BEEC

.fn fn_8049BF0C, global
/* 8049BF0C 004654CC  94 21 FF F0 */	stwu r1, -0x10(r1)
/* 8049BF10 004654D0  7C 08 02 A6 */	mflr r0
/* 8049BF14 004654D4  80 63 00 04 */	lwz r3, 0x4(r3)
/* 8049BF18 004654D8  90 01 00 14 */	stw r0, 0x14(r1)
/* 8049BF1C 004654DC  4B FE 72 41 */	bl fn_8048315C
...
/* 8049BFC4 00465584  93 C1 00 08 */	stw r30, 0x8(r1)
...
/* 8049BFD8 00465598  38 60 00 00 */	li r3, 0x0
/* 8049BFDC 0046559C  48 00 00 6C */	b .L_8049C048
.L_8049BFE0:
/* 8049BFE0 004655A0  7C A3 2B 78 */	mr r3, r5
/* 8049BFE4 004655A4  4B FF 4B 11 */	bl fn_80490AF4
/* 8049BFE8 004655A8  2C 03 00 00 */	cmpwi r3, 0x0
/* 8049BFEC 004655AC  41 82 00 20 */	beq .L_8049C00C
/* 8049BFF0 004655B0  80 7E 00 04 */	lwz r3, 0x4(r30)
/* 8049BFF4 004655B4  7F E4 FB 78 */	mr r4, r31
/* 8049BFF8 004655B8  81 83 00 00 */	lwz r12, 0x0(r3)
...
/* 8049C0A0 00465660  D0 03 00 00 */	stfs f0, 0x0(r3)
/* 8049C0A4 00465664  C0 04 00 04 */	lfs f0, 0x4(r4)
/* 8049C0A8 00465668  D0 03 00 04 */	stfs f0, 0x4(r3)
/* 8049C0AC 0046566C  C0 04 00 08 */	lfs f0, 0x8(r4)
/* 8049C0B0 00465670  D0 03 00 08 */	stfs f0, 0x8(r3)
/* 8049C0B4 00465674  48 00 00 BC */	b .L_8049C170
.L_8049C0B8:
/* 8049C0B8 00465678  7C C3 33 78 */	mr r3, r6
/* 8049C0BC 0046567C  7F E4 FB 78 */	mr r4, r31
/* 8049C0C0 00465680  4B FF 4A 35 */	bl fn_80490AF4
/* 8049C0C4 00465684  2C 03 00 00 */	cmpwi r3, 0x0
/* 8049C0C8 00465688  41 82 00 38 */	beq .L_8049C100
/* 8049C0CC 0046568C  80 7E 00 04 */	lwz r3, 0x4(r30)
/* 8049C0D0 00465690  7F E4 FB 78 */	mr r4, r31
/* 8049C0D4 00465694  81 83 00 00 */	lwz r12, 0x0(r3)
...
/* 8049C0F0 004656B0  D0 5D 00 00 */	stfs f2, 0x0(r29)
/* 8049C0F4 004656B4  D0 3D 00 04 */	stfs f1, 0x4(r29)
/* 8049C0F8 004656B8  D0 1D 00 08 */	stfs f0, 0x8(r29)
/* 8049C0FC 004656BC  48 00 00 74 */	b .L_8049C170
.L_8049C100:
/* 8049C100 004656C0  80 7E 00 04 */	lwz r3, 0x4(r30)
/* 8049C104 004656C4  80 63 07 C4 */	lwz r3, 0x7c4(r3)
/* 8049C108 004656C8  2C 03 00 00 */	cmpwi r3, 0x0
/* 8049C10C 004656CC  41 82 00 44 */	beq .L_8049C150
/* 8049C110 004656D0  81 83 00 00 */	lwz r12, 0x0(r3)
/* 8049C114 004656D4  81 8C 00 A8 */	lwz r12, 0xa8(r12)
/* 8049C118 004656D8  7D 89 03 A6 */	mtctr r12
/* 8049C11C 004656DC  4E 80 04 21 */	bctrl
/* 8049C120 004656E0  81 83 00 00 */	lwz r12, 0x0(r3)
...
/* 8049C140 00465700  D0 5D 00 00 */	stfs f2, 0x0(r29)
/* 8049C144 00465704  D0 3D 00 04 */	stfs f1, 0x4(r29)
/* 8049C148 00465708  D0 1D 00 08 */	stfs f0, 0x8(r29)
...
/* 8049C15C 0046571C  D0 1D 00 00 */	stfs f0, 0x0(r29)
/* 8049C160 00465720  C0 03 00 04 */	lfs f0, 0x4(r3)
/* 8049C164 00465724  D0 1D 00 04 */	stfs f0, 0x4(r29)
/* 8049C168 00465728  C0 03 00 08 */	lfs f0, 0x8(r3)
/* 8049C16C 0046572C  D0 1D 00 08 */	stfs f0, 0x8(r29)
.L_8049C170:
...
/* 8049C1B0 00465770  38 60 00 00 */	li r3, 0x0
...
/* 8049C1C0 00465780  38 E0 00 00 */	li r7, 0x0
/* 8049C1C4 00465784  7C 09 03 A6 */	mtctr r0
/* 8049C1C8 00465788  28 00 00 00 */	cmplwi r0, 0x0
...
.L_8049C22C:
/* 8049C22C 004657EC  38 60 00 00 */	li r3, 0x0
.L_8049C230:
...
/* 8049C264 00465824  93 C1 00 08 */	stw r30, 0x8(r1)
/* 8049C268 00465828  7C 9E 23 78 */	mr r30, r4
/* 8049C26C 0046582C  7C 09 03 A6 */	mtctr r0
/* 8049C270 00465830  28 00 00 00 */	cmplwi r0, 0x0
...
/* 8049C28C 0046584C  38 60 00 01 */	li r3, 0x1
/* 8049C290 00465850  80 84 00 08 */	lwz r4, 0x8(r4)
...
/* 8049C2A0 00465860  D0 45 00 00 */	stfs f2, 0x0(r5)
/* 8049C2A4 00465864  D0 25 00 04 */	stfs f1, 0x4(r5)
/* 8049C2A8 00465868  D0 05 00 08 */	stfs f0, 0x8(r5)
/* 8049C2AC 0046586C  48 00 00 50 */	b .L_8049C2FC
.L_8049C2B0:
/* 8049C2B0 00465870  38 C6 00 02 */	addi r6, r6, 0x2
/* 8049C2B4 00465874  38 E7 00 01 */	addi r7, r7, 0x1
/* 8049C2B8 00465878  42 00 FF C0 */	bdnz .L_8049C278
.L_8049C2BC:
/* 8049C2BC 0046587C  80 63 00 04 */	lwz r3, 0x4(r3)
/* 8049C2C0 00465880  80 63 07 C4 */	lwz r3, 0x7c4(r3)
/* 8049C2C4 00465884  2C 03 00 00 */	cmpwi r3, 0x0
/* 8049C2C8 00465888  41 82 00 30 */	beq .L_8049C2F8
/* 8049C2CC 0046588C  81 83 00 00 */	lwz r12, 0x0(r3)
/* 8049C2D0 00465890  81 8C 00 A8 */	lwz r12, 0xa8(r12)
/* 8049C2D4 00465894  7D 89 03 A6 */	mtctr r12
/* 8049C2D8 00465898  4E 80 04 21 */	bctrl
/* 8049C2DC 0046589C  81 83 00 00 */	lwz r12, 0x0(r3)
...
.L_8049C37C:
/* 8049C37C 0046593C  38 60 00 00 */	li r3, 0x0
.L_8049C380:
...
.fn fn_8049C394, global
/* 8049C394 00465954  80 63 00 04 */	lwz r3, 0x4(r3)
/* 8049C398 00465958  4B FE 67 20 */	b fn_80482AB8
.endfn fn_8049C394

.fn fn_8049C39C, global
/* 8049C39C 0046595C  80 63 00 04 */	lwz r3, 0x4(r3)
/* 8049C3A0 00465960  4B FE 67 34 */	b fn_80482AD4
.endfn fn_8049C39C

.fn fn_8049C3A4, global
/* 8049C3A4 00465964  80 63 00 04 */	lwz r3, 0x4(r3)
/* 8049C3A8 00465968  4B FE C1 C4 */	b fn_8048856C
.endfn fn_8049C3A4

.fn fn_8049C3AC, global
/* 8049C3AC 0046596C  80 A3 00 04 */	lwz r5, 0x4(r3)
/* 8049C3B0 00465970  38 60 00 01 */	li r3, 0x1
/* 8049C3B4 00465974  38 80 00 01 */	li r4, 0x1
...
/* 8049C3D8 00465998  4C 41 13 82 */	cror eq, gt, eq
/* 8049C3DC 0046599C  7C 00 00 26 */	mfcr r0
/* 8049C3E0 004659A0  54 00 1F FF */	extrwi. r0, r0, 1, 2
/* 8049C3E4 004659A4  40 82 00 08 */	bne .L_8049C3EC
/* 8049C3E8 004659A8  38 80 00 00 */	li r4, 0x0
.L_8049C3EC:
/* 8049C3EC 004659AC  2C 04 00 00 */	cmpwi r4, 0x0
...
/* 8049C408 004659C8  4C 40 13 82 */	cror eq, lt, eq
/* 8049C40C 004659CC  7C 00 00 26 */	mfcr r0
/* 8049C410 004659D0  54 00 1F FF */	extrwi. r0, r0, 1, 2
/* 8049C414 004659D4  4C 82 00 20 */	bnelr
/* 8049C418 004659D8  38 60 00 00 */	li r3, 0x0
/* 8049C41C 004659DC  4E 80 00 20 */	blr
.endfn fn_8049C3AC

.fn fn_8049C420, global
/* 8049C420 004659E0  80 63 00 04 */	lwz r3, 0x4(r3)
/* 8049C424 004659E4  80 03 07 A4 */	lwz r0, 0x7a4(r3)
/* 8049C428 004659E8  54 03 17 FE */	extrwi r3, r0, 1, 1
/* 8049C42C 004659EC  4E 80 00 20 */	blr
.endfn fn_8049C420

.fn fn_8049C430, global
/* 8049C430 004659F0  80 63 01 88 */	lwz r3, 0x188(r3)
/* 8049C434 004659F4  4E 80 00 20 */	blr
.endfn fn_8049C430

# 0x80527A30 - 0x80527A50
.rodata
.balign 8
...
# 0x80666338 - 0x80666358
.section .sdata, "wa"
.balign 8
.sym lbl_80666338, global
	.4byte lbl_8066D330
	.4byte 0x00000000
...
.obj __RTTI__IEffectAct, global
	...
	.4byte 0x00000000
.sym lbl_80666350, global
	.4byte 0x72656600
.sym lbl_80666354, global
	.4byte 0x72656600

# 0x8066D330 - 0x8066D338
.section .sdata2, "a"
.balign 8
.sym lbl_8066D330, global
	.4byte 0x65700000
.sym lbl_8066D334, global
	.4byte 0x3F800000
