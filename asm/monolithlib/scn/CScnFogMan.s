.include "macros.inc"
.file "monolithlib/scn/CScnFogMan.o"

# 0x8001F698 - 0x8001F6A8
.section extab, "a"
.balign 4
...
# 0x8049DD8C - 0x8049E380
.text
.balign 4

.fn fn_8049DD8C, global
...
/* 8049DD98 00467358  38 A0 00 00 */	li r5, 0x0
/* 8049DD9C 0046735C  C0 82 CF E0 */	lfs f4, lbl_8066D360@sda21(r2)
/* 8049DDA0 00467360  38 00 00 02 */	li r0, 0x2
...
/* 8049DDB0 00467370  90 C3 00 00 */	stw r6, 0x0(r3)
/* 8049DDB4 00467374  90 83 00 04 */	stw r4, 0x4(r3)
/* 8049DDB8 00467378  90 A3 00 08 */	stw r5, 0x8(r3)
...
/* 8049DE44 00467404  2C 04 00 00 */	cmpwi r4, 0x0
...
.fn fn_8049DE68, global
/* 8049DE68 00467428  90 83 00 08 */	stw r4, 0x8(r3)
/* 8049DE6C 0046742C  4E 80 00 20 */	blr
.endfn fn_8049DE68

.fn fn_8049DE70, global
/* 8049DE70 00467430  48 00 00 54 */	b fn_8049DEC4
.endfn fn_8049DE70

.fn fn_8049DE74, global
/* 8049DE74 00467434  81 05 00 00 */	lwz r8, 0x0(r5)
/* 8049DE78 00467438  80 E5 00 04 */	lwz r7, 0x4(r5)
/* 8049DE7C 0046743C  80 C5 00 08 */	lwz r6, 0x8(r5)
...
/* 8049DED8 00467498  F3 E1 00 98 */	psq_st f31, 0x98(r1), 0, qr0
/* 8049DEDC 0046749C  DB C1 00 80 */	stfd f30, 0x80(r1)
/* 8049DEE0 004674A0  F3 C1 00 88 */	psq_st f30, 0x88(r1), 0, qr0
/* 8049DEE4 004674A4  DB A1 00 70 */	stfd f29, 0x70(r1)
/* 8049DEE8 004674A8  F3 A1 00 78 */	psq_st f29, 0x78(r1), 0, qr0
/* 8049DEEC 004674AC  DB 81 00 60 */	stfd f28, 0x60(r1)
/* 8049DEF0 004674B0  F3 81 00 68 */	psq_st f28, 0x68(r1), 0, qr0
/* 8049DEF4 004674B4  4B E1 C2 61 */	bl _savegpr_27
/* 8049DEF8 004674B8  80 03 00 08 */	lwz r0, 0x8(r3)
/* 8049DEFC 004674BC  7C 7D 1B 78 */	mr r29, r3
/* 8049DF00 004674C0  2C 00 00 04 */	cmpwi r0, 0x4
/* 8049DF04 004674C4  40 82 00 0C */	bne .L_8049DF10
/* 8049DF08 004674C8  38 60 00 00 */	li r3, 0x0
/* 8049DF0C 004674CC  48 00 04 0C */	b .L_8049E318
.L_8049DF10:
/* 8049DF10 004674D0  80 63 00 04 */	lwz r3, 0x4(r3)
/* 8049DF14 004674D4  4B FF 0D C5 */	bl fn_8048ECD8
/* 8049DF18 004674D8  7C 7E 1B 78 */	mr r30, r3
/* 8049DF1C 004674DC  38 80 00 00 */	li r4, 0x0
/* 8049DF20 004674E0  4B F5 7F A5 */	bl GetFog__Q34nw4r3g3d7ScnRootFi
/* 8049DF24 004674E4  80 1D 00 08 */	lwz r0, 0x8(r29)
/* 8049DF28 004674E8  7C 7F 1B 78 */	mr r31, r3
/* 8049DF2C 004674EC  2C 00 00 01 */	cmpwi r0, 0x1
/* 8049DF30 004674F0  40 82 01 34 */	bne .L_8049E064
/* 8049DF34 004674F4  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 8049DF54 00467514  4C C6 31 82 */	crclr 4*cr1+eq
/* 8049DF58 00467518  4B F3 96 2D */	bl Panic__Q24nw4r2dbFPCciPCce
.L_8049DF5C:
/* 8049DF5C 0046751C  2C 1F 00 00 */	cmpwi r31, 0x0
/* 8049DF60 00467520  41 82 00 08 */	beq .L_8049DF68
/* 8049DF64 00467524  93 9F 00 00 */	stw r28, 0x0(r31)
.L_8049DF68:
/* 8049DF68 00467528  2C 1F 00 00 */	cmpwi r31, 0x0
...
/* 8049DF8C 0046754C  4C C6 31 82 */	crclr 4*cr1+eq
/* 8049DF90 00467550  4B F3 95 F5 */	bl Panic__Q24nw4r2dbFPCciPCce
.L_8049DF94:
/* 8049DF94 00467554  2C 1F 00 00 */	cmpwi r31, 0x0
/* 8049DF98 00467558  41 82 00 0C */	beq .L_8049DFA4
/* 8049DF9C 0046755C  D3 9F 00 04 */	stfs f28, 0x4(r31)
/* 8049DFA0 00467560  D3 BF 00 08 */	stfs f29, 0x8(r31)
.L_8049DFA4:
/* 8049DFA4 00467564  C0 82 CF F4 */	lfs f4, lbl_8066D374@sda21(r2)
/* 8049DFA8 00467568  2C 1F 00 00 */	cmpwi r31, 0x0
...
/* 8049E02C 004675EC  4C C6 31 82 */	crclr 4*cr1+eq
/* 8049E030 004675F0  4B F3 95 55 */	bl Panic__Q24nw4r2dbFPCciPCce
.L_8049E034:
/* 8049E034 004675F4  2C 1F 00 00 */	cmpwi r31, 0x0
...
.L_8049E05C:
/* 8049E05C 0046761C  38 60 00 01 */	li r3, 0x1
/* 8049E060 00467620  48 00 02 B8 */	b .L_8049E318
.L_8049E064:
/* 8049E064 00467624  2C 00 00 02 */	cmpwi r0, 0x2
/* 8049E068 00467628  40 82 00 14 */	bne .L_8049E07C
/* 8049E06C 0046762C  80 7D 00 04 */	lwz r3, 0x4(r29)
/* 8049E070 00467630  80 63 00 7C */	lwz r3, 0x7c(r3)
/* 8049E074 00467634  48 02 36 01 */	bl fn_804C1674
/* 8049E078 00467638  48 00 01 74 */	b .L_8049E1EC
.L_8049E07C:
/* 8049E07C 0046763C  2C 00 00 00 */	cmpwi r0, 0x0
/* 8049E080 00467640  40 82 01 30 */	bne .L_8049E1B0
/* 8049E084 00467644  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 8049E0A4 00467664  4C C6 31 82 */	crclr 4*cr1+eq
/* 8049E0A8 00467668  4B F3 94 DD */	bl Panic__Q24nw4r2dbFPCciPCce
.L_8049E0AC:
/* 8049E0AC 0046766C  2C 1F 00 00 */	cmpwi r31, 0x0
/* 8049E0B0 00467670  41 82 00 08 */	beq .L_8049E0B8
/* 8049E0B4 00467674  93 9F 00 00 */	stw r28, 0x0(r31)
.L_8049E0B8:
/* 8049E0B8 00467678  C0 82 CF F4 */	lfs f4, lbl_8066D374@sda21(r2)
/* 8049E0BC 0046767C  2C 1F 00 00 */	cmpwi r31, 0x0
...
/* 8049E110 004676D0  98 A1 00 08 */	stb r5, 0x8(r1)
/* 8049E114 004676D4  98 81 00 09 */	stb r4, 0x9(r1)
/* 8049E118 004676D8  98 61 00 0A */	stb r3, 0xa(r1)
/* 8049E11C 004676DC  98 01 00 0B */	stb r0, 0xb(r1)
/* 8049E120 004676E0  80 01 00 08 */	lwz r0, 0x8(r1)
...
/* 8049E140 00467700  4C C6 31 82 */	crclr 4*cr1+eq
/* 8049E144 00467704  4B F3 94 41 */	bl Panic__Q24nw4r2dbFPCciPCce
.L_8049E148:
/* 8049E148 00467708  2C 1F 00 00 */	cmpwi r31, 0x0
...
.L_8049E170:
/* 8049E170 00467730  2C 1F 00 00 */	cmpwi r31, 0x0
...
/* 8049E194 00467754  4C C6 31 82 */	crclr 4*cr1+eq
/* 8049E198 00467758  4B F3 93 ED */	bl Panic__Q24nw4r2dbFPCciPCce
.L_8049E19C:
/* 8049E19C 0046775C  2C 1F 00 00 */	cmpwi r31, 0x0
/* 8049E1A0 00467760  41 82 00 4C */	beq .L_8049E1EC
/* 8049E1A4 00467764  D3 9F 00 04 */	stfs f28, 0x4(r31)
/* 8049E1A8 00467768  D3 BF 00 08 */	stfs f29, 0x8(r31)
/* 8049E1AC 0046776C  48 00 00 40 */	b .L_8049E1EC
.L_8049E1B0:
/* 8049E1B0 00467770  2C 00 00 03 */	cmpwi r0, 0x3
/* 8049E1B4 00467774  40 82 00 38 */	bne .L_8049E1EC
/* 8049E1B8 00467778  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 8049E1D4 00467794  4C C6 31 82 */	crclr 4*cr1+eq
/* 8049E1D8 00467798  4B F3 93 AD */	bl Panic__Q24nw4r2dbFPCciPCce
.L_8049E1DC:
/* 8049E1DC 0046779C  2C 1F 00 00 */	cmpwi r31, 0x0
/* 8049E1E0 004677A0  41 82 00 0C */	beq .L_8049E1EC
/* 8049E1E4 004677A4  38 00 00 00 */	li r0, 0x0
/* 8049E1E8 004677A8  90 1F 00 00 */	stw r0, 0x0(r31)
.L_8049E1EC:
/* 8049E1EC 004677AC  88 1D 00 28 */	lbz r0, 0x28(r29)
/* 8049E1F0 004677B0  2C 00 00 00 */	cmpwi r0, 0x0
/* 8049E1F4 004677B4  41 82 01 20 */	beq .L_8049E314
/* 8049E1F8 004677B8  CB 82 D0 08 */	lfd f28, lbl_8066D388@sda21(r2)
/* 8049E1FC 004677BC  3B 60 00 00 */	li r27, 0x0
...
/* 8049E230 004677F0  38 80 00 00 */	li r4, 0x0
/* 8049E234 004677F4  38 A0 00 00 */	li r5, 0x0
/* 8049E238 004677F8  38 C0 00 00 */	li r6, 0x0
/* 8049E23C 004677FC  38 E0 00 00 */	li r7, 0x0
/* 8049E240 00467800  39 00 00 00 */	li r8, 0x0
...
/* 8049E2B0 00467870  2C 00 00 00 */	cmpwi r0, 0x0
...
.L_8049E308:
/* 8049E308 004678C8  3B 7B 00 01 */	addi r27, r27, 0x1
/* 8049E30C 004678CC  2C 1B 00 20 */	cmpwi r27, 0x20
/* 8049E310 004678D0  41 80 FF 08 */	blt .L_8049E218
.L_8049E314:
/* 8049E314 004678D4  38 60 00 01 */	li r3, 0x1
.L_8049E318:
/* 8049E318 004678D8  39 61 00 60 */	addi r11, r1, 0x60
/* 8049E31C 004678DC  E3 E1 00 98 */	psq_l f31, 0x98(r1), 0, qr0
/* 8049E320 004678E0  CB E1 00 90 */	lfd f31, 0x90(r1)
/* 8049E324 004678E4  E3 C1 00 88 */	psq_l f30, 0x88(r1), 0, qr0
/* 8049E328 004678E8  CB C1 00 80 */	lfd f30, 0x80(r1)
/* 8049E32C 004678EC  E3 A1 00 78 */	psq_l f29, 0x78(r1), 0, qr0
/* 8049E330 004678F0  CB A1 00 70 */	lfd f29, 0x70(r1)
/* 8049E334 004678F4  E3 81 00 68 */	psq_l f28, 0x68(r1), 0, qr0
...
.fn fn_8049E350, global
/* 8049E350 00467910  80 E4 00 00 */	lwz r7, 0x0(r4)
/* 8049E354 00467914  80 C4 00 04 */	lwz r6, 0x4(r4)
/* 8049E358 00467918  80 A4 00 08 */	lwz r5, 0x8(r4)
...
.sym lbl_80572428, global
	...
	.4byte 0x56616C69
	.4byte 0x64282900
.sym lbl_80572448, global
	.4byte 0x6733645F
	.4byte 0x666F672E
	.4byte 0x68000000
	.4byte 0x00000000
.sym lbl_80572458, global
	.4byte 0x4E573452
	.4byte 0x3A466169
	.4byte 0x6C656420
	.4byte 0x61737365
	...
	.4byte 0x56616C69
	.4byte 0x64282900
.sym lbl_80572478, global
	.4byte 0x6733645F
	.4byte 0x666F672E
	.4byte 0x68000000
	.4byte 0x00000000
.sym lbl_80572488, global
	.4byte 0x4E573452
	.4byte 0x3A466169
	.4byte 0x6C656420
	.4byte 0x61737365
	...
	.4byte 0x56616C69
	.4byte 0x64282900
.sym lbl_805724A8, global
	.4byte 0x6733645F
	.4byte 0x666F672E
	.4byte 0x68000000
	.4byte 0x00000000

# 0x80666388 - 0x80666390
.section .sdata, "wa"
.balign 8
...
# 0x8066D360 - 0x8066D390
.section .sdata2, "a"
.balign 8
.sym lbl_8066D360, global
	.4byte 0x00000000
.sym lbl_8066D364, global
	.4byte 0x3F800000
.sym lbl_8066D368, global
	.4byte 0x447A0000
.sym lbl_8066D36C, global
	.4byte 0x3DCCCCCD
.sym lbl_8066D370, global
	.4byte 0x42C80000
.sym lbl_8066D374, global
	.4byte 0x437F0000
.sym lbl_8066D378, global
	.4byte 0x3DEA72EB
.sym lbl_8066D37C, global
	.4byte 0x3E990AFE
.sym lbl_8066D380, global
	.4byte 0x3F162C23
	.4byte 0x00000000
.sym lbl_8066D388, global
	.4byte 0x43300000
	.4byte 0x00000000
