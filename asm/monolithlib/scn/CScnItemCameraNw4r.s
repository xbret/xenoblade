...
/* 80481E80 0044B440  48 01 CA 45 */	bl func_8049E8C4
...
/* 80481EC0 0044B480  93 C1 00 08 */	stw r30, 8(r1)
/* 80481EC4 0044B484  7C 7E 1B 78 */	mr r30, r3
/* 80481EC8 0044B488  41 82 00 1C */	beq lbl_80481EE4
/* 80481ECC 0044B48C  38 80 00 00 */	li r4, 0
/* 80481ED0 0044B490  48 01 CC 0D */	bl func_8049EADC
/* 80481ED4 0044B494  2C 1F 00 00 */	cmpwi r31, 0
/* 80481ED8 0044B498  40 81 00 0C */	ble lbl_80481EE4
...
/* 80481EEC 0044B4AC  83 C1 00 08 */	lwz r30, 8(r1)
...
/* 80481F10 0044B4D0  F3 E1 00 48 */	psq_st f31, 72(r1), 0, qr0
/* 80481F14 0044B4D4  DB C1 00 30 */	stfd f30, 0x30(r1)
/* 80481F18 0044B4D8  F3 C1 00 38 */	psq_st f30, 56(r1), 0, qr0
/* 80481F1C 0044B4DC  DB A1 00 20 */	stfd f29, 0x20(r1)
/* 80481F20 0044B4E0  F3 A1 00 28 */	psq_st f29, 40(r1), 0, qr0
/* 80481F24 0044B4E4  DB 81 00 10 */	stfd f28, 0x10(r1)
/* 80481F28 0044B4E8  F3 81 00 18 */	psq_st f28, 24(r1), 0, qr0
/* 80481F2C 0044B4EC  93 E1 00 0C */	stw r31, 0xc(r1)
/* 80481F30 0044B4F0  7C 7F 1B 78 */	mr r31, r3
/* 80481F34 0044B4F4  48 01 CC BD */	bl func_8049EBF0
...
/* 80481F48 0044B508  4B FC 66 01 */	bl func_80448548
...
/* 80481F6C 0044B52C  E3 E1 00 48 */	psq_l f31, 72(r1), 0, qr0
/* 80481F70 0044B530  CB E1 00 40 */	lfd f31, 0x40(r1)
/* 80481F74 0044B534  E3 C1 00 38 */	psq_l f30, 56(r1), 0, qr0
/* 80481F78 0044B538  CB C1 00 30 */	lfd f30, 0x30(r1)
/* 80481F7C 0044B53C  E3 A1 00 28 */	psq_l f29, 40(r1), 0, qr0
/* 80481F80 0044B540  CB A1 00 20 */	lfd f29, 0x20(r1)
/* 80481F84 0044B544  E3 81 00 18 */	psq_l f28, 24(r1), 0, qr0
...
/* 80481FAC 0044B56C  F3 E1 00 48 */	psq_st f31, 72(r1), 0, qr0
/* 80481FB0 0044B570  DB C1 00 30 */	stfd f30, 0x30(r1)
/* 80481FB4 0044B574  F3 C1 00 38 */	psq_st f30, 56(r1), 0, qr0
/* 80481FB8 0044B578  DB A1 00 20 */	stfd f29, 0x20(r1)
/* 80481FBC 0044B57C  F3 A1 00 28 */	psq_st f29, 40(r1), 0, qr0
/* 80481FC0 0044B580  DB 81 00 10 */	stfd f28, 0x10(r1)
/* 80481FC4 0044B584  F3 81 00 18 */	psq_st f28, 24(r1), 0, qr0
/* 80481FC8 0044B588  93 E1 00 0C */	stw r31, 0xc(r1)
/* 80481FCC 0044B58C  7C 7F 1B 78 */	mr r31, r3
/* 80481FD0 0044B590  48 01 D9 15 */	bl func_8049F8E4
...
/* 80481FE4 0044B5A4  4B FC 65 65 */	bl func_80448548
...
/* 80482008 0044B5C8  E3 E1 00 48 */	psq_l f31, 72(r1), 0, qr0
/* 8048200C 0044B5CC  CB E1 00 40 */	lfd f31, 0x40(r1)
/* 80482010 0044B5D0  E3 C1 00 38 */	psq_l f30, 56(r1), 0, qr0
/* 80482014 0044B5D4  CB C1 00 30 */	lfd f30, 0x30(r1)
/* 80482018 0044B5D8  E3 A1 00 28 */	psq_l f29, 40(r1), 0, qr0
/* 8048201C 0044B5DC  CB A1 00 20 */	lfd f29, 0x20(r1)
/* 80482020 0044B5E0  E3 81 00 18 */	psq_l f28, 24(r1), 0, qr0
...
.global func_80482040
func_80482040:
/* 80482040 0044B600  38 60 00 00 */	li r3, 0
/* 80482044 0044B604  4E 80 00 20 */	blr 

.global func_80482048
func_80482048:
/* 80482048 0044B608  4E 80 00 20 */	blr 

.global func_8048204C
func_8048204C:
...
/* 8048205C 0044B61C  2C 03 00 00 */	cmpwi r3, 0
...
/* 8048206C 0044B62C  41 82 00 10 */	beq lbl_8048207C
/* 80482070 0044B630  2C 04 00 00 */	cmpwi r4, 0
/* 80482074 0044B634  40 81 00 08 */	ble lbl_8048207C
