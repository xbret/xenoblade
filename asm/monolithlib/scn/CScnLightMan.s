.include "macros.inc"
.file "monolithlib/scn/CScnLightMan.o"
...
# 0x8048D024 - 0x8048D1C4
.text
.balign 4

.fn fn_8048D024, global
...
/* 8048D04C 0045660C  90 A3 00 00 */	stw r5, 0x0(r3)
/* 8048D050 00456610  7F 85 E3 78 */	mr r5, r28
/* 8048D054 00456614  90 83 00 04 */	stw r4, 0x4(r3)
/* 8048D058 00456618  7C 83 23 78 */	mr r3, r4
/* 8048D05C 0045661C  38 80 00 00 */	li r4, 0x0
/* 8048D060 00456620  4B FF 53 39 */	bl fn_80482398
/* 8048D064 00456624  90 7C 00 08 */	stw r3, 0x8(r28)
/* 8048D068 00456628  38 80 00 03 */	li r4, 0x3
/* 8048D06C 0045662C  80 7C 00 04 */	lwz r3, 0x4(r28)
/* 8048D070 00456630  80 63 00 60 */	lwz r3, 0x60(r3)
/* 8048D074 00456634  4B FF F6 25 */	bl fn_8048C698
/* 8048D078 00456638  80 83 00 04 */	lwz r4, 0x4(r3)
/* 8048D07C 0045663C  7C 7F 1B 78 */	mr r31, r3
/* 8048D080 00456640  83 A4 00 00 */	lwz r29, 0x0(r4)
/* 8048D084 00456644  48 00 00 30 */	b .L_8048D0B4
.L_8048D088:
/* 8048D088 00456648  83 DD 00 08 */	lwz r30, 0x8(r29)
...
/* 8048D09C 0045665C  48 00 84 11 */	bl fn_804954AC
/* 8048D0A0 00456660  A8 1E 00 10 */	lha r0, 0x10(r30)
/* 8048D0A4 00456664  2C 00 00 00 */	cmpwi r0, 0x0
/* 8048D0A8 00456668  40 82 00 08 */	bne .L_8048D0B0
/* 8048D0AC 0045666C  93 DC 00 08 */	stw r30, 0x8(r28)
.L_8048D0B0:
/* 8048D0B0 00456670  83 BD 00 00 */	lwz r29, 0x0(r29)
.L_8048D0B4:
/* 8048D0B4 00456674  80 1F 00 04 */	lwz r0, 0x4(r31)
...
/* 8048D100 004566C0  2C 04 00 00 */	cmpwi r4, 0x0
...
/* 8048D13C 004566FC  48 03 28 09 */	bl fn_804BF944
/* 8048D140 00456700  80 7F 00 08 */	lwz r3, 0x8(r31)
/* 8048D144 00456704  38 00 00 01 */	li r0, 0x1
...
/* 8048D174 00456734  80 83 00 08 */	lwz r4, 0x8(r3)
/* 8048D178 00456738  88 04 12 1C */	lbz r0, 0x121c(r4)
/* 8048D17C 0045673C  2C 00 00 00 */	cmpwi r0, 0x0
/* 8048D180 00456740  41 82 00 1C */	beq .L_8048D19C
/* 8048D184 00456744  38 64 00 14 */	addi r3, r4, 0x14
/* 8048D188 00456748  38 80 00 00 */	li r4, 0x0
/* 8048D18C 0045674C  48 00 88 5D */	bl fn_804959E8
/* 8048D190 00456750  80 7F 00 08 */	lwz r3, 0x8(r31)
/* 8048D194 00456754  38 00 00 00 */	li r0, 0x0
...
.fn fn_8048D1B0, global
/* 8048D1B0 00456770  80 63 00 08 */	lwz r3, 0x8(r3)
/* 8048D1B4 00456774  81 83 00 00 */	lwz r12, 0x0(r3)
