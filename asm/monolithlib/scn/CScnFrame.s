.include "macros.inc"
.file "monolithlib/scn/CScnFrame.o"
...
/* 8049E38C 0046794C  38 00 00 00 */	li r0, 0x0
/* 8049E390 00467950  90 A3 00 00 */	stw r5, 0x0(r3)
/* 8049E394 00467954  90 83 00 04 */	stw r4, 0x4(r3)
/* 8049E398 00467958  D0 03 00 08 */	stfs f0, 0x8(r3)
...
/* 8049E3C4 00467984  2C 04 00 00 */	cmpwi r4, 0x0
...
/* 8049E400 004679C0  2C 00 00 00 */	cmpwi r0, 0x0
/* 8049E404 004679C4  41 82 00 38 */	beq .L_8049E43C
/* 8049E408 004679C8  4B FA A0 19 */	bl fn_80448420
...
/* 8049E418 004679D8  90 01 00 08 */	stw r0, 0x8(r1)
/* 8049E41C 004679DC  C0 22 D0 14 */	lfs f1, lbl_8066D394@sda21(r2)
/* 8049E420 004679E0  C8 41 00 08 */	lfd f2, 0x8(r1)
...
/* 8049E434 004679F4  D0 1F 00 08 */	stfs f0, 0x8(r31)
/* 8049E438 004679F8  48 00 00 0C */	b .L_8049E444
.L_8049E43C:
/* 8049E43C 004679FC  C0 03 00 0C */	lfs f0, 0xc(r3)
/* 8049E440 00467A00  D0 03 00 08 */	stfs f0, 0x8(r3)
.L_8049E444:
