.include "macros.inc"
.file "monolithlib/scn/CScnMem.o"
...
/* 8048EAB4 00458074  38 00 FF FF */	li r0, -0x1
/* 8048EAB8 00458078  90 A3 00 00 */	stw r5, 0x0(r3)
/* 8048EABC 0045807C  90 83 00 04 */	stw r4, 0x4(r3)
/* 8048EAC0 00458080  90 03 00 08 */	stw r0, 0x8(r3)
...
/* 8048EAE4 004580A4  93 C1 00 08 */	stw r30, 0x8(r1)
...
/* 8048EAF8 004580B8  90 83 00 00 */	stw r4, 0x0(r3)
/* 8048EAFC 004580BC  80 63 00 08 */	lwz r3, 0x8(r3)
/* 8048EB00 004580C0  4B FA 58 B1 */	bl fn_804343B0
/* 8048EB04 004580C4  2C 1F 00 00 */	cmpwi r31, 0x0
...
/* 8048EB1C 004580DC  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 8048EB48 00458108  90 83 00 04 */	stw r4, 0x4(r3)
...
/* 8048EB5C 0045811C  4B FA 54 E5 */	bl fn_80434040
/* 8048EB60 00458120  90 7F 00 08 */	stw r3, 0x8(r31)
...
/* 8048EB8C 0045814C  48 00 70 A1 */	bl fn_80495C2C
...
/* 8048EBD4 00458194  93 C1 00 08 */	stw r30, 0x8(r1)
/* 8048EBD8 00458198  7C 7E 1B 78 */	mr r30, r3
/* 8048EBDC 0045819C  41 82 00 1C */	beq .L_8048EBF8
/* 8048EBE0 004581A0  38 80 00 00 */	li r4, 0x0
/* 8048EBE4 004581A4  48 00 71 D5 */	bl fn_80495DB8
/* 8048EBE8 004581A8  2C 1F 00 00 */	cmpwi r31, 0x0
...
/* 8048EC00 004581C0  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 8048EC54 00458214  4C C6 31 82 */	crclr 4*cr1+eq
...
/* 8048EC64 00458224  3B C0 00 00 */	li r30, 0x0
/* 8048EC68 00458228  7F E3 00 2E */	lwzx r31, r3, r0
/* 8048EC6C 0045822C  2C 1F 00 00 */	cmpwi r31, 0x0
...
/* 8048EC80 00458240  90 81 00 08 */	stw r4, 0x8(r1)
/* 8048EC84 00458244  38 81 00 08 */	addi r4, r1, 0x8
/* 8048EC88 00458248  81 9F 00 00 */	lwz r12, 0x0(r31)
/* 8048EC8C 0045824C  81 8C 00 08 */	lwz r12, 0x8(r12)
/* 8048EC90 00458250  7D 89 03 A6 */	mtctr r12
/* 8048EC94 00458254  4E 80 04 21 */	bctrl
/* 8048EC98 00458258  2C 03 00 00 */	cmpwi r3, 0x0
/* 8048EC9C 0045825C  41 82 00 08 */	beq .L_8048ECA4
/* 8048ECA0 00458260  3B C0 00 01 */	li r30, 0x1
.L_8048ECA4:
/* 8048ECA4 00458264  2C 1E 00 00 */	cmpwi r30, 0x0
...
.L_8048ECB4:
/* 8048ECB4 00458274  38 60 00 00 */	li r3, 0x0
.L_8048ECB8:
