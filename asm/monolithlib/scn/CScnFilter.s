...
/* 8049C804 00465DC4  98 83 00 04 */	stb r4, 0x4(r3)
/* 8049C808 00465DC8  38 A5 23 A8 */	addi r5, r5, __vt__CScnFilter@l
/* 8049C80C 00465DCC  60 80 00 03 */	ori r0, r4, 0x3
/* 8049C810 00465DD0  90 A3 00 00 */	stw r5, 0x0(r3)
...
/* 8049C844 00465E04  2C 04 00 00 */	cmpwi r4, 0x0
...
/* 8049C89C 00465E5C  90 01 00 08 */	stw r0, 0x8(r1)
/* 8049C8A0 00465E60  C0 43 00 10 */	lfs f2, 0x10(r3)
/* 8049C8A4 00465E64  C8 01 00 08 */	lfd f0, 0x8(r1)
...
/* 8049C8B4 00465E74  38 00 00 01 */	li r0, 0x1
/* 8049C8B8 00465E78  48 00 00 08 */	b .L_8049C8C0
.L_8049C8BC:
/* 8049C8BC 00465E7C  38 00 00 00 */	li r0, 0x0
.L_8049C8C0:
/* 8049C8C0 00465E80  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 8049C8D8 00465E98  2C 07 00 00 */	cmpwi r7, 0x0
...
/* 8049C8F4 00465EB4  90 01 00 08 */	stw r0, 0x8(r1)
/* 8049C8F8 00465EB8  C8 01 00 08 */	lfd f0, 0x8(r1)
...
/* 8049C908 00465EC8  38 00 00 01 */	li r0, 0x1
/* 8049C90C 00465ECC  48 00 00 08 */	b .L_8049C914
.L_8049C910:
/* 8049C910 00465ED0  38 00 00 00 */	li r0, 0x0
.L_8049C914:
/* 8049C914 00465ED4  2C 00 00 00 */	cmpwi r0, 0x0
/* 8049C918 00465ED8  41 82 00 20 */	beq .L_8049C938
/* 8049C91C 00465EDC  80 63 00 14 */	lwz r3, 0x14(r3)
/* 8049C920 00465EE0  2C 03 00 00 */	cmpwi r3, 0x0
/* 8049C924 00465EE4  41 82 00 14 */	beq .L_8049C938
/* 8049C928 00465EE8  81 83 00 00 */	lwz r12, 0x0(r3)
