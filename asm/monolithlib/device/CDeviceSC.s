...
/* 80447B58 00411118  38 C0 00 08 */	li r6, 0x8
...
/* 80447B70 00411130  38 80 00 00 */	li r4, 0x0
/* 80447B74 00411134  38 63 F5 B0 */	addi r3, r3, __vt__CDeviceSC@l
/* 80447B78 00411138  38 00 00 01 */	li r0, 0x1
/* 80447B7C 0041113C  90 9F 01 C4 */	stw r4, 0x1c4(r31)
/* 80447B80 00411140  90 7F 00 00 */	stw r3, 0x0(r31)
...
/* 80447C0C 004111CC  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 80447C30 004111F0  38 03 FF FF */	addi r0, r3, -0x1
...
/* 80447C68 00411228  54 00 06 F7 */	rlwinm. r0, r0, 0, 27, 27
/* 80447C6C 0041122C  41 82 00 0C */	beq .L_80447C78
/* 80447C70 00411230  38 00 00 01 */	li r0, 0x1
/* 80447C74 00411234  48 00 00 5C */	b .L_80447CD0
.L_80447C78:
/* 80447C78 00411238  80 06 01 AC */	lwz r0, 0x1ac(r6)
/* 80447C7C 0041123C  38 E0 00 00 */	li r7, 0x0
/* 80447C80 00411240  7C 09 03 A6 */	mtctr r0
/* 80447C84 00411244  28 00 00 00 */	cmplwi r0, 0x0
...
/* 80447CB0 00411270  28 00 00 02 */	cmplwi r0, 0x2
/* 80447CB4 00411274  40 82 00 08 */	bne .L_80447CBC
/* 80447CB8 00411278  48 00 00 10 */	b .L_80447CC8
.L_80447CBC:
/* 80447CBC 0041127C  38 E7 00 01 */	addi r7, r7, 0x1
/* 80447CC0 00411280  42 00 FF CC */	bdnz .L_80447C8C
.L_80447CC4:
/* 80447CC4 00411284  38 E0 FF FF */	li r7, -0x1
.L_80447CC8:
/* 80447CC8 00411288  54 E0 0F FE */	srwi r0, r7, 31
/* 80447CCC 0041128C  68 00 00 01 */	xori r0, r0, 0x1
.L_80447CD0:
/* 80447CD0 00411290  2C 00 00 00 */	cmpwi r0, 0x0
/* 80447CD4 00411294  38 60 00 00 */	li r3, 0x0
/* 80447CD8 00411298  4C 82 00 20 */	bnelr
/* 80447CDC 0041129C  80 86 00 48 */	lwz r4, 0x48(r6)
/* 80447CE0 004112A0  38 00 00 01 */	li r0, 0x1
/* 80447CE4 004112A4  2C 04 00 02 */	cmpwi r4, 0x2
/* 80447CE8 004112A8  41 82 00 10 */	beq .L_80447CF8
/* 80447CEC 004112AC  2C 04 00 03 */	cmpwi r4, 0x3
/* 80447CF0 004112B0  41 82 00 08 */	beq .L_80447CF8
/* 80447CF4 004112B4  38 00 00 00 */	li r0, 0x0
.L_80447CF8:
/* 80447CF8 004112B8  2C 00 00 00 */	cmpwi r0, 0x0
/* 80447CFC 004112BC  4D 82 00 20 */	beqlr
/* 80447D00 004112C0  38 60 00 01 */	li r3, 0x1
...
.L_80447D68:
/* 80447D68 00411328  38 60 00 00 */	li r3, 0x0
.L_80447D6C:
...
/* 80447D98 00411358  80 04 00 00 */	lwz r0, 0x0(r4)
...
/* 80447DA8 00411368  2C 03 00 00 */	cmpwi r3, 0x0
...
.L_80447DBC:
/* 80447DBC 0041137C  38 60 00 00 */	li r3, 0x0
.L_80447DC0:
