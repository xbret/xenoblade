.include "macros.inc"
.file "monolithlib/device/CDevice.o"
...
/* 8044D848 00416E08  4B FE 9D 6D */	bl fn_804375B4
...
/* 8044D858 00416E18  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 8044D87C 00416E3C  90 7E 00 00 */	stw r3, 0x0(r30)
...
/* 8044D88C 00416E4C  38 A0 00 00 */	li r5, 0x0
/* 8044D890 00416E50  4B FE B3 49 */	bl fn_80438BD8
/* 8044D894 00416E54  4B FF FC 8D */	bl fn_8044D520
/* 8044D898 00416E58  7F A3 EB 78 */	mr r3, r29
/* 8044D89C 00416E5C  38 80 00 09 */	li r4, 0x9
/* 8044D8A0 00416E60  4B FE A6 51 */	bl fn_80437EF0
/* 8044D8A4 00416E64  7F A3 EB 78 */	mr r3, r29
/* 8044D8A8 00416E68  4B FE B1 51 */	bl fn_804389F8
...
/* 8044D8E0 00416EA0  80 04 00 00 */	lwz r0, 0x0(r4)
/* 8044D8E4 00416EA4  7C 00 20 40 */	cmplw r0, r4
/* 8044D8E8 00416EA8  40 82 00 28 */	bne .L_8044D910
/* 8044D8EC 00416EAC  4B FF 6B E9 */	bl fn_804444D4
/* 8044D8F0 00416EB0  2C 03 00 00 */	cmpwi r3, 0x0
/* 8044D8F4 00416EB4  40 82 00 1C */	bne .L_8044D910
/* 8044D8F8 00416EB8  48 00 BA F9 */	bl fn_804593F0
/* 8044D8FC 00416EBC  2C 03 00 00 */	cmpwi r3, 0x0
/* 8044D900 00416EC0  40 82 00 10 */	bne .L_8044D910
/* 8044D904 00416EC4  7F E3 FB 78 */	mr r3, r31
/* 8044D908 00416EC8  4B FE B1 1D */	bl fn_80438A24
/* 8044D90C 00416ECC  48 00 00 08 */	b .L_8044D914
.L_8044D910:
/* 8044D910 00416ED0  38 60 00 00 */	li r3, 0x0
.L_8044D914:
...
/* 8044D940 00416F00  4B FF 5E 7D */	bl fn_804437BC
...
/* 8044D954 00416F14  4B FE 9C 61 */	bl fn_804375B4
...
/* 8044D964 00416F24  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 8044D98C 00416F4C  90 7D 00 00 */	stw r3, 0x0(r29)
...
/* 8044D9A0 00416F60  38 A0 00 00 */	li r5, 0x0
/* 8044D9A4 00416F64  4B FE B2 35 */	bl fn_80438BD8
...
/* 8044DA54 00417014  4B FE 69 5D */	bl fn_804343B0
/* 8044DA58 00417018  80 6D 9E 24 */	lwz r3, lbl_80665FA4@sda21(r13)
/* 8044DA5C 0041701C  4B FE 69 55 */	bl fn_804343B0
/* 8044DA60 00417020  38 00 FF FF */	li r0, -0x1
...
/* 8044DA94 00417054  93 C1 00 08 */	stw r30, 0x8(r1)
/* 8044DA98 00417058  7C 7E 1B 78 */	mr r30, r3
/* 8044DA9C 0041705C  41 82 00 24 */	beq .L_8044DAC0
/* 8044DAA0 00417060  38 00 00 00 */	li r0, 0x0
/* 8044DAA4 00417064  90 0D BD B4 */	stw r0, lbl_80667F34@sda21(r13)
/* 8044DAA8 00417068  38 80 00 00 */	li r4, 0x0
/* 8044DAAC 0041706C  4B FE A0 1D */	bl fn_80437AC8
/* 8044DAB0 00417070  2C 1F 00 00 */	cmpwi r31, 0x0
...
/* 8044DAC8 00417088  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 8044DAEC 004170AC  38 60 00 00 */	li r3, 0x0
/* 8044DAF0 004170B0  4E 80 00 20 */	blr
.L_8044DAF4:
/* 8044DAF4 004170B4  4B FE AF 30 */	b fn_80438A24
...
/* 8044DB08 004170C8  38 00 00 00 */	li r0, 0x0
