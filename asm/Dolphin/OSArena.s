...
/* 803539A8 0031CF68  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 803539AC 0031CF6C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */

.global func_803539B0
func_803539B0:
/* 803539B0 0031CF70  80 6D B8 E4 */	lwz r3, lbl_80667A64@sda21(r13)
/* 803539B4 0031CF74  4E 80 00 20 */	blr 
/* 803539B8 0031CF78  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 803539BC 0031CF7C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */

.global func_803539C0
func_803539C0:
/* 803539C0 0031CF80  80 6D B8 E0 */	lwz r3, lbl_80667A60@sda21(r13)
/* 803539C4 0031CF84  4E 80 00 20 */	blr 
/* 803539C8 0031CF88  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 803539CC 0031CF8C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */

.global func_803539D0
func_803539D0:
/* 803539D0 0031CF90  80 6D 99 E0 */	lwz r3, lbl_80665B60@sda21(r13)
/* 803539D4 0031CF94  4E 80 00 20 */	blr 
/* 803539D8 0031CF98  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 803539DC 0031CF9C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */

.global func_803539E0
func_803539E0:
/* 803539E0 0031CFA0  80 6D 99 E4 */	lwz r3, lbl_80665B64@sda21(r13)
/* 803539E4 0031CFA4  4E 80 00 20 */	blr 
/* 803539E8 0031CFA8  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 803539EC 0031CFAC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */

.global func_803539F0
func_803539F0:
/* 803539F0 0031CFB0  80 6D 99 E0 */	lwz r3, lbl_80665B60@sda21(r13)
/* 803539F4 0031CFB4  4E 80 00 20 */	blr 
/* 803539F8 0031CFB8  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 803539FC 0031CFBC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */

.global OSSetMEM1ArenaHi
OSSetMEM1ArenaHi:
/* 80353A00 0031CFC0  90 6D B8 E0 */	stw r3, lbl_80667A60@sda21(r13)
/* 80353A04 0031CFC4  4E 80 00 20 */	blr 
/* 80353A08 0031CFC8  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 80353A0C 0031CFCC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */

.global OSSetMEM2ArenaHi
OSSetMEM2ArenaHi:
/* 80353A10 0031CFD0  90 6D B8 E4 */	stw r3, lbl_80667A64@sda21(r13)
/* 80353A14 0031CFD4  4E 80 00 20 */	blr 
/* 80353A18 0031CFD8  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 80353A1C 0031CFDC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */

.global func_80353A20
func_80353A20:
/* 80353A20 0031CFE0  90 6D B8 E0 */	stw r3, lbl_80667A60@sda21(r13)
/* 80353A24 0031CFE4  4E 80 00 20 */	blr 
/* 80353A28 0031CFE8  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 80353A2C 0031CFEC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */

.global OSSetMEM1ArenaLo
OSSetMEM1ArenaLo:
/* 80353A30 0031CFF0  90 6D 99 E0 */	stw r3, lbl_80665B60@sda21(r13)
/* 80353A34 0031CFF4  4E 80 00 20 */	blr 
/* 80353A38 0031CFF8  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 80353A3C 0031CFFC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */

.global OSSetMEM2ArenaLo
OSSetMEM2ArenaLo:
/* 80353A40 0031D000  90 6D 99 E4 */	stw r3, lbl_80665B64@sda21(r13)
/* 80353A44 0031D004  4E 80 00 20 */	blr 
/* 80353A48 0031D008  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 80353A4C 0031D00C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */

.global func_80353A50
func_80353A50:
...
/* 80353A94 0031D054  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 80353A98 0031D058  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 80353A9C 0031D05C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */