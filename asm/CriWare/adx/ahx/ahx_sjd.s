.include "macros.inc"
.file "CriWare/adx/ahx/ahx_sjd.o"

# 0x8038C760 - 0x8038CF04
.text
.balign 4
...
/* 8038C77C 00355D3C  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 8038C7F4 00355DB4  38 03 00 01 */	addi r0, r3, 0x1
...
/* 8038C820 00355DE0  2C 00 00 01 */	cmpwi r0, 0x1
...
/* 8038C834 00355DF4  38 03 FF FF */	addi r0, r3, -0x1
...
/* 8038C858 00355E18  38 06 00 07 */	addi r0, r6, 0x7
/* 8038C85C 00355E1C  BF 41 00 08 */	stmw r26, 0x8(r1)
/* 8038C860 00355E20  7C 9D 23 78 */	mr r29, r4
/* 8038C864 00355E24  7C BE 2B 78 */	mr r30, r5
/* 8038C868 00355E28  54 1F 00 38 */	clrrwi r31, r0, 3
...
/* 8038C878 00355E38  38 80 00 00 */	li r4, 0x0
...
/* 8038C888 00355E48  54 04 00 38 */	clrrwi r4, r0, 3
...
/* 8038C898 00355E58  38 60 00 00 */	li r3, 0x0
...
/* 8038C8AC 00355E6C  2C 03 00 00 */	cmpwi r3, 0x0
/* 8038C8B0 00355E70  90 7F 00 04 */	stw r3, 0x4(r31)
/* 8038C8B4 00355E74  40 82 00 0C */	bne .L_8038C8C0
/* 8038C8B8 00355E78  38 60 00 00 */	li r3, 0x0
/* 8038C8BC 00355E7C  48 00 01 88 */	b .L_8038CA44
.L_8038C8C0:
/* 8038C8C0 00355E80  38 1C 00 07 */	addi r0, r28, 0x7
/* 8038C8C4 00355E84  54 04 00 38 */	clrrwi r4, r0, 3
...
/* 8038C8D8 00355E98  38 60 00 00 */	li r3, 0x0
...
/* 8038C8EC 00355EAC  2C 03 00 00 */	cmpwi r3, 0x0
/* 8038C8F0 00355EB0  90 7F 00 00 */	stw r3, 0x0(r31)
/* 8038C8F4 00355EB4  40 82 00 14 */	bne .L_8038C908
/* 8038C8F8 00355EB8  80 7F 00 04 */	lwz r3, 0x4(r31)
/* 8038C8FC 00355EBC  48 00 0A DD */	bl AHXBSR_Destroy
/* 8038C900 00355EC0  38 60 00 00 */	li r3, 0x0
/* 8038C904 00355EC4  48 00 01 40 */	b .L_8038CA44
.L_8038C908:
/* 8038C908 00355EC8  9B BF 00 0A */	stb r29, 0xa(r31)
/* 8038C90C 00355ECC  2C 9D 00 00 */	cmpwi cr1, r29, 0x0
/* 8038C910 00355ED0  38 C0 00 00 */	li r6, 0x0
/* 8038C914 00355ED4  93 5F 00 10 */	stw r26, 0x10(r31)
/* 8038C918 00355ED8  40 85 00 D0 */	ble cr1, .L_8038C9E8
/* 8038C91C 00355EDC  2C 1D 00 08 */	cmpwi r29, 0x8
/* 8038C920 00355EE0  38 9D FF F8 */	addi r4, r29, -0x8
/* 8038C924 00355EE4  40 81 00 94 */	ble .L_8038C9B8
/* 8038C928 00355EE8  38 A0 00 00 */	li r5, 0x0
/* 8038C92C 00355EEC  41 84 00 18 */	blt cr1, .L_8038C944
/* 8038C930 00355EF0  3C 60 80 00 */	lis r3, 0x8000
/* 8038C934 00355EF4  38 03 FF FE */	addi r0, r3, -0x2
/* 8038C938 00355EF8  7C 1D 00 00 */	cmpw r29, r0
/* 8038C93C 00355EFC  41 81 00 08 */	bgt .L_8038C944
/* 8038C940 00355F00  38 A0 00 01 */	li r5, 0x1
.L_8038C944:
/* 8038C944 00355F04  2C 05 00 00 */	cmpwi r5, 0x0
/* 8038C948 00355F08  41 82 00 70 */	beq .L_8038C9B8
/* 8038C94C 00355F0C  38 04 00 07 */	addi r0, r4, 0x7
...
/* 8038C960 00355F20  2C 04 00 00 */	cmpwi r4, 0x0
/* 8038C964 00355F24  40 81 00 54 */	ble .L_8038C9B8
.L_8038C968:
/* 8038C968 00355F28  80 03 00 00 */	lwz r0, 0x0(r3)
/* 8038C96C 00355F2C  38 C6 00 08 */	addi r6, r6, 0x8
/* 8038C970 00355F30  90 05 00 14 */	stw r0, 0x14(r5)
/* 8038C974 00355F34  80 03 00 04 */	lwz r0, 0x4(r3)
/* 8038C978 00355F38  90 05 00 18 */	stw r0, 0x18(r5)
/* 8038C97C 00355F3C  80 03 00 08 */	lwz r0, 0x8(r3)
...
.L_8038C9D4:
/* 8038C9D4 00355F94  80 03 00 00 */	lwz r0, 0x0(r3)
/* 8038C9D8 00355F98  38 63 00 04 */	addi r3, r3, 0x4
/* 8038C9DC 00355F9C  90 04 00 14 */	stw r0, 0x14(r4)
/* 8038C9E0 00355FA0  38 84 00 04 */	addi r4, r4, 0x4
/* 8038C9E4 00355FA4  42 00 FF F0 */	bdnz .L_8038C9D4
.L_8038C9E8:
/* 8038C9E8 00355FA8  38 C0 00 00 */	li r6, 0x0
/* 8038C9EC 00355FAC  3C 60 80 00 */	lis r3, 0x8000
/* 8038C9F0 00355FB0  98 DF 00 09 */	stb r6, 0x9(r31)
/* 8038C9F4 00355FB4  38 A3 FF FF */	addi r5, r3, -0x1
/* 8038C9F8 00355FB8  38 80 FF FF */	li r4, -0x1
/* 8038C9FC 00355FBC  38 00 00 01 */	li r0, 0x1
...
/* 8038CA40 00356000  98 1F 00 08 */	stb r0, 0x8(r31)
.L_8038CA44:
/* 8038CA44 00356004  BB 41 00 08 */	lmw r26, 0x8(r1)
...
/* 8038CA60 00356020  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 8038CA74 00356034  80 83 00 04 */	lwz r4, 0x4(r3)
/* 8038CA78 00356038  2C 04 00 00 */	cmpwi r4, 0x0
/* 8038CA7C 0035603C  41 82 00 14 */	beq .L_8038CA90
/* 8038CA80 00356040  38 00 00 00 */	li r0, 0x0
/* 8038CA84 00356044  90 03 00 04 */	stw r0, 0x4(r3)
/* 8038CA88 00356048  7C 83 23 78 */	mr r3, r4
/* 8038CA8C 0035604C  48 00 09 4D */	bl AHXBSR_Destroy
.L_8038CA90:
/* 8038CA90 00356050  80 7F 00 00 */	lwz r3, 0x0(r31)
/* 8038CA94 00356054  2C 03 00 00 */	cmpwi r3, 0x0
/* 8038CA98 00356058  41 82 00 10 */	beq .L_8038CAA8
/* 8038CA9C 0035605C  38 00 00 00 */	li r0, 0x0
/* 8038CAA0 00356060  90 1F 00 00 */	stw r0, 0x0(r31)
/* 8038CAA4 00356064  48 00 18 29 */	bl AHXDCD_Destroy
.L_8038CAA8:
/* 8038CAA8 00356068  7F E3 FB 78 */	mr r3, r31
/* 8038CAAC 0035606C  38 80 00 00 */	li r4, 0x0
...
/* 8038CACC 0035608C  88 63 00 09 */	lbz r3, 0x9(r3)
...
/* 8038CAE8 003560A8  3C 80 80 00 */	lis r4, 0x8000
/* 8038CAEC 003560AC  38 C0 00 00 */	li r6, 0x0
/* 8038CAF0 003560B0  90 01 00 14 */	stw r0, 0x14(r1)
/* 8038CAF4 003560B4  38 00 FF FF */	li r0, -0x1
/* 8038CAF8 003560B8  38 A4 FF FF */	addi r5, r4, -0x1
...
/* 8038CB34 003560F4  80 63 00 04 */	lwz r3, 0x4(r3)
/* 8038CB38 003560F8  48 00 08 B9 */	bl AHXBSR_Restruct
/* 8038CB3C 003560FC  80 7F 00 00 */	lwz r3, 0x0(r31)
/* 8038CB40 00356100  80 9F 00 04 */	lwz r4, 0x4(r31)
/* 8038CB44 00356104  48 00 18 B1 */	bl AHXDCD_SetBsr
/* 8038CB48 00356108  38 00 00 01 */	li r0, 0x1
/* 8038CB4C 0035610C  98 1F 00 09 */	stb r0, 0x9(r31)
...
/* 8038CB78 00356138  80 63 00 00 */	lwz r3, 0x0(r3)
/* 8038CB7C 0035613C  48 00 17 A5 */	bl AHXDCD_Reset
/* 8038CB80 00356140  38 00 00 00 */	li r0, 0x0
/* 8038CB84 00356144  98 1F 00 09 */	stb r0, 0x9(r31)
...
/* 8038CBB0 00356170  83 C3 00 00 */	lwz r30, 0x0(r3)
...
/* 8038CBC0 00356180  80 7B 00 00 */	lwz r3, 0x0(r27)
...
/* 8038CBD4 00356194  38 80 00 00 */	li r4, 0x0
/* 8038CBD8 00356198  80 A6 00 00 */	lwz r5, 0x0(r6)
...
/* 8038CC00 003561C0  2C 03 00 00 */	cmpwi r3, 0x0
...
.L_8038CC50:
/* 8038CC50 00356210  2C 03 FF FF */	cmpwi r3, -0x1
...
/* 8038CC64 00356224  80 E3 00 00 */	lwz r7, 0x0(r3)
/* 8038CC68 00356228  38 80 00 00 */	li r4, 0x0
...
/* 8038CC90 00356250  38 80 00 00 */	li r4, 0x0
/* 8038CC94 00356254  80 C3 00 00 */	lwz r6, 0x0(r3)
...
/* 8038CCB4 00356274  38 A0 00 00 */	li r5, 0x0
...
/* 8038CD28 003562E8  38 00 00 00 */	li r0, 0x0
...
/* 8038CD6C 0035632C  38 80 00 01 */	li r4, 0x1
/* 8038CD70 00356330  80 C3 00 00 */	lwz r6, 0x0(r3)
...
/* 8038CD84 00356344  38 A1 00 08 */	addi r5, r1, 0x8
/* 8038CD88 00356348  38 80 00 00 */	li r4, 0x0
/* 8038CD8C 0035634C  80 C3 00 00 */	lwz r6, 0x0(r3)
...
/* 8038CDA0 00356360  80 7B 00 04 */	lwz r3, 0x4(r27)
...
/* 8038CDB0 00356370  38 03 00 07 */	addi r0, r3, 0x7
...
/* 8038CDD8 00356398  2C 06 00 00 */	cmpwi r6, 0x0
...
/* 8038CDFC 003563BC  2C 0C 00 00 */	cmpwi r12, 0x0
...
/* 8038CE14 003563D4  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 8038CE28 003563E8  38 00 00 03 */	li r0, 0x3
/* 8038CE2C 003563EC  98 1B 00 09 */	stb r0, 0x9(r27)
.L_8038CE30:
...
/* 8038CE58 00356418  88 03 00 09 */	lbz r0, 0x9(r3)
/* 8038CE5C 0035641C  7C 00 07 74 */	extsb r0, r0
/* 8038CE60 00356420  2C 00 00 02 */	cmpwi r0, 0x2
/* 8038CE64 00356424  40 82 00 0C */	bne .L_8038CE70
/* 8038CE68 00356428  4B FF FD 35 */	bl fn_8038CB9C
/* 8038CE6C 0035642C  48 00 00 44 */	b .L_8038CEB0
.L_8038CE70:
/* 8038CE70 00356430  2C 00 00 01 */	cmpwi r0, 0x1
/* 8038CE74 00356434  40 82 00 3C */	bne .L_8038CEB0
/* 8038CE78 00356438  80 63 00 10 */	lwz r3, 0x10(r3)
/* 8038CE7C 0035643C  38 80 00 01 */	li r4, 0x1
/* 8038CE80 00356440  80 A3 00 00 */	lwz r5, 0x0(r3)
...
/* 8038CE98 00356458  80 7F 00 00 */	lwz r3, 0x0(r31)
/* 8038CE9C 0035645C  48 00 15 95 */	bl AHXDCD_DecodeHeader
/* 8038CEA0 00356460  80 7F 00 00 */	lwz r3, 0x0(r31)
/* 8038CEA4 00356464  48 00 17 7D */	bl AHXDCD_DecodeFrmHdr
/* 8038CEA8 00356468  38 00 00 02 */	li r0, 0x2
/* 8038CEAC 0035646C  98 1F 00 09 */	stb r0, 0x9(r31)
.L_8038CEB0:
