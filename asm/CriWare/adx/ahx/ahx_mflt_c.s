...
/* 8038A9B8 00353F78  F3 E1 00 88 */	psq_st f31, 0x88(r1), 0, qr0
/* 8038A9BC 00353F7C  DB C1 00 70 */	stfd f30, 0x70(r1)
/* 8038A9C0 00353F80  F3 C1 00 78 */	psq_st f30, 0x78(r1), 0, qr0
/* 8038A9C4 00353F84  DB A1 00 60 */	stfd f29, 0x60(r1)
/* 8038A9C8 00353F88  F3 A1 00 68 */	psq_st f29, 0x68(r1), 0, qr0
/* 8038A9CC 00353F8C  DB 81 00 50 */	stfd f28, 0x50(r1)
/* 8038A9D0 00353F90  F3 81 00 58 */	psq_st f28, 0x58(r1), 0, qr0
/* 8038A9D4 00353F94  DB 61 00 40 */	stfd f27, 0x40(r1)
/* 8038A9D8 00353F98  F3 61 00 48 */	psq_st f27, 0x48(r1), 0, qr0
/* 8038A9DC 00353F9C  DB 41 00 30 */	stfd f26, 0x30(r1)
/* 8038A9E0 00353FA0  F3 41 00 38 */	psq_st f26, 0x38(r1), 0, qr0
/* 8038A9E4 00353FA4  DB 21 00 20 */	stfd f25, 0x20(r1)
/* 8038A9E8 00353FA8  F3 21 00 28 */	psq_st f25, 0x28(r1), 0, qr0
/* 8038A9EC 00353FAC  DB 01 00 10 */	stfd f24, 0x10(r1)
/* 8038A9F0 00353FB0  F3 01 00 18 */	psq_st f24, 0x18(r1), 0, qr0
...
.L_8038AA0C:
/* 8038AA0C 00353FCC  C0 23 00 00 */	lfs f1, 0x0(r3)
/* 8038AA10 00353FD0  C0 04 00 00 */	lfs f0, 0x0(r4)
/* 8038AA14 00353FD4  C0 63 00 04 */	lfs f3, 0x4(r3)
/* 8038AA18 00353FD8  EC 01 00 32 */	fmuls f0, f1, f0
/* 8038AA1C 00353FDC  C0 44 00 04 */	lfs f2, 0x4(r4)
/* 8038AA20 00353FE0  C0 83 00 08 */	lfs f4, 0x8(r3)
/* 8038AA24 00353FE4  C0 24 00 08 */	lfs f1, 0x8(r4)
...
/* 8038AB00 003540C0  34 00 FF FF */	addic. r0, r0, -0x1
...
/* 8038AB94 00354154  D0 06 00 00 */	stfs f0, 0x0(r6)
/* 8038AB98 00354158  FC 00 00 50 */	fneg f0, f0
/* 8038AB9C 0035415C  38 C6 00 04 */	addi r6, r6, 0x4
/* 8038ABA0 00354160  D0 08 00 00 */	stfs f0, 0x0(r8)
/* 8038ABA4 00354164  39 08 FF FC */	addi r8, r8, -0x4
...
.L_8038ABC0:
/* 8038ABC0 00354180  C0 23 00 00 */	lfs f1, 0x0(r3)
/* 8038ABC4 00354184  C0 04 00 00 */	lfs f0, 0x0(r4)
/* 8038ABC8 00354188  C0 63 00 04 */	lfs f3, 0x4(r3)
/* 8038ABCC 0035418C  EC 01 00 32 */	fmuls f0, f1, f0
/* 8038ABD0 00354190  C0 44 00 04 */	lfs f2, 0x4(r4)
/* 8038ABD4 00354194  C0 83 00 08 */	lfs f4, 0x8(r3)
/* 8038ABD8 00354198  C0 24 00 08 */	lfs f1, 0x8(r4)
...
/* 8038ACB4 00354274  34 00 FF FF */	addic. r0, r0, -0x1
...
/* 8038AD48 00354308  D0 09 00 00 */	stfs f0, 0x0(r9)
/* 8038AD4C 0035430C  39 29 00 04 */	addi r9, r9, 0x4
/* 8038AD50 00354310  D0 0A 00 00 */	stfs f0, 0x0(r10)
/* 8038AD54 00354314  39 4A FF FC */	addi r10, r10, -0x4
/* 8038AD58 00354318  40 82 FE 68 */	bne .L_8038ABC0
/* 8038AD5C 0035431C  C3 03 00 00 */	lfs f24, 0x0(r3)
/* 8038AD60 00354320  C0 03 00 04 */	lfs f0, 0x4(r3)
/* 8038AD64 00354324  C0 23 00 08 */	lfs f1, 0x8(r3)
...
/* 8038AE60 00354420  E3 E1 00 88 */	psq_l f31, 0x88(r1), 0, qr0
/* 8038AE64 00354424  CB E1 00 80 */	lfd f31, 0x80(r1)
/* 8038AE68 00354428  E3 C1 00 78 */	psq_l f30, 0x78(r1), 0, qr0
/* 8038AE6C 0035442C  CB C1 00 70 */	lfd f30, 0x70(r1)
/* 8038AE70 00354430  E3 A1 00 68 */	psq_l f29, 0x68(r1), 0, qr0
/* 8038AE74 00354434  CB A1 00 60 */	lfd f29, 0x60(r1)
/* 8038AE78 00354438  E3 81 00 58 */	psq_l f28, 0x58(r1), 0, qr0
/* 8038AE7C 0035443C  CB 81 00 50 */	lfd f28, 0x50(r1)
/* 8038AE80 00354440  E3 61 00 48 */	psq_l f27, 0x48(r1), 0, qr0
/* 8038AE84 00354444  CB 61 00 40 */	lfd f27, 0x40(r1)
/* 8038AE88 00354448  E3 41 00 38 */	psq_l f26, 0x38(r1), 0, qr0
/* 8038AE8C 0035444C  CB 41 00 30 */	lfd f26, 0x30(r1)
/* 8038AE90 00354450  E3 21 00 28 */	psq_l f25, 0x28(r1), 0, qr0
/* 8038AE94 00354454  CB 21 00 20 */	lfd f25, 0x20(r1)
/* 8038AE98 00354458  E3 01 00 18 */	psq_l f24, 0x18(r1), 0, qr0
