...
/* 8038D38C 0035694C  38 00 00 01 */	li r0, 0x1
...
/* 8038D3B4 00356974  90 1D 00 00 */	stw r0, 0x0(r29)
.L_8038D3B8:
...
/* 8038D3D8 00356998  2C 03 00 00 */	cmpwi r3, 0x0
/* 8038D3DC 0035699C  4D 82 00 20 */	beqlr
/* 8038D3E0 003569A0  38 80 00 00 */	li r4, 0x0
...
/* 8038D3F8 003569B8  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 8038D46C 00356A2C  38 00 00 01 */	li r0, 0x1
...
/* 8038D490 00356A50  90 1C 00 00 */	stw r0, 0x0(r28)
.L_8038D494:
...
/* 8038D4DC 00356A9C  2C 00 00 04 */	cmpwi r0, 0x4
...
/* 8038D4F0 00356AB0  2C 04 00 00 */	cmpwi r4, 0x0
...
/* 8038D52C 00356AEC  38 00 00 00 */	li r0, 0x0
...
.L_8038D53C:
/* 8038D53C 00356AFC  90 01 00 08 */	stw r0, 0x8(r1)
/* 8038D540 00356B00  38 A1 00 10 */	addi r5, r1, 0x10
/* 8038D544 00356B04  38 80 00 00 */	li r4, 0x0
/* 8038D548 00356B08  80 63 00 04 */	lwz r3, 0x4(r3)
/* 8038D54C 00356B0C  80 C3 00 00 */	lwz r6, 0x0(r3)
/* 8038D550 00356B10  81 86 00 20 */	lwz r12, 0x20(r6)
/* 8038D554 00356B14  7D 89 03 A6 */	mtctr r12
/* 8038D558 00356B18  4E 80 04 21 */	bctrl
/* 8038D55C 00356B1C  80 7F 00 04 */	lwz r3, 0x4(r31)
/* 8038D560 00356B20  38 A1 00 08 */	addi r5, r1, 0x8
/* 8038D564 00356B24  38 80 00 01 */	li r4, 0x1
/* 8038D568 00356B28  80 C3 00 00 */	lwz r6, 0x0(r3)
/* 8038D56C 00356B2C  81 86 00 1C */	lwz r12, 0x1c(r6)
/* 8038D570 00356B30  7D 89 03 A6 */	mtctr r12
/* 8038D574 00356B34  4E 80 04 21 */	bctrl
.L_8038D578:
/* 8038D578 00356B38  80 7F 00 04 */	lwz r3, 0x4(r31)
/* 8038D57C 00356B3C  38 DF 00 1C */	addi r6, r31, 0x1c
/* 8038D580 00356B40  80 BF 00 18 */	lwz r5, 0x18(r31)
/* 8038D584 00356B44  38 80 00 01 */	li r4, 0x1
/* 8038D588 00356B48  80 E3 00 00 */	lwz r7, 0x0(r3)
...
.L_8038D5B8:
/* 8038D5B8 00356B78  2C 00 00 03 */	cmpwi r0, 0x3
/* 8038D5BC 00356B7C  40 82 00 4C */	bne .L_8038D608
/* 8038D5C0 00356B80  80 DF 00 28 */	lwz r6, 0x28(r31)
/* 8038D5C4 00356B84  80 1F 00 08 */	lwz r0, 0x8(r31)
/* 8038D5C8 00356B88  88 66 00 00 */	lbz r3, 0x0(r6)
/* 8038D5CC 00356B8C  50 03 40 2E */	rlwimi r3, r0, 8, 0, 23
/* 8038D5D0 00356B90  80 9F 00 0C */	lwz r4, 0xc(r31)
/* 8038D5D4 00356B94  88 06 00 01 */	lbz r0, 0x1(r6)
/* 8038D5D8 00356B98  50 60 40 2E */	rlwimi r0, r3, 8, 0, 23
/* 8038D5DC 00356B9C  88 A6 00 02 */	lbz r5, 0x2(r6)
/* 8038D5E0 00356BA0  38 C6 00 03 */	addi r6, r6, 0x3
/* 8038D5E4 00356BA4  50 05 40 2E */	rlwimi r5, r0, 8, 0, 23
...
/* 8038D5F4 00356BB4  38 03 FF FD */	addi r0, r3, -0x3
/* 8038D5F8 00356BB8  90 BF 00 08 */	stw r5, 0x8(r31)
...
.L_8038D608:
/* 8038D608 00356BC8  2C 00 00 02 */	cmpwi r0, 0x2
/* 8038D60C 00356BCC  40 82 00 44 */	bne .L_8038D650
/* 8038D610 00356BD0  80 BF 00 28 */	lwz r5, 0x28(r31)
/* 8038D614 00356BD4  80 7F 00 08 */	lwz r3, 0x8(r31)
/* 8038D618 00356BD8  88 05 00 00 */	lbz r0, 0x0(r5)
/* 8038D61C 00356BDC  80 9F 00 0C */	lwz r4, 0xc(r31)
/* 8038D620 00356BE0  50 60 40 2E */	rlwimi r0, r3, 8, 0, 23
/* 8038D624 00356BE4  88 C5 00 01 */	lbz r6, 0x1(r5)
/* 8038D628 00356BE8  38 A5 00 02 */	addi r5, r5, 0x2
/* 8038D62C 00356BEC  50 06 40 2E */	rlwimi r6, r0, 8, 0, 23
...
/* 8038D63C 00356BFC  38 03 FF FE */	addi r0, r3, -0x2
/* 8038D640 00356C00  90 DF 00 08 */	stw r6, 0x8(r31)
...
.L_8038D650:
/* 8038D650 00356C10  2C 00 00 01 */	cmpwi r0, 0x1
...
/* 8038D664 00356C24  88 C5 00 00 */	lbz r6, 0x0(r5)
/* 8038D668 00356C28  38 A5 00 01 */	addi r5, r5, 0x1
/* 8038D66C 00356C2C  80 FF 00 08 */	lwz r7, 0x8(r31)
/* 8038D670 00356C30  38 84 00 08 */	addi r4, r4, 0x8
/* 8038D674 00356C34  38 03 FF FF */	addi r0, r3, -0x1
/* 8038D678 00356C38  90 BF 00 28 */	stw r5, 0x28(r31)
/* 8038D67C 00356C3C  50 E6 40 2E */	rlwimi r6, r7, 8, 0, 23
/* 8038D680 00356C40  90 DF 00 08 */	stw r6, 0x8(r31)
...
.L_8038D690:
/* 8038D690 00356C50  2C 00 00 04 */	cmpwi r0, 0x4
/* 8038D694 00356C54  40 82 00 50 */	bne .L_8038D6E4
/* 8038D698 00356C58  80 BF 00 28 */	lwz r5, 0x28(r31)
/* 8038D69C 00356C5C  80 7F 00 08 */	lwz r3, 0x8(r31)
/* 8038D6A0 00356C60  88 05 00 00 */	lbz r0, 0x0(r5)
/* 8038D6A4 00356C64  50 60 40 2E */	rlwimi r0, r3, 8, 0, 23
/* 8038D6A8 00356C68  88 65 00 01 */	lbz r3, 0x1(r5)
/* 8038D6AC 00356C6C  50 03 40 2E */	rlwimi r3, r0, 8, 0, 23
/* 8038D6B0 00356C70  80 9F 00 0C */	lwz r4, 0xc(r31)
/* 8038D6B4 00356C74  88 05 00 02 */	lbz r0, 0x2(r5)
/* 8038D6B8 00356C78  50 60 40 2E */	rlwimi r0, r3, 8, 0, 23
/* 8038D6BC 00356C7C  88 C5 00 03 */	lbz r6, 0x3(r5)
/* 8038D6C0 00356C80  38 A5 00 04 */	addi r5, r5, 0x4
/* 8038D6C4 00356C84  50 06 40 2E */	rlwimi r6, r0, 8, 0, 23
...
/* 8038D6D4 00356C94  38 03 FF FC */	addi r0, r3, -0x4
/* 8038D6D8 00356C98  90 DF 00 08 */	stw r6, 0x8(r31)
...
/* 8038D710 00356CD0  93 C1 00 08 */	stw r30, 0x8(r1)
...
/* 8038D76C 00356D2C  93 C1 00 08 */	stw r30, 0x8(r1)
...
/* 8038D794 00356D54  38 00 00 00 */	li r0, 0x0
/* 8038D798 00356D58  90 1E 00 0C */	stw r0, 0xc(r30)
/* 8038D79C 00356D5C  38 60 00 00 */	li r3, 0x0
...
/* 8038D7B8 00356D78  80 DE 00 08 */	lwz r6, 0x8(r30)
...
/* 8038D7E4 00356DA4  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 8038D81C 00356DDC  54 04 07 7F */	clrlwi. r4, r0, 29
/* 8038D820 00356DE0  41 82 00 50 */	beq .L_8038D870
/* 8038D824 00356DE4  80 03 00 0C */	lwz r0, 0xc(r3)
/* 8038D828 00356DE8  23 A4 00 08 */	subfic r29, r4, 0x8
...
/* 8038D848 00356E08  38 00 00 00 */	li r0, 0x0
...
/* 8038D894 00356E54  38 00 00 00 */	li r0, 0x0
/* 8038D898 00356E58  90 1E 00 0C */	stw r0, 0xc(r30)
/* 8038D89C 00356E5C  3B E0 00 00 */	li r31, 0x0
...
/* 8038D8B0 00356E70  38 84 FF F4 */	addi r4, r4, -0xc
/* 8038D8B4 00356E74  80 BE 00 08 */	lwz r5, 0x8(r30)
...
/* 8038D8C8 00356E88  54 BF 05 3E */	clrlwi r31, r5, 20
.L_8038D8CC:
/* 8038D8CC 00356E8C  3B A0 00 00 */	li r29, 0x0
/* 8038D8D0 00356E90  48 00 00 8C */	b .L_8038D95C
.L_8038D8D4:
/* 8038D8D4 00356E94  57 E0 05 3E */	clrlwi r0, r31, 20
/* 8038D8D8 00356E98  28 00 0F FF */	cmplwi r0, 0xfff
/* 8038D8DC 00356E9C  40 82 00 0C */	bne .L_8038D8E8
/* 8038D8E0 00356EA0  38 60 00 01 */	li r3, 0x1
...
/* 8038D8F4 00356EB4  38 60 00 02 */	li r3, 0x2
...
/* 8038D904 00356EC4  2C 00 00 04 */	cmpwi r0, 0x4
...
/* 8038D93C 00356EFC  38 84 FF FC */	addi r4, r4, -0x4
/* 8038D940 00356F00  80 BE 00 08 */	lwz r5, 0x8(r30)
/* 8038D944 00356F04  38 03 00 04 */	addi r0, r3, 0x4
