...
/* 8037C640 00345C00  80 1F 00 00 */	lwz r0, 0x0(r31)
/* 8037C644 00345C04  90 7F 00 04 */	stw r3, 0x4(r31)
/* 8037C648 00345C08  2C 00 00 00 */	cmpwi r0, 0x0
/* 8037C64C 00345C0C  40 82 00 68 */	bne .L_8037C6B4
/* 8037C650 00345C10  38 7F 00 08 */	addi r3, r31, 0x8
/* 8037C654 00345C14  38 80 00 00 */	li r4, 0x0
...
/* 8037C664 00345C24  38 80 00 00 */	li r4, 0x0
...
/* 8037C684 00345C44  38 80 00 00 */	li r4, 0x0
/* 8037C688 00345C48  38 A0 00 20 */	li r5, 0x20
/* 8037C68C 00345C4C  4B C8 7C C5 */	bl memset
/* 8037C690 00345C50  38 80 00 00 */	li r4, 0x0
/* 8037C694 00345C54  38 60 FF FF */	li r3, -0x1
/* 8037C698 00345C58  38 00 00 01 */	li r0, 0x1
...
.L_8037C6B4:
/* 8037C6B4 00345C74  80 7F 00 00 */	lwz r3, 0x0(r31)
/* 8037C6B8 00345C78  38 03 00 01 */	addi r0, r3, 0x1
/* 8037C6BC 00345C7C  90 1F 00 00 */	stw r0, 0x0(r31)
...
/* 8037C6EC 00345CAC  80 1F 00 00 */	lwz r0, 0x0(r31)
/* 8037C6F0 00345CB0  34 00 FF FF */	addic. r0, r0, -0x1
/* 8037C6F4 00345CB4  90 1F 00 00 */	stw r0, 0x0(r31)
/* 8037C6F8 00345CB8  40 82 00 6C */	bne .L_8037C764
/* 8037C6FC 00345CBC  48 00 1A C1 */	bl ADXF_CloseAll
/* 8037C700 00345CC0  38 00 00 00 */	li r0, 0x0
/* 8037C704 00345CC4  38 60 00 01 */	li r3, 0x1
/* 8037C708 00345CC8  38 A0 FF FF */	li r5, -0x1
/* 8037C70C 00345CCC  90 7F 08 7C */	stw r3, 0x87c(r31)
/* 8037C710 00345CD0  38 7F 08 48 */	addi r3, r31, 0x848
/* 8037C714 00345CD4  38 80 00 00 */	li r4, 0x0
...
/* 8037C748 00345D08  38 80 00 00 */	li r4, 0x0
/* 8037C74C 00345D0C  38 A0 04 00 */	li r5, 0x400
/* 8037C750 00345D10  4B C8 7C 01 */	bl memset
/* 8037C754 00345D14  38 7F 00 08 */	addi r3, r31, 0x8
/* 8037C758 00345D18  38 80 00 00 */	li r4, 0x0
