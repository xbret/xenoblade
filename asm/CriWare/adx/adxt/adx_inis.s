...
/* 8037F698 00348C58  38 60 00 00 */	li r3, 0x0
...
/* 8037F6BC 00348C7C  38 60 00 00 */	li r3, 0x0
...
/* 8037F6E0 00348CA0  38 60 00 00 */	li r3, 0x0
...
/* 8037F708 00348CC8  93 C1 00 08 */	stw r30, 0x8(r1)
...
/* 8037F71C 00348CDC  80 1E 00 00 */	lwz r0, 0x0(r30)
/* 8037F720 00348CE0  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 8037F75C 00348D1C  38 80 00 00 */	li r4, 0x0
...
/* 8037F76C 00348D2C  38 80 00 00 */	li r4, 0x0
...
/* 8037F77C 00348D3C  38 80 00 00 */	li r4, 0x0
...
/* 8037F794 00348D54  38 60 00 02 */	li r3, 0x2
/* 8037F798 00348D58  38 FF 96 A8 */	addi r7, r31, lbl_805196A8@l
/* 8037F79C 00348D5C  38 80 00 01 */	li r4, 0x1
/* 8037F7A0 00348D60  38 C0 00 00 */	li r6, 0x0
...
/* 8037F7B4 00348D74  38 60 00 04 */	li r3, 0x4
/* 8037F7B8 00348D78  38 DF 00 0F */	addi r6, r31, 0xf
/* 8037F7BC 00348D7C  38 A0 00 00 */	li r5, 0x0
...
/* 8037F7D4 00348D94  38 60 00 05 */	li r3, 0x5
/* 8037F7D8 00348D98  38 A0 00 00 */	li r5, 0x0
/* 8037F7DC 00348D9C  48 01 74 19 */	bl SVM_SetCbSvrWithString
/* 8037F7E0 00348DA0  38 00 00 00 */	li r0, 0x0
/* 8037F7E4 00348DA4  90 7E 00 08 */	stw r3, 0x8(r30)
...
.L_8037F7FC:
/* 8037F7FC 00348DBC  80 7E 00 00 */	lwz r3, 0x0(r30)
/* 8037F800 00348DC0  38 03 00 01 */	addi r0, r3, 0x1
/* 8037F804 00348DC4  90 1E 00 00 */	stw r0, 0x0(r30)
/* 8037F808 00348DC8  83 E1 00 0C */	lwz r31, 0xc(r1)
/* 8037F80C 00348DCC  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 8037F840 00348E00  80 1E 00 00 */	lwz r0, 0x0(r30)
/* 8037F844 00348E04  2C 00 00 00 */	cmpwi r0, 0x0
...
.L_8037F860:
/* 8037F860 00348E20  34 00 FF FF */	addic. r0, r0, -0x1
/* 8037F864 00348E24  90 1E 00 00 */	stw r0, 0x0(r30)
...
/* 8037F884 00348E44  38 60 00 02 */	li r3, 0x2
/* 8037F888 00348E48  38 80 00 01 */	li r4, 0x1
/* 8037F88C 00348E4C  48 01 75 C5 */	bl SVM_DelCbSvr
/* 8037F890 00348E50  80 9E 00 10 */	lwz r4, 0x10(r30)
/* 8037F894 00348E54  38 60 00 04 */	li r3, 0x4
/* 8037F898 00348E58  48 01 75 B9 */	bl SVM_DelCbSvr
/* 8037F89C 00348E5C  80 9E 00 08 */	lwz r4, 0x8(r30)
/* 8037F8A0 00348E60  38 60 00 05 */	li r3, 0x5
...
/* 8037F8D4 00348E94  3B A0 00 00 */	li r29, 0x0
.L_8037F8D8:
/* 8037F8D8 00348E98  88 1E 00 00 */	lbz r0, 0x0(r30)
...
.L_8037F8F4:
/* 8037F8F4 00348EB4  3B BD 00 01 */	addi r29, r29, 0x1
