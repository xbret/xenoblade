...
/* 803919E4 0035AFA4  2C 00 00 00 */	cmpwi r0, 0x0
/* 803919E8 0035AFA8  54 80 28 34 */	slwi r0, r4, 5
/* 803919EC 0035AFAC  7F E3 02 14 */	add r31, r3, r0
/* 803919F0 0035AFB0  40 81 01 60 */	ble .L_80391B50
...
/* 80391A10 0035AFD0  2C 03 00 00 */	cmpwi r3, 0x0
/* 80391A14 0035AFD4  38 C0 00 00 */	li r6, 0x0
/* 80391A18 0035AFD8  38 E0 00 00 */	li r7, 0x0
/* 80391A1C 0035AFDC  41 82 00 94 */	beq .L_80391AB0
/* 80391A20 0035AFE0  28 03 00 08 */	cmplwi r3, 0x8
/* 80391A24 0035AFE4  38 83 FF F8 */	addi r4, r3, -0x8
/* 80391A28 0035AFE8  40 81 00 64 */	ble .L_80391A8C
/* 80391A2C 0035AFEC  38 04 00 07 */	addi r0, r4, 0x7
/* 80391A30 0035AFF0  54 00 E8 FE */	srwi r0, r0, 3
/* 80391A34 0035AFF4  7C 09 03 A6 */	mtctr r0
/* 80391A38 0035AFF8  28 04 00 00 */	cmplwi r4, 0x0
/* 80391A3C 0035AFFC  40 81 00 50 */	ble .L_80391A8C
.L_80391A40:
/* 80391A40 0035B000  7C BE 3A 14 */	add r5, r30, r7
/* 80391A44 0035B004  7C 9E 38 AE */	lbzx r4, r30, r7
/* 80391A48 0035B008  88 05 00 01 */	lbz r0, 0x1(r5)
/* 80391A4C 0035B00C  38 E7 00 08 */	addi r7, r7, 0x8
/* 80391A50 0035B010  7C C6 22 14 */	add r6, r6, r4
/* 80391A54 0035B014  88 85 00 02 */	lbz r4, 0x2(r5)
/* 80391A58 0035B018  7C C6 02 14 */	add r6, r6, r0
/* 80391A5C 0035B01C  88 05 00 03 */	lbz r0, 0x3(r5)
/* 80391A60 0035B020  7C C6 22 14 */	add r6, r6, r4
/* 80391A64 0035B024  88 85 00 04 */	lbz r4, 0x4(r5)
/* 80391A68 0035B028  7C C6 02 14 */	add r6, r6, r0
/* 80391A6C 0035B02C  88 05 00 05 */	lbz r0, 0x5(r5)
/* 80391A70 0035B030  7C C6 22 14 */	add r6, r6, r4
/* 80391A74 0035B034  88 85 00 06 */	lbz r4, 0x6(r5)
/* 80391A78 0035B038  7C C6 02 14 */	add r6, r6, r0
/* 80391A7C 0035B03C  88 05 00 07 */	lbz r0, 0x7(r5)
/* 80391A80 0035B040  7C C6 22 14 */	add r6, r6, r4
/* 80391A84 0035B044  7C C6 02 14 */	add r6, r6, r0
/* 80391A88 0035B048  42 00 FF B8 */	bdnz .L_80391A40
.L_80391A8C:
...
/* 80391A9C 0035B05C  40 80 00 14 */	bge .L_80391AB0
.L_80391AA0:
/* 80391AA0 0035B060  88 04 00 00 */	lbz r0, 0x0(r4)
/* 80391AA4 0035B064  38 84 00 01 */	addi r4, r4, 0x1
/* 80391AA8 0035B068  7C C6 02 14 */	add r6, r6, r0
/* 80391AAC 0035B06C  42 00 FF F4 */	bdnz .L_80391AA0
.L_80391AB0:
/* 80391AB0 0035B070  80 1F 00 40 */	lwz r0, 0x40(r31)
/* 80391AB4 0035B074  7C 06 00 40 */	cmplw r6, r0
/* 80391AB8 0035B078  41 82 00 1C */	beq .L_80391AD4
...
/* 80391AC8 0035B088  4C C6 31 82 */	crclr 4*cr1+eq
/* 80391ACC 0035B08C  4B FF FD 11 */	bl LSC_CallErrFunc_
/* 80391AD0 0035B090  48 00 00 80 */	b .L_80391B50
.L_80391AD4:
...
/* 80391AE0 0035B0A0  7D 00 FE 70 */	srawi r0, r8, 31
/* 80391AE4 0035B0A4  80 BF 00 44 */	lwz r5, 0x44(r31)
/* 80391AE8 0035B0A8  54 07 58 28 */	slwi r7, r0, 11
/* 80391AEC 0035B0AC  80 DF 00 48 */	lwz r6, 0x48(r31)
/* 80391AF0 0035B0B0  51 07 5D 7E */	rlwimi r7, r8, 11, 21, 31
/* 80391AF4 0035B0B4  55 08 58 28 */	slwi r8, r8, 11
...
/* 80391B30 0035B0F0  38 80 00 00 */	li r4, 0x0
...
/* 80391B40 0035B100  38 00 00 01 */	li r0, 0x1
/* 80391B44 0035B104  98 1D 00 02 */	stb r0, 0x2(r29)
/* 80391B48 0035B108  38 00 00 01 */	li r0, 0x1
...
/* 80391B80 0035B140  3B E0 00 00 */	li r31, 0x0
/* 80391B84 0035B144  3B C0 00 00 */	li r30, 0x0
/* 80391B88 0035B148  3B A0 00 00 */	li r29, 0x0
/* 80391B8C 0035B14C  3B 80 00 00 */	li r28, 0x0
/* 80391B90 0035B150  80 03 00 28 */	lwz r0, 0x28(r3)
/* 80391B94 0035B154  2C 00 00 00 */	cmpwi r0, 0x0
/* 80391B98 0035B158  41 82 00 8C */	beq .L_80391C24
/* 80391B9C 0035B15C  88 03 00 03 */	lbz r0, 0x3(r3)
/* 80391BA0 0035B160  2C 00 00 01 */	cmpwi r0, 0x1
/* 80391BA4 0035B164  40 82 00 20 */	bne .L_80391BC4
...
/* 80391BCC 0035B18C  38 84 00 01 */	addi r4, r4, 0x1
/* 80391BD0 0035B190  54 80 E0 06 */	slwi r0, r4, 28
/* 80391BD4 0035B194  34 A5 FF FF */	addic. r5, r5, -0x1
/* 80391BD8 0035B198  54 84 0F FE */	srwi r4, r4, 31
...
/* 80391BF0 0035B1B0  41 81 00 10 */	bgt .L_80391C00
/* 80391BF4 0035B1B4  48 00 0B 91 */	bl LSC_CallStatFunc
/* 80391BF8 0035B1B8  38 00 00 01 */	li r0, 0x1
/* 80391BFC 0035B1BC  98 1B 00 01 */	stb r0, 0x1(r27)
.L_80391C00:
/* 80391C00 0035B1C0  88 1B 00 03 */	lbz r0, 0x3(r27)
/* 80391C04 0035B1C4  2C 00 00 01 */	cmpwi r0, 0x1
/* 80391C08 0035B1C8  40 82 00 1C */	bne .L_80391C24
...
/* 80391C4C 0035B20C  93 C1 00 08 */	stw r30, 0x8(r1)
/* 80391C50 0035B210  88 03 00 04 */	lbz r0, 0x4(r3)
/* 80391C54 0035B214  2C 00 00 01 */	cmpwi r0, 0x1
/* 80391C58 0035B218  41 82 00 E8 */	beq .L_80391D40
/* 80391C5C 0035B21C  88 03 00 01 */	lbz r0, 0x1(r3)
/* 80391C60 0035B220  2C 00 00 02 */	cmpwi r0, 0x2
/* 80391C64 0035B224  40 82 00 DC */	bne .L_80391D40
/* 80391C68 0035B228  80 03 00 24 */	lwz r0, 0x24(r3)
/* 80391C6C 0035B22C  2C 00 00 00 */	cmpwi r0, 0x0
/* 80391C70 0035B230  40 81 00 D0 */	ble .L_80391D40
...
/* 80391C84 0035B244  2C 00 00 01 */	cmpwi r0, 0x1
/* 80391C88 0035B248  40 82 00 78 */	bne .L_80391D00
/* 80391C8C 0035B24C  80 63 00 28 */	lwz r3, 0x28(r3)
/* 80391C90 0035B250  2C 03 00 00 */	cmpwi r3, 0x0
/* 80391C94 0035B254  40 82 00 1C */	bne .L_80391CB0
...
/* 80391CA4 0035B264  4C C6 31 82 */	crclr 4*cr1+eq
/* 80391CA8 0035B268  4B FF FB 35 */	bl LSC_CallErrFunc_
/* 80391CAC 0035B26C  48 00 00 54 */	b .L_80391D00
.L_80391CB0:
/* 80391CB0 0035B270  4B FE F8 21 */	bl ADXSTM_GetStat
/* 80391CB4 0035B274  2C 03 00 03 */	cmpwi r3, 0x3
/* 80391CB8 0035B278  41 82 00 38 */	beq .L_80391CF0
/* 80391CBC 0035B27C  40 80 00 10 */	bge .L_80391CCC
/* 80391CC0 0035B280  2C 03 00 02 */	cmpwi r3, 0x2
/* 80391CC4 0035B284  40 80 00 1C */	bge .L_80391CE0
/* 80391CC8 0035B288  48 00 00 38 */	b .L_80391D00
.L_80391CCC:
/* 80391CCC 0035B28C  2C 03 00 05 */	cmpwi r3, 0x5
/* 80391CD0 0035B290  40 80 00 30 */	bge .L_80391D00
/* 80391CD4 0035B294  38 00 00 03 */	li r0, 0x3
/* 80391CD8 0035B298  98 1F 00 01 */	stb r0, 0x1(r31)
/* 80391CDC 0035B29C  48 00 00 24 */	b .L_80391D00
.L_80391CE0:
...
/* 80391CEC 0035B2AC  48 00 00 14 */	b .L_80391D00
.L_80391CF0:
/* 80391CF0 0035B2B0  80 7F 00 2C */	lwz r3, 0x2c(r31)
/* 80391CF4 0035B2B4  38 00 00 02 */	li r0, 0x2
...
/* 80391D10 0035B2D0  2C 00 00 02 */	cmpwi r0, 0x2
/* 80391D14 0035B2D4  40 82 00 0C */	bne .L_80391D20
...
/* 80391D30 0035B2F0  2C 00 00 00 */	cmpwi r0, 0x0
/* 80391D34 0035B2F4  40 82 00 0C */	bne .L_80391D40
...
/* 80391D48 0035B308  83 C1 00 08 */	lwz r30, 0x8(r1)
