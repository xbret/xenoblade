...
/* 803BE8DC 00387E9C  93 C1 00 08 */	stw r30, 0x8(r1)
/* 803BE8E0 00387EA0  7C 7E 1B 78 */	mr r30, r3
/* 803BE8E4 00387EA4  48 00 25 21 */	bl SFLIB_CheckHn
/* 803BE8E8 00387EA8  2C 03 00 00 */	cmpwi r3, 0x0
/* 803BE8EC 00387EAC  41 82 00 18 */	beq .L_803BE904
/* 803BE8F0 00387EB0  3C 80 FF 00 */	lis r4, 0xff00
/* 803BE8F4 00387EB4  38 60 00 00 */	li r3, 0x0
/* 803BE8F8 00387EB8  38 84 01 A3 */	addi r4, r4, 0x1a3
...
/* 803BE908 00387EC8  38 80 00 06 */	li r4, 0x6
/* 803BE90C 00387ECC  48 00 DD 69 */	bl SFSET_GetCond
/* 803BE910 00387ED0  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 803BE938 00387EF8  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 803BE960 00387F20  2C 03 00 00 */	cmpwi r3, 0x0
/* 803BE964 00387F24  41 82 00 1C */	beq .L_803BE980
/* 803BE968 00387F28  3C 80 FF 00 */	lis r4, 0xff00
/* 803BE96C 00387F2C  38 60 00 00 */	li r3, 0x0
/* 803BE970 00387F30  38 84 01 A4 */	addi r4, r4, 0x1a4
/* 803BE974 00387F34  48 00 22 E1 */	bl SFLIB_SetErr
/* 803BE978 00387F38  38 60 00 00 */	li r3, 0x0
/* 803BE97C 00387F3C  48 00 00 34 */	b .L_803BE9B0
.L_803BE980:
/* 803BE980 00387F40  7F E3 FB 78 */	mr r3, r31
/* 803BE984 00387F44  38 80 00 06 */	li r4, 0x6
/* 803BE988 00387F48  48 00 DC ED */	bl SFSET_GetCond
/* 803BE98C 00387F4C  2C 03 00 00 */	cmpwi r3, 0x0
/* 803BE990 00387F50  40 82 00 0C */	bne .L_803BE99C
/* 803BE994 00387F54  38 60 00 00 */	li r3, 0x0
...
/* 803BE9E0 00387FA0  38 80 00 06 */	li r4, 0x6
...
/* 803BE9F0 00387FB0  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 803BEA00 00387FC0  2C 0C 00 00 */	cmpwi r12, 0x0
...
/* 803BEA38 00387FF8  38 60 00 00 */	li r3, 0x0
/* 803BEA3C 00387FFC  4E 80 00 20 */	blr
.endfn SFAOAP_Init

.fn SFAOAP_Finish, global
/* 803BEA40 00388000  38 60 00 00 */	li r3, 0x0
...
/* 803BEA50 00388010  38 80 00 06 */	li r4, 0x6
...
/* 803BEACC 0038808C  2C 03 00 01 */	cmpwi r3, 0x1
/* 803BEAD0 00388090  40 82 00 14 */	bne .L_803BEAE4
/* 803BEAD4 00388094  7F E3 FB 78 */	mr r3, r31
/* 803BEAD8 00388098  38 80 00 07 */	li r4, 0x7
/* 803BEADC 0038809C  38 A0 00 01 */	li r5, 0x1
/* 803BEAE0 003880A0  48 00 FF 39 */	bl SFTRN_SetTermFlg
.L_803BEAE4:
/* 803BEAE4 003880A4  38 60 00 00 */	li r3, 0x0
.L_803BEAE8:
...
/* 803BEB04 003880C4  38 80 00 06 */	li r4, 0x6
...
/* 803BEB48 00388108  38 60 00 00 */	li r3, 0x0
...
/* 803BEB58 00388118  38 80 00 06 */	li r4, 0x6
...
/* 803BEB68 00388128  38 60 00 00 */	li r3, 0x0
...
/* 803BEB80 00388140  38 80 00 06 */	li r4, 0x6
...
/* 803BEB94 00388154  2C 03 00 00 */	cmpwi r3, 0x0
/* 803BEB98 00388158  40 82 00 0C */	bne .L_803BEBA4
/* 803BEB9C 0038815C  38 60 00 00 */	li r3, 0x0
/* 803BEBA0 00388160  48 00 00 30 */	b .L_803BEBD0
.L_803BEBA4:
/* 803BEBA4 00388164  7F E3 FB 78 */	mr r3, r31
/* 803BEBA8 00388168  38 80 00 03 */	li r4, 0x3
/* 803BEBAC 0038816C  38 A0 00 06 */	li r5, 0x6
/* 803BEBB0 00388170  38 C0 00 00 */	li r6, 0x0
/* 803BEBB4 00388174  38 E0 00 00 */	li r7, 0x0
/* 803BEBB8 00388178  48 00 FE 05 */	bl SFTRN_CallTrtTrif
/* 803BEBBC 0038817C  2C 03 00 00 */	cmpwi r3, 0x0
/* 803BEBC0 00388180  38 00 00 00 */	li r0, 0x0
...
/* 803BEBEC 003881AC  38 80 00 06 */	li r4, 0x6
...
/* 803BEC00 003881C0  2C 03 00 00 */	cmpwi r3, 0x0
/* 803BEC04 003881C4  40 82 00 0C */	bne .L_803BEC10
/* 803BEC08 003881C8  38 60 00 00 */	li r3, 0x0
/* 803BEC0C 003881CC  48 00 00 30 */	b .L_803BEC3C
.L_803BEC10:
/* 803BEC10 003881D0  7F E3 FB 78 */	mr r3, r31
/* 803BEC14 003881D4  38 80 00 03 */	li r4, 0x3
/* 803BEC18 003881D8  38 A0 00 07 */	li r5, 0x7
/* 803BEC1C 003881DC  38 C0 00 00 */	li r6, 0x0
/* 803BEC20 003881E0  38 E0 00 00 */	li r7, 0x0
/* 803BEC24 003881E4  48 00 FD 99 */	bl SFTRN_CallTrtTrif
/* 803BEC28 003881E8  2C 03 00 00 */	cmpwi r3, 0x0
/* 803BEC2C 003881EC  38 00 00 00 */	li r0, 0x0
...
/* 803BEC64 00388224  38 80 00 06 */	li r4, 0x6
/* 803BEC68 00388228  93 C1 00 08 */	stw r30, 0x8(r1)
/* 803BEC6C 0038822C  7C 7E 1B 78 */	mr r30, r3
/* 803BEC70 00388230  48 00 DA 05 */	bl SFSET_GetCond
/* 803BEC74 00388234  2C 03 00 00 */	cmpwi r3, 0x0
/* 803BEC78 00388238  40 82 00 0C */	bne .L_803BEC84
/* 803BEC7C 0038823C  38 60 00 00 */	li r3, 0x0
/* 803BEC80 00388240  48 00 00 30 */	b .L_803BECB0
.L_803BEC84:
/* 803BEC84 00388244  7F C3 F3 78 */	mr r3, r30
/* 803BEC88 00388248  7F E6 FB 78 */	mr r6, r31
/* 803BEC8C 0038824C  38 80 00 03 */	li r4, 0x3
/* 803BEC90 00388250  38 A0 00 08 */	li r5, 0x8
/* 803BEC94 00388254  38 E0 00 00 */	li r7, 0x0
/* 803BEC98 00388258  48 00 FD 25 */	bl SFTRN_CallTrtTrif
/* 803BEC9C 0038825C  2C 03 00 00 */	cmpwi r3, 0x0
/* 803BECA0 00388260  38 00 00 00 */	li r0, 0x0
...
/* 803BECB8 00388278  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 803BECC8 00388288  3C 80 FF 00 */	lis r4, 0xff00
/* 803BECCC 0038828C  38 84 0A 01 */	addi r4, r4, 0xa01
/* 803BECD0 00388290  48 00 1F 84 */	b SFLIB_SetErr
.endfn SFAOAP_GetWrite

.fn SFAOAP_AddWrite, global
/* 803BECD4 00388294  3C 80 FF 00 */	lis r4, 0xff00
/* 803BECD8 00388298  38 84 0A 01 */	addi r4, r4, 0xa01
/* 803BECDC 0038829C  48 00 1F 78 */	b SFLIB_SetErr
.endfn SFAOAP_AddWrite

.fn SFAOAP_GetRead, global
/* 803BECE0 003882A0  3C 80 FF 00 */	lis r4, 0xff00
/* 803BECE4 003882A4  38 84 0A 01 */	addi r4, r4, 0xa01
/* 803BECE8 003882A8  48 00 1F 6C */	b SFLIB_SetErr
.endfn SFAOAP_GetRead

.fn SFAOAP_AddRead, global
/* 803BECEC 003882AC  3C 80 FF 00 */	lis r4, 0xff00
/* 803BECF0 003882B0  38 84 0A 01 */	addi r4, r4, 0xa01
/* 803BECF4 003882B4  48 00 1F 60 */	b SFLIB_SetErr
.endfn SFAOAP_AddRead

.fn SFAOAP_Seek, global
/* 803BECF8 003882B8  38 60 00 00 */	li r3, 0x0
