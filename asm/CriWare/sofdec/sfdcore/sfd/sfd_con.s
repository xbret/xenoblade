.include "macros.inc"
.file "CriWare/sofdec/sfdcore/sfd/sfd_con.o"

# 0x803BFD38 - 0x803C005C
.text
.balign 4
...
/* 803BFD50 00389310  2C 03 00 00 */	cmpwi r3, 0x0
/* 803BFD54 00389314  41 82 00 18 */	beq .L_803BFD6C
/* 803BFD58 00389318  3C 80 FF 00 */	lis r4, 0xff00
/* 803BFD5C 0038931C  38 60 00 00 */	li r3, 0x0
/* 803BFD60 00389320  38 84 01 61 */	addi r4, r4, 0x161
...
/* 803BFD74 00389334  38 A0 00 01 */	li r5, 0x1
/* 803BFD78 00389338  48 00 C7 BD */	bl SFSET_SetCond
/* 803BFD7C 0038933C  38 60 00 00 */	li r3, 0x0
.L_803BFD80:
...
/* 803BFDB0 00389370  54 03 0F FE */	srwi r3, r0, 31
...
/* 803BFDE0 003893A0  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 803BFDF4 003893B4  2C 03 00 00 */	cmpwi r3, 0x0
/* 803BFDF8 003893B8  41 82 00 0C */	beq .L_803BFE04
.L_803BFDFC:
/* 803BFDFC 003893BC  38 60 00 01 */	li r3, 0x1
/* 803BFE00 003893C0  48 00 00 08 */	b .L_803BFE08
.L_803BFE04:
/* 803BFE04 003893C4  38 60 00 00 */	li r3, 0x0
.L_803BFE08:
...
/* 803BFE38 003893F8  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 803BFE4C 0038940C  2C 03 00 00 */	cmpwi r3, 0x0
/* 803BFE50 00389410  41 82 00 0C */	beq .L_803BFE5C
.L_803BFE54:
/* 803BFE54 00389414  38 60 00 01 */	li r3, 0x1
/* 803BFE58 00389418  48 00 00 08 */	b .L_803BFE60
.L_803BFE5C:
/* 803BFE5C 0038941C  38 60 00 00 */	li r3, 0x0
.L_803BFE60:
...
/* 803BFE88 00389448  38 61 00 08 */	addi r3, r1, 0x8
...
/* 803BFE9C 0038945C  38 61 00 08 */	addi r3, r1, 0x8
/* 803BFEA0 00389460  80 9F 01 64 */	lwz r4, 0x164(r31)
/* 803BFEA4 00389464  38 A5 00 01 */	addi r5, r5, 0x1
/* 803BFEA8 00389468  7C C4 F2 14 */	add r6, r4, r30
/* 803BFEAC 0038946C  54 A0 D8 08 */	slwi r0, r5, 27
/* 803BFEB0 00389470  54 A4 0F FE */	srwi r4, r5, 31
...
/* 803BFF04 003894C4  38 61 00 08 */	addi r3, r1, 0x8
...
/* 803BFF30 003894F0  3B C0 00 00 */	li r30, 0x0
/* 803BFF34 003894F4  48 00 00 44 */	b .L_803BFF78
.L_803BFF38:
/* 803BFF38 003894F8  54 60 D8 08 */	slwi r0, r3, 27
/* 803BFF3C 003894FC  54 63 0F FE */	srwi r3, r3, 31
...
/* 803BFF4C 0038950C  3B C0 00 01 */	li r30, 0x1
...
/* 803BFF68 00389528  38 63 00 01 */	addi r3, r3, 0x1
...
.L_803BFF78:
/* 803BFF78 00389538  38 61 00 08 */	addi r3, r1, 0x8
...
/* 803BFFBC 0038957C  38 61 00 08 */	addi r3, r1, 0x8
...
/* 803BFFE0 003895A0  38 00 FF FF */	li r0, -0x1
/* 803BFFE4 003895A4  3B A0 00 00 */	li r29, 0x0
/* 803BFFE8 003895A8  90 1F 00 00 */	stw r0, 0x0(r31)
/* 803BFFEC 003895AC  48 00 00 44 */	b .L_803C0030
.L_803BFFF0:
/* 803BFFF0 003895B0  80 1E 01 EC */	lwz r0, 0x1ec(r30)
/* 803BFFF4 003895B4  3B A0 00 01 */	li r29, 0x1
/* 803BFFF8 003895B8  90 1C 00 00 */	stw r0, 0x0(r28)
/* 803BFFFC 003895BC  80 7E 01 FC */	lwz r3, 0x1fc(r30)
/* 803C0000 003895C0  54 60 D8 08 */	slwi r0, r3, 27
/* 803C0004 003895C4  54 63 0F FE */	srwi r3, r3, 31
...
/* 803C0020 003895E0  90 1F 00 00 */	stw r0, 0x0(r31)
/* 803C0024 003895E4  80 7E 01 FC */	lwz r3, 0x1fc(r30)
/* 803C0028 003895E8  38 03 00 01 */	addi r0, r3, 0x1
/* 803C002C 003895EC  90 1E 01 FC */	stw r0, 0x1fc(r30)
.L_803C0030:
/* 803C0030 003895F0  38 61 00 08 */	addi r3, r1, 0x8
