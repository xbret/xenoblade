.include "macros.inc"
.file "CriWare/sofdec/sfdcore/sfd/sfd_pts.o"

# 0x803CB858 - 0x803CBC88
.text
.balign 4

.fn SFPTS_InitPtsQue, global
/* 803CB858 00394E18  38 00 00 00 */	li r0, 0x0
/* 803CB85C 00394E1C  90 03 00 00 */	stw r0, 0x0(r3)
/* 803CB860 00394E20  90 03 00 04 */	stw r0, 0x4(r3)
/* 803CB864 00394E24  90 03 00 08 */	stw r0, 0x8(r3)
...
/* 803CB874 00394E34  38 00 00 00 */	li r0, 0x0
/* 803CB878 00394E38  90 03 00 08 */	stw r0, 0x8(r3)
...
/* 803CB890 00394E50  2C 04 00 00 */	cmpwi r4, 0x0
...
/* 803CB8B8 00394E78  2C 05 00 00 */	cmpwi r5, 0x0
/* 803CB8BC 00394E7C  41 81 00 0C */	bgt .L_803CB8C8
.L_803CB8C0:
/* 803CB8C0 00394E80  38 60 00 00 */	li r3, 0x0
/* 803CB8C4 00394E84  48 00 00 68 */	b .L_803CB92C
.L_803CB8C8:
/* 803CB8C8 00394E88  4B FF 55 3D */	bl SFLIB_CheckHn
/* 803CB8CC 00394E8C  2C 03 00 00 */	cmpwi r3, 0x0
/* 803CB8D0 00394E90  41 82 00 18 */	beq .L_803CB8E8
/* 803CB8D4 00394E94  3C 80 FF 00 */	lis r4, 0xff00
/* 803CB8D8 00394E98  38 60 00 00 */	li r3, 0x0
/* 803CB8DC 00394E9C  38 84 01 65 */	addi r4, r4, 0x165
/* 803CB8E0 00394EA0  4B FF 53 75 */	bl SFLIB_SetErr
/* 803CB8E4 00394EA4  48 00 00 48 */	b .L_803CB92C
.L_803CB8E8:
/* 803CB8E8 00394EA8  38 1D 00 07 */	addi r0, r29, 0x7
/* 803CB8EC 00394EAC  38 80 00 00 */	li r4, 0x0
/* 803CB8F0 00394EB0  54 1E 00 38 */	clrrwi r30, r0, 3
...
/* 803CB94C 00394F0C  38 E0 00 00 */	li r7, 0x0
/* 803CB950 00394F10  90 E6 00 00 */	stw r7, 0x0(r6)
/* 803CB954 00394F14  6C E8 80 00 */	xoris r8, r7, 0x8000
/* 803CB958 00394F18  81 45 00 00 */	lwz r10, 0x0(r5)
/* 803CB95C 00394F1C  81 65 00 04 */	lwz r11, 0x4(r5)
...
/* 803CB978 00394F38  38 60 00 00 */	li r3, 0x0
...
/* 803CB98C 00394F4C  2C 08 00 00 */	cmpwi r8, 0x0
/* 803CB990 00394F50  40 82 00 0C */	bne .L_803CB99C
/* 803CB994 00394F54  38 60 00 00 */	li r3, 0x0
...
/* 803CB9AC 00394F6C  38 00 00 01 */	li r0, 0x1
/* 803CB9B0 00394F70  38 80 FF FF */	li r4, -0x1
/* 803CB9B4 00394F74  90 06 00 00 */	stw r0, 0x0(r6)
...
/* 803CB9C4 00394F84  38 07 00 01 */	addi r0, r7, 0x1
/* 803CB9C8 00394F88  7D 48 21 6E */	stwux r10, r8, r4
/* 803CB9CC 00394F8C  91 68 00 04 */	stw r11, 0x4(r8)
/* 803CB9D0 00394F90  80 E5 00 08 */	lwz r7, 0x8(r5)
/* 803CB9D4 00394F94  80 85 00 0C */	lwz r4, 0xc(r5)
/* 803CB9D8 00394F98  90 E8 00 08 */	stw r7, 0x8(r8)
...
/* 803CB9F8 00394FB8  38 84 00 01 */	addi r4, r4, 0x1
...
/* 803CBA10 00394FD0  38 00 00 01 */	li r0, 0x1
/* 803CBA14 00394FD4  90 06 00 00 */	stw r0, 0x0(r6)
/* 803CBA18 00394FD8  48 00 00 0C */	b .L_803CBA24
.L_803CBA1C:
/* 803CBA1C 00394FDC  38 00 00 00 */	li r0, 0x0
/* 803CBA20 00394FE0  90 06 00 00 */	stw r0, 0x0(r6)
.L_803CBA24:
/* 803CBA24 00394FE4  38 80 00 00 */	li r4, 0x0
.L_803CBA28:
/* 803CBA28 00394FE8  2C 04 FF FF */	cmpwi r4, -0x1
/* 803CBA2C 00394FEC  40 82 00 10 */	bne .L_803CBA3C
/* 803CBA30 00394FF0  3C 80 FF 00 */	lis r4, 0xff00
/* 803CBA34 00394FF4  38 84 04 21 */	addi r4, r4, 0x421
/* 803CBA38 00394FF8  4B FF 52 1C */	b SFLIB_SetErr
.L_803CBA3C:
/* 803CBA3C 00394FFC  38 60 00 00 */	li r3, 0x0
...
/* 803CBAB0 00395070  80 04 00 04 */	lwz r0, 0x4(r4)
/* 803CBAB4 00395074  90 66 00 00 */	stw r3, 0x0(r6)
/* 803CBAB8 00395078  90 06 00 04 */	stw r0, 0x4(r6)
/* 803CBABC 0039507C  80 64 00 08 */	lwz r3, 0x8(r4)
/* 803CBAC0 00395080  80 04 00 0C */	lwz r0, 0xc(r4)
/* 803CBAC4 00395084  90 66 00 08 */	stw r3, 0x8(r6)
/* 803CBAC8 00395088  90 06 00 0C */	stw r0, 0xc(r6)
/* 803CBACC 0039508C  80 7F 00 10 */	lwz r3, 0x10(r31)
/* 803CBAD0 00395090  80 1F 00 04 */	lwz r0, 0x4(r31)
/* 803CBAD4 00395094  38 63 00 01 */	addi r3, r3, 0x1
...
/* 803CBAEC 003950AC  80 7F 00 08 */	lwz r3, 0x8(r31)
/* 803CBAF0 003950B0  38 03 FF FF */	addi r0, r3, -0x1
/* 803CBAF4 003950B4  90 1F 00 08 */	stw r0, 0x8(r31)
...
.L_803CBB0C:
/* 803CBB0C 003950CC  80 1F 00 08 */	lwz r0, 0x8(r31)
/* 803CBB10 003950D0  2C 00 00 00 */	cmpwi r0, 0x0
...
.L_803CBB50:
/* 803CBB50 00395110  80 9F 00 08 */	lwz r4, 0x8(r31)
/* 803CBB54 00395114  54 A0 20 36 */	slwi r0, r5, 4
/* 803CBB58 00395118  7C 63 20 50 */	subf r3, r3, r4
/* 803CBB5C 0039511C  90 7F 00 08 */	stw r3, 0x8(r31)
/* 803CBB60 00395120  90 BF 00 10 */	stw r5, 0x10(r31)
/* 803CBB64 00395124  80 7F 00 00 */	lwz r3, 0x0(r31)
/* 803CBB68 00395128  7C 83 02 14 */	add r4, r3, r0
/* 803CBB6C 0039512C  7C 63 00 2E */	lwzx r3, r3, r0
/* 803CBB70 00395130  80 04 00 04 */	lwz r0, 0x4(r4)
/* 803CBB74 00395134  90 7E 00 00 */	stw r3, 0x0(r30)
/* 803CBB78 00395138  90 1E 00 04 */	stw r0, 0x4(r30)
/* 803CBB7C 0039513C  80 64 00 08 */	lwz r3, 0x8(r4)
/* 803CBB80 00395140  80 04 00 0C */	lwz r0, 0xc(r4)
/* 803CBB84 00395144  90 7E 00 08 */	stw r3, 0x8(r30)
/* 803CBB88 00395148  90 1E 00 0C */	stw r0, 0xc(r30)
.L_803CBB8C:
/* 803CBB8C 0039514C  38 60 00 00 */	li r3, 0x0
.L_803CBB90:
/* 803CBB90 00395150  80 01 00 14 */	lwz r0, 0x14(r1)
/* 803CBB94 00395154  83 E1 00 0C */	lwz r31, 0xc(r1)
/* 803CBB98 00395158  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 803CBBA8 00395168  80 03 00 08 */	lwz r0, 0x8(r3)
/* 803CBBAC 0039516C  7D 65 32 14 */	add r11, r5, r6
/* 803CBBB0 00395170  81 43 00 04 */	lwz r10, 0x4(r3)
/* 803CBBB4 00395174  39 20 00 00 */	li r9, 0x0
/* 803CBBB8 00395178  81 03 00 10 */	lwz r8, 0x10(r3)
/* 803CBBBC 0039517C  7C 09 03 A6 */	mtctr r0
/* 803CBBC0 00395180  2C 00 00 00 */	cmpwi r0, 0x0
/* 803CBBC4 00395184  40 81 00 84 */	ble .L_803CBC48
.L_803CBBC8:
/* 803CBBC8 00395188  80 E3 00 00 */	lwz r7, 0x0(r3)
/* 803CBBCC 0039518C  55 00 20 36 */	slwi r0, r8, 4
/* 803CBBD0 00395190  7C E7 02 14 */	add r7, r7, r0
/* 803CBBD4 00395194  81 87 00 08 */	lwz r12, 0x8(r7)
...
.L_803CBC2C:
/* 803CBC2C 003951EC  38 08 00 01 */	addi r0, r8, 0x1
...
.L_803CBC40:
/* 803CBC40 00395200  39 29 00 01 */	addi r9, r9, 0x1
/* 803CBC44 00395204  42 00 FF 84 */	bdnz .L_803CBBC8
.L_803CBC48:
/* 803CBC48 00395208  38 60 FF FF */	li r3, -0x1
...
/* 803CBC5C 0039521C  2C 00 00 00 */	cmpwi r0, 0x0
/* 803CBC60 00395220  40 82 00 0C */	bne .L_803CBC6C
/* 803CBC64 00395224  38 60 00 00 */	li r3, 0x0
...
/* 803CBC74 00395234  7C A4 FE 70 */	srawi r4, r5, 31
/* 803CBC78 00395238  54 03 0F FE */	srwi r3, r0, 31
