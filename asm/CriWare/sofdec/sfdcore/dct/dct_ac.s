...
/* 803B9AF4 003830B4  90 7D 00 00 */	stw r3, 0x0(r29)
/* 803B9AF8 003830B8  3B 7D 00 08 */	addi r27, r29, 0x8
...
/* 803B9B08 003830C8  3A E0 00 00 */	li r23, 0x0
/* 803B9B0C 003830CC  CB FC 00 08 */	lfd f31, 0x8(r28)
/* 803B9B10 003830D0  3B 40 00 00 */	li r26, 0x0
/* 803B9B14 003830D4  3F E0 43 30 */	lis r31, 0x4330
.L_803B9B18:
/* 803B9B18 003830D8  2C 17 00 00 */	cmpwi r23, 0x0
/* 803B9B1C 003830DC  40 82 00 0C */	bne .L_803B9B28
/* 803B9B20 003830E0  CB 9C 00 00 */	lfd f28, 0x0(r28)
/* 803B9B24 003830E4  48 00 00 08 */	b .L_803B9B2C
.L_803B9B28:
/* 803B9B28 003830E8  CB 9C 00 08 */	lfd f28, 0x8(r28)
.L_803B9B2C:
...
/* 803B9B38 003830F8  3A C0 00 00 */	li r22, 0x0
.L_803B9B3C:
/* 803B9B3C 003830FC  93 C1 00 0C */	stw r30, 0xc(r1)
/* 803B9B40 00383100  6E C0 80 00 */	xoris r0, r22, 0x8000
/* 803B9B44 00383104  93 E1 00 08 */	stw r31, 0x8(r1)
/* 803B9B48 00383108  C8 01 00 08 */	lfd f0, 0x8(r1)
...
/* 803B9B74 00383134  3A D6 00 01 */	addi r22, r22, 0x1
/* 803B9B78 00383138  2C 16 00 08 */	cmpwi r22, 0x8
/* 803B9B7C 0038313C  D8 19 00 00 */	stfd f0, 0x0(r25)
/* 803B9B80 00383140  3B 39 00 08 */	addi r25, r25, 0x8
/* 803B9B84 00383144  D8 18 00 00 */	stfd f0, 0x0(r24)
/* 803B9B88 00383148  3B 18 00 40 */	addi r24, r24, 0x40
/* 803B9B8C 0038314C  41 80 FF B0 */	blt .L_803B9B3C
/* 803B9B90 00383150  3A F7 00 01 */	addi r23, r23, 0x1
/* 803B9B94 00383154  3B 5A 00 08 */	addi r26, r26, 0x8
/* 803B9B98 00383158  2C 17 00 08 */	cmpwi r23, 0x8
...
/* 803B9BDC 0038319C  39 80 00 00 */	li r12, 0x0
/* 803B9BE0 003831A0  38 C0 00 00 */	li r6, 0x0
/* 803B9BE4 003831A4  3C E0 80 52 */	lis r7, lbl_8051F920@ha
/* 803B9BE8 003831A8  38 00 00 04 */	li r0, 0x4
.L_803B9BEC:
/* 803B9BEC 003831AC  39 21 00 08 */	addi r9, r1, 0x8
/* 803B9BF0 003831B0  7D 43 32 14 */	add r10, r3, r6
/* 803B9BF4 003831B4  7D 29 32 14 */	add r9, r9, r6
/* 803B9BF8 003831B8  39 00 00 00 */	li r8, 0x0
...
/* 803B9C0C 003831CC  39 08 00 08 */	addi r8, r8, 0x8
/* 803B9C10 003831D0  CB EA 00 00 */	lfd f31, 0x0(r10)
/* 803B9C14 003831D4  C9 AB 00 40 */	lfd f13, 0x40(r11)
/* 803B9C18 003831D8  FF BE EF FA */	fmadd f29, f30, f31, f29
/* 803B9C1C 003831DC  C9 8A 00 08 */	lfd f12, 0x8(r10)
...
/* 803B9C60 00383220  39 08 00 08 */	addi r8, r8, 0x8
...
/* 803B9C94 00383254  DB A9 00 00 */	stfd f29, 0x0(r9)
...
/* 803B9CBC 0038327C  DB A9 00 08 */	stfd f29, 0x8(r9)
/* 803B9CC0 00383280  39 29 00 10 */	addi r9, r9, 0x10
/* 803B9CC4 00383284  42 00 FF 3C */	bdnz .L_803B9C00
/* 803B9CC8 00383288  39 8C 00 01 */	addi r12, r12, 0x1
/* 803B9CCC 0038328C  38 C6 00 40 */	addi r6, r6, 0x40
/* 803B9CD0 00383290  2C 0C 00 08 */	cmpwi r12, 0x8
/* 803B9CD4 00383294  41 80 FF 18 */	blt .L_803B9BEC
/* 803B9CD8 00383298  39 60 00 00 */	li r11, 0x0
/* 803B9CDC 0038329C  38 60 00 00 */	li r3, 0x0
/* 803B9CE0 003832A0  3C E0 80 52 */	lis r7, lbl_8051F920@ha
/* 803B9CE4 003832A4  38 00 00 04 */	li r0, 0x4
.L_803B9CE8:
/* 803B9CE8 003832A8  39 21 00 08 */	addi r9, r1, 0x8
/* 803B9CEC 003832AC  7D A9 1C EE */	lfdux f13, r9, r3
/* 803B9CF0 003832B0  7D 44 1A 14 */	add r10, r4, r3
/* 803B9CF4 003832B4  39 00 00 00 */	li r8, 0x0
/* 803B9CF8 003832B8  38 C0 00 00 */	li r6, 0x0
...
/* 803B9D28 003832E8  39 08 00 08 */	addi r8, r8, 0x8
...
/* 803B9D7C 0038333C  39 08 00 08 */	addi r8, r8, 0x8
...
/* 803B9DC8 00383388  39 6B 00 01 */	addi r11, r11, 0x1
/* 803B9DCC 0038338C  38 63 00 08 */	addi r3, r3, 0x8
/* 803B9DD0 00383390  2C 0B 00 08 */	cmpwi r11, 0x8
