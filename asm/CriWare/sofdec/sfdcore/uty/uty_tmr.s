...
/* 803D4708 0039DCC8  38 81 00 08 */	addi r4, r1, 0x8
...
/* 803D4728 0039DCE8  2C 03 00 00 */	cmpwi r3, 0x0
/* 803D472C 0039DCEC  40 82 00 08 */	bne .L_803D4734
/* 803D4730 0039DCF0  83 C1 00 08 */	lwz r30, 0x8(r1)
.L_803D4734:
/* 803D4734 0039DCF4  80 7F 00 00 */	lwz r3, 0x0(r31)
/* 803D4738 0039DCF8  38 03 00 01 */	addi r0, r3, 0x1
/* 803D473C 0039DCFC  90 1F 00 00 */	stw r0, 0x0(r31)
/* 803D4740 0039DD00  80 1F 00 00 */	lwz r0, 0x0(r31)
/* 803D4744 0039DD04  2C 00 00 01 */	cmpwi r0, 0x1
/* 803D4748 0039DD08  40 81 00 10 */	ble .L_803D4758
/* 803D474C 0039DD0C  80 1F 00 04 */	lwz r0, 0x4(r31)
/* 803D4750 0039DD10  7C 00 F0 00 */	cmpw r0, r30
/* 803D4754 0039DD14  41 82 00 44 */	beq .L_803D4798
.L_803D4758:
/* 803D4758 0039DD18  2C 1E FF FF */	cmpwi r30, -0x1
/* 803D475C 0039DD1C  93 DF 00 04 */	stw r30, 0x4(r31)
/* 803D4760 0039DD20  40 82 00 1C */	bne .L_803D477C
/* 803D4764 0039DD24  38 00 00 00 */	li r0, 0x0
/* 803D4768 0039DD28  38 7F 00 08 */	addi r3, r31, 0x8
/* 803D476C 0039DD2C  38 80 00 01 */	li r4, 0x1
/* 803D4770 0039DD30  90 1F 00 08 */	stw r0, 0x8(r31)
/* 803D4774 0039DD34  90 83 00 04 */	stw r4, 0x4(r3)
/* 803D4778 0039DD38  48 00 00 20 */	b .L_803D4798
.L_803D477C:
/* 803D477C 0039DD3C  3C 80 80 00 */	lis r4, 0x8000
/* 803D4780 0039DD40  38 7F 00 08 */	addi r3, r31, 0x8
/* 803D4784 0039DD44  80 84 00 F8 */	lwz r4, 0xf8(r4)
/* 803D4788 0039DD48  38 00 00 00 */	li r0, 0x0
/* 803D478C 0039DD4C  54 84 F0 BE */	srwi r4, r4, 2
/* 803D4790 0039DD50  90 1F 00 08 */	stw r0, 0x8(r31)
/* 803D4794 0039DD54  90 83 00 04 */	stw r4, 0x4(r3)
.L_803D4798:
...
/* 803D47B8 0039DD78  38 03 FF FF */	addi r0, r3, -0x1
...
/* 803D47C8 0039DD88  2C 00 00 00 */	cmpwi r0, 0x0
/* 803D47CC 0039DD8C  4C 80 00 20 */	bgelr
/* 803D47D0 0039DD90  38 00 00 00 */	li r0, 0x0
...
/* 803D47E4 0039DDA4  2C 80 00 00 */	cmpwi cr1, r0, 0x0
...
/* 803D47F4 0039DDB4  2C 80 FF FF */	cmpwi cr1, r0, -0x1
/* 803D47F8 0039DDB8  40 86 00 10 */	bne cr1, .L_803D4808
.L_803D47FC:
/* 803D47FC 0039DDBC  38 80 00 00 */	li r4, 0x0
/* 803D4800 0039DDC0  38 60 00 00 */	li r3, 0x0
/* 803D4804 0039DDC4  4E 80 00 20 */	blr
.L_803D4808:
/* 803D4808 0039DDC8  7C 6D 42 E6 */	mftb r3, 269
/* 803D480C 0039DDCC  7C 8C 42 E6 */	mftb r4, 268
/* 803D4810 0039DDD0  7C 0D 42 E6 */	mftb r0, 269
...
/* 803D4824 0039DDE4  38 80 00 01 */	li r4, 0x1
/* 803D4828 0039DDE8  38 65 CE 30 */	addi r3, r5, utytmr_unit@l
/* 803D482C 0039DDEC  80 A5 CE 30 */	lwz r5, utytmr_unit@l(r5)
/* 803D4830 0039DDF0  80 03 00 04 */	lwz r0, 0x4(r3)
/* 803D4834 0039DDF4  38 60 00 00 */	li r3, 0x0
...
/* 803D4848 0039DE08  20 60 00 01 */	subfic r3, r0, 0x1
...
/* 803D485C 0039DE1C  80 84 00 04 */	lwz r4, 0x4(r4)
