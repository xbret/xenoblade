.include "macros.inc"
.file "CriWare/sofdec/sfdcore/mpv/mpv_frm.o"

# 0x803A62C4 - 0x803A6504
.text
.balign 4
...
/* 803A62E8 0036F8A8  2C 03 00 00 */	cmpwi r3, 0x0
/* 803A62EC 0036F8AC  41 82 00 18 */	beq .L_803A6304
/* 803A62F0 0036F8B0  3C 80 FF 03 */	lis r4, 0xff03
/* 803A62F4 0036F8B4  38 60 00 00 */	li r3, 0x0
/* 803A62F8 0036F8B8  38 84 02 09 */	addi r4, r4, 0x209
...
/* 803A6308 0036F8C8  2C 00 00 02 */	cmpwi r0, 0x2
...
.L_803A6324:
/* 803A6324 0036F8E4  38 00 00 08 */	li r0, 0x8
/* 803A6328 0036F8E8  38 BF 0B EC */	addi r5, r31, 0xbec
/* 803A632C 0036F8EC  38 9C FF FC */	addi r4, r28, -0x4
...
.L_803A633C:
/* 803A633C 0036F8FC  80 64 00 04 */	lwz r3, 0x4(r4)
/* 803A6340 0036F900  84 04 00 08 */	lwzu r0, 0x8(r4)
/* 803A6344 0036F904  90 65 00 04 */	stw r3, 0x4(r5)
/* 803A6348 0036F908  94 05 00 08 */	stwu r0, 0x8(r5)
/* 803A634C 0036F90C  42 00 FF F0 */	bdnz .L_803A633C
/* 803A6350 0036F910  80 04 00 04 */	lwz r0, 0x4(r4)
/* 803A6354 0036F914  7F E3 FB 78 */	mr r3, r31
/* 803A6358 0036F918  90 05 00 04 */	stw r0, 0x4(r5)
...
/* 803A63A4 0036F964  38 A3 FF FC */	addi r5, r3, -0x4
/* 803A63A8 0036F968  7C 09 03 A6 */	mtctr r0
.L_803A63AC:
/* 803A63AC 0036F96C  80 64 00 04 */	lwz r3, 0x4(r4)
/* 803A63B0 0036F970  84 04 00 08 */	lwzu r0, 0x8(r4)
/* 803A63B4 0036F974  90 65 00 04 */	stw r3, 0x4(r5)
/* 803A63B8 0036F978  94 05 00 08 */	stwu r0, 0x8(r5)
...
/* 803A641C 0036F9DC  2C 03 00 00 */	cmpwi r3, 0x0
/* 803A6420 0036F9E0  41 82 00 18 */	beq .L_803A6438
/* 803A6424 0036F9E4  3C 80 FF 03 */	lis r4, 0xff03
/* 803A6428 0036F9E8  38 60 00 00 */	li r3, 0x0
/* 803A642C 0036F9EC  38 84 02 0A */	addi r4, r4, 0x20a
/* 803A6430 0036F9F0  4B FF FE 0D */	bl MPVERR_SetCode
/* 803A6434 0036F9F4  48 00 00 50 */	b .L_803A6484
.L_803A6438:
/* 803A6438 0036F9F8  3C 60 FF 03 */	lis r3, 0xff03
/* 803A643C 0036F9FC  3B C3 03 05 */	addi r30, r3, 0x305
.L_803A6440:
/* 803A6440 0036FA00  7F A3 EB 78 */	mr r3, r29
/* 803A6444 0036FA04  48 00 18 29 */	bl MPV_GoNextDelimSj
/* 803A6448 0036FA08  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 803A6458 0036FA18  3B C0 00 00 */	li r30, 0x0
/* 803A645C 0036FA1C  48 00 00 1C */	b .L_803A6478
.L_803A6460:
/* 803A6460 0036FA20  7F A3 EB 78 */	mr r3, r29
/* 803A6464 0036FA24  38 80 00 01 */	li r4, 0x1
/* 803A6468 0036FA28  38 A0 00 04 */	li r5, 0x4
/* 803A646C 0036FA2C  48 00 1A 59 */	bl MPV_MoveChunk
/* 803A6470 0036FA30  2C 03 00 04 */	cmpwi r3, 0x4
...
/* 803A64B8 0036FA78  2C 03 00 00 */	cmpwi r3, 0x0
/* 803A64BC 0036FA7C  41 82 00 18 */	beq .L_803A64D4
/* 803A64C0 0036FA80  3C 80 FF 03 */	lis r4, 0xff03
/* 803A64C4 0036FA84  38 60 00 00 */	li r3, 0x0
/* 803A64C8 0036FA88  38 84 02 11 */	addi r4, r4, 0x211
...
/* 803A64D8 0036FA98  38 60 00 01 */	li r3, 0x1
/* 803A64DC 0036FA9C  90 7F 0D A8 */	stw r3, 0xda8(r31)
/* 803A64E0 0036FAA0  2C 00 00 02 */	cmpwi r0, 0x2
