...
/* 803A7F64 00371524  41 82 00 18 */	beq lbl_803A7F7C
/* 803A7F68 00371528  3C 03 00 FD */	addis r0, r3, 0xfd
/* 803A7F6C 0037152C  28 00 FF 05 */	cmplwi r0, 0xff05
/* 803A7F70 00371530  40 82 00 08 */	bne lbl_803A7F78
/* 803A7F74 00371534  48 00 01 48 */	b lbl_803A80BC
lbl_803A7F78:
/* 803A7F78 00371538  48 00 00 00 */	b lbl_803A7F78
lbl_803A7F7C:
...
/* 803A7FB4 00371574  41 82 00 20 */	beq lbl_803A7FD4
...
/* 803A7FD0 00371590  42 00 FF F4 */	bdnz lbl_803A7FC4
lbl_803A7FD4:
...
/* 803A8038 003715F8  41 82 00 18 */	beq lbl_803A8050
...
/* 803A8064 00371624  40 81 00 50 */	ble lbl_803A80B4
/* 803A8068 00371628  54 A0 E8 FF */	rlwinm. r0, r5, 0x1d, 3, 0x1f
/* 803A806C 0037162C  7C 09 03 A6 */	mtctr r0
/* 803A8070 00371630  41 82 00 34 */	beq lbl_803A80A4
lbl_803A8074:
...
/* 803A8098 00371658  42 00 FF DC */	bdnz lbl_803A8074
/* 803A809C 0037165C  70 A5 00 07 */	andi. r5, r5, 7
/* 803A80A0 00371660  41 82 00 14 */	beq lbl_803A80B4
lbl_803A80A4:
...
/* 803A80B0 00371670  42 00 FF F8 */	bdnz lbl_803A80A8
lbl_803A80B4:
...
/* 803A80E4 003716A4  41 82 00 18 */	beq lbl_803A80FC
...
/* 803A80F8 003716B8  48 00 00 60 */	b lbl_803A8158
lbl_803A80FC:
...
/* 803A8114 003716D4  41 82 00 18 */	beq lbl_803A812C
...
/* 803A8128 003716E8  48 00 00 30 */	b lbl_803A8158
lbl_803A812C:
...
/* 803A8240 00371800  42 00 FF 3C */	bdnz lbl_803A817C
...
/* 803A8354 00371914  42 00 FE FC */	bdnz lbl_803A8250
...
/* 803A8428 003719E8  42 00 FF 3C */	bdnz lbl_803A8364
...
/* 803A8558 00371B18  41 82 00 1C */	beq lbl_803A8574
...
/* 803A8570 00371B30  42 00 FF F8 */	bdnz lbl_803A8568
lbl_803A8574:
...
/* 803A859C 00371B5C  40 81 00 1C */	ble lbl_803A85B8
lbl_803A85A0:
/* 803A85A0 00371B60  80 03 0B 08 */	lwz r0, 0xb08(r3)
/* 803A85A4 00371B64  2C 00 00 01 */	cmpwi r0, 1
/* 803A85A8 00371B68  40 82 00 08 */	bne lbl_803A85B0
/* 803A85AC 00371B6C  48 00 00 10 */	b lbl_803A85BC
lbl_803A85B0:
/* 803A85B0 00371B70  38 63 0D C0 */	addi r3, r3, 0xdc0
/* 803A85B4 00371B74  42 00 FF EC */	bdnz lbl_803A85A0
lbl_803A85B8:
/* 803A85B8 00371B78  38 60 00 00 */	li r3, 0
lbl_803A85BC:
/* 803A85BC 00371B7C  2C 03 00 00 */	cmpwi r3, 0
/* 803A85C0 00371B80  40 82 00 0C */	bne lbl_803A85CC
...
/* 803A85DC 00371B9C  41 82 00 20 */	beq lbl_803A85FC
...
/* 803A876C 00371D2C  41 80 FF E0 */	blt lbl_803A874C
...
/* 803A87E8 00371DA8  40 82 00 0C */	bne lbl_803A87F4
/* 803A87EC 00371DAC  38 00 FF FF */	li r0, -1
/* 803A87F0 00371DB0  48 00 00 24 */	b lbl_803A8814
lbl_803A87F4:
/* 803A87F4 00371DB4  80 03 0B 08 */	lwz r0, 0xb08(r3)
/* 803A87F8 00371DB8  2C 00 00 02 */	cmpwi r0, 2
/* 803A87FC 00371DBC  41 82 00 0C */	beq lbl_803A8808
/* 803A8800 00371DC0  38 00 FF FF */	li r0, -1
/* 803A8804 00371DC4  48 00 00 10 */	b lbl_803A8814
lbl_803A8808:
...
/* 803A8818 00371DD8  41 82 00 18 */	beq lbl_803A8830
...
/* 803A882C 00371DEC  48 00 00 4C */	b lbl_803A8878
lbl_803A8830:
...
/* 803A8850 00371E10  41 82 00 1C */	beq lbl_803A886C
...
/* 803A8868 00371E28  42 00 FF F8 */	bdnz lbl_803A8860
lbl_803A886C:
...
/* 803A889C 00371E5C  40 82 00 50 */	bne lbl_803A88EC
...
/* 803A88C0 00371E80  40 81 00 20 */	ble lbl_803A88E0
lbl_803A88C4:
/* 803A88C4 00371E84  80 07 0B 08 */	lwz r0, 0xb08(r7)
/* 803A88C8 00371E88  2C 00 00 02 */	cmpwi r0, 2
/* 803A88CC 00371E8C  40 82 00 08 */	bne lbl_803A88D4
...
/* 803A88DC 00371E9C  42 00 FF E8 */	bdnz lbl_803A88C4
lbl_803A88E0:
/* 803A88E0 00371EA0  3C C0 80 60 */	lis r6, lbl_80606048@ha
/* 803A88E4 00371EA4  38 C6 60 48 */	addi r6, r6, lbl_80606048@l
/* 803A88E8 00371EA8  48 00 00 50 */	b lbl_803A8938
lbl_803A88EC:
/* 803A88EC 00371EAC  40 82 00 0C */	bne lbl_803A88F8
/* 803A88F0 00371EB0  38 00 FF FF */	li r0, -1
/* 803A88F4 00371EB4  48 00 00 24 */	b lbl_803A8918
lbl_803A88F8:
/* 803A88F8 00371EB8  80 03 0B 08 */	lwz r0, 0xb08(r3)
/* 803A88FC 00371EBC  2C 00 00 02 */	cmpwi r0, 2
/* 803A8900 00371EC0  41 82 00 0C */	beq lbl_803A890C
/* 803A8904 00371EC4  38 00 FF FF */	li r0, -1
/* 803A8908 00371EC8  48 00 00 10 */	b lbl_803A8918
lbl_803A890C:
...
/* 803A891C 00371EDC  41 82 00 18 */	beq lbl_803A8934
...
/* 803A8930 00371EF0  48 00 00 18 */	b lbl_803A8948
lbl_803A8934:
...
/* 803A899C 00371F5C  41 82 00 14 */	beq lbl_803A89B0
...
.global MPVLIB_CheckHn
MPVLIB_CheckHn:
/* 803A89D8 00371F98  2C 03 00 00 */	cmpwi r3, 0
/* 803A89DC 00371F9C  40 82 00 0C */	bne lbl_803A89E8
...
/* 803A89F0 00371FB0  41 82 00 0C */	beq lbl_803A89FC
