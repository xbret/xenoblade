.include "macros.inc"
.file "CriWare/sofdec/sfdcore/mpv/mpv_get.o"

# 0x803A6504 - 0x803A671C
.text
.balign 4
...
/* 803A6518 0036FAD8  93 C1 00 08 */	stw r30, 0x8(r1)
/* 803A651C 0036FADC  7C 9E 23 78 */	mr r30, r4
/* 803A6520 0036FAE0  48 00 24 B9 */	bl MPVLIB_CheckHn
/* 803A6524 0036FAE4  2C 03 00 00 */	cmpwi r3, 0x0
/* 803A6528 0036FAE8  41 82 00 18 */	beq .L_803A6540
/* 803A652C 0036FAEC  3C 80 FF 03 */	lis r4, 0xff03
/* 803A6530 0036FAF0  38 60 00 00 */	li r3, 0x0
/* 803A6534 0036FAF4  38 84 02 0C */	addi r4, r4, 0x20c
...
/* 803A6544 0036FB04  38 BE FF FC */	addi r5, r30, -0x4
/* 803A6548 0036FB08  38 9F 0B 58 */	addi r4, r31, 0xb58
/* 803A654C 0036FB0C  7C 09 03 A6 */	mtctr r0
.L_803A6550:
/* 803A6550 0036FB10  80 64 00 04 */	lwz r3, 0x4(r4)
/* 803A6554 0036FB14  84 04 00 08 */	lwzu r0, 0x8(r4)
/* 803A6558 0036FB18  90 65 00 04 */	stw r3, 0x4(r5)
/* 803A655C 0036FB1C  94 05 00 08 */	stwu r0, 0x8(r5)
/* 803A6560 0036FB20  42 00 FF F0 */	bdnz .L_803A6550
/* 803A6564 0036FB24  38 60 00 00 */	li r3, 0x0
.L_803A6568:
/* 803A6568 0036FB28  80 01 00 14 */	lwz r0, 0x14(r1)
/* 803A656C 0036FB2C  83 E1 00 0C */	lwz r31, 0xc(r1)
/* 803A6570 0036FB30  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 803A6594 0036FB54  93 C1 00 08 */	stw r30, 0x8(r1)
/* 803A6598 0036FB58  7C 9E 23 78 */	mr r30, r4
/* 803A659C 0036FB5C  48 00 24 3D */	bl MPVLIB_CheckHn
/* 803A65A0 0036FB60  2C 03 00 00 */	cmpwi r3, 0x0
/* 803A65A4 0036FB64  41 82 00 18 */	beq .L_803A65BC
/* 803A65A8 0036FB68  3C 80 FF 03 */	lis r4, 0xff03
/* 803A65AC 0036FB6C  38 60 00 00 */	li r3, 0x0
/* 803A65B0 0036FB70  38 84 02 0D */	addi r4, r4, 0x20d
...
/* 803A65C0 0036FB80  38 60 00 00 */	li r3, 0x0
/* 803A65C4 0036FB84  90 1E 00 00 */	stw r0, 0x0(r30)
.L_803A65C8:
/* 803A65C8 0036FB88  80 01 00 14 */	lwz r0, 0x14(r1)
/* 803A65CC 0036FB8C  83 E1 00 0C */	lwz r31, 0xc(r1)
/* 803A65D0 0036FB90  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 803A6610 0036FBD0  2C 03 00 00 */	cmpwi r3, 0x0
/* 803A6614 0036FBD4  41 82 00 18 */	beq .L_803A662C
/* 803A6618 0036FBD8  3C 80 FF 03 */	lis r4, 0xff03
/* 803A661C 0036FBDC  38 60 00 00 */	li r3, 0x0
/* 803A6620 0036FBE0  38 84 02 0F */	addi r4, r4, 0x20f
...
/* 803A6630 0036FBF0  54 00 58 28 */	slwi r0, r0, 11
/* 803A6634 0036FBF4  90 1C 00 00 */	stw r0, 0x0(r28)
/* 803A6638 0036FBF8  80 1F 0C 5C */	lwz r0, 0xc5c(r31)
/* 803A663C 0036FBFC  90 1D 00 00 */	stw r0, 0x0(r29)
...
/* 803A6650 0036FC10  38 00 FF FF */	li r0, -0x1
/* 803A6654 0036FC14  90 1E 00 00 */	stw r0, 0x0(r30)
/* 803A6658 0036FC18  48 00 00 2C */	b .L_803A6684
.L_803A665C:
/* 803A665C 0036FC1C  80 1F 0C 5C */	lwz r0, 0xc5c(r31)
/* 803A6660 0036FC20  3C 60 91 A3 */	lis r3, 0x91a3
/* 803A6664 0036FC24  38 63 B3 C5 */	addi r3, r3, -0x4c3b
...
/* 803A6674 0036FC34  7C 00 56 70 */	srawi r0, r0, 10
/* 803A6678 0036FC38  54 03 0F FE */	srwi r3, r0, 31
/* 803A667C 0036FC3C  7C 00 1A 14 */	add r0, r0, r3
/* 803A6680 0036FC40  90 1E 00 00 */	stw r0, 0x0(r30)
.L_803A6684:
/* 803A6684 0036FC44  38 60 00 00 */	li r3, 0x0
.L_803A6688:
...
/* 803A66D0 0036FC90  2C 03 00 00 */	cmpwi r3, 0x0
/* 803A66D4 0036FC94  41 82 00 18 */	beq .L_803A66EC
/* 803A66D8 0036FC98  3C 80 FF 03 */	lis r4, 0xff03
/* 803A66DC 0036FC9C  38 60 00 00 */	li r3, 0x0
/* 803A66E0 0036FCA0  38 84 02 0E */	addi r4, r4, 0x20e
...
/* 803A66F0 0036FCB0  38 60 00 00 */	li r3, 0x0
/* 803A66F4 0036FCB4  90 1D 00 00 */	stw r0, 0x0(r29)
/* 803A66F8 0036FCB8  80 1F 0C 58 */	lwz r0, 0xc58(r31)
/* 803A66FC 0036FCBC  90 1E 00 00 */	stw r0, 0x0(r30)
.L_803A6700:
