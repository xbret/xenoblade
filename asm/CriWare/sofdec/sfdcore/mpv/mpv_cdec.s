.include "macros.inc"
.file "CriWare/sofdec/sfdcore/mpv/mpv_cdec.o"

# 0x803A3F8C - 0x803A460C
.text
.balign 4
...
/* 803A3FC4 0036D584  90 83 00 08 */	stw r4, 0x8(r3)
...
/* 803A4000 0036D5C0  80 85 00 08 */	lwz r4, 0x8(r5)
/* 803A4004 0036D5C4  80 04 00 00 */	lwz r0, 0x0(r4)
/* 803A4008 0036D5C8  90 03 0C 68 */	stw r0, 0xc68(r3)
/* 803A400C 0036D5CC  80 85 00 08 */	lwz r4, 0x8(r5)
/* 803A4010 0036D5D0  80 04 00 04 */	lwz r0, 0x4(r4)
...
/* 803A4024 0036D5E4  39 20 00 00 */	li r9, 0x0
...
/* 803A4038 0036D5F8  91 23 00 04 */	stw r9, 0x4(r3)
/* 803A403C 0036D5FC  91 23 00 00 */	stw r9, 0x0(r3)
/* 803A4040 0036D600  91 23 00 0C */	stw r9, 0xc(r3)
/* 803A4044 0036D604  91 23 00 08 */	stw r9, 0x8(r3)
...
/* 803A44B0 0036DA70  38 60 00 00 */	li r3, 0x0
...
/* 803A44D0 0036DA90  38 80 00 01 */	li r4, 0x1
...
/* 803A44E4 0036DAA4  3B C1 00 08 */	addi r30, r1, 0x8
/* 803A44E8 0036DAA8  7F 5F D3 78 */	mr r31, r26
/* 803A44EC 0036DAAC  3B 60 00 00 */	li r27, 0x0
...
.L_803A4508:
/* 803A4508 0036DAC8  2C 1C 00 00 */	cmpwi r28, 0x0
...
/* 803A452C 0036DAEC  90 7E 00 00 */	stw r3, 0x0(r30)
.L_803A4530:
/* 803A4530 0036DAF0  3B 7B 00 01 */	addi r27, r27, 0x1
/* 803A4534 0036DAF4  57 9C 08 3C */	slwi r28, r28, 1
/* 803A4538 0036DAF8  2C 1B 00 06 */	cmpwi r27, 0x6
/* 803A453C 0036DAFC  3B FF 00 04 */	addi r31, r31, 0x4
/* 803A4540 0036DB00  3B DE 00 04 */	addi r30, r30, 0x4
/* 803A4544 0036DB04  41 80 FF C4 */	blt .L_803A4508
/* 803A4548 0036DB08  80 1A 0C EC */	lwz r0, 0xcec(r26)
/* 803A454C 0036DB0C  54 1E 10 3B */	slwi. r30, r0, 2
...
/* 803A455C 0036DB1C  80 81 00 08 */	lwz r4, 0x8(r1)
/* 803A4560 0036DB20  7D 89 03 A6 */	mtctr r12
/* 803A4564 0036DB24  4E 80 04 21 */	bctrl
.L_803A4568:
/* 803A4568 0036DB28  57 DE 08 3D */	slwi. r30, r30, 1
...
.L_803A4584:
/* 803A4584 0036DB44  57 DE 08 3D */	slwi. r30, r30, 1
...
.L_803A45A0:
/* 803A45A0 0036DB60  57 DE 08 3D */	slwi. r30, r30, 1
...
.L_803A45BC:
/* 803A45BC 0036DB7C  57 DE 08 3D */	slwi. r30, r30, 1
...
.L_803A45D8:
/* 803A45D8 0036DB98  57 C0 08 3D */	slwi. r0, r30, 1
...
/* 803A45F8 0036DBB8  38 60 00 00 */	li r3, 0x0
