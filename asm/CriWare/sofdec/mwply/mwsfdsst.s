...
/* 803A31F4 0036C7B4  2C 00 FF FF */	cmpwi r0, -0x1
...
/* 803A3208 0036C7C8  38 A0 00 00 */	li r5, 0x0
/* 803A320C 0036C7CC  38 C0 00 00 */	li r6, 0x0
/* 803A3210 0036C7D0  38 E0 00 00 */	li r7, 0x0
/* 803A3214 0036C7D4  48 01 DC DD */	bl SFD_SetElementOutSj
/* 803A3218 0036C7D8  38 00 FF FF */	li r0, -0x1
/* 803A321C 0036C7DC  90 1F 05 E8 */	stw r0, 0x5e8(r31)
.L_803A3220:
/* 803A3220 0036C7E0  80 1F 05 E0 */	lwz r0, 0x5e0(r31)
/* 803A3224 0036C7E4  2C 00 00 01 */	cmpwi r0, 0x1
...
/* 803A3238 0036C7F8  38 C0 00 00 */	li r6, 0x0
/* 803A323C 0036C7FC  38 E0 00 00 */	li r7, 0x0
...
/* 803A328C 0036C84C  2C 00 FF FF */	cmpwi r0, -0x1
...
/* 803A329C 0036C85C  38 A0 00 00 */	li r5, 0x0
/* 803A32A0 0036C860  38 C0 00 00 */	li r6, 0x0
/* 803A32A4 0036C864  38 E0 00 00 */	li r7, 0x0
/* 803A32A8 0036C868  48 01 DC 49 */	bl SFD_SetElementOutSj
/* 803A32AC 0036C86C  38 00 FF FF */	li r0, -0x1
...
/* 803A32EC 0036C8AC  2C 00 00 00 */	cmpwi r0, 0x0
/* 803A32F0 0036C8B0  40 82 00 0C */	bne .L_803A32FC
/* 803A32F4 0036C8B4  38 00 00 00 */	li r0, 0x0
/* 803A32F8 0036C8B8  48 00 00 28 */	b .L_803A3320
.L_803A32FC:
/* 803A32FC 0036C8BC  80 03 00 00 */	lwz r0, 0x0(r3)
/* 803A3300 0036C8C0  2C 00 00 01 */	cmpwi r0, 0x1
/* 803A3304 0036C8C4  41 82 00 0C */	beq .L_803A3310
/* 803A3308 0036C8C8  38 00 00 00 */	li r0, 0x0
...
/* 803A331C 0036C8DC  54 00 0F FE */	srwi r0, r0, 31
.L_803A3320:
/* 803A3320 0036C8E0  2C 00 00 01 */	cmpwi r0, 0x1
/* 803A3324 0036C8E4  4C 82 00 20 */	bnelr
/* 803A3328 0036C8E8  80 A3 00 08 */	lwz r5, 0x8(r3)
/* 803A332C 0036C8EC  80 03 00 24 */	lwz r0, 0x24(r3)
/* 803A3330 0036C8F0  2C 05 00 00 */	cmpwi r5, 0x0
...
/* 803A3340 0036C900  2C 0C 00 00 */	cmpwi r12, 0x0
...
/* 803A3358 0036C918  80 03 00 04 */	lwz r0, 0x4(r3)
...
/* 803A336C 0036C92C  2C 00 00 00 */	cmpwi r0, 0x0
/* 803A3370 0036C930  40 82 00 0C */	bne .L_803A337C
/* 803A3374 0036C934  38 00 00 00 */	li r0, 0x0
/* 803A3378 0036C938  48 00 00 28 */	b .L_803A33A0
.L_803A337C:
/* 803A337C 0036C93C  80 03 00 00 */	lwz r0, 0x0(r3)
/* 803A3380 0036C940  2C 00 00 01 */	cmpwi r0, 0x1
/* 803A3384 0036C944  41 82 00 0C */	beq .L_803A3390
/* 803A3388 0036C948  38 00 00 00 */	li r0, 0x0
...
/* 803A339C 0036C95C  54 00 0F FE */	srwi r0, r0, 31
.L_803A33A0:
/* 803A33A0 0036C960  2C 00 00 01 */	cmpwi r0, 0x1
/* 803A33A4 0036C964  4C 82 00 20 */	bnelr
/* 803A33A8 0036C968  80 03 00 24 */	lwz r0, 0x24(r3)
/* 803A33AC 0036C96C  80 63 00 08 */	lwz r3, 0x8(r3)
/* 803A33B0 0036C970  2C 00 00 00 */	cmpwi r0, 0x0
/* 803A33B4 0036C974  4D 82 00 20 */	beqlr
/* 803A33B8 0036C978  2C 03 00 00 */	cmpwi r3, 0x0
/* 803A33BC 0036C97C  4D 82 00 20 */	beqlr
/* 803A33C0 0036C980  81 83 00 18 */	lwz r12, 0x18(r3)
/* 803A33C4 0036C984  2C 0C 00 00 */	cmpwi r12, 0x0
...
/* 803A3430 0036C9F0  54 00 0F FE */	srwi r0, r0, 31
.L_803A3434:
/* 803A3434 0036C9F4  2C 00 00 01 */	cmpwi r0, 0x1
/* 803A3438 0036C9F8  41 82 00 0C */	beq .L_803A3444
/* 803A343C 0036C9FC  38 60 00 00 */	li r3, 0x0
/* 803A3440 0036CA00  48 00 00 30 */	b .L_803A3470
.L_803A3444:
/* 803A3444 0036CA04  80 83 00 08 */	lwz r4, 0x8(r3)
/* 803A3448 0036CA08  80 63 00 24 */	lwz r3, 0x24(r3)
/* 803A344C 0036CA0C  2C 04 00 00 */	cmpwi r4, 0x0
/* 803A3450 0036CA10  41 82 00 1C */	beq .L_803A346C
/* 803A3454 0036CA14  81 84 00 1C */	lwz r12, 0x1c(r4)
/* 803A3458 0036CA18  2C 0C 00 00 */	cmpwi r12, 0x0
...
/* 803A3480 0036CA40  80 03 00 04 */	lwz r0, 0x4(r3)
...
/* 803A3494 0036CA54  2C 00 00 00 */	cmpwi r0, 0x0
/* 803A3498 0036CA58  40 82 00 0C */	bne .L_803A34A4
/* 803A349C 0036CA5C  38 00 00 00 */	li r0, 0x0
/* 803A34A0 0036CA60  48 00 00 28 */	b .L_803A34C8
.L_803A34A4:
/* 803A34A4 0036CA64  80 03 00 00 */	lwz r0, 0x0(r3)
/* 803A34A8 0036CA68  2C 00 00 01 */	cmpwi r0, 0x1
/* 803A34AC 0036CA6C  41 82 00 0C */	beq .L_803A34B8
/* 803A34B0 0036CA70  38 00 00 00 */	li r0, 0x0
...
/* 803A34C4 0036CA84  54 00 0F FE */	srwi r0, r0, 31
.L_803A34C8:
/* 803A34C8 0036CA88  2C 00 00 01 */	cmpwi r0, 0x1
/* 803A34CC 0036CA8C  4C 82 00 20 */	bnelr
/* 803A34D0 0036CA90  80 A3 00 08 */	lwz r5, 0x8(r3)
/* 803A34D4 0036CA94  80 63 00 24 */	lwz r3, 0x24(r3)
/* 803A34D8 0036CA98  2C 05 00 00 */	cmpwi r5, 0x0
/* 803A34DC 0036CA9C  4D 82 00 20 */	beqlr
/* 803A34E0 0036CAA0  81 85 00 24 */	lwz r12, 0x24(r5)
/* 803A34E4 0036CAA4  2C 0C 00 00 */	cmpwi r12, 0x0
...
/* 803A350C 0036CACC  2C 00 00 00 */	cmpwi r0, 0x0
/* 803A3510 0036CAD0  40 82 00 0C */	bne .L_803A351C
/* 803A3514 0036CAD4  38 00 00 00 */	li r0, 0x0
/* 803A3518 0036CAD8  48 00 00 28 */	b .L_803A3540
.L_803A351C:
/* 803A351C 0036CADC  80 03 00 00 */	lwz r0, 0x0(r3)
/* 803A3520 0036CAE0  2C 00 00 01 */	cmpwi r0, 0x1
/* 803A3524 0036CAE4  41 82 00 0C */	beq .L_803A3530
/* 803A3528 0036CAE8  38 00 00 00 */	li r0, 0x0
...
/* 803A353C 0036CAFC  54 00 0F FE */	srwi r0, r0, 31
.L_803A3540:
/* 803A3540 0036CB00  2C 00 00 01 */	cmpwi r0, 0x1
/* 803A3544 0036CB04  4C 82 00 20 */	bnelr
/* 803A3548 0036CB08  80 A3 00 08 */	lwz r5, 0x8(r3)
/* 803A354C 0036CB0C  80 63 00 24 */	lwz r3, 0x24(r3)
/* 803A3550 0036CB10  2C 05 00 00 */	cmpwi r5, 0x0
/* 803A3554 0036CB14  4D 82 00 20 */	beqlr
/* 803A3558 0036CB18  81 85 00 28 */	lwz r12, 0x28(r5)
/* 803A355C 0036CB1C  2C 0C 00 00 */	cmpwi r12, 0x0
...
/* 803A35C4 0036CB84  54 00 0F FE */	srwi r0, r0, 31
.L_803A35C8:
/* 803A35C8 0036CB88  2C 00 00 01 */	cmpwi r0, 0x1
/* 803A35CC 0036CB8C  41 82 00 0C */	beq .L_803A35D8
/* 803A35D0 0036CB90  38 60 00 00 */	li r3, 0x0
/* 803A35D4 0036CB94  48 00 00 30 */	b .L_803A3604
.L_803A35D8:
/* 803A35D8 0036CB98  80 83 00 08 */	lwz r4, 0x8(r3)
/* 803A35DC 0036CB9C  80 63 00 24 */	lwz r3, 0x24(r3)
/* 803A35E0 0036CBA0  2C 04 00 00 */	cmpwi r4, 0x0
/* 803A35E4 0036CBA4  41 82 00 1C */	beq .L_803A3600
/* 803A35E8 0036CBA8  81 84 00 2C */	lwz r12, 0x2c(r4)
/* 803A35EC 0036CBAC  2C 0C 00 00 */	cmpwi r12, 0x0
...
/* 803A3628 0036CBE8  2C 00 00 00 */	cmpwi r0, 0x0
/* 803A362C 0036CBEC  40 82 00 0C */	bne .L_803A3638
/* 803A3630 0036CBF0  38 00 00 00 */	li r0, 0x0
/* 803A3634 0036CBF4  48 00 00 28 */	b .L_803A365C
.L_803A3638:
/* 803A3638 0036CBF8  80 03 00 00 */	lwz r0, 0x0(r3)
/* 803A363C 0036CBFC  2C 00 00 01 */	cmpwi r0, 0x1
/* 803A3640 0036CC00  41 82 00 0C */	beq .L_803A364C
/* 803A3644 0036CC04  38 00 00 00 */	li r0, 0x0
...
/* 803A3658 0036CC18  54 00 0F FE */	srwi r0, r0, 31
.L_803A365C:
/* 803A365C 0036CC1C  2C 00 00 01 */	cmpwi r0, 0x1
/* 803A3660 0036CC20  4C 82 00 20 */	bnelr
/* 803A3664 0036CC24  80 A3 00 08 */	lwz r5, 0x8(r3)
/* 803A3668 0036CC28  80 63 00 24 */	lwz r3, 0x24(r3)
/* 803A366C 0036CC2C  2C 05 00 00 */	cmpwi r5, 0x0
/* 803A3670 0036CC30  4D 82 00 20 */	beqlr
/* 803A3674 0036CC34  81 85 00 30 */	lwz r12, 0x30(r5)
/* 803A3678 0036CC38  2C 0C 00 00 */	cmpwi r12, 0x0
...
/* 803A36A0 0036CC60  2C 00 00 00 */	cmpwi r0, 0x0
/* 803A36A4 0036CC64  40 82 00 0C */	bne .L_803A36B0
/* 803A36A8 0036CC68  38 00 00 00 */	li r0, 0x0
/* 803A36AC 0036CC6C  48 00 00 28 */	b .L_803A36D4
.L_803A36B0:
/* 803A36B0 0036CC70  80 03 00 00 */	lwz r0, 0x0(r3)
/* 803A36B4 0036CC74  2C 00 00 01 */	cmpwi r0, 0x1
/* 803A36B8 0036CC78  41 82 00 0C */	beq .L_803A36C4
/* 803A36BC 0036CC7C  38 00 00 00 */	li r0, 0x0
...
/* 803A36D0 0036CC90  54 00 0F FE */	srwi r0, r0, 31
.L_803A36D4:
/* 803A36D4 0036CC94  2C 00 00 01 */	cmpwi r0, 0x1
/* 803A36D8 0036CC98  4C 82 00 20 */	bnelr
/* 803A36DC 0036CC9C  80 83 00 08 */	lwz r4, 0x8(r3)
/* 803A36E0 0036CCA0  80 63 00 24 */	lwz r3, 0x24(r3)
/* 803A36E4 0036CCA4  2C 04 00 00 */	cmpwi r4, 0x0
/* 803A36E8 0036CCA8  4D 82 00 20 */	beqlr
/* 803A36EC 0036CCAC  81 84 00 34 */	lwz r12, 0x34(r4)
/* 803A36F0 0036CCB0  2C 0C 00 00 */	cmpwi r12, 0x0
...
/* 803A3764 0036CD24  54 00 0F FE */	srwi r0, r0, 31
.L_803A3768:
/* 803A3768 0036CD28  2C 00 00 01 */	cmpwi r0, 0x1
/* 803A376C 0036CD2C  40 82 00 80 */	bne .L_803A37EC
/* 803A3770 0036CD30  2C 04 00 00 */	cmpwi r4, 0x0
/* 803A3774 0036CD34  40 82 00 0C */	bne .L_803A3780
/* 803A3778 0036CD38  38 00 00 00 */	li r0, 0x0
/* 803A377C 0036CD3C  48 00 00 28 */	b .L_803A37A4
.L_803A3780:
/* 803A3780 0036CD40  80 05 05 C8 */	lwz r0, 0x5c8(r5)
/* 803A3784 0036CD44  2C 00 00 01 */	cmpwi r0, 0x1
/* 803A3788 0036CD48  41 82 00 0C */	beq .L_803A3794
/* 803A378C 0036CD4C  38 00 00 00 */	li r0, 0x0
...
/* 803A37A0 0036CD60  54 00 0F FE */	srwi r0, r0, 31
.L_803A37A4:
/* 803A37A4 0036CD64  2C 00 00 01 */	cmpwi r0, 0x1
...
/* 803A3828 0036CDE8  80 03 00 04 */	lwz r0, 0x4(r3)
...
/* 803A3838 0036CDF8  2C 00 00 00 */	cmpwi r0, 0x0
/* 803A383C 0036CDFC  40 82 00 0C */	bne .L_803A3848
/* 803A3840 0036CE00  38 00 00 00 */	li r0, 0x0
/* 803A3844 0036CE04  48 00 00 28 */	b .L_803A386C
.L_803A3848:
/* 803A3848 0036CE08  80 03 00 00 */	lwz r0, 0x0(r3)
/* 803A384C 0036CE0C  2C 00 00 01 */	cmpwi r0, 0x1
/* 803A3850 0036CE10  41 82 00 0C */	beq .L_803A385C
/* 803A3854 0036CE14  38 00 00 00 */	li r0, 0x0
...
/* 803A3868 0036CE28  54 00 0F FE */	srwi r0, r0, 31
.L_803A386C:
/* 803A386C 0036CE2C  2C 00 00 01 */	cmpwi r0, 0x1
...
/* 803A389C 0036CE5C  2C 00 00 00 */	cmpwi r0, 0x0
/* 803A38A0 0036CE60  40 82 00 0C */	bne .L_803A38AC
/* 803A38A4 0036CE64  38 00 00 00 */	li r0, 0x0
/* 803A38A8 0036CE68  48 00 00 28 */	b .L_803A38D0
.L_803A38AC:
/* 803A38AC 0036CE6C  80 1E 00 00 */	lwz r0, 0x0(r30)
/* 803A38B0 0036CE70  2C 00 00 01 */	cmpwi r0, 0x1
/* 803A38B4 0036CE74  41 82 00 0C */	beq .L_803A38C0
/* 803A38B8 0036CE78  38 00 00 00 */	li r0, 0x0
...
/* 803A38CC 0036CE8C  54 00 0F FE */	srwi r0, r0, 31
.L_803A38D0:
/* 803A38D0 0036CE90  2C 00 00 01 */	cmpwi r0, 0x1
/* 803A38D4 0036CE94  40 82 00 30 */	bne .L_803A3904
/* 803A38D8 0036CE98  80 7E 00 24 */	lwz r3, 0x24(r30)
/* 803A38DC 0036CE9C  80 9E 00 08 */	lwz r4, 0x8(r30)
/* 803A38E0 0036CEA0  2C 03 00 00 */	cmpwi r3, 0x0
/* 803A38E4 0036CEA4  41 82 00 20 */	beq .L_803A3904
/* 803A38E8 0036CEA8  2C 04 00 00 */	cmpwi r4, 0x0
/* 803A38EC 0036CEAC  41 82 00 18 */	beq .L_803A3904
/* 803A38F0 0036CEB0  81 84 00 18 */	lwz r12, 0x18(r4)
/* 803A38F4 0036CEB4  2C 0C 00 00 */	cmpwi r12, 0x0
/* 803A38F8 0036CEB8  41 82 00 0C */	beq .L_803A3904
/* 803A38FC 0036CEBC  7D 89 03 A6 */	mtctr r12
/* 803A3900 0036CEC0  4E 80 04 21 */	bctrl
.L_803A3904:
/* 803A3904 0036CEC4  38 00 00 00 */	li r0, 0x0
/* 803A3908 0036CEC8  2C 1D 00 00 */	cmpwi r29, 0x0
/* 803A390C 0036CECC  90 1E 00 00 */	stw r0, 0x0(r30)
/* 803A3910 0036CED0  80 7F 00 00 */	lwz r3, 0x0(r31)
/* 803A3914 0036CED4  41 82 00 24 */	beq .L_803A3938
/* 803A3918 0036CED8  2C 03 00 00 */	cmpwi r3, 0x0
/* 803A391C 0036CEDC  41 82 00 1C */	beq .L_803A3938
/* 803A3920 0036CEE0  81 83 00 10 */	lwz r12, 0x10(r3)
/* 803A3924 0036CEE4  2C 0C 00 00 */	cmpwi r12, 0x0
...
.L_803A3938:
/* 803A3938 0036CEF8  80 9C 00 00 */	lwz r4, 0x0(r28)
...
/* 803A394C 0036CF0C  38 00 00 00 */	li r0, 0x0
/* 803A3950 0036CF10  90 1E 00 24 */	stw r0, 0x24(r30)
/* 803A3954 0036CF14  80 7F 00 00 */	lwz r3, 0x0(r31)
/* 803A3958 0036CF18  2C 03 00 00 */	cmpwi r3, 0x0
/* 803A395C 0036CF1C  41 82 00 30 */	beq .L_803A398C
/* 803A3960 0036CF20  80 1F 00 04 */	lwz r0, 0x4(r31)
/* 803A3964 0036CF24  2C 00 00 00 */	cmpwi r0, 0x0
/* 803A3968 0036CF28  41 82 00 24 */	beq .L_803A398C
/* 803A396C 0036CF2C  34 00 FF FF */	addic. r0, r0, -0x1
/* 803A3970 0036CF30  90 1F 00 04 */	stw r0, 0x4(r31)
/* 803A3974 0036CF34  40 82 00 18 */	bne .L_803A398C
/* 803A3978 0036CF38  81 83 00 04 */	lwz r12, 0x4(r3)
/* 803A397C 0036CF3C  2C 0C 00 00 */	cmpwi r12, 0x0
