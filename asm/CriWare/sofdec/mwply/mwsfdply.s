.include "macros.inc"
.file "CriWare/sofdec/mwply/mwsfdply.o"

# 0x803A1338 - 0x803A1D54
.text
.balign 4

.fn mwPlySfdStart, global
...
/* 803A134C 0036A90C  2C 03 00 00 */	cmpwi r3, 0x0
/* 803A1350 0036A910  41 82 00 28 */	beq .L_803A1378
/* 803A1354 0036A914  38 60 FE CD */	li r3, -0x133
...
/* 803A1368 0036A928  4C C6 31 82 */	crclr 4*cr1+eq
/* 803A136C 0036A92C  4B FF C8 CD */	bl MWSFSVM_Error
/* 803A1370 0036A930  38 60 FE CD */	li r3, -0x133
/* 803A1374 0036A934  48 00 00 08 */	b .L_803A137C
.L_803A1378:
/* 803A1378 0036A938  38 60 00 00 */	li r3, 0x0
.L_803A137C:
...
/* 803A13A0 0036A960  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 803A13B4 0036A974  4C C6 31 82 */	crclr 4*cr1+eq
...
/* 803A1414 0036A9D4  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 803A1428 0036A9E8  4C C6 31 82 */	crclr 4*cr1+eq
...
/* 803A145C 0036AA1C  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 803A1470 0036AA30  4C C6 31 82 */	crclr 4*cr1+eq
...
/* 803A1490 0036AA50  38 60 00 00 */	li r3, 0x0
/* 803A1494 0036AA54  90 7D 00 8C */	stw r3, 0x8c(r29)
/* 803A1498 0036AA58  2C 00 00 01 */	cmpwi r0, 0x1
...
/* 803A14AC 0036AA6C  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 803A14C0 0036AA80  4C C6 31 82 */	crclr 4*cr1+eq
/* 803A14C4 0036AA84  4B FF C7 75 */	bl MWSFSVM_Error
.L_803A14C8:
/* 803A14C8 0036AA88  38 7D 05 C8 */	addi r3, r29, 0x5c8
/* 803A14CC 0036AA8C  38 80 00 01 */	li r4, 0x1
/* 803A14D0 0036AA90  48 00 21 45 */	bl fn_803A3614
/* 803A14D4 0036AA94  38 7D 05 F0 */	addi r3, r29, 0x5f0
/* 803A14D8 0036AA98  38 80 00 01 */	li r4, 0x1
/* 803A14DC 0036AA9C  48 00 21 39 */	bl fn_803A3614
.L_803A14E0:
/* 803A14E0 0036AAA0  80 7D 00 48 */	lwz r3, 0x48(r29)
/* 803A14E4 0036AAA4  48 02 7A 51 */	bl SFD_Standby
/* 803A14E8 0036AAA8  2C 03 00 00 */	cmpwi r3, 0x0
/* 803A14EC 0036AAAC  41 82 00 1C */	beq .L_803A1508
/* 803A14F0 0036AAB0  38 60 FE C9 */	li r3, -0x137
...
/* 803A1500 0036AAC0  4C C6 31 82 */	crclr 4*cr1+eq
...
/* 803A1520 0036AAE0  2C 03 00 01 */	cmpwi r3, 0x1
/* 803A1524 0036AAE4  40 82 00 48 */	bne .L_803A156C
/* 803A1528 0036AAE8  80 1D 00 08 */	lwz r0, 0x8(r29)
/* 803A152C 0036AAEC  2C 00 00 01 */	cmpwi r0, 0x1
/* 803A1530 0036AAF0  40 82 00 3C */	bne .L_803A156C
/* 803A1534 0036AAF4  7F C3 F3 78 */	mr r3, r30
/* 803A1538 0036AAF8  38 A1 00 08 */	addi r5, r1, 0x8
/* 803A153C 0036AAFC  38 80 00 06 */	li r4, 0x6
/* 803A1540 0036AB00  48 02 B0 A1 */	bl fn_803CC5E0
/* 803A1544 0036AB04  2C 03 00 00 */	cmpwi r3, 0x0
/* 803A1548 0036AB08  40 82 00 1C */	bne .L_803A1564
/* 803A154C 0036AB0C  80 01 00 08 */	lwz r0, 0x8(r1)
/* 803A1550 0036AB10  2C 00 00 01 */	cmpwi r0, 0x1
...
.L_803A15A4:
/* 803A15A4 0036AB64  4C C6 31 82 */	crclr 4*cr1+eq
...
/* 803A1604 0036ABC4  48 00 07 61 */	bl fn_803A1D64
/* 803A1608 0036ABC8  38 60 00 00 */	li r3, 0x0
/* 803A160C 0036ABCC  38 00 00 01 */	li r0, 0x1
/* 803A1610 0036ABD0  90 7D 00 94 */	stw r3, 0x94(r29)
/* 803A1614 0036ABD4  98 7D 00 81 */	stb r3, 0x81(r29)
/* 803A1618 0036ABD8  90 1D 00 04 */	stw r0, 0x4(r29)
...
/* 803A167C 0036AC3C  38 85 00 04 */	addi r4, r5, 0x4
/* 803A1680 0036AC40  80 A6 00 00 */	lwz r5, 0x0(r6)
...
/* 803A1698 0036AC58  2C 03 00 01 */	cmpwi r3, 0x1
...
/* 803A1710 0036ACD0  48 00 01 75 */	bl fn_803A1884
/* 803A1714 0036ACD4  7F C3 F3 78 */	mr r3, r30
/* 803A1718 0036ACD8  4B FF FC B5 */	bl fn_803A13CC
/* 803A171C 0036ACDC  38 60 00 00 */	li r3, 0x0
...
/* 803A1744 0036AD04  4C C6 31 82 */	crclr 4*cr1+eq
...
.L_803A176C:
/* 803A176C 0036AD2C  3C 60 00 10 */	lis r3, 0x10
/* 803A1770 0036AD30  38 E0 00 00 */	li r7, 0x0
/* 803A1774 0036AD34  38 C3 FF FF */	addi r6, r3, -0x1
/* 803A1778 0036AD38  38 00 00 01 */	li r0, 0x1
/* 803A177C 0036AD3C  90 FE 04 E4 */	stw r7, 0x4e4(r30)
/* 803A1780 0036AD40  7F C3 F3 78 */	mr r3, r30
/* 803A1784 0036AD44  38 80 00 00 */	li r4, 0x0
/* 803A1788 0036AD48  38 A0 FF FF */	li r5, -0x1
...
/* 803A1798 0036AD58  4B FF C7 35 */	bl fn_8039DECC
/* 803A179C 0036AD5C  7F C3 F3 78 */	mr r3, r30
/* 803A17A0 0036AD60  38 80 00 00 */	li r4, 0x0
/* 803A17A4 0036AD64  38 A0 FF FF */	li r5, -0x1
/* 803A17A8 0036AD68  4B FF C7 29 */	bl fn_8039DED0
.L_803A17AC:
/* 803A17AC 0036AD6C  3C 60 80 60 */	lis r3, lbl_80602960@ha
/* 803A17B0 0036AD70  80 63 29 60 */	lwz r3, lbl_80602960@l(r3)
/* 803A17B4 0036AD74  2C 03 00 00 */	cmpwi r3, 0x0
/* 803A17B8 0036AD78  41 82 00 20 */	beq .L_803A17D8
/* 803A17BC 0036AD7C  80 83 00 00 */	lwz r4, 0x0(r3)
...
/* 803A1824 0036ADE4  4C C6 31 82 */	crclr 4*cr1+eq
/* 803A1828 0036ADE8  4B FF C4 11 */	bl MWSFSVM_Error
/* 803A182C 0036ADEC  48 00 00 40 */	b .L_803A186C
.L_803A1830:
/* 803A1830 0036ADF0  38 60 00 01 */	li r3, 0x1
/* 803A1834 0036ADF4  48 00 18 99 */	bl MWSFD_SetProhibitServer
/* 803A1838 0036ADF8  7F C3 F3 78 */	mr r3, r30
/* 803A183C 0036ADFC  48 00 00 49 */	bl fn_803A1884
/* 803A1840 0036AE00  38 00 00 00 */	li r0, 0x0
/* 803A1844 0036AE04  38 80 00 02 */	li r4, 0x2
...
/* 803A1860 0036AE20  4B FF FB 6D */	bl fn_803A13CC
/* 803A1864 0036AE24  38 60 00 00 */	li r3, 0x0
...
/* 803A18DC 0036AE9C  4C C6 31 82 */	crclr 4*cr1+eq
...
/* 803A18FC 0036AEBC  38 00 00 00 */	li r0, 0x0
/* 803A1900 0036AEC0  90 1E 06 20 */	stw r0, 0x620(r30)
/* 803A1904 0036AEC4  2C 03 00 00 */	cmpwi r3, 0x0
/* 803A1908 0036AEC8  41 82 00 08 */	beq .L_803A1910
/* 803A190C 0036AECC  4B FF C5 89 */	bl fn_8039DE94
.L_803A1910:
/* 803A1910 0036AED0  80 7E 00 54 */	lwz r3, 0x54(r30)
/* 803A1914 0036AED4  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 803A1924 0036AEE4  38 00 00 00 */	li r0, 0x0
/* 803A1928 0036AEE8  90 1E 05 28 */	stw r0, 0x528(r30)
/* 803A192C 0036AEEC  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 803A1940 0036AF00  80 83 00 00 */	lwz r4, 0x0(r3)
...
/* 803A1954 0036AF14  2C 00 00 00 */	cmpwi r0, 0x0
/* 803A1958 0036AF18  40 82 00 24 */	bne .L_803A197C
/* 803A195C 0036AF1C  38 60 00 00 */	li r3, 0x0
/* 803A1960 0036AF20  38 00 FF FF */	li r0, -0x1
...
/* 803A19A0 0036AF60  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 803A19CC 0036AF8C  2C 05 00 00 */	cmpwi r5, 0x0
...
/* 803A19E4 0036AFA4  38 84 00 04 */	addi r4, r4, 0x4
/* 803A19E8 0036AFA8  80 A5 00 00 */	lwz r5, 0x0(r5)
...
/* 803A1A00 0036AFC0  2C 03 00 01 */	cmpwi r3, 0x1
...
/* 803A1A14 0036AFD4  4C C6 31 82 */	crclr 4*cr1+eq
...
/* 803A1A2C 0036AFEC  4B FF FE 59 */	bl fn_803A1884
/* 803A1A30 0036AFF0  7F E3 FB 78 */	mr r3, r31
/* 803A1A34 0036AFF4  38 80 00 00 */	li r4, 0x0
/* 803A1A38 0036AFF8  4B FF BA F1 */	bl fn_8039D528
/* 803A1A3C 0036AFFC  38 00 00 00 */	li r0, 0x0
...
/* 803A1A54 0036B014  2C 03 00 00 */	cmpwi r3, 0x0
/* 803A1A58 0036B018  41 82 00 20 */	beq .L_803A1A78
/* 803A1A5C 0036B01C  80 83 00 00 */	lwz r4, 0x0(r3)
...
/* 803A1AB0 0036B070  2C 03 00 01 */	cmpwi r3, 0x1
...
/* 803A1AC4 0036B084  4C C6 31 82 */	crclr 4*cr1+eq
...
/* 803A1B00 0036B0C0  2C 03 00 01 */	cmpwi r3, 0x1
/* 803A1B04 0036B0C4  40 82 00 48 */	bne .L_803A1B4C
/* 803A1B08 0036B0C8  80 1D 00 08 */	lwz r0, 0x8(r29)
/* 803A1B0C 0036B0CC  2C 00 00 01 */	cmpwi r0, 0x1
/* 803A1B10 0036B0D0  40 82 00 3C */	bne .L_803A1B4C
/* 803A1B14 0036B0D4  7F E3 FB 78 */	mr r3, r31
/* 803A1B18 0036B0D8  38 A1 00 08 */	addi r5, r1, 0x8
/* 803A1B1C 0036B0DC  38 80 00 06 */	li r4, 0x6
/* 803A1B20 0036B0E0  48 02 AA C1 */	bl fn_803CC5E0
/* 803A1B24 0036B0E4  2C 03 00 00 */	cmpwi r3, 0x0
/* 803A1B28 0036B0E8  40 82 00 1C */	bne .L_803A1B44
/* 803A1B2C 0036B0EC  80 01 00 08 */	lwz r0, 0x8(r1)
/* 803A1B30 0036B0F0  2C 00 00 01 */	cmpwi r0, 0x1
...
.L_803A1B84:
/* 803A1B84 0036B144  4C C6 31 82 */	crclr 4*cr1+eq
...
/* 803A1BE4 0036B1A4  90 01 00 08 */	stw r0, 0x8(r1)
...
/* 803A1BF4 0036B1B4  C8 21 00 08 */	lfd f1, 0x8(r1)
...
/* 803A1C0C 0036B1CC  48 00 01 F9 */	bl fn_803A1E04
...
/* 803A1C38 0036B1F8  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 803A1C48 0036B208  2C 03 00 03 */	cmpwi r3, 0x3
...
/* 803A1C58 0036B218  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 803A1C6C 0036B22C  4C C6 31 82 */	crclr 4*cr1+eq
...
/* 803A1C9C 0036B25C  93 C1 00 08 */	stw r30, 0x8(r1)
...
/* 803A1CC4 0036B284  4C C6 31 82 */	crclr 4*cr1+eq
...
/* 803A1CF4 0036B2B4  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 803A1D1C 0036B2DC  2C 03 00 00 */	cmpwi r3, 0x0
/* 803A1D20 0036B2E0  40 82 00 0C */	bne .L_803A1D2C
/* 803A1D24 0036B2E4  38 60 00 00 */	li r3, 0x0
...
/* 803A1D3C 0036B2FC  54 03 0F FE */	srwi r3, r0, 31
.L_803A1D40:
...
.rodata
.balign 8
.sym lbl_8051E7B0, global
	.4byte 0x3FE99999
	.4byte 0x9999999A
.sym lbl_8051E7B8, global
	.4byte 0x43300000
	.4byte 0x80000000
.sym lbl_8051E7C0, global
	.4byte 0x45323030
	.4byte 0x31303730
	.4byte 0x3346206D
	.4byte 0x77506C79
