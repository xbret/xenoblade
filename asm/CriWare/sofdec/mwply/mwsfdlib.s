...
/* 803A0C70 0036A230  4C C6 31 82 */	crclr 4*cr1+eq
...
/* 803A0C80 0036A240  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 803A0CB8 0036A278  4C C6 31 82 */	crclr 4*cr1+eq
/* 803A0CBC 0036A27C  4B FF CF 7D */	bl MWSFSVM_Error
/* 803A0CC0 0036A280  48 00 02 00 */	b .L_803A0EC0
.L_803A0CC4:
/* 803A0CC4 0036A284  80 7F 00 08 */	lwz r3, 0x8(r31)
/* 803A0CC8 0036A288  2C 03 00 00 */	cmpwi r3, 0x0
/* 803A0CCC 0036A28C  41 82 00 20 */	beq .L_803A0CEC
/* 803A0CD0 0036A290  80 83 00 00 */	lwz r4, 0x0(r3)
...
/* 803A0CE0 0036A2A0  38 85 00 04 */	addi r4, r5, 0x4
/* 803A0CE4 0036A2A4  7D 89 03 A6 */	mtctr r12
/* 803A0CE8 0036A2A8  4E 80 04 21 */	bctrl
.L_803A0CEC:
/* 803A0CEC 0036A2AC  38 61 00 08 */	addi r3, r1, 0x8
/* 803A0CF0 0036A2B0  38 80 00 00 */	li r4, 0x0
/* 803A0CF4 0036A2B4  38 A0 00 20 */	li r5, 0x20
/* 803A0CF8 0036A2B8  4B C6 36 59 */	bl memset
/* 803A0CFC 0036A2BC  C0 1C 00 00 */	lfs f0, 0x0(r28)
/* 803A0D00 0036A2C0  38 60 00 01 */	li r3, 0x1
/* 803A0D04 0036A2C4  38 1E 00 00 */	addi r0, r30, 0x0
/* 803A0D08 0036A2C8  3B A1 00 08 */	addi r29, r1, 0x8
/* 803A0D0C 0036A2CC  D0 01 00 08 */	stfs f0, 0x8(r1)
...
/* 803A0D4C 0036A30C  34 03 FF FE */	addic. r0, r3, -0x2
/* 803A0D50 0036A310  90 01 00 10 */	stw r0, 0x10(r1)
/* 803A0D54 0036A314  40 80 00 0C */	bge .L_803A0D60
/* 803A0D58 0036A318  38 00 00 00 */	li r0, 0x0
/* 803A0D5C 0036A31C  90 01 00 10 */	stw r0, 0x10(r1)
.L_803A0D60:
/* 803A0D60 0036A320  80 1F 00 00 */	lwz r0, 0x0(r31)
/* 803A0D64 0036A324  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 803A0D80 0036A340  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 803A0D90 0036A350  38 00 FF 9B */	li r0, -0x65
...
/* 803A0DA0 0036A360  4C C6 31 82 */	crclr 4*cr1+eq
...
/* 803A0DB4 0036A374  38 00 00 00 */	li r0, 0x0
/* 803A0DB8 0036A378  C0 21 00 08 */	lfs f1, 0x8(r1)
...
/* 803A0DDC 0036A39C  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 803A0DF0 0036A3B0  4C C6 31 82 */	crclr 4*cr1+eq
/* 803A0DF4 0036A3B4  4B FF CE 45 */	bl MWSFSVM_Error
.L_803A0DF8:
/* 803A0DF8 0036A3B8  C0 01 00 08 */	lfs f0, 0x8(r1)
/* 803A0DFC 0036A3BC  38 00 00 01 */	li r0, 0x1
/* 803A0E00 0036A3C0  90 1F 00 04 */	stw r0, 0x4(r31)
/* 803A0E04 0036A3C4  38 60 00 00 */	li r3, 0x0
...
/* 803A0E1C 0036A3DC  38 60 00 00 */	li r3, 0x0
/* 803A0E20 0036A3E0  38 80 00 07 */	li r4, 0x7
/* 803A0E24 0036A3E4  38 A0 00 01 */	li r5, 0x1
...
/* 803A0E34 0036A3F4  38 80 00 00 */	li r4, 0x0
...
/* 803A0E50 0036A410  38 60 00 02 */	li r3, 0x2
/* 803A0E54 0036A414  38 84 25 6C */	addi r4, r4, MWSFSVR_VsyncThrdProc@l
/* 803A0E58 0036A418  38 A0 00 00 */	li r5, 0x0
...
.L_803A0E8C:
/* 803A0E8C 0036A44C  80 9F 00 00 */	lwz r4, 0x0(r31)
/* 803A0E90 0036A450  80 7F 00 08 */	lwz r3, 0x8(r31)
/* 803A0E94 0036A454  38 04 00 01 */	addi r0, r4, 0x1
/* 803A0E98 0036A458  2C 03 00 00 */	cmpwi r3, 0x0
/* 803A0E9C 0036A45C  90 1F 00 00 */	stw r0, 0x0(r31)
/* 803A0EA0 0036A460  41 82 00 20 */	beq .L_803A0EC0
/* 803A0EA4 0036A464  80 83 00 00 */	lwz r4, 0x0(r3)
...
/* 803A0EE8 0036A4A8  38 80 00 00 */	li r4, 0x0
...
/* 803A0F00 0036A4C0  93 C1 00 08 */	stw r30, 0x8(r1)
/* 803A0F04 0036A4C4  7C 7E 1B 78 */	mr r30, r3
/* 803A0F08 0036A4C8  7F E3 FB 78 */	mr r3, r31
/* 803A0F0C 0036A4CC  4B C6 34 45 */	bl memset
/* 803A0F10 0036A4D0  38 60 00 00 */	li r3, 0x0
/* 803A0F14 0036A4D4  48 00 20 05 */	bl MWSFSVR_SetMwsfdSvrFlg
/* 803A0F18 0036A4D8  38 80 00 00 */	li r4, 0x0
/* 803A0F1C 0036A4DC  2C 1E 00 00 */	cmpwi r30, 0x0
/* 803A0F20 0036A4E0  90 9F 00 5C */	stw r4, 0x5c(r31)
/* 803A0F24 0036A4E4  41 82 00 28 */	beq .L_803A0F4C
/* 803A0F28 0036A4E8  C0 1E 00 00 */	lfs f0, 0x0(r30)
/* 803A0F2C 0036A4EC  D0 1F 00 04 */	stfs f0, 0x4(r31)
/* 803A0F30 0036A4F0  80 1E 00 04 */	lwz r0, 0x4(r30)
/* 803A0F34 0036A4F4  90 1F 00 08 */	stw r0, 0x8(r31)
/* 803A0F38 0036A4F8  80 1E 00 08 */	lwz r0, 0x8(r30)
...
/* 803A0F50 0036A510  38 00 00 01 */	li r0, 0x1
/* 803A0F54 0036A514  C0 03 E4 04 */	lfs f0, lbl_8051E404@l(r3)
/* 803A0F58 0036A518  90 1F 00 08 */	stw r0, 0x8(r31)
/* 803A0F5C 0036A51C  D0 1F 00 04 */	stfs f0, 0x4(r31)
/* 803A0F60 0036A520  90 1F 00 0C */	stw r0, 0xc(r31)
/* 803A0F64 0036A524  90 9F 00 10 */	stw r4, 0x10(r31)
.L_803A0F68:
/* 803A0F68 0036A528  38 00 00 00 */	li r0, 0x0
/* 803A0F6C 0036A52C  38 60 00 01 */	li r3, 0x1
...
/* 803A0F80 0036A540  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 803A0FC0 0036A580  54 00 DF FE */	extrwi r0, r0, 1, 26
...
/* 803A10A0 0036A660  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 803A1104 0036A6C4  38 04 00 01 */	addi r0, r4, 0x1
/* 803A1108 0036A6C8  90 1F 34 14 */	stw r0, 0x3414(r31)
.L_803A110C:
/* 803A110C 0036A6CC  3C 60 FF 00 */	lis r3, 0xff00
/* 803A1110 0036A6D0  38 03 0F 15 */	addi r0, r3, 0xf15
...
.L_803A119C:
/* 803A119C 0036A75C  2C 1E FF FF */	cmpwi r30, -0x1
/* 803A11A0 0036A760  40 80 01 54 */	bge .L_803A12F4
/* 803A11A4 0036A764  2C 1E FF FD */	cmpwi r30, -0x3
...
/* 803A11C4 0036A784  4C C6 31 82 */	crclr 4*cr1+eq
/* 803A11C8 0036A788  4B F1 FE 71 */	bl sprintf
/* 803A11CC 0036A78C  48 00 01 44 */	b .L_803A1310
.L_803A11D0:
/* 803A11D0 0036A790  2C 1D 00 00 */	cmpwi r29, 0x0
/* 803A11D4 0036A794  38 60 00 00 */	li r3, 0x0
/* 803A11D8 0036A798  38 C0 00 00 */	li r6, 0x0
/* 803A11DC 0036A79C  38 E0 00 00 */	li r7, 0x0
/* 803A11E0 0036A7A0  41 82 00 2C */	beq .L_803A120C
/* 803A11E4 0036A7A4  80 1D 00 D0 */	lwz r0, 0xd0(r29)
/* 803A11E8 0036A7A8  2C 00 00 01 */	cmpwi r0, 0x1
...
/* 803A11F8 0036A7B8  2C 06 00 00 */	cmpwi r6, 0x0
/* 803A11FC 0036A7BC  40 81 00 10 */	ble .L_803A120C
/* 803A1200 0036A7C0  2C 07 00 00 */	cmpwi r7, 0x0
/* 803A1204 0036A7C4  40 81 00 08 */	ble .L_803A120C
/* 803A1208 0036A7C8  38 60 00 01 */	li r3, 0x1
.L_803A120C:
/* 803A120C 0036A7CC  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 803A1228 0036A7E8  4C C6 31 82 */	crclr 4*cr1+eq
...
/* 803A1248 0036A808  4C C6 31 82 */	crclr 4*cr1+eq
...
/* 803A1268 0036A828  4C C6 31 82 */	crclr 4*cr1+eq
...
/* 803A1288 0036A848  4C C6 31 82 */	crclr 4*cr1+eq
...
/* 803A12A8 0036A868  4C C6 31 82 */	crclr 4*cr1+eq
...
/* 803A12C8 0036A888  4C C6 31 82 */	crclr 4*cr1+eq
...
/* 803A12E8 0036A8A8  4C C6 31 82 */	crclr 4*cr1+eq
...
/* 803A1308 0036A8C8  4C C6 31 82 */	crclr 4*cr1+eq
/* 803A130C 0036A8CC  4B F1 FD 2D */	bl sprintf
.L_803A1310:
/* 803A1310 0036A8D0  38 7F 34 58 */	addi r3, r31, 0x3458
/* 803A1314 0036A8D4  4C C6 31 82 */	crclr 4*cr1+eq
...
.rodata
.balign 8
.sym lbl_8051E1E0, local
	.4byte 0x6D77506C
	.4byte 0x79537461
	.4byte 0x7274466E
	.4byte 0x616D6500
.sym lbl_8051E1F0, local
	.4byte 0x666E616D
	.4byte 0x65000000
	.4byte 0x6D77506C
	.4byte 0x79537461
	...
	.4byte 0x64000000
	.4byte 0x66696400
.sym lbl_8051E274, local
	.4byte 0x6D77506C
	.4byte 0x79537461
	.4byte 0x7274466E
	.4byte 0x616D654C
	.4byte 0x70000000
.sym lbl_8051E288, local
	.4byte 0x6D77506C
	.4byte 0x7952656C
	.4byte 0x65617365
	.4byte 0x4C700000
	...
	.4byte 0x616E6765
	.4byte 0x4C700000
.sym lbl_8051E2C0, local
	.4byte 0x6D77506C
	.4byte 0x79456E74
	.4byte 0x7279466E
	.4byte 0x616D6500
.sym lbl_8051E2D0, local
	.4byte 0x6D77506C
	.4byte 0x79537461
	.4byte 0x72745365
	.4byte 0x616D6C65
	.4byte 0x73730000
.sym lbl_8051E2E4, local
	.4byte 0x6D77506C
	.4byte 0x7952656C
	.4byte 0x65617365
	.4byte 0x5365616D
	.4byte 0x6C657373
	.4byte 0x00000000
.sym lbl_8051E2FC, local
	.4byte 0x6D77506C
	.4byte 0x79536574
	.4byte 0x5365616D
	.4byte 0x6C657373
	.4byte 0x4C700000
.sym lbl_8051E310, local
	.4byte 0x666C6167
	.4byte 0x00000000
.sym lbl_8051E318, local
	.4byte 0x6D77506C
	.4byte 0x7953746F
	.4byte 0x70000000
	.4byte 0x6D77506C
	...
	.4byte 0x53746F70
	.4byte 0x00000000
.sym lbl_8051E338, local
	.4byte 0x4D575346
	.4byte 0x53564D5F
	.4byte 0x4572726F
	.4byte 0x72000000
.sym lbl_8051E348, local
	.4byte 0x65727273
	.4byte 0x74720000
.sym lbl_8051E350, local
	.4byte 0x4D575346
	.4byte 0x53564D5F
	.4byte 0x476F746F
	.4byte 0x49646C65
...
.sym lbl_8051E368, local
	...
	.4byte 0x6450726F
	.4byte 0x63000000
.sym lbl_8051E380, local
	.4byte 0x72656D61
	.4byte 0x696E5F77
	.4byte 0x6F726B5F
	.4byte 0x666C6167
	.4byte 0x00000000
.sym lbl_8051E394, local
	.4byte 0x4D575346
	.4byte 0x5356525F
	.4byte 0x4D61696E
	.4byte 0x54687264
...
.sym lbl_8051E3C4, local
	...
	.4byte 0x72766572
	.4byte 0x00000000
.sym lbl_8051E3DC, local
	.4byte 0x6D777366
	.4byte 0x645F4578
	.4byte 0x65635376
	.4byte 0x72486E64
	.4byte 0x6C000000
.sym lbl_8051E3F0, local
	.4byte 0x6D775366
	.4byte 0x64567379
	.4byte 0x6E630000
	.4byte 0x3F000000
	.4byte 0x447A0000
.sym lbl_8051E404, local
	.4byte 0x426FC28F
.sym lbl_8051E408, local
	.4byte 0x45313132
	.4byte 0x32363131
	.4byte 0x206D7750
	.4byte 0x6C79496E
...
.balign 8
.sym lbl_80602958, local
	.skip 0x4
.sym lbl_8060295C, local
	.skip 0x4
.sym lbl_80602960, local
	.skip 0x8
