...
/* 80424FF4 003EE5B4  4B FF D5 A5 */	bl func_80422598
...
/* 80425024 003EE5E4  40 80 01 78 */	bge lbl_8042519C
...
/* 80425040 003EE600  39 49 00 01 */	addi r10, r9, 1
/* 80425044 003EE604  2C 0A 00 08 */	cmpwi r10, 8
/* 80425048 003EE608  40 81 01 18 */	ble lbl_80425160
/* 8042504C 003EE60C  7C 06 18 40 */	cmplw r6, r3
/* 80425050 003EE610  38 60 00 00 */	li r3, 0
/* 80425054 003EE614  38 C0 00 00 */	li r6, 0
/* 80425058 003EE618  41 81 00 28 */	bgt lbl_80425080
/* 8042505C 003EE61C  54 E0 00 01 */	rlwinm. r0, r7, 0, 0, 0
/* 80425060 003EE620  38 E0 00 01 */	li r7, 1
/* 80425064 003EE624  40 82 00 10 */	bne lbl_80425074
/* 80425068 003EE628  55 00 00 01 */	rlwinm. r0, r8, 0, 0, 0
/* 8042506C 003EE62C  41 82 00 08 */	beq lbl_80425074
/* 80425070 003EE630  38 E0 00 00 */	li r7, 0
lbl_80425074:
/* 80425074 003EE634  2C 07 00 00 */	cmpwi r7, 0
/* 80425078 003EE638  41 82 00 08 */	beq lbl_80425080
/* 8042507C 003EE63C  38 C0 00 01 */	li r6, 1
lbl_80425080:
/* 80425080 003EE640  2C 06 00 00 */	cmpwi r6, 0
/* 80425084 003EE644  41 82 00 2C */	beq lbl_804250B0
/* 80425088 003EE648  55 27 00 01 */	rlwinm. r7, r9, 0, 0, 0
/* 8042508C 003EE64C  38 C0 00 01 */	li r6, 1
/* 80425090 003EE650  40 82 00 14 */	bne lbl_804250A4
/* 80425094 003EE654  55 40 00 00 */	rlwinm r0, r10, 0, 0, 0
/* 80425098 003EE658  7C 07 00 00 */	cmpw r7, r0
/* 8042509C 003EE65C  41 82 00 08 */	beq lbl_804250A4
/* 804250A0 003EE660  38 C0 00 00 */	li r6, 0
lbl_804250A4:
/* 804250A4 003EE664  2C 06 00 00 */	cmpwi r6, 0
/* 804250A8 003EE668  41 82 00 08 */	beq lbl_804250B0
/* 804250AC 003EE66C  38 60 00 01 */	li r3, 1
lbl_804250B0:
/* 804250B0 003EE670  2C 03 00 00 */	cmpwi r3, 0
/* 804250B4 003EE674  41 82 00 AC */	beq lbl_80425160
...
/* 804250D4 003EE694  40 80 00 8C */	bge lbl_80425160
lbl_804250D8:
/* 804250D8 003EE698  D0 05 00 00 */	stfs f0, 0(r5)
/* 804250DC 003EE69C  D0 05 00 04 */	stfs f0, 4(r5)
/* 804250E0 003EE6A0  90 65 00 08 */	stw r3, 8(r5)
...
/* 8042515C 003EE71C  42 00 FF 7C */	bdnz lbl_804250D8
lbl_80425160:
...
/* 80425180 003EE740  40 80 00 1C */	bge lbl_8042519C
lbl_80425184:
/* 80425184 003EE744  D0 05 00 00 */	stfs f0, 0(r5)
/* 80425188 003EE748  D0 05 00 04 */	stfs f0, 4(r5)
/* 8042518C 003EE74C  90 85 00 08 */	stw r4, 8(r5)
/* 80425190 003EE750  90 85 00 0C */	stw r4, 0xc(r5)
/* 80425194 003EE754  38 A5 00 10 */	addi r5, r5, 0x10
/* 80425198 003EE758  42 00 FF EC */	bdnz lbl_80425184
lbl_8042519C:
/* 8042519C 003EE75C  7F E3 FB 78 */	mr r3, r31
/* 804251A0 003EE760  83 E1 00 0C */	lwz r31, 0xc(r1)
/* 804251A4 003EE764  83 C1 00 08 */	lwz r30, 8(r1)
...
/* 804251CC 003EE78C  4B FE D3 B1 */	bl func_8041257C
...
/* 80425208 003EE7C8  41 80 00 0C */	blt lbl_80425214
/* 8042520C 003EE7CC  C0 3F 0E 50 */	lfs f1, 0xe50(r31)
/* 80425210 003EE7D0  48 00 00 40 */	b lbl_80425250
lbl_80425214:
/* 80425214 003EE7D4  6C A0 80 00 */	xoris r0, r5, 0x8000
/* 80425218 003EE7D8  90 81 00 08 */	stw r4, 8(r1)
...
/* 80425228 003EE7E8  C8 81 00 08 */	lfd f4, 8(r1)
...
/* 80425274 003EE834  41 80 00 0C */	blt lbl_80425280
/* 80425278 003EE838  C0 3F 0E 60 */	lfs f1, 0xe60(r31)
/* 8042527C 003EE83C  48 00 00 40 */	b lbl_804252BC
lbl_80425280:
/* 80425280 003EE840  6C A0 80 00 */	xoris r0, r5, 0x8000
/* 80425284 003EE844  90 81 00 08 */	stw r4, 8(r1)
...
/* 80425294 003EE854  C8 81 00 08 */	lfd f4, 8(r1)
...
/* 804252C0 003EE880  38 C6 00 01 */	addi r6, r6, 1
...
/* 804252D4 003EE894  42 00 FF 20 */	bdnz lbl_804251F4
...
/* 80425318 003EE8D8  81 83 00 00 */	lwz r12, 0(r3)
...
/* 8042532C 003EE8EC  4B FE E4 25 */	bl func_80413750
...
/* 80425344 003EE904  4B FF D4 FD */	bl func_80422840
...
/* 80425394 003EE954  4B FF D7 55 */	bl func_80422AE8
/* 80425398 003EE958  2C 03 00 00 */	cmpwi r3, 0
/* 8042539C 003EE95C  40 82 00 14 */	bne lbl_804253B0
/* 804253A0 003EE960  38 7F 01 0C */	addi r3, r31, 0x10c
/* 804253A4 003EE964  4B FF D6 B5 */	bl func_80422A58
/* 804253A8 003EE968  38 60 00 00 */	li r3, 0
/* 804253AC 003EE96C  48 00 00 08 */	b lbl_804253B4
lbl_804253B0:
/* 804253B0 003EE970  38 60 00 01 */	li r3, 1
lbl_804253B4:
...
/* 804253E4 003EE9A4  4B FE DD AD */	bl func_80413190
/* 804253E8 003EE9A8  7F BF EB 78 */	mr r31, r29
/* 804253EC 003EE9AC  3B C0 00 00 */	li r30, 0
lbl_804253F0:
/* 804253F0 003EE9B0  7F C4 F3 78 */	mr r4, r30
/* 804253F4 003EE9B4  38 7D 01 0C */	addi r3, r29, 0x10c
/* 804253F8 003EE9B8  4B FF F8 0D */	bl func_80424C04
/* 804253FC 003EE9BC  2C 03 00 00 */	cmpwi r3, 0
/* 80425400 003EE9C0  41 82 00 1C */	beq lbl_8042541C
...
/* 80425410 003EE9D0  40 80 00 0C */	bge lbl_8042541C
/* 80425414 003EE9D4  38 03 00 01 */	addi r0, r3, 1
/* 80425418 003EE9D8  90 1F 0E 58 */	stw r0, 0xe58(r31)
lbl_8042541C:
/* 8042541C 003EE9DC  3B DE 00 01 */	addi r30, r30, 1
/* 80425420 003EE9E0  3B FF 00 10 */	addi r31, r31, 0x10
/* 80425424 003EE9E4  2C 1E 00 08 */	cmpwi r30, 8
/* 80425428 003EE9E8  41 80 FF C8 */	blt lbl_804253F0
...
/* 80425458 003EEA18  F3 E1 00 38 */	psq_st f31, 56(r1), 0, qr0
...
/* 80425468 003EEA28  4B FE DD 5D */	bl func_804131C4
...
/* 80425488 003EEA48  4B FF F7 7D */	bl func_80424C04
/* 8042548C 003EEA4C  2C 03 00 00 */	cmpwi r3, 0
/* 80425490 003EEA50  41 82 00 68 */	beq lbl_804254F8
...
/* 804254A8 003EEA68  41 80 00 0C */	blt lbl_804254B4
/* 804254AC 003EEA6C  C0 3D 0E 50 */	lfs f1, 0xe50(r29)
/* 804254B0 003EEA70  48 00 00 44 */	b lbl_804254F4
lbl_804254B4:
...
/* 804254C4 003EEA84  93 E1 00 08 */	stw r31, 8(r1)
/* 804254C8 003EEA88  C0 5D 0E 4C */	lfs f2, 0xe4c(r29)
/* 804254CC 003EEA8C  C8 61 00 08 */	lfd f3, 8(r1)
...
lbl_804254F4:
/* 804254F4 003EEAB4  4B FF F6 91 */	bl func_80424B84
lbl_804254F8:
/* 804254F8 003EEAB8  3B 9C 00 01 */	addi r28, r28, 1
/* 804254FC 003EEABC  3B BD 00 10 */	addi r29, r29, 0x10
/* 80425500 003EEAC0  2C 1C 00 08 */	cmpwi r28, 8
/* 80425504 003EEAC4  41 80 FF 7C */	blt lbl_80425480
/* 80425508 003EEAC8  E3 E1 00 38 */	psq_l f31, 56(r1), 0, qr0
...
/* 80425544 003EEB04  4B FE E0 5D */	bl func_804135A0
...
/* 80425558 003EEB18  80 1E 00 04 */	lwz r0, 4(r30)
/* 8042555C 003EEB1C  2C 00 00 00 */	cmpwi r0, 0
/* 80425560 003EEB20  40 82 00 10 */	bne lbl_80425570
/* 80425564 003EEB24  7F E3 FB 78 */	mr r3, r31
/* 80425568 003EEB28  4B F3 47 D9 */	bl OSUnlockMutex
/* 8042556C 003EEB2C  48 00 00 3C */	b lbl_804255A8
lbl_80425570:
/* 80425570 003EEB30  38 7E 00 04 */	addi r3, r30, 4
/* 80425574 003EEB34  38 9D 00 EC */	addi r4, r29, 0xec
/* 80425578 003EEB38  48 00 5F D5 */	bl func_8042B54C
/* 8042557C 003EEB3C  81 9D 00 00 */	lwz r12, 0(r29)
/* 80425580 003EEB40  7F A3 EB 78 */	mr r3, r29
/* 80425584 003EEB44  38 80 FF FF */	li r4, -1
...
/* 8042559C 003EEB5C  4B FF 19 7D */	bl func_80416F18
...
/* 804255DC 003EEB9C  93 C1 00 08 */	stw r30, 8(r1)
/* 804255E0 003EEBA0  7C 7E 1B 78 */	mr r30, r3
/* 804255E4 003EEBA4  41 82 00 20 */	beq lbl_80425604
/* 804255E8 003EEBA8  38 80 FF FF */	li r4, -1
/* 804255EC 003EEBAC  38 63 01 0C */	addi r3, r3, 0x10c
/* 804255F0 003EEBB0  4B FF D1 51 */	bl func_80422740
/* 804255F4 003EEBB4  2C 1F 00 00 */	cmpwi r31, 0
/* 804255F8 003EEBB8  40 81 00 0C */	ble lbl_80425604
/* 804255FC 003EEBBC  7F C3 F3 78 */	mr r3, r30
/* 80425600 003EEBC0  48 00 F6 2D */	bl func_80434C2C
lbl_80425604:
/* 80425604 003EEBC4  7F C3 F3 78 */	mr r3, r30
/* 80425608 003EEBC8  83 E1 00 0C */	lwz r31, 0xc(r1)
/* 8042560C 003EEBCC  83 C1 00 08 */	lwz r30, 8(r1)
...
/* 80425650 003EEC10  40 81 00 0C */	ble lbl_8042565C
/* 80425654 003EEC14  3B A0 00 7F */	li r29, 0x7f
/* 80425658 003EEC18  48 00 00 0C */	b lbl_80425664
lbl_8042565C:
/* 8042565C 003EEC1C  7C 80 FE 70 */	srawi r0, r4, 0x1f
...
/* 80425678 003EEC38  38 7E 00 04 */	addi r3, r30, 4
/* 8042567C 003EEC3C  7F 84 E3 78 */	mr r4, r28
/* 80425680 003EEC40  48 00 5E CD */	bl func_8042B54C
/* 80425684 003EEC44  80 7E 00 08 */	lwz r3, 8(r30)
/* 80425688 003EEC48  38 1E 00 08 */	addi r0, r30, 8
/* 8042568C 003EEC4C  48 00 00 34 */	b lbl_804256C0
lbl_80425690:
...
/* 804256A0 003EEC60  40 81 00 0C */	ble lbl_804256AC
/* 804256A4 003EEC64  38 80 00 7F */	li r4, 0x7f
/* 804256A8 003EEC68  48 00 00 0C */	b lbl_804256B4
lbl_804256AC:
/* 804256AC 003EEC6C  7C A4 FE 70 */	srawi r4, r5, 0x1f
/* 804256B0 003EEC70  7C A4 20 78 */	andc r4, r5, r4
lbl_804256B4:
/* 804256B4 003EEC74  7C 1D 20 00 */	cmpw r29, r4
/* 804256B8 003EEC78  41 80 00 10 */	blt lbl_804256C8
/* 804256BC 003EEC7C  80 63 00 00 */	lwz r3, 0(r3)
lbl_804256C0:
/* 804256C0 003EEC80  7C 03 00 40 */	cmplw r3, r0
/* 804256C4 003EEC84  40 82 FF CC */	bne lbl_80425690
lbl_804256C8:
/* 804256C8 003EEC88  90 61 00 08 */	stw r3, 8(r1)
