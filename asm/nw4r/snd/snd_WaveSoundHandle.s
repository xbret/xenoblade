.include "macros.inc"
.file "nw4r/snd/snd_WaveSoundHandle.o"

# 0x80429F38 - 0x80429F70
.text
.balign 4

# nw4r::snd::WaveSoundHandle::DetachSound()
.fn DetachSound__Q34nw4r3snd15WaveSoundHandleFv, global
/* 80429F38 003F34F8  80 83 00 00 */	lwz r4, 0x0(r3)
/* 80429F3C 003F34FC  2C 04 00 00 */	cmpwi r4, 0x0
...
/* 80429F50 003F3510  38 00 00 00 */	li r0, 0x0
/* 80429F54 003F3514  90 04 02 44 */	stw r0, 0x244(r4)
.L_80429F58:
/* 80429F58 003F3518  80 03 00 00 */	lwz r0, 0x0(r3)
/* 80429F5C 003F351C  2C 00 00 00 */	cmpwi r0, 0x0
/* 80429F60 003F3520  4D 82 00 20 */	beqlr
/* 80429F64 003F3524  38 00 00 00 */	li r0, 0x0
/* 80429F68 003F3528  90 03 00 00 */	stw r0, 0x0(r3)
