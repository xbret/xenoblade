...
/* 8041896C 003E1F2C  38 00 00 00 */	li r0, 0x0
/* 80418970 003E1F30  38 84 E3 C8 */	addi r4, r4, lbl_8056E3C8@l
/* 80418974 003E1F34  90 03 00 04 */	stw r0, 0x4(r3)
/* 80418978 003E1F38  90 83 00 00 */	stw r4, 0x0(r3)
/* 8041897C 003E1F3C  90 03 00 08 */	stw r0, 0x8(r3)
...
/* 804189A0 003E1F60  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 804189C8 003E1F88  90 83 00 00 */	stw r4, 0x0(r3)
...
/* 804189E8 003E1FA8  38 C0 00 00 */	li r6, 0x0
...
/* 80418A04 003E1FC4  38 C0 00 00 */	li r6, 0x0
...
/* 80418A24 003E1FE4  38 00 00 00 */	li r0, 0x0
/* 80418A28 003E1FE8  2C 1E 00 00 */	cmpwi r30, 0x0
...
# nw4r::snd::detail::PlayerHeap::Create(void*, unsigned long)
...
/* 80418A84 003E2044  38 60 00 01 */	li r3, 0x1
/* 80418A88 003E2048  4E 80 00 20 */	blr
.endfn Create__Q44nw4r3snd6detail10PlayerHeapFPvUl

# nw4r::snd::detail::PlayerHeap::Alloc(unsigned long)
...
/* 80418AA0 003E2060  38 60 00 00 */	li r3, 0x0
/* 80418AA4 003E2064  4E 80 00 20 */	blr
.L_80418AA8:
/* 80418AA8 003E2068  38 04 00 1F */	addi r0, r4, 0x1f
/* 80418AAC 003E206C  54 00 00 34 */	clrrwi r0, r0, 5
...
# nw4r::snd::detail::PlayerHeap::Clear()
...
/* 80418ACC 003E208C  93 C1 00 08 */	stw r30, 0x8(r1)
...
/* 80418AF0 003E20B0  38 C0 00 00 */	li r6, 0x0
...
/* 80418B0C 003E20CC  38 C0 00 00 */	li r6, 0x0
...
/* 80418B34 003E20F4  83 C1 00 08 */	lwz r30, 0x8(r1)
...
# nw4r::snd::detail::PlayerHeap::GetFreeSize() const
