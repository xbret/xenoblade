.include "macros.inc"
.file "nw4r/snd/snd_WaveFile.o"

# 0x8042984C - 0x80429BD8
.text
.balign 4

# nw4r::snd::detail::WaveArchiveReader::WaveArchiveReader(const void*)
.fn __ct__Q44nw4r3snd6detail17WaveArchiveReaderFPCv, global
/* 8042984C 003F2E0C  80 A4 00 00 */	lwz r5, 0x0(r4)
/* 80429850 003F2E10  38 C0 00 00 */	li r6, 0x0
/* 80429854 003F2E14  90 C3 00 00 */	stw r6, 0x0(r3)
/* 80429858 003F2E18  3C 05 AD A9 */	addis r0, r5, 0xada9
/* 8042985C 003F2E1C  28 00 41 52 */	cmplwi r0, 0x4152
/* 80429860 003F2E20  90 C3 00 04 */	stw r6, 0x4(r3)
/* 80429864 003F2E24  41 82 00 0C */	beq .L_80429870
/* 80429868 003F2E28  38 00 00 00 */	li r0, 0x0
/* 8042986C 003F2E2C  48 00 00 30 */	b .L_8042989C
.L_80429870:
/* 80429870 003F2E30  A0 C4 00 06 */	lhz r6, 0x6(r4)
/* 80429874 003F2E34  28 06 01 00 */	cmplwi r6, 0x100
/* 80429878 003F2E38  40 80 00 0C */	bge .L_80429884
/* 8042987C 003F2E3C  38 00 00 00 */	li r0, 0x0
/* 80429880 003F2E40  48 00 00 1C */	b .L_8042989C
.L_80429884:
...
/* 80429898 003F2E58  54 00 0F FE */	srwi r0, r0, 31
.L_8042989C:
/* 8042989C 003F2E5C  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 804298B4 003F2E74  90 A3 00 04 */	stw r5, 0x4(r3)
/* 804298B8 003F2E78  90 03 00 00 */	stw r0, 0x0(r3)
/* 804298BC 003F2E7C  4E 80 00 20 */	blr
.endfn __ct__Q44nw4r3snd6detail17WaveArchiveReaderFPCv

# nw4r::snd::detail::WaveArchiveReader::GetWaveFile(int) const
...
/* 804298C8 003F2E88  80 C3 00 00 */	lwz r6, 0x0(r3)
/* 804298CC 003F2E8C  90 01 00 14 */	stw r0, 0x14(r1)
/* 804298D0 003F2E90  2C 06 00 00 */	cmpwi r6, 0x0
/* 804298D4 003F2E94  40 82 00 0C */	bne .L_804298E0
/* 804298D8 003F2E98  38 60 00 00 */	li r3, 0x0
/* 804298DC 003F2E9C  48 00 00 5C */	b .L_80429938
.L_804298E0:
/* 804298E0 003F2EA0  80 A3 00 04 */	lwz r5, 0x4(r3)
/* 804298E4 003F2EA4  2C 05 00 00 */	cmpwi r5, 0x0
/* 804298E8 003F2EA8  40 82 00 0C */	bne .L_804298F4
/* 804298EC 003F2EAC  38 60 00 00 */	li r3, 0x0
/* 804298F0 003F2EB0  48 00 00 48 */	b .L_80429938
.L_804298F4:
/* 804298F4 003F2EB4  2C 04 00 00 */	cmpwi r4, 0x0
/* 804298F8 003F2EB8  40 80 00 0C */	bge .L_80429904
/* 804298FC 003F2EBC  38 60 00 00 */	li r3, 0x0
/* 80429900 003F2EC0  48 00 00 38 */	b .L_80429938
.L_80429904:
/* 80429904 003F2EC4  80 06 00 08 */	lwz r0, 0x8(r6)
/* 80429908 003F2EC8  7C 04 00 40 */	cmplw r4, r0
/* 8042990C 003F2ECC  41 80 00 0C */	blt .L_80429918
/* 80429910 003F2ED0  38 60 00 00 */	li r3, 0x0
/* 80429914 003F2ED4  48 00 00 24 */	b .L_80429938
.L_80429918:
...
/* 80429928 003F2EE8  90 01 00 08 */	stw r0, 0x8(r1)
/* 8042992C 003F2EEC  90 81 00 0C */	stw r4, 0xc(r1)
/* 80429930 003F2EF0  88 61 00 08 */	lbz r3, 0x8(r1)
...
# nw4r::snd::detail::WaveFileReader::WaveFileReader(const nw4r::snd::detail::WaveFile::FileHeader*)
.fn __ct__Q44nw4r3snd6detail14WaveFileReaderFPCQ54nw4r3snd6detail8WaveFile10FileHeader, global
/* 80429948 003F2F08  38 00 00 00 */	li r0, 0x0
/* 8042994C 003F2F0C  90 03 00 00 */	stw r0, 0x0(r3)
...
/* 8042995C 003F2F1C  38 04 00 08 */	addi r0, r4, 0x8
/* 80429960 003F2F20  90 03 00 00 */	stw r0, 0x0(r3)
...
/* 80429968 003F2F28  90 83 00 00 */	stw r4, 0x0(r3)
/* 8042996C 003F2F2C  4E 80 00 20 */	blr
.endfn __ct__Q44nw4r3snd6detail14WaveFileReaderFPCQ54nw4r3snd6detail8WaveFile8WaveInfo

# nw4r::snd::detail::WaveFileReader::ReadWaveInfo(nw4r::snd::detail::WaveInfo*, const void*) const
...
/* 80429984 003F2F44  80 C3 00 00 */	lwz r6, 0x0(r3)
/* 80429988 003F2F48  7C 7B 1B 78 */	mr r27, r3
/* 8042998C 003F2F4C  7C 9D 23 78 */	mr r29, r4
/* 80429990 003F2F50  7C BC 2B 78 */	mr r28, r5
/* 80429994 003F2F54  88 06 00 00 */	lbz r0, 0x0(r6)
/* 80429998 003F2F58  2C 00 00 01 */	cmpwi r0, 0x1
/* 8042999C 003F2F5C  41 82 00 24 */	beq .L_804299C0
/* 804299A0 003F2F60  40 80 00 10 */	bge .L_804299B0
/* 804299A4 003F2F64  2C 00 00 00 */	cmpwi r0, 0x0
/* 804299A8 003F2F68  40 80 00 20 */	bge .L_804299C8
/* 804299AC 003F2F6C  48 00 00 24 */	b .L_804299D0
.L_804299B0:
/* 804299B0 003F2F70  2C 00 00 03 */	cmpwi r0, 0x3
/* 804299B4 003F2F74  40 80 00 1C */	bge .L_804299D0
/* 804299B8 003F2F78  3B C0 00 03 */	li r30, 0x3
/* 804299BC 003F2F7C  48 00 00 18 */	b .L_804299D4
.L_804299C0:
/* 804299C0 003F2F80  3B C0 00 01 */	li r30, 0x1
/* 804299C4 003F2F84  48 00 00 10 */	b .L_804299D4
.L_804299C8:
/* 804299C8 003F2F88  3B C0 00 02 */	li r30, 0x2
/* 804299CC 003F2F8C  48 00 00 08 */	b .L_804299D4
.L_804299D0:
/* 804299D0 003F2F90  3B C0 00 03 */	li r30, 0x3
.L_804299D4:
/* 804299D4 003F2F94  80 E3 00 00 */	lwz r7, 0x0(r3)
/* 804299D8 003F2F98  7F C5 F3 78 */	mr r5, r30
/* 804299DC 003F2F9C  93 C4 00 00 */	stw r30, 0x0(r4)
/* 804299E0 003F2FA0  38 60 00 00 */	li r3, 0x0
/* 804299E4 003F2FA4  88 07 00 02 */	lbz r0, 0x2(r7)
/* 804299E8 003F2FA8  90 04 00 08 */	stw r0, 0x8(r4)
/* 804299EC 003F2FAC  88 C7 00 03 */	lbz r6, 0x3(r7)
/* 804299F0 003F2FB0  A0 07 00 04 */	lhz r0, 0x4(r7)
/* 804299F4 003F2FB4  54 C6 80 1E */	slwi r6, r6, 16
/* 804299F8 003F2FB8  7C 06 02 14 */	add r0, r6, r0
/* 804299FC 003F2FBC  90 04 00 0C */	stw r0, 0xc(r4)
/* 80429A00 003F2FC0  88 C7 00 01 */	lbz r6, 0x1(r7)
/* 80429A04 003F2FC4  7C 06 00 D0 */	neg r0, r6
/* 80429A08 003F2FC8  7C 00 33 78 */	or r0, r0, r6
/* 80429A0C 003F2FCC  54 00 0F FE */	srwi r0, r0, 31
/* 80429A10 003F2FD0  98 04 00 04 */	stb r0, 0x4(r4)
/* 80429A14 003F2FD4  80 87 00 08 */	lwz r4, 0x8(r7)
...
/* 80429A24 003F2FE4  80 9B 00 00 */	lwz r4, 0x0(r27)
/* 80429A28 003F2FE8  38 60 00 00 */	li r3, 0x0
...
/* 80429A34 003F2FF4  38 03 00 01 */	addi r0, r3, 0x1
/* 80429A38 003F2FF8  80 7B 00 00 */	lwz r3, 0x0(r27)
/* 80429A3C 003F2FFC  90 1D 00 14 */	stw r0, 0x14(r29)
/* 80429A40 003F3000  3B FD 00 18 */	addi r31, r29, 0x18
/* 80429A44 003F3004  3B A0 00 00 */	li r29, 0x0
/* 80429A48 003F3008  80 03 00 10 */	lwz r0, 0x10(r3)
/* 80429A4C 003F300C  7F C0 1A 14 */	add r30, r0, r3
/* 80429A50 003F3010  48 00 00 F4 */	b .L_80429B44
.L_80429A54:
/* 80429A54 003F3014  2C 1D 00 02 */	cmpwi r29, 0x2
/* 80429A58 003F3018  40 80 00 E0 */	bge .L_80429B38
/* 80429A5C 003F301C  80 1E 00 00 */	lwz r0, 0x0(r30)
/* 80429A60 003F3020  7C 80 1A 14 */	add r4, r0, r3
/* 80429A64 003F3024  80 04 00 04 */	lwz r0, 0x4(r4)
/* 80429A68 003F3028  2C 00 00 00 */	cmpwi r0, 0x0
/* 80429A6C 003F302C  41 82 00 BC */	beq .L_80429B28
/* 80429A70 003F3030  7C A3 02 6E */	lhzux r5, r3, r0
/* 80429A74 003F3034  A0 03 00 02 */	lhz r0, 0x2(r3)
/* 80429A78 003F3038  B0 BF 00 04 */	sth r5, 0x4(r31)
/* 80429A7C 003F303C  B0 1F 00 06 */	sth r0, 0x6(r31)
/* 80429A80 003F3040  A0 A3 00 04 */	lhz r5, 0x4(r3)
/* 80429A84 003F3044  A0 03 00 06 */	lhz r0, 0x6(r3)
/* 80429A88 003F3048  B0 BF 00 08 */	sth r5, 0x8(r31)
/* 80429A8C 003F304C  B0 1F 00 0A */	sth r0, 0xa(r31)
/* 80429A90 003F3050  A0 A3 00 08 */	lhz r5, 0x8(r3)
...
/* 80429B34 003F30F4  90 7F 00 00 */	stw r3, 0x0(r31)
.L_80429B38:
/* 80429B38 003F30F8  3B FF 00 34 */	addi r31, r31, 0x34
/* 80429B3C 003F30FC  3B DE 00 04 */	addi r30, r30, 0x4
/* 80429B40 003F3100  3B BD 00 01 */	addi r29, r29, 0x1
.L_80429B44:
/* 80429B44 003F3104  80 7B 00 00 */	lwz r3, 0x0(r27)
/* 80429B48 003F3108  88 03 00 02 */	lbz r0, 0x2(r3)
/* 80429B4C 003F310C  7C 1D 00 00 */	cmpw r29, r0
/* 80429B50 003F3110  41 80 FF 04 */	blt .L_80429A54
/* 80429B54 003F3114  39 61 00 20 */	addi r11, r1, 0x20
/* 80429B58 003F3118  38 60 00 01 */	li r3, 0x1
...
# nw4r::snd::detail::WaveFileReader::GetWaveDataAddress(const nw4r::snd::detail::WaveFile::WaveChannelInfo*, const void*) const
.fn GetWaveDataAddress__Q44nw4r3snd6detail14WaveFileReaderCFPCQ54nw4r3snd6detail8WaveFile15WaveChannelInfoPCv, global
/* 80429B70 003F3130  2C 05 00 00 */	cmpwi r5, 0x0
/* 80429B74 003F3134  7C A0 00 34 */	cntlzw r0, r5
/* 80429B78 003F3138  54 06 D9 7E */	srwi r6, r0, 5
/* 80429B7C 003F313C  40 82 00 08 */	bne .L_80429B84
/* 80429B80 003F3140  80 A3 00 00 */	lwz r5, 0x0(r3)
.L_80429B84:
/* 80429B84 003F3144  80 63 00 00 */	lwz r3, 0x0(r3)
/* 80429B88 003F3148  88 03 00 06 */	lbz r0, 0x6(r3)
/* 80429B8C 003F314C  2C 00 00 01 */	cmpwi r0, 0x1
/* 80429B90 003F3150  41 82 00 2C */	beq .L_80429BBC
/* 80429B94 003F3154  40 80 00 30 */	bge .L_80429BC4
/* 80429B98 003F3158  2C 00 00 00 */	cmpwi r0, 0x0
/* 80429B9C 003F315C  40 80 00 08 */	bge .L_80429BA4
/* 80429BA0 003F3160  48 00 00 24 */	b .L_80429BC4
.L_80429BA4:
/* 80429BA4 003F3164  80 03 00 14 */	lwz r0, 0x14(r3)
/* 80429BA8 003F3168  2C 06 00 00 */	cmpwi r6, 0x0
/* 80429BAC 003F316C  7C 60 2A 14 */	add r3, r0, r5
/* 80429BB0 003F3170  41 82 00 1C */	beq .L_80429BCC
/* 80429BB4 003F3174  38 63 00 08 */	addi r3, r3, 0x8
/* 80429BB8 003F3178  48 00 00 14 */	b .L_80429BCC
.L_80429BBC:
/* 80429BBC 003F317C  80 63 00 14 */	lwz r3, 0x14(r3)
/* 80429BC0 003F3180  48 00 00 0C */	b .L_80429BCC
.L_80429BC4:
/* 80429BC4 003F3184  38 60 00 00 */	li r3, 0x0
/* 80429BC8 003F3188  4E 80 00 20 */	blr
.L_80429BCC:
/* 80429BCC 003F318C  80 04 00 00 */	lwz r0, 0x0(r4)
