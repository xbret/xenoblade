...
/* 804293DC 003F299C  2C 03 00 00 */	cmpwi r3, 0x0
/* 804293E0 003F29A0  C0 22 C5 50 */	lfs f1, lbl_8066C8D0@sda21(r2)
/* 804293E4 003F29A4  38 C0 00 00 */	li r6, 0x0
/* 804293E8 003F29A8  40 80 00 34 */	bge .L_8042941C
/* 804293EC 003F29AC  54 A4 E8 FF */	srwi. r4, r5, 3
...
.L_804293FC:
/* 804293FC 003F29BC  38 C6 FF F8 */	addi r6, r6, -0x8
/* 80429400 003F29C0  42 00 FF FC */	bdnz .L_804293FC
/* 80429404 003F29C4  70 A5 00 07 */	andi. r5, r5, 0x7
/* 80429408 003F29C8  41 82 00 10 */	beq .L_80429418
.L_8042940C:
/* 8042940C 003F29CC  7C A9 03 A6 */	mtctr r5
.L_80429410:
/* 80429410 003F29D0  38 C6 FF FF */	addi r6, r6, -0x1
...
/* 8042946C 003F2A2C  54 C4 E8 FF */	srwi. r4, r6, 3
...
/* 804294A0 003F2A60  70 C5 00 07 */	andi. r5, r6, 0x7
...
.L_804294B8:
/* 804294B8 003F2A78  2C 06 00 00 */	cmpwi r6, 0x0
...
/* 804294C8 003F2A88  54 80 E8 FF */	srwi. r0, r4, 3
...
/* 804294F8 003F2AB8  70 84 00 07 */	andi. r4, r4, 0x7
...
/* 80429510 003F2AD0  54 60 C0 0E */	slwi r0, r3, 24
/* 80429514 003F2AD4  54 63 0F FE */	srwi r3, r3, 31
...
.L_80429540:
/* 80429540 003F2B00  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 8042959C 003F2B5C  D8 01 00 08 */	stfd f0, 0x8(r1)
...
# nw4r::snd::detail::Util::CalcPanRatio(float, const nw4r::snd::detail::Util::PanInfo&)
...
/* 804295E8 003F2BA8  80 03 00 00 */	lwz r0, 0x0(r3)
...
/* 8042961C 003F2BDC  D8 01 00 08 */	stfd f0, 0x8(r1)
...
.L_80429638:
/* 80429638 003F2BF8  88 03 00 05 */	lbz r0, 0x5(r3)
/* 8042963C 003F2BFC  2C 00 00 00 */	cmpwi r0, 0x0
...
# nw4r::snd::detail::Util::CalcSurroundPanRatio(float, const nw4r::snd::detail::Util::PanInfo&)
...
/* 804296C8 003F2C88  80 03 00 00 */	lwz r0, 0x0(r3)
...
/* 804296F0 003F2CB0  D8 01 00 08 */	stfd f0, 0x8(r1)
...
/* 80429770 003F2D30  4C 41 13 82 */	cror eq, gt, eq
...
/* 80429798 003F2D58  D8 01 00 08 */	stfd f0, 0x8(r1)
...
# nw4r::snd::detail::Util::GetRemoteFilterCoefs(int, unsigned short*, unsigned short*, unsigned short*, unsigned short*, unsigned short*)
...
.L_804297C0:
/* 804297C0 003F2D80  7C 60 FE 70 */	srawi r0, r3, 31
...
/* 804297DC 003F2D9C  A0 69 00 02 */	lhz r3, 0x2(r9)
/* 804297E0 003F2DA0  B0 04 00 00 */	sth r0, 0x0(r4)
/* 804297E4 003F2DA4  A0 09 00 04 */	lhz r0, 0x4(r9)
/* 804297E8 003F2DA8  B0 65 00 00 */	sth r3, 0x0(r5)
/* 804297EC 003F2DAC  A0 69 00 06 */	lhz r3, 0x6(r9)
/* 804297F0 003F2DB0  B0 06 00 00 */	sth r0, 0x0(r6)
/* 804297F4 003F2DB4  A0 09 00 08 */	lhz r0, 0x8(r9)
/* 804297F8 003F2DB8  B0 67 00 00 */	sth r3, 0x0(r7)
/* 804297FC 003F2DBC  B0 08 00 00 */	sth r0, 0x0(r8)
...
/* 80429828 003F2DE8  2C 03 00 01 */	cmpwi r3, 0x1
/* 8042982C 003F2DEC  40 82 00 0C */	bne .L_80429838
/* 80429830 003F2DF0  7C 64 2A 14 */	add r3, r4, r5
/* 80429834 003F2DF4  4E 80 00 20 */	blr
.L_80429838:
/* 80429838 003F2DF8  2C 03 00 00 */	cmpwi r3, 0x0
/* 8042983C 003F2DFC  38 60 00 00 */	li r3, 0x0
...
.section .sdata2, "a"
.balign 8
.sym lbl_8066C8D0, local
	.4byte 0x3F800000
.sym lbl_8066C8D4, local
	.4byte 0x40000000
.sym lbl_8066C8D8, local
	.4byte 0x3F000000
.sym lbl_8066C8DC, local
	.4byte 0x40C00000
.sym lbl_8066C8E0, local
	.4byte 0xC2B4CCCD
.sym lbl_8066C8E4, local
	.4byte 0x41200000
.sym lbl_8066C8E8, local
	.4byte 0xBF800000
.sym lbl_8066C8EC, local
	.4byte 0x43800000
.sym lbl_8066C8F0, local
	.4byte 0x00000000
.sym lbl_8066C8F4, local
	.4byte 0x3E0ADE7F
.sym lbl_8066C8F8, local
	.4byte 0x3F666666
.sym lbl_8066C8FC, local
	.4byte 0x3D088889
