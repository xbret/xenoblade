...
/* 80415A20 003DEFE0  38 00 00 00 */	li r0, 0x0
...
/* 80415A38 003DEFF8  38 81 00 08 */	addi r4, r1, 0x8
/* 80415A3C 003DEFFC  C0 02 C3 EC */	lfs f0, lbl_8066C76C@sda21(r2)
/* 80415A40 003DF000  90 03 00 04 */	stw r0, 0x4(r3)
/* 80415A44 003DF004  90 03 00 08 */	stw r0, 0x8(r3)
/* 80415A48 003DF008  90 A3 00 00 */	stw r5, 0x0(r3)
...
/* 80415A6C 003DF02C  D0 61 00 08 */	stfs f3, 0x8(r1)
...
# nw4r::snd::FxChorusDpl2::GetRequiredMemSize()
...
# nw4r::snd::FxChorusDpl2::AssignWorkBuffer(void*, unsigned long)
...
# nw4r::snd::FxChorusDpl2::ReleaseWorkBuffer()
...
/* 80415B48 003DF108  2C 04 00 00 */	cmpwi r4, 0x0
/* 80415B4C 003DF10C  40 82 00 0C */	bne .L_80415B58
/* 80415B50 003DF110  38 00 00 00 */	li r0, 0x0
...
/* 80415B68 003DF128  38 60 00 00 */	li r3, 0x0
...
/* 80415B78 003DF138  2C 03 00 02 */	cmpwi r3, 0x2
/* 80415B7C 003DF13C  40 82 00 44 */	bne .L_80415BC0
/* 80415B80 003DF140  38 00 00 01 */	li r0, 0x1
...
/* 80415B90 003DF150  38 A1 00 08 */	addi r5, r1, 0x8
...
/* 80415BA8 003DF168  80 A1 00 08 */	lwz r5, 0x8(r1)
...
.L_80415BC0:
/* 80415BC0 003DF180  38 00 00 00 */	li r0, 0x0
...
/* 80415BD0 003DF190  38 A1 00 08 */	addi r5, r1, 0x8
...
/* 80415BE8 003DF1A8  80 A1 00 08 */	lwz r5, 0x8(r1)
...
# nw4r::snd::FxChorusDpl2::Shutdown()
...
/* 80415C40 003DF200  2C 00 00 00 */	cmpwi r0, 0x0
/* 80415C44 003DF204  41 82 00 4C */	beq .L_80415C90
/* 80415C48 003DF208  38 00 00 00 */	li r0, 0x0
...
/* 80415C58 003DF218  38 A1 00 08 */	addi r5, r1, 0x8
...
/* 80415C64 003DF224  2C 00 00 01 */	cmpwi r0, 0x1
...
/* 80415C88 003DF248  80 A1 00 08 */	lwz r5, 0x8(r1)
...
# nw4r::snd::FxChorusDpl2::SetParam(const nw4r::snd::detail::FxChorusParam&)
...
/* 80415CAC 003DF26C  C0 84 00 00 */	lfs f4, 0x0(r4)
...
/* 80415CBC 003DF27C  C0 64 00 04 */	lfs f3, 0x4(r4)
/* 80415CC0 003DF280  FC 04 28 40 */	fcmpo cr0, f4, f5
/* 80415CC4 003DF284  93 C1 00 08 */	stw r30, 0x8(r1)
/* 80415CC8 003DF288  7C 7E 1B 78 */	mr r30, r3
/* 80415CCC 003DF28C  C0 44 00 08 */	lfs f2, 0x8(r4)
...
.L_80415D08:
/* 80415D08 003DF2C8  C0 04 00 04 */	lfs f0, 0x4(r4)
...
.L_80415D38:
/* 80415D38 003DF2F8  C0 04 00 08 */	lfs f0, 0x8(r4)
...
/* 80415DCC 003DF38C  38 80 00 00 */	li r4, 0x0
/* 80415DD0 003DF390  C0 02 C3 EC */	lfs f0, lbl_8066C76C@sda21(r2)
/* 80415DD4 003DF394  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 80415DFC 003DF3BC  38 60 00 01 */	li r3, 0x1
...
/* 80415E34 003DF3F4  2C 04 00 00 */	cmpwi r4, 0x0
/* 80415E38 003DF3F8  40 82 00 0C */	bne .L_80415E44
/* 80415E3C 003DF3FC  38 00 00 00 */	li r0, 0x0
...
# nw4r::snd::FxChorusDpl2::UpdateBuffer(int, void**, unsigned long, nw4r::snd::SampleFormat, float, nw4r::snd::OutputMode)
...
/* 80415EB4 003DF474  2C 00 00 00 */	cmpwi r0, 0x0
/* 80415EB8 003DF478  41 82 00 78 */	beq .L_80415F30
/* 80415EBC 003DF47C  38 08 FF FE */	addi r0, r8, -0x2
...
/* 80415ED4 003DF494  2C 03 00 01 */	cmpwi r3, 0x1
/* 80415ED8 003DF498  40 82 00 34 */	bne .L_80415F0C
/* 80415EDC 003DF49C  80 05 00 00 */	lwz r0, 0x0(r5)
...
/* 80415EEC 003DF4AC  80 05 00 04 */	lwz r0, 0x4(r5)
/* 80415EF0 003DF4B0  90 01 00 1C */	stw r0, 0x1c(r1)
/* 80415EF4 003DF4B4  80 05 00 08 */	lwz r0, 0x8(r5)
...
.L_80415F0C:
/* 80415F0C 003DF4CC  80 05 00 00 */	lwz r0, 0x0(r5)
/* 80415F10 003DF4D0  38 61 00 08 */	addi r3, r1, 0x8
/* 80415F14 003DF4D4  38 84 00 30 */	addi r4, r4, 0x30
/* 80415F18 003DF4D8  90 01 00 08 */	stw r0, 0x8(r1)
/* 80415F1C 003DF4DC  80 05 00 04 */	lwz r0, 0x4(r5)
/* 80415F20 003DF4E0  90 01 00 0C */	stw r0, 0xc(r1)
/* 80415F24 003DF4E4  80 05 00 08 */	lwz r0, 0x8(r5)
...
# nw4r::snd::FxChorusDpl2::OnChangeOutputMode()
...
/* 80415F5C 003DF51C  38 63 FF FE */	addi r3, r3, -0x2
...
/* 80415F74 003DF534  81 9F 00 00 */	lwz r12, 0x0(r31)
...
/* 80415F88 003DF548  81 9F 00 00 */	lwz r12, 0x0(r31)
...
.section .sdata2, "a"
.balign 8
.sym lbl_8066C760, local
	.4byte 0x41200000
.sym lbl_8066C764, local
	.4byte 0x3F000000
.sym lbl_8066C768, local
	.4byte 0x3F800000
.sym lbl_8066C76C, local
	.4byte 0x00000000
.sym lbl_8066C770, local
	.4byte 0x42480000
.sym lbl_8066C774, local
	.4byte 0x3DCCCCCD
.sym lbl_8066C778, local
	.4byte 0x40000000
.sym lbl_8066C77C, local
	.4byte 0x3F7D70A4
