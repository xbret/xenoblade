...
/* 80419620 003E2BE0  54 00 0F FE */	srwi r0, r0, 31
.L_80419624:
/* 80419624 003E2BE4  2C 00 00 00 */	cmpwi r0, 0x0
/* 80419628 003E2BE8  4D 82 00 20 */	beqlr
/* 8041962C 003E2BEC  80 04 00 10 */	lwz r0, 0x10(r4)
/* 80419630 003E2BF0  90 83 00 00 */	stw r4, 0x0(r3)
/* 80419634 003E2BF4  7C 00 22 14 */	add r0, r0, r4
/* 80419638 003E2BF8  90 03 00 04 */	stw r0, 0x4(r3)
...
/* 80419640 003E2C00  80 63 00 04 */	lwz r3, 0x4(r3)
/* 80419644 003E2C04  80 03 00 08 */	lwz r0, 0x8(r3)
...
# nw4r::snd::detail::SeqFileReader::ReadOffsetByLabel(const char*, unsigned long*) const
...
/* 80419664 003E2C24  80 63 00 00 */	lwz r3, 0x0(r3)
...
/* 804196C4 003E2C84  2C 03 00 00 */	cmpwi r3, 0x0
/* 804196C8 003E2C88  40 82 00 14 */	bne .L_804196DC
/* 804196CC 003E2C8C  80 1F 00 08 */	lwz r0, 0x8(r31)
/* 804196D0 003E2C90  38 60 00 01 */	li r3, 0x1
/* 804196D4 003E2C94  90 19 00 00 */	stw r0, 0x0(r25)
/* 804196D8 003E2C98  48 00 00 18 */	b .L_804196F0
.L_804196DC:
/* 804196DC 003E2C9C  3B BD 00 04 */	addi r29, r29, 0x4
/* 804196E0 003E2CA0  3B 5A 00 01 */	addi r26, r26, 0x1
.L_804196E4:
/* 804196E4 003E2CA4  7C 1A F0 40 */	cmplw r26, r30
/* 804196E8 003E2CA8  41 80 FF B8 */	blt .L_804196A0
/* 804196EC 003E2CAC  38 60 00 00 */	li r3, 0x0
.L_804196F0:
