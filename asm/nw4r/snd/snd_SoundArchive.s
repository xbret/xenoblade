...
/* 8041C78C 003E5D4C  90 A3 00 00 */	stw r5, 0(r3)
/* 8041C790 003E5D50  90 83 00 04 */	stw r4, 4(r3)
/* 8041C794 003E5D54  98 03 00 08 */	stb r0, 8(r3)
...
/* 8041C7B8 003E5D78  41 82 00 10 */	beq lbl_8041C7C8
/* 8041C7BC 003E5D7C  2C 04 00 00 */	cmpwi r4, 0
/* 8041C7C0 003E5D80  40 81 00 08 */	ble lbl_8041C7C8
...
/* 8041C808 003E5DC8  98 03 00 08 */	stb r0, 8(r3)
...
/* 8041C8C4 003E5E84  80 63 00 04 */	lwz r3, 4(r3)
...
/* 8041C8E8 003E5EA8  48 00 01 D4 */	b lbl_8041CABC
lbl_8041C8EC:
/* 8041C8EC 003E5EAC  83 41 00 18 */	lwz r26, 0x18(r1)
/* 8041C8F0 003E5EB0  2C 1A 00 00 */	cmpwi r26, 0
/* 8041C8F4 003E5EB4  41 82 00 94 */	beq lbl_8041C988
/* 8041C8F8 003E5EB8  88 1A 00 00 */	lbz r0, 0(r26)
/* 8041C8FC 003E5EBC  83 61 00 10 */	lwz r27, 0x10(r1)
/* 8041C900 003E5EC0  2C 00 00 2F */	cmpwi r0, 0x2f
/* 8041C904 003E5EC4  40 82 00 08 */	bne lbl_8041C90C
/* 8041C908 003E5EC8  48 00 00 54 */	b lbl_8041C95C
lbl_8041C90C:
/* 8041C90C 003E5ECC  7F 43 D3 78 */	mr r3, r26
/* 8041C910 003E5ED0  4B E9 CC A9 */	bl strlen
/* 8041C914 003E5ED4  7C 7C 1B 78 */	mr r28, r3
/* 8041C918 003E5ED8  38 7D 00 08 */	addi r3, r29, 8
...
/* 8041C92C 003E5EEC  41 80 00 0C */	blt lbl_8041C938
/* 8041C930 003E5EF0  38 60 00 00 */	li r3, 0
/* 8041C934 003E5EF4  48 00 01 88 */	b lbl_8041CABC
lbl_8041C938:
/* 8041C938 003E5EF8  38 61 01 50 */	addi r3, r1, 0x150
/* 8041C93C 003E5EFC  38 9D 00 08 */	addi r4, r29, 8
/* 8041C940 003E5F00  38 A5 00 01 */	addi r5, r5, 1
...
/* 8041C978 003E5F38  38 E0 00 00 */	li r7, 0
/* 8041C97C 003E5F3C  7D 89 03 A6 */	mtctr r12
/* 8041C980 003E5F40  4E 80 04 21 */	bctrl 
/* 8041C984 003E5F44  48 00 01 38 */	b lbl_8041CABC
lbl_8041C988:
/* 8041C988 003E5F48  80 7D 00 04 */	lwz r3, 4(r29)
...
/* 8041C9A8 003E5F68  48 00 01 14 */	b lbl_8041CABC
lbl_8041C9AC:
...
/* 8041C9C8 003E5F88  48 00 00 F4 */	b lbl_8041CABC
lbl_8041C9CC:
/* 8041C9CC 003E5F8C  80 7D 00 04 */	lwz r3, 4(r29)
...
/* 8041C9EC 003E5FAC  48 00 00 D0 */	b lbl_8041CABC
lbl_8041C9F0:
...
/* 8041C9FC 003E5FBC  2C 1A 00 00 */	cmpwi r26, 0
/* 8041CA00 003E5FC0  83 21 00 28 */	lwz r25, 0x28(r1)
/* 8041CA04 003E5FC4  7F 63 02 14 */	add r27, r3, r0
/* 8041CA08 003E5FC8  41 82 00 90 */	beq lbl_8041CA98
/* 8041CA0C 003E5FCC  88 1A 00 00 */	lbz r0, 0(r26)
/* 8041CA10 003E5FD0  2C 00 00 2F */	cmpwi r0, 0x2f
/* 8041CA14 003E5FD4  40 82 00 08 */	bne lbl_8041CA1C
/* 8041CA18 003E5FD8  48 00 00 54 */	b lbl_8041CA6C
lbl_8041CA1C:
/* 8041CA1C 003E5FDC  7F 43 D3 78 */	mr r3, r26
/* 8041CA20 003E5FE0  4B E9 CB 99 */	bl strlen
/* 8041CA24 003E5FE4  7C 7C 1B 78 */	mr r28, r3
/* 8041CA28 003E5FE8  38 7D 00 08 */	addi r3, r29, 8
...
/* 8041CA3C 003E5FFC  41 80 00 0C */	blt lbl_8041CA48
/* 8041CA40 003E6000  38 60 00 00 */	li r3, 0
/* 8041CA44 003E6004  48 00 00 78 */	b lbl_8041CABC
lbl_8041CA48:
/* 8041CA48 003E6008  38 61 00 50 */	addi r3, r1, 0x50
/* 8041CA4C 003E600C  38 9D 00 08 */	addi r4, r29, 8
/* 8041CA50 003E6010  38 A5 00 01 */	addi r5, r5, 1
...
/* 8041CA60 003E6020  38 BC 00 01 */	addi r5, r28, 1
/* 8041CA64 003E6024  4B EA 5D 85 */	bl strncat
/* 8041CA68 003E6028  3B 41 00 50 */	addi r26, r1, 0x50
lbl_8041CA6C:
/* 8041CA6C 003E602C  81 9D 00 00 */	lwz r12, 0(r29)
...
/* 8041CA94 003E6054  48 00 00 28 */	b lbl_8041CABC
lbl_8041CA98:
/* 8041CA98 003E6058  81 9D 00 00 */	lwz r12, 0(r29)
