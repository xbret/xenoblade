...
/* 804119F0 003DAFB0  80 A4 00 00 */	lwz r5, 0x0(r4)
/* 804119F4 003DAFB4  38 C0 00 00 */	li r6, 0x0
/* 804119F8 003DAFB8  90 C3 00 00 */	stw r6, 0x0(r3)
/* 804119FC 003DAFBC  3C 05 AD BE */	addis r0, r5, 0xadbe
/* 80411A00 003DAFC0  28 00 4E 4B */	cmplwi r0, 0x4e4b
/* 80411A04 003DAFC4  90 C3 00 04 */	stw r6, 0x4(r3)
/* 80411A08 003DAFC8  90 C3 00 08 */	stw r6, 0x8(r3)
/* 80411A0C 003DAFCC  41 82 00 0C */	beq .L_80411A18
/* 80411A10 003DAFD0  38 00 00 00 */	li r0, 0x0
/* 80411A14 003DAFD4  48 00 00 30 */	b .L_80411A44
.L_80411A18:
/* 80411A18 003DAFD8  A0 C4 00 06 */	lhz r6, 0x6(r4)
/* 80411A1C 003DAFDC  28 06 01 00 */	cmplwi r6, 0x100
/* 80411A20 003DAFE0  40 80 00 0C */	bge .L_80411A2C
/* 80411A24 003DAFE4  38 00 00 00 */	li r0, 0x0
...
/* 80411A40 003DB000  54 00 0F FE */	srwi r0, r0, 31
.L_80411A44:
/* 80411A44 003DB004  2C 00 00 00 */	cmpwi r0, 0x0
/* 80411A48 003DB008  4D 82 00 20 */	beqlr
/* 80411A4C 003DB00C  80 04 00 10 */	lwz r0, 0x10(r4)
/* 80411A50 003DB010  90 83 00 00 */	stw r4, 0x0(r3)
/* 80411A54 003DB014  2C 00 00 00 */	cmpwi r0, 0x0
/* 80411A58 003DB018  41 82 00 0C */	beq .L_80411A64
/* 80411A5C 003DB01C  7C 00 22 14 */	add r0, r0, r4
/* 80411A60 003DB020  90 03 00 04 */	stw r0, 0x4(r3)
.L_80411A64:
/* 80411A64 003DB024  80 83 00 00 */	lwz r4, 0x0(r3)
/* 80411A68 003DB028  80 04 00 18 */	lwz r0, 0x18(r4)
/* 80411A6C 003DB02C  2C 00 00 00 */	cmpwi r0, 0x0
/* 80411A70 003DB030  4D 82 00 20 */	beqlr
/* 80411A74 003DB034  7C 00 22 14 */	add r0, r0, r4
/* 80411A78 003DB038  90 03 00 08 */	stw r0, 0x8(r3)
/* 80411A7C 003DB03C  4E 80 00 20 */	blr
.endfn __ct__Q44nw4r3snd6detail14BankFileReaderFPCv

# nw4r::snd::detail::BankFileReader::GetInstParam(int, int, int) const
...
/* 80411ADC 003DB09C  88 04 00 01 */	lbz r0, 0x1(r4)
/* 80411AE0 003DB0A0  28 00 00 04 */	cmplwi r0, 0x4
/* 80411AE4 003DB0A4  40 82 00 0C */	bne .L_80411AF0
/* 80411AE8 003DB0A8  38 60 00 00 */	li r3, 0x0
/* 80411AEC 003DB0AC  48 00 00 88 */	b .L_80411B74
.L_80411AF0:
/* 80411AF0 003DB0B0  28 00 00 01 */	cmplwi r0, 0x1
...
/* 80411AFC 003DB0BC  2C 03 00 00 */	cmpwi r3, 0x0
/* 80411B00 003DB0C0  7C 64 1B 78 */	mr r4, r3
/* 80411B04 003DB0C4  40 82 00 0C */	bne .L_80411B10
/* 80411B08 003DB0C8  38 60 00 00 */	li r3, 0x0
/* 80411B0C 003DB0CC  48 00 00 68 */	b .L_80411B74
.L_80411B10:
/* 80411B10 003DB0D0  88 04 00 01 */	lbz r0, 0x1(r4)
/* 80411B14 003DB0D4  28 00 00 04 */	cmplwi r0, 0x4
/* 80411B18 003DB0D8  40 82 00 0C */	bne .L_80411B24
/* 80411B1C 003DB0DC  38 60 00 00 */	li r3, 0x0
/* 80411B20 003DB0E0  48 00 00 54 */	b .L_80411B74
.L_80411B24:
/* 80411B24 003DB0E4  28 00 00 01 */	cmplwi r0, 0x1
...
/* 80411B38 003DB0F8  2C 03 00 00 */	cmpwi r3, 0x0
/* 80411B3C 003DB0FC  7C 64 1B 78 */	mr r4, r3
/* 80411B40 003DB100  40 82 00 0C */	bne .L_80411B4C
/* 80411B44 003DB104  38 60 00 00 */	li r3, 0x0
/* 80411B48 003DB108  48 00 00 2C */	b .L_80411B74
.L_80411B4C:
/* 80411B4C 003DB10C  88 04 00 01 */	lbz r0, 0x1(r4)
/* 80411B50 003DB110  28 00 00 01 */	cmplwi r0, 0x1
/* 80411B54 003DB114  41 82 00 0C */	beq .L_80411B60
/* 80411B58 003DB118  38 60 00 00 */	li r3, 0x0
/* 80411B5C 003DB11C  48 00 00 18 */	b .L_80411B74
.L_80411B60:
/* 80411B60 003DB120  80 BE 00 04 */	lwz r5, 0x4(r30)
/* 80411B64 003DB124  88 64 00 00 */	lbz r3, 0x0(r4)
/* 80411B68 003DB128  80 84 00 04 */	lwz r4, 0x4(r4)
/* 80411B6C 003DB12C  38 A5 00 08 */	addi r5, r5, 0x8
...
/* 80411B7C 003DB13C  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 80411BA8 003DB168  93 C1 00 08 */	stw r30, 0x8(r1)
...
/* 80411BB8 003DB178  2C 03 00 00 */	cmpwi r3, 0x0
/* 80411BBC 003DB17C  40 82 00 0C */	bne .L_80411BC8
/* 80411BC0 003DB180  38 60 00 00 */	li r3, 0x0
/* 80411BC4 003DB184  48 00 01 54 */	b .L_80411D18
.L_80411BC8:
/* 80411BC8 003DB188  88 03 00 09 */	lbz r0, 0x9(r3)
/* 80411BCC 003DB18C  2C 00 00 00 */	cmpwi r0, 0x0
/* 80411BD0 003DB190  40 82 00 2C */	bne .L_80411BFC
/* 80411BD4 003DB194  80 03 00 00 */	lwz r0, 0x0(r3)
/* 80411BD8 003DB198  2C 00 00 00 */	cmpwi r0, 0x0
/* 80411BDC 003DB19C  40 80 00 0C */	bge .L_80411BE8
/* 80411BE0 003DB1A0  38 60 00 00 */	li r3, 0x0
/* 80411BE4 003DB1A4  48 00 01 34 */	b .L_80411D18
.L_80411BE8:
/* 80411BE8 003DB1A8  38 00 00 00 */	li r0, 0x0
/* 80411BEC 003DB1AC  90 1F 00 00 */	stw r0, 0x0(r31)
/* 80411BF0 003DB1B0  80 03 00 00 */	lwz r0, 0x0(r3)
/* 80411BF4 003DB1B4  90 1F 00 04 */	stw r0, 0x4(r31)
/* 80411BF8 003DB1B8  48 00 00 6C */	b .L_80411C64
.L_80411BFC:
/* 80411BFC 003DB1BC  28 00 00 01 */	cmplwi r0, 0x1
/* 80411C00 003DB1C0  40 82 00 2C */	bne .L_80411C2C
/* 80411C04 003DB1C4  80 03 00 00 */	lwz r0, 0x0(r3)
/* 80411C08 003DB1C8  2C 00 00 00 */	cmpwi r0, 0x0
/* 80411C0C 003DB1CC  40 82 00 0C */	bne .L_80411C18
/* 80411C10 003DB1D0  38 60 00 00 */	li r3, 0x0
/* 80411C14 003DB1D4  48 00 01 04 */	b .L_80411D18
.L_80411C18:
/* 80411C18 003DB1D8  38 00 00 01 */	li r0, 0x1
/* 80411C1C 003DB1DC  90 1F 00 00 */	stw r0, 0x0(r31)
/* 80411C20 003DB1E0  80 03 00 00 */	lwz r0, 0x0(r3)
/* 80411C24 003DB1E4  90 1F 00 04 */	stw r0, 0x4(r31)
/* 80411C28 003DB1E8  48 00 00 3C */	b .L_80411C64
.L_80411C2C:
/* 80411C2C 003DB1EC  28 00 00 02 */	cmplwi r0, 0x2
/* 80411C30 003DB1F0  40 82 00 2C */	bne .L_80411C5C
/* 80411C34 003DB1F4  80 03 00 00 */	lwz r0, 0x0(r3)
/* 80411C38 003DB1F8  2C 00 00 00 */	cmpwi r0, 0x0
/* 80411C3C 003DB1FC  40 82 00 0C */	bne .L_80411C48
/* 80411C40 003DB200  38 60 00 00 */	li r3, 0x0
/* 80411C44 003DB204  48 00 00 D4 */	b .L_80411D18
.L_80411C48:
/* 80411C48 003DB208  38 00 00 02 */	li r0, 0x2
/* 80411C4C 003DB20C  90 1F 00 00 */	stw r0, 0x0(r31)
/* 80411C50 003DB210  80 03 00 00 */	lwz r0, 0x0(r3)
/* 80411C54 003DB214  90 1F 00 04 */	stw r0, 0x4(r31)
/* 80411C58 003DB218  48 00 00 0C */	b .L_80411C64
.L_80411C5C:
/* 80411C5C 003DB21C  38 60 00 00 */	li r3, 0x0
/* 80411C60 003DB220  48 00 00 B8 */	b .L_80411D18
.L_80411C64:
/* 80411C64 003DB224  88 03 00 04 */	lbz r0, 0x4(r3)
/* 80411C68 003DB228  80 9E 00 00 */	lwz r4, 0x0(r30)
/* 80411C6C 003DB22C  98 1F 00 08 */	stb r0, 0x8(r31)
/* 80411C70 003DB230  88 03 00 08 */	lbz r0, 0x8(r3)
/* 80411C74 003DB234  98 1F 00 09 */	stb r0, 0x9(r31)
/* 80411C78 003DB238  88 03 00 05 */	lbz r0, 0x5(r3)
/* 80411C7C 003DB23C  98 1F 00 0A */	stb r0, 0xa(r31)
/* 80411C80 003DB240  88 03 00 06 */	lbz r0, 0x6(r3)
/* 80411C84 003DB244  98 1F 00 0B */	stb r0, 0xb(r31)
/* 80411C88 003DB248  88 03 00 07 */	lbz r0, 0x7(r3)
...
/* 80411CA0 003DB260  A0 04 00 06 */	lhz r0, 0x6(r4)
...
/* 80411D20 003DB2E0  83 C1 00 08 */	lwz r30, 0x8(r1)
...
# nw4r::snd::detail::BankFileReader::GetReferenceToSubRegion(const nw4r::snd::detail::Util::DataRef_v_Q54nw4r3snd6detail8BankFile9InstParam_Q54nw4r3snd6detail8BankFile10RangeTable_Q54nw4r3snd6detail8BankFile10IndexTable_*, int) const
...
.L_80411D68:
/* 80411D68 003DB328  2C 00 00 04 */	cmpwi r0, 0x4
...
/* 80411E3C 003DB3FC  38 A3 00 04 */	addi r5, r3, 0x4
.L_80411E40:
...
# nw4r::snd::detail::BankFileReader::ReadWaveInfo(nw4r::snd::detail::WaveInfo*, const nw4r::snd::detail::InstInfo::WaveDataLocation&, const void*, const nw4r::snd::detail::WaveInfo**) const
...
/* 80411E60 003DB420  2C 07 00 00 */	cmpwi r7, 0x0
...
/* 80411E84 003DB444  38 00 00 00 */	li r0, 0x0
/* 80411E88 003DB448  90 07 00 00 */	stw r0, 0x0(r7)
.L_80411E8C:
/* 80411E8C 003DB44C  80 03 00 00 */	lwz r0, 0x0(r3)
/* 80411E90 003DB450  2C 00 00 00 */	cmpwi r0, 0x0
/* 80411E94 003DB454  40 82 00 0C */	bne .L_80411EA0
/* 80411E98 003DB458  38 60 00 00 */	li r3, 0x0
/* 80411E9C 003DB45C  48 00 01 F4 */	b .L_80412090
.L_80411EA0:
/* 80411EA0 003DB460  80 05 00 00 */	lwz r0, 0x0(r5)
/* 80411EA4 003DB464  2C 00 00 00 */	cmpwi r0, 0x0
/* 80411EA8 003DB468  40 82 00 B8 */	bne .L_80411F60
/* 80411EAC 003DB46C  80 63 00 08 */	lwz r3, 0x8(r3)
/* 80411EB0 003DB470  83 C5 00 04 */	lwz r30, 0x4(r5)
/* 80411EB4 003DB474  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 80411ED4 003DB494  2C 03 00 00 */	cmpwi r3, 0x0
/* 80411ED8 003DB498  40 82 00 0C */	bne .L_80411EE4
/* 80411EDC 003DB49C  38 60 00 00 */	li r3, 0x0
...
/* 80411EF8 003DB4B8  38 A0 00 00 */	li r5, 0x0
...
.L_80411F04:
/* 80411F04 003DB4C4  80 03 00 08 */	lwz r0, 0x8(r3)
/* 80411F08 003DB4C8  38 A3 00 08 */	addi r5, r3, 0x8
/* 80411F0C 003DB4CC  7C 1E 00 40 */	cmplw r30, r0
/* 80411F10 003DB4D0  41 80 00 0C */	blt .L_80411F1C
/* 80411F14 003DB4D4  38 60 00 00 */	li r3, 0x0
...
/* 80411F30 003DB4F0  2C 03 00 00 */	cmpwi r3, 0x0
/* 80411F34 003DB4F4  40 82 00 0C */	bne .L_80411F40
/* 80411F38 003DB4F8  38 60 00 00 */	li r3, 0x0
/* 80411F3C 003DB4FC  48 00 01 54 */	b .L_80412090
.L_80411F40:
/* 80411F40 003DB500  7C 64 1B 78 */	mr r4, r3
/* 80411F44 003DB504  38 61 00 08 */	addi r3, r1, 0x8
...
/* 80411F54 003DB514  38 61 00 08 */	addi r3, r1, 0x8
...
.L_80411F60:
/* 80411F60 003DB520  2C 00 00 01 */	cmpwi r0, 0x1
/* 80411F64 003DB524  40 82 00 84 */	bne .L_80411FE8
/* 80411F68 003DB528  80 05 00 04 */	lwz r0, 0x4(r5)
/* 80411F6C 003DB52C  2C 00 00 00 */	cmpwi r0, 0x0
/* 80411F70 003DB530  40 82 00 0C */	bne .L_80411F7C
/* 80411F74 003DB534  38 60 00 00 */	li r3, 0x0
/* 80411F78 003DB538  48 00 01 18 */	b .L_80412090
.L_80411F7C:
/* 80411F7C 003DB53C  2C 07 00 00 */	cmpwi r7, 0x0
/* 80411F80 003DB540  41 82 00 08 */	beq .L_80411F88
/* 80411F84 003DB544  90 07 00 00 */	stw r0, 0x0(r7)
.L_80411F88:
/* 80411F88 003DB548  80 E5 00 04 */	lwz r7, 0x4(r5)
/* 80411F8C 003DB54C  38 00 00 0D */	li r0, 0xd
/* 80411F90 003DB550  38 C4 00 14 */	addi r6, r4, 0x14
/* 80411F94 003DB554  80 67 00 00 */	lwz r3, 0x0(r7)
/* 80411F98 003DB558  38 A7 00 14 */	addi r5, r7, 0x14
/* 80411F9C 003DB55C  90 64 00 00 */	stw r3, 0x0(r4)
/* 80411FA0 003DB560  88 67 00 04 */	lbz r3, 0x4(r7)
/* 80411FA4 003DB564  98 64 00 04 */	stb r3, 0x4(r4)
/* 80411FA8 003DB568  80 67 00 08 */	lwz r3, 0x8(r7)
/* 80411FAC 003DB56C  90 64 00 08 */	stw r3, 0x8(r4)
...
.L_80411FCC:
/* 80411FCC 003DB58C  80 65 00 04 */	lwz r3, 0x4(r5)
/* 80411FD0 003DB590  84 05 00 08 */	lwzu r0, 0x8(r5)
/* 80411FD4 003DB594  90 66 00 04 */	stw r3, 0x4(r6)
/* 80411FD8 003DB598  94 06 00 08 */	stwu r0, 0x8(r6)
/* 80411FDC 003DB59C  42 00 FF F0 */	bdnz .L_80411FCC
/* 80411FE0 003DB5A0  38 60 00 01 */	li r3, 0x1
/* 80411FE4 003DB5A4  48 00 00 AC */	b .L_80412090
.L_80411FE8:
/* 80411FE8 003DB5A8  2C 00 00 02 */	cmpwi r0, 0x2
/* 80411FEC 003DB5AC  40 82 00 A0 */	bne .L_8041208C
/* 80411FF0 003DB5B0  80 65 00 04 */	lwz r3, 0x4(r5)
/* 80411FF4 003DB5B4  2C 03 00 00 */	cmpwi r3, 0x0
/* 80411FF8 003DB5B8  40 82 00 0C */	bne .L_80412004
/* 80411FFC 003DB5BC  38 60 00 00 */	li r3, 0x0
/* 80412000 003DB5C0  48 00 00 90 */	b .L_80412090
.L_80412004:
/* 80412004 003DB5C4  81 83 00 00 */	lwz r12, 0x0(r3)
/* 80412008 003DB5C8  81 8C 00 08 */	lwz r12, 0x8(r12)
/* 8041200C 003DB5CC  7D 89 03 A6 */	mtctr r12
/* 80412010 003DB5D0  4E 80 04 21 */	bctrl
/* 80412014 003DB5D4  2C 03 00 00 */	cmpwi r3, 0x0
/* 80412018 003DB5D8  40 82 00 0C */	bne .L_80412024
/* 8041201C 003DB5DC  38 60 00 00 */	li r3, 0x0
/* 80412020 003DB5E0  48 00 00 70 */	b .L_80412090
.L_80412024:
/* 80412024 003DB5E4  2C 1E 00 00 */	cmpwi r30, 0x0
/* 80412028 003DB5E8  41 82 00 08 */	beq .L_80412030
/* 8041202C 003DB5EC  90 7E 00 00 */	stw r3, 0x0(r30)
.L_80412030:
/* 80412030 003DB5F0  80 C3 00 00 */	lwz r6, 0x0(r3)
...
/* 80412040 003DB600  90 DF 00 00 */	stw r6, 0x0(r31)
/* 80412044 003DB604  88 C3 00 04 */	lbz r6, 0x4(r3)
/* 80412048 003DB608  98 DF 00 04 */	stb r6, 0x4(r31)
/* 8041204C 003DB60C  80 C3 00 08 */	lwz r6, 0x8(r3)
/* 80412050 003DB610  90 DF 00 08 */	stw r6, 0x8(r31)
...
.L_80412070:
/* 80412070 003DB630  80 64 00 04 */	lwz r3, 0x4(r4)
/* 80412074 003DB634  84 04 00 08 */	lwzu r0, 0x8(r4)
/* 80412078 003DB638  90 65 00 04 */	stw r3, 0x4(r5)
/* 8041207C 003DB63C  94 05 00 08 */	stwu r0, 0x8(r5)
/* 80412080 003DB640  42 00 FF F0 */	bdnz .L_80412070
/* 80412084 003DB644  38 60 00 01 */	li r3, 0x1
/* 80412088 003DB648  48 00 00 08 */	b .L_80412090
.L_8041208C:
/* 8041208C 003DB64C  38 60 00 00 */	li r3, 0x0
.L_80412090:
