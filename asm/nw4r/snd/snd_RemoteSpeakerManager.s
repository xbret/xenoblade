.include "macros.inc"
.file "nw4r/snd/snd_RemoteSpeakerManager.o"

# 0x80419354 - 0x804195D4
.text
.balign 4
...
/* 8041937C 003E293C  38 00 00 00 */	li r0, 0x0
...
/* 804193A4 003E2964  38 80 00 01 */	li r4, 0x1
/* 804193A8 003E2968  38 A0 00 00 */	li r5, 0x0
/* 804193AC 003E296C  38 60 00 02 */	li r3, 0x2
/* 804193B0 003E2970  38 00 00 03 */	li r0, 0x3
...
# nw4r::snd::detail::RemoteSpeakerManager::GetRemoteSpeaker(int)
...
/* 80419410 003E29D0  88 03 00 00 */	lbz r0, 0x0(r3)
/* 80419414 003E29D4  2C 00 00 00 */	cmpwi r0, 0x0
/* 80419418 003E29D8  40 82 00 6C */	bne .L_80419484
/* 8041941C 003E29DC  38 63 00 08 */	addi r3, r3, 0x8
/* 80419420 003E29E0  4B F3 9A 01 */	bl OSCreateAlarm
/* 80419424 003E29E4  4B F4 35 3D */	bl OSGetTime
/* 80419428 003E29E8  3C C0 80 00 */	lis r6, 0x8000
/* 8041942C 003E29EC  3C A0 43 1C */	lis r5, 0x431c
/* 80419430 003E29F0  80 06 00 F8 */	lwz r0, 0xf8(r6)
/* 80419434 003E29F4  3C C0 10 62 */	lis r6, 0x1062
/* 80419438 003E29F8  39 46 4D D3 */	addi r10, r6, 0x4dd3
...
/* 80419444 003E2A04  38 A5 DE 83 */	addi r5, r5, -0x217d
/* 80419448 003E2A08  7D 05 00 16 */	mulhwu r8, r5, r0
/* 8041944C 003E2A0C  3C E0 00 66 */	lis r7, 0x66
/* 80419450 003E2A10  7C 86 23 78 */	mr r6, r4
/* 80419454 003E2A14  38 07 B9 AB */	addi r0, r7, -0x4655
/* 80419458 003E2A18  7C 65 1B 78 */	mr r5, r3
/* 8041945C 003E2A1C  38 7F 00 08 */	addi r3, r31, 0x8
/* 80419460 003E2A20  55 04 8B FE */	srwi r4, r8, 15
...
/* 8041946C 003E2A2C  38 E0 00 00 */	li r7, 0x0
...
/* 8041947C 003E2A3C  38 00 00 01 */	li r0, 0x1
/* 80419480 003E2A40  98 1F 00 00 */	stb r0, 0x0(r31)
.L_80419484:
...
# nw4r::snd::detail::RemoteSpeakerManager::Shutdown()
...
/* 804194AC 003E2A6C  88 03 00 00 */	lbz r0, 0x0(r3)
/* 804194B0 003E2A70  2C 00 00 00 */	cmpwi r0, 0x0
/* 804194B4 003E2A74  41 82 00 14 */	beq .L_804194C8
/* 804194B8 003E2A78  38 63 00 08 */	addi r3, r3, 0x8
/* 804194BC 003E2A7C  4B F3 9C C5 */	bl OSCancelAlarm
/* 804194C0 003E2A80  38 00 00 00 */	li r0, 0x0
/* 804194C4 003E2A84  98 1F 00 00 */	stb r0, 0x0(r31)
.L_804194C8:
...
/* 80419504 003E2AC4  38 00 00 00 */	li r0, 0x0
...
/* 8041952C 003E2AEC  38 80 00 01 */	li r4, 0x1
/* 80419530 003E2AF0  38 A0 00 00 */	li r5, 0x0
/* 80419534 003E2AF4  38 60 00 02 */	li r3, 0x2
/* 80419538 003E2AF8  38 00 00 03 */	li r0, 0x3
...
/* 8041958C 003E2B4C  38 81 00 08 */	addi r4, r1, 0x8
...
/* 8041959C 003E2B5C  3B FF 00 01 */	addi r31, r31, 0x1
/* 804195A0 003E2B60  3B BD 00 A8 */	addi r29, r29, 0xa8
/* 804195A4 003E2B64  2C 1F 00 04 */	cmpwi r31, 0x4
...
.balign 8
.sym lbl_8063B1E8, global
	.skip 0x2D8

# 0x80667DD0 - 0x80667DD8
.section .sbss, "wa", @nobits
.balign 8
.sym lbl_80667DD0, global
	.skip 0x8
