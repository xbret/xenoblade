...
/* 8041ABD8 003E4198  93 C1 00 08 */	stw r30, 0x8(r1)
...
/* 8041ABF0 003E41B0  90 9E 00 00 */	stw r4, 0x0(r30)
...
/* 8041ABFC 003E41BC  38 00 00 00 */	li r0, 0x0
...
/* 8041AC44 003E4204  83 C1 00 08 */	lwz r30, 0x8(r1)
...
# nw4r::snd::detail::SeqSound::SeqLoadTask::~SeqLoadTask()
...
/* 8041AC60 003E4220  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 8041AC9C 003E425C  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 8041ACC8 003E4288  38 00 00 00 */	li r0, 0x0
...
# nw4r::snd::detail::SeqSound::Setup(nw4r::snd::detail::SeqTrackAllocator*, unsigned long, nw4r::snd::detail::NoteOnCallback*)
...
/* 8041AD10 003E42D0  81 83 00 00 */	lwz r12, 0x0(r3)
...
# nw4r::snd::detail::SeqSound::Prepare(const void*, long, nw4r::snd::detail::SeqPlayer::OffsetType, int)
...
/* 8041AD8C 003E434C  2C 1F 00 00 */	cmpwi r31, 0x0
...
.L_8041ADA4:
/* 8041ADA4 003E4364  38 00 00 01 */	li r0, 0x1
...
# nw4r::snd::detail::SeqSound::Prepare(nw4r::ut::FileStream*, long, nw4r::snd::detail::SeqPlayer::OffsetType, int)
...
/* 8041ADD4 003E4394  38 00 00 01 */	li r0, 0x1
...
/* 8041ADE8 003E43A8  83 C3 00 04 */	lwz r30, 0x4(r3)
/* 8041ADEC 003E43AC  90 83 02 A8 */	stw r4, 0x2a8(r3)
/* 8041ADF0 003E43B0  2C 1E 00 00 */	cmpwi r30, 0x0
...
/* 8041AE08 003E43C8  38 00 00 00 */	li r0, 0x0
/* 8041AE0C 003E43CC  48 00 00 78 */	b .L_8041AE84
.L_8041AE10:
/* 8041AE10 003E43D0  81 84 00 00 */	lwz r12, 0x0(r4)
...
/* 8041AE24 003E43E4  81 9E 00 00 */	lwz r12, 0x0(r30)
...
/* 8041AE40 003E4400  2C 03 00 00 */	cmpwi r3, 0x0
/* 8041AE44 003E4404  40 82 00 0C */	bne .L_8041AE50
/* 8041AE48 003E4408  38 00 00 00 */	li r0, 0x0
...
/* 8041AE78 003E4438  38 A0 00 01 */	li r5, 0x1
...
/* 8041AE80 003E4440  38 00 00 01 */	li r0, 0x1
.L_8041AE84:
/* 8041AE84 003E4444  2C 00 00 00 */	cmpwi r0, 0x0
/* 8041AE88 003E4448  40 82 00 18 */	bne .L_8041AEA0
/* 8041AE8C 003E444C  81 9D 00 00 */	lwz r12, 0x0(r29)
...
# nw4r::snd::detail::SeqSound::NotifyLoadAsyncEndSeqData(bool, const void*, void*)
...
/* 8041AEC4 003E4484  2C 03 00 00 */	cmpwi r3, 0x0
/* 8041AEC8 003E4488  90 01 00 14 */	stw r0, 0x14(r1)
/* 8041AECC 003E448C  38 00 00 00 */	li r0, 0x0
...
/* 8041AEE4 003E44A4  38 80 00 00 */	li r4, 0x0
...
/* 8041AF00 003E44C0  2C 05 00 00 */	cmpwi r5, 0x0
...
.L_8041AF14:
/* 8041AF14 003E44D4  38 00 00 01 */	li r0, 0x1
...
/* 8041AF50 003E4510  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 8041AFA0 003E4560  80 1E 00 04 */	lwz r0, 0x4(r30)
/* 8041AFA4 003E4564  2C 00 00 00 */	cmpwi r0, 0x0
...
.L_8041AFB8:
/* 8041AFB8 003E4578  38 7E 00 04 */	addi r3, r30, 0x4
...
/* 8041AFC4 003E4584  81 9D 00 00 */	lwz r12, 0x0(r29)
/* 8041AFC8 003E4588  7F A3 EB 78 */	mr r3, r29
/* 8041AFCC 003E458C  38 80 FF FF */	li r4, -0x1
...
/* 8041B014 003E45D4  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 8041B024 003E45E4  93 C1 00 08 */	stw r30, 0x8(r1)
...
/* 8041B064 003E4624  83 C1 00 08 */	lwz r30, 0x8(r1)
...
# nw4r::snd::detail::SeqSound::SetReleasePriorityFix(bool)
...
# nw4r::snd::detail::SeqSound::SetSeqUserprocCallback(void (*)(unsigned short, nw4r::snd::SeqUserprocCallbackParam*, void*), void*)
...
# nw4r::snd::detail::SeqSound::OnUpdatePlayerPriority()
...
.L_8041B0CC:
/* 8041B0CC 003E468C  7C 80 FE 70 */	srawi r0, r4, 31
...
/* 8041B0E8 003E46A8  38 7E 00 04 */	addi r3, r30, 0x4
...
/* 8041B0F4 003E46B4  80 7E 00 08 */	lwz r3, 0x8(r30)
/* 8041B0F8 003E46B8  38 1E 00 08 */	addi r0, r30, 0x8
...
.L_8041B11C:
/* 8041B11C 003E46DC  7C A4 FE 70 */	srawi r4, r5, 31
...
/* 8041B12C 003E46EC  80 63 00 00 */	lwz r3, 0x0(r3)
.L_8041B130:
/* 8041B130 003E46F0  7C 03 00 40 */	cmplw r3, r0
/* 8041B134 003E46F4  40 82 FF CC */	bne .L_8041B100
.L_8041B138:
/* 8041B138 003E46F8  90 61 00 08 */	stw r3, 0x8(r1)
/* 8041B13C 003E46FC  7F 85 E3 78 */	mr r5, r28
/* 8041B140 003E4700  38 7E 00 04 */	addi r3, r30, 0x4
/* 8041B144 003E4704  38 81 00 08 */	addi r4, r1, 0x8
...
/* 8041B180 003E4740  54 03 0F FE */	srwi r3, r0, 31
...
# nw4r::snd::detail::SeqSound::SeqLoadTask::Execute()
...
/* 8041B198 003E4758  38 80 00 00 */	li r4, 0x0
/* 8041B19C 003E475C  38 A0 00 00 */	li r5, 0x0
...
/* 8041B1B0 003E4770  81 83 00 00 */	lwz r12, 0x0(r3)
...
/* 8041B1C8 003E4788  81 83 00 00 */	lwz r12, 0x0(r3)
...
/* 8041B1DC 003E479C  38 00 00 00 */	li r0, 0x0
/* 8041B1E0 003E47A0  2C 03 FF FD */	cmpwi r3, -0x3
...
/* 8041B1F0 003E47B0  2C 0C 00 00 */	cmpwi r12, 0x0
/* 8041B1F4 003E47B4  41 82 00 80 */	beq .L_8041B274
/* 8041B1F8 003E47B8  80 BF 00 20 */	lwz r5, 0x20(r31)
/* 8041B1FC 003E47BC  38 60 00 00 */	li r3, 0x0
/* 8041B200 003E47C0  38 80 00 00 */	li r4, 0x0
...
/* 8041B220 003E47E0  2C 0C 00 00 */	cmpwi r12, 0x0
/* 8041B224 003E47E4  41 82 00 50 */	beq .L_8041B274
/* 8041B228 003E47E8  80 BF 00 20 */	lwz r5, 0x20(r31)
/* 8041B22C 003E47EC  38 60 00 00 */	li r3, 0x0
/* 8041B230 003E47F0  38 80 00 00 */	li r4, 0x0
...
/* 8041B244 003E4804  38 61 00 08 */	addi r3, r1, 0x8
/* 8041B248 003E4808  4B FF E3 8D */	bl __ct__Q44nw4r3snd6detail13SeqFileReaderFPCv
/* 8041B24C 003E480C  38 61 00 08 */	addi r3, r1, 0x8
...
/* 8041B258 003E4818  2C 0C 00 00 */	cmpwi r12, 0x0
...
/* 8041B268 003E4828  38 60 00 01 */	li r3, 0x1
...
# nw4r::snd::detail::SeqSound::IsPrepared() const
