...
/* 80429BF4 003F31B4  93 C1 00 08 */	stw r30, 0x8(r1)
...
/* 80429C0C 003F31CC  90 9E 00 00 */	stw r4, 0x0(r30)
/* 80429C10 003F31D0  48 00 07 1D */	bl __ct__Q44nw4r3snd6detail9WsdPlayerFv
/* 80429C14 003F31D4  38 00 00 00 */	li r0, 0x0
...
/* 80429C2C 003F31EC  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 80429C48 003F3208  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 80429C5C 003F321C  2C 04 00 00 */	cmpwi r4, 0x0
...
# nw4r::snd::detail::WaveSound::Prepare(const void*, long, nw4r::snd::detail::WsdPlayer::StartOffsetType, long, const nw4r::snd::detail::WsdPlayer::WsdCallback*, unsigned long)
.fn Prepare__Q44nw4r3snd6detail9WaveSoundFPCvlQ54nw4r3snd6detail9WsdPlayer15StartOffsetTypelPCQ54nw4r3snd6detail9WsdPlayer11WsdCallbackUl, global
...
/* 80429C94 003F3254  81 83 00 00 */	lwz r12, 0x0(r3)
...
/* 80429CEC 003F32AC  2C 03 00 00 */	cmpwi r3, 0x0
/* 80429CF0 003F32B0  40 82 00 0C */	bne .L_80429CFC
/* 80429CF4 003F32B4  38 60 00 00 */	li r3, 0x0
/* 80429CF8 003F32B8  48 00 00 10 */	b .L_80429D08
.L_80429CFC:
/* 80429CFC 003F32BC  38 00 00 01 */	li r0, 0x1
/* 80429D00 003F32C0  38 60 00 01 */	li r3, 0x1
...
.endfn Prepare__Q44nw4r3snd6detail9WaveSoundFPCvlQ54nw4r3snd6detail9WsdPlayer15StartOffsetTypelPCQ54nw4r3snd6detail9WsdPlayer11WsdCallbackUl
...
/* 80429D50 003F3310  80 1E 00 04 */	lwz r0, 0x4(r30)
/* 80429D54 003F3314  2C 00 00 00 */	cmpwi r0, 0x0
...
.L_80429D68:
/* 80429D68 003F3328  38 7E 00 04 */	addi r3, r30, 0x4
...
/* 80429D74 003F3334  81 9D 00 00 */	lwz r12, 0x0(r29)
/* 80429D78 003F3338  7F A3 EB 78 */	mr r3, r29
/* 80429D7C 003F333C  38 80 FF FF */	li r4, -0x1
...
/* 80429DC4 003F3384  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 80429DD8 003F3398  2C 04 00 00 */	cmpwi r4, 0x0
...
# nw4r::snd::detail::WaveSound::SetReleasePriorityFix(bool)
.fn SetReleasePriorityFix__Q44nw4r3snd6detail9WaveSoundFb, global
...
.endfn SetReleasePriorityFix__Q44nw4r3snd6detail9WaveSoundFb

# nw4r::snd::detail::WaveSound::OnUpdatePlayerPriority()
.fn OnUpdatePlayerPriority__Q44nw4r3snd6detail9WaveSoundFv, global
...
.L_80429E48:
/* 80429E48 003F3408  7C 80 FE 70 */	srawi r0, r4, 31
...
/* 80429E64 003F3424  38 7E 00 04 */	addi r3, r30, 0x4
...
/* 80429E70 003F3430  80 7E 00 08 */	lwz r3, 0x8(r30)
/* 80429E74 003F3434  38 1E 00 08 */	addi r0, r30, 0x8
...
.L_80429E98:
/* 80429E98 003F3458  7C A4 FE 70 */	srawi r4, r5, 31
...
/* 80429EA8 003F3468  80 63 00 00 */	lwz r3, 0x0(r3)
.L_80429EAC:
/* 80429EAC 003F346C  7C 03 00 40 */	cmplw r3, r0
/* 80429EB0 003F3470  40 82 FF CC */	bne .L_80429E7C
.L_80429EB4:
/* 80429EB4 003F3474  90 61 00 08 */	stw r3, 0x8(r1)
/* 80429EB8 003F3478  7F 85 E3 78 */	mr r5, r28
/* 80429EBC 003F347C  38 7E 00 04 */	addi r3, r30, 0x4
/* 80429EC0 003F3480  38 81 00 08 */	addi r4, r1, 0x8
...
.endfn OnUpdatePlayerPriority__Q44nw4r3snd6detail9WaveSoundFv
...
/* 80429EFC 003F34BC  54 03 0F FE */	srwi r3, r0, 31
...
# nw4r::snd::detail::WaveSound::IsPrepared() const
.fn IsPrepared__Q44nw4r3snd6detail9WaveSoundCFv, global
