...
/* 80425800 003EEDC0  38 E0 00 03 */	li r7, 0x3
/* 80425804 003EEDC4  4B E9 42 FD */	bl __construct_array
/* 80425808 003EEDC8  38 00 00 00 */	li r0, 0x0
...
/* 8042583C 003EEDFC  38 00 00 01 */	li r0, 0x1
...
/* 80425868 003EEE28  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 80425878 003EEE38  93 C1 00 08 */	stw r30, 0x8(r1)
...
/* 80425890 003EEE50  38 C0 00 03 */	li r6, 0x3
/* 80425894 003EEE54  4B E9 43 65 */	bl __destroy_arr
/* 80425898 003EEE58  2C 1F 00 00 */	cmpwi r31, 0x0
...
/* 804258B0 003EEE70  83 C1 00 08 */	lwz r30, 0x8(r1)
...
# nw4r::ut::LinkList_Q44nw4r3snd6detail4Task_4_::~LinkList_Q44nw4r3snd6detail4Task_4_()
...
/* 804258CC 003EEE8C  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 80425908 003EEEC8  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 8042591C 003EEEDC  38 00 00 00 */	li r0, 0x0
/* 80425920 003EEEE0  38 83 00 04 */	addi r4, r3, 0x4
/* 80425924 003EEEE4  90 03 00 04 */	stw r0, 0x4(r3)
/* 80425928 003EEEE8  90 03 00 08 */	stw r0, 0x8(r3)
/* 8042592C 003EEEEC  90 03 00 00 */	stw r0, 0x0(r3)
/* 80425930 003EEEF0  90 83 00 04 */	stw r4, 0x4(r3)
/* 80425934 003EEEF4  90 83 00 08 */	stw r4, 0x8(r3)
...
/* 80425968 003EEF28  38 80 00 01 */	li r4, 0x1
/* 8042596C 003EEF2C  98 9E 00 0C */	stb r4, 0xc(r30)
/* 80425970 003EEF30  7C 7F 1B 78 */	mr r31, r3
/* 80425974 003EEF34  38 81 00 08 */	addi r4, r1, 0x8
/* 80425978 003EEF38  7C 7D 02 14 */	add r3, r29, r0
/* 8042597C 003EEF3C  38 03 00 04 */	addi r0, r3, 0x4
/* 80425980 003EEF40  38 BE 00 04 */	addi r5, r30, 0x4
/* 80425984 003EEF44  90 01 00 08 */	stw r0, 0x8(r1)
...
# nw4r::snd::detail::TaskManager::PopTask()
...
/* 80425A1C 003EEFDC  3B DD FF FC */	addi r30, r29, -0x4
.L_80425A20:
/* 80425A20 003EEFE0  2C 1E 00 00 */	cmpwi r30, 0x0
...
/* 80425A74 003EF034  3B DD FF FC */	addi r30, r29, -0x4
.L_80425A78:
/* 80425A78 003EF038  2C 1E 00 00 */	cmpwi r30, 0x0
...
/* 80425A94 003EF054  80 1C 00 00 */	lwz r0, 0x0(r28)
/* 80425A98 003EF058  7C 7E 1B 78 */	mr r30, r3
/* 80425A9C 003EF05C  2C 00 00 00 */	cmpwi r0, 0x0
/* 80425AA0 003EF060  40 82 00 10 */	bne .L_80425AB0
/* 80425AA4 003EF064  4B F3 2F 4D */	bl OSRestoreInterrupts
/* 80425AA8 003EF068  3B C0 00 00 */	li r30, 0x0
/* 80425AAC 003EF06C  48 00 00 24 */	b .L_80425AD0
.L_80425AB0:
/* 80425AB0 003EF070  83 BC 00 04 */	lwz r29, 0x4(r28)
/* 80425AB4 003EF074  7F 83 E3 78 */	mr r3, r28
/* 80425AB8 003EF078  38 81 00 08 */	addi r4, r1, 0x8
/* 80425ABC 003EF07C  93 A1 00 08 */	stw r29, 0x8(r1)
...
/* 80425ACC 003EF08C  3B DD FF FC */	addi r30, r29, -0x4
.L_80425AD0:
/* 80425AD0 003EF090  2C 1E 00 00 */	cmpwi r30, 0x0
...
/* 80425AF0 003EF0B0  38 60 00 00 */	li r3, 0x0
.L_80425AF4:
...
# nw4r::snd::detail::TaskManager::GetNextTask()
...
/* 80425B5C 003EF11C  3B DE FF FC */	addi r30, r30, -0x4
.L_80425B60:
/* 80425B60 003EF120  2C 1E 00 00 */	cmpwi r30, 0x0
...
/* 80425B9C 003EF15C  3B DE FF FC */	addi r30, r30, -0x4
.L_80425BA0:
/* 80425BA0 003EF160  2C 1E 00 00 */	cmpwi r30, 0x0
...
/* 80425BBC 003EF17C  80 1D 00 00 */	lwz r0, 0x0(r29)
/* 80425BC0 003EF180  2C 00 00 00 */	cmpwi r0, 0x0
/* 80425BC4 003EF184  40 82 00 10 */	bne .L_80425BD4
/* 80425BC8 003EF188  4B F3 2E 29 */	bl OSRestoreInterrupts
/* 80425BCC 003EF18C  3B C0 00 00 */	li r30, 0x0
/* 80425BD0 003EF190  48 00 00 10 */	b .L_80425BE0
.L_80425BD4:
/* 80425BD4 003EF194  83 DD 00 04 */	lwz r30, 0x4(r29)
/* 80425BD8 003EF198  4B F3 2E 19 */	bl OSRestoreInterrupts
/* 80425BDC 003EF19C  3B DE FF FC */	addi r30, r30, -0x4
.L_80425BE0:
/* 80425BE0 003EF1A0  2C 1E 00 00 */	cmpwi r30, 0x0
...
/* 80425C00 003EF1C0  38 60 00 00 */	li r3, 0x0
.L_80425C04:
...
# nw4r::snd::detail::TaskManager::ExecuteTask()
...
# nw4r::snd::detail::TaskManager::CancelTask(nw4r::snd::detail::Task*)
...
/* 80425CCC 003EF28C  81 9A 00 00 */	lwz r12, 0x0(r26)
...
.L_80425CFC:
/* 80425CFC 003EF2BC  3B 60 00 00 */	li r27, 0x0
/* 80425D00 003EF2C0  3B E0 00 00 */	li r31, 0x0
/* 80425D04 003EF2C4  3B A0 00 00 */	li r29, 0x0
.L_80425D08:
/* 80425D08 003EF2C8  7C 79 FA 14 */	add r3, r25, r31
/* 80425D0C 003EF2CC  80 83 00 04 */	lwz r4, 0x4(r3)
/* 80425D10 003EF2D0  38 03 00 04 */	addi r0, r3, 0x4
/* 80425D14 003EF2D4  48 00 00 40 */	b .L_80425D54
.L_80425D18:
/* 80425D18 003EF2D8  7C 9C 23 78 */	mr r28, r4
/* 80425D1C 003EF2DC  80 84 00 00 */	lwz r4, 0x0(r4)
/* 80425D20 003EF2E0  38 BC FF FC */	addi r5, r28, -0x4
/* 80425D24 003EF2E4  7C 05 D0 40 */	cmplw r5, r26
/* 80425D28 003EF2E8  40 82 00 2C */	bne .L_80425D54
/* 80425D2C 003EF2EC  93 81 00 08 */	stw r28, 0x8(r1)
/* 80425D30 003EF2F0  38 81 00 08 */	addi r4, r1, 0x8
/* 80425D34 003EF2F4  48 00 57 61 */	bl Erase__Q44nw4r2ut6detail12LinkListImplFQ54nw4r2ut6detail12LinkListImpl8Iterator
/* 80425D38 003EF2F8  9B BC 00 08 */	stb r29, 0x8(r28)
/* 80425D3C 003EF2FC  38 7C FF FC */	addi r3, r28, -0x4
/* 80425D40 003EF300  81 9C FF FC */	lwz r12, -0x4(r28)
...
.L_80425D5C:
/* 80425D5C 003EF31C  3B 7B 00 01 */	addi r27, r27, 0x1
/* 80425D60 003EF320  3B FF 00 0C */	addi r31, r31, 0xc
/* 80425D64 003EF324  2C 1B 00 03 */	cmpwi r27, 0x3
...
# nw4r::snd::detail::TaskManager::CancelAllTask()
...
/* 80425DAC 003EF36C  3B 60 00 00 */	li r27, 0x0
/* 80425DB0 003EF370  3B E0 00 00 */	li r31, 0x0
/* 80425DB4 003EF374  3B A0 00 00 */	li r29, 0x0
.L_80425DB8:
/* 80425DB8 003EF378  7C 19 F8 2E */	lwzx r0, r25, r31
/* 80425DBC 003EF37C  7F 59 FA 14 */	add r26, r25, r31
/* 80425DC0 003EF380  2C 00 00 00 */	cmpwi r0, 0x0
/* 80425DC4 003EF384  41 82 00 44 */	beq .L_80425E08
/* 80425DC8 003EF388  48 00 00 34 */	b .L_80425DFC
.L_80425DCC:
/* 80425DCC 003EF38C  80 BA 00 08 */	lwz r5, 0x8(r26)
/* 80425DD0 003EF390  7F 43 D3 78 */	mr r3, r26
/* 80425DD4 003EF394  38 81 00 08 */	addi r4, r1, 0x8
/* 80425DD8 003EF398  90 A1 00 08 */	stw r5, 0x8(r1)
/* 80425DDC 003EF39C  3B 85 FF FC */	addi r28, r5, -0x4
...
/* 80425E48 003EF408  2C 00 00 00 */	cmpwi r0, 0x0
...
# nw4r::snd::detail::TaskManager::WaitTask()
...
/* 80425ED0 003EF490  83 C1 00 08 */	lwz r30, 0x8(r1)
...
# nw4r::snd::detail::TaskManager::CancelWaitTask()
...
/* 80425F20 003EF4E0  83 C1 00 08 */	lwz r30, 0x8(r1)
