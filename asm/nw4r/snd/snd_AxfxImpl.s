...
/* 804115BC 003DAB7C  2C 04 00 00 */	cmpwi r4, 0x0
...
/* 80411630 003DABF0  80 03 00 00 */	lwz r0, 0x0(r3)
/* 80411634 003DABF4  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 80411644 003DAC04  38 00 00 00 */	li r0, 0x0
/* 80411648 003DAC08  90 1F 00 00 */	stw r0, 0x0(r31)
.L_8041164C:
...
# nw4r::snd::detail::AxfxImpl::HookAlloc(void* (**)(unsigned long), void (**)(void*))
...
/* 80411694 003DAC54  38 00 00 00 */	li r0, 0x0
...
# nw4r::snd::detail::AxfxImpl::RestoreAlloc(void* (*)(unsigned long), void (*)(void*))
...
/* 804116CC 003DAC8C  38 00 00 00 */	li r0, 0x0
...
/* 804116F0 003DACB0  38 A0 00 04 */	li r5, 0x4
...
/* 80411708 003DACC8  80 66 00 00 */	lwz r3, 0x0(r6)
/* 8041170C 003DACCC  4B F3 81 25 */	bl MEMAllocFromFrmHeapEx
/* 80411710 003DACD0  80 AD BC 28 */	lwz r5, lbl_80667DA8@sda21(r13)
/* 80411714 003DACD4  38 1F 00 03 */	addi r0, r31, 0x3
/* 80411718 003DACD8  54 00 00 3A */	clrrwi r0, r0, 2
/* 8041171C 003DACDC  80 85 00 04 */	lwz r4, 0x4(r5)
/* 80411720 003DACE0  38 84 00 01 */	addi r4, r4, 0x1
/* 80411724 003DACE4  90 85 00 04 */	stw r4, 0x4(r5)
...
/* 8041174C 003DAD0C  80 64 00 04 */	lwz r3, 0x4(r4)
/* 80411750 003DAD10  2C 03 00 00 */	cmpwi r3, 0x0
/* 80411754 003DAD14  41 82 00 0C */	beq .L_80411760
/* 80411758 003DAD18  38 03 FF FF */	addi r0, r3, -0x1
/* 8041175C 003DAD1C  90 04 00 04 */	stw r0, 0x4(r4)
.L_80411760:
/* 80411760 003DAD20  80 6D BC 28 */	lwz r3, lbl_80667DA8@sda21(r13)
/* 80411764 003DAD24  80 03 00 04 */	lwz r0, 0x4(r3)
/* 80411768 003DAD28  2C 00 00 00 */	cmpwi r0, 0x0
/* 8041176C 003DAD2C  4C 82 00 20 */	bnelr
/* 80411770 003DAD30  80 63 00 00 */	lwz r3, 0x0(r3)
/* 80411774 003DAD34  38 80 00 03 */	li r4, 0x3
