.include "macros.inc"
.file "nw4r/snd/snd_SeqSoundHandle.o"

# 0x8041B304 - 0x8041B33C
.text
.balign 4

# nw4r::snd::SeqSoundHandle::DetachSound()
.fn DetachSound__Q34nw4r3snd14SeqSoundHandleFv, global
/* 8041B304 003E48C4  80 83 00 00 */	lwz r4, 0x0(r3)
/* 8041B308 003E48C8  2C 04 00 00 */	cmpwi r4, 0x0
...
/* 8041B31C 003E48DC  38 00 00 00 */	li r0, 0x0
/* 8041B320 003E48E0  90 04 02 90 */	stw r0, 0x290(r4)
.L_8041B324:
/* 8041B324 003E48E4  80 03 00 00 */	lwz r0, 0x0(r3)
/* 8041B328 003E48E8  2C 00 00 00 */	cmpwi r0, 0x0
/* 8041B32C 003E48EC  4D 82 00 20 */	beqlr
/* 8041B330 003E48F0  38 00 00 00 */	li r0, 0x0
/* 8041B334 003E48F4  90 03 00 00 */	stw r0, 0x0(r3)
