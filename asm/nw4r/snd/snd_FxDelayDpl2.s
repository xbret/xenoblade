...
/* 80415FC4 003DF584  38 00 00 00 */	li r0, 0x0
...
/* 80415FDC 003DF59C  38 81 00 08 */	addi r4, r1, 0x8
/* 80415FE0 003DF5A0  90 03 00 04 */	stw r0, 0x4(r3)
/* 80415FE4 003DF5A4  90 03 00 08 */	stw r0, 0x8(r3)
/* 80415FE8 003DF5A8  90 A3 00 00 */	stw r5, 0x0(r3)
...
/* 8041600C 003DF5CC  D0 41 00 08 */	stfs f2, 0x8(r1)
...
# nw4r::snd::FxDelayDpl2::GetRequiredMemSize()
...
# nw4r::snd::FxDelayDpl2::AssignWorkBuffer(void*, unsigned long)
...
# nw4r::snd::FxDelayDpl2::ReleaseWorkBuffer()
...
/* 804160C8 003DF688  54 1F 00 34 */	clrrwi r31, r0, 5
/* 804160CC 003DF68C  4B EC 0F F5 */	bl AXFXDelayExpGetMemSizeDpl2
/* 804160D0 003DF690  38 03 00 87 */	addi r0, r3, 0x87
/* 804160D4 003DF694  54 03 00 34 */	clrrwi r3, r0, 5
/* 804160D8 003DF698  7C 03 F8 40 */	cmplw r3, r31
/* 804160DC 003DF69C  40 80 00 08 */	bge .L_804160E4
/* 804160E0 003DF6A0  7F E3 FB 78 */	mr r3, r31
.L_804160E4:
/* 804160E4 003DF6A4  80 9E 00 14 */	lwz r4, 0x14(r30)
/* 804160E8 003DF6A8  2C 04 00 00 */	cmpwi r4, 0x0
/* 804160EC 003DF6AC  40 82 00 0C */	bne .L_804160F8
/* 804160F0 003DF6B0  38 00 00 00 */	li r0, 0x0
/* 804160F4 003DF6B4  48 00 00 0C */	b .L_80416100
.L_804160F8:
...
/* 80416104 003DF6C4  40 81 00 0C */	ble .L_80416110
/* 80416108 003DF6C8  38 60 00 00 */	li r3, 0x0
/* 8041610C 003DF6CC  48 00 00 A4 */	b .L_804161B0
.L_80416110:
...
/* 80416118 003DF6D8  2C 03 00 02 */	cmpwi r3, 0x2
/* 8041611C 003DF6DC  40 82 00 44 */	bne .L_80416160
/* 80416120 003DF6E0  38 00 00 01 */	li r0, 0x1
...
/* 80416130 003DF6F0  38 A1 00 08 */	addi r5, r1, 0x8
...
/* 80416148 003DF708  80 A1 00 08 */	lwz r5, 0x8(r1)
...
/* 8041615C 003DF71C  48 00 00 40 */	b .L_8041619C
.L_80416160:
/* 80416160 003DF720  38 00 00 00 */	li r0, 0x0
...
/* 80416170 003DF730  38 A1 00 08 */	addi r5, r1, 0x8
...
/* 80416188 003DF748  80 A1 00 08 */	lwz r5, 0x8(r1)
...
/* 804161E0 003DF7A0  2C 00 00 00 */	cmpwi r0, 0x0
/* 804161E4 003DF7A4  41 82 00 4C */	beq .L_80416230
/* 804161E8 003DF7A8  38 00 00 00 */	li r0, 0x0
...
/* 804161F8 003DF7B8  38 A1 00 08 */	addi r5, r1, 0x8
...
/* 80416204 003DF7C4  2C 00 00 01 */	cmpwi r0, 0x1
/* 80416208 003DF7C8  40 82 00 10 */	bne .L_80416218
/* 8041620C 003DF7CC  38 7F 00 88 */	addi r3, r31, 0x88
/* 80416210 003DF7D0  4B EC 13 11 */	bl AXFXDelayExpShutdownDpl2
/* 80416214 003DF7D4  48 00 00 0C */	b .L_80416220
.L_80416218:
...
/* 80416228 003DF7E8  80 A1 00 08 */	lwz r5, 0x8(r1)
...
# nw4r::snd::FxDelayDpl2::SetParam(const nw4r::snd::detail::FxDelayParam&)
...
/* 80416290 003DF850  40 80 00 08 */	bge .L_80416298
/* 80416294 003DF854  48 00 00 08 */	b .L_8041629C
.L_80416298:
...
/* 804162AC 003DF86C  C0 04 00 00 */	lfs f0, 0x0(r4)
/* 804162B0 003DF870  54 00 1F FE */	extrwi r0, r0, 1, 2
/* 804162B4 003DF874  D0 A3 00 C8 */	stfs f5, 0xc8(r3)
/* 804162B8 003DF878  68 1E 00 01 */	xori r30, r0, 0x1
/* 804162BC 003DF87C  FC 00 08 40 */	fcmpo cr0, f0, f1
/* 804162C0 003DF880  D0 A3 00 68 */	stfs f5, 0x68(r3)
/* 804162C4 003DF884  40 81 00 08 */	ble .L_804162CC
/* 804162C8 003DF888  48 00 00 18 */	b .L_804162E0
.L_804162CC:
/* 804162CC 003DF88C  C0 22 C4 0C */	lfs f1, lbl_8066C78C@sda21(r2)
/* 804162D0 003DF890  FC 00 08 40 */	fcmpo cr0, f0, f1
/* 804162D4 003DF894  40 80 00 08 */	bge .L_804162DC
/* 804162D8 003DF898  48 00 00 08 */	b .L_804162E0
.L_804162DC:
/* 804162DC 003DF89C  FC 20 00 90 */	fmr f1, f0
.L_804162E0:
/* 804162E0 003DF8A0  C0 04 00 04 */	lfs f0, 0x4(r4)
...
/* 804162F4 003DF8B4  40 81 00 08 */	ble .L_804162FC
/* 804162F8 003DF8B8  48 00 00 18 */	b .L_80416310
.L_804162FC:
/* 804162FC 003DF8BC  C0 42 C4 14 */	lfs f2, lbl_8066C794@sda21(r2)
/* 80416300 003DF8C0  FC 00 10 40 */	fcmpo cr0, f0, f2
/* 80416304 003DF8C4  40 80 00 08 */	bge .L_8041630C
/* 80416308 003DF8C8  48 00 00 08 */	b .L_80416310
.L_8041630C:
...
/* 80416324 003DF8E4  40 81 00 08 */	ble .L_8041632C
/* 80416328 003DF8E8  48 00 00 18 */	b .L_80416340
.L_8041632C:
/* 8041632C 003DF8EC  C0 22 C4 14 */	lfs f1, lbl_8066C794@sda21(r2)
/* 80416330 003DF8F0  FC 00 08 40 */	fcmpo cr0, f0, f1
/* 80416334 003DF8F4  40 80 00 08 */	bge .L_8041633C
/* 80416338 003DF8F8  48 00 00 08 */	b .L_80416340
.L_8041633C:
/* 8041633C 003DF8FC  FC 20 00 90 */	fmr f1, f0
.L_80416340:
/* 80416340 003DF900  C0 04 00 08 */	lfs f0, 0x8(r4)
...
/* 80416354 003DF914  40 81 00 08 */	ble .L_8041635C
/* 80416358 003DF918  48 00 00 18 */	b .L_80416370
.L_8041635C:
/* 8041635C 003DF91C  C0 42 C4 14 */	lfs f2, lbl_8066C794@sda21(r2)
/* 80416360 003DF920  FC 00 10 40 */	fcmpo cr0, f0, f2
/* 80416364 003DF924  40 80 00 08 */	bge .L_8041636C
/* 80416368 003DF928  48 00 00 08 */	b .L_80416370
.L_8041636C:
/* 8041636C 003DF92C  FC 40 00 90 */	fmr f2, f0
.L_80416370:
/* 80416370 003DF930  88 03 00 0C */	lbz r0, 0xc(r3)
/* 80416374 003DF934  38 80 00 00 */	li r4, 0x0
/* 80416378 003DF938  C0 02 C4 14 */	lfs f0, lbl_8066C794@sda21(r2)
/* 8041637C 003DF93C  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 804163A0 003DF960  40 82 00 0C */	bne .L_804163AC
/* 804163A4 003DF964  38 60 00 01 */	li r3, 0x1
/* 804163A8 003DF968  48 00 00 DC */	b .L_80416484
.L_804163AC:
...
/* 804163BC 003DF97C  54 1F 00 34 */	clrrwi r31, r0, 5
/* 804163C0 003DF980  4B EC 0D 01 */	bl AXFXDelayExpGetMemSizeDpl2
/* 804163C4 003DF984  38 03 00 87 */	addi r0, r3, 0x87
/* 804163C8 003DF988  54 03 00 34 */	clrrwi r3, r0, 5
/* 804163CC 003DF98C  7C 03 F8 40 */	cmplw r3, r31
/* 804163D0 003DF990  40 80 00 08 */	bge .L_804163D8
/* 804163D4 003DF994  7F E3 FB 78 */	mr r3, r31
.L_804163D8:
/* 804163D8 003DF998  80 9D 00 14 */	lwz r4, 0x14(r29)
/* 804163DC 003DF99C  2C 04 00 00 */	cmpwi r4, 0x0
/* 804163E0 003DF9A0  40 82 00 0C */	bne .L_804163EC
/* 804163E4 003DF9A4  38 00 00 00 */	li r0, 0x0
/* 804163E8 003DF9A8  48 00 00 0C */	b .L_804163F4
.L_804163EC:
...
/* 804163F8 003DF9B8  40 81 00 0C */	ble .L_80416404
/* 804163FC 003DF9BC  38 60 00 00 */	li r3, 0x0
/* 80416400 003DF9C0  48 00 00 84 */	b .L_80416484
.L_80416404:
/* 80416404 003DF9C4  2C 1E 00 00 */	cmpwi r30, 0x0
/* 80416408 003DF9C8  41 82 00 4C */	beq .L_80416454
/* 8041640C 003DF9CC  38 7D 00 14 */	addi r3, r29, 0x14
/* 80416410 003DF9D0  38 81 00 0C */	addi r4, r1, 0xc
/* 80416414 003DF9D4  38 A1 00 08 */	addi r5, r1, 0x8
...
/* 80416420 003DF9E0  2C 00 00 01 */	cmpwi r0, 0x1
/* 80416424 003DF9E4  40 82 00 10 */	bne .L_80416434
/* 80416428 003DF9E8  38 7D 00 88 */	addi r3, r29, 0x88
/* 8041642C 003DF9EC  4B EC 0E F5 */	bl AXFXDelayExpSettingsDpl2
/* 80416430 003DF9F0  48 00 00 0C */	b .L_8041643C
.L_80416434:
...
/* 80416444 003DFA04  80 A1 00 08 */	lwz r5, 0x8(r1)
...
/* 80416450 003DFA10  48 00 00 28 */	b .L_80416478
.L_80416454:
/* 80416454 003DFA14  80 1D 00 10 */	lwz r0, 0x10(r29)
/* 80416458 003DFA18  2C 00 00 01 */	cmpwi r0, 0x1
/* 8041645C 003DFA1C  40 82 00 10 */	bne .L_8041646C
/* 80416460 003DFA20  38 7D 00 88 */	addi r3, r29, 0x88
/* 80416464 003DFA24  4B EC 0F ED */	bl AXFXDelayExpSettingsUpdateDpl2
/* 80416468 003DFA28  48 00 00 0C */	b .L_80416474
.L_8041646C:
...
/* 80416480 003DFA40  54 03 0F FE */	srwi r3, r0, 31
.L_80416484:
...
# nw4r::snd::FxDelayDpl2::UpdateBuffer(int, void**, unsigned long, nw4r::snd::SampleFormat, float, nw4r::snd::OutputMode)
...
/* 804164B4 003DFA74  2C 00 00 00 */	cmpwi r0, 0x0
/* 804164B8 003DFA78  41 82 00 78 */	beq .L_80416530
/* 804164BC 003DFA7C  38 08 FF FE */	addi r0, r8, -0x2
...
/* 804164D0 003DFA90  40 82 00 60 */	bne .L_80416530
/* 804164D4 003DFA94  2C 03 00 01 */	cmpwi r3, 0x1
/* 804164D8 003DFA98  40 82 00 34 */	bne .L_8041650C
/* 804164DC 003DFA9C  80 05 00 00 */	lwz r0, 0x0(r5)
...
/* 804164EC 003DFAAC  80 05 00 04 */	lwz r0, 0x4(r5)
/* 804164F0 003DFAB0  90 01 00 1C */	stw r0, 0x1c(r1)
/* 804164F4 003DFAB4  80 05 00 08 */	lwz r0, 0x8(r5)
...
/* 80416508 003DFAC8  48 00 00 28 */	b .L_80416530
.L_8041650C:
/* 8041650C 003DFACC  80 05 00 00 */	lwz r0, 0x0(r5)
/* 80416510 003DFAD0  38 61 00 08 */	addi r3, r1, 0x8
/* 80416514 003DFAD4  38 84 00 30 */	addi r4, r4, 0x30
/* 80416518 003DFAD8  90 01 00 08 */	stw r0, 0x8(r1)
/* 8041651C 003DFADC  80 05 00 04 */	lwz r0, 0x4(r5)
/* 80416520 003DFAE0  90 01 00 0C */	stw r0, 0xc(r1)
/* 80416524 003DFAE4  80 05 00 08 */	lwz r0, 0x8(r5)
...
# nw4r::snd::FxDelayDpl2::OnChangeOutputMode()
...
/* 8041655C 003DFB1C  38 63 FF FE */	addi r3, r3, -0x2
...
/* 80416570 003DFB30  41 82 00 2C */	beq .L_8041659C
/* 80416574 003DFB34  81 9F 00 00 */	lwz r12, 0x0(r31)
...
/* 80416588 003DFB48  81 9F 00 00 */	lwz r12, 0x0(r31)
