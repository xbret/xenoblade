...
/* 803D7270 003A0830  38 01 00 08 */	addi r0, r1, 0x8
/* 803D7274 003A0834  3D 80 02 00 */	lis r12, 0x200
/* 803D7278 003A0838  90 61 00 08 */	stw r3, 0x8(r1)
...
# nw4r::db::Console_GetTotalLines(nw4r::db::detail::ConsoleHead*)
...
/* 803D72D4 003A0894  A0 1F 00 06 */	lhz r0, 0x6(r31)
/* 803D72D8 003A0898  7C 84 02 14 */	add r4, r4, r0
.L_803D72DC:
/* 803D72DC 003A089C  A0 1F 00 0E */	lhz r0, 0xe(r31)
/* 803D72E0 003A08A0  54 84 04 3E */	clrlwi r4, r4, 16
/* 803D72E4 003A08A4  2C 00 00 00 */	cmpwi r0, 0x0
/* 803D72E8 003A08A8  41 82 00 0C */	beq .L_803D72F4
/* 803D72EC 003A08AC  38 04 00 01 */	addi r0, r4, 0x1
/* 803D72F0 003A08B0  54 04 04 3E */	clrlwi r4, r0, 16
.L_803D72F4:
...
# nw4r::ut::CharWriter::SetTextColor(nw4r::ut::Color)
.fn SetTextColor__Q34nw4r2ut10CharWriterFQ34nw4r2ut5Color, global
/* 803D7318 003A08D8  88 E4 00 00 */	lbz r7, 0x0(r4)
/* 803D731C 003A08DC  88 C4 00 01 */	lbz r6, 0x1(r4)
/* 803D7320 003A08E0  88 A4 00 02 */	lbz r5, 0x2(r4)
/* 803D7324 003A08E4  88 04 00 03 */	lbz r0, 0x3(r4)
