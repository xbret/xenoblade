...
/* 803D7378 003A0938  39 61 00 08 */	addi r11, r1, 0x8
/* 803D737C 003A093C  3F E0 01 00 */	lis r31, 0x100
/* 803D7380 003A0940  2C 00 00 00 */	cmpwi r0, 0x0
/* 803D7384 003A0944  90 61 00 08 */	stw r3, 0x8(r1)
...
/* 803D744C 003A0A0C  4C C6 31 82 */	crclr 4*cr1+eq
/* 803D7450 003A0A10  4B FF FE ED */	bl Assertion_Printf___Q24nw4r2dbFPCce
/* 803D7454 003A0A14  3B DE 00 01 */	addi r30, r30, 0x1
/* 803D7458 003A0A18  83 BD 00 00 */	lwz r29, 0x0(r29)
...
/* 803D7494 003A0A54  83 C1 00 00 */	lwz r30, 0x0(r1)
...
/* 803D74B4 003A0A74  38 60 00 00 */	li r3, 0x0
...
/* 803D74E8 003A0AA8  4C C6 31 82 */	crclr 4*cr1+eq
...
/* 803D74F8 003A0AB8  4C C6 31 82 */	crclr 4*cr1+eq
...
/* 803D7518 003A0AD8  38 00 00 00 */	li r0, 0x0
.L_803D751C:
/* 803D751C 003A0ADC  90 1E 00 18 */	stw r0, 0x18(r30)
/* 803D7520 003A0AE0  38 00 00 01 */	li r0, 0x1
...
/* 803D7540 003A0B00  4C C6 31 82 */	crclr 4*cr1+eq
...
/* 803D7558 003A0B18  4C C6 31 82 */	crclr 4*cr1+eq
/* 803D755C 003A0B1C  4B F7 D9 95 */	bl OSReport
.L_803D7560:
/* 803D7560 003A0B20  2C 1D 00 00 */	cmpwi r29, 0x0
...
/* 803D75BC 003A0B7C  38 01 00 08 */	addi r0, r1, 0x8
...
# nw4r::db::Warning(const char*, int, const char*, ...)
...
/* 803D7664 003A0C24  38 01 00 08 */	addi r0, r1, 0x8
/* 803D7668 003A0C28  3D 80 03 00 */	lis r12, 0x300
/* 803D766C 003A0C2C  2C 1E 00 00 */	cmpwi r30, 0x0
/* 803D7670 003A0C30  90 61 00 08 */	stw r3, 0x8(r1)
...
/* 803D76B8 003A0C78  4C C6 31 82 */	crclr 4*cr1+eq
...
/* 803D76C8 003A0C88  4C C6 31 82 */	crclr 4*cr1+eq
...
/* 803D7724 003A0CE4  38 00 00 01 */	li r0, 0x1
...
/* 803D7740 003A0D00  38 00 00 01 */	li r0, 0x1
/* 803D7744 003A0D04  2C 1E 00 00 */	cmpwi r30, 0x0
...
/* 803D775C 003A0D1C  38 A0 00 00 */	li r5, 0x0
...
/* 803D777C 003A0D3C  4C C6 31 82 */	crclr 4*cr1+eq
...
/* 803D7794 003A0D54  4C C6 31 82 */	crclr 4*cr1+eq
...
/* 803D77B8 003A0D78  2C 03 00 00 */	cmpwi r3, 0x0
/* 803D77BC 003A0D7C  4D 82 00 20 */	beqlr
/* 803D77C0 003A0D80  38 00 00 00 */	li r0, 0x0
...
# nw4r::ut::CharWriter::SetTextColor(nw4r::ut::Color, nw4r::ut::Color)
.fn SetTextColor__Q34nw4r2ut10CharWriterFQ34nw4r2ut5ColorQ34nw4r2ut5Color, global
/* 803D77CC 003A0D8C  89 64 00 00 */	lbz r11, 0x0(r4)
/* 803D77D0 003A0D90  89 44 00 01 */	lbz r10, 0x1(r4)
/* 803D77D4 003A0D94  89 24 00 02 */	lbz r9, 0x2(r4)
/* 803D77D8 003A0D98  89 04 00 03 */	lbz r8, 0x3(r4)
/* 803D77DC 003A0D9C  88 E5 00 00 */	lbz r7, 0x0(r5)
/* 803D77E0 003A0DA0  88 C5 00 01 */	lbz r6, 0x1(r5)
/* 803D77E4 003A0DA4  88 85 00 02 */	lbz r4, 0x2(r5)
/* 803D77E8 003A0DA8  88 05 00 03 */	lbz r0, 0x3(r5)
