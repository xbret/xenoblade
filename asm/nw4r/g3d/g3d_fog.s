...
/* 803FD128 003C66E8  90 83 00 00 */	stw r4, 0x0(r3)
/* 803FD12C 003C66EC  4E 80 00 20 */	blr
.endfn __ct__Q34nw4r3g3d3FogFPQ34nw4r3g3d7FogData

# nw4r::g3d::Fog::Init()
.fn Init__Q34nw4r3g3d3FogFv, global
/* 803FD130 003C66F0  80 63 00 00 */	lwz r3, 0x0(r3)
/* 803FD134 003C66F4  2C 03 00 00 */	cmpwi r3, 0x0
/* 803FD138 003C66F8  4D 82 00 20 */	beqlr
/* 803FD13C 003C66FC  38 00 00 00 */	li r0, 0x0
/* 803FD140 003C6700  C0 02 C1 78 */	lfs f0, lbl_8066C4F8@sda21(r2)
/* 803FD144 003C6704  90 03 00 00 */	stw r0, 0x0(r3)
/* 803FD148 003C6708  D0 03 00 04 */	stfs f0, 0x4(r3)
/* 803FD14C 003C670C  D0 03 00 08 */	stfs f0, 0x8(r3)
...
# nw4r::g3d::Fog::CopyTo(void*) const
.fn CopyTo__Q34nw4r3g3d3FogCFPv, global
/* 803FD1A0 003C6760  2C 04 00 00 */	cmpwi r4, 0x0
/* 803FD1A4 003C6764  41 82 00 48 */	beq .L_803FD1EC
/* 803FD1A8 003C6768  80 A3 00 00 */	lwz r5, 0x0(r3)
/* 803FD1AC 003C676C  2C 05 00 00 */	cmpwi r5, 0x0
/* 803FD1B0 003C6770  41 82 00 3C */	beq .L_803FD1EC
/* 803FD1B4 003C6774  C8 05 00 00 */	lfd f0, 0x0(r5)
/* 803FD1B8 003C6778  7C 83 23 78 */	mr r3, r4
/* 803FD1BC 003C677C  D8 04 00 00 */	stfd f0, 0x0(r4)
/* 803FD1C0 003C6780  C8 05 00 08 */	lfd f0, 0x8(r5)
/* 803FD1C4 003C6784  D8 04 00 08 */	stfd f0, 0x8(r4)
...
.L_803FD1EC:
/* 803FD1EC 003C67AC  38 60 00 00 */	li r3, 0x0
/* 803FD1F0 003C67B0  4E 80 00 20 */	blr
.endfn CopyTo__Q34nw4r3g3d3FogCFPv

# nw4r::g3d::Fog::GetFog(_GXFogType*, float*, float*, float*, float*, _GXColor*)
.fn GetFog__Q34nw4r3g3d3FogFP10_GXFogTypePfPfPfPfP8_GXColor, global
/* 803FD1F4 003C67B4  80 63 00 00 */	lwz r3, 0x0(r3)
/* 803FD1F8 003C67B8  2C 03 00 00 */	cmpwi r3, 0x0
/* 803FD1FC 003C67BC  4D 82 00 20 */	beqlr
/* 803FD200 003C67C0  2C 04 00 00 */	cmpwi r4, 0x0
/* 803FD204 003C67C4  41 82 00 0C */	beq .L_803FD210
/* 803FD208 003C67C8  80 03 00 00 */	lwz r0, 0x0(r3)
/* 803FD20C 003C67CC  90 04 00 00 */	stw r0, 0x0(r4)
.L_803FD210:
/* 803FD210 003C67D0  2C 05 00 00 */	cmpwi r5, 0x0
/* 803FD214 003C67D4  41 82 00 0C */	beq .L_803FD220
/* 803FD218 003C67D8  C0 03 00 04 */	lfs f0, 0x4(r3)
/* 803FD21C 003C67DC  D0 05 00 00 */	stfs f0, 0x0(r5)
.L_803FD220:
/* 803FD220 003C67E0  2C 06 00 00 */	cmpwi r6, 0x0
/* 803FD224 003C67E4  41 82 00 0C */	beq .L_803FD230
/* 803FD228 003C67E8  C0 03 00 08 */	lfs f0, 0x8(r3)
/* 803FD22C 003C67EC  D0 06 00 00 */	stfs f0, 0x0(r6)
.L_803FD230:
/* 803FD230 003C67F0  2C 07 00 00 */	cmpwi r7, 0x0
/* 803FD234 003C67F4  41 82 00 0C */	beq .L_803FD240
/* 803FD238 003C67F8  C0 03 00 0C */	lfs f0, 0xc(r3)
/* 803FD23C 003C67FC  D0 07 00 00 */	stfs f0, 0x0(r7)
.L_803FD240:
/* 803FD240 003C6800  2C 08 00 00 */	cmpwi r8, 0x0
/* 803FD244 003C6804  41 82 00 0C */	beq .L_803FD250
/* 803FD248 003C6808  C0 03 00 10 */	lfs f0, 0x10(r3)
/* 803FD24C 003C680C  D0 08 00 00 */	stfs f0, 0x0(r8)
.L_803FD250:
/* 803FD250 003C6810  2C 09 00 00 */	cmpwi r9, 0x0
/* 803FD254 003C6814  4D 82 00 20 */	beqlr
/* 803FD258 003C6818  88 03 00 14 */	lbz r0, 0x14(r3)
/* 803FD25C 003C681C  98 09 00 00 */	stb r0, 0x0(r9)
/* 803FD260 003C6820  88 03 00 15 */	lbz r0, 0x15(r3)
/* 803FD264 003C6824  98 09 00 01 */	stb r0, 0x1(r9)
/* 803FD268 003C6828  88 03 00 16 */	lbz r0, 0x16(r3)
/* 803FD26C 003C682C  98 09 00 02 */	stb r0, 0x2(r9)
/* 803FD270 003C6830  88 03 00 17 */	lbz r0, 0x17(r3)
/* 803FD274 003C6834  98 09 00 03 */	stb r0, 0x3(r9)
/* 803FD278 003C6838  4E 80 00 20 */	blr
.endfn GetFog__Q34nw4r3g3d3FogFP10_GXFogTypePfPfPfPfP8_GXColor

# nw4r::g3d::Fog::SetFogRangeAdjParam(unsigned short, unsigned short, const nw4r::math::MTX44&)
.fn SetFogRangeAdjParam__Q34nw4r3g3d3FogFUsUsRCQ34nw4r4math5MTX44, global
/* 803FD27C 003C683C  80 63 00 00 */	lwz r3, 0x0(r3)
/* 803FD280 003C6840  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 803FD2AC 003C686C  83 E3 00 00 */	lwz r31, 0x0(r3)
/* 803FD2B0 003C6870  2C 1F 00 00 */	cmpwi r31, 0x0
/* 803FD2B4 003C6874  41 82 00 5C */	beq .L_803FD310
/* 803FD2B8 003C6878  80 1F 00 00 */	lwz r0, 0x0(r31)
/* 803FD2BC 003C687C  2C 00 00 00 */	cmpwi r0, 0x0
/* 803FD2C0 003C6880  41 82 00 14 */	beq .L_803FD2D4
...
/* 803FD2D8 003C6898  38 81 00 08 */	addi r4, r1, 0x8
/* 803FD2DC 003C689C  98 01 00 08 */	stb r0, 0x8(r1)
/* 803FD2E0 003C68A0  88 1F 00 15 */	lbz r0, 0x15(r31)
/* 803FD2E4 003C68A4  98 01 00 09 */	stb r0, 0x9(r1)
...
/* 803FD2F8 003C68B8  80 7F 00 00 */	lwz r3, 0x0(r31)
/* 803FD2FC 003C68BC  C0 3F 00 04 */	lfs f1, 0x4(r31)
/* 803FD300 003C68C0  C0 5F 00 08 */	lfs f2, 0x8(r31)
