...
/* 803F1E24 003BB3E4  54 C0 FF 7E */	extrwi r0, r6, 3, 28
/* 803F1E28 003BB3E8  28 00 00 07 */	cmplwi r0, 0x7
...
/* 803F1E48 003BB408  38 60 00 00 */	li r3, 0x0
/* 803F1E4C 003BB40C  48 00 01 0C */	b .L_803F1F58
.L_803F1E50:
/* 803F1E50 003BB410  C0 25 00 08 */	lfs f1, 0x8(r5)
/* 803F1E54 003BB414  38 61 00 0C */	addi r3, r1, 0xc
/* 803F1E58 003BB418  C0 02 C1 08 */	lfs f0, lbl_8066C488@sda21(r2)
/* 803F1E5C 003BB41C  38 81 00 08 */	addi r4, r1, 0x8
/* 803F1E60 003BB420  EC 20 00 72 */	fmuls f1, f0, f1
/* 803F1E64 003BB424  48 01 8F 89 */	bl SinCosFIdx__Q24nw4r4mathFPfPff
/* 803F1E68 003BB428  2C 1E 00 00 */	cmpwi r30, 0x0
/* 803F1E6C 003BB42C  41 82 00 74 */	beq .L_803F1EE0
/* 803F1E70 003BB430  C0 FF 00 00 */	lfs f7, 0x0(r31)
/* 803F1E74 003BB434  C0 01 00 08 */	lfs f0, 0x8(r1)
/* 803F1E78 003BB438  C0 DF 00 04 */	lfs f6, 0x4(r31)
...
/* 803F1E90 003BB450  D0 1D 00 00 */	stfs f0, 0x0(r29)
...
/* 803F1EA0 003BB460  D0 7D 00 08 */	stfs f3, 0x8(r29)
/* 803F1EA4 003BB464  D0 5D 00 0C */	stfs f2, 0xc(r29)
/* 803F1EA8 003BB468  D0 9D 00 04 */	stfs f4, 0x4(r29)
...
/* 803F1EB8 003BB478  C0 41 00 08 */	lfs f2, 0x8(r1)
...
.L_803F1EE0:
/* 803F1EE0 003BB4A0  C0 5F 00 04 */	lfs f2, 0x4(r31)
...
/* 803F1EF4 003BB4B4  C0 61 00 08 */	lfs f3, 0x8(r1)
/* 803F1EF8 003BB4B8  C1 1F 00 00 */	lfs f8, 0x0(r31)
...
.L_803F1F54:
/* 803F1F54 003BB514  38 60 00 01 */	li r3, 0x1
.L_803F1F58:
...
# nw4r::g3d::detail::dcc::CalcWorldMtx_Basic(nw4r::math::MTX34*, nw4r::math::VEC3*, const nw4r::math::MTX34*, const nw4r::math::VEC3*, unsigned long, const nw4r::g3d::ChrAnmResult*)
...
/* 803F1FA8 003BB568  57 E0 07 7B */	rlwinm. r0, r31, 0, 29, 29
...
.L_803F1FDC:
/* 803F1FDC 003BB59C  57 E0 06 B5 */	rlwinm. r0, r31, 0, 26, 26
...
/* 803F1FF8 003BB5B8  38 A1 00 08 */	addi r5, r1, 0x8
/* 803F1FFC 003BB5BC  C0 08 00 28 */	lfs f0, 0x28(r8)
/* 803F2000 003BB5C0  D0 21 00 0C */	stfs f1, 0xc(r1)
/* 803F2004 003BB5C4  D0 01 00 08 */	stfs f0, 0x8(r1)
...
.L_803F2014:
/* 803F2014 003BB5D4  C0 26 00 00 */	lfs f1, 0x0(r6)
/* 803F2018 003BB5D8  38 68 00 1C */	addi r3, r8, 0x1c
/* 803F201C 003BB5DC  C0 46 00 04 */	lfs f2, 0x4(r6)
/* 803F2020 003BB5E0  38 81 00 18 */	addi r4, r1, 0x18
/* 803F2024 003BB5E4  C0 66 00 08 */	lfs f3, 0x8(r6)
...
.L_803F2078:
/* 803F2078 003BB638  57 E0 07 39 */	rlwinm. r0, r31, 0, 28, 28
...
/* 803F2088 003BB648  D0 1B 00 08 */	stfs f0, 0x8(r27)
/* 803F208C 003BB64C  D0 1B 00 04 */	stfs f0, 0x4(r27)
/* 803F2090 003BB650  D0 1B 00 00 */	stfs f0, 0x0(r27)
/* 803F2094 003BB654  48 00 00 20 */	b .L_803F20B4
.L_803F2098:
/* 803F2098 003BB658  C0 5E 00 04 */	lfs f2, 0x4(r30)
/* 803F209C 003BB65C  57 A4 00 BE */	clrlwi r4, r29, 2
/* 803F20A0 003BB660  C0 3E 00 08 */	lfs f1, 0x8(r30)
/* 803F20A4 003BB664  C0 1E 00 0C */	lfs f0, 0xc(r30)
/* 803F20A8 003BB668  D0 5B 00 00 */	stfs f2, 0x0(r27)
/* 803F20AC 003BB66C  D0 3B 00 04 */	stfs f1, 0x4(r27)
/* 803F20B0 003BB670  D0 1B 00 08 */	stfs f0, 0x8(r27)
.L_803F20B4:
/* 803F20B4 003BB674  57 E0 06 F7 */	rlwinm. r0, r31, 0, 27, 27
