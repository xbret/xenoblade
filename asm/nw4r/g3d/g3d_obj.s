...
/* 803E729C 003B085C  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 803E72BC 003B087C  90 A3 00 00 */	stw r5, 0x0(r3)
/* 803E72C0 003B0880  80 63 00 08 */	lwz r3, 0x8(r3)
...
/* 803E72F4 003B08B4  80 03 00 04 */	lwz r0, 0x4(r3)
/* 803E72F8 003B08B8  2C 00 00 00 */	cmpwi r0, 0x0
/* 803E72FC 003B08BC  41 82 00 28 */	beq .L_803E7324
/* 803E7300 003B08C0  7C 03 03 78 */	mr r3, r0
/* 803E7304 003B08C4  3C 80 00 01 */	lis r4, 0x1
/* 803E7308 003B08C8  81 83 00 00 */	lwz r12, 0x0(r3)
/* 803E730C 003B08CC  7F E6 FB 78 */	mr r6, r31
/* 803E7310 003B08D0  38 84 00 01 */	addi r4, r4, 0x1
/* 803E7314 003B08D4  38 A0 00 00 */	li r5, 0x0
/* 803E7318 003B08D8  81 8C 00 0C */	lwz r12, 0xc(r12)
/* 803E731C 003B08DC  7D 89 03 A6 */	mtctr r12
/* 803E7320 003B08E0  4E 80 04 21 */	bctrl
.L_803E7324:
/* 803E7324 003B08E4  2C 1F 00 00 */	cmpwi r31, 0x0
/* 803E7328 003B08E8  41 82 00 1C */	beq .L_803E7344
/* 803E732C 003B08EC  81 9F 00 00 */	lwz r12, 0x0(r31)
/* 803E7330 003B08F0  7F E3 FB 78 */	mr r3, r31
/* 803E7334 003B08F4  38 80 00 01 */	li r4, 0x1
...
# nw4r::g3d::G3dObj::IsDerivedFrom(nw4r::g3d::G3dObj::TypeObj) const
...
/* 803E735C 003B091C  80 04 00 00 */	lwz r0, 0x0(r4)
...
# nw4r::g3d::G3dObj::GetTypeName() const
...
/* 803E7380 003B0940  81 83 00 00 */	lwz r12, 0x0(r3)
...
/* 803E7394 003B0954  38 63 00 04 */	addi r3, r3, 0x4
...
# nw4r::g3d::G3dObj::GetTypeObj() const
