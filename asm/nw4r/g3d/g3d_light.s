...
/* 803FDC74 003C7234  4B EB C5 1D */	bl func_802BA190
...
/* 803FDE04 003C73C4  4B EB C3 9D */	bl func_802BA1A0
...
/* 803FDF24 003C74E4  4B EB C2 7D */	bl func_802BA1A0
...
/* 803FDF5C 003C751C  41 82 00 2C */	beq lbl_803FDF88
/* 803FDF60 003C7520  28 04 00 08 */	cmplwi r4, 8
/* 803FDF64 003C7524  40 80 00 24 */	bge lbl_803FDF88
...
/* 803FDF74 003C7534  41 80 00 14 */	blt lbl_803FDF88
...
/* 803FDFB4 003C7574  41 82 00 24 */	beq lbl_803FDFD8
...
/* 803FDFC4 003C7584  41 80 00 14 */	blt lbl_803FDFD8
...
/* 803FE004 003C75C4  41 82 00 44 */	beq lbl_803FE048
/* 803FE008 003C75C8  28 04 00 08 */	cmplwi r4, 8
/* 803FE00C 003C75CC  40 80 00 3C */	bge lbl_803FE048
/* 803FE010 003C75D0  2C 05 00 00 */	cmpwi r5, 0
/* 803FE014 003C75D4  40 80 00 18 */	bge lbl_803FE02C
...
/* 803FE034 003C75F4  40 80 00 14 */	bge lbl_803FE048
...
/* 803FE074 003C7634  41 82 00 3C */	beq lbl_803FE0B0
/* 803FE078 003C7638  2C 04 00 00 */	cmpwi r4, 0
/* 803FE07C 003C763C  40 80 00 18 */	bge lbl_803FE094
...
/* 803FE09C 003C765C  40 80 00 14 */	bge lbl_803FE0B0
