...
/* 803EE5C8 003B7B88  2C 07 00 00 */	cmpwi r7, 0x0
...
/* 803EE5D8 003B7B98  93 C1 00 08 */	stw r30, 0x8(r1)
...
.L_803EE5F4:
/* 803EE5F4 003B7BB4  2C 07 00 01 */	cmpwi r7, 0x1
...
.L_803EE618:
/* 803EE618 003B7BD8  2C 00 00 00 */	cmpwi r0, 0x0
/* 803EE61C 003B7BDC  41 82 00 14 */	beq .L_803EE630
/* 803EE620 003B7BE0  2C 1F 00 00 */	cmpwi r31, 0x0
...
/* 803EE638 003B7BF8  83 C1 00 08 */	lwz r30, 0x8(r1)
...
# nw4r::g3d::CalcTexMtx(nw4r::math::MTX34*, bool, const nw4r::g3d::TexSrt&, nw4r::g3d::TexSrt::Flag)
...
/* 803EE65C 003B7C1C  93 C1 00 08 */	stw r30, 0x8(r1)
...
/* 803EE66C 003B7C2C  54 00 D9 7F */	srwi. r0, r0, 5
/* 803EE670 003B7C30  41 82 00 14 */	beq .L_803EE684
/* 803EE674 003B7C34  2C 1F 00 00 */	cmpwi r31, 0x0
...
/* 803EE68C 003B7C4C  83 C1 00 08 */	lwz r30, 0x8(r1)
