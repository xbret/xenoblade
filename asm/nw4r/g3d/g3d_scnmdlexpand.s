...
/* 803FBFBC 003C557C  41 82 00 08 */	beq lbl_803FBFC4
/* 803FBFC0 003C5580  90 04 00 00 */	stw r0, 0(r4)
lbl_803FBFC4:
/* 803FBFC4 003C5584  2C 03 00 00 */	cmpwi r3, 0
/* 803FBFC8 003C5588  41 82 01 54 */	beq lbl_803FC11C
/* 803FBFCC 003C558C  7F 63 DB 78 */	mr r3, r27
/* 803FBFD0 003C5590  7C 04 03 78 */	mr r4, r0
/* 803FBFD4 003C5594  4B F4 DA BD */	bl func_80349A90
/* 803FBFD8 003C5598  2C 03 00 00 */	cmpwi r3, 0
/* 803FBFDC 003C559C  7C 7F 1B 78 */	mr r31, r3
/* 803FBFE0 003C55A0  40 82 00 0C */	bne lbl_803FBFEC
/* 803FBFE4 003C55A4  38 60 00 00 */	li r3, 0
/* 803FBFE8 003C55A8  48 00 01 38 */	b lbl_803FC120
lbl_803FBFEC:
/* 803FBFEC 003C55AC  41 82 01 30 */	beq lbl_803FC11C
...
/* 803FBFFC 003C55BC  4B FF 9A 11 */	bl func_803F5A0C
...
/* 803FC020 003C55E0  41 82 00 D8 */	beq lbl_803FC0F8
/* 803FC024 003C55E4  28 1D 00 08 */	cmplwi r29, 8
/* 803FC028 003C55E8  38 BD FF F8 */	addi r5, r29, -8
/* 803FC02C 003C55EC  40 81 00 A4 */	ble lbl_803FC0D0
...
/* 803FC044 003C5604  40 81 00 8C */	ble lbl_803FC0D0
lbl_803FC048:
...
/* 803FC0CC 003C568C  42 00 FF 7C */	bdnz lbl_803FC048
lbl_803FC0D0:
...
/* 803FC0E0 003C56A0  40 80 00 18 */	bge lbl_803FC0F8
lbl_803FC0E4:
...
/* 803FC0F4 003C56B4  42 00 FF F0 */	bdnz lbl_803FC0E4
lbl_803FC0F8:
...
/* 803FC174 003C5734  40 82 00 0C */	bne lbl_803FC180
/* 803FC178 003C5738  38 60 00 00 */	li r3, 0
/* 803FC17C 003C573C  48 00 00 84 */	b lbl_803FC200
lbl_803FC180:
...
/* 803FC198 003C5758  4B FD D5 BD */	bl func_803D9754
/* 803FC19C 003C575C  7C 1E 18 40 */	cmplw r30, r3
/* 803FC1A0 003C5760  40 80 00 24 */	bge lbl_803FC1C4
/* 803FC1A4 003C5764  80 1D 00 E4 */	lwz r0, 0xe4(r29)
/* 803FC1A8 003C5768  7C 1F 00 40 */	cmplw r31, r0
/* 803FC1AC 003C576C  40 80 00 18 */	bge lbl_803FC1C4
...
/* 803FC1F8 003C57B8  48 00 00 08 */	b lbl_803FC200
lbl_803FC1FC:
...
/* 803FC240 003C5800  4B FF 95 01 */	bl func_803F5740
/* 803FC244 003C5804  2C 03 00 00 */	cmpwi r3, 0
/* 803FC248 003C5808  41 82 01 08 */	beq lbl_803FC350
...
/* 803FC258 003C5818  40 85 00 EC */	ble cr1, lbl_803FC344
...
/* 803FC268 003C5828  40 81 00 B0 */	ble lbl_803FC318
/* 803FC26C 003C582C  41 84 00 AC */	blt cr1, lbl_803FC318
...
/* 803FC288 003C5848  40 81 00 90 */	ble lbl_803FC318
lbl_803FC28C:
...
/* 803FC314 003C58D4  42 00 FF 78 */	bdnz lbl_803FC28C
lbl_803FC318:
...
/* 803FC328 003C58E8  40 81 00 1C */	ble lbl_803FC344
lbl_803FC32C:
...
/* 803FC340 003C5900  42 00 FF EC */	bdnz lbl_803FC32C
lbl_803FC344:
...
/* 803FC388 003C5948  4B FF 95 45 */	bl func_803F58CC
/* 803FC38C 003C594C  2C 03 00 00 */	cmpwi r3, 0
/* 803FC390 003C5950  41 82 00 F8 */	beq lbl_803FC488
/* 803FC394 003C5954  80 9E 00 E4 */	lwz r4, 0xe4(r30)
/* 803FC398 003C5958  7C 9F 20 40 */	cmplw cr1, r31, r4
/* 803FC39C 003C595C  40 84 00 EC */	bge cr1, lbl_803FC488
...
/* 803FC3AC 003C596C  40 81 00 B0 */	ble lbl_803FC45C
/* 803FC3B0 003C5970  41 85 00 AC */	bgt cr1, lbl_803FC45C
...
/* 803FC3CC 003C598C  40 80 00 90 */	bge lbl_803FC45C
lbl_803FC3D0:
...
/* 803FC458 003C5A18  42 00 FF 78 */	bdnz lbl_803FC3D0
lbl_803FC45C:
...
/* 803FC46C 003C5A2C  40 80 00 1C */	bge lbl_803FC488
lbl_803FC470:
...
/* 803FC484 003C5A44  42 00 FF EC */	bdnz lbl_803FC470
lbl_803FC488:
...
/* 803FC550 003C5B10  40 80 00 24 */	bge lbl_803FC574
...
/* 803FC568 003C5B28  41 82 00 0C */	beq lbl_803FC574
/* 803FC56C 003C5B2C  38 A0 00 01 */	li r5, 1
/* 803FC570 003C5B30  48 00 00 08 */	b lbl_803FC578
lbl_803FC574:
/* 803FC574 003C5B34  38 A0 00 00 */	li r5, 0
lbl_803FC578:
/* 803FC578 003C5B38  2C 05 00 00 */	cmpwi r5, 0
/* 803FC57C 003C5B3C  40 82 02 78 */	bne lbl_803FC7F4
...
/* 803FC58C 003C5B4C  41 82 01 E0 */	beq lbl_803FC76C
/* 803FC590 003C5B50  40 80 00 10 */	bge lbl_803FC5A0
/* 803FC594 003C5B54  2C 04 00 01 */	cmpwi r4, 1
/* 803FC598 003C5B58  41 82 00 18 */	beq lbl_803FC5B0
/* 803FC59C 003C5B5C  48 00 02 1C */	b lbl_803FC7B8
lbl_803FC5A0:
/* 803FC5A0 003C5B60  38 A5 00 04 */	addi r5, r5, 4
/* 803FC5A4 003C5B64  7C 04 28 00 */	cmpw r4, r5
/* 803FC5A8 003C5B68  40 80 02 10 */	bge lbl_803FC7B8
/* 803FC5AC 003C5B6C  48 00 01 A8 */	b lbl_803FC754
lbl_803FC5B0:
/* 803FC5B0 003C5B70  80 A3 00 D4 */	lwz r5, 0xd4(r3)
/* 803FC5B4 003C5B74  2C 05 00 00 */	cmpwi r5, 0
/* 803FC5B8 003C5B78  41 82 00 40 */	beq lbl_803FC5F8
/* 803FC5BC 003C5B7C  A0 83 00 DA */	lhz r4, 0xda(r3)
/* 803FC5C0 003C5B80  54 84 07 FF */	clrlwi. r4, r4, 0x1f
/* 803FC5C4 003C5B84  41 82 00 34 */	beq lbl_803FC5F8
/* 803FC5C8 003C5B88  88 63 00 D8 */	lbz r3, 0xd8(r3)
/* 803FC5CC 003C5B8C  54 63 07 FF */	clrlwi. r3, r3, 0x1f
/* 803FC5D0 003C5B90  41 82 00 28 */	beq lbl_803FC5F8
...
/* 803FC660 003C5C20  41 82 00 20 */	beq lbl_803FC680
...
/* 803FC68C 003C5C4C  48 00 00 78 */	b lbl_803FC704
lbl_803FC690:
...
/* 803FC6A4 003C5C64  41 82 00 58 */	beq lbl_803FC6FC
...
/* 803FC6B8 003C5C78  41 82 00 20 */	beq lbl_803FC6D8
/* 803FC6BC 003C5C7C  38 81 00 10 */	addi r4, r1, 0x10
/* 803FC6C0 003C5C80  38 A0 00 01 */	li r5, 1
/* 803FC6C4 003C5C84  4B FF BE 8D */	bl func_803F8550
/* 803FC6C8 003C5C88  2C 03 00 00 */	cmpwi r3, 0
/* 803FC6CC 003C5C8C  40 82 00 10 */	bne lbl_803FC6DC
/* 803FC6D0 003C5C90  63 18 00 01 */	ori r24, r24, 1
/* 803FC6D4 003C5C94  48 00 00 08 */	b lbl_803FC6DC
lbl_803FC6D8:
...
/* 803FC708 003C5CC8  41 80 FF 88 */	blt lbl_803FC690
...
/* 803FC750 003C5D10  48 00 00 A4 */	b lbl_803FC7F4
lbl_803FC754:
...
/* 803FC764 003C5D24  4B FF 8B 81 */	bl func_803F52E4
/* 803FC768 003C5D28  48 00 00 8C */	b lbl_803FC7F4
lbl_803FC76C:
/* 803FC76C 003C5D2C  80 63 00 E8 */	lwz r3, 0xe8(r3)
/* 803FC770 003C5D30  7C 06 18 40 */	cmplw r6, r3
/* 803FC774 003C5D34  40 82 00 2C */	bne lbl_803FC7A0
...
/* 803FC79C 003C5D5C  48 00 00 58 */	b lbl_803FC7F4
lbl_803FC7A0:
...
/* 803FC7B0 003C5D70  4B FF 8B 35 */	bl func_803F52E4
/* 803FC7B4 003C5D74  48 00 00 40 */	b lbl_803FC7F4
lbl_803FC7B8:
/* 803FC7B8 003C5D78  80 63 00 E8 */	lwz r3, 0xe8(r3)
/* 803FC7BC 003C5D7C  2C 03 00 00 */	cmpwi r3, 0
/* 803FC7C0 003C5D80  41 82 00 20 */	beq lbl_803FC7E0
...
/* 803FC7F0 003C5DB0  4B FF 8A F5 */	bl func_803F52E4
lbl_803FC7F4:
...
/* 803FC824 003C5DE4  41 82 00 4C */	beq lbl_803FC870
...
/* 803FC83C 003C5DFC  41 82 00 28 */	beq lbl_803FC864
...
/* 803FC86C 003C5E2C  4B FF 92 11 */	bl func_803F5A7C
lbl_803FC870:
