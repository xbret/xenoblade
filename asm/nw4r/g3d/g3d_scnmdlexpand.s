...
.fn Construct__Q34nw4r3g3d12ScnMdlExpandFP12MEMAllocatorPUlUlPQ34nw4r3g3d12ScnMdlSimple, global
...
/* 803FBF94 003C5554  2C 04 00 00 */	cmpwi r4, 0x0
/* 803FBF98 003C5558  38 07 00 F3 */	addi r0, r7, 0xf3
/* 803FBF9C 003C555C  7C BD 2B 78 */	mr r29, r5
/* 803FBFA0 003C5560  54 1C 00 3A */	clrrwi r28, r0, 2
...
/* 803FBFB0 003C5570  38 05 00 03 */	addi r0, r5, 0x3
/* 803FBFB4 003C5574  3B E0 00 00 */	li r31, 0x0
/* 803FBFB8 003C5578  54 00 00 3A */	clrrwi r0, r0, 2
/* 803FBFBC 003C557C  41 82 00 08 */	beq .L_803FBFC4
/* 803FBFC0 003C5580  90 04 00 00 */	stw r0, 0x0(r4)
.L_803FBFC4:
/* 803FBFC4 003C5584  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 803FC004 003C55C4  2C 1D 00 00 */	cmpwi r29, 0x0
/* 803FC008 003C55C8  38 63 D0 C8 */	addi r3, r3, __vt__g3d_scnmdlexpand@l
/* 803FC00C 003C55CC  7C 1F E2 14 */	add r0, r31, r28
/* 803FC010 003C55D0  90 7F 00 00 */	stw r3, 0x0(r31)
/* 803FC014 003C55D4  38 60 00 00 */	li r3, 0x0
...
/* 803FC024 003C55E4  28 1D 00 08 */	cmplwi r29, 0x8
/* 803FC028 003C55E8  38 BD FF F8 */	addi r5, r29, -0x8
/* 803FC02C 003C55EC  40 81 00 A4 */	ble .L_803FC0D0
/* 803FC030 003C55F0  38 05 00 07 */	addi r0, r5, 0x7
/* 803FC034 003C55F4  38 80 00 00 */	li r4, 0x0
/* 803FC038 003C55F8  54 00 E8 FE */	srwi r0, r0, 3
/* 803FC03C 003C55FC  7C 09 03 A6 */	mtctr r0
/* 803FC040 003C5600  28 05 00 00 */	cmplwi r5, 0x0
/* 803FC044 003C5604  40 81 00 8C */	ble .L_803FC0D0
.L_803FC048:
/* 803FC048 003C5608  80 0D 9C 58 */	lwz r0, lbl_80665DD8@sda21(r13)
/* 803FC04C 003C560C  38 63 00 08 */	addi r3, r3, 0x8
...
/* 803FC064 003C5624  90 C5 00 04 */	stw r6, 0x4(r5)
...
/* 803FC074 003C5634  90 C5 00 08 */	stw r6, 0x8(r5)
...
/* 803FC0F0 003C56B0  38 84 00 04 */	addi r4, r4, 0x4
/* 803FC0F4 003C56B4  42 00 FF F0 */	bdnz .L_803FC0E4
.L_803FC0F8:
/* 803FC0F8 003C56B8  81 9E 00 00 */	lwz r12, 0x0(r30)
/* 803FC0FC 003C56BC  3C 80 00 01 */	lis r4, 0x1
...
/* 803FC10C 003C56CC  38 84 00 02 */	addi r4, r4, 0x2
/* 803FC110 003C56D0  38 A0 00 00 */	li r5, 0x0
...
.endfn Construct__Q34nw4r3g3d12ScnMdlExpandFP12MEMAllocatorPUlUlPQ34nw4r3g3d12ScnMdlSimple

# nw4r::g3d::ScnMdlExpand::PushBack(nw4r::g3d::ScnObj*, unsigned long)
.fn PushBack__Q34nw4r3g3d12ScnMdlExpandFPQ34nw4r3g3d6ScnObjUl, global
...
/* 803FC15C 003C571C  81 83 00 00 */	lwz r12, 0x0(r3)
...
/* 803FC260 003C5820  38 BE 00 08 */	addi r5, r30, 0x8
/* 803FC264 003C5824  28 00 00 08 */	cmplwi r0, 0x8
/* 803FC268 003C5828  40 81 00 B0 */	ble .L_803FC318
/* 803FC26C 003C582C  41 84 00 AC */	blt cr1, .L_803FC318
/* 803FC270 003C5830  38 04 00 07 */	addi r0, r4, 0x7
...
/* 803FC290 003C5850  38 84 FF F8 */	addi r4, r4, -0x8
/* 803FC294 003C5854  7C A0 32 14 */	add r5, r0, r6
/* 803FC298 003C5858  80 05 FF FC */	lwz r0, -0x4(r5)
/* 803FC29C 003C585C  90 05 00 00 */	stw r0, 0x0(r5)
/* 803FC2A0 003C5860  80 1D 00 EC */	lwz r0, 0xec(r29)
/* 803FC2A4 003C5864  7C A0 32 14 */	add r5, r0, r6
/* 803FC2A8 003C5868  80 05 FF F8 */	lwz r0, -0x8(r5)
/* 803FC2AC 003C586C  90 05 FF FC */	stw r0, -0x4(r5)
...
/* 803FC2BC 003C587C  90 05 FF F8 */	stw r0, -0x8(r5)
...
/* 803FC308 003C58C8  38 C6 FF E0 */	addi r6, r6, -0x20
...
/* 803FC334 003C58F4  38 A5 FF FC */	addi r5, r5, -0x4
/* 803FC338 003C58F8  80 04 FF FC */	lwz r0, -0x4(r4)
/* 803FC33C 003C58FC  90 04 00 00 */	stw r0, 0x0(r4)
...
/* 803FC3A4 003C5964  38 A4 FF F8 */	addi r5, r4, -0x8
/* 803FC3A8 003C5968  28 00 00 08 */	cmplwi r0, 0x8
/* 803FC3AC 003C596C  40 81 00 B0 */	ble .L_803FC45C
/* 803FC3B0 003C5970  41 85 00 AC */	bgt cr1, .L_803FC45C
/* 803FC3B4 003C5974  38 05 00 07 */	addi r0, r5, 0x7
...
/* 803FC3D4 003C5994  3B FF 00 08 */	addi r31, r31, 0x8
/* 803FC3D8 003C5998  7C A0 32 14 */	add r5, r0, r6
/* 803FC3DC 003C599C  80 05 00 04 */	lwz r0, 0x4(r5)
/* 803FC3E0 003C59A0  90 05 00 00 */	stw r0, 0x0(r5)
/* 803FC3E4 003C59A4  80 1E 00 EC */	lwz r0, 0xec(r30)
/* 803FC3E8 003C59A8  7C A0 32 14 */	add r5, r0, r6
/* 803FC3EC 003C59AC  80 05 00 08 */	lwz r0, 0x8(r5)
/* 803FC3F0 003C59B0  90 05 00 04 */	stw r0, 0x4(r5)
...
/* 803FC400 003C59C0  90 05 00 08 */	stw r0, 0x8(r5)
...
/* 803FC478 003C5A38  38 A5 00 04 */	addi r5, r5, 0x4
/* 803FC47C 003C5A3C  80 04 00 04 */	lwz r0, 0x4(r4)
/* 803FC480 003C5A40  90 04 00 00 */	stw r0, 0x0(r4)
...
/* 803FC490 003C5A50  83 C1 00 08 */	lwz r30, 0x8(r1)
/* 803FC494 003C5A54  7C 08 03 A6 */	mtlr r0
/* 803FC498 003C5A58  38 21 00 10 */	addi r1, r1, 0x10
/* 803FC49C 003C5A5C  4E 80 00 20 */	blr
.endfn Remove__Q34nw4r3g3d12ScnMdlExpandFUl

# nw4r::g3d::ScnMdlExpand::Remove(nw4r::g3d::ScnObj*)
.fn Remove__Q34nw4r3g3d12ScnMdlExpandFPQ34nw4r3g3d6ScnObj, global
...
.L_803FC4C4:
/* 803FC4C4 003C5A84  38 A5 00 04 */	addi r5, r5, 0x4
.L_803FC4C8:
/* 803FC4C8 003C5A88  7C 05 38 40 */	cmplw r5, r7
/* 803FC4CC 003C5A8C  41 82 00 10 */	beq .L_803FC4DC
/* 803FC4D0 003C5A90  80 05 00 00 */	lwz r0, 0x0(r5)
...
/* 803FC4E4 003C5AA4  38 60 00 00 */	li r3, 0x0
/* 803FC4E8 003C5AA8  48 00 00 2C */	b .L_803FC514
.L_803FC4EC:
/* 803FC4EC 003C5AAC  81 83 00 00 */	lwz r12, 0x0(r3)
...
/* 803FC510 003C5AD0  54 03 0F FE */	srwi r3, r0, 31
.L_803FC514:
...
.endfn Remove__Q34nw4r3g3d12ScnMdlExpandFPQ34nw4r3g3d6ScnObj

# nw4r::g3d::ScnMdlExpand::G3dProc(unsigned long, unsigned long, void*)
.fn G3dProc__Q34nw4r3g3d12ScnMdlExpandFUlUlPv, global
...
/* 803FC538 003C5AF8  28 04 00 09 */	cmplwi r4, 0x9
/* 803FC53C 003C5AFC  90 A1 00 08 */	stw r5, 0x8(r1)
...
/* 803FC554 003C5B14  38 E4 FF FF */	addi r7, r4, -0x1
/* 803FC558 003C5B18  39 00 00 01 */	li r8, 0x1
...
/* 803FC56C 003C5B2C  38 A0 00 01 */	li r5, 0x1
/* 803FC570 003C5B30  48 00 00 08 */	b .L_803FC578
.L_803FC574:
/* 803FC574 003C5B34  38 A0 00 00 */	li r5, 0x0
.L_803FC578:
/* 803FC578 003C5B38  2C 05 00 00 */	cmpwi r5, 0x0
/* 803FC57C 003C5B3C  40 82 02 78 */	bne .L_803FC7F4
/* 803FC580 003C5B40  3C A0 00 01 */	lis r5, 0x1
/* 803FC584 003C5B44  38 E5 00 01 */	addi r7, r5, 0x1
...
/* 803FC594 003C5B54  2C 04 00 01 */	cmpwi r4, 0x1
/* 803FC598 003C5B58  41 82 00 18 */	beq .L_803FC5B0
/* 803FC59C 003C5B5C  48 00 02 1C */	b .L_803FC7B8
.L_803FC5A0:
/* 803FC5A0 003C5B60  38 A5 00 04 */	addi r5, r5, 0x4
...
/* 803FC65C 003C5C1C  2C 03 00 00 */	cmpwi r3, 0x0
/* 803FC660 003C5C20  41 82 00 20 */	beq .L_803FC680
/* 803FC664 003C5C24  81 83 00 00 */	lwz r12, 0x0(r3)
/* 803FC668 003C5C28  7F C4 F3 78 */	mr r4, r30
/* 803FC66C 003C5C2C  38 DD 00 3C */	addi r6, r29, 0x3c
/* 803FC670 003C5C30  80 A1 00 08 */	lwz r5, 0x8(r1)
...
/* 803FC684 003C5C44  3B 20 00 00 */	li r25, 0x0
/* 803FC688 003C5C48  3B 60 00 00 */	li r27, 0x0
...
/* 803FC69C 003C5C5C  83 01 00 08 */	lwz r24, 0x8(r1)
...
/* 803FC6B0 003C5C70  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 803FC6C0 003C5C80  38 A0 00 01 */	li r5, 0x1
...
/* 803FC6C8 003C5C88  2C 03 00 00 */	cmpwi r3, 0x0
/* 803FC6CC 003C5C8C  40 82 00 10 */	bne .L_803FC6DC
/* 803FC6D0 003C5C90  63 18 00 01 */	ori r24, r24, 0x1
/* 803FC6D4 003C5C94  48 00 00 08 */	b .L_803FC6DC
.L_803FC6D8:
/* 803FC6D8 003C5C98  63 18 00 01 */	ori r24, r24, 0x1
.L_803FC6DC:
/* 803FC6DC 003C5C9C  81 9C 00 00 */	lwz r12, 0x0(r28)
...
.L_803FC6FC:
/* 803FC6FC 003C5CBC  3B 7B 00 04 */	addi r27, r27, 0x4
/* 803FC700 003C5CC0  3B 39 00 01 */	addi r25, r25, 0x1
.L_803FC704:
...
/* 803FC778 003C5D38  81 83 00 00 */	lwz r12, 0x0(r3)
/* 803FC77C 003C5D3C  38 85 00 03 */	addi r4, r5, 0x3
/* 803FC780 003C5D40  7F A6 EB 78 */	mr r6, r29
/* 803FC784 003C5D44  38 A0 00 00 */	li r5, 0x0
/* 803FC788 003C5D48  81 8C 00 0C */	lwz r12, 0xc(r12)
/* 803FC78C 003C5D4C  7D 89 03 A6 */	mtctr r12
/* 803FC790 003C5D50  4E 80 04 21 */	bctrl
/* 803FC794 003C5D54  38 00 00 00 */	li r0, 0x0
...
/* 803FC7BC 003C5D7C  2C 03 00 00 */	cmpwi r3, 0x0
/* 803FC7C0 003C5D80  41 82 00 20 */	beq .L_803FC7E0
/* 803FC7C4 003C5D84  81 83 00 00 */	lwz r12, 0x0(r3)
...
.L_803FC7E0:
/* 803FC7E0 003C5DA0  80 A1 00 08 */	lwz r5, 0x8(r1)
...
.endfn G3dProc__Q34nw4r3g3d12ScnMdlExpandFUlUlPv

# nw4r::g3d::ScnMdlExpand::~ScnMdlExpand()
.fn __dt__Q34nw4r3g3d12ScnMdlExpandFv, global
/* 803FC80C 003C5DCC  94 21 FF F0 */	stwu r1, -0x10(r1)
/* 803FC810 003C5DD0  7C 08 02 A6 */	mflr r0
/* 803FC814 003C5DD4  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 803FC834 003C5DF4  2C 00 00 00 */	cmpwi r0, 0x0
/* 803FC838 003C5DF8  90 83 00 00 */	stw r4, 0x0(r3)
/* 803FC83C 003C5DFC  41 82 00 28 */	beq .L_803FC864
/* 803FC840 003C5E00  7C 03 03 78 */	mr r3, r0
/* 803FC844 003C5E04  3C 80 00 01 */	lis r4, 0x1
/* 803FC848 003C5E08  81 83 00 00 */	lwz r12, 0x0(r3)
/* 803FC84C 003C5E0C  7F E6 FB 78 */	mr r6, r31
/* 803FC850 003C5E10  38 84 00 03 */	addi r4, r4, 0x3
/* 803FC854 003C5E14  38 A0 00 00 */	li r5, 0x0
...
/* 803FC868 003C5E28  38 80 00 00 */	li r4, 0x0
...
# nw4r::g3d::ScnMdlExpand::IsDerivedFrom(nw4r::g3d::G3dObj::TypeObj) const
...
/* 803FC88C 003C5E4C  80 04 00 00 */	lwz r0, 0x0(r4)
...
/* 803FC8B8 003C5E78  38 60 00 01 */	li r3, 0x1
...
/* 803FC8D0 003C5E90  38 60 00 01 */	li r3, 0x1
...
.endfn IsDerivedFrom__Q34nw4r3g3d12ScnMdlExpandCFQ44nw4r3g3d6G3dObj7TypeObj

# nw4r::g3d::ScnMdlExpand::GetTypeName() const
.fn GetTypeName__Q34nw4r3g3d12ScnMdlExpandCFv, global
...
/* 803FC8FC 003C5EBC  81 83 00 00 */	lwz r12, 0x0(r3)
...
/* 803FC910 003C5ED0  38 63 00 04 */	addi r3, r3, 0x4
/* 803FC914 003C5ED4  7C 08 03 A6 */	mtlr r0
/* 803FC918 003C5ED8  38 21 00 10 */	addi r1, r1, 0x10
/* 803FC91C 003C5EDC  4E 80 00 20 */	blr
.endfn GetTypeName__Q34nw4r3g3d12ScnMdlExpandCFv

# nw4r::g3d::ScnMdlExpand::GetTypeObj() const
