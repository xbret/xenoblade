...
/* 803FCEF8 003C64B8  41 82 00 10 */	beq lbl_803FCF08
...
/* 803FCF0C 003C64CC  41 82 00 10 */	beq lbl_803FCF1C
...
/* 803FCF54 003C6514  40 80 00 24 */	bge lbl_803FCF78
...
/* 803FCF6C 003C652C  41 82 00 0C */	beq lbl_803FCF78
/* 803FCF70 003C6530  38 00 00 01 */	li r0, 1
/* 803FCF74 003C6534  48 00 00 08 */	b lbl_803FCF7C
lbl_803FCF78:
/* 803FCF78 003C6538  38 00 00 00 */	li r0, 0
lbl_803FCF7C:
/* 803FCF7C 003C653C  2C 00 00 00 */	cmpwi r0, 0
/* 803FCF80 003C6540  40 82 00 B0 */	bne lbl_803FD030
/* 803FCF84 003C6544  2C 04 00 06 */	cmpwi r4, 6
/* 803FCF88 003C6548  41 82 00 48 */	beq lbl_803FCFD0
/* 803FCF8C 003C654C  40 80 00 10 */	bge lbl_803FCF9C
/* 803FCF90 003C6550  2C 04 00 05 */	cmpwi r4, 5
/* 803FCF94 003C6554  40 80 00 14 */	bge lbl_803FCFA8
/* 803FCF98 003C6558  48 00 00 90 */	b lbl_803FD028
lbl_803FCF9C:
/* 803FCF9C 003C655C  2C 04 00 08 */	cmpwi r4, 8
/* 803FCFA0 003C6560  40 80 00 88 */	bge lbl_803FD028
/* 803FCFA4 003C6564  48 00 00 58 */	b lbl_803FCFFC
lbl_803FCFA8:
...
/* 803FCFCC 003C658C  48 00 00 64 */	b lbl_803FD030
lbl_803FCFD0:
/* 803FCFD0 003C6590  80 03 00 EC */	lwz r0, 0xec(r3)
/* 803FCFD4 003C6594  2C 00 00 00 */	cmpwi r0, 0
/* 803FCFD8 003C6598  41 82 00 58 */	beq lbl_803FD030
/* 803FCFDC 003C659C  38 60 07 FF */	li r3, 0x7ff
/* 803FCFE0 003C65A0  4B FE DF 09 */	bl func_803EAEE8
...
/* 803FCFF8 003C65B8  48 00 00 38 */	b lbl_803FD030
lbl_803FCFFC:
/* 803FCFFC 003C65BC  80 03 00 EC */	lwz r0, 0xec(r3)
/* 803FD000 003C65C0  2C 00 00 00 */	cmpwi r0, 0
/* 803FD004 003C65C4  41 82 00 2C */	beq lbl_803FD030
/* 803FD008 003C65C8  38 60 07 FF */	li r3, 0x7ff
/* 803FD00C 003C65CC  4B FE DE DD */	bl func_803EAEE8
...
/* 803FD024 003C65E4  48 00 00 0C */	b lbl_803FD030
lbl_803FD028:
/* 803FD028 003C65E8  7F E3 FB 78 */	mr r3, r31
/* 803FD02C 003C65EC  4B FF 7C 5D */	bl func_803F4C88
lbl_803FD030:
...
/* 803FD100 003C66C0  41 82 00 10 */	beq lbl_803FD110
/* 803FD104 003C66C4  41 82 00 0C */	beq lbl_803FD110
/* 803FD108 003C66C8  38 80 00 00 */	li r4, 0
/* 803FD10C 003C66CC  4B FF 74 A9 */	bl func_803F45B4
lbl_803FD110:
