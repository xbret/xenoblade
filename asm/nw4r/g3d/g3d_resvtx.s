...
/* 803DD1D8 003A6798  41 82 00 0C */	beq lbl_803DD1E4
/* 803DD1DC 003A679C  7C 85 02 14 */	add r4, r5, r0
/* 803DD1E0 003A67A0  48 00 00 08 */	b lbl_803DD1E8
lbl_803DD1E4:
/* 803DD1E4 003A67A4  38 80 00 00 */	li r4, 0
lbl_803DD1E8:
/* 803DD1E8 003A67A8  88 A5 00 1D */	lbz r5, 0x1d(r5)
/* 803DD1EC 003A67AC  4B F3 C8 C4 */	b func_80319AB0
...
/* 803DD208 003A67C8  41 82 00 0C */	beq lbl_803DD214
/* 803DD20C 003A67CC  7C 06 02 14 */	add r0, r6, r0
/* 803DD210 003A67D0  48 00 00 08 */	b lbl_803DD218
lbl_803DD214:
...
/* 803DD254 003A6814  41 82 00 24 */	beq lbl_803DD278
...
/* 803DD274 003A6834  4B F7 6D 6D */	bl func_80353FE0
lbl_803DD278:
...
/* 803DD2A8 003A6868  41 82 00 0C */	beq lbl_803DD2B4
/* 803DD2AC 003A686C  7C 85 02 14 */	add r4, r5, r0
/* 803DD2B0 003A6870  48 00 00 08 */	b lbl_803DD2B8
lbl_803DD2B4:
/* 803DD2B4 003A6874  38 80 00 00 */	li r4, 0
lbl_803DD2B8:
/* 803DD2B8 003A6878  88 A5 00 1D */	lbz r5, 0x1d(r5)
/* 803DD2BC 003A687C  4B F3 C7 F4 */	b func_80319AB0
...
/* 803DD2D8 003A6898  41 82 00 0C */	beq lbl_803DD2E4
/* 803DD2DC 003A689C  7C 06 02 14 */	add r0, r6, r0
/* 803DD2E0 003A68A0  48 00 00 08 */	b lbl_803DD2E8
lbl_803DD2E4:
...
/* 803DD324 003A68E4  41 82 00 24 */	beq lbl_803DD348
...
/* 803DD344 003A6904  4B F7 6C 9D */	bl func_80353FE0
lbl_803DD348:
...
/* 803DD384 003A6944  41 82 00 0C */	beq lbl_803DD390
/* 803DD388 003A6948  7C 85 02 14 */	add r4, r5, r0
/* 803DD38C 003A694C  48 00 00 08 */	b lbl_803DD394
lbl_803DD390:
/* 803DD390 003A6950  38 80 00 00 */	li r4, 0
lbl_803DD394:
/* 803DD394 003A6954  88 A5 00 1C */	lbz r5, 0x1c(r5)
/* 803DD398 003A6958  4B F3 C7 18 */	b func_80319AB0
...
/* 803DD3B4 003A6974  41 82 00 0C */	beq lbl_803DD3C0
/* 803DD3B8 003A6978  7C 06 02 14 */	add r0, r6, r0
/* 803DD3BC 003A697C  48 00 00 08 */	b lbl_803DD3C4
lbl_803DD3C0:
...
/* 803DD400 003A69C0  41 82 00 24 */	beq lbl_803DD424
...
/* 803DD420 003A69E0  4B F7 6B C1 */	bl func_80353FE0
lbl_803DD424:
...
/* 803DD450 003A6A10  41 82 00 0C */	beq lbl_803DD45C
/* 803DD454 003A6A14  7C 06 02 14 */	add r0, r6, r0
/* 803DD458 003A6A18  48 00 00 08 */	b lbl_803DD460
lbl_803DD45C:
...
/* 803DD4DC 003A6A9C  48 00 00 08 */	b lbl_803DD4E4
lbl_803DD4E0:
/* 803DD4E0 003A6AA0  38 80 00 00 */	li r4, 0
lbl_803DD4E4:
/* 803DD4E4 003A6AA4  88 A6 00 1D */	lbz r5, 0x1d(r6)
/* 803DD4E8 003A6AA8  4B F3 C5 C8 */	b func_80319AB0
...
/* 803DD4FC 003A6ABC  41 82 00 08 */	beq lbl_803DD504
/* 803DD500 003A6AC0  4B F7 6A E0 */	b func_80353FE0
lbl_803DD504:
/* 803DD504 003A6AC4  4B F7 6B 3C */	b func_80354040
...
/* 803DD514 003A6AD4  41 82 00 08 */	beq lbl_803DD51C
/* 803DD518 003A6AD8  4B F7 6A C8 */	b func_80353FE0
lbl_803DD51C:
/* 803DD51C 003A6ADC  4B F7 6B 24 */	b func_80354040
...
/* 803DD52C 003A6AEC  41 82 00 08 */	beq lbl_803DD534
/* 803DD530 003A6AF0  4B F7 6A B0 */	b func_80353FE0
lbl_803DD534:
/* 803DD534 003A6AF4  4B F7 6B 0C */	b func_80354040
...
/* 803DD544 003A6B04  41 82 00 08 */	beq lbl_803DD54C
/* 803DD548 003A6B08  4B F7 6A 98 */	b func_80353FE0
lbl_803DD54C:
/* 803DD54C 003A6B0C  4B F7 6A F4 */	b func_80354040
...
/* 803DD55C 003A6B1C  41 82 00 08 */	beq lbl_803DD564
/* 803DD560 003A6B20  4B F7 6A 80 */	b func_80353FE0
lbl_803DD564:
/* 803DD564 003A6B24  4B F7 6A DC */	b func_80354040
...
/* 803DD574 003A6B34  41 82 00 08 */	beq lbl_803DD57C
/* 803DD578 003A6B38  4B F7 6A 68 */	b func_80353FE0
lbl_803DD57C:
/* 803DD57C 003A6B3C  4B F7 6A C4 */	b func_80354040