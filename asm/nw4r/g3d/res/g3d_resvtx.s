.include "macros.inc"
.file "nw4r/g3d/res/g3d_resvtx.o"

# 0x803DD1C0 - 0x803DD580
.text
.balign 4

# nw4r::g3d::ResVtxPos::SetArray()
.fn SetArray__Q34nw4r3g3d9ResVtxPosFv, global
/* 803DD1C0 003A6780  80 A3 00 00 */	lwz r5, 0x0(r3)
/* 803DD1C4 003A6784  2C 05 00 00 */	cmpwi r5, 0x0
/* 803DD1C8 003A6788  4D 82 00 20 */	beqlr
/* 803DD1CC 003A678C  80 05 00 08 */	lwz r0, 0x8(r5)
/* 803DD1D0 003A6790  38 60 00 09 */	li r3, 0x9
/* 803DD1D4 003A6794  2C 00 00 00 */	cmpwi r0, 0x0
...
.L_803DD1E4:
/* 803DD1E4 003A67A4  38 80 00 00 */	li r4, 0x0
.L_803DD1E8:
...
# nw4r::g3d::ResVtxPos::GetArray(const void**, unsigned char*) const
.fn GetArray__Q34nw4r3g3d9ResVtxPosCFPPCvPUc, global
/* 803DD1F4 003A67B4  2C 04 00 00 */	cmpwi r4, 0x0
/* 803DD1F8 003A67B8  41 82 00 24 */	beq .L_803DD21C
/* 803DD1FC 003A67BC  80 C3 00 00 */	lwz r6, 0x0(r3)
/* 803DD200 003A67C0  80 06 00 08 */	lwz r0, 0x8(r6)
/* 803DD204 003A67C4  2C 00 00 00 */	cmpwi r0, 0x0
...
.L_803DD214:
/* 803DD214 003A67D4  38 00 00 00 */	li r0, 0x0
.L_803DD218:
/* 803DD218 003A67D8  90 04 00 00 */	stw r0, 0x0(r4)
.L_803DD21C:
/* 803DD21C 003A67DC  2C 05 00 00 */	cmpwi r5, 0x0
/* 803DD220 003A67E0  4D 82 00 20 */	beqlr
/* 803DD224 003A67E4  80 63 00 00 */	lwz r3, 0x0(r3)
/* 803DD228 003A67E8  88 03 00 1D */	lbz r0, 0x1d(r3)
/* 803DD22C 003A67EC  98 05 00 00 */	stb r0, 0x0(r5)
/* 803DD230 003A67F0  4E 80 00 20 */	blr
.endfn GetArray__Q34nw4r3g3d9ResVtxPosCFPPCvPUc

# nw4r::g3d::ResVtxPos::CopyTo(void*) const
...
/* 803DD23C 003A67FC  80 A3 00 00 */	lwz r5, 0x0(r3)
/* 803DD240 003A6800  90 01 00 14 */	stw r0, 0x14(r1)
/* 803DD244 003A6804  2C 05 00 00 */	cmpwi r5, 0x0
/* 803DD248 003A6808  93 E1 00 0C */	stw r31, 0xc(r1)
/* 803DD24C 003A680C  93 C1 00 08 */	stw r30, 0x8(r1)
/* 803DD250 003A6810  7C 9E 23 78 */	mr r30, r4
/* 803DD254 003A6814  41 82 00 24 */	beq .L_803DD278
/* 803DD258 003A6818  83 E5 00 00 */	lwz r31, 0x0(r5)
...
/* 803DD280 003A6840  83 C1 00 08 */	lwz r30, 0x8(r1)
...
# nw4r::g3d::ResVtxNrm::SetArray()
.fn SetArray__Q34nw4r3g3d9ResVtxNrmFv, global
/* 803DD290 003A6850  80 A3 00 00 */	lwz r5, 0x0(r3)
/* 803DD294 003A6854  2C 05 00 00 */	cmpwi r5, 0x0
/* 803DD298 003A6858  4D 82 00 20 */	beqlr
/* 803DD29C 003A685C  80 05 00 08 */	lwz r0, 0x8(r5)
/* 803DD2A0 003A6860  38 60 00 0A */	li r3, 0xa
/* 803DD2A4 003A6864  2C 00 00 00 */	cmpwi r0, 0x0
...
.L_803DD2B4:
/* 803DD2B4 003A6874  38 80 00 00 */	li r4, 0x0
.L_803DD2B8:
...
# nw4r::g3d::ResVtxNrm::GetArray(const void**, unsigned char*) const
.fn GetArray__Q34nw4r3g3d9ResVtxNrmCFPPCvPUc, global
/* 803DD2C4 003A6884  2C 04 00 00 */	cmpwi r4, 0x0
/* 803DD2C8 003A6888  41 82 00 24 */	beq .L_803DD2EC
/* 803DD2CC 003A688C  80 C3 00 00 */	lwz r6, 0x0(r3)
/* 803DD2D0 003A6890  80 06 00 08 */	lwz r0, 0x8(r6)
/* 803DD2D4 003A6894  2C 00 00 00 */	cmpwi r0, 0x0
...
.L_803DD2E4:
/* 803DD2E4 003A68A4  38 00 00 00 */	li r0, 0x0
.L_803DD2E8:
/* 803DD2E8 003A68A8  90 04 00 00 */	stw r0, 0x0(r4)
.L_803DD2EC:
/* 803DD2EC 003A68AC  2C 05 00 00 */	cmpwi r5, 0x0
/* 803DD2F0 003A68B0  4D 82 00 20 */	beqlr
/* 803DD2F4 003A68B4  80 63 00 00 */	lwz r3, 0x0(r3)
/* 803DD2F8 003A68B8  88 03 00 1D */	lbz r0, 0x1d(r3)
/* 803DD2FC 003A68BC  98 05 00 00 */	stb r0, 0x0(r5)
/* 803DD300 003A68C0  4E 80 00 20 */	blr
.endfn GetArray__Q34nw4r3g3d9ResVtxNrmCFPPCvPUc

# nw4r::g3d::ResVtxNrm::CopyTo(void*) const
...
/* 803DD30C 003A68CC  80 A3 00 00 */	lwz r5, 0x0(r3)
/* 803DD310 003A68D0  90 01 00 14 */	stw r0, 0x14(r1)
/* 803DD314 003A68D4  2C 05 00 00 */	cmpwi r5, 0x0
/* 803DD318 003A68D8  93 E1 00 0C */	stw r31, 0xc(r1)
/* 803DD31C 003A68DC  93 C1 00 08 */	stw r30, 0x8(r1)
/* 803DD320 003A68E0  7C 9E 23 78 */	mr r30, r4
/* 803DD324 003A68E4  41 82 00 24 */	beq .L_803DD348
/* 803DD328 003A68E8  83 E5 00 00 */	lwz r31, 0x0(r5)
...
/* 803DD350 003A6910  83 C1 00 08 */	lwz r30, 0x8(r1)
...
# nw4r::g3d::ResVtxClr::SetArray(_GXAttr)
.fn SetArray__Q34nw4r3g3d9ResVtxClrF7_GXAttr, global
/* 803DD360 003A6920  80 A3 00 00 */	lwz r5, 0x0(r3)
/* 803DD364 003A6924  2C 05 00 00 */	cmpwi r5, 0x0
/* 803DD368 003A6928  4D 82 00 20 */	beqlr
/* 803DD36C 003A692C  38 04 FF F5 */	addi r0, r4, -0xb
/* 803DD370 003A6930  28 00 00 01 */	cmplwi r0, 0x1
/* 803DD374 003A6934  4D 81 00 20 */	bgtlr
/* 803DD378 003A6938  80 05 00 08 */	lwz r0, 0x8(r5)
/* 803DD37C 003A693C  7C 83 23 78 */	mr r3, r4
/* 803DD380 003A6940  2C 00 00 00 */	cmpwi r0, 0x0
...
.L_803DD390:
/* 803DD390 003A6950  38 80 00 00 */	li r4, 0x0
.L_803DD394:
...
# nw4r::g3d::ResVtxClr::GetArray(const void**, unsigned char*) const
.fn GetArray__Q34nw4r3g3d9ResVtxClrCFPPCvPUc, global
/* 803DD3A0 003A6960  2C 04 00 00 */	cmpwi r4, 0x0
/* 803DD3A4 003A6964  41 82 00 24 */	beq .L_803DD3C8
/* 803DD3A8 003A6968  80 C3 00 00 */	lwz r6, 0x0(r3)
/* 803DD3AC 003A696C  80 06 00 08 */	lwz r0, 0x8(r6)
/* 803DD3B0 003A6970  2C 00 00 00 */	cmpwi r0, 0x0
...
.L_803DD3C0:
/* 803DD3C0 003A6980  38 00 00 00 */	li r0, 0x0
.L_803DD3C4:
/* 803DD3C4 003A6984  90 04 00 00 */	stw r0, 0x0(r4)
.L_803DD3C8:
/* 803DD3C8 003A6988  2C 05 00 00 */	cmpwi r5, 0x0
/* 803DD3CC 003A698C  4D 82 00 20 */	beqlr
/* 803DD3D0 003A6990  80 63 00 00 */	lwz r3, 0x0(r3)
/* 803DD3D4 003A6994  88 03 00 1C */	lbz r0, 0x1c(r3)
/* 803DD3D8 003A6998  98 05 00 00 */	stb r0, 0x0(r5)
/* 803DD3DC 003A699C  4E 80 00 20 */	blr
.endfn GetArray__Q34nw4r3g3d9ResVtxClrCFPPCvPUc

# nw4r::g3d::ResVtxClr::CopyTo(void*) const
...
/* 803DD3E8 003A69A8  80 A3 00 00 */	lwz r5, 0x0(r3)
/* 803DD3EC 003A69AC  90 01 00 14 */	stw r0, 0x14(r1)
/* 803DD3F0 003A69B0  2C 05 00 00 */	cmpwi r5, 0x0
/* 803DD3F4 003A69B4  93 E1 00 0C */	stw r31, 0xc(r1)
/* 803DD3F8 003A69B8  93 C1 00 08 */	stw r30, 0x8(r1)
/* 803DD3FC 003A69BC  7C 9E 23 78 */	mr r30, r4
/* 803DD400 003A69C0  41 82 00 24 */	beq .L_803DD424
/* 803DD404 003A69C4  83 E5 00 00 */	lwz r31, 0x0(r5)
...
/* 803DD42C 003A69EC  83 C1 00 08 */	lwz r30, 0x8(r1)
...
# nw4r::g3d::ResVtxTexCoord::GetArray(const void**, unsigned char*) const
.fn GetArray__Q34nw4r3g3d14ResVtxTexCoordCFPPCvPUc, global
/* 803DD43C 003A69FC  2C 04 00 00 */	cmpwi r4, 0x0
/* 803DD440 003A6A00  41 82 00 24 */	beq .L_803DD464
/* 803DD444 003A6A04  80 C3 00 00 */	lwz r6, 0x0(r3)
/* 803DD448 003A6A08  80 06 00 08 */	lwz r0, 0x8(r6)
/* 803DD44C 003A6A0C  2C 00 00 00 */	cmpwi r0, 0x0
...
.L_803DD45C:
/* 803DD45C 003A6A1C  38 00 00 00 */	li r0, 0x0
.L_803DD460:
/* 803DD460 003A6A20  90 04 00 00 */	stw r0, 0x0(r4)
.L_803DD464:
/* 803DD464 003A6A24  2C 05 00 00 */	cmpwi r5, 0x0
/* 803DD468 003A6A28  4D 82 00 20 */	beqlr
/* 803DD46C 003A6A2C  80 63 00 00 */	lwz r3, 0x0(r3)
/* 803DD470 003A6A30  88 03 00 1D */	lbz r0, 0x1d(r3)
/* 803DD474 003A6A34  98 05 00 00 */	stb r0, 0x0(r5)
/* 803DD478 003A6A38  4E 80 00 20 */	blr
.endfn GetArray__Q34nw4r3g3d14ResVtxTexCoordCFPPCvPUc

# nw4r::g3d::ResVtxFurPos::SetArray(unsigned short)
.fn SetArray__Q34nw4r3g3d12ResVtxFurPosFUs, global
/* 803DD47C 003A6A3C  80 C3 00 00 */	lwz r6, 0x0(r3)
/* 803DD480 003A6A40  2C 06 00 00 */	cmpwi r6, 0x0
/* 803DD484 003A6A44  4D 82 00 20 */	beqlr
/* 803DD488 003A6A48  80 E6 00 08 */	lwz r7, 0x8(r6)
/* 803DD48C 003A6A4C  38 60 00 00 */	li r3, 0x0
/* 803DD490 003A6A50  38 A0 00 00 */	li r5, 0x0
/* 803DD494 003A6A54  2C 07 00 00 */	cmpwi r7, 0x0
...
/* 803DD4A8 003A6A68  38 A0 00 01 */	li r5, 0x1
.L_803DD4AC:
/* 803DD4AC 003A6A6C  2C 05 00 00 */	cmpwi r5, 0x0
/* 803DD4B0 003A6A70  41 82 00 10 */	beq .L_803DD4C0
/* 803DD4B4 003A6A74  2C 04 00 00 */	cmpwi r4, 0x0
/* 803DD4B8 003A6A78  41 80 00 08 */	blt .L_803DD4C0
/* 803DD4BC 003A6A7C  38 60 00 01 */	li r3, 0x1
.L_803DD4C0:
/* 803DD4C0 003A6A80  2C 03 00 00 */	cmpwi r3, 0x0
/* 803DD4C4 003A6A84  38 60 00 09 */	li r3, 0x9
...
.L_803DD4E0:
/* 803DD4E0 003A6AA0  38 80 00 00 */	li r4, 0x0
.L_803DD4E4:
...
# nw4r::g3d::ResVtxPos::DCStore(bool)
.fn DCStore__Q34nw4r3g3d9ResVtxPosFb, global
/* 803DD4F0 003A6AB0  80 63 00 00 */	lwz r3, 0x0(r3)
/* 803DD4F4 003A6AB4  2C 04 00 00 */	cmpwi r4, 0x0
/* 803DD4F8 003A6AB8  80 83 00 00 */	lwz r4, 0x0(r3)
...
# nw4r::g3d::ResVtxNrm::DCStore(bool)
.fn DCStore__Q34nw4r3g3d9ResVtxNrmFb, global
/* 803DD508 003A6AC8  80 63 00 00 */	lwz r3, 0x0(r3)
/* 803DD50C 003A6ACC  2C 04 00 00 */	cmpwi r4, 0x0
/* 803DD510 003A6AD0  80 83 00 00 */	lwz r4, 0x0(r3)
...
# nw4r::g3d::ResVtxClr::DCStore(bool)
.fn DCStore__Q34nw4r3g3d9ResVtxClrFb, global
/* 803DD520 003A6AE0  80 63 00 00 */	lwz r3, 0x0(r3)
/* 803DD524 003A6AE4  2C 04 00 00 */	cmpwi r4, 0x0
/* 803DD528 003A6AE8  80 83 00 00 */	lwz r4, 0x0(r3)
...
# nw4r::g3d::ResVtxTexCoord::DCStore(bool)
.fn DCStore__Q34nw4r3g3d14ResVtxTexCoordFb, global
/* 803DD538 003A6AF8  80 63 00 00 */	lwz r3, 0x0(r3)
/* 803DD53C 003A6AFC  2C 04 00 00 */	cmpwi r4, 0x0
/* 803DD540 003A6B00  80 83 00 00 */	lwz r4, 0x0(r3)
...
# nw4r::g3d::ResVtxFurVec::DCStore(bool)
.fn DCStore__Q34nw4r3g3d12ResVtxFurVecFb, global
/* 803DD550 003A6B10  80 63 00 00 */	lwz r3, 0x0(r3)
/* 803DD554 003A6B14  2C 04 00 00 */	cmpwi r4, 0x0
/* 803DD558 003A6B18  80 83 00 00 */	lwz r4, 0x0(r3)
...
# nw4r::g3d::ResVtxFurPos::DCStore(bool)
.fn DCStore__Q34nw4r3g3d12ResVtxFurPosFb, global
/* 803DD568 003A6B28  80 63 00 00 */	lwz r3, 0x0(r3)
/* 803DD56C 003A6B2C  2C 04 00 00 */	cmpwi r4, 0x0
/* 803DD570 003A6B30  80 83 00 00 */	lwz r4, 0x0(r3)
