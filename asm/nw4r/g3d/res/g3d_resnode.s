.include "macros.inc"
.file "nw4r/g3d/res/g3d_resnode.o"

# 0x803DD784 - 0x803DDAA8
.text
.balign 4

# nw4r::g3d::ResNode::PatchChrAnmResult(nw4r::g3d::ChrAnmResult*) const
.fn PatchChrAnmResult__Q34nw4r3g3d7ResNodeCFPQ34nw4r3g3d12ChrAnmResult, global
...
/* 803DD7A0 003A6D60  83 A3 00 00 */	lwz r29, 0x0(r3)
/* 803DD7A4 003A6D64  2C 1D 00 00 */	cmpwi r29, 0x0
/* 803DD7A8 003A6D68  41 82 01 5C */	beq .L_803DD904
/* 803DD7AC 003A6D6C  83 E4 00 00 */	lwz r31, 0x0(r4)
/* 803DD7B0 003A6D70  57 E0 06 31 */	rlwinm. r0, r31, 0, 24, 24
/* 803DD7B4 003A6D74  41 82 00 58 */	beq .L_803DD80C
/* 803DD7B8 003A6D78  80 7D 00 14 */	lwz r3, 0x14(r29)
/* 803DD7BC 003A6D7C  54 60 07 39 */	rlwinm. r0, r3, 0, 28, 28
...
/* 803DD7D0 003A6D90  D0 04 00 08 */	stfs f0, 0x8(r4)
/* 803DD7D4 003A6D94  D0 04 00 04 */	stfs f0, 0x4(r4)
/* 803DD7D8 003A6D98  48 00 00 34 */	b .L_803DD80C
.L_803DD7DC:
/* 803DD7DC 003A6D9C  54 60 06 F7 */	rlwinm. r0, r3, 0, 27, 27
/* 803DD7E0 003A6DA0  57 E3 07 34 */	rlwinm r3, r31, 0, 28, 26
/* 803DD7E4 003A6DA4  41 82 00 08 */	beq .L_803DD7EC
/* 803DD7E8 003A6DA8  63 E3 00 10 */	ori r3, r31, 0x10
.L_803DD7EC:
/* 803DD7EC 003A6DAC  C0 1D 00 20 */	lfs f0, 0x20(r29)
/* 803DD7F0 003A6DB0  38 00 FF F5 */	li r0, -0xb
/* 803DD7F4 003A6DB4  7C 7F 00 38 */	and r31, r3, r0
/* 803DD7F8 003A6DB8  D0 04 00 04 */	stfs f0, 0x4(r4)
/* 803DD7FC 003A6DBC  C0 1D 00 24 */	lfs f0, 0x24(r29)
/* 803DD800 003A6DC0  D0 04 00 08 */	stfs f0, 0x8(r4)
/* 803DD804 003A6DC4  C0 1D 00 28 */	lfs f0, 0x28(r29)
/* 803DD808 003A6DC8  D0 04 00 0C */	stfs f0, 0xc(r4)
.L_803DD80C:
/* 803DD80C 003A6DCC  57 E0 05 EF */	rlwinm. r0, r31, 0, 23, 23
/* 803DD810 003A6DD0  41 82 00 80 */	beq .L_803DD890
...
/* 803DD820 003A6DE0  54 00 07 7B */	rlwinm. r0, r0, 0, 29, 29
/* 803DD824 003A6DE4  C0 04 00 28 */	lfs f0, 0x28(r4)
/* 803DD828 003A6DE8  D0 21 00 0C */	stfs f1, 0xc(r1)
/* 803DD82C 003A6DEC  D0 01 00 08 */	stfs f0, 0x8(r1)
/* 803DD830 003A6DF0  D0 41 00 10 */	stfs f2, 0x10(r1)
/* 803DD834 003A6DF4  41 82 00 14 */	beq .L_803DD848
...
/* 803DD844 003A6E04  48 00 00 30 */	b .L_803DD874
.L_803DD848:
...
/* 803DD86C 003A6E2C  38 00 FF D9 */	li r0, -0x27
/* 803DD870 003A6E30  7F FF 00 38 */	and r31, r31, r0
.L_803DD874:
/* 803DD874 003A6E34  C0 41 00 08 */	lfs f2, 0x8(r1)
...
.L_803DD890:
/* 803DD890 003A6E50  57 E0 05 AD */	rlwinm. r0, r31, 0, 22, 22
/* 803DD894 003A6E54  41 82 00 48 */	beq .L_803DD8DC
/* 803DD898 003A6E58  80 1D 00 14 */	lwz r0, 0x14(r29)
/* 803DD89C 003A6E5C  54 00 07 BD */	rlwinm. r0, r0, 0, 30, 30
...
/* 803DD8B8 003A6E78  48 00 00 24 */	b .L_803DD8DC
.L_803DD8BC:
/* 803DD8BC 003A6E7C  C0 1D 00 38 */	lfs f0, 0x38(r29)
/* 803DD8C0 003A6E80  38 00 FF B9 */	li r0, -0x47
...
.L_803DD8DC:
/* 803DD8DC 003A6E9C  57 E0 06 B5 */	rlwinm. r0, r31, 0, 26, 26
/* 803DD8E0 003A6EA0  41 82 00 1C */	beq .L_803DD8FC
/* 803DD8E4 003A6EA4  57 E0 06 73 */	rlwinm. r0, r31, 0, 25, 25
/* 803DD8E8 003A6EA8  41 82 00 14 */	beq .L_803DD8FC
/* 803DD8EC 003A6EAC  63 FF 00 04 */	ori r31, r31, 0x4
/* 803DD8F0 003A6EB0  57 E0 07 39 */	rlwinm. r0, r31, 0, 28, 28
/* 803DD8F4 003A6EB4  41 82 00 08 */	beq .L_803DD8FC
/* 803DD8F8 003A6EB8  63 FF 00 02 */	ori r31, r31, 0x2
.L_803DD8FC:
/* 803DD8FC 003A6EBC  57 E0 06 6A */	rlwinm r0, r31, 0, 25, 21
/* 803DD900 003A6EC0  90 1E 00 00 */	stw r0, 0x0(r30)
.L_803DD904:
...
.endfn PatchChrAnmResult__Q34nw4r3g3d7ResNodeCFPQ34nw4r3g3d12ChrAnmResult

# nw4r::g3d::ResNode::CalcChrAnmResult(nw4r::g3d::ChrAnmResult*) const
.fn CalcChrAnmResult__Q34nw4r3g3d7ResNodeCFPQ34nw4r3g3d12ChrAnmResult, global
...
/* 803DD930 003A6EF0  83 E3 00 00 */	lwz r31, 0x0(r3)
/* 803DD934 003A6EF4  93 C1 00 28 */	stw r30, 0x28(r1)
/* 803DD938 003A6EF8  2C 1F 00 00 */	cmpwi r31, 0x0
/* 803DD93C 003A6EFC  93 A1 00 24 */	stw r29, 0x24(r1)
/* 803DD940 003A6F00  7C 9D 23 78 */	mr r29, r4
/* 803DD944 003A6F04  41 82 01 28 */	beq .L_803DDA6C
/* 803DD948 003A6F08  80 7F 00 14 */	lwz r3, 0x14(r31)
/* 803DD94C 003A6F0C  3B C0 00 00 */	li r30, 0x0
/* 803DD950 003A6F10  54 60 07 39 */	rlwinm. r0, r3, 0, 28, 28
...
/* 803DD964 003A6F24  D0 04 00 08 */	stfs f0, 0x8(r4)
/* 803DD968 003A6F28  D0 04 00 04 */	stfs f0, 0x4(r4)
/* 803DD96C 003A6F2C  48 00 00 28 */	b .L_803DD994
.L_803DD970:
/* 803DD970 003A6F30  54 60 06 F7 */	rlwinm. r0, r3, 0, 27, 27
/* 803DD974 003A6F34  41 82 00 08 */	beq .L_803DD97C
/* 803DD978 003A6F38  63 DE 00 10 */	ori r30, r30, 0x10
.L_803DD97C:
/* 803DD97C 003A6F3C  C0 1F 00 20 */	lfs f0, 0x20(r31)
/* 803DD980 003A6F40  D0 04 00 04 */	stfs f0, 0x4(r4)
/* 803DD984 003A6F44  C0 1F 00 24 */	lfs f0, 0x24(r31)
/* 803DD988 003A6F48  D0 04 00 08 */	stfs f0, 0x8(r4)
...
/* 803DD998 003A6F58  54 00 07 7B */	rlwinm. r0, r0, 0, 29, 29
/* 803DD99C 003A6F5C  41 82 00 14 */	beq .L_803DD9B0
...
/* 803DD9AC 003A6F6C  48 00 00 4C */	b .L_803DD9F8
.L_803DD9B0:
...
/* 803DD9E0 003A6FA0  D0 21 00 08 */	stfs f1, 0x8(r1)
...
/* 803DD9FC 003A6FBC  54 00 07 BD */	rlwinm. r0, r0, 0, 30, 30
/* 803DDA00 003A6FC0  41 82 00 0C */	beq .L_803DDA0C
/* 803DDA04 003A6FC4  63 DE 00 40 */	ori r30, r30, 0x40
/* 803DDA08 003A6FC8  48 00 00 1C */	b .L_803DDA24
.L_803DDA0C:
...
.L_803DDA24:
/* 803DDA24 003A6FE4  57 C0 06 B5 */	rlwinm. r0, r30, 0, 26, 26
/* 803DDA28 003A6FE8  41 82 00 1C */	beq .L_803DDA44
/* 803DDA2C 003A6FEC  57 C0 06 73 */	rlwinm. r0, r30, 0, 25, 25
/* 803DDA30 003A6FF0  41 82 00 14 */	beq .L_803DDA44
/* 803DDA34 003A6FF4  63 DE 00 04 */	ori r30, r30, 0x4
/* 803DDA38 003A6FF8  57 C0 07 39 */	rlwinm. r0, r30, 0, 28, 28
/* 803DDA3C 003A6FFC  41 82 00 08 */	beq .L_803DDA44
/* 803DDA40 003A7000  63 DE 00 02 */	ori r30, r30, 0x2
.L_803DDA44:
/* 803DDA44 003A7004  80 7F 00 14 */	lwz r3, 0x14(r31)
/* 803DDA48 003A7008  67 DE 80 00 */	oris r30, r30, 0x8000
/* 803DDA4C 003A700C  63 DE 00 01 */	ori r30, r30, 0x1
/* 803DDA50 003A7010  54 60 06 B5 */	rlwinm. r0, r3, 0, 26, 26
/* 803DDA54 003A7014  41 82 00 08 */	beq .L_803DDA5C
/* 803DDA58 003A7018  63 DE 04 00 */	ori r30, r30, 0x400
.L_803DDA5C:
/* 803DDA5C 003A701C  54 60 06 73 */	rlwinm. r0, r3, 0, 25, 25
/* 803DDA60 003A7020  41 82 00 08 */	beq .L_803DDA68
/* 803DDA64 003A7024  63 DE 08 00 */	ori r30, r30, 0x800
.L_803DDA68:
/* 803DDA68 003A7028  93 DD 00 00 */	stw r30, 0x0(r29)
.L_803DDA6C:
...
/* 803DDA94 003A7054  41 82 00 0C */	beq .L_803DDAA0
/* 803DDA98 003A7058  7C 63 02 14 */	add r3, r3, r0
/* 803DDA9C 003A705C  4E 80 00 20 */	blr
.L_803DDAA0:
/* 803DDAA0 003A7060  38 60 00 00 */	li r3, 0x0
