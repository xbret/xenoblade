.include "macros.inc"
.file "nw4r/g3d/res/g3d_resdict.o"

# 0x803D7960 - 0x803D7CE4
.text
.balign 4

# nw4r::g3d::ResDic::Get(nw4r::g3d::ResName) const
...
/* 803D7968 003A0F28  80 A3 00 00 */	lwz r5, 0x0(r3)
/* 803D796C 003A0F2C  90 01 00 24 */	stw r0, 0x24(r1)
/* 803D7970 003A0F30  39 05 00 08 */	addi r8, r5, 0x8
/* 803D7974 003A0F34  93 E1 00 1C */	stw r31, 0x1c(r1)
/* 803D7978 003A0F38  A0 05 00 0C */	lhz r0, 0xc(r5)
/* 803D797C 003A0F3C  80 64 00 00 */	lwz r3, 0x0(r4)
/* 803D7980 003A0F40  54 00 20 36 */	slwi r0, r0, 4
/* 803D7984 003A0F44  38 E3 00 04 */	addi r7, r3, 0x4
/* 803D7988 003A0F48  80 C3 00 00 */	lwz r6, 0x0(r3)
/* 803D798C 003A0F4C  7C 65 02 14 */	add r3, r5, r0
/* 803D7990 003A0F50  3B E3 00 08 */	addi r31, r3, 0x8
/* 803D7994 003A0F54  48 00 00 50 */	b .L_803D79E4
.L_803D7998:
/* 803D7998 003A0F58  54 60 EC FE */	extrwi r0, r3, 13, 16
/* 803D799C 003A0F5C  7F E8 FB 78 */	mr r8, r31
/* 803D79A0 003A0F60  7C 00 30 40 */	cmplw r0, r6
/* 803D79A4 003A0F64  54 63 07 7E */	clrlwi r3, r3, 29
...
/* 803D79B8 003A0F78  54 00 07 FF */	clrlwi. r0, r0, 31
/* 803D79BC 003A0F7C  41 82 00 18 */	beq .L_803D79D4
/* 803D79C0 003A0F80  A0 1F 00 06 */	lhz r0, 0x6(r31)
/* 803D79C4 003A0F84  54 00 20 36 */	slwi r0, r0, 4
/* 803D79C8 003A0F88  7C 65 02 14 */	add r3, r5, r0
/* 803D79CC 003A0F8C  3B E3 00 08 */	addi r31, r3, 0x8
/* 803D79D0 003A0F90  48 00 00 14 */	b .L_803D79E4
.L_803D79D4:
/* 803D79D4 003A0F94  A0 1F 00 04 */	lhz r0, 0x4(r31)
/* 803D79D8 003A0F98  54 00 20 36 */	slwi r0, r0, 4
/* 803D79DC 003A0F9C  7C 65 02 14 */	add r3, r5, r0
/* 803D79E0 003A0FA0  3B E3 00 08 */	addi r31, r3, 0x8
.L_803D79E4:
/* 803D79E4 003A0FA4  A0 7F 00 00 */	lhz r3, 0x0(r31)
/* 803D79E8 003A0FA8  A0 08 00 00 */	lhz r0, 0x0(r8)
/* 803D79EC 003A0FAC  7C 00 18 40 */	cmplw r0, r3
/* 803D79F0 003A0FB0  41 81 FF A8 */	bgt .L_803D7998
/* 803D79F4 003A0FB4  80 1F 00 08 */	lwz r0, 0x8(r31)
/* 803D79F8 003A0FB8  7C 83 23 78 */	mr r3, r4
/* 803D79FC 003A0FBC  38 81 00 08 */	addi r4, r1, 0x8
/* 803D7A00 003A0FC0  7C A5 02 14 */	add r5, r5, r0
/* 803D7A04 003A0FC4  38 05 FF FC */	addi r0, r5, -0x4
/* 803D7A08 003A0FC8  90 01 00 08 */	stw r0, 0x8(r1)
/* 803D7A0C 003A0FCC  4B FF FE 05 */	bl __eq__Q34nw4r3g3d7ResNameCFQ34nw4r3g3d7ResName
/* 803D7A10 003A0FD0  2C 03 00 00 */	cmpwi r3, 0x0
...
.L_803D7A20:
/* 803D7A20 003A0FE0  38 60 00 00 */	li r3, 0x0
.L_803D7A24:
...
# nw4r::g3d::ResDic::Get(const char*, unsigned long) const
...
/* 803D7A40 003A1000  80 C3 00 00 */	lwz r6, 0x0(r3)
/* 803D7A44 003A1004  90 01 00 14 */	stw r0, 0x14(r1)
/* 803D7A48 003A1008  38 E6 00 08 */	addi r7, r6, 0x8
...
/* 803D7A5C 003A101C  3B E3 00 08 */	addi r31, r3, 0x8
/* 803D7A60 003A1020  48 00 00 50 */	b .L_803D7AB0
.L_803D7A64:
/* 803D7A64 003A1024  54 60 EC FE */	extrwi r0, r3, 13, 16
/* 803D7A68 003A1028  7F E7 FB 78 */	mr r7, r31
/* 803D7A6C 003A102C  7C 00 28 40 */	cmplw r0, r5
/* 803D7A70 003A1030  54 63 07 7E */	clrlwi r3, r3, 29
...
/* 803D7A84 003A1044  54 00 07 FF */	clrlwi. r0, r0, 31
/* 803D7A88 003A1048  41 82 00 18 */	beq .L_803D7AA0
/* 803D7A8C 003A104C  A0 1F 00 06 */	lhz r0, 0x6(r31)
/* 803D7A90 003A1050  54 00 20 36 */	slwi r0, r0, 4
/* 803D7A94 003A1054  7C 66 02 14 */	add r3, r6, r0
/* 803D7A98 003A1058  3B E3 00 08 */	addi r31, r3, 0x8
/* 803D7A9C 003A105C  48 00 00 14 */	b .L_803D7AB0
.L_803D7AA0:
/* 803D7AA0 003A1060  A0 1F 00 04 */	lhz r0, 0x4(r31)
/* 803D7AA4 003A1064  54 00 20 36 */	slwi r0, r0, 4
/* 803D7AA8 003A1068  7C 66 02 14 */	add r3, r6, r0
/* 803D7AAC 003A106C  3B E3 00 08 */	addi r31, r3, 0x8
.L_803D7AB0:
/* 803D7AB0 003A1070  A0 7F 00 00 */	lhz r3, 0x0(r31)
/* 803D7AB4 003A1074  A0 07 00 00 */	lhz r0, 0x0(r7)
/* 803D7AB8 003A1078  7C 00 18 40 */	cmplw r0, r3
/* 803D7ABC 003A107C  41 81 FF A8 */	bgt .L_803D7A64
/* 803D7AC0 003A1080  80 1F 00 08 */	lwz r0, 0x8(r31)
/* 803D7AC4 003A1084  2C 00 00 00 */	cmpwi r0, 0x0
...
.L_803D7ADC:
/* 803D7ADC 003A109C  38 80 00 00 */	li r4, 0x0
.L_803D7AE0:
/* 803D7AE0 003A10A0  4B EE AD 55 */	bl strcmp
/* 803D7AE4 003A10A4  2C 03 00 00 */	cmpwi r3, 0x0
...
.L_803D7AF4:
/* 803D7AF4 003A10B4  38 60 00 00 */	li r3, 0x0
.L_803D7AF8:
...
# nw4r::g3d::ResDic::operator[](const char*) const
...
/* 803D7B18 003A10D8  80 03 00 00 */	lwz r0, 0x0(r3)
/* 803D7B1C 003A10DC  93 E1 00 0C */	stw r31, 0xc(r1)
/* 803D7B20 003A10E0  7C 9F 23 78 */	mr r31, r4
/* 803D7B24 003A10E4  2C 00 00 00 */	cmpwi r0, 0x0
/* 803D7B28 003A10E8  93 C1 00 08 */	stw r30, 0x8(r1)
/* 803D7B2C 003A10EC  7C 7E 1B 78 */	mr r30, r3
/* 803D7B30 003A10F0  41 82 00 3C */	beq .L_803D7B6C
/* 803D7B34 003A10F4  2C 04 00 00 */	cmpwi r4, 0x0
...
/* 803D7B54 003A1114  2C 03 00 00 */	cmpwi r3, 0x0
/* 803D7B58 003A1118  41 82 00 14 */	beq .L_803D7B6C
/* 803D7B5C 003A111C  80 9E 00 00 */	lwz r4, 0x0(r30)
...
# nw4r::g3d::ResDic::operator[](nw4r::g3d::ResName) const
...
/* 803D7B94 003A1154  80 03 00 00 */	lwz r0, 0x0(r3)
/* 803D7B98 003A1158  93 E1 00 1C */	stw r31, 0x1c(r1)
/* 803D7B9C 003A115C  7C 7F 1B 78 */	mr r31, r3
/* 803D7BA0 003A1160  2C 00 00 00 */	cmpwi r0, 0x0
/* 803D7BA4 003A1164  41 82 00 34 */	beq .L_803D7BD8
/* 803D7BA8 003A1168  80 04 00 00 */	lwz r0, 0x0(r4)
/* 803D7BAC 003A116C  2C 00 00 00 */	cmpwi r0, 0x0
/* 803D7BB0 003A1170  41 82 00 28 */	beq .L_803D7BD8
/* 803D7BB4 003A1174  90 01 00 08 */	stw r0, 0x8(r1)
/* 803D7BB8 003A1178  38 81 00 08 */	addi r4, r1, 0x8
/* 803D7BBC 003A117C  4B FF FD A5 */	bl Get__Q34nw4r3g3d6ResDicCFQ34nw4r3g3d7ResName
/* 803D7BC0 003A1180  2C 03 00 00 */	cmpwi r3, 0x0
/* 803D7BC4 003A1184  41 82 00 14 */	beq .L_803D7BD8
/* 803D7BC8 003A1188  80 9F 00 00 */	lwz r4, 0x0(r31)
...
.L_803D7BD8:
/* 803D7BD8 003A1198  38 60 00 00 */	li r3, 0x0
.L_803D7BDC:
...
# nw4r::g3d::ResDic::GetIndex(const char*) const
...
/* 803D7BFC 003A11BC  80 03 00 00 */	lwz r0, 0x0(r3)
/* 803D7C00 003A11C0  93 E1 00 0C */	stw r31, 0xc(r1)
/* 803D7C04 003A11C4  7C 9F 23 78 */	mr r31, r4
/* 803D7C08 003A11C8  2C 00 00 00 */	cmpwi r0, 0x0
/* 803D7C0C 003A11CC  93 C1 00 08 */	stw r30, 0x8(r1)
/* 803D7C10 003A11D0  7C 7E 1B 78 */	mr r30, r3
/* 803D7C14 003A11D4  41 82 00 44 */	beq .L_803D7C58
/* 803D7C18 003A11D8  2C 04 00 00 */	cmpwi r4, 0x0
...
/* 803D7C38 003A11F8  2C 03 00 00 */	cmpwi r3, 0x0
/* 803D7C3C 003A11FC  41 82 00 1C */	beq .L_803D7C58
/* 803D7C40 003A1200  80 9E 00 00 */	lwz r4, 0x0(r30)
...
# nw4r::g3d::ResDic::GetIndex(nw4r::g3d::ResName) const
.fn GetIndex__Q34nw4r3g3d6ResDicCFQ34nw4r3g3d7ResName, global
...
/* 803D7C80 003A1240  80 03 00 00 */	lwz r0, 0x0(r3)
/* 803D7C84 003A1244  93 E1 00 1C */	stw r31, 0x1c(r1)
/* 803D7C88 003A1248  7C 7F 1B 78 */	mr r31, r3
/* 803D7C8C 003A124C  2C 00 00 00 */	cmpwi r0, 0x0
/* 803D7C90 003A1250  41 82 00 3C */	beq .L_803D7CCC
/* 803D7C94 003A1254  80 04 00 00 */	lwz r0, 0x0(r4)
/* 803D7C98 003A1258  2C 00 00 00 */	cmpwi r0, 0x0
/* 803D7C9C 003A125C  41 82 00 30 */	beq .L_803D7CCC
/* 803D7CA0 003A1260  90 01 00 08 */	stw r0, 0x8(r1)
/* 803D7CA4 003A1264  38 81 00 08 */	addi r4, r1, 0x8
/* 803D7CA8 003A1268  4B FF FC B9 */	bl Get__Q34nw4r3g3d6ResDicCFQ34nw4r3g3d7ResName
/* 803D7CAC 003A126C  2C 03 00 00 */	cmpwi r3, 0x0
/* 803D7CB0 003A1270  41 82 00 1C */	beq .L_803D7CCC
/* 803D7CB4 003A1274  80 9F 00 00 */	lwz r4, 0x0(r31)
...
.L_803D7CCC:
/* 803D7CCC 003A128C  38 60 FF FF */	li r3, -0x1
.L_803D7CD0:
...
.endfn GetIndex__Q34nw4r3g3d6ResDicCFQ34nw4r3g3d7ResName
