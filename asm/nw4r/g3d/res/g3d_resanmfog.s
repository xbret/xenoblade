...
.fn GetAnmResult__Q34nw4r3g3d9ResAnmFogCFPQ34nw4r3g3d12FogAnmResultf, global
...
/* 803E0960 003A9F20  F3 E1 00 48 */	psq_st f31, 0x48(r1), 0, qr0
/* 803E0964 003A9F24  DB C1 00 30 */	stfd f30, 0x30(r1)
/* 803E0968 003A9F28  F3 C1 00 38 */	psq_st f30, 0x38(r1), 0, qr0
/* 803E096C 003A9F2C  FF C0 08 90 */	fmr f30, f1
/* 803E0970 003A9F30  93 E1 00 2C */	stw r31, 0x2c(r1)
/* 803E0974 003A9F34  83 E3 00 00 */	lwz r31, 0x0(r3)
...
/* 803E0988 003A9F48  80 1F 00 04 */	lwz r0, 0x4(r31)
/* 803E098C 003A9F4C  80 BF 00 14 */	lwz r5, 0x14(r31)
/* 803E0990 003A9F50  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 803E0A00 003A9FC0  54 BE 17 FE */	extrwi r30, r5, 1, 1
/* 803E0A04 003A9FC4  54 BD 0F FE */	srwi r29, r5, 31
/* 803E0A08 003A9FC8  90 04 00 00 */	stw r0, 0x0(r4)
...
.L_803E0A2C:
/* 803E0A2C 003A9FEC  2C 1E 00 00 */	cmpwi r30, 0x0
/* 803E0A30 003A9FF0  D0 3C 00 04 */	stfs f1, 0x4(r28)
...
.L_803E0A54:
/* 803E0A54 003AA014  2C 1D 00 00 */	cmpwi r29, 0x0
/* 803E0A58 003AA018  D0 3C 00 08 */	stfs f1, 0x8(r28)
...
/* 803E0A80 003AA040  E3 E1 00 48 */	psq_l f31, 0x48(r1), 0, qr0
/* 803E0A84 003AA044  CB E1 00 40 */	lfd f31, 0x40(r1)
/* 803E0A88 003AA048  E3 C1 00 38 */	psq_l f30, 0x38(r1), 0, qr0
