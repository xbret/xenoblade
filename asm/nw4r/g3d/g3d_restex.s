...
/* 803DD58C 003A6B4C  41 82 00 08 */	beq lbl_803DD594
/* 803DD590 003A6B50  4B F7 6A 50 */	b func_80353FE0
lbl_803DD594:
/* 803DD594 003A6B54  4B F7 6A AC */	b func_80354040

.global func_803DD598
func_803DD598:
...
/* 803DD5A8 003A6B68  41 82 00 0C */	beq lbl_803DD5B4
...
/* 803DD5C8 003A6B88  41 82 00 0C */	beq lbl_803DD5D4
...
/* 803DD5E8 003A6BA8  41 82 00 0C */	beq lbl_803DD5F4
...
/* 803DD5F8 003A6BB8  41 82 00 20 */	beq lbl_803DD618
/* 803DD5FC 003A6BBC  80 0B 00 10 */	lwz r0, 0x10(r11)
/* 803DD600 003A6BC0  2C 00 00 00 */	cmpwi r0, 0
/* 803DD604 003A6BC4  41 82 00 0C */	beq lbl_803DD610
/* 803DD608 003A6BC8  7C 0B 02 14 */	add r0, r11, r0
/* 803DD60C 003A6BCC  48 00 00 08 */	b lbl_803DD614
lbl_803DD610:
...
/* 803DD61C 003A6BDC  41 82 00 10 */	beq lbl_803DD62C
...
/* 803DD630 003A6BF0  41 82 00 10 */	beq lbl_803DD640
...
/* 803DD644 003A6C04  41 82 00 0C */	beq lbl_803DD650
...
/* 803DD654 003A6C14  41 82 00 0C */	beq lbl_803DD660
...
/* 803DD664 003A6C24  41 82 00 0C */	beq lbl_803DD670
...
/* 803DD674 003A6C34  41 82 00 1C */	beq lbl_803DD690
...
/* 803DD6A4 003A6C64  40 82 00 0C */	bne lbl_803DD6B0
...
/* 803DD6B4 003A6C74  41 82 00 20 */	beq lbl_803DD6D4
/* 803DD6B8 003A6C78  80 0B 00 10 */	lwz r0, 0x10(r11)
/* 803DD6BC 003A6C7C  2C 00 00 00 */	cmpwi r0, 0
/* 803DD6C0 003A6C80  41 82 00 0C */	beq lbl_803DD6CC
/* 803DD6C4 003A6C84  7C 0B 02 14 */	add r0, r11, r0
/* 803DD6C8 003A6C88  48 00 00 08 */	b lbl_803DD6D0
lbl_803DD6CC:
...
/* 803DD6D8 003A6C98  41 82 00 10 */	beq lbl_803DD6E8
...
/* 803DD6EC 003A6CAC  41 82 00 10 */	beq lbl_803DD6FC
...
/* 803DD700 003A6CC0  41 82 00 0C */	beq lbl_803DD70C
...
/* 803DD710 003A6CD0  41 82 00 0C */	beq lbl_803DD71C
...
/* 803DD720 003A6CE0  41 82 00 0C */	beq lbl_803DD72C
...
/* 803DD730 003A6CF0  41 82 00 1C */	beq lbl_803DD74C
...
/* 803DD764 003A6D24  41 82 00 0C */	beq lbl_803DD770
