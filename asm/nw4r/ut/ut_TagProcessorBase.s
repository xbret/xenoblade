...
.fn __ct__Q34nw4r2ut19TagProcessorBase_c_Fv, global
/* 8042B700 003F4CC0  3C 80 80 57 */	lis r4, lbl_8056E6FC@ha
/* 8042B704 003F4CC4  38 84 E6 FC */	addi r4, r4, lbl_8056E6FC@l
/* 8042B708 003F4CC8  90 83 00 00 */	stw r4, 0x0(r3)
/* 8042B70C 003F4CCC  4E 80 00 20 */	blr
.endfn __ct__Q34nw4r2ut19TagProcessorBase_c_Fv

# nw4r::ut::TagProcessorBase_c_::~TagProcessorBase_c_()
.fn __dt__Q34nw4r2ut19TagProcessorBase_c_Fv, global
/* 8042B710 003F4CD0  94 21 FF F0 */	stwu r1, -0x10(r1)
/* 8042B714 003F4CD4  7C 08 02 A6 */	mflr r0
/* 8042B718 003F4CD8  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 8042B72C 003F4CEC  2C 04 00 00 */	cmpwi r4, 0x0
...
.endfn __dt__Q34nw4r2ut19TagProcessorBase_c_Fv

.fn Process__Q34nw4r2ut19TagProcessorBase_c_FUsPQ34nw4r2ut15PrintContext_c, global
...
/* 8042B760 003F4D20  F3 E1 00 48 */	psq_st f31, 0x48(r1), 0, qr0
/* 8042B764 003F4D24  DB C1 00 30 */	stfd f30, 0x30(r1)
/* 8042B768 003F4D28  F3 C1 00 38 */	psq_st f30, 0x38(r1), 0, qr0
...
/* 8042B788 003F4D48  2C 04 00 09 */	cmpwi r4, 0x9
/* 8042B78C 003F4D4C  40 80 00 30 */	bge .L_8042B7BC
/* 8042B790 003F4D50  48 00 00 C0 */	b .L_8042B850
.L_8042B794:
/* 8042B794 003F4D54  83 E5 00 00 */	lwz r31, 0x0(r5)
/* 8042B798 003F4D58  C3 E5 00 08 */	lfs f31, 0x8(r5)
...
/* 8042B7F8 003F4DB8  90 01 00 08 */	stw r0, 0x8(r1)
/* 8042B7FC 003F4DBC  C0 9F 00 2C */	lfs f4, 0x2c(r31)
/* 8042B800 003F4DC0  C8 01 00 08 */	lfd f0, 0x8(r1)
/* 8042B804 003F4DC4  C0 7D 00 08 */	lfs f3, 0x8(r29)
...
/* 8042B828 003F4DE8  38 03 00 01 */	addi r0, r3, 0x1
...
.L_8042B848:
/* 8042B848 003F4E08  38 60 00 01 */	li r3, 0x1
/* 8042B84C 003F4E0C  48 00 00 08 */	b .L_8042B854
.L_8042B850:
/* 8042B850 003F4E10  38 60 00 00 */	li r3, 0x0
.L_8042B854:
/* 8042B854 003F4E14  E3 E1 00 48 */	psq_l f31, 0x48(r1), 0, qr0
/* 8042B858 003F4E18  CB E1 00 40 */	lfd f31, 0x40(r1)
/* 8042B85C 003F4E1C  E3 C1 00 38 */	psq_l f30, 0x38(r1), 0, qr0
...
.endfn Process__Q34nw4r2ut19TagProcessorBase_c_FUsPQ34nw4r2ut15PrintContext_c

.fn CalcRect__Q34nw4r2ut19TagProcessorBase_c_FPQ34nw4r2ut4RectUsPQ34nw4r2ut15PrintContext_c, global
...
/* 8042B890 003F4E50  F3 E1 00 58 */	psq_st f31, 0x58(r1), 0, qr0
/* 8042B894 003F4E54  DB C1 00 40 */	stfd f30, 0x40(r1)
/* 8042B898 003F4E58  F3 C1 00 48 */	psq_st f30, 0x48(r1), 0, qr0
...
/* 8042B8B8 003F4E78  2C 05 00 09 */	cmpwi r5, 0x9
/* 8042B8BC 003F4E7C  40 80 00 90 */	bge .L_8042B94C
/* 8042B8C0 003F4E80  48 00 01 7C */	b .L_8042BA3C
.L_8042B8C4:
/* 8042B8C4 003F4E84  83 C6 00 00 */	lwz r30, 0x0(r6)
/* 8042B8C8 003F4E88  C0 1E 00 2C */	lfs f0, 0x2c(r30)
/* 8042B8CC 003F4E8C  D0 04 00 08 */	stfs f0, 0x8(r4)
/* 8042B8D0 003F4E90  C0 1E 00 30 */	lfs f0, 0x30(r30)
/* 8042B8D4 003F4E94  D0 04 00 04 */	stfs f0, 0x4(r4)
/* 8042B8D8 003F4E98  83 E6 00 00 */	lwz r31, 0x0(r6)
/* 8042B8DC 003F4E9C  C3 E6 00 08 */	lfs f31, 0x8(r6)
...
/* 8042B8FC 003F4EBC  D0 1B 00 00 */	stfs f0, 0x0(r27)
/* 8042B900 003F4EC0  C3 DE 00 30 */	lfs f30, 0x30(r30)
/* 8042B904 003F4EC4  80 7C 00 00 */	lwz r3, 0x0(r28)
/* 8042B908 003F4EC8  48 00 43 B5 */	bl GetFontHeight__Q34nw4r2ut10CharWriterCFv
/* 8042B90C 003F4ECC  EC 1E 08 2A */	fadds f0, f30, f1
/* 8042B910 003F4ED0  C0 DB 00 04 */	lfs f6, 0x4(r27)
/* 8042B914 003F4ED4  C0 FB 00 00 */	lfs f7, 0x0(r27)
/* 8042B918 003F4ED8  38 60 00 03 */	li r3, 0x3
/* 8042B91C 003F4EDC  C0 BB 00 08 */	lfs f5, 0x8(r27)
...
/* 8042B938 003F4EF8  D0 3B 00 04 */	stfs f1, 0x4(r27)
/* 8042B93C 003F4EFC  D0 9B 00 00 */	stfs f4, 0x0(r27)
/* 8042B940 003F4F00  D0 7B 00 08 */	stfs f3, 0x8(r27)
/* 8042B944 003F4F04  D0 1B 00 0C */	stfs f0, 0xc(r27)
/* 8042B948 003F4F08  48 00 00 F8 */	b .L_8042BA40
.L_8042B94C:
/* 8042B94C 003F4F0C  83 A6 00 00 */	lwz r29, 0x0(r6)
/* 8042B950 003F4F10  C0 1D 00 2C */	lfs f0, 0x2c(r29)
/* 8042B954 003F4F14  D0 04 00 00 */	stfs f0, 0x0(r4)
/* 8042B958 003F4F18  83 E6 00 00 */	lwz r31, 0x0(r6)
/* 8042B95C 003F4F1C  83 DF 00 58 */	lwz r30, 0x58(r31)
/* 8042B960 003F4F20  2C 1E 00 00 */	cmpwi r30, 0x0
/* 8042B964 003F4F24  40 81 00 80 */	ble .L_8042B9E4
/* 8042B968 003F4F28  88 1F 00 43 */	lbz r0, 0x43(r31)
/* 8042B96C 003F4F2C  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 8042B994 003F4F54  90 01 00 08 */	stw r0, 0x8(r1)
/* 8042B998 003F4F58  C0 9F 00 2C */	lfs f4, 0x2c(r31)
/* 8042B99C 003F4F5C  C8 01 00 08 */	lfd f0, 0x8(r1)
/* 8042B9A0 003F4F60  C0 7C 00 08 */	lfs f3, 0x8(r28)
...
/* 8042B9C4 003F4F84  38 03 00 01 */	addi r0, r3, 0x1
...
/* 8042B9EC 003F4FAC  D0 1B 00 08 */	stfs f0, 0x8(r27)
/* 8042B9F0 003F4FB0  C0 1D 00 30 */	lfs f0, 0x30(r29)
/* 8042B9F4 003F4FB4  D0 1B 00 04 */	stfs f0, 0x4(r27)
/* 8042B9F8 003F4FB8  48 00 42 C5 */	bl GetFontHeight__Q34nw4r2ut10CharWriterCFv
/* 8042B9FC 003F4FBC  C0 5B 00 04 */	lfs f2, 0x4(r27)
/* 8042BA00 003F4FC0  38 60 00 01 */	li r3, 0x1
/* 8042BA04 003F4FC4  C0 DB 00 00 */	lfs f6, 0x0(r27)
/* 8042BA08 003F4FC8  EC 02 08 2A */	fadds f0, f2, f1
/* 8042BA0C 003F4FCC  C0 9B 00 08 */	lfs f4, 0x8(r27)
...
/* 8042BA28 003F4FE8  D0 BB 00 00 */	stfs f5, 0x0(r27)
/* 8042BA2C 003F4FEC  D0 9B 00 08 */	stfs f4, 0x8(r27)
/* 8042BA30 003F4FF0  D0 3B 00 04 */	stfs f1, 0x4(r27)
/* 8042BA34 003F4FF4  D0 1B 00 0C */	stfs f0, 0xc(r27)
/* 8042BA38 003F4FF8  48 00 00 08 */	b .L_8042BA40
.L_8042BA3C:
/* 8042BA3C 003F4FFC  38 60 00 00 */	li r3, 0x0
.L_8042BA40:
/* 8042BA40 003F5000  E3 E1 00 58 */	psq_l f31, 0x58(r1), 0, qr0
/* 8042BA44 003F5004  CB E1 00 50 */	lfd f31, 0x50(r1)
/* 8042BA48 003F5008  E3 C1 00 48 */	psq_l f30, 0x48(r1), 0, qr0
...
.endfn CalcRect__Q34nw4r2ut19TagProcessorBase_c_FPQ34nw4r2ut4RectUsPQ34nw4r2ut15PrintContext_c

# nw4r::ut::TagProcessorBase_w_::TagProcessorBase_w_()
.fn __ct__Q34nw4r2ut19TagProcessorBase_w_Fv, global
/* 8042BA68 003F5028  3C 80 80 57 */	lis r4, lbl_8056E6E8@ha
/* 8042BA6C 003F502C  38 84 E6 E8 */	addi r4, r4, lbl_8056E6E8@l
/* 8042BA70 003F5030  90 83 00 00 */	stw r4, 0x0(r3)
/* 8042BA74 003F5034  4E 80 00 20 */	blr
.endfn __ct__Q34nw4r2ut19TagProcessorBase_w_Fv

# nw4r::ut::TagProcessorBase_w_::~TagProcessorBase_w_()
.fn __dt__Q34nw4r2ut19TagProcessorBase_w_Fv, global
/* 8042BA78 003F5038  94 21 FF F0 */	stwu r1, -0x10(r1)
/* 8042BA7C 003F503C  7C 08 02 A6 */	mflr r0
/* 8042BA80 003F5040  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 8042BA94 003F5054  2C 04 00 00 */	cmpwi r4, 0x0
...
.endfn __dt__Q34nw4r2ut19TagProcessorBase_w_Fv

.fn Process__Q34nw4r2ut19TagProcessorBase_w_FUsPQ34nw4r2ut15PrintContext_w, global
...
/* 8042BAC8 003F5088  F3 E1 00 48 */	psq_st f31, 0x48(r1), 0, qr0
/* 8042BACC 003F508C  DB C1 00 30 */	stfd f30, 0x30(r1)
/* 8042BAD0 003F5090  F3 C1 00 38 */	psq_st f30, 0x38(r1), 0, qr0
...
/* 8042BAF0 003F50B0  2C 04 00 09 */	cmpwi r4, 0x9
/* 8042BAF4 003F50B4  40 80 00 30 */	bge .L_8042BB24
/* 8042BAF8 003F50B8  48 00 00 C0 */	b .L_8042BBB8
.L_8042BAFC:
/* 8042BAFC 003F50BC  83 E5 00 00 */	lwz r31, 0x0(r5)
/* 8042BB00 003F50C0  C3 E5 00 08 */	lfs f31, 0x8(r5)
...
/* 8042BB60 003F5120  90 01 00 08 */	stw r0, 0x8(r1)
/* 8042BB64 003F5124  C0 9F 00 2C */	lfs f4, 0x2c(r31)
/* 8042BB68 003F5128  C8 01 00 08 */	lfd f0, 0x8(r1)
/* 8042BB6C 003F512C  C0 7D 00 08 */	lfs f3, 0x8(r29)
...
/* 8042BB90 003F5150  38 03 00 01 */	addi r0, r3, 0x1
...
.L_8042BBB0:
/* 8042BBB0 003F5170  38 60 00 01 */	li r3, 0x1
/* 8042BBB4 003F5174  48 00 00 08 */	b .L_8042BBBC
.L_8042BBB8:
/* 8042BBB8 003F5178  38 60 00 00 */	li r3, 0x0
.L_8042BBBC:
/* 8042BBBC 003F517C  E3 E1 00 48 */	psq_l f31, 0x48(r1), 0, qr0
/* 8042BBC0 003F5180  CB E1 00 40 */	lfd f31, 0x40(r1)
/* 8042BBC4 003F5184  E3 C1 00 38 */	psq_l f30, 0x38(r1), 0, qr0
...
.endfn Process__Q34nw4r2ut19TagProcessorBase_w_FUsPQ34nw4r2ut15PrintContext_w

.fn CalcRect__Q34nw4r2ut19TagProcessorBase_w_FPQ34nw4r2ut4RectUsPQ34nw4r2ut15PrintContext_w, global
...
/* 8042BBF8 003F51B8  F3 E1 00 58 */	psq_st f31, 0x58(r1), 0, qr0
/* 8042BBFC 003F51BC  DB C1 00 40 */	stfd f30, 0x40(r1)
/* 8042BC00 003F51C0  F3 C1 00 48 */	psq_st f30, 0x48(r1), 0, qr0
...
/* 8042BC20 003F51E0  2C 05 00 09 */	cmpwi r5, 0x9
/* 8042BC24 003F51E4  40 80 00 90 */	bge .L_8042BCB4
/* 8042BC28 003F51E8  48 00 01 7C */	b .L_8042BDA4
.L_8042BC2C:
/* 8042BC2C 003F51EC  83 C6 00 00 */	lwz r30, 0x0(r6)
/* 8042BC30 003F51F0  C0 1E 00 2C */	lfs f0, 0x2c(r30)
/* 8042BC34 003F51F4  D0 04 00 08 */	stfs f0, 0x8(r4)
/* 8042BC38 003F51F8  C0 1E 00 30 */	lfs f0, 0x30(r30)
/* 8042BC3C 003F51FC  D0 04 00 04 */	stfs f0, 0x4(r4)
/* 8042BC40 003F5200  83 E6 00 00 */	lwz r31, 0x0(r6)
/* 8042BC44 003F5204  C3 E6 00 08 */	lfs f31, 0x8(r6)
...
/* 8042BC64 003F5224  D0 1B 00 00 */	stfs f0, 0x0(r27)
/* 8042BC68 003F5228  C3 DE 00 30 */	lfs f30, 0x30(r30)
/* 8042BC6C 003F522C  80 7C 00 00 */	lwz r3, 0x0(r28)
/* 8042BC70 003F5230  48 00 40 4D */	bl GetFontHeight__Q34nw4r2ut10CharWriterCFv
/* 8042BC74 003F5234  EC 1E 08 2A */	fadds f0, f30, f1
/* 8042BC78 003F5238  C0 DB 00 04 */	lfs f6, 0x4(r27)
/* 8042BC7C 003F523C  C0 FB 00 00 */	lfs f7, 0x0(r27)
/* 8042BC80 003F5240  38 60 00 03 */	li r3, 0x3
/* 8042BC84 003F5244  C0 BB 00 08 */	lfs f5, 0x8(r27)
...
/* 8042BCA0 003F5260  D0 3B 00 04 */	stfs f1, 0x4(r27)
/* 8042BCA4 003F5264  D0 9B 00 00 */	stfs f4, 0x0(r27)
/* 8042BCA8 003F5268  D0 7B 00 08 */	stfs f3, 0x8(r27)
/* 8042BCAC 003F526C  D0 1B 00 0C */	stfs f0, 0xc(r27)
/* 8042BCB0 003F5270  48 00 00 F8 */	b .L_8042BDA8
.L_8042BCB4:
/* 8042BCB4 003F5274  83 A6 00 00 */	lwz r29, 0x0(r6)
/* 8042BCB8 003F5278  C0 1D 00 2C */	lfs f0, 0x2c(r29)
/* 8042BCBC 003F527C  D0 04 00 00 */	stfs f0, 0x0(r4)
/* 8042BCC0 003F5280  83 E6 00 00 */	lwz r31, 0x0(r6)
/* 8042BCC4 003F5284  83 DF 00 58 */	lwz r30, 0x58(r31)
/* 8042BCC8 003F5288  2C 1E 00 00 */	cmpwi r30, 0x0
/* 8042BCCC 003F528C  40 81 00 80 */	ble .L_8042BD4C
/* 8042BCD0 003F5290  88 1F 00 43 */	lbz r0, 0x43(r31)
/* 8042BCD4 003F5294  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 8042BCFC 003F52BC  90 01 00 08 */	stw r0, 0x8(r1)
/* 8042BD00 003F52C0  C0 9F 00 2C */	lfs f4, 0x2c(r31)
/* 8042BD04 003F52C4  C8 01 00 08 */	lfd f0, 0x8(r1)
/* 8042BD08 003F52C8  C0 7C 00 08 */	lfs f3, 0x8(r28)
...
/* 8042BD2C 003F52EC  38 03 00 01 */	addi r0, r3, 0x1
...
/* 8042BD54 003F5314  D0 1B 00 08 */	stfs f0, 0x8(r27)
/* 8042BD58 003F5318  C0 1D 00 30 */	lfs f0, 0x30(r29)
/* 8042BD5C 003F531C  D0 1B 00 04 */	stfs f0, 0x4(r27)
/* 8042BD60 003F5320  48 00 3F 5D */	bl GetFontHeight__Q34nw4r2ut10CharWriterCFv
/* 8042BD64 003F5324  C0 5B 00 04 */	lfs f2, 0x4(r27)
/* 8042BD68 003F5328  38 60 00 01 */	li r3, 0x1
/* 8042BD6C 003F532C  C0 DB 00 00 */	lfs f6, 0x0(r27)
/* 8042BD70 003F5330  EC 02 08 2A */	fadds f0, f2, f1
/* 8042BD74 003F5334  C0 9B 00 08 */	lfs f4, 0x8(r27)
...
/* 8042BD90 003F5350  D0 BB 00 00 */	stfs f5, 0x0(r27)
/* 8042BD94 003F5354  D0 9B 00 08 */	stfs f4, 0x8(r27)
/* 8042BD98 003F5358  D0 3B 00 04 */	stfs f1, 0x4(r27)
/* 8042BD9C 003F535C  D0 1B 00 0C */	stfs f0, 0xc(r27)
/* 8042BDA0 003F5360  48 00 00 08 */	b .L_8042BDA8
.L_8042BDA4:
/* 8042BDA4 003F5364  38 60 00 00 */	li r3, 0x0
.L_8042BDA8:
/* 8042BDA8 003F5368  E3 E1 00 58 */	psq_l f31, 0x58(r1), 0, qr0
/* 8042BDAC 003F536C  CB E1 00 50 */	lfd f31, 0x50(r1)
/* 8042BDB0 003F5370  E3 C1 00 48 */	psq_l f30, 0x48(r1), 0, qr0
