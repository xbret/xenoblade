.include "macros.inc"
.file "nw4r/lyt/lyt_group.o"

# 0x803FF934 - 0x803FFC74
.text
.balign 4

# nw4r::lyt::Group::Group(const nw4r::lyt::res::Group*, nw4r::lyt::Pane*)
...
/* 803FF948 003C8F08  3B C0 00 00 */	li r30, 0x0
...
/* 803FF970 003C8F30  90 C3 00 00 */	stw r6, 0x0(r3)
/* 803FF974 003C8F34  38 84 00 08 */	addi r4, r4, 0x8
/* 803FF978 003C8F38  93 C3 00 04 */	stw r30, 0x4(r3)
/* 803FF97C 003C8F3C  93 C3 00 08 */	stw r30, 0x8(r3)
...
/* 803FF9E0 003C8FA0  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 803FF9F0 003C8FB0  93 C3 00 00 */	stw r30, 0x0(r3)
/* 803FF9F4 003C8FB4  93 C3 00 04 */	stw r30, 0x4(r3)
/* 803FF9F8 003C8FB8  48 00 00 08 */	b .L_803FFA00
.L_803FF9FC:
/* 803FF9FC 003C8FBC  38 A0 00 00 */	li r5, 0x0
.L_803FFA00:
/* 803FFA00 003C8FC0  2C 05 00 00 */	cmpwi r5, 0x0
/* 803FFA04 003C8FC4  41 82 00 1C */	beq .L_803FFA20
/* 803FFA08 003C8FC8  93 E5 00 08 */	stw r31, 0x8(r5)
/* 803FFA0C 003C8FCC  38 18 00 10 */	addi r0, r24, 0x10
/* 803FFA10 003C8FD0  38 78 00 0C */	addi r3, r24, 0xc
/* 803FFA14 003C8FD4  38 81 00 08 */	addi r4, r1, 0x8
/* 803FFA18 003C8FD8  90 01 00 08 */	stw r0, 0x8(r1)
...
/* 803FFA24 003C8FE4  3B 7B 00 01 */	addi r27, r27, 0x1
.L_803FFA28:
...
/* 803FFA64 003C9024  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 803FFAC8 003C9088  38 80 00 00 */	li r4, 0x0
/* 803FFACC 003C908C  48 02 B9 45 */	bl __dt__Q44nw4r2ut6detail12LinkListImplFv
.L_803FFAD0:
/* 803FFAD0 003C9090  2C 1C 00 00 */	cmpwi r28, 0x0
...
# nw4r::lyt::GroupContainer::~GroupContainer()
...
/* 803FFB10 003C90D0  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 803FFB20 003C90E0  83 E3 00 04 */	lwz r31, 0x4(r3)
/* 803FFB24 003C90E4  3B C3 00 04 */	addi r30, r3, 0x4
/* 803FFB28 003C90E8  48 00 00 54 */	b .L_803FFB7C
.L_803FFB2C:
/* 803FFB2C 003C90EC  7F FD FB 78 */	mr r29, r31
/* 803FFB30 003C90F0  83 FF 00 00 */	lwz r31, 0x0(r31)
/* 803FFB34 003C90F4  7F 63 DB 78 */	mr r3, r27
/* 803FFB38 003C90F8  38 81 00 08 */	addi r4, r1, 0x8
/* 803FFB3C 003C90FC  93 A1 00 08 */	stw r29, 0x8(r1)
...
/* 803FFB48 003C9108  2C 00 00 00 */	cmpwi r0, 0x0
/* 803FFB4C 003C910C  40 82 00 30 */	bne .L_803FFB7C
/* 803FFB50 003C9110  37 BD FF FC */	addic. r29, r29, -0x4
/* 803FFB54 003C9114  41 82 00 28 */	beq .L_803FFB7C
/* 803FFB58 003C9118  81 9D 00 00 */	lwz r12, 0x0(r29)
/* 803FFB5C 003C911C  7F A3 EB 78 */	mr r3, r29
/* 803FFB60 003C9120  38 80 FF FF */	li r4, -0x1
/* 803FFB64 003C9124  81 8C 00 08 */	lwz r12, 0x8(r12)
...
# nw4r::lyt::GroupContainer::AppendGroup(nw4r::lyt::Group*)
...
/* 803FFBD4 003C9194  38 03 00 04 */	addi r0, r3, 0x4
/* 803FFBD8 003C9198  38 81 00 08 */	addi r4, r1, 0x8
/* 803FFBDC 003C919C  38 A5 00 04 */	addi r5, r5, 0x4
/* 803FFBE0 003C91A0  90 01 00 08 */	stw r0, 0x8(r1)
...
# nw4r::lyt::GroupContainer::FindGroupByName(const char*)
...
/* 803FFC0C 003C91CC  3B C3 00 04 */	addi r30, r3, 0x4
...
/* 803FFC1C 003C91DC  83 E3 00 04 */	lwz r31, 0x4(r3)
/* 803FFC20 003C91E0  48 00 00 28 */	b .L_803FFC48
.L_803FFC24:
/* 803FFC24 003C91E4  3B BF FF FC */	addi r29, r31, -0x4
...
/* 803FFC34 003C91F4  2C 03 00 00 */	cmpwi r3, 0x0
