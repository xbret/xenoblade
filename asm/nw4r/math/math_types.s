...
/* 8040B014 003D45D4  F0 43 00 00 */	psq_st f2, 0(r3), 0, qr0
/* 8040B018 003D45D8  F0 43 00 10 */	psq_st f2, 16(r3), 0, qr0
...
/* 8040B024 003D45E4  E0 04 00 00 */	psq_l f0, 0(r4), 0, qr0
/* 8040B028 003D45E8  E0 24 00 08 */	psq_l f1, 8(r4), 0, qr0
/* 8040B02C 003D45EC  E0 44 00 10 */	psq_l f2, 16(r4), 0, qr0
/* 8040B030 003D45F0  E0 64 00 18 */	psq_l f3, 24(r4), 0, qr0
/* 8040B034 003D45F4  E0 84 00 20 */	psq_l f4, 32(r4), 0, qr0
/* 8040B038 003D45F8  E0 A4 00 28 */	psq_l f5, 40(r4), 0, qr0
/* 8040B03C 003D45FC  F0 03 00 00 */	psq_st f0, 0(r3), 0, qr0
/* 8040B040 003D4600  F0 23 80 08 */	psq_st f1, 8(r3), 1, qr0
/* 8040B044 003D4604  F0 43 00 0C */	psq_st f2, 12(r3), 0, qr0
/* 8040B048 003D4608  F0 63 80 14 */	psq_st f3, 20(r3), 1, qr0
/* 8040B04C 003D460C  F0 83 00 18 */	psq_st f4, 24(r3), 0, qr0
/* 8040B050 003D4610  F0 A3 80 20 */	psq_st f5, 32(r3), 1, qr0
...
/* 8040B068 003D4628  F0 03 00 18 */	psq_st f0, 24(r3), 0, qr0
/* 8040B06C 003D462C  F0 03 00 20 */	psq_st f0, 32(r3), 0, qr0
...
/* 8040B084 003D4644  E0 04 00 08 */	psq_l f0, 8(r4), 0, qr0
/* 8040B088 003D4648  E0 25 00 08 */	psq_l f1, 8(r5), 0, qr0
/* 8040B08C 003D464C  F0 43 00 00 */	psq_st f2, 0(r3), 0, qr0
/* 8040B090 003D4650  10 40 08 2A */	ps_add f2, f0, f1
/* 8040B094 003D4654  E0 04 00 10 */	psq_l f0, 16(r4), 0, qr0
/* 8040B098 003D4658  E0 25 00 10 */	psq_l f1, 16(r5), 0, qr0
/* 8040B09C 003D465C  F0 43 00 08 */	psq_st f2, 8(r3), 0, qr0
/* 8040B0A0 003D4660  10 40 08 2A */	ps_add f2, f0, f1
/* 8040B0A4 003D4664  E0 04 00 18 */	psq_l f0, 24(r4), 0, qr0
/* 8040B0A8 003D4668  E0 25 00 18 */	psq_l f1, 24(r5), 0, qr0
/* 8040B0AC 003D466C  F0 43 00 10 */	psq_st f2, 16(r3), 0, qr0
/* 8040B0B0 003D4670  10 40 08 2A */	ps_add f2, f0, f1
/* 8040B0B4 003D4674  E0 04 00 20 */	psq_l f0, 32(r4), 0, qr0
/* 8040B0B8 003D4678  E0 25 00 20 */	psq_l f1, 32(r5), 0, qr0
/* 8040B0BC 003D467C  F0 43 00 18 */	psq_st f2, 24(r3), 0, qr0
/* 8040B0C0 003D4680  10 40 08 2A */	ps_add f2, f0, f1
/* 8040B0C4 003D4684  E0 04 00 28 */	psq_l f0, 40(r4), 0, qr0
/* 8040B0C8 003D4688  E0 25 00 28 */	psq_l f1, 40(r5), 0, qr0
/* 8040B0CC 003D468C  F0 43 00 20 */	psq_st f2, 32(r3), 0, qr0
...
/* 8040B0E8 003D46A8  F0 43 00 00 */	psq_st f2, 0(r3), 0, qr0
/* 8040B0EC 003D46AC  10 40 00 58 */	ps_muls0 f2, f0, f1
/* 8040B0F0 003D46B0  E0 04 00 10 */	psq_l f0, 16(r4), 0, qr0
/* 8040B0F4 003D46B4  F0 43 00 08 */	psq_st f2, 8(r3), 0, qr0
/* 8040B0F8 003D46B8  10 40 00 58 */	ps_muls0 f2, f0, f1
/* 8040B0FC 003D46BC  E0 04 00 18 */	psq_l f0, 24(r4), 0, qr0
/* 8040B100 003D46C0  F0 43 00 10 */	psq_st f2, 16(r3), 0, qr0
/* 8040B104 003D46C4  10 40 00 58 */	ps_muls0 f2, f0, f1
/* 8040B108 003D46C8  E0 04 00 20 */	psq_l f0, 32(r4), 0, qr0
/* 8040B10C 003D46CC  F0 43 00 18 */	psq_st f2, 24(r3), 0, qr0
/* 8040B110 003D46D0  10 40 00 58 */	ps_muls0 f2, f0, f1
/* 8040B114 003D46D4  E0 04 00 28 */	psq_l f0, 40(r4), 0, qr0
/* 8040B118 003D46D8  F0 43 00 20 */	psq_st f2, 32(r3), 0, qr0
...
/* 8040B134 003D46F4  E0 A4 00 20 */	psq_l f5, 32(r4), 0, qr0
/* 8040B138 003D46F8  10 42 00 32 */	ps_mul f2, f2, f0
/* 8040B13C 003D46FC  10 84 00 32 */	ps_mul f4, f4, f0
/* 8040B140 003D4700  E0 25 80 08 */	psq_l f1, 8(r5), 1, qr0
/* 8040B144 003D4704  10 A5 00 32 */	ps_mul f5, f5, f0
/* 8040B148 003D4708  E0 64 00 08 */	psq_l f3, 8(r4), 0, qr0
/* 8040B14C 003D470C  E0 04 00 18 */	psq_l f0, 24(r4), 0, qr0
/* 8040B150 003D4710  E0 C4 00 28 */	psq_l f6, 40(r4), 0, qr0
/* 8040B154 003D4714  10 63 00 72 */	ps_mul f3, f3, f1
/* 8040B158 003D4718  F0 43 00 00 */	psq_st f2, 0(r3), 0, qr0
/* 8040B15C 003D471C  10 00 00 72 */	ps_mul f0, f0, f1
/* 8040B160 003D4720  10 C6 00 72 */	ps_mul f6, f6, f1
/* 8040B164 003D4724  F0 83 00 10 */	psq_st f4, 16(r3), 0, qr0
/* 8040B168 003D4728  F0 63 00 08 */	psq_st f3, 8(r3), 0, qr0
/* 8040B16C 003D472C  F0 03 00 18 */	psq_st f0, 24(r3), 0, qr0
/* 8040B170 003D4730  F0 A3 00 20 */	psq_st f5, 32(r3), 0, qr0
...
/* 8040B188 003D4748  E0 84 00 10 */	psq_l f4, 16(r4), 0, qr0
/* 8040B18C 003D474C  11 02 00 32 */	ps_mul f8, f2, f0
/* 8040B190 003D4750  E0 25 80 08 */	psq_l f1, 8(r5), 1, qr0
/* 8040B194 003D4754  E0 A4 00 18 */	psq_l f5, 24(r4), 0, qr0
/* 8040B198 003D4758  11 23 40 7A */	ps_madd f9, f3, f1, f8
/* 8040B19C 003D475C  E0 C4 00 20 */	psq_l f6, 32(r4), 0, qr0
/* 8040B1A0 003D4760  11 04 00 32 */	ps_mul f8, f4, f0
/* 8040B1A4 003D4764  E0 E4 00 28 */	psq_l f7, 40(r4), 0, qr0
/* 8040B1A8 003D4768  F0 63 00 08 */	psq_st f3, 8(r3), 0, qr0
/* 8040B1AC 003D476C  11 49 4A 94 */	ps_sum0 f10, f9, f10, f9
/* 8040B1B0 003D4770  11 25 40 7A */	ps_madd f9, f5, f1, f8
/* 8040B1B4 003D4774  F0 A3 00 18 */	psq_st f5, 24(r3), 0, qr0
/* 8040B1B8 003D4778  11 06 00 32 */	ps_mul f8, f6, f0
/* 8040B1BC 003D477C  F1 43 80 0C */	psq_st f10, 12(r3), 1, qr0
/* 8040B1C0 003D4780  11 49 4A 94 */	ps_sum0 f10, f9, f10, f9
/* 8040B1C4 003D4784  11 27 40 7A */	ps_madd f9, f7, f1, f8
/* 8040B1C8 003D4788  F0 E3 00 28 */	psq_st f7, 40(r3), 0, qr0
/* 8040B1CC 003D478C  F1 43 80 1C */	psq_st f10, 28(r3), 1, qr0
/* 8040B1D0 003D4790  11 49 4A 94 */	ps_sum0 f10, f9, f10, f9
/* 8040B1D4 003D4794  F0 43 00 00 */	psq_st f2, 0(r3), 0, qr0
/* 8040B1D8 003D4798  F0 83 00 10 */	psq_st f4, 16(r3), 0, qr0
/* 8040B1DC 003D479C  F0 C3 00 20 */	psq_st f6, 32(r3), 0, qr0
/* 8040B1E0 003D47A0  F1 43 80 2C */	psq_st f10, 44(r3), 1, qr0
...
/* 8040B204 003D47C4  4B F4 25 DD */	bl func_8034D7E0
...
/* 8040B270 003D4830  41 81 FF F8 */	bgt lbl_8040B268
/* 8040B274 003D4834  10 84 24 A0 */	ps_merge10 f4, f4, f4
lbl_8040B278:
/* 8040B278 003D4838  F0 81 30 08 */	psq_st f4, 8(r1), 0, qr3
/* 8040B27C 003D483C  E0 E1 30 08 */	psq_l f7, 8(r1), 0, qr3
/* 8040B280 003D4840  FC A0 1A 10 */	fabs f5, f3
/* 8040B284 003D4844  80 01 00 08 */	lwz r0, 8(r1)
/* 8040B288 003D4848  FC 05 00 00 */	fcmpu cr0, f5, f0
/* 8040B28C 003D484C  40 81 00 10 */	ble lbl_8040B29C
lbl_8040B290:
/* 8040B290 003D4850  EC A5 00 28 */	fsubs f5, f5, f0
/* 8040B294 003D4854  FC 05 00 00 */	fcmpu cr0, f5, f0
/* 8040B298 003D4858  41 81 FF F8 */	bgt lbl_8040B290
lbl_8040B29C:
/* 8040B29C 003D485C  F0 A1 B0 08 */	psq_st f5, 8(r1), 1, qr3
/* 8040B2A0 003D4860  54 05 A5 36 */	rlwinm r5, r0, 0x14, 0x14, 0x1b
/* 8040B2A4 003D4864  7C A4 2A 14 */	add r5, r4, r5
/* 8040B2A8 003D4868  10 E4 38 28 */	ps_sub f7, f4, f7
/* 8040B2AC 003D486C  E0 85 00 00 */	psq_l f4, 0(r5), 0, qr0
/* 8040B2B0 003D4870  54 06 25 36 */	rlwinm r6, r0, 4, 0x14, 0x1b
/* 8040B2B4 003D4874  E1 05 00 08 */	psq_l f8, 8(r5), 0, qr0
...
/* 8040B2C4 003D4884  E0 86 00 00 */	psq_l f4, 0(r6), 0, qr0
/* 8040B2C8 003D4888  E1 06 00 08 */	psq_l f8, 8(r6), 0, qr0
/* 8040B2CC 003D488C  A0 01 00 08 */	lhz r0, 8(r1)
/* 8040B2D0 003D4890  40 80 00 0C */	bge lbl_8040B2DC
...
/* 8040B2E0 003D48A0  E0 E1 B0 08 */	psq_l f7, 8(r1), 1, qr3
/* 8040B2E4 003D48A4  54 00 25 36 */	rlwinm r0, r0, 4, 0x14, 0x1b
...
/* 8040B2F4 003D48B4  E0 85 00 00 */	psq_l f4, 0(r5), 0, qr0
/* 8040B2F8 003D48B8  E1 05 00 08 */	psq_l f8, 8(r5), 0, qr0
/* 8040B2FC 003D48BC  40 80 00 0C */	bge lbl_8040B308
...
/* 8040B310 003D48D0  40 80 00 0C */	bge lbl_8040B31C
...
/* 8040B334 003D48F4  F0 E3 80 2C */	psq_st f7, 44(r3), 1, qr0
/* 8040B338 003D48F8  11 03 00 98 */	ps_muls0 f8, f3, f2
/* 8040B33C 003D48FC  F0 C3 80 00 */	psq_st f6, 0(r3), 1, qr0
...
/* 8040B350 003D4910  F0 C3 00 04 */	psq_st f6, 4(r3), 0, qr0
/* 8040B354 003D4914  10 C7 2C 20 */	ps_merge00 f6, f7, f5
/* 8040B358 003D4918  F0 C3 00 0C */	psq_st f6, 12(r3), 0, qr0
/* 8040B35C 003D491C  10 C4 10 5C */	ps_madds0 f6, f4, f1, f2
/* 8040B360 003D4920  F0 C3 00 14 */	psq_st f6, 20(r3), 0, qr0
/* 8040B364 003D4924  10 C0 08 50 */	ps_neg f6, f1
/* 8040B368 003D4928  10 C7 34 20 */	ps_merge00 f6, f7, f6
/* 8040B36C 003D492C  F0 C3 00 1C */	psq_st f6, 28(r3), 0, qr0
/* 8040B370 003D4930  10 C0 00 5A */	ps_muls1 f6, f0, f1
/* 8040B374 003D4934  F0 C3 00 24 */	psq_st f6, 36(r3), 0, qr0
...
/* 8040B380 003D4940  C0 64 00 00 */	lfs f3, 0(r4)
/* 8040B384 003D4944  C0 45 00 00 */	lfs f2, 0(r5)
...
/* 8040B398 003D4958  C0 64 00 04 */	lfs f3, 4(r4)
/* 8040B39C 003D495C  EC 20 00 B2 */	fmuls f1, f0, f2
/* 8040B3A0 003D4960  C0 A5 00 04 */	lfs f5, 4(r5)
...
/* 8040B3B4 003D4974  C1 04 00 08 */	lfs f8, 8(r4)
/* 8040B3B8 003D4978  EC 62 01 72 */	fmuls f3, f2, f5
/* 8040B3BC 003D497C  C1 25 00 08 */	lfs f9, 8(r5)
...
/* 8040B3EC 003D49AC  D0 81 00 08 */	stfs f4, 8(r1)
/* 8040B3F0 003D49B0  D0 61 00 0C */	stfs f3, 0xc(r1)
/* 8040B3F4 003D49B4  EC 02 00 2A */	fadds f0, f2, f0
/* 8040B3F8 003D49B8  D0 83 00 00 */	stfs f4, 0(r3)
/* 8040B3FC 003D49BC  D0 01 00 10 */	stfs f0, 0x10(r1)
/* 8040B400 003D49C0  D0 63 00 04 */	stfs f3, 4(r3)
/* 8040B404 003D49C4  D0 03 00 08 */	stfs f0, 8(r3)
...
/* 8040B424 003D49E4  F0 03 00 18 */	psq_st f0, 24(r3), 0, qr0
/* 8040B428 003D49E8  F0 03 00 20 */	psq_st f0, 32(r3), 0, qr0
/* 8040B42C 003D49EC  F0 43 00 10 */	psq_st f2, 16(r3), 0, qr0
/* 8040B430 003D49F0  F0 23 00 00 */	psq_st f1, 0(r3), 0, qr0
/* 8040B434 003D49F4  F0 23 00 28 */	psq_st f1, 40(r3), 0, qr0
/* 8040B438 003D49F8  F0 03 00 30 */	psq_st f0, 48(r3), 0, qr0
/* 8040B43C 003D49FC  F0 43 00 38 */	psq_st f2, 56(r3), 0, qr0
...
/* 8040B444 003D4A04  E0 04 00 00 */	psq_l f0, 0(r4), 0, qr0
/* 8040B448 003D4A08  E0 24 00 08 */	psq_l f1, 8(r4), 0, qr0
/* 8040B44C 003D4A0C  E0 44 00 10 */	psq_l f2, 16(r4), 0, qr0
/* 8040B450 003D4A10  E0 64 00 18 */	psq_l f3, 24(r4), 0, qr0
/* 8040B454 003D4A14  E0 84 00 20 */	psq_l f4, 32(r4), 0, qr0
/* 8040B458 003D4A18  E0 A4 00 28 */	psq_l f5, 40(r4), 0, qr0
/* 8040B45C 003D4A1C  E0 C4 00 30 */	psq_l f6, 48(r4), 0, qr0
/* 8040B460 003D4A20  E0 E4 00 38 */	psq_l f7, 56(r4), 0, qr0
/* 8040B464 003D4A24  F0 03 00 00 */	psq_st f0, 0(r3), 0, qr0
/* 8040B468 003D4A28  F0 23 00 08 */	psq_st f1, 8(r3), 0, qr0
/* 8040B46C 003D4A2C  F0 43 00 10 */	psq_st f2, 16(r3), 0, qr0
/* 8040B470 003D4A30  F0 63 00 18 */	psq_st f3, 24(r3), 0, qr0
/* 8040B474 003D4A34  F0 83 00 20 */	psq_st f4, 32(r3), 0, qr0
/* 8040B478 003D4A38  F0 A3 00 28 */	psq_st f5, 40(r3), 0, qr0
