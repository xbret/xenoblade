...
/* 802CC654 00295C14  38 A0 00 00 */	li r5, 0x0
...
/* 802CC664 00295C24  38 60 00 00 */	li r3, 0x0
/* 802CC668 00295C28  90 A4 00 04 */	stw r5, 0x4(r4)
...
/* 802CC6A4 00295C64  80 1F 00 04 */	lwz r0, 0x4(r31)
/* 802CC6A8 00295C68  1C 00 00 0C */	mulli r0, r0, 0xc
/* 802CC6AC 00295C6C  7C 9F 02 14 */	add r4, r31, r0
/* 802CC6B0 00295C70  38 84 00 08 */	addi r4, r4, 0x8
/* 802CC6B4 00295C74  4B FF F4 C9 */	bl TRK_memcpy
/* 802CC6B8 00295C78  80 7F 00 04 */	lwz r3, 0x4(r31)
/* 802CC6BC 00295C7C  80 9E B8 B0 */	lwz r4, lbl_8057B8B0@l(r30)
/* 802CC6C0 00295C80  38 03 00 01 */	addi r0, r3, 0x1
/* 802CC6C4 00295C84  90 1F 00 04 */	stw r0, 0x4(r31)
/* 802CC6C8 00295C88  2C 00 00 02 */	cmpwi r0, 0x2
/* 802CC6CC 00295C8C  38 04 FF FF */	addi r0, r4, -0x1
/* 802CC6D0 00295C90  90 1E B8 B0 */	stw r0, lbl_8057B8B0@l(r30)
/* 802CC6D4 00295C94  40 82 00 0C */	bne .L_802CC6E0
/* 802CC6D8 00295C98  38 00 00 00 */	li r0, 0x0
/* 802CC6DC 00295C9C  90 1F 00 04 */	stw r0, 0x4(r31)
.L_802CC6E0:
/* 802CC6E0 00295CA0  38 80 00 01 */	li r4, 0x1
.L_802CC6E4:
/* 802CC6E4 00295CA4  83 E1 00 0C */	lwz r31, 0xc(r1)
/* 802CC6E8 00295CA8  7C 83 23 78 */	mr r3, r4
/* 802CC6EC 00295CAC  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 802CC714 00295CD4  3B E0 00 00 */	li r31, 0x0
...
/* 802CC724 00295CE4  2C 06 00 02 */	cmpwi r6, 0x2
...
/* 802CC748 00295D08  80 1E 00 04 */	lwz r0, 0x4(r30)
/* 802CC74C 00295D0C  38 A0 00 0C */	li r5, 0xc
/* 802CC750 00295D10  7C 00 32 14 */	add r0, r0, r6
/* 802CC754 00295D14  54 03 0F FE */	srwi r3, r0, 31
/* 802CC758 00295D18  54 00 07 FE */	clrlwi r0, r0, 31
...
/* 802CC76C 00295D2C  38 63 00 08 */	addi r3, r3, 0x8
...
/* 802CC784 00295D44  38 03 00 01 */	addi r0, r3, 0x1
...
/* 802CC7A4 00295D64  38 03 00 01 */	addi r0, r3, 0x1
...
/* 802CC7CC 00295D8C  38 A0 00 00 */	li r5, 0x0
/* 802CC7D0 00295D90  38 00 FF FF */	li r0, -0x1
/* 802CC7D4 00295D94  90 83 00 00 */	stw r4, 0x0(r3)
/* 802CC7D8 00295D98  90 A3 00 04 */	stw r5, 0x4(r3)
/* 802CC7DC 00295D9C  90 03 00 08 */	stw r0, 0x8(r3)
/* 802CC7E0 00295DA0  4E 80 00 20 */	blr
.endfn TRKConstructEvent

.fn TRKDestructEvent, global
/* 802CC7E4 00295DA4  80 63 00 08 */	lwz r3, 0x8(r3)
