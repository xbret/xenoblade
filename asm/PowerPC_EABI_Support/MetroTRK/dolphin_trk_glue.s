...
/* 802CC224 002957E4  80 03 00 00 */	lwz r0, 0x0(r3)
/* 802CC228 002957E8  80 23 00 04 */	lwz r1, 0x4(r3)
/* 802CC22C 002957EC  80 43 00 08 */	lwz r2, 0x8(r3)
/* 802CC230 002957F0  A0 A3 01 A2 */	lhz r5, 0x1a2(r3)
/* 802CC234 002957F4  54 A6 07 BD */	rlwinm. r6, r5, 0, 30, 30
/* 802CC238 002957F8  41 82 00 14 */	beq .L_802CC24C
/* 802CC23C 002957FC  54 A5 07 FA */	rlwinm r5, r5, 0, 31, 29
...
/* 802CC25C 0029581C  7C 8F F1 20 */	mtcrf 255, r4
...
/* 802CC27C 0029583C  54 84 04 5E */	rlwinm r4, r4, 0, 17, 15
/* 802CC280 00295840  54 84 07 FA */	rlwinm r4, r4, 0, 31, 29
/* 802CC284 00295844  7C 80 01 24 */	mtmsr r4
/* 802CC288 00295848  7C 51 43 A6 */	mtsprg 1, r2
/* 802CC28C 0029584C  80 9F 00 0C */	lwz r4, 0xc(r31)
/* 802CC290 00295850  7C 92 43 A6 */	mtsprg 2, r4
/* 802CC294 00295854  80 9F 00 10 */	lwz r4, 0x10(r31)
/* 802CC298 00295858  7C 93 43 A6 */	mtsprg 3, r4
...
/* 802CC2FC 002958BC  93 C1 00 08 */	stw r30, 0x8(r1)
/* 802CC300 002958C0  3F C0 80 54 */	lis r30, "@stringBase0"@ha
/* 802CC304 002958C4  38 7E FD 80 */	addi r3, r30, "@stringBase0"@l
/* 802CC308 002958C8  4C C6 31 82 */	crclr 4*cr1+eq
/* 802CC30C 002958CC  48 08 8B E5 */	bl OSReport
/* 802CC310 002958D0  3B DE FD 80 */	addi r30, r30, "@stringBase0"@l
/* 802CC314 002958D4  38 80 00 40 */	li r4, 0x40
/* 802CC318 002958D8  38 7E 00 15 */	addi r3, r30, 0x15
/* 802CC31C 002958DC  4C C6 31 82 */	crclr 4*cr1+eq
/* 802CC320 002958E0  48 08 8B D1 */	bl OSReport
/* 802CC324 002958E4  2C 1F 00 02 */	cmpwi r31, 0x2
/* 802CC328 002958E8  38 00 00 00 */	li r0, 0x0
/* 802CC32C 002958EC  98 0D B3 F8 */	stb r0, TRK_Use_BBA@sda21(r13)
/* 802CC330 002958F0  40 82 00 0C */	bne .L_802CC33C
/* 802CC334 002958F4  38 60 00 00 */	li r3, 0x0
/* 802CC338 002958F8  48 00 00 CC */	b .L_802CC404
.L_802CC33C:
/* 802CC33C 002958FC  2C 1F 00 01 */	cmpwi r31, 0x1
/* 802CC340 00295900  40 82 00 98 */	bne .L_802CC3D8
/* 802CC344 00295904  38 7E 00 3A */	addi r3, r30, 0x3a
/* 802CC348 00295908  4C C6 31 82 */	crclr 4*cr1+eq
...
/* 802CC3AC 0029596C  38 60 00 00 */	li r3, 0x0
...
/* 802CC3C0 00295980  91 0C 00 08 */	stw r8, 0x8(r12)
...
/* 802CC3D0 00295990  90 8C 00 04 */	stw r4, 0x4(r12)
...
/* 802CC460 00295A20  38 60 00 00 */	li r3, 0x0
...
/* 802CC478 00295A38  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 802CC488 00295A48  81 83 00 04 */	lwz r12, 0x4(r3)
/* 802CC48C 00295A4C  2C 0C 00 00 */	cmpwi r12, 0x0
...
/* 802CC4DC 00295A9C  7C 03 FE 70 */	srawi r3, r0, 31
...
/* 802CC518 00295AD8  7C 03 FE 70 */	srawi r3, r0, 31
...
/* 802CC578 00295B38  38 A0 00 04 */	li r5, 0x4
...
/* 802CC58C 00295B4C  38 7F 00 04 */	addi r3, r31, 0x4
/* 802CC590 00295B50  4B FF F5 ED */	bl TRK_memcpy
/* 802CC594 00295B54  38 7F 00 04 */	addi r3, r31, 0x4
/* 802CC598 00295B58  38 80 00 04 */	li r4, 0x4
/* 802CC59C 00295B5C  48 08 7B 05 */	bl ICInvalidateRange
/* 802CC5A0 00295B60  38 7F 00 04 */	addi r3, r31, 0x4
/* 802CC5A4 00295B64  38 80 00 04 */	li r4, 0x4
