...
/* 802B9D8C 0028334C  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 802B9D9C 0028335C  38 60 00 00 */	li r3, 0x0
/* 802B9DA0 00283360  48 00 02 2C */	b .L_802B9FCC
.L_802B9DA4:
/* 802B9DA4 00283364  7C 83 20 2E */	lwzx r4, r3, r4
/* 802B9DA8 00283368  81 64 00 00 */	lwz r11, 0x0(r4)
/* 802B9DAC 0028336C  2C 0B 00 00 */	cmpwi r11, 0x0
/* 802B9DB0 00283370  41 82 01 E8 */	beq .L_802B9F98
/* 802B9DB4 00283374  80 04 00 04 */	lwz r0, 0x4(r4)
/* 802B9DB8 00283378  2C 05 00 00 */	cmpwi r5, 0x0
/* 802B9DBC 0028337C  7C 63 02 14 */	add r3, r3, r0
/* 802B9DC0 00283380  41 82 02 0C */	beq .L_802B9FCC
/* 802B9DC4 00283384  80 85 00 00 */	lwz r4, 0x0(r5)
/* 802B9DC8 00283388  81 2B 00 00 */	lwz r9, 0x0(r11)
...
/* 802B9DDC 0028339C  38 A0 00 00 */	li r5, 0x0
/* 802B9DE0 002833A0  48 00 00 30 */	b .L_802B9E10
.L_802B9DE4:
/* 802B9DE4 002833A4  39 29 00 01 */	addi r9, r9, 0x1
/* 802B9DE8 002833A8  39 4A 00 01 */	addi r10, r10, 0x1
.L_802B9DEC:
/* 802B9DEC 002833AC  89 89 00 00 */	lbz r12, 0x0(r9)
/* 802B9DF0 002833B0  88 AA 00 00 */	lbz r5, 0x0(r10)
...
/* 802B9E04 002833C4  89 0A 00 00 */	lbz r8, 0x0(r10)
/* 802B9E08 002833C8  88 A9 00 00 */	lbz r5, 0x0(r9)
/* 802B9E0C 002833CC  7C A8 28 50 */	subf r5, r8, r5
.L_802B9E10:
/* 802B9E10 002833D0  2C 05 00 00 */	cmpwi r5, 0x0
/* 802B9E14 002833D4  40 82 00 08 */	bne .L_802B9E1C
/* 802B9E18 002833D8  48 00 01 B4 */	b .L_802B9FCC
.L_802B9E1C:
/* 802B9E1C 002833DC  80 AB 00 04 */	lwz r5, 0x4(r11)
/* 802B9E20 002833E0  2C 05 00 00 */	cmpwi r5, 0x0
/* 802B9E24 002833E4  41 82 01 74 */	beq .L_802B9F98
/* 802B9E28 002833E8  48 00 01 64 */	b .L_802B9F8C
.L_802B9E2C:
/* 802B9E2C 002833EC  81 85 00 04 */	lwz r12, 0x4(r5)
/* 802B9E30 002833F0  55 88 00 01 */	clrrwi. r8, r12, 31
/* 802B9E34 002833F4  41 82 00 FC */	beq .L_802B9F30
/* 802B9E38 002833F8  55 88 00 7E */	clrlwi r8, r12, 1
/* 802B9E3C 002833FC  83 E5 00 08 */	lwz r31, 0x8(r5)
/* 802B9E40 00283400  7D 00 42 15 */	add. r8, r0, r8
/* 802B9E44 00283404  40 82 00 D8 */	bne .L_802B9F1C
/* 802B9E48 00283408  81 49 00 00 */	lwz r10, 0x0(r9)
...
/* 802B9E5C 0028341C  39 00 00 00 */	li r8, 0x0
/* 802B9E60 00283420  48 00 00 30 */	b .L_802B9E90
.L_802B9E64:
/* 802B9E64 00283424  39 4A 00 01 */	addi r10, r10, 0x1
/* 802B9E68 00283428  39 6B 00 01 */	addi r11, r11, 0x1
.L_802B9E6C:
/* 802B9E6C 0028342C  89 8A 00 00 */	lbz r12, 0x0(r10)
/* 802B9E70 00283430  89 0B 00 00 */	lbz r8, 0x0(r11)
...
/* 802B9E84 00283444  89 2B 00 00 */	lbz r9, 0x0(r11)
/* 802B9E88 00283448  89 0A 00 00 */	lbz r8, 0x0(r10)
/* 802B9E8C 0028344C  7D 09 40 50 */	subf r8, r9, r8
.L_802B9E90:
/* 802B9E90 00283450  2C 08 00 00 */	cmpwi r8, 0x0
...
/* 802B9EA0 00283460  2C 1F 00 00 */	cmpwi r31, 0x0
/* 802B9EA4 00283464  40 81 00 F4 */	ble .L_802B9F98
.L_802B9EA8:
/* 802B9EA8 00283468  81 6C 00 04 */	lwz r11, 0x4(r12)
/* 802B9EAC 0028346C  7C 80 5A 15 */	add. r4, r0, r11
/* 802B9EB0 00283470  40 82 00 60 */	bne .L_802B9F10
/* 802B9EB4 00283474  80 8C 00 00 */	lwz r4, 0x0(r12)
/* 802B9EB8 00283478  81 26 00 00 */	lwz r9, 0x0(r6)
/* 802B9EBC 0028347C  81 04 00 00 */	lwz r8, 0x0(r4)
...
/* 802B9ECC 0028348C  38 80 00 00 */	li r4, 0x0
/* 802B9ED0 00283490  48 00 00 30 */	b .L_802B9F00
.L_802B9ED4:
/* 802B9ED4 00283494  39 08 00 01 */	addi r8, r8, 0x1
/* 802B9ED8 00283498  39 29 00 01 */	addi r9, r9, 0x1
.L_802B9EDC:
/* 802B9EDC 0028349C  89 48 00 00 */	lbz r10, 0x0(r8)
/* 802B9EE0 002834A0  88 89 00 00 */	lbz r4, 0x0(r9)
...
/* 802B9EF4 002834B4  88 A9 00 00 */	lbz r5, 0x0(r9)
/* 802B9EF8 002834B8  88 88 00 00 */	lbz r4, 0x0(r8)
/* 802B9EFC 002834BC  7C 85 20 50 */	subf r4, r5, r4
.L_802B9F00:
/* 802B9F00 002834C0  2C 04 00 00 */	cmpwi r4, 0x0
...
.L_802B9F10:
/* 802B9F10 002834D0  39 8C 00 08 */	addi r12, r12, 0x8
/* 802B9F14 002834D4  42 00 FF 94 */	bdnz .L_802B9EA8
/* 802B9F18 002834D8  48 00 00 80 */	b .L_802B9F98
.L_802B9F1C:
/* 802B9F1C 002834DC  39 1F FF FF */	addi r8, r31, -0x1
...
.L_802B9F30:
/* 802B9F30 002834F0  81 49 00 00 */	lwz r10, 0x0(r9)
...
/* 802B9F44 00283504  39 00 00 00 */	li r8, 0x0
/* 802B9F48 00283508  48 00 00 30 */	b .L_802B9F78
.L_802B9F4C:
/* 802B9F4C 0028350C  39 4A 00 01 */	addi r10, r10, 0x1
/* 802B9F50 00283510  39 6B 00 01 */	addi r11, r11, 0x1
.L_802B9F54:
/* 802B9F54 00283514  8B EA 00 00 */	lbz r31, 0x0(r10)
/* 802B9F58 00283518  89 0B 00 00 */	lbz r8, 0x0(r11)
...
/* 802B9F6C 0028352C  89 2B 00 00 */	lbz r9, 0x0(r11)
/* 802B9F70 00283530  89 0A 00 00 */	lbz r8, 0x0(r10)
/* 802B9F74 00283534  7D 09 40 50 */	subf r8, r9, r8
.L_802B9F78:
/* 802B9F78 00283538  2C 08 00 00 */	cmpwi r8, 0x0
...
.L_802B9F88:
/* 802B9F88 00283548  38 A5 00 08 */	addi r5, r5, 0x8
.L_802B9F8C:
/* 802B9F8C 0028354C  81 25 00 00 */	lwz r9, 0x0(r5)
/* 802B9F90 00283550  2C 09 00 00 */	cmpwi r9, 0x0
...
/* 802B9FE8 002835A8  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 802B9FFC 002835BC  2C 04 00 00 */	cmpwi r4, 0x0
