...
/* 802BC2DC 0028589C  3B E0 00 00 */	li r31, 0x0
...
/* 802BC2FC 002858BC  54 00 57 7F */	extrwi. r0, r0, 3, 7
...
/* 802BC318 002858D8  2C 00 00 00 */	cmpwi r0, 0x0
...
.L_802BC328:
/* 802BC328 002858E8  80 03 00 04 */	lwz r0, 0x4(r3)
/* 802BC32C 002858EC  2C 1D 00 00 */	cmpwi r29, 0x0
/* 802BC330 002858F0  53 C0 B1 D2 */	rlwimi r0, r30, 22, 7, 9
/* 802BC334 002858F4  90 03 00 04 */	stw r0, 0x4(r3)
/* 802BC338 002858F8  41 82 00 14 */	beq .L_802BC34C
/* 802BC33C 002858FC  88 1D 00 0C */	lbz r0, 0xc(r29)
/* 802BC340 00285900  2C 00 00 00 */	cmpwi r0, 0x0
/* 802BC344 00285904  41 82 00 08 */	beq .L_802BC34C
/* 802BC348 00285908  93 E3 00 4C */	stw r31, 0x4c(r3)
.L_802BC34C:
/* 802BC34C 0028590C  2C 1D 00 00 */	cmpwi r29, 0x0
...
/* 802BC398 00285958  54 00 57 7F */	extrwi. r0, r0, 3, 7
...
/* 802BC3A8 00285968  2C 03 00 00 */	cmpwi r3, 0x0
/* 802BC3AC 0028596C  41 82 00 08 */	beq .L_802BC3B4
/* 802BC3B0 00285970  3B E0 FF FF */	li r31, -0x1
.L_802BC3B4:
/* 802BC3B4 00285974  83 DE 00 4C */	lwz r30, 0x4c(r30)
.L_802BC3B8:
/* 802BC3B8 00285978  2C 1E 00 00 */	cmpwi r30, 0x0
...
/* 802BC3C8 00285988  83 C1 00 08 */	lwz r30, 0x8(r1)
