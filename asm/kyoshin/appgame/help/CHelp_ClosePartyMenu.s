.include "macros.inc"
.file "kyoshin/appgame/help/CHelp_ClosePartyMenu.o"

# 0x8001BDF8 - 0x8001BE08
.section extab, "a"
.balign 4
...
# 0x802B84EC - 0x802B859C
.text
.balign 4

.fn fn_802B84EC, global
...
/* 802B84FC 00281ABC  3B E0 00 00 */	li r31, 0x0
/* 802B8500 00281AC0  4B FD B7 11 */	bl fn_80293C10
/* 802B8504 00281AC4  2C 03 00 00 */	cmpwi r3, 0x0
/* 802B8508 00281AC8  40 82 00 10 */	bne .L_802B8518
/* 802B850C 00281ACC  4B ED A6 C5 */	bl fn_80192BD0
/* 802B8510 00281AD0  2C 03 00 00 */	cmpwi r3, 0x0
/* 802B8514 00281AD4  41 82 00 08 */	beq .L_802B851C
.L_802B8518:
/* 802B8518 00281AD8  3B E0 00 01 */	li r31, 0x1
.L_802B851C:
...
/* 802B8544 00281B04  3B E0 00 00 */	li r31, 0x0
/* 802B8548 00281B08  93 C1 00 08 */	stw r30, 0x8(r1)
/* 802B854C 00281B0C  7C 7E 1B 78 */	mr r30, r3
/* 802B8550 00281B10  4B FD B6 C1 */	bl fn_80293C10
/* 802B8554 00281B14  2C 03 00 00 */	cmpwi r3, 0x0
/* 802B8558 00281B18  40 82 00 14 */	bne .L_802B856C
/* 802B855C 00281B1C  4B ED A6 75 */	bl fn_80192BD0
/* 802B8560 00281B20  2C 03 00 00 */	cmpwi r3, 0x0
/* 802B8564 00281B24  40 82 00 08 */	bne .L_802B856C
/* 802B8568 00281B28  3B E0 00 01 */	li r31, 0x1
.L_802B856C:
/* 802B856C 00281B2C  81 9E 00 08 */	lwz r12, 0x8(r30)
...
/* 802B858C 00281B4C  83 C1 00 08 */	lwz r30, 0x8(r1)
