.include "macros.inc"
.file "kyoshin/appgame/help/CHelp_LandMark.o"

# 0x8001BDA8 - 0x8001BDF0
.section extab, "a"
.balign 4
...
# 0x802B8198 - 0x802B8398
.text
.balign 4

.fn fn_802B8198, global
...
/* 802B81AC 0028176C  93 C1 00 08 */	stw r30, 0x8(r1)
/* 802B81B0 00281770  7C 7E 1B 78 */	mr r30, r3
/* 802B81B4 00281774  4B FF FA 21 */	bl fn_802B7BD4
/* 802B81B8 00281778  3C 60 80 54 */	lis r3, __vt__cf_CHelp_LandMark@ha
/* 802B81BC 0028177C  38 00 00 00 */	li r0, 0x0
/* 802B81C0 00281780  38 63 ED 10 */	addi r3, r3, __vt__cf_CHelp_LandMark@l
/* 802B81C4 00281784  2C 1E 00 00 */	cmpwi r30, 0x0
/* 802B81C8 00281788  38 83 00 1C */	addi r4, r3, 0x1c
/* 802B81CC 0028178C  90 7E 00 08 */	stw r3, 0x8(r30)
...
.L_802B81E8:
/* 802B81E8 002817A8  4B DE 52 2D */	bl fn_8009D414
/* 802B81EC 002817AC  7F C3 F3 78 */	mr r3, r30
/* 802B81F0 002817B0  83 E1 00 0C */	lwz r31, 0xc(r1)
/* 802B81F4 002817B4  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 802B8220 002817E0  93 C1 00 08 */	stw r30, 0x8(r1)
...
/* 802B8238 002817F8  90 83 00 08 */	stw r4, 0x8(r3)
...
/* 802B8250 00281810  4B DE 52 C5 */	bl fn_8009D514
/* 802B8254 00281814  2C 1F 00 00 */	cmpwi r31, 0x0
...
/* 802B826C 0028182C  83 C1 00 08 */	lwz r30, 0x8(r1)
...
.fn fn_802B8280, global
/* 802B8280 00281840  38 00 00 00 */	li r0, 0x0
...
/* 802B82B4 00281874  80 63 00 00 */	lwz r3, 0x0(r3)
/* 802B82B8 00281878  4B DE 4C D5 */	bl fn_8009CF8C
/* 802B82BC 0028187C  7C 03 00 D0 */	neg r0, r3
/* 802B82C0 00281880  7C 00 1B 78 */	or r0, r0, r3
/* 802B82C4 00281884  54 00 0F FF */	srwi. r0, r0, 31
...
/* 802B82DC 0028189C  2C 1F 00 00 */	cmpwi r31, 0x0
/* 802B82E0 002818A0  41 82 00 2C */	beq .L_802B830C
/* 802B82E4 002818A4  4B DC EC 61 */	bl fn_80086F44
/* 802B82E8 002818A8  90 7D 00 18 */	stw r3, 0x18(r29)
/* 802B82EC 002818AC  38 60 FF FF */	li r3, -0x1
/* 802B82F0 002818B0  38 80 00 00 */	li r4, 0x0
/* 802B82F4 002818B4  4B DC EA CD */	bl fn_80086DC0
...
/* 802B8338 002818F8  2C 04 00 00 */	cmpwi r4, 0x0
/* 802B833C 002818FC  41 81 00 0C */	bgt .L_802B8348
/* 802B8340 00281900  38 60 00 00 */	li r3, 0x0
/* 802B8344 00281904  48 00 00 34 */	b .L_802B8378
.L_802B8348:
/* 802B8348 00281908  34 04 FF FF */	addic. r0, r4, -0x1
/* 802B834C 0028190C  90 03 00 14 */	stw r0, 0x14(r3)
/* 802B8350 00281910  40 81 00 0C */	ble .L_802B835C
/* 802B8354 00281914  38 60 00 00 */	li r3, 0x0
/* 802B8358 00281918  48 00 00 20 */	b .L_802B8378
.L_802B835C:
/* 802B835C 0028191C  80 63 00 18 */	lwz r3, 0x18(r3)
/* 802B8360 00281920  38 80 00 01 */	li r4, 0x1
/* 802B8364 00281924  4B DC EA 5D */	bl fn_80086DC0
/* 802B8368 00281928  80 0D A5 A4 */	lwz r0, lbl_80666724@sda21(r13)
/* 802B836C 0028192C  38 60 00 01 */	li r3, 0x1
/* 802B8370 00281930  54 00 04 E2 */	rlwinm r0, r0, 0, 19, 17
...
.fn fn_802B8388, global
/* 802B8388 00281948  38 63 FF F4 */	addi r3, r3, -0xc
/* 802B838C 0028194C  4B FF FF 04 */	b fn_802B8290
.endfn fn_802B8388

.fn fn_802B8390, global
/* 802B8390 00281950  38 63 FF F4 */	addi r3, r3, -0xc
/* 802B8394 00281954  4B FF FE 74 */	b fn_802B8208
.endfn fn_802B8390
