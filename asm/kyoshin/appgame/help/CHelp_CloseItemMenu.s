.include "macros.inc"
.file "kyoshin/appgame/help/CHelp_CloseItemMenu.o"

# 0x8001BD70 - 0x8001BD78
.section extab, "a"
.balign 4

.obj "@etb_8001BD70", local
.hidden "@etb_8001BD70"
	.4byte 0x08080000
	.4byte 0x00000000
.endobj "@etb_8001BD70"

# 0x800338F0 - 0x800338FC
.section extabindex, "a"
.balign 4

.obj "@eti_800338F0", local
.hidden "@eti_800338F0"
	.4byte fn_802B7E34
	.4byte 0x00000048
	.4byte "@etb_8001BD70"
...
# 0x802B7E34 - 0x802B7E7C
.text
.balign 4

.fn fn_802B7E34, global
...
/* 802B7E48 00281408  4B EF C9 D5 */	bl fn_801B481C
/* 802B7E4C 0028140C  81 9F 00 08 */	lwz r12, 0x8(r31)
