.include "macros.inc"
.file "kyoshin/appgame/CMainMenu.o"

# 0x8000AD80 - 0x8000AE84
.section extab, "a"
.balign 4
...
# 0x800FEB84 - 0x800FF300
.text
.balign 4

.fn fn_800FEB84, global
...
/* 800FEBCC 000C818C  3B C0 00 00 */	li r30, 0x0
/* 800FEBD0 000C8190  38 7F 00 60 */	addi r3, r31, 0x60
/* 800FEBD4 000C8194  80 08 00 04 */	lwz r0, 0x4(r8)
...
/* 800FEBE4 000C81A4  80 C8 00 08 */	lwz r6, 0x8(r8)
/* 800FEBE8 000C81A8  90 DF 00 44 */	stw r6, 0x44(r31)
/* 800FEBEC 000C81AC  80 E8 00 00 */	lwz r7, 0x0(r8)
/* 800FEBF0 000C81B0  80 C8 00 04 */	lwz r6, 0x4(r8)
/* 800FEBF4 000C81B4  90 DF 00 4C */	stw r6, 0x4c(r31)
/* 800FEBF8 000C81B8  90 FF 00 48 */	stw r7, 0x48(r31)
/* 800FEBFC 000C81BC  80 C8 00 08 */	lwz r6, 0x8(r8)
...
/* 800FEC48 000C8208  48 0D 33 79 */	bl fn_801D1FC0
...
/* 800FEC58 000C8218  90 9D 00 00 */	stw r4, 0x0(r29)
/* 800FEC5C 000C821C  38 80 00 00 */	li r4, 0x0
/* 800FEC60 000C8220  48 0D 40 ED */	bl fn_801D2D4C
/* 800FEC64 000C8224  38 00 00 03 */	li r0, 0x3
...
/* 800FECCC 000C828C  93 C1 00 08 */	stw r30, 0x8(r1)
/* 800FECD0 000C8290  7C 7E 1B 78 */	mr r30, r3
/* 800FECD4 000C8294  41 82 00 1C */	beq .L_800FECF0
/* 800FECD8 000C8298  38 80 00 00 */	li r4, 0x0
/* 800FECDC 000C829C  48 34 5E 5D */	bl fn_80444B38
/* 800FECE0 000C82A0  2C 1F 00 00 */	cmpwi r31, 0x0
...
/* 800FECF8 000C82B8  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 800FED24 000C82E4  93 C1 00 08 */	stw r30, 0x8(r1)
...
/* 800FED34 000C82F4  38 80 00 00 */	li r4, 0x0
/* 800FED38 000C82F8  48 34 5E 01 */	bl fn_80444B38
.L_800FED3C:
/* 800FED3C 000C82FC  2C 1F 00 00 */	cmpwi r31, 0x0
...
/* 800FED54 000C8314  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 800FED80 000C8340  93 C1 00 08 */	stw r30, 0x8(r1)
/* 800FED84 000C8344  7C 7E 1B 78 */	mr r30, r3
/* 800FED88 000C8348  41 82 00 54 */	beq .L_800FEDDC
/* 800FED8C 000C834C  38 80 FF FF */	li r4, -0x1
/* 800FED90 000C8350  38 63 00 A8 */	addi r3, r3, 0xa8
/* 800FED94 000C8354  48 0D 3F F5 */	bl fn_801D2D88
/* 800FED98 000C8358  34 7E 00 90 */	addic. r3, r30, 0x90
/* 800FED9C 000C835C  41 82 00 0C */	beq .L_800FEDA8
/* 800FEDA0 000C8360  38 80 00 00 */	li r4, 0x0
/* 800FEDA4 000C8364  48 0D 32 49 */	bl fn_801D1FEC
.L_800FEDA8:
/* 800FEDA8 000C8368  38 7E 00 60 */	addi r3, r30, 0x60
/* 800FEDAC 000C836C  38 80 FF FF */	li r4, -0x1
/* 800FEDB0 000C8370  48 36 07 D1 */	bl fn_8045F580
/* 800FEDB4 000C8374  2C 1E 00 00 */	cmpwi r30, 0x0
...
/* 800FEDC4 000C8384  38 80 00 00 */	li r4, 0x0
/* 800FEDC8 000C8388  48 34 5D 71 */	bl fn_80444B38
.L_800FEDCC:
/* 800FEDCC 000C838C  2C 1F 00 00 */	cmpwi r31, 0x0
...
/* 800FEDE4 000C83A4  83 C1 00 08 */	lwz r30, 0x8(r1)
...
.L_800FEE28:
/* 800FEE28 000C83E8  48 33 55 79 */	bl fn_804343A0
/* 800FEE2C 000C83EC  80 8D 85 38 */	lwz r4, lbl_806646B8@sda21(r13)
/* 800FEE30 000C83F0  7F E5 FB 78 */	mr r5, r31
/* 800FEE34 000C83F4  38 C0 00 00 */	li r6, 0x0
/* 800FEE38 000C83F8  38 E0 00 00 */	li r7, 0x0
/* 800FEE3C 000C83FC  48 34 F9 59 */	bl fn_8044E794
/* 800FEE40 000C8400  90 7E 00 74 */	stw r3, 0x74(r30)
/* 800FEE44 000C8404  83 E1 00 0C */	lwz r31, 0xc(r1)
/* 800FEE48 000C8408  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 800FEE6C 000C842C  93 C1 00 08 */	stw r30, 0x8(r1)
/* 800FEE70 000C8430  7C 7E 1B 78 */	mr r30, r3
/* 800FEE74 000C8434  48 34 9B D1 */	bl fn_80448A44
/* 800FEE78 000C8438  2C 1E 00 00 */	cmpwi r30, 0x0
...
/* 800FEE8C 000C844C  48 39 70 C5 */	bl fn_80495F50
/* 800FEE90 000C8450  38 7E 00 74 */	addi r3, r30, 0x74
/* 800FEE94 000C8454  48 03 A2 4D */	bl fn_801390E0
...
.fn fn_800FEF20, global
/* 800FEF20 000C84E0  80 03 00 74 */	lwz r0, 0x74(r3)
/* 800FEF24 000C84E4  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 800FEF6C 000C852C  48 03 CE E5 */	bl fn_8013BE50
/* 800FEF70 000C8530  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 800FEF84 000C8544  38 00 00 01 */	li r0, 0x1
/* 800FEF88 000C8548  98 1F 00 54 */	stb r0, 0x54(r31)
/* 800FEF8C 000C854C  48 00 03 54 */	b .L_800FF2E0
.L_800FEF90:
/* 800FEF90 000C8550  48 17 FA D5 */	bl fn_8027EA64
/* 800FEF94 000C8554  2C 03 00 00 */	cmpwi r3, 0x0
/* 800FEF98 000C8558  40 82 03 48 */	bne .L_800FF2E0
/* 800FEF9C 000C855C  48 17 5A E1 */	bl fn_80274A7C
/* 800FEFA0 000C8560  2C 03 00 00 */	cmpwi r3, 0x0
/* 800FEFA4 000C8564  40 82 03 3C */	bne .L_800FF2E0
/* 800FEFA8 000C8568  48 09 3C 29 */	bl fn_80192BD0
/* 800FEFAC 000C856C  2C 03 00 00 */	cmpwi r3, 0x0
/* 800FEFB0 000C8570  40 82 03 30 */	bne .L_800FF2E0
/* 800FEFB4 000C8574  48 06 8A 65 */	bl fn_80167A18
/* 800FEFB8 000C8578  2C 03 00 00 */	cmpwi r3, 0x0
/* 800FEFBC 000C857C  40 82 03 24 */	bne .L_800FF2E0
/* 800FEFC0 000C8580  48 01 DD 9D */	bl fn_8011CD5C
/* 800FEFC4 000C8584  2C 03 00 00 */	cmpwi r3, 0x0
/* 800FEFC8 000C8588  40 82 03 18 */	bne .L_800FF2E0
/* 800FEFCC 000C858C  48 11 34 B5 */	bl fn_80212480
/* 800FEFD0 000C8590  2C 03 00 00 */	cmpwi r3, 0x0
/* 800FEFD4 000C8594  40 82 03 0C */	bne .L_800FF2E0
/* 800FEFD8 000C8598  48 13 05 59 */	bl fn_8022F530
/* 800FEFDC 000C859C  2C 03 00 00 */	cmpwi r3, 0x0
/* 800FEFE0 000C85A0  40 82 03 00 */	bne .L_800FF2E0
/* 800FEFE4 000C85A4  48 14 33 71 */	bl fn_80242354
/* 800FEFE8 000C85A8  2C 03 00 00 */	cmpwi r3, 0x0
/* 800FEFEC 000C85AC  40 82 02 F4 */	bne .L_800FF2E0
/* 800FEFF0 000C85B0  48 15 3C E5 */	bl fn_80252CD4
/* 800FEFF4 000C85B4  2C 03 00 00 */	cmpwi r3, 0x0
/* 800FEFF8 000C85B8  40 82 02 E8 */	bne .L_800FF2E0
/* 800FEFFC 000C85BC  48 15 83 0D */	bl fn_80257308
/* 800FF000 000C85C0  2C 03 00 00 */	cmpwi r3, 0x0
/* 800FF004 000C85C4  40 82 02 DC */	bne .L_800FF2E0
/* 800FF008 000C85C8  48 16 49 3D */	bl fn_80263944
/* 800FF00C 000C85CC  2C 03 00 00 */	cmpwi r3, 0x0
/* 800FF010 000C85D0  40 82 02 D0 */	bne .L_800FF2E0
/* 800FF014 000C85D4  48 17 13 69 */	bl fn_8027037C
/* 800FF018 000C85D8  2C 03 00 00 */	cmpwi r3, 0x0
/* 800FF01C 000C85DC  40 82 02 C4 */	bne .L_800FF2E0
/* 800FF020 000C85E0  48 17 34 69 */	bl fn_80272488
/* 800FF024 000C85E4  2C 03 00 00 */	cmpwi r3, 0x0
/* 800FF028 000C85E8  40 82 02 B8 */	bne .L_800FF2E0
/* 800FF02C 000C85EC  48 18 F4 15 */	bl fn_8028E440
/* 800FF030 000C85F0  2C 03 00 00 */	cmpwi r3, 0x0
/* 800FF034 000C85F4  40 82 02 AC */	bne .L_800FF2E0
/* 800FF038 000C85F8  48 19 CB 69 */	bl fn_8029BBA0
/* 800FF03C 000C85FC  2C 03 00 00 */	cmpwi r3, 0x0
/* 800FF040 000C8600  40 82 02 A0 */	bne .L_800FF2E0
/* 800FF044 000C8604  48 19 FE 15 */	bl fn_8029EE58
/* 800FF048 000C8608  2C 03 00 00 */	cmpwi r3, 0x0
/* 800FF04C 000C860C  40 82 02 94 */	bne .L_800FF2E0
/* 800FF050 000C8610  48 1A D4 C1 */	bl fn_802AC510
/* 800FF054 000C8614  2C 03 00 00 */	cmpwi r3, 0x0
/* 800FF058 000C8618  40 82 02 88 */	bne .L_800FF2E0
/* 800FF05C 000C861C  7F E3 FB 78 */	mr r3, r31
/* 800FF060 000C8620  48 00 2B 99 */	bl fn_80101BF8
/* 800FF064 000C8624  80 1F 00 E0 */	lwz r0, 0xe0(r31)
/* 800FF068 000C8628  28 00 00 08 */	cmplwi r0, 0x8
...
.L_800FF088:
/* 800FF088 000C8648  38 60 00 08 */	li r3, 0x8
/* 800FF08C 000C864C  48 03 8F ED */	bl fn_80138078
/* 800FF090 000C8650  38 00 00 01 */	li r0, 0x1
...
/* 800FF0A4 000C8664  48 03 83 A1 */	bl fn_80137444
/* 800FF0A8 000C8668  2C 03 00 00 */	cmpwi r3, 0x0
/* 800FF0AC 000C866C  41 82 02 0C */	beq .L_800FF2B8
/* 800FF0B0 000C8670  80 7F 00 C0 */	lwz r3, 0xc0(r31)
/* 800FF0B4 000C8674  37 83 00 01 */	addic. r28, r3, 0x1
...
/* 800FF0D0 000C8690  48 03 70 C1 */	bl fn_80136190
...
/* 800FF0E4 000C86A4  48 03 70 AD */	bl fn_80136190
...
/* 800FF0F8 000C86B8  38 C0 00 00 */	li r6, 0x0
/* 800FF0FC 000C86BC  48 03 7A 51 */	bl fn_80136B4C
...
/* 800FF10C 000C86CC  38 C0 00 00 */	li r6, 0x0
/* 800FF110 000C86D0  48 03 7A 3D */	bl fn_80136B4C
...
/* 800FF140 000C8700  38 C0 00 00 */	li r6, 0x0
/* 800FF144 000C8704  48 03 7A 09 */	bl fn_80136B4C
.L_800FF148:
/* 800FF148 000C8708  38 7F 00 90 */	addi r3, r31, 0x90
/* 800FF14C 000C870C  38 80 00 01 */	li r4, 0x1
/* 800FF150 000C8710  48 0D 30 1D */	bl fn_801D216C
/* 800FF154 000C8714  38 00 00 02 */	li r0, 0x2
...
/* 800FF164 000C8724  48 00 07 BD */	bl fn_800FF920
...
/* 800FF174 000C8734  48 03 82 D1 */	bl fn_80137444
/* 800FF178 000C8738  2C 03 00 00 */	cmpwi r3, 0x0
/* 800FF17C 000C873C  41 82 01 3C */	beq .L_800FF2B8
/* 800FF180 000C8740  38 60 00 01 */	li r3, 0x1
/* 800FF184 000C8744  38 00 00 00 */	li r0, 0x0
...
/* 800FF198 000C8758  48 00 28 F1 */	bl fn_80101A88
/* 800FF19C 000C875C  2C 03 00 00 */	cmpwi r3, 0x0
/* 800FF1A0 000C8760  40 82 00 34 */	bne .L_800FF1D4
/* 800FF1A4 000C8764  48 19 B4 B5 */	bl fn_8029A658
/* 800FF1A8 000C8768  2C 03 00 00 */	cmpwi r3, 0x0
/* 800FF1AC 000C876C  40 82 00 28 */	bne .L_800FF1D4
/* 800FF1B0 000C8770  80 1F 00 C0 */	lwz r0, 0xc0(r31)
/* 800FF1B4 000C8774  2C 00 00 00 */	cmpwi r0, 0x0
/* 800FF1B8 000C8778  41 82 00 10 */	beq .L_800FF1C8
/* 800FF1BC 000C877C  2C 00 00 03 */	cmpwi r0, 0x3
/* 800FF1C0 000C8780  41 82 00 10 */	beq .L_800FF1D0
/* 800FF1C4 000C8784  48 00 00 10 */	b .L_800FF1D4
.L_800FF1C8:
/* 800FF1C8 000C8788  48 03 52 99 */	bl fn_80134460
/* 800FF1CC 000C878C  48 00 00 08 */	b .L_800FF1D4
.L_800FF1D0:
/* 800FF1D0 000C8790  48 03 50 09 */	bl fn_801341D8
.L_800FF1D4:
/* 800FF1D4 000C8794  38 00 00 02 */	li r0, 0x2
...
/* 800FF1E4 000C87A4  48 00 1C 31 */	bl fn_80100E14
/* 800FF1E8 000C87A8  48 00 00 D0 */	b .L_800FF2B8
.L_800FF1EC:
/* 800FF1EC 000C87AC  7F E3 FB 78 */	mr r3, r31
/* 800FF1F0 000C87B0  48 00 1E C9 */	bl fn_801010B8
...
/* 800FF200 000C87C0  48 03 82 45 */	bl fn_80137444
/* 800FF204 000C87C4  2C 03 00 00 */	cmpwi r3, 0x0
/* 800FF208 000C87C8  41 82 00 B0 */	beq .L_800FF2B8
/* 800FF20C 000C87CC  80 7F 00 C0 */	lwz r3, 0xc0(r31)
/* 800FF210 000C87D0  37 A3 00 01 */	addic. r29, r3, 0x1
...
/* 800FF22C 000C87EC  48 03 6F 65 */	bl fn_80136190
...
/* 800FF240 000C8800  48 03 6F 51 */	bl fn_80136190
...
/* 800FF254 000C8814  38 C0 00 00 */	li r6, 0x0
/* 800FF258 000C8818  48 03 78 F5 */	bl fn_80136B4C
...
/* 800FF268 000C8828  38 C0 00 00 */	li r6, 0x0
/* 800FF26C 000C882C  48 03 78 E1 */	bl fn_80136B4C
...
/* 800FF29C 000C885C  38 C0 00 00 */	li r6, 0x0
/* 800FF2A0 000C8860  48 03 78 AD */	bl fn_80136B4C
.L_800FF2A4:
/* 800FF2A4 000C8864  38 00 00 02 */	li r0, 0x2
...
/* 800FF2B4 000C8874  48 00 26 41 */	bl fn_801018F4
.L_800FF2B8:
/* 800FF2B8 000C8878  80 7F 00 7C */	lwz r3, 0x7c(r31)
/* 800FF2BC 000C887C  38 80 00 00 */	li r4, 0x0
/* 800FF2C0 000C8880  81 83 00 00 */	lwz r12, 0x0(r3)
...
/* 800FF2D4 000C8894  48 0D 2D 59 */	bl fn_801D202C
/* 800FF2D8 000C8898  38 7F 00 A8 */	addi r3, r31, 0xa8
/* 800FF2DC 000C889C  48 0D 2D 51 */	bl fn_801D202C
.L_800FF2E0:
...
# 0x804F8568 - 0x804F88F0
.rodata
.balign 8
.sym lbl_804F8568, global
	.4byte 0x2F6D656E
	.4byte 0x752F4D61
	.4byte 0x696E4D65
	.4byte 0x6E752E61
	.4byte 0x72630000
.sym lbl_804F857C, global
	.4byte 0xFF40FF80
	.4byte 0xFFC00000
	.4byte 0x00400080
	.4byte 0x00C00000
.sym lbl_804F858C, global
	.4byte 0x7069635F
	.4byte 0x69636F6E
	.4byte 0x30325F30
	.4byte 0x31000000
.sym lbl_804F859C, global
	.4byte 0x7069635F
	.4byte 0x69636F6E
	.4byte 0x30325F30
	.4byte 0x32000000
.sym lbl_804F85AC, global
	.4byte 0x7069635F
	.4byte 0x69636F6E
	.4byte 0x30325F30
	.4byte 0x33000000
.sym lbl_804F85BC, global
	.4byte 0x7069635F
	.4byte 0x69636F6E
	.4byte 0x30335F30
	.4byte 0x31000000
.sym lbl_804F85CC, global
	.4byte 0x7069635F
	.4byte 0x69636F6E
	.4byte 0x30335F30
	.4byte 0x32000000
.sym lbl_804F85DC, global
	.4byte 0x7069635F
	.4byte 0x69636F6E
	.4byte 0x30355F30
	.4byte 0x31000000
.sym lbl_804F85EC, global
	.4byte 0x7069635F
	.4byte 0x69636F6E
	.4byte 0x30355F30
	.4byte 0x32000000
.sym lbl_804F85FC, global
	.4byte 0x7069635F
	.4byte 0x69636F6E
	.4byte 0x30355F30
	.4byte 0x33000000
.sym lbl_804F860C, global
	.4byte 0x7069635F
	.4byte 0x69636F6E
	.4byte 0x30355F30
	.4byte 0x34000000
.sym lbl_804F861C, global
	.4byte 0x7069635F
	.4byte 0x69636F6E
	.4byte 0x30365F30
	.4byte 0x31000000
.sym lbl_804F862C, global
	.4byte 0x7069635F
	.4byte 0x69636F6E
	.4byte 0x30365F30
	.4byte 0x32000000
.sym lbl_804F863C, global
	.4byte 0x7069635F
	.4byte 0x69636F6E
	.4byte 0x30375F30
	.4byte 0x31000000
.sym lbl_804F864C, global
	.4byte 0x7069635F
	.4byte 0x69636F6E
	.4byte 0x30375F30
	.4byte 0x32000000
.sym lbl_804F865C, global
	.4byte 0x7069635F
	.4byte 0x69636F6E
	.4byte 0x30375F30
	.4byte 0x33000000
	.4byte 0x00000000
.sym lbl_804F8670, global
	.4byte lbl_804F858C
	.4byte lbl_804F859C
	.4byte lbl_804F85AC
	.4byte lbl_804F85BC
...
# 0x8052F5B8 - 0x8052F780
.data
.balign 8
.sym lbl_8052F5B8, global
	.4byte 0x00000000
	.4byte 0xFFFFFFFF
	.4byte fn_800FEF20
.sym lbl_8052F5C4, global
	.4byte 0x00000000
	.4byte 0xFFFFFFFF
	.4byte fn_800FEF4C

.obj jumptable_8052F5D0, local
	.rel fn_800FEF4C, .L_800FF088
	.rel fn_800FEF4C, .L_800FF09C
	.rel fn_800FEF4C, .L_800FF160
	.rel fn_800FEF4C, .L_800FF16C
	.rel fn_800FEF4C, .L_800FF194
	.rel fn_800FEF4C, .L_800FF1E0
	.rel fn_800FEF4C, .L_800FF1EC
	.rel fn_800FEF4C, .L_800FF1F8
	.rel fn_800FEF4C, .L_800FF2B0
...
# 0x806646B8 - 0x806646E8
.section .sdata, "wa"
.balign 8
.sym lbl_806646B8, global
	.4byte lbl_804F8568
	.4byte 0x00000000
...
# 0x80666810 - 0x80666818
.section .sbss, "wa", @nobits
.balign 8
.sym lbl_80666810, global
	.skip 0x8
