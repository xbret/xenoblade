...
# 0x801C3974 - 0x801C3ED0
.text
.balign 4

.fn fn_801C3974, global
...
/* 801C3988 0018CF48  BF C1 00 08 */	stmw r30, 0x8(r1)
/* 801C398C 0018CF4C  7C 7E 1B 78 */	mr r30, r3
/* 801C3990 0018CF50  7C 9F 23 78 */	mr r31, r4
/* 801C3994 0018CF54  90 A3 00 00 */	stw r5, 0x0(r3)
/* 801C3998 0018CF58  38 63 00 04 */	addi r3, r3, 0x4
/* 801C399C 0018CF5C  48 29 BB C9 */	bl fn_8045F564
/* 801C39A0 0018CF60  38 00 00 00 */	li r0, 0x0
...
/* 801C39BC 0018CF7C  BB C1 00 08 */	lmw r30, 0x8(r1)
...
/* 801C39F0 0018CFB0  38 80 FF FF */	li r4, -0x1
/* 801C39F4 0018CFB4  38 63 00 04 */	addi r3, r3, 0x4
/* 801C39F8 0018CFB8  48 29 BB 89 */	bl fn_8045F580
/* 801C39FC 0018CFBC  2C 1F 00 00 */	cmpwi r31, 0x0
...
/* 801C3A10 0018CFD0  BB C1 00 08 */	lmw r30, 0x8(r1)
...
/* 801C3A38 0018CFF8  48 27 09 69 */	bl fn_804343A0
/* 801C3A3C 0018CFFC  3F C0 80 50 */	lis r30, lbl_80500B88@ha
/* 801C3A40 0018D000  7C 64 1B 78 */	mr r4, r3
/* 801C3A44 0018D004  38 7F 00 04 */	addi r3, r31, 0x4
/* 801C3A48 0018D008  38 A0 20 00 */	li r5, 0x2000
/* 801C3A4C 0018D00C  38 DE 0B 88 */	addi r6, r30, lbl_80500B88@l
/* 801C3A50 0018D010  38 E0 00 01 */	li r7, 0x1
/* 801C3A54 0018D014  48 29 BC 2D */	bl fn_8045F680
/* 801C3A58 0018D018  38 61 00 08 */	addi r3, r1, 0x8
/* 801C3A5C 0018D01C  38 9F 00 04 */	addi r4, r31, 0x4
/* 801C3A60 0018D020  48 29 BD F9 */	bl fn_8045F858
/* 801C3A64 0018D024  38 60 00 00 */	li r3, 0x0
/* 801C3A68 0018D028  48 27 0F E5 */	bl fn_80434A4C
/* 801C3A6C 0018D02C  80 0D A8 F4 */	lwz r0, lbl_80666A74@sda21(r13)
/* 801C3A70 0018D030  54 03 06 3E */	clrlwi r3, r0, 24
...
/* 801C3A8C 0018D04C  4B F7 33 F9 */	bl fn_80136E84
...
/* 801C3AAC 0018D06C  4B F7 33 D9 */	bl fn_80136E84
/* 801C3AB0 0018D070  48 00 00 CC */	b .L_801C3B7C
.L_801C3AB4:
/* 801C3AB4 0018D074  4B F7 38 01 */	bl fn_801372B4
/* 801C3AB8 0018D078  54 60 06 3E */	clrlwi r0, r3, 24
/* 801C3ABC 0018D07C  2C 00 00 01 */	cmpwi r0, 0x1
/* 801C3AC0 0018D080  41 82 00 30 */	beq .L_801C3AF0
/* 801C3AC4 0018D084  2C 00 00 02 */	cmpwi r0, 0x2
/* 801C3AC8 0018D088  41 82 00 40 */	beq .L_801C3B08
/* 801C3ACC 0018D08C  2C 00 00 03 */	cmpwi r0, 0x3
/* 801C3AD0 0018D090  41 82 00 50 */	beq .L_801C3B20
/* 801C3AD4 0018D094  2C 00 00 04 */	cmpwi r0, 0x4
/* 801C3AD8 0018D098  41 82 00 60 */	beq .L_801C3B38
/* 801C3ADC 0018D09C  2C 00 00 05 */	cmpwi r0, 0x5
/* 801C3AE0 0018D0A0  41 82 00 70 */	beq .L_801C3B50
/* 801C3AE4 0018D0A4  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 801C3B00 0018D0C0  4B F7 33 85 */	bl fn_80136E84
...
/* 801C3B18 0018D0D8  4B F7 33 6D */	bl fn_80136E84
...
/* 801C3B30 0018D0F0  4B F7 33 55 */	bl fn_80136E84
...
/* 801C3B48 0018D108  4B F7 33 3D */	bl fn_80136E84
...
/* 801C3B60 0018D120  4B F7 33 25 */	bl fn_80136E84
...
/* 801C3B78 0018D138  4B F7 33 0D */	bl fn_80136E84
.L_801C3B7C:
...
/* 801C3BE0 0018D1A0  4B F6 06 91 */	bl fn_80124270
/* 801C3BE4 0018D1A4  7F E3 FB 78 */	mr r3, r31
/* 801C3BE8 0018D1A8  48 00 02 55 */	bl fn_801C3E3C
/* 801C3BEC 0018D1AC  38 7F 00 04 */	addi r3, r31, 0x4
/* 801C3BF0 0018D1B0  48 29 BC 21 */	bl fn_8045F810
/* 801C3BF4 0018D1B4  38 61 00 08 */	addi r3, r1, 0x8
/* 801C3BF8 0018D1B8  38 80 FF FF */	li r4, -0x1
/* 801C3BFC 0018D1BC  48 29 BC CD */	bl fn_8045F8C8
...
/* 801C3C20 0018D1E0  BF C1 00 08 */	stmw r30, 0x8(r1)
...
/* 801C3C30 0018D1F0  2C 00 00 00 */	cmpwi r0, 0x0
/* 801C3C34 0018D1F4  38 03 00 01 */	addi r0, r3, 0x1
/* 801C3C38 0018D1F8  90 0D AB D0 */	stw r0, lbl_80666D50@sda21(r13)
/* 801C3C3C 0018D1FC  41 82 00 0C */	beq .L_801C3C48
/* 801C3C40 0018D200  38 60 00 01 */	li r3, 0x1
/* 801C3C44 0018D204  48 00 00 FC */	b .L_801C3D40
.L_801C3C48:
/* 801C3C48 0018D208  80 0D A8 F4 */	lwz r0, lbl_80666A74@sda21(r13)
/* 801C3C4C 0018D20C  3B E0 00 00 */	li r31, 0x0
/* 801C3C50 0018D210  54 03 06 3E */	clrlwi r3, r0, 24
...
.L_801C3C84:
/* 801C3C84 0018D244  4B F7 36 31 */	bl fn_801372B4
/* 801C3C88 0018D248  54 60 06 3E */	clrlwi r0, r3, 24
/* 801C3C8C 0018D24C  2C 00 00 01 */	cmpwi r0, 0x1
/* 801C3C90 0018D250  41 82 00 30 */	beq .L_801C3CC0
/* 801C3C94 0018D254  2C 00 00 02 */	cmpwi r0, 0x2
/* 801C3C98 0018D258  41 82 00 38 */	beq .L_801C3CD0
/* 801C3C9C 0018D25C  2C 00 00 03 */	cmpwi r0, 0x3
/* 801C3CA0 0018D260  41 82 00 40 */	beq .L_801C3CE0
/* 801C3CA4 0018D264  2C 00 00 04 */	cmpwi r0, 0x4
/* 801C3CA8 0018D268  41 82 00 48 */	beq .L_801C3CF0
/* 801C3CAC 0018D26C  2C 00 00 05 */	cmpwi r0, 0x5
/* 801C3CB0 0018D270  41 82 00 50 */	beq .L_801C3D00
/* 801C3CB4 0018D274  2C 00 00 00 */	cmpwi r0, 0x0
...
.L_801C3D1C:
/* 801C3D1C 0018D2DC  48 27 06 85 */	bl fn_804343A0
/* 801C3D20 0018D2E0  7F E4 FB 78 */	mr r4, r31
/* 801C3D24 0018D2E4  7F C5 F3 78 */	mr r5, r30
/* 801C3D28 0018D2E8  38 C0 00 00 */	li r6, 0x0
/* 801C3D2C 0018D2EC  38 E0 00 00 */	li r7, 0x0
/* 801C3D30 0018D2F0  48 28 AA 65 */	bl fn_8044E794
/* 801C3D34 0018D2F4  90 7E 00 14 */	stw r3, 0x14(r30)
/* 801C3D38 0018D2F8  48 28 B6 CD */	bl fn_8044F404
/* 801C3D3C 0018D2FC  38 60 00 00 */	li r3, 0x0
.L_801C3D40:
/* 801C3D40 0018D300  BB C1 00 08 */	lmw r30, 0x8(r1)
...
.fn fn_801C3D54, global
/* 801C3D54 0018D314  88 03 00 1C */	lbz r0, 0x1c(r3)
/* 801C3D58 0018D318  2C 00 00 00 */	cmpwi r0, 0x0
/* 801C3D5C 0018D31C  4D 82 00 20 */	beqlr
/* 801C3D60 0018D320  80 63 00 18 */	lwz r3, 0x18(r3)
/* 801C3D64 0018D324  38 80 00 00 */	li r4, 0x0
/* 801C3D68 0018D328  81 83 00 00 */	lwz r12, 0x0(r3)
...
.fn fn_801C3D7C, global
/* 801C3D7C 0018D33C  88 03 00 1C */	lbz r0, 0x1c(r3)
/* 801C3D80 0018D340  2C 00 00 00 */	cmpwi r0, 0x0
/* 801C3D84 0018D344  4D 82 00 20 */	beqlr
/* 801C3D88 0018D348  80 63 00 18 */	lwz r3, 0x18(r3)
/* 801C3D8C 0018D34C  38 A0 00 00 */	li r5, 0x0
/* 801C3D90 0018D350  38 C0 00 01 */	li r6, 0x1
/* 801C3D94 0018D354  4B F7 32 A4 */	b fn_80137038
/* 801C3D98 0018D358  4E 80 00 20 */	blr
.endfn fn_801C3D7C

.fn fn_801C3D9C, global
...
/* 801C3DB8 0018D378  38 04 FF FF */	addi r0, r4, -0x1
/* 801C3DBC 0018D37C  90 0D AB D0 */	stw r0, lbl_80666D50@sda21(r13)
/* 801C3DC0 0018D380  4B F7 53 21 */	bl fn_801390E0
/* 801C3DC4 0018D384  38 00 00 00 */	li r0, 0x0
/* 801C3DC8 0018D388  98 1F 00 1C */	stb r0, 0x1c(r31)
/* 801C3DCC 0018D38C  48 28 4C 79 */	bl fn_80448A44
/* 801C3DD0 0018D390  80 7F 00 18 */	lwz r3, 0x18(r31)
/* 801C3DD4 0018D394  2C 03 00 00 */	cmpwi r3, 0x0
/* 801C3DD8 0018D398  41 82 00 24 */	beq .L_801C3DFC
/* 801C3DDC 0018D39C  41 82 00 18 */	beq .L_801C3DF4
/* 801C3DE0 0018D3A0  81 83 00 00 */	lwz r12, 0x0(r3)
/* 801C3DE4 0018D3A4  38 80 00 01 */	li r4, 0x1
/* 801C3DE8 0018D3A8  81 8C 00 08 */	lwz r12, 0x8(r12)
/* 801C3DEC 0018D3AC  7D 89 03 A6 */	mtctr r12
/* 801C3DF0 0018D3B0  4E 80 04 21 */	bctrl
.L_801C3DF4:
/* 801C3DF4 0018D3B4  38 00 00 00 */	li r0, 0x0
/* 801C3DF8 0018D3B8  90 1F 00 18 */	stw r0, 0x18(r31)
.L_801C3DFC:
/* 801C3DFC 0018D3BC  80 0D AB D0 */	lwz r0, lbl_80666D50@sda21(r13)
/* 801C3E00 0018D3C0  2C 00 00 00 */	cmpwi r0, 0x0
/* 801C3E04 0018D3C4  41 81 00 14 */	bgt .L_801C3E18
/* 801C3E08 0018D3C8  80 6D AB D4 */	lwz r3, lbl_80666D54@sda21(r13)
/* 801C3E0C 0018D3CC  4B F7 53 19 */	bl fn_80139124
/* 801C3E10 0018D3D0  38 00 00 00 */	li r0, 0x0
/* 801C3E14 0018D3D4  90 0D AB D4 */	stw r0, lbl_80666D54@sda21(r13)
.L_801C3E18:
/* 801C3E18 0018D3D8  38 7F 00 04 */	addi r3, r31, 0x4
/* 801C3E1C 0018D3DC  48 29 B9 5D */	bl fn_8045F778
...
/* 801C3E70 0018D430  80 04 00 04 */	lwz r0, 0x4(r4)
/* 801C3E74 0018D434  7C 05 00 40 */	cmplw r5, r0
/* 801C3E78 0018D438  40 82 00 40 */	bne .L_801C3EB8
/* 801C3E7C 0018D43C  83 C5 00 04 */	lwz r30, 0x4(r5)
/* 801C3E80 0018D440  3B E0 00 00 */	li r31, 0x0
/* 801C3E84 0018D444  93 E5 00 04 */	stw r31, 0x4(r5)
/* 801C3E88 0018D448  48 29 B3 2D */	bl fn_8045F1B4
...
/* 801C3EAC 0018D46C  4B FF FB 79 */	bl fn_801C3A24
/* 801C3EB0 0018D470  38 60 00 01 */	li r3, 0x1
/* 801C3EB4 0018D474  48 00 00 08 */	b .L_801C3EBC
.L_801C3EB8:
/* 801C3EB8 0018D478  38 60 00 00 */	li r3, 0x0
.L_801C3EBC:
...
.balign 8
.sym lbl_80666D50, global
	.skip 0x4
.sym lbl_80666D54, global
	.skip 0x4
