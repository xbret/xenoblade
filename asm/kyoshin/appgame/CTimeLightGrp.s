.include "macros.inc"
.file "kyoshin/appgame/CTimeLightGrp.o"
...
/* 80059EDC 0002349C  3B E0 00 00 */	li r31, 0x0
/* 80059EE0 000234A0  C0 02 85 48 */	lfs f0, lbl_806688C8@sda21(r2)
/* 80059EE4 000234A4  93 C1 00 08 */	stw r30, 0x8(r1)
/* 80059EE8 000234A8  7C 7E 1B 78 */	mr r30, r3
/* 80059EEC 000234AC  90 A3 00 00 */	stw r5, 0x0(r3)
...
/* 80059EF8 000234B8  90 83 00 04 */	stw r4, 0x4(r3)
/* 80059EFC 000234BC  90 E3 00 08 */	stw r7, 0x8(r3)
...
/* 80059F10 000234D0  90 C6 00 00 */	stw r6, 0x0(r6)
/* 80059F14 000234D4  90 C6 00 04 */	stw r6, 0x4(r6)
/* 80059F18 000234D8  90 A3 00 08 */	stw r5, 0x8(r3)
...
/* 80059F34 000234F4  48 43 C0 D1 */	bl fn_80496004
/* 80059F38 000234F8  7C 64 1B 78 */	mr r4, r3
/* 80059F3C 000234FC  38 60 01 80 */	li r3, 0x180
/* 80059F40 00023500  48 3D AB 41 */	bl fn_80434A80
/* 80059F44 00023504  38 00 00 02 */	li r0, 0x2
/* 80059F48 00023508  90 7E 00 1C */	stw r3, 0x1c(r30)
/* 80059F4C 0002350C  38 80 00 00 */	li r4, 0x0
...
/* 8005A028 000235E8  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 8005A058 00023618  2C 04 00 00 */	cmpwi r4, 0x0
...
/* 8005A094 00023654  93 C1 00 08 */	stw r30, 0x8(r1)
...
/* 8005A0A4 00023664  80 83 00 04 */	lwz r4, 0x4(r3)
/* 8005A0A8 00023668  38 A5 9C 78 */	addi r5, r5, __vt___reslist_base_CVirtualLightObj@l
/* 8005A0AC 0002366C  90 A3 00 00 */	stw r5, 0x0(r3)
/* 8005A0B0 00023670  38 00 00 00 */	li r0, 0x0
/* 8005A0B4 00023674  80 A4 00 00 */	lwz r5, 0x0(r4)
/* 8005A0B8 00023678  48 00 00 10 */	b .L_8005A0C8
.L_8005A0BC:
/* 8005A0BC 0002367C  7C A4 2B 78 */	mr r4, r5
/* 8005A0C0 00023680  80 A5 00 00 */	lwz r5, 0x0(r5)
/* 8005A0C4 00023684  90 04 00 00 */	stw r0, 0x0(r4)
.L_8005A0C8:
/* 8005A0C8 00023688  80 83 00 04 */	lwz r4, 0x4(r3)
/* 8005A0CC 0002368C  7C 05 20 40 */	cmplw r5, r4
/* 8005A0D0 00023690  40 82 FF EC */	bne .L_8005A0BC
/* 8005A0D4 00023694  90 84 00 00 */	stw r4, 0x0(r4)
/* 8005A0D8 00023698  80 83 00 04 */	lwz r4, 0x4(r3)
/* 8005A0DC 0002369C  90 84 00 04 */	stw r4, 0x4(r4)
/* 8005A0E0 000236A0  88 03 00 1C */	lbz r0, 0x1c(r3)
/* 8005A0E4 000236A4  2C 00 00 00 */	cmpwi r0, 0x0
/* 8005A0E8 000236A8  40 82 00 1C */	bne .L_8005A104
/* 8005A0EC 000236AC  80 63 00 14 */	lwz r3, 0x14(r3)
/* 8005A0F0 000236B0  2C 03 00 00 */	cmpwi r3, 0x0
/* 8005A0F4 000236B4  41 82 00 10 */	beq .L_8005A104
/* 8005A0F8 000236B8  48 3D AC E9 */	bl __dla__FPv
/* 8005A0FC 000236BC  38 00 00 00 */	li r0, 0x0
/* 8005A100 000236C0  90 1E 00 14 */	stw r0, 0x14(r30)
.L_8005A104:
/* 8005A104 000236C4  2C 1F 00 00 */	cmpwi r31, 0x0
...
/* 8005A11C 000236DC  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 8005A148 00023708  93 C1 00 08 */	stw r30, 0x8(r1)
...
/* 8005A15C 0002371C  80 83 00 04 */	lwz r4, 0x4(r3)
/* 8005A160 00023720  38 A5 9C 78 */	addi r5, r5, __vt___reslist_base_CVirtualLightObj@l
/* 8005A164 00023724  90 A3 00 00 */	stw r5, 0x0(r3)
/* 8005A168 00023728  38 00 00 00 */	li r0, 0x0
/* 8005A16C 0002372C  80 84 00 00 */	lwz r4, 0x0(r4)
/* 8005A170 00023730  48 00 00 10 */	b .L_8005A180
.L_8005A174:
/* 8005A174 00023734  7C 85 23 78 */	mr r5, r4
/* 8005A178 00023738  80 84 00 00 */	lwz r4, 0x0(r4)
/* 8005A17C 0002373C  90 05 00 00 */	stw r0, 0x0(r5)
.L_8005A180:
/* 8005A180 00023740  80 A3 00 04 */	lwz r5, 0x4(r3)
/* 8005A184 00023744  7C 04 28 40 */	cmplw r4, r5
/* 8005A188 00023748  40 82 FF EC */	bne .L_8005A174
/* 8005A18C 0002374C  90 A5 00 00 */	stw r5, 0x0(r5)
/* 8005A190 00023750  80 83 00 04 */	lwz r4, 0x4(r3)
/* 8005A194 00023754  90 84 00 04 */	stw r4, 0x4(r4)
/* 8005A198 00023758  88 03 00 1C */	lbz r0, 0x1c(r3)
/* 8005A19C 0002375C  2C 00 00 00 */	cmpwi r0, 0x0
/* 8005A1A0 00023760  40 82 00 1C */	bne .L_8005A1BC
/* 8005A1A4 00023764  80 63 00 14 */	lwz r3, 0x14(r3)
/* 8005A1A8 00023768  2C 03 00 00 */	cmpwi r3, 0x0
/* 8005A1AC 0002376C  41 82 00 10 */	beq .L_8005A1BC
/* 8005A1B0 00023770  48 3D AC 31 */	bl __dla__FPv
/* 8005A1B4 00023774  38 00 00 00 */	li r0, 0x0
/* 8005A1B8 00023778  90 1E 00 14 */	stw r0, 0x14(r30)
.L_8005A1BC:
/* 8005A1BC 0002377C  2C 1F 00 00 */	cmpwi r31, 0x0
...
/* 8005A1D4 00023794  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 8005A21C 000237DC  90 A3 00 00 */	stw r5, 0x0(r3)
/* 8005A220 000237E0  38 00 00 00 */	li r0, 0x0
/* 8005A224 000237E4  80 A4 00 00 */	lwz r5, 0x0(r4)
/* 8005A228 000237E8  48 00 00 10 */	b .L_8005A238
.L_8005A22C:
/* 8005A22C 000237EC  7C A4 2B 78 */	mr r4, r5
/* 8005A230 000237F0  80 A5 00 00 */	lwz r5, 0x0(r5)
/* 8005A234 000237F4  90 04 00 00 */	stw r0, 0x0(r4)
.L_8005A238:
...
/* 8005A244 00023804  90 84 00 00 */	stw r4, 0x0(r4)
/* 8005A248 00023808  37 A3 00 08 */	addic. r29, r3, 0x8
/* 8005A24C 0002380C  80 63 00 0C */	lwz r3, 0xc(r3)
/* 8005A250 00023810  90 63 00 04 */	stw r3, 0x4(r3)
...
/* 8005A260 00023820  80 7D 00 04 */	lwz r3, 0x4(r29)
/* 8005A264 00023824  38 84 9C 78 */	addi r4, r4, __vt___reslist_base_CVirtualLightObj@l
/* 8005A268 00023828  90 9D 00 00 */	stw r4, 0x0(r29)
/* 8005A26C 0002382C  38 00 00 00 */	li r0, 0x0
/* 8005A270 00023830  80 83 00 00 */	lwz r4, 0x0(r3)
/* 8005A274 00023834  48 00 00 10 */	b .L_8005A284
.L_8005A278:
/* 8005A278 00023838  7C 83 23 78 */	mr r3, r4
/* 8005A27C 0002383C  80 84 00 00 */	lwz r4, 0x0(r4)
/* 8005A280 00023840  90 03 00 00 */	stw r0, 0x0(r3)
.L_8005A284:
/* 8005A284 00023844  80 7D 00 04 */	lwz r3, 0x4(r29)
/* 8005A288 00023848  7C 04 18 40 */	cmplw r4, r3
/* 8005A28C 0002384C  40 82 FF EC */	bne .L_8005A278
/* 8005A290 00023850  90 63 00 00 */	stw r3, 0x0(r3)
/* 8005A294 00023854  80 7D 00 04 */	lwz r3, 0x4(r29)
/* 8005A298 00023858  90 63 00 04 */	stw r3, 0x4(r3)
/* 8005A29C 0002385C  88 1D 00 1C */	lbz r0, 0x1c(r29)
/* 8005A2A0 00023860  2C 00 00 00 */	cmpwi r0, 0x0
/* 8005A2A4 00023864  40 82 00 1C */	bne .L_8005A2C0
/* 8005A2A8 00023868  80 7D 00 14 */	lwz r3, 0x14(r29)
/* 8005A2AC 0002386C  2C 03 00 00 */	cmpwi r3, 0x0
/* 8005A2B0 00023870  41 82 00 10 */	beq .L_8005A2C0
/* 8005A2B4 00023874  48 3D AB 2D */	bl __dla__FPv
/* 8005A2B8 00023878  38 00 00 00 */	li r0, 0x0
/* 8005A2BC 0002387C  90 1D 00 14 */	stw r0, 0x14(r29)
.L_8005A2C0:
/* 8005A2C0 00023880  2C 1F 00 00 */	cmpwi r31, 0x0
...
/* 8005A33C 000238FC  34 65 00 08 */	addic. r3, r5, 0x8
/* 8005A340 00023900  41 82 00 0C */	beq .L_8005A34C
/* 8005A344 00023904  90 3F 00 1C */	stw r1, 0x1c(r31)
/* 8005A348 00023908  90 83 00 00 */	stw r4, 0x0(r3)
.L_8005A34C:
/* 8005A34C 0002390C  91 25 00 00 */	stw r9, 0x0(r5)
/* 8005A350 00023910  7F EA FB 78 */	mr r10, r31
/* 8005A354 00023914  80 09 00 04 */	lwz r0, 0x4(r9)
/* 8005A358 00023918  90 05 00 04 */	stw r0, 0x4(r5)
/* 8005A35C 0002391C  80 69 00 04 */	lwz r3, 0x4(r9)
/* 8005A360 00023920  90 A3 00 00 */	stw r5, 0x0(r3)
/* 8005A364 00023924  90 A9 00 04 */	stw r5, 0x4(r9)
/* 8005A368 00023928  83 FF 00 2C */	lwz r31, 0x2c(r31)
/* 8005A36C 0002392C  80 21 00 00 */	lwz r1, 0x0(r1)
...
/* 8005A3A0 00023960  D0 01 00 08 */	stfs f0, 0x8(r1)
/* 8005A3A4 00023964  81 24 00 00 */	lwz r9, 0x0(r4)
/* 8005A3A8 00023968  D0 81 00 0C */	stfs f4, 0xc(r1)
/* 8005A3AC 0002396C  80 E1 00 08 */	lwz r7, 0x8(r1)
...
.L_8005A3C4:
/* 8005A3C4 00023984  81 09 00 08 */	lwz r8, 0x8(r9)
/* 8005A3C8 00023988  88 08 00 19 */	lbz r0, 0x19(r8)
/* 8005A3CC 0002398C  2C 00 00 00 */	cmpwi r0, 0x0
...
.L_8005A3E4:
/* 8005A3E4 000239A4  81 29 00 00 */	lwz r9, 0x0(r9)
.L_8005A3E8:
