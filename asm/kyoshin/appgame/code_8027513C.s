...
/* 8027515C 0023E71C  38 00 00 01 */	li r0, 0x1
...
/* 8027517C 0023E73C  38 00 00 01 */	li r0, 0x1
...
/* 8027519C 0023E75C  38 00 00 01 */	li r0, 0x1
...
/* 80275210 0023E7D0  81 83 00 00 */	lwz r12, 0x0(r3)
...
/* 80275250 0023E810  81 83 00 00 */	lwz r12, 0x0(r3)
...
/* 80275290 0023E850  81 83 00 00 */	lwz r12, 0x0(r3)
...
/* 802752D0 0023E890  81 83 00 00 */	lwz r12, 0x0(r3)
...
/* 80275310 0023E8D0  81 83 00 00 */	lwz r12, 0x0(r3)
...
/* 80275350 0023E910  81 83 00 00 */	lwz r12, 0x0(r3)
...
/* 80275390 0023E950  81 83 00 00 */	lwz r12, 0x0(r3)
...
/* 802753D0 0023E990  81 83 00 00 */	lwz r12, 0x0(r3)
...
/* 8027540C 0023E9CC  93 C1 00 08 */	stw r30, 0x8(r1)
/* 80275410 0023E9D0  7C 7E 1B 78 */	mr r30, r3
/* 80275414 0023E9D4  80 A3 00 74 */	lwz r5, 0x74(r3)
/* 80275418 0023E9D8  2C 05 00 00 */	cmpwi r5, 0x0
...
/* 80275444 0023EA04  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 80275474 0023EA34  2C 1B 00 00 */	cmpwi r27, 0x0
/* 80275478 0023EA38  41 82 02 60 */	beq .L_802756D8
/* 8027547C 0023EA3C  80 1B 04 EC */	lwz r0, 0x4ec(r27)
/* 80275480 0023EA40  54 00 07 BD */	rlwinm. r0, r0, 0, 30, 30
/* 80275484 0023EA44  41 82 01 70 */	beq .L_802755F4
/* 80275488 0023EA48  80 83 00 6C */	lwz r4, 0x6c(r3)
/* 8027548C 0023EA4C  C0 02 AF 18 */	lfs f0, lbl_8066B298@sda21(r2)
/* 80275490 0023EA50  38 04 00 01 */	addi r0, r4, 0x1
...
/* 802754A4 0023EA64  81 85 00 00 */	lwz r12, 0x0(r5)
...
/* 802754C0 0023EA80  2C 04 00 00 */	cmpwi r4, 0x0
...
/* 802754D0 0023EA90  C0 02 AF 00 */	lfs f0, lbl_8066B280@sda21(r2)
...
/* 802754E8 0023EAA8  C0 02 AF 04 */	lfs f0, lbl_8066B284@sda21(r2)
...
/* 80275500 0023EAC0  2C 03 00 00 */	cmpwi r3, 0x0
/* 80275504 0023EAC4  7C 7D 1B 78 */	mr r29, r3
/* 80275508 0023EAC8  41 82 00 A0 */	beq .L_802755A8
/* 8027550C 0023EACC  C0 22 AF 08 */	lfs f1, lbl_8066B288@sda21(r2)
/* 80275510 0023EAD0  38 A1 00 34 */	addi r5, r1, 0x34
/* 80275514 0023EAD4  C0 02 AF 0C */	lfs f0, lbl_8066B28C@sda21(r2)
...
/* 80275524 0023EAE4  E0 5E 00 00 */	psq_l f2, 0x0(r30), 0, qr0
/* 80275528 0023EAE8  D0 01 00 38 */	stfs f0, 0x38(r1)
/* 8027552C 0023EAEC  E0 05 00 00 */	psq_l f0, 0x0(r5), 0, qr0
/* 80275530 0023EAF0  D0 21 00 3C */	stfs f1, 0x3c(r1)
/* 80275534 0023EAF4  10 22 00 2A */	ps_add f1, f2, f0
/* 80275538 0023EAF8  E0 5E 80 08 */	psq_l f2, 0x8(r30), 1, qr0
/* 8027553C 0023EAFC  E0 05 80 08 */	psq_l f0, 0x8(r5), 1, qr0
/* 80275540 0023EB00  F0 26 00 00 */	psq_st f1, 0x0(r6), 0, qr0
/* 80275544 0023EB04  10 22 00 2A */	ps_add f1, f2, f0
/* 80275548 0023EB08  C0 41 00 40 */	lfs f2, 0x40(r1)
/* 8027554C 0023EB0C  F0 26 80 08 */	psq_st f1, 0x8(r6), 1, qr0
...
/* 80275564 0023EB24  81 83 00 00 */	lwz r12, 0x0(r3)
...
/* 8027557C 0023EB3C  C0 02 AF 10 */	lfs f0, lbl_8066B290@sda21(r2)
...
/* 802755B8 0023EB78  C0 02 AF 10 */	lfs f0, lbl_8066B290@sda21(r2)
/* 802755BC 0023EB7C  7F C5 F3 78 */	mr r5, r30
/* 802755C0 0023EB80  C0 42 AF 14 */	lfs f2, lbl_8066B294@sda21(r2)
/* 802755C4 0023EB84  38 60 00 00 */	li r3, 0x0
...
/* 802755D8 0023EB98  2C 00 00 00 */	cmpwi r0, 0x0
/* 802755DC 0023EB9C  41 82 00 FC */	beq .L_802756D8
/* 802755E0 0023EBA0  C0 02 AF 1C */	lfs f0, lbl_8066B29C@sda21(r2)
/* 802755E4 0023EBA4  D0 1B 05 04 */	stfs f0, 0x504(r27)
/* 802755E8 0023EBA8  C0 02 AF 20 */	lfs f0, lbl_8066B2A0@sda21(r2)
...
/* 80275620 0023EBE0  2C 03 00 00 */	cmpwi r3, 0x0
/* 80275624 0023EBE4  7C 7C 1B 78 */	mr r28, r3
/* 80275628 0023EBE8  41 82 00 B0 */	beq .L_802756D8
/* 8027562C 0023EBEC  2C 1F 00 00 */	cmpwi r31, 0x0
...
/* 80275640 0023EC00  38 A0 00 00 */	li r5, 0x0
...
/* 802756AC 0023EC6C  C0 02 AF 10 */	lfs f0, lbl_8066B290@sda21(r2)
/* 802756B0 0023EC70  38 81 00 08 */	addi r4, r1, 0x8
/* 802756B4 0023EC74  80 A5 00 98 */	lwz r5, 0x98(r5)
/* 802756B8 0023EC78  C0 25 07 60 */	lfs f1, 0x760(r5)
/* 802756BC 0023EC7C  D0 21 00 08 */	stfs f1, 0x8(r1)
...
/* 80275738 0023ECF8  2C 03 00 00 */	cmpwi r3, 0x0
/* 8027573C 0023ECFC  7C 7F 1B 78 */	mr r31, r3
/* 80275740 0023ED00  41 82 00 B0 */	beq .L_802757F0
/* 80275744 0023ED04  2C 1E 00 00 */	cmpwi r30, 0x0
...
/* 80275758 0023ED18  38 A0 00 00 */	li r5, 0x0
...
/* 802757C4 0023ED84  C0 02 AF 10 */	lfs f0, lbl_8066B290@sda21(r2)
/* 802757C8 0023ED88  38 81 00 08 */	addi r4, r1, 0x8
/* 802757CC 0023ED8C  80 A5 00 98 */	lwz r5, 0x98(r5)
/* 802757D0 0023ED90  C0 25 07 60 */	lfs f1, 0x760(r5)
/* 802757D4 0023ED94  D0 21 00 08 */	stfs f1, 0x8(r1)
...
/* 80275808 0023EDC8  38 00 00 00 */	li r0, 0x0
/* 8027580C 0023EDCC  38 80 FF FF */	li r4, -0x1
...
/* 80275828 0023EDE8  2C 04 00 00 */	cmpwi r4, 0x0
/* 8027582C 0023EDEC  4D 82 00 20 */	beqlr
/* 80275830 0023EDF0  38 A0 00 00 */	li r5, 0x0
...
/* 80275868 0023EE28  28 00 00 02 */	cmplwi r0, 0x2
...
/* 80275958 0023EF18  38 00 00 00 */	li r0, 0x0
...
/* 80275970 0023EF30  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 80275984 0023EF44  2C 04 00 00 */	cmpwi r4, 0x0
