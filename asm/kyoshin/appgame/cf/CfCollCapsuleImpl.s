.include "macros.inc"
.file "kyoshin/appgame/cf/CfCollCapsuleImpl.o"
...
# 0x800AB2E4 - 0x800AB3D0
.text
.balign 4

.fn fn_800AB2E4, global
...
/* 800AB314 000748D4  2C 00 00 01 */	cmpwi r0, 0x1
...
.L_800AB354:
/* 800AB354 00074914  2C 00 00 06 */	cmpwi r0, 0x6
...
/* 800AB364 00074924  D0 61 00 08 */	stfs f3, 0x8(r1)
/* 800AB368 00074928  D0 21 00 0C */	stfs f1, 0xc(r1)
/* 800AB36C 0007492C  80 C1 00 08 */	lwz r6, 0x8(r1)
...
/* 800AB3A4 00074964  4B FF C2 51 */	bl fn_800A75F4
...
/* 800AB3CC 0007498C  4B FF 98 7C */	b fn_800A4C48
.endfn fn_800AB3B8
