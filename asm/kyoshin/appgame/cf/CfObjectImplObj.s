.include "macros.inc"
.file "kyoshin/appgame/cf/CfObjectImplObj.o"
...
/* 800CA500 00093AC0  48 00 04 49 */	bl fn_800CA948
/* 800CA504 00093AC4  81 9F 00 00 */	lwz r12, 0x0(r31)
...
/* 800CA520 00093AE0  48 09 16 1D */	bl fn_8015BB3C
...
/* 800CA5C4 00093B84  38 C0 FF FF */	li r6, -0x1
/* 800CA5C8 00093B88  38 03 FF D0 */	addi r0, r3, -0x30
/* 800CA5CC 00093B8C  54 00 06 3E */	clrlwi r0, r0, 24
/* 800CA5D0 00093B90  28 00 00 09 */	cmplwi r0, 0x9
...
/* 800CA5EC 00093BAC  38 A0 00 00 */	li r5, 0x0
/* 800CA5F0 00093BB0  38 E0 00 00 */	li r7, 0x0
/* 800CA5F4 00093BB4  81 83 00 00 */	lwz r12, 0x0(r3)
/* 800CA5F8 00093BB8  39 00 00 00 */	li r8, 0x0
...
/* 800CA618 00093BD8  38 C0 FF FF */	li r6, -0x1
/* 800CA61C 00093BDC  38 03 FF D0 */	addi r0, r3, -0x30
/* 800CA620 00093BE0  54 00 06 3E */	clrlwi r0, r0, 24
/* 800CA624 00093BE4  28 00 00 09 */	cmplwi r0, 0x9
...
/* 800CA640 00093C00  38 A0 00 00 */	li r5, 0x0
/* 800CA644 00093C04  38 E0 00 00 */	li r7, 0x0
/* 800CA648 00093C08  81 83 00 00 */	lwz r12, 0x0(r3)
/* 800CA64C 00093C0C  39 00 00 00 */	li r8, 0x0
...
/* 800CA688 00093C48  93 C1 00 08 */	stw r30, 0x8(r1)
/* 800CA68C 00093C4C  7C 7E 1B 78 */	mr r30, r3
/* 800CA690 00093C50  41 82 00 20 */	beq .L_800CA6B0
/* 800CA694 00093C54  38 80 FF FF */	li r4, -0x1
/* 800CA698 00093C58  38 63 03 68 */	addi r3, r3, 0x368
/* 800CA69C 00093C5C  48 0C 87 A5 */	bl fn_80192E40
/* 800CA6A0 00093C60  2C 1F 00 00 */	cmpwi r31, 0x0
...
/* 800CA6B8 00093C78  83 C1 00 08 */	lwz r30, 0x8(r1)
