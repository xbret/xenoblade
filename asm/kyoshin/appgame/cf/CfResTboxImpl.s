.include "macros.inc"
.file "kyoshin/appgame/cf/CfResTboxImpl.o"
...
# 0x801F8E34 - 0x801F92D8
.text
.balign 4

.fn fn_801F8E34, global
...
/* 801F8E48 001C2408  4B F7 39 A9 */	bl fn_8016C7F0
...
/* 801F8EC0 001C2480  F3 E1 00 78 */	psq_st f31, 0x78(r1), 0, qr0
...
/* 801F8ED4 001C2494  80 63 00 00 */	lwz r3, 0x0(r3)
/* 801F8ED8 001C2498  81 83 00 00 */	lwz r12, 0x0(r3)
...
/* 801F8EE8 001C24A8  80 7F 00 00 */	lwz r3, 0x0(r31)
/* 801F8EEC 001C24AC  81 83 00 00 */	lwz r12, 0x0(r3)
...
/* 801F8EFC 001C24BC  80 7F 00 00 */	lwz r3, 0x0(r31)
/* 801F8F00 001C24C0  38 00 00 00 */	li r0, 0x0
/* 801F8F04 001C24C4  90 03 00 90 */	stw r0, 0x90(r3)
/* 801F8F08 001C24C8  80 7F 00 00 */	lwz r3, 0x0(r31)
/* 801F8F0C 001C24CC  90 03 00 94 */	stw r0, 0x94(r3)
/* 801F8F10 001C24D0  4B E8 99 F1 */	bl fn_80082900
/* 801F8F14 001C24D4  2C 03 00 00 */	cmpwi r3, 0x0
/* 801F8F18 001C24D8  41 82 02 74 */	beq .L_801F918C
/* 801F8F1C 001C24DC  80 0D A5 A4 */	lwz r0, lbl_80666724@sda21(r13)
/* 801F8F20 001C24E0  54 00 02 D7 */	rlwinm. r0, r0, 0, 11, 11
/* 801F8F24 001C24E4  40 82 02 68 */	bne .L_801F918C
/* 801F8F28 001C24E8  4B E8 C9 35 */	bl fn_8008585C
/* 801F8F2C 001C24EC  2C 03 00 00 */	cmpwi r3, 0x0
/* 801F8F30 001C24F0  40 82 02 5C */	bne .L_801F918C
/* 801F8F34 001C24F4  4B E6 A1 4D */	bl fn_80063080
...
/* 801F8F44 001C2504  3B A0 00 01 */	li r29, 0x1
/* 801F8F48 001C2508  81 83 00 00 */	lwz r12, 0x0(r3)
/* 801F8F4C 001C250C  81 8C 00 40 */	lwz r12, 0x40(r12)
/* 801F8F50 001C2510  7D 89 03 A6 */	mtctr r12
/* 801F8F54 001C2514  4E 80 04 21 */	bctrl
/* 801F8F58 001C2518  2C 03 00 00 */	cmpwi r3, 0x0
/* 801F8F5C 001C251C  40 82 00 08 */	bne .L_801F8F64
/* 801F8F60 001C2520  3B A0 00 00 */	li r29, 0x0
.L_801F8F64:
/* 801F8F64 001C2524  2C 1D 00 00 */	cmpwi r29, 0x0
/* 801F8F68 001C2528  41 82 02 24 */	beq .L_801F918C
/* 801F8F6C 001C252C  A0 9F 00 08 */	lhz r4, 0x8(r31)
/* 801F8F70 001C2530  38 60 00 00 */	li r3, 0x0
/* 801F8F74 001C2534  38 04 00 01 */	addi r0, r4, 0x1
/* 801F8F78 001C2538  B0 1F 00 08 */	sth r0, 0x8(r31)
/* 801F8F7C 001C253C  48 23 BA D1 */	bl fn_80434A4C
/* 801F8F80 001C2540  80 7F 00 00 */	lwz r3, 0x0(r31)
/* 801F8F84 001C2544  80 03 00 6C */	lwz r0, 0x6c(r3)
/* 801F8F88 001C2548  54 00 06 B5 */	rlwinm. r0, r0, 0, 26, 26
/* 801F8F8C 001C254C  41 82 00 B4 */	beq .L_801F9040
/* 801F8F90 001C2550  80 03 00 98 */	lwz r0, 0x98(r3)
/* 801F8F94 001C2554  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 801F8FA4 001C2564  38 80 00 01 */	li r4, 0x1
...
/* 801F8FBC 001C257C  4B E6 DE C1 */	bl fn_80066E7C
/* 801F8FC0 001C2580  80 DF 00 00 */	lwz r6, 0x0(r31)
/* 801F8FC4 001C2584  38 A1 00 0C */	addi r5, r1, 0xc
/* 801F8FC8 001C2588  38 80 00 00 */	li r4, 0x0
/* 801F8FCC 001C258C  90 66 00 90 */	stw r3, 0x90(r6)
/* 801F8FD0 001C2590  80 7F 00 00 */	lwz r3, 0x0(r31)
/* 801F8FD4 001C2594  80 63 00 90 */	lwz r3, 0x90(r3)
/* 801F8FD8 001C2598  4B E6 91 3D */	bl fn_80062114
/* 801F8FDC 001C259C  80 9F 00 00 */	lwz r4, 0x0(r31)
/* 801F8FE0 001C25A0  90 64 00 90 */	stw r3, 0x90(r4)
/* 801F8FE4 001C25A4  80 7F 00 00 */	lwz r3, 0x0(r31)
/* 801F8FE8 001C25A8  81 83 00 00 */	lwz r12, 0x0(r3)
/* 801F8FEC 001C25AC  81 8C 00 E0 */	lwz r12, 0xe0(r12)
/* 801F8FF0 001C25B0  7D 89 03 A6 */	mtctr r12
/* 801F8FF4 001C25B4  4E 80 04 21 */	bctrl
/* 801F8FF8 001C25B8  80 9F 00 00 */	lwz r4, 0x0(r31)
/* 801F8FFC 001C25BC  FF E0 08 90 */	fmr f31, f1
/* 801F9000 001C25C0  80 6D A5 94 */	lwz r3, lbl_80666714@sda21(r13)
/* 801F9004 001C25C4  38 A0 00 06 */	li r5, 0x6
/* 801F9008 001C25C8  80 84 00 90 */	lwz r4, 0x90(r4)
/* 801F900C 001C25CC  38 C0 00 01 */	li r6, 0x1
/* 801F9010 001C25D0  38 E0 00 00 */	li r7, 0x0
/* 801F9014 001C25D4  39 00 00 70 */	li r8, 0x70
/* 801F9018 001C25D8  48 29 0A 49 */	bl fn_80489A60
/* 801F901C 001C25DC  7C 64 1B 78 */	mr r4, r3
/* 801F9020 001C25E0  80 7F 00 00 */	lwz r3, 0x0(r31)
/* 801F9024 001C25E4  4B EC 2A B9 */	bl fn_800BBADC
/* 801F9028 001C25E8  80 7F 00 00 */	lwz r3, 0x0(r31)
/* 801F902C 001C25EC  FC 20 F8 90 */	fmr f1, f31
/* 801F9030 001C25F0  81 83 00 00 */	lwz r12, 0x0(r3)
/* 801F9034 001C25F4  81 8C 00 DC */	lwz r12, 0xdc(r12)
/* 801F9038 001C25F8  7D 89 03 A6 */	mtctr r12
/* 801F903C 001C25FC  4E 80 04 21 */	bctrl
.L_801F9040:
/* 801F9040 001C2600  80 7F 00 00 */	lwz r3, 0x0(r31)
/* 801F9044 001C2604  80 03 00 6C */	lwz r0, 0x6c(r3)
/* 801F9048 001C2608  54 00 06 F7 */	rlwinm. r0, r0, 0, 27, 27
/* 801F904C 001C260C  41 82 00 AC */	beq .L_801F90F8
/* 801F9050 001C2610  38 00 00 00 */	li r0, 0x0
...
/* 801F9060 001C2620  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 801F9070 001C2630  38 80 00 00 */	li r4, 0x0
...
/* 801F9088 001C2648  38 A0 00 00 */	li r5, 0x0
/* 801F908C 001C264C  38 C0 00 00 */	li r6, 0x0
/* 801F9090 001C2650  4B EB 12 AD */	bl fn_800AA33C
/* 801F9094 001C2654  81 9F 00 10 */	lwz r12, 0x10(r31)
/* 801F9098 001C2658  7F E3 FB 78 */	mr r3, r31
/* 801F909C 001C265C  38 80 00 01 */	li r4, 0x1
...
/* 801F90B4 001C2674  4B E6 DD C9 */	bl fn_80066E7C
/* 801F90B8 001C2678  80 DF 00 00 */	lwz r6, 0x0(r31)
/* 801F90BC 001C267C  38 A1 00 08 */	addi r5, r1, 0x8
/* 801F90C0 001C2680  38 80 00 01 */	li r4, 0x1
/* 801F90C4 001C2684  90 66 00 94 */	stw r3, 0x94(r6)
/* 801F90C8 001C2688  80 7F 00 00 */	lwz r3, 0x0(r31)
/* 801F90CC 001C268C  80 63 00 94 */	lwz r3, 0x94(r3)
/* 801F90D0 001C2690  4B E6 90 45 */	bl fn_80062114
/* 801F90D4 001C2694  80 9F 00 00 */	lwz r4, 0x0(r31)
/* 801F90D8 001C2698  90 64 00 94 */	stw r3, 0x94(r4)
/* 801F90DC 001C269C  4B E6 8E FD */	bl fn_80061FD8
/* 801F90E0 001C26A0  80 9F 00 00 */	lwz r4, 0x0(r31)
/* 801F90E4 001C26A4  38 A1 00 10 */	addi r5, r1, 0x10
/* 801F90E8 001C26A8  80 84 00 94 */	lwz r4, 0x94(r4)
/* 801F90EC 001C26AC  4B E5 F3 CD */	bl fn_800584B8
/* 801F90F0 001C26B0  80 9F 00 00 */	lwz r4, 0x0(r31)
/* 801F90F4 001C26B4  90 64 00 9C */	stw r3, 0x9c(r4)
.L_801F90F8:
/* 801F90F8 001C26B8  38 60 00 01 */	li r3, 0x1
/* 801F90FC 001C26BC  48 23 B9 51 */	bl fn_80434A4C
/* 801F9100 001C26C0  80 7F 00 00 */	lwz r3, 0x0(r31)
...
/* 801F9120 001C26E0  80 7F 00 00 */	lwz r3, 0x0(r31)
/* 801F9124 001C26E4  81 83 00 00 */	lwz r12, 0x0(r3)
...
/* 801F9134 001C26F4  80 7F 00 00 */	lwz r3, 0x0(r31)
/* 801F9138 001C26F8  C0 22 A7 14 */	lfs f1, lbl_8066AA94@sda21(r2)
/* 801F913C 001C26FC  4B EC 32 75 */	bl fn_800BC3B0
.L_801F9140:
/* 801F9140 001C2700  80 7F 00 00 */	lwz r3, 0x0(r31)
/* 801F9144 001C2704  4B EC 3E 5D */	bl fn_800BCFA0
/* 801F9148 001C2708  80 7F 00 00 */	lwz r3, 0x0(r31)
/* 801F914C 001C270C  80 63 00 38 */	lwz r3, 0x38(r3)
/* 801F9150 001C2710  2C 03 00 00 */	cmpwi r3, 0x0
/* 801F9154 001C2714  41 82 00 14 */	beq .L_801F9168
/* 801F9158 001C2718  81 83 00 00 */	lwz r12, 0x0(r3)
/* 801F915C 001C271C  81 8C 00 B0 */	lwz r12, 0xb0(r12)
/* 801F9160 001C2720  7D 89 03 A6 */	mtctr r12
/* 801F9164 001C2724  4E 80 04 21 */	bctrl
.L_801F9168:
/* 801F9168 001C2728  80 7F 00 00 */	lwz r3, 0x0(r31)
/* 801F916C 001C272C  80 63 00 98 */	lwz r3, 0x98(r3)
/* 801F9170 001C2730  2C 03 00 00 */	cmpwi r3, 0x0
/* 801F9174 001C2734  41 82 00 18 */	beq .L_801F918C
/* 801F9178 001C2738  81 83 00 00 */	lwz r12, 0x0(r3)
/* 801F917C 001C273C  38 80 00 01 */	li r4, 0x1
...
/* 801F9190 001C2750  E3 E1 00 78 */	psq_l f31, 0x78(r1), 0, qr0
...
.fn fn_801F91B0, global
/* 801F91B0 001C2770  4E 80 00 20 */	blr
.endfn fn_801F91B0

.fn fn_801F91B4, global
...
/* 801F91DC 001C279C  80 A4 00 04 */	lwz r5, 0x4(r4)
/* 801F91E0 001C27A0  38 00 00 01 */	li r0, 0x1
/* 801F91E4 001C27A4  80 84 00 08 */	lwz r4, 0x8(r4)
/* 801F91E8 001C27A8  90 A7 00 04 */	stw r5, 0x4(r7)
/* 801F91EC 001C27AC  90 87 00 08 */	stw r4, 0x8(r7)
/* 801F91F0 001C27B0  98 0D AD D0 */	stb r0, lbl_80666F50@sda21(r13)
.L_801F91F4:
/* 801F91F4 001C27B4  A0 03 00 08 */	lhz r0, 0x8(r3)
/* 801F91F8 001C27B8  28 00 00 03 */	cmplwi r0, 0x3
...
/* 801F9244 001C2804  2C 04 00 00 */	cmpwi r4, 0x0
...
/* 801F9280 001C2840  54 03 0F FE */	srwi r3, r0, 31
/* 801F9284 001C2844  4E 80 00 20 */	blr
.endfn fn_801F9268

.fn fn_801F9288, global
...
/* 801F92A0 001C2860  88 03 00 01 */	lbz r0, 0x1(r3)
/* 801F92A4 001C2864  60 00 00 80 */	ori r0, r0, 0x80
/* 801F92A8 001C2868  98 03 00 01 */	stb r0, 0x1(r3)
/* 801F92AC 001C286C  4E 80 00 20 */	blr
.endfn fn_801F9288

.fn fn_801F92B0, global
...
/* 801F92C8 001C2888  88 03 00 01 */	lbz r0, 0x1(r3)
/* 801F92CC 001C288C  60 00 00 40 */	ori r0, r0, 0x40
/* 801F92D0 001C2890  98 03 00 01 */	stb r0, 0x1(r3)
...
.balign 8
.sym lbl_80666F50, global
	.skip 0x8

# 0x8066AA90 - 0x8066AA98
.section .sdata2, "a"
.balign 8
.sym lbl_8066AA90, global
	.4byte 0x3F800000
.sym lbl_8066AA94, global
	.4byte 0x41A00000
