.include "macros.inc"
.file "kyoshin/appgame/cf/CfGimmickSaveOff.o"
...
/* 802ABBB0 00275170  4B F5 D4 71 */	bl fn_80209020
...
/* 802ABBC4 00275184  4B F5 D6 C5 */	bl fn_80209288
...
/* 802ABBDC 0027519C  4B D8 EF 6D */	bl fn_8003AB48
...
/* 802ABBF8 002751B8  4B D8 EF 51 */	bl fn_8003AB48
...
/* 802ABC18 002751D8  4B D8 EF 31 */	bl fn_8003AB48
/* 802ABC1C 002751DC  90 61 00 08 */	stw r3, 0x8(r1)
/* 802ABC20 002751E0  7F A3 EB 78 */	mr r3, r29
/* 802ABC24 002751E4  88 01 00 08 */	lbz r0, 0x8(r1)
/* 802ABC28 002751E8  90 1D 00 84 */	stw r0, 0x84(r29)
/* 802ABC2C 002751EC  81 9D 00 00 */	lwz r12, 0x0(r29)
...
/* 802ABC74 00275234  93 C1 00 08 */	stw r30, 0x8(r1)
/* 802ABC78 00275238  7C 7E 1B 78 */	mr r30, r3
/* 802ABC7C 0027523C  41 82 00 1C */	beq .L_802ABC98
/* 802ABC80 00275240  38 80 00 00 */	li r4, 0x0
/* 802ABC84 00275244  4B F5 CC A9 */	bl fn_8020892C
/* 802ABC88 00275248  2C 1F 00 00 */	cmpwi r31, 0x0
...
/* 802ABCA0 00275260  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 802ABCC4 00275284  93 C1 00 08 */	stw r30, 0x8(r1)
/* 802ABCC8 00275288  7C 7E 1B 78 */	mr r30, r3
/* 802ABCCC 0027528C  A0 03 00 6E */	lhz r0, 0x6e(r3)
/* 802ABCD0 00275290  2C 00 00 00 */	cmpwi r0, 0x0
/* 802ABCD4 00275294  41 82 00 24 */	beq .L_802ABCF8
/* 802ABCD8 00275298  4B DD 66 1D */	bl fn_800822F4
...
/* 802ABD18 002752D8  38 BE 00 04 */	addi r5, r30, 0x4
/* 802ABD1C 002752DC  7D 89 03 A6 */	mtctr r12
/* 802ABD20 002752E0  4E 80 04 21 */	bctrl
/* 802ABD24 002752E4  2C 03 00 00 */	cmpwi r3, 0x0
/* 802ABD28 002752E8  41 82 00 70 */	beq .L_802ABD98
/* 802ABD2C 002752EC  80 1E 00 84 */	lwz r0, 0x84(r30)
/* 802ABD30 002752F0  2C 00 00 02 */	cmpwi r0, 0x2
/* 802ABD34 002752F4  40 82 00 50 */	bne .L_802ABD84
/* 802ABD38 002752F8  4B E0 AE 91 */	bl fn_800B6BC8
/* 802ABD3C 002752FC  80 83 00 04 */	lwz r4, 0x4(r3)
/* 802ABD40 00275300  7C 7F 1B 78 */	mr r31, r3
/* 802ABD44 00275304  83 C4 00 00 */	lwz r30, 0x0(r4)
/* 802ABD48 00275308  48 00 00 2C */	b .L_802ABD74
.L_802ABD4C:
/* 802ABD4C 0027530C  80 7E 00 08 */	lwz r3, 0x8(r30)
/* 802ABD50 00275310  81 83 00 00 */	lwz r12, 0x0(r3)
...
/* 802ABD60 00275320  2C 03 00 00 */	cmpwi r3, 0x0
/* 802ABD64 00275324  41 82 00 0C */	beq .L_802ABD70
/* 802ABD68 00275328  38 63 00 84 */	addi r3, r3, 0x84
/* 802ABD6C 0027532C  4B DD FB F1 */	bl fn_8008B95C
.L_802ABD70:
/* 802ABD70 00275330  83 DE 00 00 */	lwz r30, 0x0(r30)
.L_802ABD74:
/* 802ABD74 00275334  80 1F 00 04 */	lwz r0, 0x4(r31)
...
.L_802ABD84:
/* 802ABD84 00275344  2C 00 00 01 */	cmpwi r0, 0x1
/* 802ABD88 00275348  40 82 00 0C */	bne .L_802ABD94
/* 802ABD8C 0027534C  4B F5 E2 B1 */	bl fn_8020A03C
/* 802ABD90 00275350  48 00 00 08 */	b .L_802ABD98
.L_802ABD94:
/* 802ABD94 00275354  4B F5 E3 39 */	bl fn_8020A0CC
.L_802ABD98:
/* 802ABD98 00275358  80 01 00 14 */	lwz r0, 0x14(r1)
/* 802ABD9C 0027535C  83 E1 00 0C */	lwz r31, 0xc(r1)
/* 802ABDA0 00275360  83 C1 00 08 */	lwz r30, 0x8(r1)
