.include "macros.inc"
.file "kyoshin/appgame/cf/CfResTask.o"

# 0x80007C44 - 0x80007C78
.section extab, "a"
.balign 4
...
# 0x80065848 - 0x800659C4
.text
.balign 4

.fn fn_80065848, global
/* 80065848 0002EE08  94 21 FF F0 */	stwu r1, -0x10(r1)
/* 8006584C 0002EE0C  7C 08 02 A6 */	mflr r0
/* 80065850 0002EE10  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 80065860 0002EE20  93 C1 00 08 */	stw r30, 0x8(r1)
/* 80065864 0002EE24  7C 7E 1B 78 */	mr r30, r3
/* 80065868 0002EE28  41 82 00 1C */	beq .L_80065884
/* 8006586C 0002EE2C  38 80 00 00 */	li r4, 0x0
/* 80065870 0002EE30  48 3D F2 C9 */	bl fn_80444B38
/* 80065874 0002EE34  2C 1F 00 00 */	cmpwi r31, 0x0
...
/* 8006588C 0002EE4C  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 800658B8 0002EE78  93 C1 00 08 */	stw r30, 0x8(r1)
/* 800658BC 0002EE7C  7C 7E 1B 78 */	mr r30, r3
/* 800658C0 0002EE80  41 82 00 20 */	beq .L_800658E0
/* 800658C4 0002EE84  38 80 FF FF */	li r4, -0x1
/* 800658C8 0002EE88  38 63 00 04 */	addi r3, r3, 0x4
/* 800658CC 0002EE8C  48 00 1C 81 */	bl fn_8006754C
/* 800658D0 0002EE90  2C 1F 00 00 */	cmpwi r31, 0x0
...
/* 800658E8 0002EEA8  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 80065914 0002EED4  93 C1 00 08 */	stw r30, 0x8(r1)
...
/* 80065928 0002EEE8  38 63 00 04 */	addi r3, r3, 0x4
/* 8006592C 0002EEEC  38 80 FF FF */	li r4, -0x1
/* 80065930 0002EEF0  48 00 1C 1D */	bl fn_8006754C
.L_80065934:
/* 80065934 0002EEF4  2C 1E 00 00 */	cmpwi r30, 0x0
/* 80065938 0002EEF8  41 82 00 10 */	beq .L_80065948
/* 8006593C 0002EEFC  7F C3 F3 78 */	mr r3, r30
/* 80065940 0002EF00  38 80 00 00 */	li r4, 0x0
/* 80065944 0002EF04  48 3D F1 F5 */	bl fn_80444B38
.L_80065948:
/* 80065948 0002EF08  2C 1F 00 00 */	cmpwi r31, 0x0
...
/* 80065960 0002EF20  83 C1 00 08 */	lwz r30, 0x8(r1)
...
.fn fn_80065974, global
/* 80065974 0002EF34  4E 80 00 20 */	blr
.endfn fn_80065974

.fn fn_80065978, global
...
/* 80065990 0002EF50  48 00 23 A9 */	bl fn_80067D38
/* 80065994 0002EF54  38 7F 00 54 */	addi r3, r31, 0x54
/* 80065998 0002EF58  4B FF D7 C1 */	bl fn_80063158
/* 8006599C 0002EF5C  38 00 00 00 */	li r0, 0x0
