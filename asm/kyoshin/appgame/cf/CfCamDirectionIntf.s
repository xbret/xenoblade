.include "macros.inc"
.file "kyoshin/appgame/cf/CfCamDirectionIntf.o"

# 0x80008088 - 0x80008098
.section extab, "a"
.balign 4
...
/* 8006B3F0 000349B0  80 C5 00 00 */	lwz r6, 0x0(r5)
/* 8006B3F4 000349B4  80 65 00 04 */	lwz r3, 0x4(r5)
/* 8006B3F8 000349B8  80 05 00 08 */	lwz r0, 0x8(r5)
...
/* 8006B424 000349E4  38 61 00 08 */	addi r3, r1, 0x8
...
/* 8006B440 00034A00  48 00 94 C1 */	bl fn_80074900
/* 8006B444 00034A04  80 61 00 08 */	lwz r3, 0x8(r1)
...
/* 8006B45C 00034A1C  80 7F 00 00 */	lwz r3, 0x0(r31)
/* 8006B460 00034A20  80 1F 00 04 */	lwz r0, 0x4(r31)
/* 8006B464 00034A24  90 1E 02 60 */	stw r0, 0x260(r30)
/* 8006B468 00034A28  90 7E 02 5C */	stw r3, 0x25c(r30)
/* 8006B46C 00034A2C  80 1F 00 08 */	lwz r0, 0x8(r31)
...
/* 8006B4A4 00034A64  38 A1 00 08 */	addi r5, r1, 0x8
...
/* 8006B4B4 00034A74  48 00 94 F9 */	bl fn_800749AC
/* 8006B4B8 00034A78  C0 02 87 70 */	lfs f0, lbl_80668AF0@sda21(r2)
/* 8006B4BC 00034A7C  D0 01 00 10 */	stfs f0, 0x10(r1)
/* 8006B4C0 00034A80  80 9F 00 00 */	lwz r4, 0x0(r31)
/* 8006B4C4 00034A84  80 7F 00 04 */	lwz r3, 0x4(r31)
/* 8006B4C8 00034A88  80 1F 00 08 */	lwz r0, 0x8(r31)
...
/* 8006B4D8 00034A98  80 61 00 08 */	lwz r3, 0x8(r1)
