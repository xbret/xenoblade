.include "macros.inc"
.file "kyoshin/appgame/cf/voice/cvs/CVS_THREAD_TENSION_UP.o"

# 0x8001AEDC - 0x8001AF28
.section extab, "a"
.balign 4
...
/* 802A8E14 002723D4  54 00 07 BD */	rlwinm. r0, r0, 0, 30, 30
/* 802A8E18 002723D8  40 82 00 0C */	bne .L_802A8E24
/* 802A8E1C 002723DC  38 60 00 00 */	li r3, 0x0
/* 802A8E20 002723E0  48 00 00 A4 */	b .L_802A8EC4
.L_802A8E24:
/* 802A8E24 002723E4  2C 04 00 03 */	cmpwi r4, 0x3
/* 802A8E28 002723E8  40 80 00 0C */	bge .L_802A8E34
/* 802A8E2C 002723EC  38 60 00 00 */	li r3, 0x0
/* 802A8E30 002723F0  48 00 00 94 */	b .L_802A8EC4
.L_802A8E34:
/* 802A8E34 002723F4  38 60 00 82 */	li r3, 0x82
/* 802A8E38 002723F8  38 80 00 01 */	li r4, 0x1
/* 802A8E3C 002723FC  4B FF A4 D1 */	bl fn_802A330C
/* 802A8E40 00272400  2C 03 00 00 */	cmpwi r3, 0x0
/* 802A8E44 00272404  40 82 00 0C */	bne .L_802A8E50
/* 802A8E48 00272408  38 60 00 00 */	li r3, 0x0
/* 802A8E4C 0027240C  48 00 00 78 */	b .L_802A8EC4
.L_802A8E50:
/* 802A8E50 00272410  38 60 00 28 */	li r3, 0x28
/* 802A8E54 00272414  4B FF A6 91 */	bl fn_802A34E4
/* 802A8E58 00272418  2C 03 00 00 */	cmpwi r3, 0x0
/* 802A8E5C 0027241C  7C 7E 1B 78 */	mr r30, r3
/* 802A8E60 00272420  40 82 00 0C */	bne .L_802A8E6C
/* 802A8E64 00272424  38 60 00 00 */	li r3, 0x0
...
/* 802A8E74 00272434  4B FF AC 0D */	bl fn_802A3A80
...
/* 802A8E90 00272450  38 60 00 00 */	li r3, 0x0
/* 802A8E94 00272454  38 80 00 00 */	li r4, 0x0
/* 802A8E98 00272458  38 A0 00 00 */	li r5, 0x0
...
/* 802A8EAC 0027246C  80 05 00 04 */	lwz r0, 0x4(r5)
/* 802A8EB0 00272470  80 85 00 00 */	lwz r4, 0x0(r5)
/* 802A8EB4 00272474  90 9E 00 00 */	stw r4, 0x0(r30)
/* 802A8EB8 00272478  90 1E 00 04 */	stw r0, 0x4(r30)
/* 802A8EBC 0027247C  80 05 00 08 */	lwz r0, 0x8(r5)
/* 802A8EC0 00272480  90 1E 00 08 */	stw r0, 0x8(r30)
.L_802A8EC4:
...
/* 802A8ED8 00272498  81 41 00 00 */	lwz r10, 0x0(r1)
/* 802A8EDC 0027249C  80 0A 00 04 */	lwz r0, 0x4(r10)
...
/* 802A8F0C 002724CC  80 05 00 04 */	lwz r0, 0x4(r5)
/* 802A8F10 002724D0  90 03 00 04 */	stw r0, 0x4(r3)
/* 802A8F14 002724D4  2C 06 00 00 */	cmpwi r6, 0x0
/* 802A8F18 002724D8  90 83 00 00 */	stw r4, 0x0(r3)
/* 802A8F1C 002724DC  80 05 00 08 */	lwz r0, 0x8(r5)
/* 802A8F20 002724E0  90 03 00 08 */	stw r0, 0x8(r3)
/* 802A8F24 002724E4  41 82 00 E4 */	beq .L_802A9008
/* 802A8F28 002724E8  81 86 00 00 */	lwz r12, 0x0(r6)
...
/* 802A8F68 00272528  4B FF AC DD */	bl fn_802A3C44
/* 802A8F6C 0027252C  2C 03 00 00 */	cmpwi r3, 0x0
/* 802A8F70 00272530  40 82 00 AC */	bne .L_802A901C
.L_802A8F74:
/* 802A8F74 00272534  80 1F 00 24 */	lwz r0, 0x24(r31)
/* 802A8F78 00272538  2C 00 00 03 */	cmpwi r0, 0x3
/* 802A8F7C 0027253C  40 82 00 8C */	bne .L_802A9008
/* 802A8F80 00272540  80 7F 00 20 */	lwz r3, 0x20(r31)
/* 802A8F84 00272544  4B FF E8 65 */	bl fn_802A77E8
/* 802A8F88 00272548  2C 03 00 04 */	cmpwi r3, 0x4
/* 802A8F8C 0027254C  41 82 00 0C */	beq .L_802A8F98
/* 802A8F90 00272550  38 00 00 00 */	li r0, 0x0
/* 802A8F94 00272554  48 00 00 20 */	b .L_802A8FB4
.L_802A8F98:
/* 802A8F98 00272558  4B DD 93 5D */	bl fn_800822F4
/* 802A8F9C 0027255C  20 03 00 03 */	subfic r0, r3, 0x3
/* 802A8FA0 00272560  38 80 00 03 */	li r4, 0x3
...
/* 802A8FB0 00272570  54 00 0F FE */	srwi r0, r0, 31
.L_802A8FB4:
/* 802A8FB4 00272574  2C 00 00 00 */	cmpwi r0, 0x0
/* 802A8FB8 00272578  41 82 00 2C */	beq .L_802A8FE4
/* 802A8FBC 0027257C  80 9F 00 20 */	lwz r4, 0x20(r31)
/* 802A8FC0 00272580  2C 04 00 00 */	cmpwi r4, 0x0
...
/* 802A8FD4 00272594  4B FF AC 71 */	bl fn_802A3C44
/* 802A8FD8 00272598  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 802A8FE8 002725A8  2C 04 00 00 */	cmpwi r4, 0x0
...
/* 802A8FFC 002725BC  4B FF AC 49 */	bl fn_802A3C44
/* 802A9000 002725C0  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 802A9010 002725D0  81 8C 00 08 */	lwz r12, 0x8(r12)
...
/* 802A904C 0027260C  4B FF AE 3D */	bl fn_802A3E88
/* 802A9050 00272610  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 802A9064 00272624  80 05 00 04 */	lwz r0, 0x4(r5)
/* 802A9068 00272628  90 1D 00 04 */	stw r0, 0x4(r29)
/* 802A906C 0027262C  90 9D 00 00 */	stw r4, 0x0(r29)
/* 802A9070 00272630  80 05 00 08 */	lwz r0, 0x8(r5)
/* 802A9074 00272634  90 1D 00 08 */	stw r0, 0x8(r29)
/* 802A9078 00272638  4B FF E9 21 */	bl fn_802A7998
/* 802A907C 0027263C  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 802A908C 0027264C  4B FF E7 5D */	bl fn_802A77E8
/* 802A9090 00272650  2C 03 00 01 */	cmpwi r3, 0x1
/* 802A9094 00272654  41 82 00 38 */	beq .L_802A90CC
/* 802A9098 00272658  2C 03 00 02 */	cmpwi r3, 0x2
/* 802A909C 0027265C  41 82 00 4C */	beq .L_802A90E8
/* 802A90A0 00272660  2C 03 00 03 */	cmpwi r3, 0x3
/* 802A90A4 00272664  41 82 00 60 */	beq .L_802A9104
/* 802A90A8 00272668  2C 03 00 04 */	cmpwi r3, 0x4
/* 802A90AC 0027266C  41 82 00 74 */	beq .L_802A9120
/* 802A90B0 00272670  2C 03 00 05 */	cmpwi r3, 0x5
/* 802A90B4 00272674  41 82 00 88 */	beq .L_802A913C
/* 802A90B8 00272678  2C 03 00 06 */	cmpwi r3, 0x6
/* 802A90BC 0027267C  41 82 00 9C */	beq .L_802A9158
/* 802A90C0 00272680  2C 03 00 07 */	cmpwi r3, 0x7
/* 802A90C4 00272684  41 82 00 B0 */	beq .L_802A9174
/* 802A90C8 00272688  48 00 00 C8 */	b .L_802A9190
.L_802A90CC:
/* 802A90CC 0027268C  38 60 00 02 */	li r3, 0x2
/* 802A90D0 00272690  48 18 CE 2D */	bl mtRand__2mlFi
/* 802A90D4 00272694  2C 03 00 00 */	cmpwi r3, 0x0
...
.L_802A90E8:
/* 802A90E8 002726A8  38 60 00 02 */	li r3, 0x2
/* 802A90EC 002726AC  48 18 CE 11 */	bl mtRand__2mlFi
/* 802A90F0 002726B0  2C 03 00 00 */	cmpwi r3, 0x0
...
.L_802A9104:
/* 802A9104 002726C4  38 60 00 02 */	li r3, 0x2
/* 802A9108 002726C8  48 18 CD F5 */	bl mtRand__2mlFi
/* 802A910C 002726CC  2C 03 00 00 */	cmpwi r3, 0x0
...
.L_802A9120:
/* 802A9120 002726E0  38 60 00 02 */	li r3, 0x2
/* 802A9124 002726E4  48 18 CD D9 */	bl mtRand__2mlFi
/* 802A9128 002726E8  2C 03 00 00 */	cmpwi r3, 0x0
...
.L_802A913C:
/* 802A913C 002726FC  38 60 00 02 */	li r3, 0x2
/* 802A9140 00272700  48 18 CD BD */	bl mtRand__2mlFi
/* 802A9144 00272704  2C 03 00 00 */	cmpwi r3, 0x0
...
.L_802A9158:
/* 802A9158 00272718  38 60 00 02 */	li r3, 0x2
/* 802A915C 0027271C  48 18 CD A1 */	bl mtRand__2mlFi
/* 802A9160 00272720  2C 03 00 00 */	cmpwi r3, 0x0
...
.L_802A9174:
/* 802A9174 00272734  38 60 00 02 */	li r3, 0x2
/* 802A9178 00272738  48 18 CD 85 */	bl mtRand__2mlFi
/* 802A917C 0027273C  2C 03 00 00 */	cmpwi r3, 0x0
...
.L_802A9190:
/* 802A9190 00272750  3B C0 FF FF */	li r30, -0x1
.L_802A9194:
...
/* 802A91A4 00272764  4B FF E9 ED */	bl fn_802A7B90
/* 802A91A8 00272768  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 802A91C4 00272784  4B FF E9 CD */	bl fn_802A7B90
/* 802A91C8 00272788  2C 03 00 00 */	cmpwi r3, 0x0
/* 802A91CC 0027278C  41 82 00 08 */	beq .L_802A91D4
/* 802A91D0 00272790  3B C0 04 51 */	li r30, 0x451
.L_802A91D4:
/* 802A91D4 00272794  2C 1E 00 00 */	cmpwi r30, 0x0
/* 802A91D8 00272798  40 81 00 28 */	ble .L_802A9200
/* 802A91DC 0027279C  2C 1F 00 00 */	cmpwi r31, 0x0
...
/* 802A91F4 002727B4  4B FF AA 51 */	bl fn_802A3C44
/* 802A91F8 002727B8  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 802A9208 002727C8  81 8C 00 08 */	lwz r12, 0x8(r12)
...
/* 802A9244 00272804  4B FF AC 45 */	bl fn_802A3E88
/* 802A9248 00272808  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 802A9258 00272818  81 8C 00 08 */	lwz r12, 0x8(r12)
...
/* 802A928C 0027284C  93 C1 00 08 */	stw r30, 0x8(r1)
/* 802A9290 00272850  7C 7E 1B 78 */	mr r30, r3
/* 802A9294 00272854  4B FF A9 59 */	bl fn_802A3BEC
/* 802A9298 00272858  80 7E 00 20 */	lwz r3, 0x20(r30)
/* 802A929C 0027285C  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 802A92B0 00272870  38 00 00 00 */	li r0, 0x0
...
/* 802A92C0 00272880  83 C1 00 08 */	lwz r30, 0x8(r1)
