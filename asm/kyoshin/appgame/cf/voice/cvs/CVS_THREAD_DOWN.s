.include "macros.inc"
.file "kyoshin/appgame/cf/voice/cvs/CVS_THREAD_DOWN.o"

# 0x8001ABE4 - 0x8001AC30
.section extab, "a"
.balign 4

.obj "@etb_8001ABE4", local
.hidden "@etb_8001ABE4"
	.4byte 0x20180000
	.4byte 0x00000094
	.4byte 0x00000018
...
.obj "@etb_8001AC10", local
.hidden "@etb_8001AC10"
	.4byte 0x10080000
	.4byte 0x00000000
.endobj "@etb_8001AC10"

.obj "@etb_8001AC18", local
.hidden "@etb_8001AC18"
	.4byte 0x08080000
	.4byte 0x00000000
.endobj "@etb_8001AC18"

.obj "@etb_8001AC20", local
.hidden "@etb_8001AC20"
	.4byte 0x08080000
	.4byte 0x00000000
.endobj "@etb_8001AC20"

.obj "@etb_8001AC28", local
.hidden "@etb_8001AC28"
	.4byte 0x10080000
	.4byte 0x00000000
.endobj "@etb_8001AC28"

# 0x80032AA4 - 0x80032AE0
.section extabindex, "a"
.balign 4

.obj "@eti_80032AA4", local
.hidden "@eti_80032AA4"
	.4byte fn_802A5B88
	.4byte 0x00000108
	.4byte "@etb_8001ABE4"
...
# 0x802A5B88 - 0x802A5ED4
.text
.balign 4

.fn fn_802A5B88, global
...
/* 802A5BB4 0026F174  54 00 07 BD */	rlwinm. r0, r0, 0, 30, 30
/* 802A5BB8 0026F178  40 82 00 0C */	bne .L_802A5BC4
/* 802A5BBC 0026F17C  38 60 00 00 */	li r3, 0x0
/* 802A5BC0 0026F180  48 00 00 A8 */	b .L_802A5C68
.L_802A5BC4:
/* 802A5BC4 0026F184  80 04 3F 00 */	lwz r0, 0x3f00(r4)
/* 802A5BC8 0026F188  54 00 07 BD */	rlwinm. r0, r0, 0, 30, 30
/* 802A5BCC 0026F18C  40 82 00 0C */	bne .L_802A5BD8
/* 802A5BD0 0026F190  38 60 00 00 */	li r3, 0x0
/* 802A5BD4 0026F194  48 00 00 94 */	b .L_802A5C68
.L_802A5BD8:
/* 802A5BD8 0026F198  38 60 00 F0 */	li r3, 0xf0
/* 802A5BDC 0026F19C  38 80 00 01 */	li r4, 0x1
/* 802A5BE0 0026F1A0  4B FF D7 2D */	bl fn_802A330C
/* 802A5BE4 0026F1A4  2C 03 00 00 */	cmpwi r3, 0x0
/* 802A5BE8 0026F1A8  40 82 00 0C */	bne .L_802A5BF4
/* 802A5BEC 0026F1AC  38 60 00 00 */	li r3, 0x0
/* 802A5BF0 0026F1B0  48 00 00 78 */	b .L_802A5C68
.L_802A5BF4:
/* 802A5BF4 0026F1B4  38 60 00 28 */	li r3, 0x28
/* 802A5BF8 0026F1B8  4B FF D8 ED */	bl fn_802A34E4
/* 802A5BFC 0026F1BC  2C 03 00 00 */	cmpwi r3, 0x0
/* 802A5C00 0026F1C0  7C 7E 1B 78 */	mr r30, r3
/* 802A5C04 0026F1C4  40 82 00 0C */	bne .L_802A5C10
/* 802A5C08 0026F1C8  38 60 00 00 */	li r3, 0x0
...
/* 802A5C18 0026F1D8  4B FF DE 69 */	bl fn_802A3A80
...
/* 802A5C34 0026F1F4  38 60 00 00 */	li r3, 0x0
/* 802A5C38 0026F1F8  38 80 00 00 */	li r4, 0x0
/* 802A5C3C 0026F1FC  38 A0 00 00 */	li r5, 0x0
...
/* 802A5C50 0026F210  80 05 00 04 */	lwz r0, 0x4(r5)
/* 802A5C54 0026F214  80 85 00 00 */	lwz r4, 0x0(r5)
/* 802A5C58 0026F218  90 9E 00 00 */	stw r4, 0x0(r30)
/* 802A5C5C 0026F21C  90 1E 00 04 */	stw r0, 0x4(r30)
/* 802A5C60 0026F220  80 05 00 08 */	lwz r0, 0x8(r5)
/* 802A5C64 0026F224  90 1E 00 08 */	stw r0, 0x8(r30)
.L_802A5C68:
...
/* 802A5C7C 0026F23C  81 41 00 00 */	lwz r10, 0x0(r1)
/* 802A5C80 0026F240  80 0A 00 04 */	lwz r0, 0x4(r10)
/* 802A5C84 0026F244  7D 41 53 78 */	mr r1, r10
/* 802A5C88 0026F248  7C 08 03 A6 */	mtlr r0
/* 802A5C8C 0026F24C  4E 80 00 20 */	blr
.endfn fn_802A5B88

.fn fn_802A5C90, global
...
/* 802A5CA4 0026F264  93 C1 00 08 */	stw r30, 0x8(r1)
...
/* 802A5CB4 0026F274  80 05 00 04 */	lwz r0, 0x4(r5)
/* 802A5CB8 0026F278  90 03 00 04 */	stw r0, 0x4(r3)
/* 802A5CBC 0026F27C  2C 06 00 00 */	cmpwi r6, 0x0
/* 802A5CC0 0026F280  90 83 00 00 */	stw r4, 0x0(r3)
/* 802A5CC4 0026F284  80 05 00 08 */	lwz r0, 0x8(r5)
/* 802A5CC8 0026F288  90 03 00 08 */	stw r0, 0x8(r3)
/* 802A5CCC 0026F28C  41 82 00 68 */	beq .L_802A5D34
/* 802A5CD0 0026F290  81 86 00 00 */	lwz r12, 0x0(r6)
...
/* 802A5D14 0026F2D4  4B FF DF 31 */	bl fn_802A3C44
/* 802A5D18 0026F2D8  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 802A5D28 0026F2E8  81 8C 00 08 */	lwz r12, 0x8(r12)
...
/* 802A5D60 0026F320  4B FF E1 29 */	bl fn_802A3E88
/* 802A5D64 0026F324  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 802A5D78 0026F338  80 05 00 04 */	lwz r0, 0x4(r5)
/* 802A5D7C 0026F33C  90 1F 00 04 */	stw r0, 0x4(r31)
/* 802A5D80 0026F340  2C 03 00 00 */	cmpwi r3, 0x0
/* 802A5D84 0026F344  90 9F 00 00 */	stw r4, 0x0(r31)
/* 802A5D88 0026F348  80 05 00 08 */	lwz r0, 0x8(r5)
/* 802A5D8C 0026F34C  90 1F 00 08 */	stw r0, 0x8(r31)
/* 802A5D90 0026F350  41 82 00 68 */	beq .L_802A5DF8
/* 802A5D94 0026F354  81 83 00 00 */	lwz r12, 0x0(r3)
...
/* 802A5DA4 0026F364  2C 03 00 00 */	cmpwi r3, 0x0
/* 802A5DA8 0026F368  40 82 00 50 */	bne .L_802A5DF8
/* 802A5DAC 0026F36C  38 60 00 02 */	li r3, 0x2
/* 802A5DB0 0026F370  48 19 01 4D */	bl mtRand__2mlFi
/* 802A5DB4 0026F374  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 802A5DC8 0026F388  2C 04 00 00 */	cmpwi r4, 0x0
...
/* 802A5DD8 0026F398  4B FF DE 6D */	bl fn_802A3C44
/* 802A5DDC 0026F39C  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 802A5DEC 0026F3AC  81 8C 00 08 */	lwz r12, 0x8(r12)
...
/* 802A5E20 0026F3E0  4B FF E0 69 */	bl fn_802A3E88
/* 802A5E24 0026F3E4  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 802A5E34 0026F3F4  81 8C 00 08 */	lwz r12, 0x8(r12)
...
/* 802A5E68 0026F428  93 C1 00 08 */	stw r30, 0x8(r1)
/* 802A5E6C 0026F42C  7C 7E 1B 78 */	mr r30, r3
/* 802A5E70 0026F430  4B FF DD 7D */	bl fn_802A3BEC
/* 802A5E74 0026F434  80 7E 00 20 */	lwz r3, 0x20(r30)
/* 802A5E78 0026F438  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 802A5EAC 0026F46C  38 00 00 00 */	li r0, 0x0
...
# 0x8053D1F8 - 0x8053D248
.data
.balign 8
.sym lbl_8053D1F8, global
	.4byte 0x00000000
	.4byte 0xFFFFFFFF
	.4byte fn_802A5C90
.sym lbl_8053D204, global
	.4byte 0x00000000
	.4byte 0xFFFFFFFF
	.4byte fn_802A5D4C
.sym lbl_8053D210, global
	.4byte 0x00000000
	.4byte 0xFFFFFFFF
	.4byte fn_802A5E0C
