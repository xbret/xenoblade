.include "macros.inc"
.file "kyoshin/appgame/cf/voice/cvs/CVS_THREAD_CHAIN.o"
...
# 0x802A5830 - 0x802A5B88
.text
.balign 4

.fn fn_802A5830, global
/* 802A5830 0026EDF0  94 21 FF D0 */	stwu r1, -0x30(r1)
/* 802A5834 0026EDF4  7C 08 02 A6 */	mflr r0
/* 802A5838 0026EDF8  38 60 00 01 */	li r3, 0x1
/* 802A583C 0026EDFC  38 80 00 00 */	li r4, 0x0
...
/* 802A5850 0026EE10  4B FF DA BD */	bl fn_802A330C
/* 802A5854 0026EE14  2C 03 00 00 */	cmpwi r3, 0x0
/* 802A5858 0026EE18  40 82 00 0C */	bne .L_802A5864
/* 802A585C 0026EE1C  38 60 00 00 */	li r3, 0x0
/* 802A5860 0026EE20  48 00 00 78 */	b .L_802A58D8
.L_802A5864:
/* 802A5864 0026EE24  38 60 00 24 */	li r3, 0x24
/* 802A5868 0026EE28  4B FF DC 7D */	bl fn_802A34E4
/* 802A586C 0026EE2C  2C 03 00 00 */	cmpwi r3, 0x0
/* 802A5870 0026EE30  7C 7E 1B 78 */	mr r30, r3
/* 802A5874 0026EE34  40 82 00 0C */	bne .L_802A5880
/* 802A5878 0026EE38  38 60 00 00 */	li r3, 0x0
...
/* 802A5888 0026EE48  4B FF E1 F9 */	bl fn_802A3A80
/* 802A588C 0026EE4C  3C 60 80 54 */	lis r3, __vt__cf_CVS_THREAD_CHAIN@ha
/* 802A5890 0026EE50  38 00 00 00 */	li r0, 0x0
...
/* 802A58A4 0026EE64  38 60 00 00 */	li r3, 0x0
/* 802A58A8 0026EE68  38 80 00 00 */	li r4, 0x0
/* 802A58AC 0026EE6C  38 A0 00 00 */	li r5, 0x0
...
/* 802A58C0 0026EE80  80 05 00 04 */	lwz r0, 0x4(r5)
/* 802A58C4 0026EE84  80 85 00 00 */	lwz r4, 0x0(r5)
/* 802A58C8 0026EE88  90 9E 00 00 */	stw r4, 0x0(r30)
/* 802A58CC 0026EE8C  90 1E 00 04 */	stw r0, 0x4(r30)
/* 802A58D0 0026EE90  80 05 00 08 */	lwz r0, 0x8(r5)
/* 802A58D4 0026EE94  90 1E 00 08 */	stw r0, 0x8(r30)
.L_802A58D8:
...
/* 802A58E4 0026EEA4  81 41 00 00 */	lwz r10, 0x0(r1)
/* 802A58E8 0026EEA8  80 0A 00 04 */	lwz r0, 0x4(r10)
/* 802A58EC 0026EEAC  7D 41 53 78 */	mr r1, r10
/* 802A58F0 0026EEB0  7C 08 03 A6 */	mtlr r0
/* 802A58F4 0026EEB4  4E 80 00 20 */	blr
.endfn fn_802A5830

.fn fn_802A58F8, global
...
/* 802A590C 0026EECC  4B FF E5 7D */	bl fn_802A3E88
/* 802A5910 0026EED0  2C 03 00 00 */	cmpwi r3, 0x0
/* 802A5914 0026EED4  40 82 00 0C */	bne .L_802A5920
/* 802A5918 0026EED8  38 00 00 00 */	li r0, 0x0
...
/* 802A5948 0026EF08  93 C1 00 08 */	stw r30, 0x8(r1)
/* 802A594C 0026EF0C  7C 7E 1B 78 */	mr r30, r3
/* 802A5950 0026EF10  4B FF E2 9D */	bl fn_802A3BEC
/* 802A5954 0026EF14  80 7E 00 20 */	lwz r3, 0x20(r30)
/* 802A5958 0026EF18  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 802A596C 0026EF2C  38 00 00 00 */	li r0, 0x0
...
/* 802A59B0 0026EF70  4B FF E4 D9 */	bl fn_802A3E88
/* 802A59B4 0026EF74  2C 03 00 00 */	cmpwi r3, 0x0
/* 802A59B8 0026EF78  41 82 00 0C */	beq .L_802A59C4
/* 802A59BC 0026EF7C  7F A3 EB 78 */	mr r3, r29
/* 802A59C0 0026EF80  4B FF E4 69 */	bl fn_802A3E28
.L_802A59C4:
/* 802A59C4 0026EF84  2C 1E 00 00 */	cmpwi r30, 0x0
/* 802A59C8 0026EF88  41 82 00 08 */	beq .L_802A59D0
/* 802A59CC 0026EF8C  3B DE C1 64 */	addi r30, r30, -0x3e9c
.L_802A59D0:
/* 802A59D0 0026EF90  2C 1E 00 00 */	cmpwi r30, 0x0
...
/* 802A59EC 0026EFAC  4B FF E2 59 */	bl fn_802A3C44
...
.fn fn_802A5A0C, global
/* 802A5A0C 0026EFCC  38 60 00 01 */	li r3, 0x1
/* 802A5A10 0026EFD0  4E 80 00 20 */	blr
.endfn fn_802A5A0C

.fn fn_802A5A14, global
...
/* 802A5A28 0026EFE8  93 C1 00 08 */	stw r30, 0x8(r1)
/* 802A5A2C 0026EFEC  7C 7E 1B 78 */	mr r30, r3
/* 802A5A30 0026EFF0  80 03 3F 00 */	lwz r0, 0x3f00(r3)
/* 802A5A34 0026EFF4  54 00 07 BD */	rlwinm. r0, r0, 0, 30, 30
/* 802A5A38 0026EFF8  40 82 00 0C */	bne .L_802A5A44
/* 802A5A3C 0026EFFC  38 60 00 00 */	li r3, 0x0
/* 802A5A40 0026F000  48 00 00 AC */	b .L_802A5AEC
.L_802A5A44:
/* 802A5A44 0026F004  81 83 00 00 */	lwz r12, 0x0(r3)
...
/* 802A5AC4 0026F084  4B FF E2 91 */	bl fn_802A3D54
/* 802A5AC8 0026F088  48 00 00 20 */	b .L_802A5AE8
.L_802A5ACC:
/* 802A5ACC 0026F08C  2C 1E 00 00 */	cmpwi r30, 0x0
...
/* 802A5B1C 0026F0DC  54 00 07 BD */	rlwinm. r0, r0, 0, 30, 30
/* 802A5B20 0026F0E0  40 82 00 0C */	bne .L_802A5B2C
/* 802A5B24 0026F0E4  38 60 00 00 */	li r3, 0x0
/* 802A5B28 0026F0E8  48 00 00 4C */	b .L_802A5B74
.L_802A5B2C:
/* 802A5B2C 0026F0EC  38 60 00 0A */	li r3, 0xa
/* 802A5B30 0026F0F0  38 80 00 01 */	li r4, 0x1
/* 802A5B34 0026F0F4  4B FF D7 D9 */	bl fn_802A330C
/* 802A5B38 0026F0F8  2C 03 00 00 */	cmpwi r3, 0x0
/* 802A5B3C 0026F0FC  40 82 00 0C */	bne .L_802A5B48
/* 802A5B40 0026F100  38 60 00 00 */	li r3, 0x0
/* 802A5B44 0026F104  48 00 00 30 */	b .L_802A5B74
.L_802A5B48:
/* 802A5B48 0026F108  2C 1F 00 00 */	cmpwi r31, 0x0
/* 802A5B4C 0026F10C  41 82 00 08 */	beq .L_802A5B54
/* 802A5B50 0026F110  3B FF 3E 9C */	addi r31, r31, 0x3e9c
.L_802A5B54:
/* 802A5B54 0026F114  38 60 00 02 */	li r3, 0x2
...
/* 802A5B6C 0026F12C  4B FF E1 E9 */	bl fn_802A3D54
/* 802A5B70 0026F130  38 60 00 00 */	li r3, 0x0
.L_802A5B74:
