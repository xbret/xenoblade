.include "macros.inc"
.file "kyoshin/appgame/cf/voice/cvs/CVS_THREAD_FAINT.o"
...
.obj "@etb_8001ACC8", local
.hidden "@etb_8001ACC8"
	.4byte 0x10080000
	.4byte 0x00000000
.endobj "@etb_8001ACC8"

.obj "@etb_8001ACD0", local
.hidden "@etb_8001ACD0"
	.4byte 0x08080000
	.4byte 0x00000000
.endobj "@etb_8001ACD0"

.obj "@etb_8001ACD8", local
.hidden "@etb_8001ACD8"
	.4byte 0x08080000
	.4byte 0x00000000
.endobj "@etb_8001ACD8"

.obj "@etb_8001ACE0", local
.hidden "@etb_8001ACE0"
	.4byte 0x10080000
	.4byte 0x00000000
.endobj "@etb_8001ACE0"

.obj "@etb_8001ACE8", local
.hidden "@etb_8001ACE8"
	.4byte 0x08080000
	.4byte 0x00000000
.endobj "@etb_8001ACE8"
...
/* 802A6AD4 00270094  54 00 07 BD */	rlwinm. r0, r0, 0, 30, 30
/* 802A6AD8 00270098  40 82 00 0C */	bne .L_802A6AE4
/* 802A6ADC 0027009C  38 60 00 00 */	li r3, 0x0
/* 802A6AE0 002700A0  48 00 00 A8 */	b .L_802A6B88
.L_802A6AE4:
/* 802A6AE4 002700A4  80 04 3F 00 */	lwz r0, 0x3f00(r4)
/* 802A6AE8 002700A8  54 00 07 BD */	rlwinm. r0, r0, 0, 30, 30
/* 802A6AEC 002700AC  40 82 00 0C */	bne .L_802A6AF8
/* 802A6AF0 002700B0  38 60 00 00 */	li r3, 0x0
/* 802A6AF4 002700B4  48 00 00 94 */	b .L_802A6B88
.L_802A6AF8:
/* 802A6AF8 002700B8  38 60 00 F0 */	li r3, 0xf0
/* 802A6AFC 002700BC  38 80 00 01 */	li r4, 0x1
/* 802A6B00 002700C0  4B FF C8 0D */	bl fn_802A330C
/* 802A6B04 002700C4  2C 03 00 00 */	cmpwi r3, 0x0
/* 802A6B08 002700C8  40 82 00 0C */	bne .L_802A6B14
/* 802A6B0C 002700CC  38 60 00 00 */	li r3, 0x0
/* 802A6B10 002700D0  48 00 00 78 */	b .L_802A6B88
.L_802A6B14:
/* 802A6B14 002700D4  38 60 00 28 */	li r3, 0x28
/* 802A6B18 002700D8  4B FF C9 CD */	bl fn_802A34E4
/* 802A6B1C 002700DC  2C 03 00 00 */	cmpwi r3, 0x0
/* 802A6B20 002700E0  7C 7E 1B 78 */	mr r30, r3
/* 802A6B24 002700E4  40 82 00 0C */	bne .L_802A6B30
/* 802A6B28 002700E8  38 60 00 00 */	li r3, 0x0
...
/* 802A6B38 002700F8  4B FF CF 49 */	bl fn_802A3A80
...
/* 802A6B54 00270114  38 60 00 00 */	li r3, 0x0
/* 802A6B58 00270118  38 80 00 00 */	li r4, 0x0
/* 802A6B5C 0027011C  38 A0 00 00 */	li r5, 0x0
...
/* 802A6B70 00270130  80 05 00 04 */	lwz r0, 0x4(r5)
/* 802A6B74 00270134  80 85 00 00 */	lwz r4, 0x0(r5)
/* 802A6B78 00270138  90 9E 00 00 */	stw r4, 0x0(r30)
/* 802A6B7C 0027013C  90 1E 00 04 */	stw r0, 0x4(r30)
/* 802A6B80 00270140  80 05 00 08 */	lwz r0, 0x8(r5)
/* 802A6B84 00270144  90 1E 00 08 */	stw r0, 0x8(r30)
.L_802A6B88:
...
/* 802A6B9C 0027015C  81 41 00 00 */	lwz r10, 0x0(r1)
/* 802A6BA0 00270160  80 0A 00 04 */	lwz r0, 0x4(r10)
...
/* 802A6BC4 00270184  93 C1 00 08 */	stw r30, 0x8(r1)
...
/* 802A6BD4 00270194  80 05 00 04 */	lwz r0, 0x4(r5)
/* 802A6BD8 00270198  90 03 00 04 */	stw r0, 0x4(r3)
/* 802A6BDC 0027019C  2C 06 00 00 */	cmpwi r6, 0x0
/* 802A6BE0 002701A0  90 83 00 00 */	stw r4, 0x0(r3)
/* 802A6BE4 002701A4  80 05 00 08 */	lwz r0, 0x8(r5)
/* 802A6BE8 002701A8  90 03 00 08 */	stw r0, 0x8(r3)
/* 802A6BEC 002701AC  41 82 00 68 */	beq .L_802A6C54
/* 802A6BF0 002701B0  81 86 00 00 */	lwz r12, 0x0(r6)
...
/* 802A6C34 002701F4  4B FF D0 11 */	bl fn_802A3C44
/* 802A6C38 002701F8  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 802A6C48 00270208  81 8C 00 08 */	lwz r12, 0x8(r12)
...
/* 802A6C5C 0027021C  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 802A6C80 00270240  4B FF D2 09 */	bl fn_802A3E88
/* 802A6C84 00270244  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 802A6C98 00270258  80 05 00 04 */	lwz r0, 0x4(r5)
/* 802A6C9C 0027025C  90 1F 00 04 */	stw r0, 0x4(r31)
/* 802A6CA0 00270260  2C 03 00 00 */	cmpwi r3, 0x0
/* 802A6CA4 00270264  90 9F 00 00 */	stw r4, 0x0(r31)
/* 802A6CA8 00270268  80 05 00 08 */	lwz r0, 0x8(r5)
/* 802A6CAC 0027026C  90 1F 00 08 */	stw r0, 0x8(r31)
/* 802A6CB0 00270270  41 82 00 68 */	beq .L_802A6D18
/* 802A6CB4 00270274  81 83 00 00 */	lwz r12, 0x0(r3)
...
/* 802A6CC4 00270284  2C 03 00 00 */	cmpwi r3, 0x0
/* 802A6CC8 00270288  40 82 00 50 */	bne .L_802A6D18
/* 802A6CCC 0027028C  38 60 00 02 */	li r3, 0x2
/* 802A6CD0 00270290  48 18 F2 2D */	bl mtRand__2mlFi
/* 802A6CD4 00270294  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 802A6CE8 002702A8  2C 04 00 00 */	cmpwi r4, 0x0
...
/* 802A6CF8 002702B8  4B FF CF 4D */	bl fn_802A3C44
/* 802A6CFC 002702BC  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 802A6D0C 002702CC  81 8C 00 08 */	lwz r12, 0x8(r12)
...
/* 802A6D40 00270300  4B FF D1 49 */	bl fn_802A3E88
/* 802A6D44 00270304  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 802A6D54 00270314  81 8C 00 08 */	lwz r12, 0x8(r12)
...
/* 802A6D88 00270348  93 C1 00 08 */	stw r30, 0x8(r1)
/* 802A6D8C 0027034C  7C 7E 1B 78 */	mr r30, r3
/* 802A6D90 00270350  4B FF CE 5D */	bl fn_802A3BEC
/* 802A6D94 00270354  80 7E 00 20 */	lwz r3, 0x20(r30)
/* 802A6D98 00270358  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 802A6DCC 0027038C  38 00 00 00 */	li r0, 0x0
...
/* 802A6DDC 0027039C  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 802A6E68 00270428  4B FF CE ED */	bl fn_802A3D54
/* 802A6E6C 0027042C  38 60 00 00 */	li r3, 0x0
.L_802A6E70:
