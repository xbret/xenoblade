.include "macros.inc"
.file "kyoshin/appgame/cf/voice/cvs/CVS_THREAD_BATTLE_END.o"

# 0x8001AAF8 - 0x8001AB44
.section extab, "a"
.balign 4
...
/* 802A4898 0026DE58  4B FF EA 75 */	bl fn_802A330C
/* 802A489C 0026DE5C  2C 03 00 00 */	cmpwi r3, 0x0
/* 802A48A0 0026DE60  40 82 00 0C */	bne .L_802A48AC
/* 802A48A4 0026DE64  38 60 00 00 */	li r3, 0x0
/* 802A48A8 0026DE68  48 00 00 B0 */	b .L_802A4958
.L_802A48AC:
/* 802A48AC 0026DE6C  38 60 00 3C */	li r3, 0x3c
/* 802A48B0 0026DE70  4B FF EC 35 */	bl fn_802A34E4
/* 802A48B4 0026DE74  2C 03 00 00 */	cmpwi r3, 0x0
/* 802A48B8 0026DE78  7C 7E 1B 78 */	mr r30, r3
/* 802A48BC 0026DE7C  40 82 00 0C */	bne .L_802A48C8
/* 802A48C0 0026DE80  38 60 00 00 */	li r3, 0x0
...
/* 802A48D0 0026DE90  4B FF F1 B1 */	bl fn_802A3A80
...
/* 802A48E4 0026DEA4  38 80 00 00 */	li r4, 0x0
...
/* 802A48F4 0026DEB4  38 00 00 00 */	li r0, 0x0
/* 802A48F8 0026DEB8  90 1E 00 2C */	stw r0, 0x2c(r30)
/* 802A48FC 0026DEBC  38 60 00 02 */	li r3, 0x2
...
/* 802A4918 0026DED8  54 00 0F FE */	srwi r0, r0, 31
/* 802A491C 0026DEDC  98 1E 00 38 */	stb r0, 0x38(r30)
/* 802A4920 0026DEE0  48 00 00 14 */	b .L_802A4934
/* 802A4924 0026DEE4  38 60 00 00 */	li r3, 0x0
/* 802A4928 0026DEE8  38 80 00 00 */	li r4, 0x0
/* 802A492C 0026DEEC  38 A0 00 00 */	li r5, 0x0
...
/* 802A4940 0026DF00  80 05 00 04 */	lwz r0, 0x4(r5)
/* 802A4944 0026DF04  80 85 00 00 */	lwz r4, 0x0(r5)
/* 802A4948 0026DF08  90 9E 00 00 */	stw r4, 0x0(r30)
/* 802A494C 0026DF0C  90 1E 00 04 */	stw r0, 0x4(r30)
/* 802A4950 0026DF10  80 05 00 08 */	lwz r0, 0x8(r5)
/* 802A4954 0026DF14  90 1E 00 08 */	stw r0, 0x8(r30)
.L_802A4958:
...
/* 802A4968 0026DF28  81 41 00 00 */	lwz r10, 0x0(r1)
/* 802A496C 0026DF2C  80 0A 00 04 */	lwz r0, 0x4(r10)
/* 802A4970 0026DF30  7D 41 53 78 */	mr r1, r10
/* 802A4974 0026DF34  7C 08 03 A6 */	mtlr r0
/* 802A4978 0026DF38  4E 80 00 20 */	blr
.endfn fn_802A4870

.fn fn_802A497C, global
...
/* 802A4988 0026DF48  38 80 00 03 */	li r4, 0x3
/* 802A498C 0026DF4C  90 01 00 24 */	stw r0, 0x24(r1)
/* 802A4990 0026DF50  38 A0 00 00 */	li r5, 0x0
...
/* 802A49A8 0026DF68  80 07 00 04 */	lwz r0, 0x4(r7)
/* 802A49AC 0026DF6C  90 03 00 04 */	stw r0, 0x4(r3)
/* 802A49B0 0026DF70  90 C3 00 00 */	stw r6, 0x0(r3)
/* 802A49B4 0026DF74  80 07 00 08 */	lwz r0, 0x8(r7)
/* 802A49B8 0026DF78  90 03 00 08 */	stw r0, 0x8(r3)
/* 802A49BC 0026DF7C  38 63 00 20 */	addi r3, r3, 0x20
/* 802A49C0 0026DF80  48 00 2E B1 */	bl fn_802A7870
/* 802A49C4 0026DF84  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 802A49D8 0026DF98  81 8C 00 08 */	lwz r12, 0x8(r12)
...
/* 802A49F4 0026DFB4  2C 00 00 00 */	cmpwi r0, 0x0
/* 802A49F8 0026DFB8  90 7D 00 2C */	stw r3, 0x2c(r29)
/* 802A49FC 0026DFBC  40 82 00 5C */	bne .L_802A4A58
/* 802A4A00 0026DFC0  4B E1 21 A5 */	bl fn_800B6BA4
/* 802A4A04 0026DFC4  80 83 00 04 */	lwz r4, 0x4(r3)
/* 802A4A08 0026DFC8  7C 7F 1B 78 */	mr r31, r3
/* 802A4A0C 0026DFCC  83 C4 00 00 */	lwz r30, 0x0(r4)
/* 802A4A10 0026DFD0  48 00 00 38 */	b .L_802A4A48
.L_802A4A14:
/* 802A4A14 0026DFD4  80 7E 00 08 */	lwz r3, 0x8(r30)
/* 802A4A18 0026DFD8  2C 03 00 00 */	cmpwi r3, 0x0
/* 802A4A1C 0026DFDC  41 82 00 08 */	beq .L_802A4A24
/* 802A4A20 0026DFE0  38 63 C1 64 */	addi r3, r3, -0x3e9c
.L_802A4A24:
/* 802A4A24 0026DFE4  81 83 00 00 */	lwz r12, 0x0(r3)
...
/* 802A4A34 0026DFF4  2C 03 00 00 */	cmpwi r3, 0x0
/* 802A4A38 0026DFF8  41 82 00 0C */	beq .L_802A4A44
/* 802A4A3C 0026DFFC  38 00 00 01 */	li r0, 0x1
/* 802A4A40 0026E000  48 00 00 18 */	b .L_802A4A58
.L_802A4A44:
/* 802A4A44 0026E004  83 DE 00 00 */	lwz r30, 0x0(r30)
.L_802A4A48:
/* 802A4A48 0026E008  80 1F 00 04 */	lwz r0, 0x4(r31)
/* 802A4A4C 0026E00C  7C 1E 00 40 */	cmplw r30, r0
/* 802A4A50 0026E010  40 82 FF C4 */	bne .L_802A4A14
/* 802A4A54 0026E014  38 00 00 00 */	li r0, 0x0
.L_802A4A58:
...
/* 802A4A90 0026E050  93 C1 00 08 */	stw r30, 0x8(r1)
/* 802A4A94 0026E054  84 C7 D1 00 */	lwzu r6, lbl_8053D100@l(r7)
/* 802A4A98 0026E058  80 03 00 30 */	lwz r0, 0x30(r3)
/* 802A4A9C 0026E05C  80 A7 00 04 */	lwz r5, 0x4(r7)
/* 802A4AA0 0026E060  54 00 10 3A */	slwi r0, r0, 2
/* 802A4AA4 0026E064  90 A3 00 04 */	stw r5, 0x4(r3)
/* 802A4AA8 0026E068  7C 83 02 14 */	add r4, r3, r0
/* 802A4AAC 0026E06C  90 C3 00 00 */	stw r6, 0x0(r3)
/* 802A4AB0 0026E070  80 07 00 08 */	lwz r0, 0x8(r7)
/* 802A4AB4 0026E074  90 03 00 08 */	stw r0, 0x8(r3)
/* 802A4AB8 0026E078  80 64 00 20 */	lwz r3, 0x20(r4)
/* 802A4ABC 0026E07C  2C 03 00 00 */	cmpwi r3, 0x0
/* 802A4AC0 0026E080  41 82 02 2C */	beq .L_802A4CEC
/* 802A4AC4 0026E084  81 83 00 00 */	lwz r12, 0x0(r3)
...
/* 802A4AD4 0026E094  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 802A4AF8 0026E0B8  2C 00 00 01 */	cmpwi r0, 0x1
...
/* 802A4B08 0026E0C8  48 00 2C E1 */	bl fn_802A77E8
/* 802A4B0C 0026E0CC  2C 03 00 01 */	cmpwi r3, 0x1
...
/* 802A4BD0 0026E190  54 60 0F FE */	srwi r0, r3, 31
/* 802A4BD4 0026E194  7C 64 18 10 */	subfc r3, r4, r3
/* 802A4BD8 0026E198  38 60 00 00 */	li r3, 0x0
...
.L_802A4C14:
/* 802A4C14 0026E1D4  38 60 00 07 */	li r3, 0x7
...
/* 802A4C3C 0026E1FC  2C 04 00 00 */	cmpwi r4, 0x0
...
/* 802A4C4C 0026E20C  4B FF EF F9 */	bl fn_802A3C44
/* 802A4C50 0026E210  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 802A4C60 0026E220  81 8C 00 08 */	lwz r12, 0x8(r12)
...
/* 802A4C74 0026E234  2C 00 00 00 */	cmpwi r0, 0x0
/* 802A4C78 0026E238  41 82 00 1C */	beq .L_802A4C94
/* 802A4C7C 0026E23C  38 60 00 02 */	li r3, 0x2
...
.L_802A4C94:
/* 802A4C94 0026E254  38 60 00 04 */	li r3, 0x4
...
/* 802A4CBC 0026E27C  2C 04 00 00 */	cmpwi r4, 0x0
...
/* 802A4CCC 0026E28C  4B FF EF 79 */	bl fn_802A3C44
/* 802A4CD0 0026E290  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 802A4CE0 0026E2A0  81 8C 00 08 */	lwz r12, 0x8(r12)
...
/* 802A4D18 0026E2D8  4B FF F1 71 */	bl fn_802A3E88
/* 802A4D1C 0026E2DC  2C 03 00 00 */	cmpwi r3, 0x0
/* 802A4D20 0026E2E0  40 82 00 94 */	bne .L_802A4DB4
/* 802A4D24 0026E2E4  88 1F 00 38 */	lbz r0, 0x38(r31)
/* 802A4D28 0026E2E8  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 802A4D38 0026E2F8  38 63 00 01 */	addi r3, r3, 0x1
...
/* 802A4D48 0026E308  38 00 00 00 */	li r0, 0x0
...
/* 802A4D58 0026E318  34 03 FF FF */	addic. r0, r3, -0x1
...
/* 802A4D68 0026E328  38 03 FF FF */	addi r0, r3, -0x1
...
/* 802A4D88 0026E348  80 04 00 04 */	lwz r0, 0x4(r4)
/* 802A4D8C 0026E34C  90 1F 00 04 */	stw r0, 0x4(r31)
/* 802A4D90 0026E350  90 7F 00 00 */	stw r3, 0x0(r31)
/* 802A4D94 0026E354  80 04 00 08 */	lwz r0, 0x8(r4)
/* 802A4D98 0026E358  90 1F 00 08 */	stw r0, 0x8(r31)
...
/* 802A4DA8 0026E368  81 8C 00 08 */	lwz r12, 0x8(r12)
...
/* 802A4DDC 0026E39C  93 C1 00 08 */	stw r30, 0x8(r1)
/* 802A4DE0 0026E3A0  7C 7E 1B 78 */	mr r30, r3
/* 802A4DE4 0026E3A4  4B FF EE 09 */	bl fn_802A3BEC
/* 802A4DE8 0026E3A8  7F C5 F3 78 */	mr r5, r30
/* 802A4DEC 0026E3AC  38 C0 00 00 */	li r6, 0x0
/* 802A4DF0 0026E3B0  38 60 00 00 */	li r3, 0x0
/* 802A4DF4 0026E3B4  48 00 00 28 */	b .L_802A4E1C
.L_802A4DF8:
/* 802A4DF8 0026E3B8  80 85 00 20 */	lwz r4, 0x20(r5)
/* 802A4DFC 0026E3BC  2C 04 00 00 */	cmpwi r4, 0x0
...
.L_802A4E14:
/* 802A4E14 0026E3D4  38 A5 00 04 */	addi r5, r5, 0x4
/* 802A4E18 0026E3D8  38 C6 00 01 */	addi r6, r6, 0x1
.L_802A4E1C:
...
# 0x8053D0E8 - 0x8053D170
.data
.balign 8
.sym lbl_8053D0E8, global
	.4byte 0x00000000
	.4byte 0xFFFFFFFF
	.4byte fn_802A497C
.sym lbl_8053D0F4, global
	.4byte 0x00000000
	.4byte 0xFFFFFFFF
	.4byte fn_802A4A78
.sym lbl_8053D100, global
	.4byte 0x00000000
	.4byte 0xFFFFFFFF
	.4byte fn_802A4D04
.sym lbl_8053D10C, global
	.4byte 0x00000000
	.4byte 0xFFFFFFFF
	.4byte fn_802A4A78
.sym lbl_8053D118, global
	.4byte 0x00000B55
	.4byte 0x00000B56
	.4byte 0x00000B61
	.4byte 0x00000B62
...
# 0x806655C0 - 0x806655D8
.section .sdata, "wa"
.balign 8
.sym lbl_806655C0, global
	.4byte 0x00000B57
	.4byte 0x00000B58
.sym lbl_806655C8, global
	.4byte 0x00000B5D
	.4byte 0x00000B5E
