.include "macros.inc"
.file "kyoshin/appgame/cf/CfCollCircleImpl.o"

# 0x80009364 - 0x80009384
.section extab, "a"
.balign 4

.obj "@etb_80009364", local
.hidden "@etb_80009364"
	.4byte 0x100A0000
	.4byte 0x00000030
	.4byte 0x001C0010
...
.obj "@etb_8000937C", local
.hidden "@etb_8000937C"
	.4byte 0x200A0000
	.4byte 0x00000000
.endobj "@etb_8000937C"

# 0x80024BB4 - 0x80024BCC
.section extabindex, "a"
.balign 4

.obj "@eti_80024BB4", local
.hidden "@eti_80024BB4"
	.4byte fn_800AABD4
	.4byte 0x000000C4
	.4byte "@etb_80009364"
...
# 0x800AABD4 - 0x800AAD28
.text
.balign 4

.fn fn_800AABD4, global
...
/* 800AABF0 000741B0  48 3A B5 45 */	bl fn_80456134
/* 800AABF4 000741B4  80 6D A5 94 */	lwz r3, lbl_80666714@sda21(r13)
/* 800AABF8 000741B8  38 81 00 18 */	addi r4, r1, 0x18
/* 800AABFC 000741BC  38 A0 00 00 */	li r5, 0x0
/* 800AAC00 000741C0  48 3E 57 4D */	bl fn_8049034C
...
/* 800AAC10 000741D0  38 81 00 08 */	addi r4, r1, 0x8
/* 800AAC14 000741D4  C0 02 8E 60 */	lfs f0, lbl_806691E0@sda21(r2)
/* 800AAC18 000741D8  D0 41 00 08 */	stfs f2, 0x8(r1)
...
/* 800AAC70 00074230  48 3A CB 45 */	bl fn_804577B4
/* 800AAC74 00074234  38 61 00 18 */	addi r3, r1, 0x18
/* 800AAC78 00074238  38 80 FF FF */	li r4, -0x1
/* 800AAC7C 0007423C  48 3A B5 31 */	bl fn_804561AC
...
/* 800AACC8 00074288  81 9C 00 00 */	lwz r12, 0x0(r28)
...
/* 800AACF0 000742B0  90 01 00 08 */	stw r0, 0x8(r1)
/* 800AACF4 000742B4  7F A3 EB 78 */	mr r3, r29
/* 800AACF8 000742B8  7F C5 F3 78 */	mr r5, r30
/* 800AACFC 000742BC  C8 01 00 08 */	lfd f0, 0x8(r1)
/* 800AAD00 000742C0  EC 20 08 28 */	fsubs f1, f0, f1
/* 800AAD04 000742C4  4B FF A3 A9 */	bl fn_800A50AC
