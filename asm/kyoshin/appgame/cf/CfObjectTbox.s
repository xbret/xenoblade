.include "macros.inc"
.file "kyoshin/appgame/cf/CfObjectTbox.o"
...
# 0x801F8CB4 - 0x801F8E34
.text
.balign 4

.fn fn_801F8CB4, global
...
/* 801F8CC8 001C2288  4B EC 6C C5 */	bl fn_800BF98C
...
/* 801F8CD8 001C2298  38 00 00 00 */	li r0, 0x0
/* 801F8CDC 001C229C  2C 03 00 00 */	cmpwi r3, 0x0
/* 801F8CE0 001C22A0  90 9F 00 00 */	stw r4, 0x0(r31)
...
/* 801F8CF4 001C22B4  38 80 00 01 */	li r4, 0x1
/* 801F8CF8 001C22B8  81 8C 00 08 */	lwz r12, 0x8(r12)
/* 801F8CFC 001C22BC  7D 89 03 A6 */	mtctr r12
/* 801F8D00 001C22C0  4E 80 04 21 */	bctrl
.L_801F8D04:
/* 801F8D04 001C22C4  38 00 00 00 */	li r0, 0x0
/* 801F8D08 001C22C8  90 1F 00 B0 */	stw r0, 0xb0(r31)
.L_801F8D0C:
/* 801F8D0C 001C22CC  38 00 00 00 */	li r0, 0x0
/* 801F8D10 001C22D0  38 60 00 01 */	li r3, 0x1
...
/* 801F8D20 001C22E0  4B E6 92 DD */	bl fn_80061FFC
/* 801F8D24 001C22E4  7C 64 1B 78 */	mr r4, r3
/* 801F8D28 001C22E8  38 60 00 1C */	li r3, 0x1c
/* 801F8D2C 001C22EC  48 23 BD 31 */	bl mm_malloc
/* 801F8D30 001C22F0  2C 03 00 00 */	cmpwi r3, 0x0
/* 801F8D34 001C22F4  41 82 00 0C */	beq .L_801F8D40
/* 801F8D38 001C22F8  7F E4 FB 78 */	mr r4, r31
/* 801F8D3C 001C22FC  48 00 00 F9 */	bl fn_801F8E34
.L_801F8D40:
...
/* 801F8D74 001C2334  93 C1 00 08 */	stw r30, 0x8(r1)
...
/* 801F8D88 001C2348  91 83 00 00 */	stw r12, 0x0(r3)
...
/* 801F8D9C 001C235C  38 80 00 00 */	li r4, 0x0
/* 801F8DA0 001C2360  4B EC 6C 75 */	bl fn_800BFA14
/* 801F8DA4 001C2364  2C 1F 00 00 */	cmpwi r31, 0x0
...
/* 801F8DBC 001C237C  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 801F8DE8 001C23A8  81 83 00 00 */	lwz r12, 0x0(r3)
...
/* 801F8E08 001C23C8  4B EC 6D 89 */	bl fn_800BFB90
...
.fn fn_801F8E20, global
/* 801F8E20 001C23E0  80 63 00 38 */	lwz r3, 0x38(r3)
/* 801F8E24 001C23E4  2C 03 00 00 */	cmpwi r3, 0x0
/* 801F8E28 001C23E8  4D 82 00 20 */	beqlr
/* 801F8E2C 001C23EC  48 07 C5 CC */	b fn_802753F8
