.include "macros.inc"
.file "kyoshin/appgame/cf/CCharEffectEne.o"
...
# 0x8015CCBC - 0x8015D208
.text
.balign 4

.fn fn_8015CCBC, global
...
/* 8015CCD0 00126290  4B FF ED D9 */	bl fn_8015BAA8
...
/* 8015CCE0 001262A0  90 7F 00 00 */	stw r3, 0x0(r31)
/* 8015CCE4 001262A4  60 00 00 01 */	ori r0, r0, 0x1
...
.fn fn_8015CD04, global
/* 8015CD04 001262C4  94 21 FF F0 */	stwu r1, -0x10(r1)
/* 8015CD08 001262C8  7C 08 02 A6 */	mflr r0
/* 8015CD0C 001262CC  2C 05 00 00 */	cmpwi r5, 0x0
/* 8015CD10 001262D0  38 C0 00 00 */	li r6, 0x0
...
/* 8015CD2C 001262EC  2C 04 00 00 */	cmpwi r4, 0x0
...
/* 8015CD40 00126300  4B F2 4B 3D */	bl fn_8008187C
...
/* 8015CD50 00126310  38 84 FE 00 */	addi r4, r4, -0x200
/* 8015CD54 00126314  81 83 00 00 */	lwz r12, 0x0(r3)
...
/* 8015CD74 00126334  81 83 00 00 */	lwz r12, 0x0(r3)
...
/* 8015CDFC 001263BC  81 83 00 00 */	lwz r12, 0x0(r3)
...
.L_8015CE10:
/* 8015CE10 001263D0  2C 1F 00 00 */	cmpwi r31, 0x0
...
/* 8015CE20 001263E0  38 A0 00 00 */	li r5, 0x0
/* 8015CE24 001263E4  4B F5 01 55 */	bl fn_800ACF78
.L_8015CE28:
/* 8015CE28 001263E8  7F E3 FB 78 */	mr r3, r31
/* 8015CE2C 001263EC  83 E1 00 0C */	lwz r31, 0xc(r1)
/* 8015CE30 001263F0  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 8015CE78 00126438  2C 03 00 00 */	cmpwi r3, 0x0
/* 8015CE7C 0012643C  41 82 00 20 */	beq .L_8015CE9C
/* 8015CE80 00126440  4B F2 49 FD */	bl fn_8008187C
/* 8015CE84 00126444  7C 7F 1B 78 */	mr r31, r3
/* 8015CE88 00126448  48 00 00 14 */	b .L_8015CE9C
.L_8015CE8C:
/* 8015CE8C 0012644C  7C A3 2B 78 */	mr r3, r5
/* 8015CE90 00126450  38 80 00 00 */	li r4, 0x0
/* 8015CE94 00126454  4B F2 49 29 */	bl fn_800817BC
/* 8015CE98 00126458  7C 7F 1B 78 */	mr r31, r3
.L_8015CE9C:
/* 8015CE9C 0012645C  2C 1F 00 00 */	cmpwi r31, 0x0
...
/* 8015CEAC 0012646C  38 A0 00 00 */	li r5, 0x0
/* 8015CEB0 00126470  4B F5 00 C9 */	bl fn_800ACF78
.L_8015CEB4:
/* 8015CEB4 00126474  7F E3 FB 78 */	mr r3, r31
/* 8015CEB8 00126478  83 E1 00 0C */	lwz r31, 0xc(r1)
/* 8015CEBC 0012647C  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 8015CF04 001264C4  2C 04 00 00 */	cmpwi r4, 0x0
...
/* 8015CF18 001264D8  4B F2 49 65 */	bl fn_8008187C
/* 8015CF1C 001264DC  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 8015CF2C 001264EC  38 A0 00 00 */	li r5, 0x0
/* 8015CF30 001264F0  4B F5 00 49 */	bl fn_800ACF78
/* 8015CF34 001264F4  48 00 00 40 */	b .L_8015CF74
.L_8015CF38:
/* 8015CF38 001264F8  80 63 02 9C */	lwz r3, 0x29c(r3)
/* 8015CF3C 001264FC  38 84 FE 00 */	addi r4, r4, -0x200
/* 8015CF40 00126500  81 83 00 00 */	lwz r12, 0x0(r3)
...
/* 8015CF60 00126520  81 83 00 00 */	lwz r12, 0x0(r3)
...
/* 8015CF7C 0012653C  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 8015CFB8 00126578  2C 00 00 00 */	cmpwi r0, 0x0
/* 8015CFBC 0012657C  41 82 00 E0 */	beq .L_8015D09C
/* 8015CFC0 00126580  2C 07 00 00 */	cmpwi r7, 0x0
/* 8015CFC4 00126584  54 DF CF FE */	extrwi r31, r6, 1, 24
/* 8015CFC8 00126588  54 C4 06 7E */	clrlwi r4, r6, 25
/* 8015CFCC 0012658C  38 00 00 00 */	li r0, 0x0
/* 8015CFD0 00126590  41 82 00 08 */	beq .L_8015CFD8
/* 8015CFD4 00126594  38 E7 C1 64 */	addi r7, r7, -0x3e9c
.L_8015CFD8:
/* 8015CFD8 00126598  28 05 00 0A */	cmplwi r5, 0xa
/* 8015CFDC 0012659C  38 60 00 00 */	li r3, 0x0
...
/* 8015CFFC 001265BC  28 04 00 02 */	cmplwi r4, 0x2
...
/* 8015D058 00126618  4B F4 FF 21 */	bl fn_800ACF78
/* 8015D05C 0012661C  81 9E 00 00 */	lwz r12, 0x0(r30)
...
/* 8015D084 00126644  4B F4 FE 75 */	bl fn_800ACEF8
/* 8015D088 00126648  80 7D 02 9C */	lwz r3, 0x29c(r29)
/* 8015D08C 0012664C  80 63 00 98 */	lwz r3, 0x98(r3)
/* 8015D090 00126650  48 32 7E 21 */	bl fn_80484EB0
/* 8015D094 00126654  7F C3 F3 78 */	mr r3, r30
/* 8015D098 00126658  4B F4 FB B9 */	bl fn_800ACC50
.L_8015D09C:
...
.fn fn_8015D0B8, global
/* 8015D0B8 00126678  38 60 00 00 */	li r3, 0x0
/* 8015D0BC 0012667C  38 00 FF FF */	li r0, -0x1
...
/* 8015D0EC 001266AC  93 C1 00 08 */	stw r30, 0x8(r1)
...
/* 8015D100 001266C0  38 80 00 00 */	li r4, 0x0
/* 8015D104 001266C4  48 2E 7A 35 */	bl fn_80444B38
.L_8015D108:
/* 8015D108 001266C8  2C 1F 00 00 */	cmpwi r31, 0x0
...
/* 8015D120 001266E0  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 8015D154 00126714  93 C1 00 08 */	stw r30, 0x8(r1)
/* 8015D158 00126718  7C 7E 1B 78 */	mr r30, r3
/* 8015D15C 0012671C  4B FD EC F5 */	bl fn_8013BE50
/* 8015D160 00126720  2C 03 00 00 */	cmpwi r3, 0x0
/* 8015D164 00126724  41 82 00 8C */	beq .L_8015D1F0
/* 8015D168 00126728  80 0D 8A D4 */	lwz r0, lbl_80664C54@sda21(r13)
/* 8015D16C 0012672C  2C 00 00 00 */	cmpwi r0, 0x0
/* 8015D170 00126730  41 80 00 78 */	blt .L_8015D1E8
/* 8015D174 00126734  38 60 00 01 */	li r3, 0x1
/* 8015D178 00126738  4B FD 88 21 */	bl fn_80135998
...
/* 8015D188 00126748  38 83 00 09 */	addi r4, r3, 0x9
/* 8015D18C 0012674C  4B FD 90 05 */	bl fn_80136190
/* 8015D190 00126750  38 80 00 00 */	li r4, 0x0
/* 8015D194 00126754  38 A0 00 00 */	li r5, 0x0
/* 8015D198 00126758  4B FE 03 C5 */	bl fn_8013D55C
/* 8015D19C 0012675C  38 7F D8 80 */	addi r3, r31, lbl_804FD880@l
/* 8015D1A0 00126760  38 A0 00 80 */	li r5, 0x80
/* 8015D1A4 00126764  38 83 00 09 */	addi r4, r3, 0x9
/* 8015D1A8 00126768  4B FD 8F E9 */	bl fn_80136190
/* 8015D1AC 0012676C  38 80 00 00 */	li r4, 0x0
/* 8015D1B0 00126770  38 A0 00 00 */	li r5, 0x0
/* 8015D1B4 00126774  4B FE 03 A9 */	bl fn_8013D55C
/* 8015D1B8 00126778  80 6D 8A D4 */	lwz r3, lbl_80664C54@sda21(r13)
/* 8015D1BC 0012677C  38 80 00 00 */	li r4, 0x0
/* 8015D1C0 00126780  38 A0 00 00 */	li r5, 0x0
/* 8015D1C4 00126784  38 63 01 00 */	addi r3, r3, 0x100
/* 8015D1C8 00126788  4B FE 08 99 */	bl fn_8013DA60
/* 8015D1CC 0012678C  38 00 FF FF */	li r0, -0x1
/* 8015D1D0 00126790  90 0D 8A D4 */	stw r0, lbl_80664C54@sda21(r13)
/* 8015D1D4 00126794  38 60 00 00 */	li r3, 0x0
/* 8015D1D8 00126798  4B FD 87 C1 */	bl fn_80135998
/* 8015D1DC 0012679C  38 00 00 01 */	li r0, 0x1
/* 8015D1E0 001267A0  98 1E 00 64 */	stb r0, 0x64(r30)
/* 8015D1E4 001267A4  48 00 00 0C */	b .L_8015D1F0
.L_8015D1E8:
/* 8015D1E8 001267A8  38 00 00 01 */	li r0, 0x1
...
/* 8015D1F8 001267B8  83 C1 00 08 */	lwz r30, 0x8(r1)
