.include "macros.inc"
.file "kyoshin/appgame/cf/CfGimmickItem.o"

# 0x80013294 - 0x800132FC
.section extab, "a"
.balign 4

.obj "@etb_80013294", local
.hidden "@etb_80013294"
	.4byte 0x300A0000
	.4byte 0x00000038
	.4byte 0x00C80010
...
.obj "@etb_800132D4", local
.hidden "@etb_800132D4"
	.4byte 0x20080000
	.4byte 0x00000000
.endobj "@etb_800132D4"

.obj "@etb_800132DC", local
.hidden "@etb_800132DC"
	.4byte 0x08080000
	.4byte 0x00000000
.endobj "@etb_800132DC"

.obj "@etb_800132E4", local
.hidden "@etb_800132E4"
	.4byte 0x180A0000
	.4byte 0x00000000
.endobj "@etb_800132E4"

.obj "@etb_800132EC", local
.hidden "@etb_800132EC"
	.4byte 0x20080000
	.4byte 0x00000000
.endobj "@etb_800132EC"

.obj "@etb_800132F4", local
.hidden "@etb_800132F4"
	.4byte 0x08080000
	.4byte 0x00000000
.endobj "@etb_800132F4"

# 0x8002D23C - 0x8002D29C
.section extabindex, "a"
.balign 4

.obj "@eti_8002D23C", local
.hidden "@eti_8002D23C"
	.4byte fn_80210264
	.4byte 0x00000390
	.4byte "@etb_80013294"
...
# 0x80210264 - 0x80210C20
.text
.balign 4

.fn fn_80210264, global
...
/* 802102D0 001D9890  4B FF 8D 51 */	bl fn_80209020
...
/* 802102E4 001D98A4  4B FF 8F A5 */	bl fn_80209288
...
/* 802102F8 001D98B8  4B E2 A8 51 */	bl fn_8003AB48
/* 802102FC 001D98BC  90 61 00 54 */	stw r3, 0x54(r1)
/* 80210300 001D98C0  3B 40 00 00 */	li r26, 0x0
/* 80210304 001D98C4  3B 60 00 00 */	li r27, 0x0
/* 80210308 001D98C8  3B ED 8F 30 */	addi r31, r13, lbl_806650B0@sda21
/* 8021030C 001D98CC  88 01 00 54 */	lbz r0, 0x54(r1)
/* 80210310 001D98D0  3B 80 00 01 */	li r28, 0x1
/* 80210314 001D98D4  B0 1D 00 66 */	sth r0, 0x66(r29)
.L_80210318:
/* 80210318 001D98D8  80 7F 00 04 */	lwz r3, 0x4(r31)
...
/* 80210328 001D98E8  98 03 00 00 */	stb r0, 0x0(r3)
/* 8021032C 001D98EC  98 04 00 00 */	stb r0, 0x0(r4)
/* 80210330 001D98F0  80 61 00 58 */	lwz r3, 0x58(r1)
/* 80210334 001D98F4  4B E2 A8 15 */	bl fn_8003AB48
/* 80210338 001D98F8  90 61 00 50 */	stw r3, 0x50(r1)
/* 8021033C 001D98FC  7C 7D DA 14 */	add r3, r29, r27
/* 80210340 001D9900  80 9F 00 04 */	lwz r4, 0x4(r31)
...
.L_80210378:
/* 80210378 001D9938  3B 5A 00 01 */	addi r26, r26, 0x1
/* 8021037C 001D993C  3B 7B 00 02 */	addi r27, r27, 0x2
/* 80210380 001D9940  2C 1A 00 03 */	cmpwi r26, 0x3
...
/* 80210398 001D9958  38 9F 00 08 */	addi r4, r31, 0x8
/* 8021039C 001D995C  4B E2 A7 AD */	bl fn_8003AB48
...
/* 802103B8 001D9978  4B E2 A7 91 */	bl fn_8003AB48
...
/* 802103D4 001D9994  4B E2 A7 75 */	bl fn_8003AB48
...
/* 802103F0 001D99B0  4B E2 A7 59 */	bl fn_8003AB48
...
/* 8021040C 001D99CC  4B E2 A7 3D */	bl fn_8003AB48
...
/* 80210428 001D99E8  4B E2 A7 21 */	bl fn_8003AB48
...
/* 80210444 001D9A04  4B E2 A7 05 */	bl fn_8003AB48
...
/* 80210460 001D9A20  4B E2 A6 E9 */	bl fn_8003AB48
...
/* 8021047C 001D9A3C  4B E2 A6 CD */	bl fn_8003AB48
...
/* 80210498 001D9A58  4B E2 A6 B1 */	bl fn_8003AB48
...
/* 802104B4 001D9A74  4B E2 A6 95 */	bl fn_8003AB48
...
/* 802104D0 001D9A90  4B E2 A6 79 */	bl fn_8003AB48
...
/* 802104F4 001D9AB4  4B E2 A6 55 */	bl fn_8003AB48
...
/* 80210510 001D9AD0  4B E2 A6 39 */	bl fn_8003AB48
...
/* 8021052C 001D9AEC  4B E2 A6 1D */	bl fn_8003AB48
...
/* 80210548 001D9B08  4B E2 A6 01 */	bl fn_8003AB48
...
/* 80210564 001D9B24  4B E2 A5 E5 */	bl fn_8003AB48
/* 80210568 001D9B28  90 61 00 08 */	stw r3, 0x8(r1)
/* 8021056C 001D9B2C  7F A3 EB 78 */	mr r3, r29
/* 80210570 001D9B30  88 01 00 08 */	lbz r0, 0x8(r1)
/* 80210574 001D9B34  98 1D 00 97 */	stb r0, 0x97(r29)
/* 80210578 001D9B38  81 9D 00 00 */	lwz r12, 0x0(r29)
...
/* 8021060C 001D9BCC  93 C1 00 08 */	stw r30, 0x8(r1)
...
/* 80210620 001D9BE0  90 83 00 00 */	stw r4, 0x0(r3)
/* 80210624 001D9BE4  4B FF 88 C1 */	bl fn_80208EE4
/* 80210628 001D9BE8  38 7E 00 7C */	addi r3, r30, 0x7c
/* 8021062C 001D9BEC  4B FF 9E 09 */	bl fn_8020A434
/* 80210630 001D9BF0  7F C3 F3 78 */	mr r3, r30
/* 80210634 001D9BF4  38 80 00 00 */	li r4, 0x0
/* 80210638 001D9BF8  4B FF 82 F5 */	bl fn_8020892C
/* 8021063C 001D9BFC  2C 1F 00 00 */	cmpwi r31, 0x0
...
/* 80210654 001D9C14  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 8021069C 001D9C5C  54 00 06 F7 */	rlwinm. r0, r0, 0, 27, 27
/* 802106A0 001D9C60  41 82 00 3C */	beq .L_802106DC
/* 802106A4 001D9C64  A0 1F 00 66 */	lhz r0, 0x66(r31)
/* 802106A8 001D9C68  54 00 07 FF */	clrlwi. r0, r0, 31
...
/* 802106BC 001D9C7C  38 9F 00 04 */	addi r4, r31, 0x4
/* 802106C0 001D9C80  38 C0 00 00 */	li r6, 0x0
/* 802106C4 001D9C84  38 E0 00 00 */	li r7, 0x0
/* 802106C8 001D9C88  4B FF 9F E9 */	bl fn_8020A6B0
.L_802106CC:
/* 802106CC 001D9C8C  80 1F 00 74 */	lwz r0, 0x74(r31)
/* 802106D0 001D9C90  54 00 07 34 */	rlwinm r0, r0, 0, 28, 26
...
/* 802106E0 001D9CA0  4B FF 9D 55 */	bl fn_8020A434
.L_802106E4:
...
/* 80210754 001D9D14  2C 03 00 00 */	cmpwi r3, 0x0
/* 80210758 001D9D18  41 82 00 24 */	beq .L_8021077C
/* 8021075C 001D9D1C  4B E7 1B F9 */	bl fn_80082354
...
/* 80210788 001D9D48  38 BC 00 04 */	addi r5, r28, 0x4
...
/* 8021079C 001D9D5C  4B FF 8F B9 */	bl fn_80209754
/* 802107A0 001D9D60  2C 03 00 00 */	cmpwi r3, 0x0
/* 802107A4 001D9D64  41 82 00 80 */	beq .L_80210824
/* 802107A8 001D9D68  7F 9F E3 78 */	mr r31, r28
/* 802107AC 001D9D6C  3B C0 00 00 */	li r30, 0x0
/* 802107B0 001D9D70  3B A0 00 00 */	li r29, 0x0
.L_802107B4:
/* 802107B4 001D9D74  A0 7F 00 84 */	lhz r3, 0x84(r31)
/* 802107B8 001D9D78  2C 03 00 00 */	cmpwi r3, 0x0
/* 802107BC 001D9D7C  41 82 00 1C */	beq .L_802107D8
/* 802107C0 001D9D80  4B F4 80 29 */	bl fn_801587E8
/* 802107C4 001D9D84  2C 03 00 00 */	cmpwi r3, 0x0
/* 802107C8 001D9D88  40 82 00 0C */	bne .L_802107D4
/* 802107CC 001D9D8C  3B C0 00 00 */	li r30, 0x0
/* 802107D0 001D9D90  48 00 00 18 */	b .L_802107E8
.L_802107D4:
/* 802107D4 001D9D94  3B C0 00 01 */	li r30, 0x1
.L_802107D8:
/* 802107D8 001D9D98  3B BD 00 01 */	addi r29, r29, 0x1
/* 802107DC 001D9D9C  3B FF 00 02 */	addi r31, r31, 0x2
/* 802107E0 001D9DA0  2C 1D 00 03 */	cmpwi r29, 0x3
/* 802107E4 001D9DA4  41 80 FF D0 */	blt .L_802107B4
.L_802107E8:
/* 802107E8 001D9DA8  A0 1C 00 66 */	lhz r0, 0x66(r28)
/* 802107EC 001D9DAC  54 00 07 FF */	clrlwi. r0, r0, 31
/* 802107F0 001D9DB0  41 82 00 18 */	beq .L_80210808
/* 802107F4 001D9DB4  A0 7C 00 8E */	lhz r3, 0x8e(r28)
/* 802107F8 001D9DB8  2C 03 00 00 */	cmpwi r3, 0x0
/* 802107FC 001D9DBC  41 82 00 0C */	beq .L_80210808
/* 80210800 001D9DC0  38 9C 00 04 */	addi r4, r28, 0x4
/* 80210804 001D9DC4  4B FF 84 45 */	bl fn_80208C48
.L_80210808:
/* 80210808 001D9DC8  2C 1E 00 00 */	cmpwi r30, 0x0
/* 8021080C 001D9DCC  41 82 00 10 */	beq .L_8021081C
/* 80210810 001D9DD0  38 00 00 02 */	li r0, 0x2
/* 80210814 001D9DD4  B0 1C 00 9E */	sth r0, 0x9e(r28)
/* 80210818 001D9DD8  48 00 00 0C */	b .L_80210824
.L_8021081C:
/* 8021081C 001D9DDC  38 00 00 01 */	li r0, 0x1
...
.L_802108B0:
/* 802108B0 001D9E70  38 60 00 00 */	li r3, 0x0
.L_802108B4:
/* 802108B4 001D9E74  2C 03 00 00 */	cmpwi r3, 0x0
/* 802108B8 001D9E78  40 82 00 0C */	bne .L_802108C4
.L_802108BC:
/* 802108BC 001D9E7C  38 00 00 04 */	li r0, 0x4
...
/* 80210934 001D9EF4  48 25 25 C1 */	bl fn_80462EF4
/* 80210938 001D9EF8  48 00 00 0C */	b .L_80210944
.L_8021093C:
/* 8021093C 001D9EFC  7F A3 EB 78 */	mr r3, r29
/* 80210940 001D9F00  48 25 25 D1 */	bl fn_80462F10
.L_80210944:
/* 80210944 001D9F04  7F A3 EB 78 */	mr r3, r29
/* 80210948 001D9F08  38 80 00 00 */	li r4, 0x0
/* 8021094C 001D9F0C  48 25 26 01 */	bl fn_80462F4C
/* 80210950 001D9F10  48 00 00 48 */	b .L_80210998
.L_80210954:
/* 80210954 001D9F14  57 C0 07 FF */	clrlwi. r0, r30, 31
/* 80210958 001D9F18  41 82 00 20 */	beq .L_80210978
/* 8021095C 001D9F1C  7F A3 EB 78 */	mr r3, r29
/* 80210960 001D9F20  38 80 00 00 */	li r4, 0x0
/* 80210964 001D9F24  48 25 26 0D */	bl fn_80462F70
/* 80210968 001D9F28  7F A3 EB 78 */	mr r3, r29
/* 8021096C 001D9F2C  38 80 00 01 */	li r4, 0x1
/* 80210970 001D9F30  48 25 25 DD */	bl fn_80462F4C
/* 80210974 001D9F34  48 00 00 24 */	b .L_80210998
.L_80210978:
/* 80210978 001D9F38  57 C0 07 BD */	rlwinm. r0, r30, 0, 30, 30
/* 8021097C 001D9F3C  41 82 00 1C */	beq .L_80210998
/* 80210980 001D9F40  7F A3 EB 78 */	mr r3, r29
/* 80210984 001D9F44  38 80 00 01 */	li r4, 0x1
/* 80210988 001D9F48  48 25 25 E9 */	bl fn_80462F70
/* 8021098C 001D9F4C  7F A3 EB 78 */	mr r3, r29
/* 80210990 001D9F50  38 80 00 01 */	li r4, 0x1
/* 80210994 001D9F54  48 25 25 B9 */	bl fn_80462F4C
.L_80210998:
/* 80210998 001D9F58  57 C0 07 39 */	rlwinm. r0, r30, 0, 28, 28
/* 8021099C 001D9F5C  41 82 00 14 */	beq .L_802109B0
/* 802109A0 001D9F60  7F A3 EB 78 */	mr r3, r29
/* 802109A4 001D9F64  38 80 00 00 */	li r4, 0x0
/* 802109A8 001D9F68  48 25 25 29 */	bl fn_80462ED0
/* 802109AC 001D9F6C  48 00 00 10 */	b .L_802109BC
.L_802109B0:
/* 802109B0 001D9F70  7F A3 EB 78 */	mr r3, r29
/* 802109B4 001D9F74  38 80 00 01 */	li r4, 0x1
/* 802109B8 001D9F78  48 25 25 19 */	bl fn_80462ED0
.L_802109BC:
/* 802109BC 001D9F7C  88 9F 00 99 */	lbz r4, 0x99(r31)
/* 802109C0 001D9F80  7F A3 EB 78 */	mr r3, r29
/* 802109C4 001D9F84  48 25 25 D1 */	bl fn_80462F94
.L_802109C8:
/* 802109C8 001D9F88  A0 7F 00 90 */	lhz r3, 0x90(r31)
/* 802109CC 001D9F8C  80 1F 00 74 */	lwz r0, 0x74(r31)
/* 802109D0 001D9F90  2C 03 00 00 */	cmpwi r3, 0x0
/* 802109D4 001D9F94  60 00 00 08 */	ori r0, r0, 0x8
/* 802109D8 001D9F98  90 1F 00 74 */	stw r0, 0x74(r31)
/* 802109DC 001D9F9C  41 82 00 0C */	beq .L_802109E8
/* 802109E0 001D9FA0  38 9F 00 04 */	addi r4, r31, 0x4
/* 802109E4 001D9FA4  4B FF 82 65 */	bl fn_80208C48
.L_802109E8:
/* 802109E8 001D9FA8  88 7F 00 9B */	lbz r3, 0x9b(r31)
/* 802109EC 001D9FAC  2C 03 00 00 */	cmpwi r3, 0x0
/* 802109F0 001D9FB0  41 82 00 1C */	beq .L_80210A0C
/* 802109F4 001D9FB4  38 80 00 00 */	li r4, 0x0
/* 802109F8 001D9FB8  4B E7 0D C5 */	bl fn_800817BC
/* 802109FC 001D9FBC  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 80210A10 001D9FD0  2C 03 00 00 */	cmpwi r3, 0x0
/* 80210A14 001D9FD4  41 82 00 08 */	beq .L_80210A1C
/* 80210A18 001D9FD8  4B E6 A6 B1 */	bl fn_8007B0C8
.L_80210A1C:
...
/* 80210A2C 001D9FEC  38 03 00 01 */	addi r0, r3, 0x1
...
.L_80210A8C:
/* 80210A8C 001DA04C  38 60 00 00 */	li r3, 0x0
.L_80210A90:
/* 80210A90 001DA050  2C 03 00 00 */	cmpwi r3, 0x0
/* 80210A94 001DA054  40 82 00 20 */	bne .L_80210AB4
.L_80210A98:
/* 80210A98 001DA058  80 9F 00 74 */	lwz r4, 0x74(r31)
/* 80210A9C 001DA05C  38 60 00 00 */	li r3, 0x0
/* 80210AA0 001DA060  38 00 00 03 */	li r0, 0x3
/* 80210AA4 001DA064  B0 7F 00 A0 */	sth r3, 0xa0(r31)
/* 80210AA8 001DA068  54 83 07 76 */	rlwinm r3, r4, 0, 29, 27
...
/* 80210B00 001DA0C0  2C 03 00 00 */	cmpwi r3, 0x0
...
/* 80210B18 001DA0D8  38 80 00 01 */	li r4, 0x1
/* 80210B1C 001DA0DC  4B F4 90 E9 */	bl fn_80159C04
.L_80210B20:
/* 80210B20 001DA0E0  3B BD 00 01 */	addi r29, r29, 0x1
/* 80210B24 001DA0E4  3B DE 00 02 */	addi r30, r30, 0x2
/* 80210B28 001DA0E8  2C 1D 00 03 */	cmpwi r29, 0x3
/* 80210B2C 001DA0EC  41 80 FF D0 */	blt .L_80210AFC
/* 80210B30 001DA0F0  A0 7C 00 8A */	lhz r3, 0x8a(r28)
/* 80210B34 001DA0F4  2C 03 00 00 */	cmpwi r3, 0x0
/* 80210B38 001DA0F8  41 82 00 0C */	beq .L_80210B44
/* 80210B3C 001DA0FC  38 80 00 01 */	li r4, 0x1
/* 80210B40 001DA100  4B F4 7B 95 */	bl fn_801586D4
.L_80210B44:
/* 80210B44 001DA104  88 1C 00 9C */	lbz r0, 0x9c(r28)
/* 80210B48 001DA108  28 00 00 03 */	cmplwi r0, 0x3
/* 80210B4C 001DA10C  40 82 00 10 */	bne .L_80210B5C
/* 80210B50 001DA110  38 00 00 05 */	li r0, 0x5
/* 80210B54 001DA114  B0 1C 00 9E */	sth r0, 0x9e(r28)
/* 80210B58 001DA118  48 00 00 20 */	b .L_80210B78
.L_80210B5C:
/* 80210B5C 001DA11C  28 00 00 02 */	cmplwi r0, 0x2
/* 80210B60 001DA120  40 82 00 10 */	bne .L_80210B70
/* 80210B64 001DA124  38 00 00 05 */	li r0, 0x5
/* 80210B68 001DA128  B0 1C 00 9E */	sth r0, 0x9e(r28)
/* 80210B6C 001DA12C  48 00 00 0C */	b .L_80210B78
.L_80210B70:
/* 80210B70 001DA130  38 00 00 04 */	li r0, 0x4
/* 80210B74 001DA134  B0 1C 00 9E */	sth r0, 0x9e(r28)
.L_80210B78:
/* 80210B78 001DA138  A0 7C 00 64 */	lhz r3, 0x64(r28)
/* 80210B7C 001DA13C  2C 03 00 00 */	cmpwi r3, 0x0
/* 80210B80 001DA140  41 82 00 0C */	beq .L_80210B8C
/* 80210B84 001DA144  38 80 00 01 */	li r4, 0x1
/* 80210B88 001DA148  4B FF 8B C5 */	bl fn_8020974C
.L_80210B8C:
...
/* 80210BC4 001DA184  54 00 07 FF */	clrlwi. r0, r0, 31
...
/* 80210BD8 001DA198  38 A3 00 04 */	addi r5, r3, 0x4
...
/* 80210BF8 001DA1B8  2C 03 00 00 */	cmpwi r3, 0x0
/* 80210BFC 001DA1BC  40 82 00 0C */	bne .L_80210C08
.L_80210C00:
/* 80210C00 001DA1C0  38 00 00 00 */	li r0, 0x0
...
.fn fn_80210C1C, global
/* 80210C1C 001DA1DC  4E 80 00 20 */	blr
.endfn fn_80210C1C

# 0x80503EB8 - 0x80503F30
.rodata
.balign 8
...
# 0x80539208 - 0x80539288
.data
.balign 8
.sym lbl_80539208, global
	.4byte 0x00000000
	.4byte 0xFFFFFFFF
	.4byte fn_802106F8
	.4byte 0x00000000
...
# 0x806650B0 - 0x806650C0
.section .sdata, "wa"
.balign 8
.sym lbl_806650B0, global
	.4byte lbl_8066ACF8
	.4byte lbl_8066AD00
...
# 0x8066ACF8 - 0x8066AD10
.section .sdata2, "a"
.balign 8
.sym lbl_8066ACF8, global
	.4byte 0x415F4974
	.4byte 0x656D0000
.sym lbl_8066AD00, global
	.4byte 0x415F4C6F
	.4byte 0x73740000
.sym lbl_8066AD08, global
	.4byte 0x00000000
.sym lbl_8066AD0C, global
	.4byte 0x40A00000
