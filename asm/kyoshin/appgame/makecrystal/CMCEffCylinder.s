.include "macros.inc"
.file "kyoshin/appgame/makecrystal/CMCEffCylinder.o"

# 0x800151A4 - 0x8001520C
.section extab, "a"
.balign 4
...
# 0x80225D00 - 0x802262B8
.text
.balign 4

.fn fn_80225D00, global
/* 80225D00 001EF2C0  3C C0 80 54 */	lis r6, __vt__CMCEffCylinder@ha
/* 80225D04 001EF2C4  38 A0 00 00 */	li r5, 0x0
/* 80225D08 001EF2C8  38 C6 97 D0 */	addi r6, r6, __vt__CMCEffCylinder@l
/* 80225D0C 001EF2CC  38 00 00 01 */	li r0, 0x1
/* 80225D10 001EF2D0  90 C3 00 00 */	stw r6, 0x0(r3)
/* 80225D14 001EF2D4  98 A3 00 04 */	stb r5, 0x4(r3)
/* 80225D18 001EF2D8  98 03 00 05 */	stb r0, 0x5(r3)
/* 80225D1C 001EF2DC  90 83 00 08 */	stw r4, 0x8(r3)
...
/* 80225D54 001EF314  2C 04 00 00 */	cmpwi r4, 0x0
...
/* 80225D84 001EF344  BF C1 00 08 */	stmw r30, 0x8(r1)
...
/* 80225DF8 001EF3B8  4B F1 0A C9 */	bl fn_801368C0
.L_80225DFC:
/* 80225DFC 001EF3BC  7F C3 F3 78 */	mr r3, r30
/* 80225E00 001EF3C0  48 00 03 21 */	bl fn_80226120
/* 80225E04 001EF3C4  38 00 00 01 */	li r0, 0x1
/* 80225E08 001EF3C8  98 1E 00 1C */	stb r0, 0x1c(r30)
/* 80225E0C 001EF3CC  BB C1 00 08 */	lmw r30, 0x8(r1)
...
/* 80225E38 001EF3F8  2C 00 00 00 */	cmpwi r0, 0x0
/* 80225E3C 001EF3FC  41 82 00 50 */	beq .L_80225E8C
/* 80225E40 001EF400  88 03 00 04 */	lbz r0, 0x4(r3)
/* 80225E44 001EF404  2C 00 00 01 */	cmpwi r0, 0x1
/* 80225E48 001EF408  41 82 00 18 */	beq .L_80225E60
/* 80225E4C 001EF40C  2C 00 00 03 */	cmpwi r0, 0x3
/* 80225E50 001EF410  41 82 00 18 */	beq .L_80225E68
/* 80225E54 001EF414  2C 00 00 04 */	cmpwi r0, 0x4
/* 80225E58 001EF418  41 82 00 18 */	beq .L_80225E70
/* 80225E5C 001EF41C  48 00 00 18 */	b .L_80225E74
.L_80225E60:
/* 80225E60 001EF420  48 00 01 DD */	bl fn_8022603C
/* 80225E64 001EF424  48 00 00 10 */	b .L_80225E74
.L_80225E68:
/* 80225E68 001EF428  48 00 02 21 */	bl fn_80226088
/* 80225E6C 001EF42C  48 00 00 08 */	b .L_80225E74
.L_80225E70:
/* 80225E70 001EF430  48 00 02 65 */	bl fn_802260D4
.L_80225E74:
/* 80225E74 001EF434  80 7F 00 0C */	lwz r3, 0xc(r31)
/* 80225E78 001EF438  38 80 00 00 */	li r4, 0x0
/* 80225E7C 001EF43C  81 83 00 00 */	lwz r12, 0x0(r3)
...
.fn fn_80225EA0, global
/* 80225EA0 001EF460  88 03 00 1C */	lbz r0, 0x1c(r3)
/* 80225EA4 001EF464  2C 00 00 00 */	cmpwi r0, 0x0
/* 80225EA8 001EF468  4D 82 00 20 */	beqlr
/* 80225EAC 001EF46C  80 63 00 0C */	lwz r3, 0xc(r3)
/* 80225EB0 001EF470  38 A0 00 00 */	li r5, 0x0
/* 80225EB4 001EF474  38 C0 00 01 */	li r6, 0x1
/* 80225EB8 001EF478  4B F1 11 80 */	b fn_80137038
/* 80225EBC 001EF47C  4E 80 00 20 */	blr
.endfn fn_80225EA0

.fn fn_80225EC0, global
...
/* 80225ECC 001EF48C  38 00 00 00 */	li r0, 0x0
...
/* 80225EE0 001EF4A0  2C 04 00 00 */	cmpwi r4, 0x0
...
/* 80225EF0 001EF4B0  38 80 00 01 */	li r4, 0x1
/* 80225EF4 001EF4B4  81 83 00 00 */	lwz r12, 0x0(r3)
/* 80225EF8 001EF4B8  81 8C 00 08 */	lwz r12, 0x8(r12)
/* 80225EFC 001EF4BC  7D 89 03 A6 */	mtctr r12
/* 80225F00 001EF4C0  4E 80 04 21 */	bctrl
.L_80225F04:
/* 80225F04 001EF4C4  38 00 00 00 */	li r0, 0x0
...
.fn fn_80225F20, global
/* 80225F20 001EF4E0  88 63 00 05 */	lbz r3, 0x5(r3)
/* 80225F24 001EF4E4  4E 80 00 20 */	blr
.endfn fn_80225F20

.fn fn_80225F28, global
...
/* 80225F3C 001EF4FC  88 03 00 04 */	lbz r0, 0x4(r3)
/* 80225F40 001EF500  2C 00 00 00 */	cmpwi r0, 0x0
/* 80225F44 001EF504  40 82 00 24 */	bne .L_80225F68
/* 80225F48 001EF508  38 00 00 01 */	li r0, 0x1
/* 80225F4C 001EF50C  98 03 00 04 */	stb r0, 0x4(r3)
/* 80225F50 001EF510  48 00 01 D1 */	bl fn_80226120
/* 80225F54 001EF514  80 7F 00 10 */	lwz r3, 0x10(r31)
/* 80225F58 001EF518  38 00 00 00 */	li r0, 0x0
/* 80225F5C 001EF51C  C0 02 AA 90 */	lfs f0, lbl_8066AE10@sda21(r2)
/* 80225F60 001EF520  D0 03 00 10 */	stfs f0, 0x10(r3)
/* 80225F64 001EF524  98 1F 00 05 */	stb r0, 0x5(r31)
.L_80225F68:
...
/* 80225F90 001EF550  88 03 00 04 */	lbz r0, 0x4(r3)
/* 80225F94 001EF554  28 00 00 02 */	cmplwi r0, 0x2
/* 80225F98 001EF558  40 82 00 24 */	bne .L_80225FBC
/* 80225F9C 001EF55C  38 00 00 03 */	li r0, 0x3
/* 80225FA0 001EF560  98 03 00 04 */	stb r0, 0x4(r3)
/* 80225FA4 001EF564  48 00 02 8D */	bl fn_80226230
/* 80225FA8 001EF568  80 7F 00 18 */	lwz r3, 0x18(r31)
/* 80225FAC 001EF56C  38 00 00 00 */	li r0, 0x0
/* 80225FB0 001EF570  C0 02 AA 90 */	lfs f0, lbl_8066AE10@sda21(r2)
/* 80225FB4 001EF574  D0 03 00 10 */	stfs f0, 0x10(r3)
/* 80225FB8 001EF578  98 1F 00 05 */	stb r0, 0x5(r31)
.L_80225FBC:
...
/* 80225FE4 001EF5A4  88 03 00 04 */	lbz r0, 0x4(r3)
/* 80225FE8 001EF5A8  28 00 00 02 */	cmplwi r0, 0x2
/* 80225FEC 001EF5AC  40 82 00 24 */	bne .L_80226010
/* 80225FF0 001EF5B0  38 00 00 04 */	li r0, 0x4
/* 80225FF4 001EF5B4  98 03 00 04 */	stb r0, 0x4(r3)
/* 80225FF8 001EF5B8  48 00 01 B1 */	bl fn_802261A8
/* 80225FFC 001EF5BC  80 7F 00 14 */	lwz r3, 0x14(r31)
/* 80226000 001EF5C0  38 00 00 00 */	li r0, 0x0
/* 80226004 001EF5C4  C0 02 AA 90 */	lfs f0, lbl_8066AE10@sda21(r2)
/* 80226008 001EF5C8  D0 03 00 10 */	stfs f0, 0x10(r3)
/* 8022600C 001EF5CC  98 1F 00 05 */	stb r0, 0x5(r31)
.L_80226010:
...
/* 80226038 001EF5F8  4B F1 08 D8 */	b fn_80136910
.endfn fn_80226024

.fn fn_8022603C, global
...
/* 80226058 001EF618  4B F1 13 ED */	bl fn_80137444
/* 8022605C 001EF61C  2C 03 00 00 */	cmpwi r3, 0x0
/* 80226060 001EF620  41 82 00 14 */	beq .L_80226074
/* 80226064 001EF624  38 60 00 02 */	li r3, 0x2
/* 80226068 001EF628  38 00 00 01 */	li r0, 0x1
/* 8022606C 001EF62C  98 7F 00 04 */	stb r3, 0x4(r31)
/* 80226070 001EF630  98 1F 00 05 */	stb r0, 0x5(r31)
.L_80226074:
...
/* 802260A4 001EF664  4B F1 13 A1 */	bl fn_80137444
/* 802260A8 001EF668  2C 03 00 00 */	cmpwi r3, 0x0
/* 802260AC 001EF66C  41 82 00 14 */	beq .L_802260C0
/* 802260B0 001EF670  38 60 00 00 */	li r3, 0x0
/* 802260B4 001EF674  38 00 00 01 */	li r0, 0x1
/* 802260B8 001EF678  98 7F 00 04 */	stb r3, 0x4(r31)
/* 802260BC 001EF67C  98 1F 00 05 */	stb r0, 0x5(r31)
.L_802260C0:
...
/* 802260F0 001EF6B0  4B F1 13 55 */	bl fn_80137444
/* 802260F4 001EF6B4  2C 03 00 00 */	cmpwi r3, 0x0
/* 802260F8 001EF6B8  41 82 00 14 */	beq .L_8022610C
/* 802260FC 001EF6BC  38 60 00 02 */	li r3, 0x2
/* 80226100 001EF6C0  38 00 00 01 */	li r0, 0x1
/* 80226104 001EF6C4  98 7F 00 04 */	stb r3, 0x4(r31)
/* 80226108 001EF6C8  98 1F 00 05 */	stb r0, 0x5(r31)
.L_8022610C:
...
/* 80226138 001EF6F8  81 83 00 00 */	lwz r12, 0x0(r3)
...
/* 80226150 001EF710  81 83 00 00 */	lwz r12, 0x0(r3)
...
/* 80226164 001EF724  38 A0 00 01 */	li r5, 0x1
/* 80226168 001EF728  80 9F 00 10 */	lwz r4, 0x10(r31)
/* 8022616C 001EF72C  81 83 00 00 */	lwz r12, 0x0(r3)
...
/* 80226180 001EF740  38 80 00 00 */	li r4, 0x0
/* 80226184 001EF744  81 83 00 00 */	lwz r12, 0x0(r3)
...
/* 802261C0 001EF780  81 83 00 00 */	lwz r12, 0x0(r3)
...
/* 802261D8 001EF798  81 83 00 00 */	lwz r12, 0x0(r3)
...
/* 802261EC 001EF7AC  38 A0 00 01 */	li r5, 0x1
/* 802261F0 001EF7B0  80 9F 00 14 */	lwz r4, 0x14(r31)
/* 802261F4 001EF7B4  81 83 00 00 */	lwz r12, 0x0(r3)
...
/* 80226208 001EF7C8  38 80 00 00 */	li r4, 0x0
/* 8022620C 001EF7CC  81 83 00 00 */	lwz r12, 0x0(r3)
...
/* 80226248 001EF808  81 83 00 00 */	lwz r12, 0x0(r3)
...
/* 80226260 001EF820  81 83 00 00 */	lwz r12, 0x0(r3)
...
/* 80226274 001EF834  38 A0 00 01 */	li r5, 0x1
/* 80226278 001EF838  80 9F 00 18 */	lwz r4, 0x18(r31)
/* 8022627C 001EF83C  81 83 00 00 */	lwz r12, 0x0(r3)
...
/* 80226290 001EF850  38 80 00 00 */	li r4, 0x0
/* 80226294 001EF854  81 83 00 00 */	lwz r12, 0x0(r3)
