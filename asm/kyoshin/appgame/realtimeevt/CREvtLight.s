.include "macros.inc"
.file "kyoshin/appgame/realtimeevt/CREvtLight.o"
...
# 0x801C35A8 - 0x801C3974
.text
.balign 4

.fn fn_801C35A8, local
...
/* 801C35BC 0018CB7C  38 80 00 02 */	li r4, 0x2
/* 801C35C0 0018CB80  93 C1 00 08 */	stw r30, 0x8(r1)
/* 801C35C4 0018CB84  7C 7E 1B 78 */	mr r30, r3
/* 801C35C8 0018CB88  4B FC 20 C9 */	bl fn_80185690
/* 801C35CC 0018CB8C  3C 60 80 53 */	lis r3, __vt__cf_CREvtLight@ha
/* 801C35D0 0018CB90  38 00 00 00 */	li r0, 0x0
/* 801C35D4 0018CB94  38 63 75 48 */	addi r3, r3, __vt__cf_CREvtLight@l
/* 801C35D8 0018CB98  90 7E 00 00 */	stw r3, 0x0(r30)
...
/* 801C35F0 0018CBB0  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 801C361C 0018CBDC  93 C1 00 08 */	stw r30, 0x8(r1)
...
/* 801C3634 0018CBF4  90 A3 00 00 */	stw r5, 0x0(r3)
/* 801C3638 0018CBF8  2C 04 00 00 */	cmpwi r4, 0x0
...
/* 801C3648 0018CC08  48 2F E7 35 */	bl fn_804C1D7C
/* 801C364C 0018CC0C  38 00 00 00 */	li r0, 0x0
/* 801C3650 0018CC10  90 1E 00 20 */	stw r0, 0x20(r30)
/* 801C3654 0018CC14  4B EB FC 45 */	bl fn_80083298
/* 801C3658 0018CC18  2C 03 00 00 */	cmpwi r3, 0x0
/* 801C365C 0018CC1C  41 82 00 30 */	beq .L_801C368C
/* 801C3660 0018CC20  4B EB FC 39 */	bl fn_80083298
/* 801C3664 0018CC24  80 03 2F 3C */	lwz r0, 0x2f3c(r3)
/* 801C3668 0018CC28  2C 00 00 00 */	cmpwi r0, 0x0
/* 801C366C 0018CC2C  41 82 00 20 */	beq .L_801C368C
/* 801C3670 0018CC30  4B EB FC 29 */	bl fn_80083298
/* 801C3674 0018CC34  80 63 2F 3C */	lwz r3, 0x2f3c(r3)
/* 801C3678 0018CC38  38 80 00 01 */	li r4, 0x1
/* 801C367C 0018CC3C  81 83 00 00 */	lwz r12, 0x0(r3)
...
/* 801C3690 0018CC50  38 80 00 00 */	li r4, 0x0
/* 801C3694 0018CC54  4B FC 20 2D */	bl fn_801856C0
/* 801C3698 0018CC58  2C 1F 00 00 */	cmpwi r31, 0x0
/* 801C369C 0018CC5C  40 81 00 0C */	ble .L_801C36A8
/* 801C36A0 0018CC60  7F C3 F3 78 */	mr r3, r30
/* 801C36A4 0018CC64  4B FC 20 B1 */	bl fn_80185754
.L_801C36A8:
/* 801C36A8 0018CC68  7F C3 F3 78 */	mr r3, r30
/* 801C36AC 0018CC6C  83 E1 00 0C */	lwz r31, 0xc(r1)
/* 801C36B0 0018CC70  83 C1 00 08 */	lwz r30, 0x8(r1)
...
/* 801C36EC 0018CCAC  2C 00 00 00 */	cmpwi r0, 0x0
...
/* 801C3700 0018CCC0  48 2F E6 7D */	bl fn_804C1D7C
/* 801C3704 0018CCC4  38 00 00 00 */	li r0, 0x0
/* 801C3708 0018CCC8  90 1D 00 20 */	stw r0, 0x20(r29)
/* 801C370C 0018CCCC  4B EB FB 8D */	bl fn_80083298
/* 801C3710 0018CCD0  2C 03 00 00 */	cmpwi r3, 0x0
/* 801C3714 0018CCD4  41 82 00 30 */	beq .L_801C3744
/* 801C3718 0018CCD8  4B EB FB 81 */	bl fn_80083298
/* 801C371C 0018CCDC  80 03 2F 3C */	lwz r0, 0x2f3c(r3)
/* 801C3720 0018CCE0  2C 00 00 00 */	cmpwi r0, 0x0
/* 801C3724 0018CCE4  41 82 00 20 */	beq .L_801C3744
/* 801C3728 0018CCE8  4B EB FB 71 */	bl fn_80083298
/* 801C372C 0018CCEC  80 63 2F 3C */	lwz r3, 0x2f3c(r3)
/* 801C3730 0018CCF0  38 80 00 01 */	li r4, 0x1
/* 801C3734 0018CCF4  81 83 00 00 */	lwz r12, 0x0(r3)
/* 801C3738 0018CCF8  81 8C 00 68 */	lwz r12, 0x68(r12)
/* 801C373C 0018CCFC  7D 89 03 A6 */	mtctr r12
/* 801C3740 0018CD00  4E 80 04 21 */	bctrl
.L_801C3744:
/* 801C3744 0018CD04  2C 1F 00 00 */	cmpwi r31, 0x0
...
/* 801C3754 0018CD14  38 A0 00 07 */	li r5, 0x7
/* 801C3758 0018CD18  80 63 00 7C */	lwz r3, 0x7c(r3)
/* 801C375C 0018CD1C  48 2F E4 45 */	bl fn_804C1BA0
/* 801C3760 0018CD20  90 7D 00 20 */	stw r3, 0x20(r29)
/* 801C3764 0018CD24  4B EB FB 35 */	bl fn_80083298
/* 801C3768 0018CD28  2C 03 00 00 */	cmpwi r3, 0x0
/* 801C376C 0018CD2C  41 82 00 38 */	beq .L_801C37A4
/* 801C3770 0018CD30  4B EB FB 29 */	bl fn_80083298
/* 801C3774 0018CD34  80 03 2F 3C */	lwz r0, 0x2f3c(r3)
/* 801C3778 0018CD38  2C 00 00 00 */	cmpwi r0, 0x0
/* 801C377C 0018CD3C  41 82 00 28 */	beq .L_801C37A4
/* 801C3780 0018CD40  4B EB FB 19 */	bl fn_80083298
/* 801C3784 0018CD44  83 E3 2F 3C */	lwz r31, 0x2f3c(r3)
/* 801C3788 0018CD48  4B FB D1 B9 */	bl fn_80180940
/* 801C378C 0018CD4C  81 9F 00 00 */	lwz r12, 0x0(r31)
...
/* 801C37E4 0018CDA4  81 84 00 00 */	lwz r12, 0x0(r4)
/* 801C37E8 0018CDA8  81 8C 00 AC */	lwz r12, 0xac(r12)
/* 801C37EC 0018CDAC  7D 89 03 A6 */	mtctr r12
/* 801C37F0 0018CDB0  4E 80 04 21 */	bctrl
/* 801C37F4 0018CDB4  E0 03 00 00 */	psq_l f0, 0x0(r3), 0, qr0
/* 801C37F8 0018CDB8  38 81 00 14 */	addi r4, r1, 0x14
/* 801C37FC 0018CDBC  E0 3F 00 3C */	psq_l f1, 0x3c(r31), 0, qr0
/* 801C3800 0018CDC0  38 01 00 08 */	addi r0, r1, 0x8
/* 801C3804 0018CDC4  10 60 08 28 */	ps_sub f3, f0, f1
/* 801C3808 0018CDC8  E0 03 80 08 */	psq_l f0, 0x8(r3), 1, qr0
/* 801C380C 0018CDCC  E0 3F 80 44 */	psq_l f1, 0x44(r31), 1, qr0
/* 801C3810 0018CDD0  7C 03 03 78 */	mr r3, r0
/* 801C3814 0018CDD4  F0 64 00 00 */	psq_st f3, 0x0(r4), 0, qr0
/* 801C3818 0018CDD8  10 60 08 28 */	ps_sub f3, f0, f1
/* 801C381C 0018CDDC  C0 41 00 14 */	lfs f2, 0x14(r1)
/* 801C3820 0018CDE0  F0 64 80 08 */	psq_st f3, 0x8(r4), 1, qr0
/* 801C3824 0018CDE4  C0 21 00 18 */	lfs f1, 0x18(r1)
/* 801C3828 0018CDE8  C0 01 00 1C */	lfs f0, 0x1c(r1)
/* 801C382C 0018CDEC  D0 41 00 08 */	stfs f2, 0x8(r1)
...
/* 801C3868 0018CE28  81 84 00 00 */	lwz r12, 0x0(r4)
/* 801C386C 0018CE2C  81 8C 00 AC */	lwz r12, 0xac(r12)
/* 801C3870 0018CE30  7D 89 03 A6 */	mtctr r12
/* 801C3874 0018CE34  4E 80 04 21 */	bctrl
/* 801C3878 0018CE38  E0 03 00 00 */	psq_l f0, 0x0(r3), 0, qr0
/* 801C387C 0018CE3C  38 81 00 14 */	addi r4, r1, 0x14
/* 801C3880 0018CE40  E0 3F 00 3C */	psq_l f1, 0x3c(r31), 0, qr0
/* 801C3884 0018CE44  10 40 08 28 */	ps_sub f2, f0, f1
/* 801C3888 0018CE48  E0 03 80 08 */	psq_l f0, 0x8(r3), 1, qr0
/* 801C388C 0018CE4C  E0 3F 80 44 */	psq_l f1, 0x44(r31), 1, qr0
/* 801C3890 0018CE50  F0 44 00 00 */	psq_st f2, 0x0(r4), 0, qr0
/* 801C3894 0018CE54  10 40 08 28 */	ps_sub f2, f0, f1
/* 801C3898 0018CE58  C0 21 00 14 */	lfs f1, 0x14(r1)
/* 801C389C 0018CE5C  F0 44 80 08 */	psq_st f2, 0x8(r4), 1, qr0
/* 801C38A0 0018CE60  C0 01 00 18 */	lfs f0, 0x18(r1)
/* 801C38A4 0018CE64  C0 41 00 1C */	lfs f2, 0x1c(r1)
/* 801C38A8 0018CE68  D0 21 00 08 */	stfs f1, 0x8(r1)
...
/* 801C38DC 0018CE9C  4C 40 13 82 */	cror eq, lt, eq
...
/* 801C391C 0018CEDC  38 60 00 02 */	li r3, 0x2
...
/* 801C392C 0018CEEC  38 60 00 04 */	li r3, 0x4
...
/* 801C3940 0018CF00  38 60 00 02 */	li r3, 0x2
...
/* 801C3954 0018CF14  38 60 00 04 */	li r3, 0x4
/* 801C3958 0018CF18  48 00 00 08 */	b .L_801C3960
.L_801C395C:
/* 801C395C 0018CF1C  38 60 00 01 */	li r3, 0x1
.L_801C3960:
...
.section .sdata2, "a"
.balign 8
.sym lbl_8066A7C8, local
	.4byte 0x3CC90FDB
.sym lbl_8066A7CC, local
	.4byte 0x42700000
.sym lbl_8066A7D0, local
	.4byte 0x40000000
	.4byte 0x00000000
